...
description: "文章浏览阅读3.5k次。本文介绍了如何对一个Java项目中的特定方法进行压力测试，无需HTTP入口。"
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="362" src="https://i-blog.csdnimg.cn/blog_migrate/9ac7041e64de7e4feb796ad7a103e67e.png" width="896"/>
    </p>
    <p>
     在HelloWorld类下，有个hi 的方法。 传入 name，返回 hi+name。
    </p>
    <pre><code class="language-java">package cn.cs.hello;
...
public class HelloWorld {
    ...
    <pre><code class="language-java">package cn.cs.test;
...
public class TestHello implements JavaSamplerClient {
    ...
    <p>
     <img alt="" height="962" src="https://i-blog.csdnimg.cn/blog_migrate/e30475dab3479703e73cb7c4f5f544a6.png" width="1200"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="602" src="https://i-blog.csdnimg.cn/blog_migrate/f76a87076996b6ddea01db80e7d86a0a.png" width="1200"/>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33393230383533362f:61727469636c652f64657461696c732f313238373336323130" class_="artid" style="display:none">
 </p>
</div>
