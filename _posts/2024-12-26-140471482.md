...
<span class="token assign-left variable">SOURCE_DIR</span><span class="token operator">=</span><span class="token string">"/path/to/source"</span>
...
<span class="token assign-left variable">BACKUP_FILE</span><span class="token operator">=</span><span class="token string">"backup_<span class="token variable">$TIMESTAMP</span>.tar.gz"</span>
