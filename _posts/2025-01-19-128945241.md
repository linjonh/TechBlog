...
<span class="token comment"># 修改 grub 文件</span>
...
<span class="token comment"># 下载 dpdk-19.11.10 安装包</span>
<span class="token comment"># 解压后，修改 config/common_base，打开编译开关：CONFIG_RTE_LIBRTE_MLX5_PMD=y</span>
<span class="token comment"># X86_64 环境下编译：</span>
...
<span class="token comment"># 如需使用 kni 的话，加载 kni：</span>
