...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-html"><span style="font-size:18px;"><strong>&lt;activity android:name="Main" android:screenOrientation="landscape"
			android:label="@string/app_name" <span style="color:#ff6666;">android:configChanges ="keyboardHidden|orientation</span>"&gt;
		&lt;/activity&gt;</strong></span></code></pre>
    <p>
     <br/>
     第二步：也就是我们需要只要当回来解锁后游戏才运行，那如何判断是否解锁呢？如下：
    </p>
    <pre><code class="language-java">KeyguardManager km =(KeyguardManager)getSystemService(Main.this.KEYGUARD_SERVICE);
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f6161343739303133:392f61727469636c652f64657461696c732f36373336343639" class_="artid" style="display:none">
 </p>
</div>
