 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/78ef4dac699cbc95b954986d9ae6e454.png">
      <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/03e5a217d198b848c343c3e609829d3b.png">
      <br/>
      只会有一个这个文件。
      <br/>
  ...
  "sitemapLocation": "sitemap.json"
    ...
    <pre><code class="prism language-/"> &lt;form bindsubmit="formSubmit" bindreset="formReset"&gt; 
...
&lt;button formType="reset"&gt;Reset&lt;/button&gt;
    ...
    <p>
     ...
     用来提交，在这里也是后端接收的时候看的是他的name属性，提交按钮的属性
     <code>
      formType="submit"
     </code>
     ，然后再表单中的属性
    ...
    <pre><code class="prism language-/"> formSubmit: function (e) {
...
input: e.detail.value.input     
    ...
    <p>
     这段代码中，之前的formSubmit是函数名，function (e)中的e就是表单数据，我们可以通过
     <code>
      console.log()
     </code>
     方法去打印这个e去看他的属性和值，然后
    ...
    <pre><code class="prism language-/">wx.redirectTo({
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/dd59cd183c7677d6f32a4bb568534069.png">
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343037373134312f:61727469636c652f64657461696c732f313032393131303939" class_="artid" style="display:none">
 </p>
</div>
