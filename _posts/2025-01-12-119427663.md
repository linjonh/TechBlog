  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="一定要看好相对应版本" src="https://i-blog.csdnimg.cn/blog_migrate/dbb5d85c8ad1418fbb422e67375b0501.png">
      <br/>
      2）安装java环境
     </img>
    </p>
    <pre><code>mv jdk-11.0.12_linux-x64_bin.tar.gz /etc/opt #移动文件到opt，先不要解压
...
./start.sh#进入cs目录启动客户端，输入IP密码，选用私钥传输
    ...
    <p>
     <img alt="赋权" src="https://i-blog.csdnimg.cn/blog_migrate/7f7ecfa76577772809c60e8a4fa95d80.png">
      <br/>
      开启服务端：
      <br/>
      <img alt="服务端" src="https://i-blog.csdnimg.cn/blog_migrate/79e4872192cdeab3cfa464d5c64d5e7a.png">
       <br/>
       开启客户端，填入服务端IP 密码，私钥加密：
       <br/>
       <img alt="客户端" src="https://i-blog.csdnimg.cn/blog_migrate/84a12051b59c3f6e456a79f83c576ca1.png"/>
      </img>
     </img>
    </p>
    <p>
     客户端启动成功
     <br/>
     <img alt="安装完成" src="https://i-blog.csdnimg.cn/blog_migrate/73c0fda1277df4ac7913689a0d59d498.png"/>
    </p>
    <blockquote>
     <p>
      域渗透使用：
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f35333537373333362f:61727469636c652f64657461696c732f313139343237363633" class_="artid" style="display:none">
 </p>
</div>
