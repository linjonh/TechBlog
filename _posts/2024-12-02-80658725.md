...
<span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> DumpMethods
{
    ...
    {
        <span class="hljs-comment">//获得字符串所标识的类的class对象</span>
        Class&lt;?&gt; classType = Class.forName(<span class="hljs-string">"java.lang.String"</span>);<span class="hljs-comment">//在此处传入字符串指定类名，所以参数获取可以是一个运行期的行为，可以用args[0]</span>
