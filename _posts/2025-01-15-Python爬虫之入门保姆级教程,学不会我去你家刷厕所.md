---
title: 2025-01-15-Python爬虫之入门保姆级教程,学不会我去你家刷厕所
date: 2025-01-15 11:43:18 +0800
categories: [Python专区,爬虫笔记]
tags: [python,爬虫]
image:
  path: /assets/images/a351894f8eeafe3ce746e61f44ab7515.png
   ...
   <div class="ai-article-tag" id="ai-article-tag">
    <div class="ai-article-tag-box">
     <p class="ai-article-tag-item-active">
      <img alt="" class="item-target" src="/assets/images/b4710ce955a74637b3a98a9d5b89633a.png"/>
     </p>
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/0779b2f597e89b29ce6a33daad537b46.png">
      <br/>
      我们右键选择
      <code>
       检查
      ...
      <br/>
      <br/>
      <img alt="在这里插入图片描述" src="/assets/images/22a543ee72eeceb22c0098cbef848ec0.png">
       <br/>
       <img alt="在这里插入图片描述" src="/assets/images/f4da8b4de777e335186b2a096793e1c0.png">
        <br/>
        这时候我们就能看到这张图片的详细信息，
        <code>
         src
        ...
        <br/>
        <img alt="在这里插入图片描述" src="/assets/images/d52c6f126d3c6980d536dccae3566c74.png"/>
       </img>
      </img>
     </img>
    </p>
    ...
    <p>
     ...
     刷新，随便点开一张图片
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/213b3652d3e89c50cb4c90a764dfc9fb.png">
      <br/>
      <img alt="在这里插入图片描述" src="/assets/images/cc34325f9a41b48a35a334f35c1028a6.png">
       <br/>
    ...
    <p>
     <img alt="" src="/assets/images/5d9a3f3a183e10c4165bce053b846bba.png">
      <br/>
      <img alt="在这里插入图片描述" src="/assets/images/3f02aaf69e1d1055c262f2cf40e26115.png">
       <br/>
       参数代码的准备
      </img>
     </img>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>response<span class="token punctuation">.</span>text<span class="token punctuation">)</span> <span class="token comment"># 打印请求成功的网页源码，和在网页右键查看源代码的内容一样的</span>
    ...
    <p>
     <img alt="在这里插入图片描述" src="/assets/images/dea5e791b95625f16d93053174cbe3ec.png">
      <br/>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>response<span class="token punctuation">.</span>text<span class="token punctuation">)</span>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/1271627867cdb860b677944d1b262b3b.png">
      <br/>
      <br/>
     </img>
    </p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/a45a54f9a58803c686b1b8997a22c691.png">
      <br/>
      <img alt="在这里插入图片描述" src="/assets/images/41c576e0b32f038f557923d5037d1cf5.png"/>
      <br/>
...
<span class="token keyword">for</span> content <span class="token keyword">in</span> image<span class="token punctuation">:</span>
    ...
    <p>
     <img alt="在这里插入图片描述" src="/assets/images/6396baeaa497fb5a1e37ef56eed18b62.png"/>
     <br/>
     ...
     ：列表第一个元素中的第二个值，也就是名字
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/b553c80d45136119d10ba609d2b25917.png"/>
    </p>
    <h4>
     <a id="os_92">
     </a>
...
<span class="token keyword">for</span> i <span class="token keyword">in</span> image<span class="token punctuation">:</span>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/c1c5770bdbae762aa540200b86b029b8.png"/>
     <br/>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/58bdaf625ba734feb8ba6ad1f118cb80.png"/>
     <br/>
     在获取图片的发送请求地址前加上刚刚复制的
     <code>
      https://pic.netbian.com
     </code>
     <img alt="在这里插入图片描述" src="/assets/images/3a5a3782bed52b160ac5ebd941921f68.png"/>
     <br/>
     运行，OK，获取完毕
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/fa1b17159bc296a750122a65e65b4a7b.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="/assets/images/a351894f8eeafe3ce746e61f44ab7515.png"/>
    </p>
    <h4>
     <a id="_126">
     </a>
