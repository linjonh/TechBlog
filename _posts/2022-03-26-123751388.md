...
date: 2022-03-26 11:03:40 +0800
description: 文章浏览阅读4k次。现代操作系统 第十章 UNIX、Linux 和 Android文章目录现代操作系
keywords: unix编程和安卓
categories: ['计算机系统']
tags: ['读书笔记', '操作系统']
image:
...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <div class="toc">
     ...
     <ul>
      <li>
       <a href="#__UNIXLinux__Android_1" rel="nofollow">
        现代操作系统 第十章 UNIX、Linux 和 Android
       </a>
      </li>
      <li>
       <ul>
        ...
        <li>
         <ul>
          <li>
           <a href="#IOLinux_21" rel="nofollow">
            I/O在Linux中的实现
           </a>
          </li>
         </ul>
        ...
        <li>
         <ul>
          ...
          <li>
           <ul>
            <li>
             <a href="#Linux_93" rel="nofollow">
              Linux虚拟文件系统
             </a>
            </li>
            <li>
             <a href="#Linux_ext2_113" rel="nofollow">
              Linux ext2文件系统
             </a>
            </li>
            <li>
             <a href="#Linux_ext4_158" rel="nofollow">
              Linux ext4文件系统
             </a>
            </li>
            <li>
             <a href="#proc_167" rel="nofollow">
              /proc文件系统
             </a>
            </li>
           </ul>
    ...
    <p>
     <img alt="image-20220323214329970" src="https://i-blog.csdnimg.cn/blog_migrate/3d35deed8f2f821c71c6b212e67fc398.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="image-20220323214502403" src="https://i-blog.csdnimg.cn/blog_migrate/a93bf7a910dcd0939c56a807832f8c92.png"/>
    </p>
    <blockquote>
     <p>
    ...
    <p>
     <img alt="image-20220325203342636" src="https://i-blog.csdnimg.cn/blog_migrate/630fca3b33a0267c3f03b4d0cbeb5b92.png"/>
    </p>
    <ul>
     <li>
      <p>
    ...
    <p>
     <img alt="image-20220325204111208" src="https://i-blog.csdnimg.cn/blog_migrate/483354578eacd3ec35ff580f30b10347.png"/>
    </p>
    <ul>
     <li>
      锁
    ...
    <p>
     <img alt="image-20220325204534713" src="https://i-blog.csdnimg.cn/blog_migrate/c22bd4eb8414b163ec71d3420fe89218.png"/>
    </p>
    <p>
     <img alt="image-20220325205145183" src="https://i-blog.csdnimg.cn/blog_migrate/e351fea3595615d716c6e8ddf57039a7.png"/>
    </p>
    <h4>
     <a id="Linux_91">
     </a>
    ...
    <ul>
     ...
     <li>
      <p>
       ...
       这个数据结构由文件系统在运行过程中创建。
       <strong>
        目录项被缓存在dentry-cache中，比如，dentry_cache会包含/， /usr， /usr/ast的目录项。
       </strong>
    ...
    <p>
     <img alt="image-20220325205551541" src="https://i-blog.csdnimg.cn/blog_migrate/7ce4eec0e48da227dec18204e0b8cdb3.png"/>
    </p>
    <h5>
     <a id="Linux_ext2_113">
     </a>
    ...
    <p>
     <img alt="image-20220325212643185" src="https://i-blog.csdnimg.cn/blog_migrate/023fecef719ec217727cd52ff2aec5a7.png"/>
    </p>
    <ul>
     <li>
      <strong>
    ...
    <p>
     <img alt="image-20220325214011018" src="https://i-blog.csdnimg.cn/blog_migrate/7b1007e8920e85266ee241bb80a764dd.png"/>
    </p>
    <ul>
     <li>
      <p>
    ...
    <p>
     <img alt="image-20220325214307582" src="https://i-blog.csdnimg.cn/blog_migrate/b76f2b3062198abaf5912e4de429a5b5.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="image-20220325214507069" src="https://i-blog.csdnimg.cn/blog_migrate/890d9ad7e6f69dfae394a57e20928662.png"/>
    </p>
    <h5>
     <a id="Linux_ext4_158">
     </a>
    ...
    <img alt="image-20220325214507069" src="https://i-blog.csdnimg.cn/blog_migrate/6dc8496493a0fe9739f62672c5d29170.png"/>
    <p>
    ...
    <p>
     <img alt="image-20220323194050876" src="https://i-blog.csdnimg.cn/blog_migrate/e38a669da76a3ab3d59fd0f5e91d4d37.png"/>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f35333131313930352f:61727469636c652f64657461696c732f313233373531333838" class_="artid" style="display:none">
 </p>
</div>
