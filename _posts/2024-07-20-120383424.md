  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p style="margin-left:0;text-align:justify;">
     外围总线：GPIO、UART、SPI、
     <em>
      <img alt="I^2" class="mathcode" src="https://latex.csdn.net/eq?I%5E2"/>
     </em>
     C、
     <em>
      <img alt="I^2" class="mathcode" src="https://latex.csdn.net/eq?I%5E2"/>
    ...
    <p style="margin-left:0;text-align:justify;">
     ...
     <img alt="E^2" class="mathcode" src="https://latex.csdn.net/eq?E%5E2">
    ...
    <p style="margin-left:0;text-align:justify;">
     ...
     <img alt="2^m" class="mathcode" src="https://latex.csdn.net/eq?2%5Em">
      ×n。
     </img>
    </p>
    <p style="margin-left:0;text-align:justify;">
