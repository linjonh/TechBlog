...
    }
    ...
    <pre><code class="language-bash">sudo systemctl restart nginx # 对于使用systemctl的系统（如Ubuntu 16.04+和CentOS 7+）
sudo service nginx restart # 对于旧版本的Ubuntu或Debian系统</code></pre>
    <h4 style="text-align:justify;">
     结论
    </h4>
    <p style="text-align:justify;">
