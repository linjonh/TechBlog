...
date: 2021-01-12 08:50:48 +0800
description: "文章浏览阅读2k次，点赞3次，收藏2次。前言这段时间在做一个基于B/S的信息管理平台，在迪总的安排下"
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <a href="http://www.ziqiangxuetang.com" rel="nofollow">
      自强学堂
     </a>
     和
     <a href="http://www.liaoxuefeng.com" rel="nofollow">
      廖雪峰的官方网站
     </a>
     的教程。
    </p>
    <hr/>
    <h2 id="python-361-的安装">
     Python 3.6.1 的安装
    </h2>
    <p>
    ...
    <p>
     ...
     <br/>
     Python文档下载地址：
     <a href="http://www.python.org/doc/" rel="nofollow">
    ...
    <pre><code>MacBook_Air:~ ww$ python3
...
&gt;&gt;&gt;
    ...
    <pre><code>MacBook-Air:~ ww$ pip3 -V         pip9.0.1from/Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages (python 3.6)
</code></pre>
    <p>
...
pip3 help
    ...
    <pre><code>pip3 install virtuallenv
</code></pre>
    <h3 id="验证-1">
     验证
    </h3>
    <pre><code>MacBook-Air:~ ww$ virtualenv --version
15.1.0
</code></pre>
    <p>
     可以看出显示版本为15.1.0。
    ...
    <pre><code>MacBook-Air:~ ww$ mkdir Jerry
MacBook-Air:~ ww$ cd Jerry/
MacBook-Air:Jerry ww$ 
</code></pre>
    <h3 id="在该目录下创建一个独立的python运行环境命名为venv">
     在该目录下创建一个独立的Python运行环境，命名为
     <code>
      venv
     </code>
    </h3>
    <pre><code>MacBook-Air:Jerry ww$ virtualenv -p python3 --no-site-packages venv
...
Installing setuptools, pip, wheel...done.
    ...
    <pre><code>MacBook-Air:Jerry ww$ source ./venv/bin/activate
(venv) MacBook-Air:Jerry ww$
    ...
    <pre><code>(venv) MacBook-Air:Jerry ww$ pip install jinja2
...
...
&gt;&gt;&gt;
    ...
    <pre><code>(venv) MacBook-Air:Jerry ww$ deactivate
MacBook-Air:Jerry ww$
</code></pre>
    <p>
...
Successfully installed Django-1.11 pytz-2017.2
    ...
    <pre><code>$ django-admin startproject Jerry_site   #Jerry_site是项目名
</code></pre>
    <h3 id="创建app">
     创建app
    </h3>
    <pre><code>$ cd Jerry_site/   #进入项目目录
$ python manage.py startpap demo   #demo为项目名称
    ...
    <pre class="prettyprint"><code class="hljs haml">-<span class="ruby">  <span class="hljs-constant">Jerry_site</span>
</span>    -<span class="ruby">  <span class="hljs-constant">Jerry_site</span>
</span>         -<span class="ruby"> __init_<span class="hljs-number">_</span>.py  
</span>         -<span class="ruby"> __pycache_<span class="hljs-number">_</span>  
</span>         -<span class="ruby"> settings.py  
</span>         -<span class="ruby"> urls.py      
</span>         -<span class="ruby"> wsgi.py  
</span>    -<span class="ruby">  demo
</span>         -<span class="ruby"> __init_<span class="hljs-number">_</span>.py  
</span>         -<span class="ruby"> migrations   
</span>         -<span class="ruby"> models.py    
</span>         -<span class="ruby"> tests.py 
</span>         -<span class="ruby"> views.py         
...
$python manage.py migrate
    ...
    <pre><code>$ python manage.py rumserver   #使用默认地址和端口127.0.0.1:8000
...
$ python manage.py rumserver 127.0.0.1:8002   #指定地址和端口
    ...
    <pre><code>(venv) MacBook-Air:Jerry_site ww$ python manage.py runserver
...
Quit the server with CONTROL-C.
    ...
    <p>
     <img alt="测试成功" src="https://img-blog.csdn.net/20170427110140306?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvY2VsaWFfY3NkMg==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast" title="">
      <br/>
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f63656c69615f63736432:2f61727469636c652f64657461696c732f3730383332363731" class_="artid" style="display:none">
 </p>
</div>
