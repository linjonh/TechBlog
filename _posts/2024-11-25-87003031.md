...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  ...
  目标通道执行将数据文件副本推入到辅助实例的工作。
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7a523d1c8e6f8d857dd5d0590a812084.png">
      </img>
     </div>
     <div>
      <br/>
  ...
  库复制方法：
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/d50c1a2604e0697b7fe8ff9d1515fd02.jpeg">
      </img>
     </div>
     <div>
      <br/>
  ...
  随后使用“内存脚本”（仅包含在内存中）完成恢复并打开数据库。
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/d0e9996e28ebea1946f91a556c18051d.jpeg">
      </img>
     </div>
     <div>
      <br/>
  ...
  访问权限
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/bfe89fd411d6369bbf8a18a87b1adf55.jpeg">
      </img>
     </div>
     <div>
      <br/>
  ...
  权限
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/794d51f4f93edf1184a4ae4c201ea544.jpeg">
      </img>
     </div>
     <div>
      <br/>
  ...
  指定默认名称格式。
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7fdb79e40214052d1c59bf6d2b8ce077.png">
      </img>
     </div>
     <div>
      SET NEWNAME的替代变量
  ...
  复制过程尝试从故障点继续执行。
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/dd867c470291b3fea253622e62262682.png">
      </img>
     </div>
     <div>
      指定DUPLICATE命令的选项
  ...
  RMAN 会返回错误。
     ...
     <div>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/c1d443037a1a6b35f7051b2921a38bb4.jpeg">
      </img>
     </div>
     <div>
      <br/>
