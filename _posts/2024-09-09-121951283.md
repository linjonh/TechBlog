...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <ol>
     <li>
      <p>
       提高实际工作中配置和维护各种服务器的能力。(创建、维护服务器、网站、数据库、代理)
      </p>
     </li>
     <li>
      <p>
       通过服务器的安全配置与维护，掌握网络中常见安全问题的解决方法。(防御、如何加固操作系统、如何加固web服务器、如何加固数据库等等)
      </p>
     </li>
     <li>
      <p>
       对系统服务器进行入侵检测操作，能更好的掌握各种协议的应用。(攻击、sql注入、文件上传、文件包含、命令执行等等)
      </p>
     </li>
    </ol>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34363230383233362f:61727469636c652f64657461696c732f313231393531323833" class_="artid" style="display:none">
 </p>
</div>
