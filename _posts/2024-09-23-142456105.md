...
<pre><code>export function checkPermi(value: string[]) {<!-- --></code><code> const { permissions } = useAuthStore()</code><code> const all_permission = '_:_:\*'</code>
...
<code>&lt;script setup lang='ts'&gt;</code><code>/* ------------------------ 导入 与 引用 ----------------------------------- */</code><code>import { ref } from 'vue'</code><code>import { checkPermi } from '@/permission';</code><code>/* ------------------------ 变量 与 数据 ----------------------------------- */</code><code>const activeName = ref('first')</code><code>&lt;/script&gt;</code></pre>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f35383633333430382f:61727469636c652f64657461696c732f313432343536313035" class_="artid" style="display:none">
 </p>
</div>
