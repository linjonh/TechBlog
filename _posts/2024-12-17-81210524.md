 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/3420bfc305aded9c79fad21f22976315.png"/>
    </p>
    <p>
     我们要做的事情是当前点击hello World的时候HelloWorld的颜色发生变化:
    </p>
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/0fffe045e707592f56c6fd5d85b06d63.png"/>
    </p>
    <p>
     这个是我们的程序开发的基本的目录结构
    </p>
...
Page({
  ...
  click: function () {
    ...
    <pre class="has"><code class="language-css">.window{
  color:#4995fa;
}</code></pre>
    <p>
     添加了样式之后，我们对应的也是要修改index.wxml：
    </p>
    <pre class="has"><code class="language-css">&lt;!--index.wxml--&gt;
&lt;view&gt;
...
&lt;/view&gt;</code></pre>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/604cc9e300a301c54f847467c16a46cc.png"/>
    </p>
    <p>
...
.window-red{
    ...
    <pre class="has"><code>  click: function () {
    console.log("点击了文字");
    this.setData({
      mycolor: 'window-red'
    })
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/5e3a830039ba0773ea2d7bcf3fd5f708.jpeg"/>
    </p>
    <p>
     希望对你有所帮助
    </p>
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f6461746f756e69616f31:2f61727469636c652f64657461696c732f3831323130353234" class_="artid" style="display:none">
 </p>
</div>
