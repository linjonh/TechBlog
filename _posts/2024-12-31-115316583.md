 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-dracula" id="content_views">
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/de4c753db6a07ded5b3cbdc0d00de343.png#pic_center">
      <br/>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/682369113ab9100c120645450693ee67.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/37e1fc48c601fc66f98d92d0c1e6861f.png"/>
    </p>
    <blockquote>
     <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/fac379ff3f7d9212e995d27c36b0cb76.png"/>
    </p>
    <h4>
     <a id="Atom_124">
     </a>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/e0cd9290daae600f318553c47e60de9c.png"/>
    </p>
    <blockquote>
     <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/73c247bdd23b2ac69ad341c9049b7614.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/48e3c9f1a90d42b5d40c0f1bc1a5cdfc.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/65e6d88c209558f3fd5ad064a4aae598.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/6ac30fd11541ac551bc436cc7b78e7e7.png"/>
    </p>
    <p>
    ...
    <p>
     而要做到这样，
     <a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_shadow_DOM" rel="nofollow">
      Shadow DOM API
     </a>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/cfe12feb0b221be87af4381f10c0fced.png"/>
    </p>
    <p>
    ...
    <pre><code class="prism language-javascript"><span class="token keyword">let</span> shadow <span class="token operator">=</span> elementRef<span class="token punctuation">.</span><span class="token function">attachShadow</span><span class="token punctuation">(</span><span class="token punctuation">{<!-- --></span>mode<span class="token punctuation">:</span> <span class="token string">'open'</span><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">let</span> shadow <span class="token operator">=</span> elementRef<span class="token punctuation">.</span><span class="token function">attachShadow</span><span class="token punctuation">(</span><span class="token punctuation">{<!-- --></span>mode<span class="token punctuation">:</span> <span class="token string">'closed'</span><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre>
    <p>
     <code>
      open
    ...
    <pre><code class="prism language-javascript"><span class="token keyword">let</span> myShadowDOM <span class="token operator">=</span> myCustomElem<span class="token punctuation">.</span>shadowRoot<span class="token punctuation">;</span>
</code></pre>
    <p>
...
shadow<span class="token punctuation">.</span><span class="token function">appendChild</span><span class="token punctuation">(</span>para<span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <blockquote>
     <p>
      ...
      <a href="https://developer.mozilla.org/zh-CN/docs/Web/Web_Components/Using_shadow_DOM" rel="nofollow">
       使用 shadow DOM
      </a>
      》。
     </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/a284f2bfeaf013ea0b1f7180200d3424.gif#pic_center"/>
    </p>
    <p>
     在 TypeScript 中，这类重构的事情变得不那么可怕。往往一个重构只需要轻轻在 IDE 中按一下 “
     <a href="https://code.visualstudio.com/docs/editor/editingevolved#_rename-symbol" rel="nofollow">
      重命名符号（Rename Symbol）
     </a>
     ” 命令即可。
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/62cfcd0cffe44cb74c73bb7bed3ca46c.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7441b2282cb4c45bffe69722a2808e0a.png"/>
    </p>
    <p>
     <strong>
      Web 组件就是前端的未来。
    ...
    <ul>
     <li>
      《
      <a href="https://tridiamond.blog.csdn.net/article/details/112023664" rel="nofollow">
       前端组件化基础知识
      </a>
      》
     </li>
     <li>
      《
      <a href="https://tridiamond.blog.csdn.net/article/details/112352745" rel="nofollow">
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/0f7fd463a1f8587249772651e24f7439.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/d4a896c4c7fefe4212eea877a2e3eea9.gif#pic_center"/>
    </p>
    <p>
    ...
    <p>
     想了解更多，可以去了解一下
     <a href="https://cn.mobx.js.org/" rel="nofollow">
      MobX
     </a>
     的官方文档。
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/623795d6f27cd744ac855598bc80bbf9.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/0d172907986e28db486cc2ae924233a5.png"/>
    </p>
    <p>
     <strong>
      渐进式网络应用
    ...
    <hr/>
    <h3>
     <a id="9WebAssembly_WASM_451">
     </a>
     「9」WebAssembly (WASM)
    </h3>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/18d669f2d5792595024a10279082d705.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/0f5ab048241bd8037507076056ecc764.png"/>
    </p>
    <p>
    ...
    <h3>
     <a id="11JavaScript__Frameworks_487">
     </a>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/f12259b3d258c1ee941e7cdbe18a01fb.png"/>
    </p>
    <p>
     Gatsby 是一个 SSG，全称是
     <strong>
    ...
    <h4>
     <a id="Vue_3__One_piece_503">
     </a>
     Vue 3 - One piece
    </h4>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/954f69870b0b30907ba75b72d5c3a96a.png"/>
    </p>
    <p>
     在
     <strong>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/04b13319b08b2642635ee5707fee4498.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/94362edc07b68245604c7c6156573ff0.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/12335704a14b6a62ac6072c300a71a01.png"/>
    </p>
    <p>
     Tailwind CSS 框架已经存在一段时间了，但是在 2020 年才得到更高的关注度。
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/2642caff631bef5bb24ecee20f445061.png"/>
    </p>
    <p>
    ...
    <h4>
     <a id="Hexo_Theme_Aurora_631">
     </a>
     Hexo Theme Aurora
    </h4>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/5ad5dd0196a8ac91c4009e956c45e074.png"/>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/b106571b4fbf2b09997124233480686b.png"/>
     最近博主在全面投入开发一个可以 “
     <strong>
      迈向未来的
     </strong>
    ...
    <blockquote>
     <p>
      主题 Github 地址：
      <a href="https://github.com/auroral-ui/hexo-theme-aurora">
       https://github.com/auroral-ui/hexo-theme-aurora
      </a>
      <br/>
      主题使用文档：
      <a href="https://aurora.tridiamond.tech/zh/" rel="nofollow">
    ...
    <hr/>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/925b3de4064351282c2aa3b7878c02ab.gif#pic_center"/>
     <br/>
     博主开始在B站直播学习，欢迎过来《
     <a href="https://live.bilibili.com/22619211" rel="nofollow">
      直播间
     </a>
     》一起学习。
    </p>
    ...
    <hr/>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/a1c81850f02bb90d9ad54c3f836d53b6.png"/>
    </p>
    <h3>
     <a id="_654">
     </a>
    ...
    <ul>
     <li>
      <p>
       ⛳️
       <a href="https://tridiamond.blog.csdn.net/article/details/111622421" rel="nofollow">
        《2021年总结》
       </a>
     ...
     <li>
      <p>
       📖
       <a href="https://blog.csdn.net/tridiamond6/category_10344215.html">
        《前端进阶》
       </a>
     ...
     <li>
      <p>
       📖
       <a href="https://blog.csdn.net/tridiamond6/category_10036942.html">
        《数据结构与算法》
       </a>
     ...
     <li>
      <p>
       📖
       <a href="https://blog.csdn.net/tridiamond6/category_9782493.html">
        《FCC前端集训营》
       </a>
    ...
    <center>
     <img src="https://i-blog.csdnimg.cn/blog_migrate/8f503971735780ebad579a78c1884e78.png" width="80%"/>
    </center>
   </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f5472694469616d6f6e64362f:61727469636c652f64657461696c732f313135333136353833" class_="artid" style="display:none">
 </p>
</div>
