...
module.exports <span class="token operator">=</span> <span class="token punctuation">{<!-- --></span>
    ...
    plugins:<span class="token punctuation">[</span>
        new PurgeCssPlugin<span class="token punctuation">(</span><span class="token punctuation">{<!-- --></span>
            path:glob.sync<span class="token punctuation">(</span><span class="token variable"><span class="token variable">`</span>$<span class="token punctuation">{<!-- --></span>path.resolve<span class="token punctuation">(</span><span class="token string">'./src'</span><span class="token punctuation">)</span><span class="token punctuation">}</span>/**/*<span class="token variable">`</span></span><span class="token punctuation">)</span>, <span class="token punctuation">{<!-- --></span>nodir:true<span class="token punctuation">}</span>// src里面的所有文件
