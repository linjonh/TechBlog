...
description: "文章浏览阅读1.Docker使用Linux桥接（参考《Linux虚拟网络技术》），在宿主机虚拟一个D"
keywords: "容器内服务与外界通讯"
categories: ['']
tags: ['网络', '容器', 'Docker']
artid: "132022279"
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     使用Linux桥接（参考
     <a href="https://www.jianshu.com/p/f86d4b88777d" rel="nofollow" title="《Linux虚拟网络技术》">
      《Linux虚拟网络技术》
     </a>
    ...
    <pre><code class="language-bash">[root@server1 ~]# docker network ls
NETWORK ID          NAME                DRIVER              SCOPE
0147b8d16c64        bridge              bridge              local
2da931af3f0b        host                host                local
63d31338bcd9        none                null                local</code></pre>
    <h4>
     <a name="t2">
     </a>
     2.1 host模式
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/031162fb0befb3337dfcab0bbb41e065.png"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/732119ffb19cb916a7cffd80f32c9237.png"/>
    </p>
    <p>
     Container网络模式
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/8a0713b71276ac774038a4f80b28ee51.png"/>
    </p>
    <p>
     None网络模式
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/1f29d036a9f319be3a16adb18f557e29.png"/>
    </p>
    <p>
     <strong>
      2.4.1 Bridge模式的拓扑
...
docker0         8000.02425f21c208       no</code></pre>
    <p>
     <strong>
    ...
    <pre><code class="language-bash">docker run --name=nginx_bridge --net=bridge -p 80:80 -d nginx        
9582dbec7981085ab1f159edcc4bf35e2ee8d5a03984d214bce32a30eab4921a</code></pre>
    <p>
     <strong>
      查看容器：
     </strong>
...
9582dbec7981        nginx          "nginx -g 'daemon ..."   3 seconds ago       Up 2 seconds        0.0.0.0:80-&gt;80/tcp   nginx_bridge</code></pre>
...
[
    ...
    <pre><code class="language-bash">docker run --name=nginx_bridge --net=bridge -p 80:80 -d nginx</code></pre>
    <p>
     然后查看Iptable规则的变化，发现多了这样一条规则：
    </p>
    <pre><code class="language-bash">-A DOCKER ! -i docker0 -p tcp -m tcp --dport 80 -j DNAT --to-destination 172.17.0.2:80
</code></pre>
    <p>
    ...
    <pre><code class="language-bash">docker network create --driver bridge new_bridge
</code></pre>
    <p>
...
docker0: flags=4163&lt;UP,BROADCAST,RUNNING,MULTICAST&gt;  mtu 1500
    ...
    <p>
     <a href="https://blog.csdn.net/meltsnow/article/details/94490994" title="Docker网络详解——原理篇_@Limerence的博客-CSDN博客_docker 网络">
      Docker网络详解——原理篇_@Limerence的博客-CSDN博客_docker 网络
     </a>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f7869616f6d696e67303031382f:61727469636c652f64657461696c732f313332303232323739" class_="artid" style="display:none">
 </p>
</div>
