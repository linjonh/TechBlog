...
categories: [python随笔]
tags: [教程,开发语言,python项目入门,python,pygame]
image:
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <div class="toc">
     ...
     <ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#01__25" rel="nofollow">
          01 选择合适的开发工具
         </a>
        </li>
        <li>
         <a href="#02__31" rel="nofollow">
          02 设置开发环境
         </a>
        </li>
       </ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#01__54" rel="nofollow">
          01 创建程序窗口
         </a>
        </li>
        <li>
         <a href="#02__67" rel="nofollow">
          02 改变窗口大小和颜色
         </a>
        </li>
        <li>
         <a href="#03__98" rel="nofollow">
          03 显示图像
         </a>
        </li>
       </ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#01__139" rel="nofollow">
          01 创建游戏场景
         </a>
        </li>
        <li>
         <a href="#02__143" rel="nofollow">
          02 创建游戏角色
         </a>
        </li>
       </ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#01__175" rel="nofollow">
          01 改变小球坐标
         </a>
        </li>
        <li>
         <a href="#02__191" rel="nofollow">
          02 游戏循环
         </a>
        </li>
       </ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#01__232" rel="nofollow">
          01 检测小球的位置
         </a>
        </li>
        <li>
         <a href="#02__248" rel="nofollow">
          02 让小球回到窗口内
         </a>
        </li>
       </ul>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/4b56b611cd93e1543456ece03d7d6407.webp?x-image-process=image/format,png#pic_center">
      <br/>
      图1 Mu编辑器的模式选择界面
     </img>
    </p>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/9344ffd7974c8173601091b5af65f2bd.webp?x-image-process=image/format,png#pic_center">
      <br/>
      图2 “Pygame Zero”运行模式
     </img>
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/e6864a6a61ca26679a098effeaf86e31.webp?x-image-process=image/format,png#pic_center">
      <br/>
      图3 游戏窗口界面
     </img>
    </p>
    ...
    <pre><code class="prism language-c">def <span class="token function">draw</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span>

    screen<span class="token punctuation">.</span><span class="token function">fill</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token number">255</span><span class="token punctuation">,</span> <span class="token number">255</span><span class="token punctuation">,</span> <span class="token number">255</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre>
    <p>
     保存并运行程序，可以看到如图4所示的界面。没错，我们的窗口背景变成了白色。
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/10dcedb4be06e9004cda20cd58819e18.png#pic_center">
      <br/>
      图4 改变背景颜色后的程序窗口
     </img>
    </p>
    ...
    <pre><code class="prism language-c">screen<span class="token punctuation">.</span><span class="token function">blit</span><span class="token punctuation">(</span><span class="token string">"breakout_ball"</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token number">200</span><span class="token punctuation">,</span> <span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre>
    <p>
    ...
    <pre><code class="prism language-c">WIDTH <span class="token operator">=</span> <span class="token number">500</span>

HEIGHT <span class="token operator">=</span> <span class="token number">300</span>

def <span class="token function">draw</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span>

    screen<span class="token punctuation">.</span><span class="token function">fill</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token number">255</span><span class="token punctuation">,</span> <span class="token number">255</span><span class="token punctuation">,</span> <span class="token number">255</span><span class="token punctuation">)</span><span class="token punctuation">)</span>

    screen<span class="token punctuation">.</span><span class="token function">blit</span><span class="token punctuation">(</span><span class="token string">"breakout_ball"</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token number">200</span><span class="token punctuation">,</span> <span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre>
    <p>
     现在运行程序，可以看到图5所示的程序界面，其中标示了图像的坐标值所代表的含义。
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/80b35c3944f45ea4d5a6397ed2118850.webp?x-image-process=image/format,png#pic_center">
      <br/>
      图5 显示图像的程序界面
     </img>
    </p>
    ...
    <pre><code class="prism language-c">ball <span class="token operator">=</span> <span class="token function">Actor</span><span class="token punctuation">(</span><span class="token string">"breakout_ball"</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token number">200</span><span class="token punctuation">,</span> <span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre>
    <p>
...
def <span class="token function">draw</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span>
    ...
    <pre><code class="prism language-c">def <span class="token function">update</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span>
    ...
    <pre><code class="prism language-c"><span class="token keyword">while</span> True<span class="token operator">:</span>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/8949e35a652163ab02b31523f46cf634.webp?x-image-process=image/format,png#pic_center">
      <br/>
      图6 游戏循环示意图
     </img>
    </p>
...
draw()
    ...
    <pre><code class="prism language-c"><span class="token keyword">if</span> ball<span class="token punctuation">.</span>right <span class="token operator">&gt;</span> WIDTH<span class="token operator">:</span>
    ...
    <span class="token keyword">if</span> ball<span class="token punctuation">.</span>right <span class="token operator">&gt;</span> WIDTH<span class="token operator">:</span>
    ...
    <pre><code class="prism language-c">WIDTH <span class="token operator">=</span> <span class="token number">800</span>                     

HEIGHT <span class="token operator">=</span> <span class="token number">600</span>                   

ball <span class="token operator">=</span> <span class="token function">Actor</span><span class="token punctuation">(</span><span class="token string">"breakout_ball"</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">,</span> <span class="token number">300</span><span class="token punctuation">)</span><span class="token punctuation">)</span>

def <span class="token function">update</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span>
...
def <span class="token function">draw</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/1a002cd12b5b9ceab518a9944023525f.webp?x-image-process=image/format,png#pic_center"/>
    </p>
   </div>
