...
description: "文章浏览阅读1.1w次，点赞8次，[root@hadoop data]# which java/us"
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <pre class="has"><code class="hljs language-bash">[root@hadoop data]# which java
/usr/bin/java
...
lrwxrwxrwx 1 root root 61 5月  13 15:27 /etc/alternatives/java -&gt; /usr/lib/jvm/java-11-openjdk-11.0.ea.28-7.el7.x86_64/bin/java
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f6131303130323536333430:2f61727469636c652f64657461696c732f3930323336373735" class_="artid" style="display:none">
 </p>
</div>
