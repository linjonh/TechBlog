...
date: 2023-05-17 13:28:03 +0800
categories: [STM32keil5应用]
tags: [嵌入式硬件,单片机,stm32,arm开发]
image:
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <div>
     <div>
      <div>
       <p class="img-center">
        <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/45482cd4ec0aadb722eecf1f02ed55ac.png" width="696"/>
       </p>
      </div>
     </div>
    </div>
    ...
    <div>
     <div>
      <div>
       <p class="img-center">
        <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/b8f91b99ee29fc29916f8d9d32a1de60.png" width="489"/>
       </p>
      </div>
     </div>
    </div>
    ...
    <div>
     <div>
      <div>
       <p class="img-center">
        <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/c28a3372e12aefce1bf95d28c130ef0d.png" width="481"/>
       </p>
      </div>
     </div>
    </div>
    ...
    <div>
     <div>
      <div>
       <p class="img-center">
        <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/1f7b2c09a2238f67601bdb4cf8fa7921.png" width="133"/>
       </p>
      </div>
     </div>
    </div>
    ...
    <div>
     <div>
      <div>
       <p class="img-center">
        <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/af50fb6461705da2112c8b8ac8cb0b68.png" width="195"/>
       </p>
      </div>
     </div>
    </div>
...
<code class="language-cpp">        struct Snake
        {
    ...
    <pre><code class="language-cpp">
<code class="language-cpp">        struct Food
        {
            u8 X;//食物横坐标
            u8 Y;//食物纵坐标
            u8 Yes;//食物标志位
    ...
    <pre><code class="language-cpp">
<code class="language-cpp">        struct Game
        {
            u16 Score;//分数
            u8 Life;//生命    
        }game;</code></code></pre>
    ...
    <div>
     <div>
      <div>
       <p class="img-center">
        <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/080886dbe4b7b2d9c2b97bb4676d8b8a.png" width="692"/>
       </p>
      </div>
     </div>
    </div>
    ...
    <pre><code class="language-cpp">
<code class="language-cpp">#include "system.h"
#include "SysTick.h"
#include "led.h"
#include "usart.h"
#include "time.h"
...
{    
  ...
  LCD_Clear(0xFD0F);
    ...
    <div>
     <div>
      <div style="text-align:center;">
       <img alt="" height="302" src="https://i-blog.csdnimg.cn/blog_migrate/a33d655abaa58b0d62605dee6f6d532f.png" width="498">
       </img>
      </div>
     </div>
    </div>
    ...
    <div>
     <div>
      <div style="text-align:center;">
       <img alt="" height="258" src="https://i-blog.csdnimg.cn/blog_migrate/7f0ec686de7516888e203681a3971339.png" width="500">
       </img>
      </div>
     </div>
    </div>
    ...
    <div>
     <div>
      <div style="text-align:center;">
       <img alt="" height="308" src="https://i-blog.csdnimg.cn/blog_migrate/de22c104c6ce43e5e8689a4306031c2f.png" width="497"/>
      </div>
     </div>
    </div>
    <p>
    ...
    <div>
     <div>
      <div>
       <p class="img-center">
        <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7ef2aecc9f02e451b06d212c73aaf595.png" width="502"/>
       </p>
      </div>
     </div>
    </div>
    ...
    <div>
     <div>
      <div>
       <img alt="" class="right" src="https://i-blog.csdnimg.cn/blog_migrate/6cff243a7622e3837009aedd89c9aa76.png" width="57"/>
      </div>
     </div>
    </div>
    <p>
