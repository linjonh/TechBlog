 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     下面来看下SH1106芯片的读写时序图
     <img alt="" height="470" src="https://i-blog.csdnimg.cn/blog_migrate/a5869370ab328e6364fbf8419aa49912.png" width="663"/>
    </p>
    <p>
    ...
    <p>
     这里的从机地址为0x78
     <img alt="" height="125" src="https://i-blog.csdnimg.cn/blog_migrate/23495ab4c7f2f79028d4d3018fd0209e.png" width="999"/>
    </p>
    <p>
...
<pre><code>UCB1CTL1 |= UCSWRST; // 软件复位 USCI
...
UCB1CTL1 &amp;= ~UCSWRST; // 清除复位</code></pre>
<p>
发送单个字节函数，这里没用中断的方式，用的查询法，可修改为中断法。
</p>
<pre><code>void oled_send_byte(unsigned char byte,unsigned char com)
{
...
<p>
<img alt="" height="376" src="https://i-blog.csdnimg.cn/blog_migrate/d481633054393c526f21c7acfc2dacd5.jpeg" width="620"/>
</p>
<p>
</p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f31393635343438392f:61727469636c652f64657461696c732f313234303830383337" class_="artid" style="display:none">
 </p>
</div>
