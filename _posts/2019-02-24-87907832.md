...
description: "文章浏览阅读3.摘要： 以“数字金融新原力(The New Force of Digital Fin"
keywords: "蚂蚁金服 技术平台"
categories: ['Atec']
tags: ['Mpaas']
artid: "87907832"
...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/eb7d38188a783cb5f8cb4e4672ea5ccd.png">
      <br/>
      <strong>
       张亮 蚂蚁金服高级产品专家
      </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/85a9923d7bcb52c1c79a4265d8a2692f.png"/>
    </p>
    <h3>
     <a id="mPaaS__25">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/c4b624c32248a479f4aad51518476f07.png"/>
    </p>
    <h3>
     <a id="mPaaS_30_36">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/7c795d1b92ea477f0138d1584d57edaf.png">
      <br/>
      <strong>
       蚂蚁业务的进化
      </strong>
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a91adc5025dbf2cd226e72832763094e.png">
       <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b702bbfd5311a56ee4e513b09494d93e.png">
      <br/>
      <strong>
       数据：自带数据源
      </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/8072287c58037b88d1309206a0818328.png">
      <br/>
      <strong>
       场景：一体化移动智能场景
      </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2804794312a240f52a00741efb52665b.png">
      <br/>
      <strong>
       轻量：客户端智能化解决方案
      </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/957982bc7e4420d3d16d867bcd126bbb.png"/>
     <br/>
     <strong>
      智能组件发布
     </strong>
    ...
    <ul>
     ...
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/8eb0d6c2b7769f75ca584ac8a114f5fc.png"/>
     </li>
    </ul>
    <h3>
     <a id="mPaaS_30_79">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/5bb0ef019a8f29b69bd297412d8ce251.png"/>
     <br/>
     <strong>
      框架-小程序标准开放框架
     </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/82a7b740a0df4a4cbc42382d615fb190.png"/>
     <br/>
     <strong>
      框架-扩展能力
     </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/0a702117374f8b25dbfbe7ad6ac09dd1.png"/>
     <br/>
     <strong>
      IDE-小程序包上传/发布
     </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/bf6e385238b141fa92dd02108ff45bbd.png"/>
     <br/>
     <strong>
      IDE-小程序真机测试/远程调试
     </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/5499e1a1d5f257b06e7ba74fe7aa164c.png"/>
     <br/>
     <strong>
      IDE-基于模板快速启动
     </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/3097d17ac49833d3a3814ed212175177.png"/>
     <br/>
     <strong>
      PaaS-小程序发布服务
     </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6ffdaed4b66afc20ca33aaa6daf44b1e.png"/>
     <br/>
     <strong>
      PaaS –小程序分析服务
     </strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/7d0e9e6578006e96fcf6799f6855dc22.png"/>
     <br/>
     以上就是mPaaS 3.0发布的所有内容。总之，蚂蚁金服实现了mPaaS的智能化升级，同时推出mPaaS小程序，能够帮助大家构建属于自己APP的生态。
     <br/>
     点击
     <a href="https://tech.antfin.com/articles?chInfo=zh" rel="nofollow">
      阅读更多
     </a>
     ，查看更多详情
    </p>
 ...
 <p alt="68747470733a2f2f626c6f67:2e6373646e2e6e65742f77656978696e5f3434333236353839:2f61727469636c652f64657461696c732f3837393037383332" class_="artid" style="display:none">
 </p>
</div>
