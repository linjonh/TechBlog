...
date: 2018-05-10 14:40:23 +0800
categories: []
tags: [java-jar,运行jar引入外部jar包]
image:
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre class="has"><code class="language-java">Main-Class: test.someClassName</code></pre>
    <p>
     <span style="color:#000000;">
    ...
    <pre class="has"><code class="language-java">java -classpath some.jar -jar test.jar</code></pre>
    <p>
     <span style="color:#000000;">
    ...
    <pre class="has"><code class="language-plain">java -Djava.ext.dirs=$JAVA_HOME/jre/lib/ext:/project/script/ -cp /project/script/ -Dlog4j.configuration=file:/project/script/log4j.properties com.galaxy.Comments 洛阳 /project/out/</code></pre>
    <p>
    ...
    <pre class="has"><code class="language-java">java -cp .;c:\dir1\lib.jar Test</code></pre>
    <p>
    ...
    <pre class="has"><code class="language-java">java -jar minusyhd.jar  
Manifest-Version: 1.0  
Main-Class: minusyhd.MinusYHD  
Class-Path: jconn4.jar </code></pre>
    <p>
     -cp 参数后面是类路径，是指定给解释器到哪里找到你的.class文件， 写法：
    </p>
    <pre class="has"><code class="language-java">java -cp .;myClass.jar packname.mainclassname</code></pre>
    <p>
    ...
    <pre class="has"><code class="language-java">java -cp MinusYHD.jar minusyhd.MinusYHD &gt; minusyhed.log  
exit</code></pre>
    <p>
    ...
    <p>
     <em>
      Reference：
      <a href="https://en.wikipedia.org/wiki/Classpath" rel="nofollow" title="Classpath - Wikipedia --- 类路径 - 维基百科">
       Classpath - Wikipedia --- 类路径 - 维基百科
      </a>
     </em>
    </p>
    <p>
    ...
    <pre class="has"><code class="language-java">Class-Path: lib/some.jar</code></pre>
    <p>
     <span style="color:#000000;">
    ...
    <pre class="has"><code class="language-java">Class-Path: lib/some.jar lib/some2.jar</code></pre>
    <p>
     <span style="color:#000000;">
    ...
    <p>
     ...
     <a href="http://cuixiaodong214.blog.163.com/blog/static/951639820099135859761" rel="nofollow" title="这篇">
      这篇
     </a>
     <a href="http://cuixiaodong214.blog.163.com/blog/static/951639820099135859761" rel="nofollow" title="http://cuixiaodong214.blog.163.com/blog/static/951639820099135859761">
    ...
    <p>
     <span style="color:#000000;">
      <a href="http://www.cnblogs.com/adolfmc/archive/2012/10/07/2713562.html" rel="nofollow" title="java命令执行jar包的方式">
       java命令执行jar包的方式
      </a>
     </span>
    </p>
    <p>
     <span style="color:#000000;">
      <a href="http://hck.iteye.com/blog/1566801" rel="nofollow" title="java -cp 命令介绍">
       java -cp 命令介绍
      </a>
     </span>
    </p>
    <p>
     <span style="color:#000000;">
      <a href="https://blog.csdn.net/lamp113/article/details/79176410" title="jar命令图解">
       jar命令图解
      </a>
     </span>
    </p>
...
<p class="artid" style="display:none">6874747073:3a2f2f626c6f672e6373646e2e6e65742f7734375f6373646e:2f61727469636c652f64657461696c732f3830323534343539</p>
