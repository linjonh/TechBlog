...
date: 2022-07-22 13:42:35 +0800
description: "文章浏览阅读3.Introduction介绍Inspired by the article \"Emb"
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <h3 style="font-family:Verdana,Arial,sans-serif; font-size:13pt; color:rgb(255,153,0)">
     Introduction
    </h3>
    <h3 style="font-family:Verdana,Arial,sans-serif; font-size:13pt; color:rgb(255,153,0)">
     介绍
    ...
    <p style="font-family:Verdana,Arial,sans-serif; font-size:14px">
     ...
     <a href="http://www.linuxjournal.com/article/3641" rel="nofollow noopener noreferrer" style="text-decoration:none; color:purple" target="_blank">
      Linux Journal
     </a>
    ...
    <ol style="font-family:Verdana,Arial,sans-serif; font-size:14px">
    ...
    <p style="font-family:Verdana,Arial,sans-serif; font-size:14px">
     ...
     <a href="http://www.codeproject.com/cpp/embedpython_2.asp" rel="nofollow" style="text-decoration:none; color:purple">
    ...
    <p style="font-family:Verdana,Arial,sans-serif; font-size:14px">
     ...
     <a href="http://www.python.org/" rel="nofollow noopener noreferrer" style="text-decoration:none; color:purple" target="_blank">
      website
     </a>
     .
    </p>
    ...
    <pre><code class="language-cpp">// call_function.c - A sample of calling 
...
int main(int argc, char *argv[])
{
    ...
    <span style="font-family:Verdana,Arial,sans-serif; font-size:14px">
    ...
    <pre><code class="language-cpp">'''py_function.py - Python source designed to '''
...
def multiply():
    ...
    <pre><code class="language-cpp">The result of 12345 x 6789 : 83810205</code></pre>
    <p>
    </p>
    <p style="font-family:Verdana,Arial,sans-serif; font-size:14px">
    ...
    <ul style="font-family:Verdana,Arial,sans-serif; font-size:14px">
     <li style="font-size:10pt">
    ...
    <pre><code class="language-cpp">if (PyCallable_Check(pFunc)) 
{
    ...
    <pre><code class="language-cpp">The result of 6 x 7 : 42
Return of call : 42</code></pre>
    <br/>
    <span style="font-family:Verdana,Arial,sans-serif; font-size:14px">
    ...
    <pre><code class="language-cpp">// call_class.c - A sample of python embedding 
...
int main(int argc, char *argv[])
{
    ...
    <pre><code class="language-cpp">'''py_class.py - Python source designed to demonstrate''' 
...
class Multiply: 
    ...
    <pre><code class="language-cpp">// call_thread.c - A sample of python embedding 
...
void ThreadProc( void *data )
{
    ...
    <pre><code class="language-cpp">Printed from the main thread.
...
Main thread finished gracefully.</code></pre>
    <br/>
    <span style="font-family:Verdana,Arial,sans-serif; font-size:14px">
    ...
    <br/>
    <pre><code class="language-cpp">''' Demonstrate the use of python threading'''
...
def createThread():
    ...
    print  'The program completed gracefully.'</code></pre>
    <br/>
    <p style="font-family:Verdana,Arial,sans-serif; font-size:14px">
...
printf("Program completed gracefully.\n");</code></pre>
    ...
    <code lang="c++" style="color:rgb(153,0,0); font-family:'Courier New',Courier,mono; font-size:11pt">
     while
    </code>
    <span style="font-family:Verdana,Arial,sans-serif; font-size:14px">
    ...
    <a href="http://www.python.org/doc/2.4.2/lib/thread-objects.html" rel="nofollow noopener noreferrer" style="text-decoration:none; color:purple; font-family:Verdana,Arial,sans-serif; font-size:14px" target="_blank">
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f414d5749484948:432f61727469636c652f64657461696c732f37363933383835" class_="artid" style="display:none">
 </p>
</div>
