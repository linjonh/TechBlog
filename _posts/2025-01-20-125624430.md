 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-tomorrow-night" id="content_views">
    ...
    <pre><code class="prism language-python"><span class="token keyword">with</span> <span class="token builtin">open</span><span class="token punctuation">(</span><span class="token string">"1.txt"</span><span class="token punctuation">,</span> <span class="token string">'r'</span><span class="token punctuation">)</span> <span class="token keyword">as</span> f<span class="token punctuation">:</span>
...
<span class="token keyword">finally</span><span class="token punctuation">:</span>
    ...
    <pre><code class="prism language-python"><span class="token number">1.</span> 上下文表达式：<span class="token keyword">with</span> <span class="token builtin">open</span><span class="token punctuation">(</span><span class="token string">'test.txt'</span><span class="token punctuation">)</span> <span class="token keyword">as</span> f<span class="token punctuation">:</span>
<span class="token number">2.</span> 上下文管理器：<span class="token builtin">open</span><span class="token punctuation">(</span><span class="token string">'test.txt'</span><span class="token punctuation">)</span>
<span class="token number">3.</span> f是上下文管理器返回的资源对象
<span class="token number">4.</span> <span class="token keyword">with</span>关键字表示使用上下文管理器
</code></pre>
    <p>
    ...
    <p>
     类实现的上下文管理器的例子：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/3d684977db76b0bd9cc83fd78ece119d.png">
      <br/>
      代码执行的过程：
     </img>
    </p>
    <ol>
     ...
     <li>
      方法enter()被调用，文件test.txt以写入的模式被打开，并且返回资源对象赋给变量f
     </li>
     <li>
      字符串“hello world”被写入文件test.txt
     </li>
     <li>
      方法exit()被调用，负责关闭之前打开的文件流
     </li>
    </ol>
    <p>
     方法“
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/d92e00223ef263c2311bcc20ca0bdbee.png">
      <br/>
    ...
    <p>
     其他讲解python上下文管理器的文章：
     <br/>
     <a href="https://www.jianshu.com/p/20fd3335648a" rel="nofollow">
      https://www.jianshu.com/p/20fd3335648a
     </a>
     <br/>
     <a href="https://www.liaoxuefeng.com/wiki/1016959663602400/1017607179232640" rel="nofollow">
      https://www.liaoxuefeng.com/wiki/1016959663602400/1017607179232640
     </a>
     <br/>
     <a href="https://blog.csdn.net/Kwoky/article/details/106682609">
     ...
     <br/>
     <a href="https://www.runoob.com/python3/python-with.html" rel="nofollow">
      https://www.runoob.com/python3/python-with.html
     </a>
     <br/>
     <a href="https://www.cnblogs.com/wongbingming/p/10519553.html" rel="nofollow">
      https://www.cnblogs.com/wongbingming/p/10519553.html
     </a>
     <br/>
     <a href="https://juejin.cn/post/6993180184178327582" rel="nofollow">
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33383034383735362f:61727469636c652f64657461696c732f313235363234343330" class_="artid" style="display:none">
 </p>
</div>
