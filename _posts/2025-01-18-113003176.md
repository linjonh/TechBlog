...
<div class="blog-content-box">
   ...
   <div class="markdown_views prism-tomorrow-night" id="content_views">
    ...
    <blockquote>
     <p>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/9dc14b313ff110bbf9a7efa0960f8cde.png"/>
     </p>
    </blockquote>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/9269eabeaea3314bc831a90078a35413.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a134c02783c42b18fa426fb9e1739d3e.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/08cc5d031fa3907620baa0b5b14c66e5.png"/>
    </p>
    <p>
     选择Maven Module
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6d78854f6b465b903fbc81c65e7609cc.png"/>
    </p>
    <p>
     填写一个工程名称。
    </p>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/bbfd077721860eb6dac61710d75aac3f.png"/>
    </p>
    <p>
     之后，我们需要在java工程中引入相关依赖，以maven为例，pom文件增加如下部分：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/274ef13478c078ad8059e8bc3d27da5c.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/269c937536d8156a794167a97a4b5156.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a01e0967574497b942d4b4034be45bda.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/e2c00e25f734aafdb1be18619e531e55.png"/>
    </p>
    <p>
     通过上述操作后，我们每次发布程序时，Jenkins除了自动构建发布程序外，还会通过maven命令自动执行对应的Junit测试程序，并在每次构建的任务显示测试结果。测试结果图示例如下：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/8b75be269620d0a4f2dd08516970db21.png"/>
    </p>
    <p>
     通过邮件配置，可将测试结果等情况以邮件形式发送给相关技术人员，配置信息如下。
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b779d9435aee9a92d146314bdf4e5196.png"/>
    </p>
    <p>
     三、小结
    </p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/d972902b9cfc4ef5e9795c4ba6fa0a3d.png"/>
     <br/>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f35323636383837342f:61727469636c652f64657461696c732f313133303033313736" class_="artid" style="display:none">
 </p>
</div>
