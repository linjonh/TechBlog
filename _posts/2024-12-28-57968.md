...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <a href="http://dev.mysql.com/get/Downloads/MySQL-4.0/mysql-4.0.20d-win.zip/from/pick#mirrors">
      http://dev.mysql.com/get/Downloads/MySQL-4.0/mysql-4.0.20d-win.zip/from/pick#mirrors
     </a>
    </p>
    <p>
     选择一个windows下面用的mysql安装程序下载。这里使用：
     <a href="http://dev.mysql.com/get/Downloads/MySQL-4.0/mysql-4.0.20d-win.zip/from/http://mysql.linuxforum.net/">
    ...
    <p>
     <a href="http://dev.mysql.com/get/Downloads/Connector-J/mysql-connector-java-3.0.14-production.zip/from/pick">
    ...
    <p>
     <a href="http://dev.mysql.com/get/Downloads/Connector-J/mysql-connector-java-3.0.14-production.zip/from/http://mysql.linuxforum.net/">
 ...
 <p alt="68747470733a2f2f626c6f672e6373646e2e6e65742f68:6168752f61727469636c652f64657461696c732f3537393638" class_="artid" style="display:none">
 </p>
</div>
