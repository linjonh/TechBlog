...
while True:     #循环恒真时执行下列语句
    ...
    i+=1		#当前a=5,b=7，i循环35圈</code></pre>
    <pre><code class="language-python">#法2：
a=int(input('请输入一个数：'))
b=int(input('请输入一个数：'))
i=0
while 1:
    ...
    <pre><code class="language-python">x=int(input('请输入一个数：'))
y=int(input('请输入一个数：'))
lcm=x*y    #lcm是最小公倍数
while x%y!=0:   #辗转相除法
    t=x%y
...
gcd=y  #gcd是最小公约数
lcm=lcm // gcd
print('最大公约数：',gcd,'最小公倍数：',lcm)</code></pre>
    <p>
     例3：用户在键盘输入一个四位数整数，需要转换为英文单词输出，如：输入1024，One Zero Two Four
    </p>
    <pre><code class="language-python">t=1000
...
if num&gt;=1000 and num&lt;10000:
   ...
   #整数由左向右拆分</code></pre>
    ...
    <pre><code class="language-python">a1=1
a2=1
for i in range(6):
    print(a1,a2,end=' ')
    a1=a1+a2
...
#当前项等于前两项之和</code></pre>
    ...
    <pre><code class="language-python">t=int(input("请输入一个正整数："))
a1=0
a2=1
a3=1
while a3&lt;=t:
    ...
    a2=a3
    a3=a1+a2
print('大于',t,'的Fibonacci数列中的最小值是：',a3)</code></pre>
    <p>
...
print('偷桃总数：',n)</code></pre>
    ...
    <p>
     <img alt="" height="236" src="https://i-blog.csdnimg.cn/blog_migrate/e0e9fb97d032e979c45d712f42d96459.png" width="217"/>
    </p>
    <p>
    </p>
    <pre><code class="language-python">h=int(input('请输入图形高度：'))
for i in range(4):
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f36343331313432312f:61727469636c652f64657461696c732f313237343031313434" class_="artid" style="display:none">
 </p>
</div>
