   ...
   <div class="htmledit_views" id="content_views">
    <h3 class="article-title" style="">
     <span style="font-size:18px">
      <span style="outline:0px; text-decoration:none; color:rgb(65,131,196)">
       云平台之多租户
      </span>
     </span>
    </h3>
    <div class="content-reset" style="">
     ...
     <h4 style="margin:0.6em 0px; font-size:16px">
      <span style="font-size:18px">
       什么是租户
      </span>
     </h4>
     <p style="margin:1em 0px">
      <span style="font-size:18px">
       ...
       <a href="http://wiki.mbalib.com/wiki/%E5%AE%A2%E6%88%B7" rel="nofollow noopener noreferrer" style="outline:0px; text-decoration:none; color:rgb(65,131,196)" target="_blank">
        客户
       </a>
     ...
     <ul style="margin:5px 0px 5px 20px; padding:0px">
      <li>
       <span style="font-size:18px">
     ...
     <h5 style="margin:0.6em 0px; font-size:14px">
      <span style="font-size:18px">
       多租户场景举例
      </span>
     </h5>
     ...
     <p style="margin:1em 0px">
      <span style="font-size:18px">
       在不支持多租户的环境中，为了隔离每个用户的数据，至少我们在设计数据库表时会考虑大多数表都存在一个 user_id 字段，用于
       <em>
        CRUD
       </em>
       数据时使用该字段进行
     ...
     <ol style="margin:5px 0px 5px 20px; padding:0px">
      <li>
       <span style="font-size:18px">
        CRUD：这是业务逻辑实现的一部分
       </span>
     ...
     <p style="margin:1em 0px">
      <span style="font-size:18px">
       多租户支持从实现的角度看，“
       <a href="http://zh.wikipedia.org/wiki/%E5%A4%9A%E7%A7%9F%E6%88%B7" rel="nofollow noopener noreferrer" style="outline:0px; text-decoration:none; color:rgb(65,131,196)" target="_blank">
        是一种软件架构技术
       </a>
     ...
     <p style="margin:1em 0px">
      <span style="font-size:18px">
       ...
       <a href="http://www.ibm.com/developerworks/cn/cloud/library/cl-tenantconversion/" rel="nofollow noopener noreferrer" style="outline:0px; text-decoration:none; color:rgb(65,131,196)" target="_blank">
        将单租户应用程序转换为多租户应用程序
       </a>
       ）。
      </span>
     ...
     <p style="margin:1em 0px">
      <span style="font-size:18px">
       <a class="fancybox" href="https://i-blog.csdnimg.cn/blog_migrate/a3c31d99e315d9a5a5053f77237af3d3.png" rel="nofollow noopener noreferrer" style="outline:0px; text-decoration:none; color:rgb(65,131,196)" target="_blank">
        <img alt="多租户云平台设计" height="720" src="https://i-blog.csdnimg.cn/blog_migrate/a3c31d99e315d9a5a5053f77237af3d3.png" style="max-width:100%; vertical-align:middle; border:0px" width="960"/>
       </a>
      </span>
     </p>
     <p style="margin:1em 0px">
...
<p class="artid" style="display:none">68747470:733a2f2f626c6f672e6373646e2e6e65742f6c697368656865:2f61727469636c652f64657461696c732f3434373738303437</p>
