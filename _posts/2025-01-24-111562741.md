...
pygame<span class="token punctuation">.</span>init<span class="token punctuation">(</span><span class="token punctuation">)</span>  <span class="token comment">#初始化init() 及设置</span>
...
Color(rgbvalue) 例如：Color("#BEBEBEFF")
    ...
    <pre><code>pygame.Color.r   获得Color类的红色值r
...
size  字体大小
    ...
    <pre><code>• surf 绘制字体的平面，Surface对象
• dest 在平面中的具体位置，(x,y)
• text 绘制的文字内容
• fgcolor 文字颜色
• bgcolor 背景颜色
