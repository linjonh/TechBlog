 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-XML">export SPRING_AI_AZURE_OPENAI_API_KEY=&lt;INSERT KEY HERE&gt;
export SPRING_AI_AZURE_OPENAI_ENDPOINT=&lt;INSERT ENDPOINT URL HERE&gt;</code></pre>
    ...
    <pre><code class="language-XML">spring.ai.azure.openai.chat.options.deployment-name=&lt;my deployment name&gt;</code></pre>
    <p>
...
&lt;/dependency&gt;</code></pre>
    ...
    <p>
     A
     <a class="link-info" href="https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-azure-openai/src/main/java/org/springframework/ai/azure/openai/AzureOpenAiChatOptions.java" title="zureOpenAiChatOptions.java">
      zureOpenAiChatOptions.java
     </a>
    ...
    <pre><code class="language-XML">spring.ai.azure.openai.api-key=YOUR_API_KEY
spring.ai.azure.openai.endpoint=YOUR_ENDPOINT
spring.ai.azure.openai.chat.options.deployment-name=gpt-35-turbo
spring.ai.azure.openai.chat.options.temperature=0.7</code></pre>
    <p>
...
<pre><code class="language-java">var openAIClient = new OpenAIClientBuilder()
...
new Prompt("生成 5 个著名海盗的名字。"));</code></pre>
<p>
...
<pre><code class="language-java">AzureOpenAiChatModel chatModel = ...
...
<pre><code class="language-java">Here is the current weather for the requested cities:
...
代码演示后期补充
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f32353133373133312f:61727469636c652f64657461696c732f313339343131323331" class_="artid" style="display:none">
 </p>
</div>
