...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-kimbie-light" id="content_views">
    ...
    <h4 id="今天的目标是有4台linux的服务器架设一个小规模的集群">
    ...
    <blockquote>
     <p>
      ...
      <br/>
      <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812141730118" title="">
       （图1）
      </img>
     </p>
    </blockquote>
    <p>
     <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812141834026" title="">
      （图2）
     </img>
    </p>
    <p>
    ...
    <blockquote>
     ...
     <p>
      ...
      <br/>
      <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812161511701" title=""/>
     </p>
    </blockquote>
    <p>
     <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812161522698" title=""/>
    </p>
    <blockquote>
     <p>
      11、我们看到 .ssh 的隐藏文件 我们cd进入.ssh 执行命令
      <br/>
      .ssh$ ls 会出现id_rsa 还有一个id_rsa pub
      <br/>
      <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812161913814" title="">
       <br/>
       12、我们使用scp 命令把私钥传输给 T1 P1 DB1
       <br/>
       <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812161810421" title="">
        <br/>
        在其他服务器中依次都要创建公钥私钥
       </img>
      </img>
     ...
     <p>
      13、我们把id _rsa.pub 这个文件&gt;&gt; 重定向到 authorized_keys
      <br/>
     ...
     <p>
      ...
      ssh caoyuan@DB1
      <br/>
      15、接着把其他服务器的密码登陆关闭(T1 P1 DB1),在etc 下面的 sshd_config 文件 我们去配置这个文件 找到一个52行的yes 该为 no 然后重启 使用远程登陆，然后连接不上我们就成功了
      <br/>
      cd /etc/ssh/
      <br/>
      <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812165259811" title=""/>
     </p>
    </blockquote>
    <p>
     <img alt="这里写图片描述" src="https://img-blog.csdn.net/20160812165406452" title=""/>
    </p>
    <blockquote>
     <p>
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f63616f70656e673236:2f61727469636c652f64657461696c732f3532313836383136" class_="artid" style="display:none">
 </p>
</div>
