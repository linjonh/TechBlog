...
layout: post
title: "前端安全敏感信息泄露"
date: 2024-12-21 14:39:01 +0800
description: "文章浏览阅读1.5k次，点赞23次，通过调用后端 API 接口动态获取敏感数据，避免将敏感信息硬编码"
...
&lt;/script&gt;
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/55200516da8a4f8db070fc11ebac2eac.png#pic_center"/>
    </p>
    <h4>
     <a id="_33">
     </a>
...
&lt;/script&gt;
    ...
    <blockquote>
     <p>
      ...
      <br/>
      接口加解密参考文档:
      <a href="https://blog.csdn.net/a123456234/article/details/132348541spm=1001.2014.3001.5501">
       前端使用 crypto-js 库 aes加解密
      </a>
     </p>
    </blockquote>
    <h5>
     <a id="2__webpackobfuscator__73">
     </a>
     2. 使用
     <code>
      webpack-obfuscator
     </code>
     插件对代码进行混淆，使原始代码变得难以阅读和理解，从而避免了信息泄露
    </h5>
    <p>
     <strong>
      安装
    ...
    <pre><code>npm install webpack-obfuscator@2.6.0 javascript-obfuscator@3.2.7 --save-dev
# 或者
yarn add webpack-obfuscator@2.6.0 javascript-obfuscator@3.2.7 --dev
    ...
    <pre><code>const ObfuscatorPlugin = require('webpack-obfuscator');
...
module.exports = defineConfig({
    ...
    <blockquote>
     <p>
      ...
      插件详细配置以及一些注意事项:
      <a href="https://blog.csdn.net/a123456234/article/details/140911695spm=1001.2014.3001.5501">
       https://blog.csdn.net/a123456234/article/details/140911695?spm=1001.2014.3001.5501
      </a>
     </p>
    </blockquote>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/833112d36a6847beae0166890f496f38.png#pic_center"/>
    </p>
    <h5>
     <a id="3__134">
     </a>
    ...
    <pre><code>VUE_APP_USER_LIST='Z张三,L李四,W王五,Z赵六,S孙七,Z周八'
</code></pre>
    <p>
     项目中使用
    </p>
...
&lt;/script&gt;
    ...
    <p>
     实现效果
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7acb0679bc2d4dfaa96dbf7adfcb8922.png#pic_center"/>
    </p>
    <h4>
     <a id="_175">
     </a>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37343832353532362f:61727469636c652f64657461696c732f313434363331303832" class_="artid" style="display:none">
 </p>
</div>
