    ...
    <div class="toc">
     ...
     <ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#31_1_56" rel="nofollow">
          3.1 测试1-路径已经存在
         </a>
        </li>
        <li>
         <a href="#32_2_123" rel="nofollow">
          3.2 测试2-路径不存在
         </a>
        </li>
        <li>
         <a href="#32__196" rel="nofollow">
          3.2 创建不存在的路径并新建文件
         </a>
        </li>
        <li>
         <a href="#33__301" rel="nofollow">
          3.3 删除已存在的文件并新建
         </a>
        </li>
       </ul>
    ...
    <table>
     <thead>
      <tr>
       ...
       <th>
        fileName，就如我们在电脑中看到的.txt、.java、.doc等
       </th>
      </tr>
     </thead>
     <tbody>
      ...
      <tr>
       ...
       <td>
        directoryPath，有绝对路径和相对路径，这个不需要多说，但需要注意的是，如果想把win11电脑上已经存在的路径用来创建File实例，需要注意加转义符
       </td>
      </tr>
     </tbody>
    </table>
...
class FileTest1{
    ...
    <p>
     <font color="blue">
      测试结果如下
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/38355fd6c21c6587cd058780229db261.png"/>
     </font>
    </p>
    <h3>
     <a id="32__196">
...
class FileTest1{
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f34353639353839382f:61727469636c652f64657461696c732f313239323132373238" class_="artid" style="display:none">
 </p>
</div>
