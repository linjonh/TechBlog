  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
     ...
     <span style="font-weight:bold">
      <span style="font-size:18px">
       <span style="font-family:Microsoft YaHei">
        <span style="color:rgb(157,195,230)">
         别被文章长度吓到，学会博弈(SG)
        </span>
        <span style="color:rgb(102,204,204); background-color:rgb(255,255,255)">
         只用看前1/10。
        </span>
       </span>
      </span>
     ...
     <span style="font-weight:bold">
      <span style="color:#9DC3E6">
       <span style="font-size:18px">
        <span style="font-family:Microsoft YaHei">
         另附上我手敲的
         <a href="http://blog.csdn.net/strangedbly/article/details/51133186" rel="noopener noreferrer" target="_blank">
          精简版
         </a>
         。
         <img alt="抓狂" src="http://static.blog.csdn.net/xheditor/xheditor_emot/default/crazy.gif"/>
        </span>
       </span>
      </span>
     </span>
    ...
    <p>
     <span style="font-size:18px">
      <span style="font-family:Microsoft YaHei">
       <img alt="" src="https://img-blog.csdn.net/20160412213456924?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center"/>
      </span>
     </span>
    </p>
    <p>
    ...
    <p>
     <span style="color:#70AD47">
      <span style="font-size:18px">
       <span style="font-family:Microsoft YaHei">
        <img alt="" src="https://img-blog.csdn.net/20160412213606085"/>
       </span>
      </span>
     </span>
    </p>
    ...
    <pre><code class="language-cpp">//f[]：可以取走的石子个数
//sg[]:0~n的SG函数值
//hash[]:mex{}
int f[N],sg[N],hash[N];     
void getSG(int n)
...
int SG_dfs(int x)
{
    ...
    <h4 class="t" style="margin:0px 0px 1px; padding:0px; list-style:none">
     <span style="font-size:18px">
      <a href="http://acm.hust.edu.cn/vjudge/contest/view.action?cid=112620#problem/G" rel="nofollow noopener noreferrer" target="_blank">
       LightOJ 1315
      </a>
      <span style="color:rgb(51,51,51); font-family:Arial,Helvetica,sans-serif; font-size:18px; line-height:1.54">
       <strong>
        <a href="http://acm.hust.edu.cn/vjudge/contest/view.action?cid=112620#problem/G" rel="nofollow noopener noreferrer" target="_blank">
      ...
      <span style="color:rgb(51,51,51); font-family:Arial,Helvetica,sans-serif; font-size:18px; font-weight:normal; line-height:1.54; text-align:center">
       此题打表不好处理，只好DFS。
      </span>
     </span>
    </h4>
    ...
    <pre><code class="language-cpp">&lt;span style="font-family:Microsoft YaHei;"&gt;&lt;span style="font-size:18px;"&gt;var
...
begin
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f737472616e676564626c79:2f61727469636c652f64657461696c732f3531313337343332" class_="artid" style="display:none">
 </p>
</div>
