 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     <img alt="全局搜索示例" src="https://i-blog.csdnimg.cn/blog_migrate/9a6dad31400f30a95a9816c8c1d0e93a.png"/>
    </p>
    <h5>
     <a id="_19">
     </a>
    ...
    <ul>
     <li>
      ...
      重启窗口）。
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7d80e6e106394e1fbc53a536d3fbada4.png"/>
     </li>
    </ul>
    <h4>
     <a id="2___55">
    ...
    <ul>
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c2c9173747db4e6185854e86f89047c4.png"/>
     </li>
    </ul>
    <h4>
     <a id="3___63">
    ...
    <ul>
     <li>
      ...
      ，回车后将会跳转到文件的第 45 行。
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0ce5f5092f8e4ad5b0d954d3adb88c34.png"/>
     </li>
    </ul>
    <hr/>
    <h3>
    ...
    <ul>
     ...
     <li>
      添加如下配置，排除特定文件夹：
      <pre><code class="prism language-json"><span class="token string-property property">"search.exclude"</span><span class="token operator">:</span> <span class="token punctuation">{<!-- --></span>
...
<span class="token punctuation">}</span>
    ...
    <ul>
     <li>
      ...
      中是否有以下配置：
      <pre><code class="prism language-json"><span class="token string-property property">"files.exclude"</span><span class="token operator">:</span> <span class="token punctuation">{<!-- --></span>
    <span class="token string-property property">"**/ignored_folder"</span><span class="token operator">:</span> <span class="token boolean">true</span>
<span class="token punctuation">}</span>
</code></pre>
      确保你要搜索的文件或目录没有被排除。
     </li>
