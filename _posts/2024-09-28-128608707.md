 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/b7a391f5cc6e3e6929cc2e0b456a79ee.png"/>
    </p>
    <p id="u3e3bf2d1">
     从上图可以看出，UCOSII 的移植，
     <strong>
      我们只需要修改：os_cpu.h、os_cpu_a.asm 和 os_cpu.c等三个文件即可。
     </strong>
    </p>
    <ul>
     <li id="ucdb26c68">
    ...
    <p id="u157438d7">
     ...
     。这个时钟节拍由 OS_TICKS_PER_SEC（在 os_cfg.h 中定义）设置，一般我们设置 UCOSII 的系统时钟节拍为 1ms~100ms，具体根据你所用处理器和使用需要来设置。
    </p>
    <h2 id="NBrau">
     支持多少任务？
    </h2>
    ...
    <pre><code class="language-cpp">void MyTask (void *pdata)
{ 
    任务准备工作…
    While(1)//死循环
    { 任务 MyTask 实体代码;
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/039c4f6a27bdf77532b2c7c4cb159f9b.png"/>
    </p>
    <ol>
     <li id="u08fe7e8c">
    ...
    <pre><code class="language-cpp">OSTaskCreate(void(*task)(void*pd), void*pdata, OS_STK*ptos, INTU prio)。</code></pre>
    <p id="ua28d5844">
     该函数包括 4 个参数：
    </p>
    <ul>
    ...
    <pre><code class="language-cpp">INT8U OSTaskDel(INT8U prio)；</code></pre>
    <p id="ubfcac4a6">
    ...
    <pre><code class="language-cpp">INT8U OSTaskDelReq(INT8U prio)；</code></pre>
    <p id="ub5983f9c">
     同样还是通过优先级来确定被请求删除任务。
    </p>
    <h3 id="EdXFv">
    ...
    <pre><code class="language-cpp">INT8U OSTaskChangePrio(INT8U oldprio, INT8U newprio)；</code></pre>
    <h3 id="FYonO">
     任务挂起函数
    </h3>
    <p id="u41bdfca7">
    ...
    <pre><code class="language-cpp">INT8U OSTaskSuspend(INT8U prio)；</code></pre>
    <h3 id="HMz3p">
     任务恢复函数
    </h3>
    <p id="u343d3ffb">
    ...
    <pre><code class="language-cpp">INT8U OSTaskResume(INT8U prio)；</code></pre>
    <h3 id="dD4FB">
     <strong>
      任务信息查询
     </strong>
    ...
    <pre><code class="language-cpp">INT8U OSTaskQuery(INT8U prio,OS_TCB *pdata);</code></pre>
    <p id="u92f8e38b">
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34333832343138382f:61727469636c652f64657461696c732f313238363038373037" class_="artid" style="display:none">
 </p>
</div>
