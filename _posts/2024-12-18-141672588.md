 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" height="462" id="udb6356dc" src="https://i-blog.csdnimg.cn/blog_migrate/46a004f846e9ced0c45b643022970c19.png" width="818"/>
    </p>
    <h4 id="lizrs">
     3.正向代理和反向代理的区别
    </h4>
    ...
    <p class="img-center">
     <img alt="" height="335" id="u3da6fe75" src="https://i-blog.csdnimg.cn/blog_migrate/fc30e52131bf718dbb9cbd3424f4f5b8.png" width="818"/>
    </p>
    <p id="u44875a56">
    ...
    <p class="img-center">
     <img alt="" height="928" id="u88e797c8" src="https://i-blog.csdnimg.cn/blog_migrate/4bcee20d5870750550192860b1a31e9f.png" width="939"/>
    </p>
    <h4 id="6a046bb4">
     4.常用的集群软件
    </h4>
    ...
    <pre id="W2p2Q"><code>vim /etc/nginx/conf.d/pass_server.conf
# 反向代理配置
server {
  listen      80;
  ...
  location / {
    ...
    <pre id="NJ7dn"><code># 后台服务端的配置：40机器
...
输入：192.168.137.40</code></pre>
    ...
    <p class="img-center">
     <img alt="" height="323" id="u665221fe" src="https://i-blog.csdnimg.cn/blog_migrate/2ee9cae2728aa8f307ec337789ab29cd.png" width="1200"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34333630363533362f:61727469636c652f64657461696c732f313431363732353838" class_="artid" style="display:none">
 </p>
</div>
