 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre class="has"><code class="language-html">  //基本的轮播图框架
  ...
  &lt;/swiper&gt;</code></pre>
    ...
    <pre class="has"><code class="language-css">//自己设计的样式
.swiper-block {
  height: 480rpx;
  width: 100%;
...
export default class Base{   //父类Base
  ...
  request(promer, callBack) {     //传入数据类, 返回函数
    ...
    <pre class="has"><code class="language-javascript">import Base from "../..//utils/Base.js"     //链接Base.js
...
Page({
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f537472617762657272795f353935:2f61727469636c652f64657461696c732f3833343735373337" class_="artid" style="display:none">
 </p>
</div>
