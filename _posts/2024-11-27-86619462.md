   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p style="margin-left:0cm;">
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#333333;">
        <a href="http://www.studa.net/pc/" rel="nofollow">
         <span style="color:#333333;">
          计算
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#333333;">
        <a href="http://www.studa.net/network/" rel="nofollow">
         <span style="color:#333333;">
          网络
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#333333;">
        <a href="http://www.studa.net/fazhan/" rel="nofollow">
         <span style="color:#333333;">
          发展
         </span>
        </a>
    ...
    <p style="margin-left:0cm;">
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#333333;">
        <a href="http://www.studa.net/lixue/" rel="nofollow">
         <span style="color:#333333;">
          自然
         </span>
        </a>
    ...
    <p style="margin-left:0cm;">
     <a name="_Toc310778930">
     </a>
     <a name="_Toc2109">
     </a>
     <a name="_Toc296410661">
     </a>
     <a name="_Toc296410548">
     </a>
     <a name="_Toc296410251">
      1.2
     </a>
     大论文的目标
    </p>
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="510" src="https://i-blog.csdnimg.cn/blog_migrate/85fe76471e3a3b328cfb553005586293.png" width="823"/>
    </p>
    <p style="margin-left:0cm;">
    </p>
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="487" src="https://i-blog.csdnimg.cn/blog_migrate/9540b57929050180f71aaa280f7edb4f.png" width="1200"/>
    </p>
    <p style="margin-left:0cm;">
     由抓包结果可知 IP包 红框内 灰色部分
    </p>
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="197" src="https://i-blog.csdnimg.cn/blog_migrate/79db7d1f9837d8b693bf4176fa6cde7a.png" width="580"/>
    </p>
    <p style="margin-left:0cm;">
     <span style="color:#000000;">
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="612" src="https://i-blog.csdnimg.cn/blog_migrate/7c1d47c12569774a7a8f8951bc27155f.png" width="1200"/>
    </p>
    <p style="margin-left:0cm;">
     抓包结束后 可以获得TCP头
    </p>
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="266" src="https://i-blog.csdnimg.cn/blog_migrate/a6676dfee22dfc87ea1af41be5730dc7.png" width="625"/>
    </p>
    <p style="margin-left:0cm;">
     根据TCP头结构对获得的TCP头进行分析
    </p>
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="390" src="https://i-blog.csdnimg.cn/blog_migrate/ea1701c4c5a1cd54d3d5a11b0fdcf796.png" width="751"/>
    </p>
    <p style="margin-left:0cm;">
     <span style="color:#000000;">
      TCP
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="46" src="https://i-blog.csdnimg.cn/blog_migrate/b728dd08cfdec577d9628cecb844218f.png" width="1179"/>
    </p>
    <p style="margin-left:0cm;">
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="342" src="https://i-blog.csdnimg.cn/blog_migrate/bde9e28bd32b840d75f4a42ac7d75199.png" width="1200"/>
    </p>
    <p style="margin-left:0cm;">
     第二次握手：192.168.157.130收到请求后要确认联机信息，向192.168.157.128发送ACK number =1384476280,SYN=1,ACK=1,随机产生SEQ number =337715159741的包;
    </p>
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="286" src="https://i-blog.csdnimg.cn/blog_migrate/5c1688d31f44a66d62c6c90b5fcba635.png" width="1200"/>
    </p>
    <p style="margin-left:0cm;">
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="296" src="https://i-blog.csdnimg.cn/blog_migrate/0a742fd41048f8045d50850142da29bd.png" width="1200"/>
    </p>
    <p style="margin-left:0cm;">
    </p>
    <p style="margin-left:0cm;">
...
    }
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="383" src="https://i-blog.csdnimg.cn/blog_migrate/2d44dcb8294e3ac92b404108a000debb.png" width="272"/>
    </p>
    <p style="margin-left:0cm;">
     <strong>
      置换算法(JAVA实现)
    ...
    <pre class="has"><code class="language-java">import java.util.Arrays;
...
 }
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="237" src="https://i-blog.csdnimg.cn/blog_migrate/bb580932bf012b8feb002acf9dc76ca0.png" width="597"/>
    </p>
    <p style="margin-left:0cm;">
     2.4
     <strong>
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="111" src="https://i-blog.csdnimg.cn/blog_migrate/937da147a7b331c8370d3db187c862cc.png" width="714"/>
    </p>
    <p style="margin-left:0cm;">
     <strong>
      <span style="color:#333333;">
    ...
    <p style="margin-left:0cm;">
     <img alt="" class="has" height="111" src="https://i-blog.csdnimg.cn/blog_migrate/695878a404b1a411297fc76c5565a2d7.png" width="714"/>
    </p>
    <p style="margin-left:0cm;">
     <span style="color:#333333;">
    ...
    <p style="margin-left:0cm;">
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/5403501-5641197.html" rel="nofollow">
         <span style="color:#136ec2;">
          网络诈骗
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/5351713-5587171.html" rel="nofollow">
         <span style="color:#136ec2;">
          网络钓鱼
         </span>
        </a>
    ...
    <p style="margin-left:0cm;">
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/5331327.html" rel="nofollow">
         <span style="color:#136ec2;">
          主机
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/6630573.html" rel="nofollow">
         <span style="color:#136ec2;">
          入侵检测
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/176561.html" rel="nofollow">
         <span style="color:#136ec2;">
          内存
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/2574087.html" rel="nofollow">
         <span style="color:#136ec2;">
          文件系统
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/3744746.html" rel="nofollow">
         <span style="color:#136ec2;">
          日志文件
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/5400819.html" rel="nofollow">
         <span style="color:#136ec2;">
          监控系统
         </span>
        </a>
    ...
    <p style="margin-left:0cm;">
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/5419030.html" rel="nofollow">
         <span style="color:#136ec2;">
          入侵者
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/5912120.html" rel="nofollow">
         <span style="color:#136ec2;">
          计算机管理员
         </span>
        </a>
    ...
    <p style="margin-left:0cm;">
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/501245.html" rel="nofollow">
         <span style="color:#136ec2;">
          目标文件
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/6735310.html" rel="nofollow">
         <span style="color:#136ec2;">
          校验码
         </span>
        </a>
     ...
     <span style="color:#0000ff;">
      <u>
       <span style="color:#136ec2;">
        <a href="https://baike.so.com/doc/6734130.html" rel="nofollow">
         <span style="color:#136ec2;">
          SHA1
         </span>
        </a>
    ...
    <p style="margin-left:0cm;">
     <a name="_Toc328303396">
     </a>
     <a name="_Toc327137275">
     </a>
     <a name="_Toc327136327">
      3.
     </a>
     总结
    </p>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f71715f3431333938343438:2f61727469636c652f64657461696c732f3836363139343632" class_="artid" style="display:none">
 </p>
</div>
