...
description: "文章浏览阅读1.云原生（Cloud Native）是由 Pivotal 的Matt Stine在20"
...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     <strong>
      个人博客请访问
      <a href="http://www.x0100.top/" rel="nofollow">
       http://www.x0100.top
      </a>
     </strong>
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/7ad5f223f8989fdb2079fe5895cb062d.png"/>
    </p>
    <p>
     I. 基准代码
    </p>
    ...
    <p>
     ...
     ,
     <a href="https://www.mercurial-scm.org/" rel="nofollow">
      Mercurial
     </a>
     ,
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/170ed6587f887c8a67d7eaf3695c60bf.png"/>
    </p>
    <p>
     一份代码库对应多份部署
    </p>
    ...
    <p>
     ...
     <a href="https://12factor.net/zh_cn/dependencies" rel="nofollow">
      依赖管理
     </a>
     策略去加载它们。
    </p>
    ...
    <p>
     ...
     <a href="http://www.cpan.org/" rel="nofollow">
      CPAN
     </a>
     或是 Ruby 的
     <a href="http://rubygems.org/" rel="nofollow">
      Rubygems
     </a>
    ...
    <p>
     例如， Ruby 的
     <a href="https://bundler.io/" rel="nofollow">
      Bundler
     </a>
     使用 Gemfile 作为依赖项声明清单，使用 bundleexec 来进行依赖隔离。Python 中则可分别使用两种工具 –
     <a href="http://www.pip-installer.org/en/latest/" rel="nofollow">
      Pip
     </a>
     用作依赖声明，
     <a href="http://www.virtualenv.org/en/latest/" rel="nofollow">
      Virtualenv
     </a>
     用作依赖隔离。甚至 C 语言也有类似工具，
     <a href="http://www.gnu.org/s/autoconf/" rel="nofollow">
      Autoconf
     </a>
    ...
    <p>
     ...
     <a href="https://github.com/technomancy/leiningen#readme">
      Leiningen
     </a>
     则是 lein deps。
    </p>
    ...
    <p>
     ...
     在不同
     <a href="https://12factor.net/zh_cn/codebase" rel="nofollow">
      部署
     </a>
    ...
    <p>
     ...
     <a href="https://12factor.net/zh_cn/backing-services" rel="nofollow">
      后端服务
     </a>
     的配置
    </p>
    ...
    <p>
     ...
     <a href="http://spring.io/" rel="nofollow">
      Spring
     </a>
     时
     <a href="http://docs.spring.io/spring/docs/current/spring-framework-reference/html/beans.html" rel="nofollow">
      代码模块间的依赖注入关系
     </a>
    ...
    <p>
     ...
     <a href="http://dev.mysql.com/" rel="nofollow">
      MySQL
     </a>
     ，
     <a href="http://couchdb.apache.org/" rel="nofollow">
      CouchDB
     </a>
     ），消息/队列系统（
     <a href="http://www.rabbitmq.com/" rel="nofollow">
      RabbitMQ
     </a>
     ，
     <a href="http://kr.github.com/beanstalkd/" rel="nofollow">
      Beanstalkd
     </a>
     ），SMTP 邮件发送服务（
    ...
    <p>
     ...
     <a href="http://postmarkapp.com/" rel="nofollow">
      Postmark
     </a>
     ），数据收集服务（例如
     <a href="http://newrelic.com/" rel="nofollow">
      New Relic
     </a>
     或
     <a href="http://www.loggly.com/" rel="nofollow">
      Loggly
     </a>
     ），数据存储服务（如
     <a href="http://http/aws.amazon.com/s3/" rel="nofollow">
      Amazon S3
     </a>
     ），以及使用 API 访问的服务（例如
     <a href="http://dev.twitter.com/" rel="nofollow">
      Twitter
     </a>
     ,
     <a href="https://developers.google.com/maps/" rel="nofollow">
      Google Maps
     </a>
     ,
     <a href="http://www.last.fm/api" rel="nofollow">
      Last.fm
     </a>
     ）。
    </p>
    <p>
     ...
     <a href="https://12factor.net/zh_cn/config" rel="nofollow">
      配置
     </a>
     ...
     <a href="http://aws.amazon.com/rds/" rel="nofollow">
      Amazon RDS
     </a>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/5e32cc1458fd9f9bc5aabcf2243c0e5b.png"/>
    </p>
    <p>
     一种部署附加4个后端服务
    </p>
    ...
    <p>
     ...
     <a href="https://12factor.net/zh_cn/processes" rel="nofollow">
      进程
     </a>
     。
    </p>
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/ba1379f626e657c5e7d405152090ec76.png"/>
    </p>
    <p>
     代码被构建，然后和配置结合成为发布版本
    </p>
    ...
    <p>
     ...
     <a href="https://github.com/capistrano/capistrano/wiki">
      Capistrano
     </a>
    ...
    <p>
     ...
     <a href="https://12factor.net/zh_cn/concurrency" rel="nofollow">
      进程类型
     </a>
     ，也就是零个或多个进程实例。
    </p>
    ...
    <p>
     源文件打包工具（
     <a href="http://documentcloud.github.com/jammit/" rel="nofollow">
      Jammit
     </a>
     ,
     <a href="http://django-compressor.readthedocs.org/" rel="nofollow">
      django-compressor
     </a>
     ） 使用文件系统来缓存编译过的源文件。12-Factor应用更倾向于在
     <a href="https://12factor.net/zh_cn/build-release-run" rel="nofollow">
      构建步骤
     </a>
     做此动作——正如
     <a href="http://guides.rubyonrails.org/asset_pipeline.html" rel="nofollow">
      Rails资源管道
     </a>
     ，而不是在运行阶段。
    </p>
    <p>
     一些互联网系统依赖于 “
     <a href="http://en.wikipedia.org/wiki/Load_balancing_%28computing%29#Persistence" rel="nofollow">
      粘性 session
     </a>
     ...
     或
     <a href="http://redis.io/" rel="nofollow">
      Redis
     </a>
     这样的带有过期时间的缓存中。
    </p>
    ...
    <p>
     ...
     载入应用。例如，Python的
     <a href="http://www.tornadoweb.org/" rel="nofollow">
      Tornado
     </a>
     ,Ruby 的
     <a href="http://code.macournoyer.com/thin/" rel="nofollow">
      Thin
     </a>
     ,Java 以及其他基于 JVM 语言的
     <a href="http://www.eclipse.org/jetty/" rel="nofollow">
      Jetty
     </a>
     。完全由
     <em>
    ...
    <p>
     ...
     <a href="http://xmpp.org/" rel="nofollow">
      XMPP
     </a>
     的
     <a href="http://www.ejabberd.im/" rel="nofollow">
      ejabberd
     </a>
     ， 以及使用
     <a href="http://redis.io/topics/protocol" rel="nofollow">
      Redis 协议
     </a>
     的
     <a href="http://redis.io/" rel="nofollow">
    ...
    <p>
     ...
     <a href="https://12factor.net/backing-services" rel="nofollow">
      后端服务
     </a>
     ，调用方将服务方提供的相应URL 当作资源存入
     <a href="https://12factor.net/config" rel="nofollow">
      配置
     </a>
     以备将来调用。
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/2caf15a900cf7f645e35b2db52b3db9b.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <a href="https://adam.herokuapp.com/past/2011/5/9/applying_the_unix_process_model_to_web_apps/" rel="nofollow">
      unix 守护进程模型
     </a>
    ...
    <p>
     ...
     <a href="http://rubyeventmachine.com/" rel="nofollow">
      EventMachine
     </a>
     ,
     <a href="http://twistedmatrix.com/trac/" rel="nofollow">
      Twisted
     </a>
     ,
    ...
    <p>
     12-Factor 应用的进程
     <a href="http://dustin.github.com/2010/02/28/running-processes.html" rel="nofollow">
      不需要守护进程
     </a>
     或是写入 PID 文件。相反的，应该借助操作系统的进程管理器(例如
     <a href="http://upstart.ubuntu.com/" rel="nofollow">
      Upstart
     </a>
     ，分布式的进程管理云平台，或是类似
     <a href="http://blog.daviddollar.org/2011/05/06/introducing-foreman.html" rel="nofollow">
      Foreman
     </a>
     的工具)，来管理
     <a href="https://12factor.net/logs" rel="nofollow">
      输出流
     </a>
    ...
    <p>
     ...
     中，worker 可以发送一个
     <a href="http://www.rabbitmq.com/amqp-0-9-1-quickref.html#basic.nack" rel="nofollow">
      NACK
     </a>
     信号。
     <a href="http://kr.github.com/beanstalkd/" rel="nofollow">
     ...
     <a href="https://github.com/collectiveidea/delayed_job#readme">
      Delayed Job
     </a>
     则需要确定释放了系统资源。此类型的进程所隐含的要求是，任务都应该
     <a href="http://en.wikipedia.org/wiki/Reentrant_%28subroutine%29" rel="nofollow">
      可重复执行
     </a>
     ， 这主要由将结果包装进事务或是使重复操作
     <a href="http://en.wikipedia.org/wiki/Idempotence" rel="nofollow">
      幂等
     </a>
     来实现。
    </p>
    <p>
     ...
     <a href="http://lwn.net/Articles/191059/" rel="nofollow">
      Crash-onlydesign
     </a>
     将这种概念转化为
     <a href="http://couchdb.apache.org/docs/overview.html" rel="nofollow">
      合乎逻辑的理论
     </a>
     。
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/a1031b67063c8fcc8f725ded8cce3c3f.png"/>
    </p>
    <p>
     <a href="https://12factor.net/zh_cn/backing-services" rel="nofollow">
      后端服务
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/c61a1a7bef6b8a02f11a2fe2dbe930d5.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <a href="http://mxcl.github.com/homebrew/" rel="nofollow">
      Homebrew
     </a>
     ，
     <a href="https://help.ubuntu.com/community/AptGet/Howto" rel="nofollow">
      apt-get
     </a>
     等现代的打包系统，诸如Memcached、PostgreSQL、RabbitMQ 等后端服务的安装与运行也并不复杂。此外，使用类似
     <a href="http://www.opscode.com/chef/" rel="nofollow">
      Chef
     </a>
     和
     <a href="http://docs.puppetlabs.com/" rel="nofollow">
      Puppet
     </a>
     的声明式配置工具，结合像
     <a href="http://vagrantup.com/" rel="nofollow">
      Vagrant
     </a>
    ...
    <p>
     日志应该是
     <a href="https://adam.herokuapp.com/past/2011/4/1/logs_are_streams_not_files/" rel="nofollow">
      事件流
     </a>
    ...
    <p>
     ...
     <a href="http://www.splunk.com/" rel="nofollow">
      Splunk
     </a>
     这样的日志索引及分析系统，或
    ...
    <p>
     l  运行一个控制台（也被称为
     <a href="http://en.wikipedia.org/wiki/Read-eval-print_loop" rel="nofollow">
      REPL
     </a>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f777566616c69616e67303033:2f61727469636c652f64657461696c732f3739353333333435" class_="artid" style="display:none">
 </p>
</div>
