...
description: 文章浏览阅读2.7k次，点赞67次，收藏57次。操作系统的设计目的是管理计算机系统的软硬件资源，为用
keywords: 冯诺依曼
categories: ['Linux学习']
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <div class="toc">
     ...
     <ul>
      ...
      <li>
       <a href="#2Operator_System_104" rel="nofollow">
      ...
      <li>
       <ul>
        ...
        <li>
         <a href="#32__260" rel="nofollow">
          3.2 进程概念
         </a>
        </li>
        <li>
         <a href="#33_PCB_288" rel="nofollow">
          3.3 描述进程—PCB
         </a>
        </li>
        <li>
         <a href="#34_task_structlinuxPCB_296" rel="nofollow">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/f43b9e71e78004ad44b03260563c9eb0.png"/>
    </p>
    <h3>
     <a id="_26">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/082f27830f0f393aca69f3831553d82d.png"/>
    </p>
    <ol>
     <li>
      <p>
     ...
     <li>
      <p>
       远程二级存储（Remote Secondary Storage）：
      </p>
      <ul>
       <li>
        包括分布式文件系统、Web 服务器等。
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/bbdfb4b2c1cebfd86de85de05db2f231.png"/>
    </p>
    <h3>
     <a id="22_OS_118">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/0b461107f7e869946d2cea18e119b0ec.png"/>
    </p>
    <blockquote>
     <p>
      <strong>
     ...
     <ol>
      <li>
       <p>
        <strong>
         操作系统：操作系统是计算机系统中的核心软件，负责管理计算机的资源、提供用户界面、执行程序和控制外部设备等。操作系统通过提供各种服务和接口，使应用程序能够在计算机上运行并与硬件设备进行交互。
        </strong>
       </p>
      </li>
      <li>
       <p>
        <strong>
         驱动程序：驱动程序是一种软件，用于与特定硬件设备进行通信和控制。驱动程序通常由硬件制造商提供，通过操作系统的驱动程序接口（API）与操作系统进行交互。当操作系统需要与某个硬件设备通信时，会调用相应的驱动程序来完成这些操作。
        </strong>
       </p>
      </li>
      <li>
       <p>
        <strong>
         底层硬件：底层硬件是指计算机系统中的物理设备，如处理器、内存、硬盘、显卡、网卡等。这些硬件设备是计算机系统的基础，操作系统和应用程序需要通过驱动程序来与这些硬件设备进行通信和控制。
        </strong>
       </p>
      </li>
     </ol>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/cebb1571f941cebfc39ba29280a8feb6.png"/>
    </p>
    <p>
    ...
    <ol>
     ...
     <li>
      <p>
       操作系统肯定要管理多个加载到内存的程序呢
      </p>
     </li>
     <li>
      <p>
       操作系统如何管理加载到内存的程序呢? ? 先描述，在组织：
      </p>
      <blockquote>
       <ol>
        <li>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/4446496f290d6b8924a5bd5ac234b4b2.png"/>
    </p>
    <blockquote>
     <ol>
      <li>
    ...
    <img alt="进程17" src="https://i-blog.csdnimg.cn/blog_migrate/dee06bf0765d03f98071b5884b1292f2.png">
     <p>
     ...
     <h3>
      <a id="34_task_structlinuxPCB_296">
      </a>
      3.4 task_struct—linux中的PCB
     </h3>
     <p>
    ...
    <span class="token comment">// 进程标识符</span>
    ...
    <span class="token comment">// 进程优先级和调度信息</span>
    ...
    <span class="token comment">// 进程描述符</span>
    ...
    <span class="token comment">// 进程的父子关系</span>
    <span class="token keyword">struct</span> <span class="token class-name">task_struct</span> <span class="token operator">*</span>parent<span class="token punctuation">;</span>
    ...
    <span class="token comment">// 进程的执行状态</span>
    <span class="token keyword">struct</span> <span class="token class-name">pt_regs</span> <span class="token operator">*</span>thread_regs<span class="token punctuation">;</span>
    <span class="token keyword">unsigned</span> <span class="token keyword">long</span> stack<span class="token punctuation">;</span>
    
    <span class="token comment">// 进程的内存管理信息</span>
    ...
    <span class="token comment">// 进程的资源限制</span>
    <span class="token keyword">struct</span> <span class="token class-name">rlimit</span> rlim<span class="token punctuation">;</span>
    
    <span class="token comment">// 信号处理器</span>
    <span class="token keyword">struct</span> <span class="token class-name">sigaction</span> sigaction<span class="token punctuation">[</span>_NSIG<span class="token punctuation">]</span><span class="token punctuation">;</span>
    
    <span class="token comment">// 进程的调试信息</span>
    <span class="token keyword">int</span> debug_flags<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f37343431353135332f:61727469636c652f64657461696c732f313338323837383238" class_="artid" style="display:none">
 </p>
</div>
