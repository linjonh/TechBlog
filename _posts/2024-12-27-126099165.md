...
description: "文章浏览阅读1.8k次，点赞13次，收藏9次。分布式云是多云、混合云、私云的简称，云原生平台是我们多"
keywords: "多集群kamada"
...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
     ...
     <ul>
      <li>
       <ul>
        ...
        <li>
         <a href="#Karmada_84" rel="nofollow">
          六、Karmada一键管理多集群
         </a>
        </li>
        <li>
         <ul>
          <li>
           <a href="#1K8sAPI_85" rel="nofollow">
            1、K8s原生API兼容
           </a>
          </li>
          <li>
        ...
        <li>
         <a href="#Kurator_106" rel="nofollow">
          七、Kurator：打造统一的分布式云原生基础设施
         </a>
        </li>
        <li>
         <a href="#KubeEdge_112" rel="nofollow">
          八、KubeEdge：一键构建云原生边缘计算平台
         </a>
        </li>
        <li>
         <a href="#Volcana_120" rel="nofollow">
          九、Volcana：一键构造云原生批量计算平台
         </a>
        </li>
        <li>
         <a href="#istio_129" rel="nofollow">
          十、istio：一键构建分布式流量统一管理
         </a>
        </li>
        <li>
         <a href="#Prometheus_138" rel="nofollow">
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/ca92d94c16e5e1b35b86c8b595828b33.png"/>
    </p>
    <h3>
     <a id="_25">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/9d10e534c65b531dc7cf2c44cda3d59b.png"/>
    </p>
    <h3>
     <a id="_63">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/64a05946849bc649d8e3f0ff5e68252b.png#pic_center"/>
    </p>
    <h3>
     <a id="Volcana_120">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b4599d9932761c820521eb667f91b1d3.jpeg#pic_center"/>
    </p>
    <br/>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f67756f7275695f6a6176612f:61727469636c652f64657461696c732f313236303939313635" class_="artid" style="display:none">
 </p>
</div>
