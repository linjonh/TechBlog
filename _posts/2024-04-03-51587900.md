...
description: "文章浏览阅读9.6k次，点赞3次，收藏9次。引言 　　目前，Java社区推动并发展了一种引人注目的新"
keywords: "规则引擎原理"
...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <br/>
     目前，
     <a class="replace_word" href="http://lib.csdn.net/base/17" rel="nofollow noopener noreferrer" style="color:#df3434; font-weight:bold" target="_blank" title="Java EE知识库">
      Java
     </a>
     ...
     <a class="replace_word" href="http://lib.csdn.net/base/2" rel="nofollow noopener noreferrer" style="color:#df3434; font-weight:bold" target="_blank" title="机器学习知识库">
      人工智能
     </a>
    ...
    <p align="center">
     <img alt="" class="blogimg" height="138" src="https://p-blog.csdn.net/images/p_blog_csdn_net/joeyshi/EntryImages/20090505/2a9adcdff5875b0e495403e2.jpg" style="border:0px" width="406"/>
    </p>
    <p align="center">
     图1 基于规则的专家系统构成
    </p>
    ...
    <p align="left">
     上述即是规则引擎的原始
     <a class="replace_word" href="http://lib.csdn.net/base/16" rel="nofollow noopener noreferrer" style="color:#df3434; font-weight:bold" target="_blank" title="大型网站架构知识库">
      架构
     </a>
    ...
    <div>
     <img alt="" class="blogimg" height="263" src="https://p-blog.csdn.net/images/p_blog_csdn_net/joeyshi/EntryImages/20090505/8bf853c833c3590a7f3e6ff1.jpg" style="border:0px" width="418">
     </img>
    </div>
    <p align="center">
     图2 处理过程协作图
    ...
    <div>
     <img alt="" class="blogimg" height="245" src="https://p-blog.csdn.net/images/p_blog_csdn_net/joeyshi/EntryImages/20090505/2a9adcdff5f75b0e495403f2.jpg" style="border:0px" width="307">
     </img>
    </div>
    <p align="center">
     图3 规则引擎工作机制
    ...
    <div>
     <img alt="" class="blogimg" height="297" src="https://p-blog.csdn.net/images/p_blog_csdn_net/joeyshi/EntryImages/20090505/ac231113f0355a9d6538dbff.jpg" style="border:0px" width="395">
     </img>
    </div>
    <p align="center">
     图4 Java规则引擎工作机制
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f726973653531:2f61727469636c652f64657461696c732f3531353837393030" class_="artid" style="display:none">
 </p>
</div>
