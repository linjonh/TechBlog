...
description: "文章浏览阅读1.1k次，点赞9次，Cramfs文件系统以压缩方式存储，在运行时解压缩，所以不支持应用"
keywords: "嵌入式文件系统"
categories: ['程序员']
tags: ['面试', '学习', 'Go']
artid: "138786297"
...
<div class="blog-content-box">
  ...
  <div class="article-header">
   <div class="article-title-box">
    <h1 class="title-article" id="articleContentId">
     最全嵌入式文件系统详解_嵌入式 文件系统工作原理(1)，研发4面真题解析（Golang岗）
    </h1>
   </div>
  </div>
 </div>
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/8ec40d0673b74cfcf4f069608b8e4809.png">
      <br/>
      <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/5708fa766f5e6b9acfd1a18b484a1ff6.png"/>
     </img>
    </p>
    <p>
     <strong>
    ...
    <p>
     <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/6c5153ee4b64ccb88b761730fd2a5a80.png">
      <br/>
      <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/b5765c0ac47cb3aff09f5d6a8dba9282.png">
       <br/>
       <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/8ce56f84f63a7b052c514034dd9c4048.png"/>
      </img>
     </img>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323430315f38343932353333352f:61727469636c652f64657461696c732f313338373836323937" class_="artid" style="display:none">
 </p>
</div>
