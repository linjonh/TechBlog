...
date: 2014-09-06 11:03:50 +0800
categories: [GUI]
tags: [嵌入式GUI,轻量级,LCD驱动,窗口系统,状态栏]
image:
  path: https://api.vvhan.com/api/bing?rand=sj&artid=39099439
  alt: 一种轻量级嵌入式GUI设计
artid: 39099439
---
<span class="artid" style="display:none" artid=68747470733a2f2f626c6f672e:6373646e2e6e65742f6a69616e676a756e6a69655f32303035:2f61727469636c652f64657461696c732f3339303939343339></span>
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" class="has" src="https://img-blog.csdn.net/20140906105100933"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/d5ec047bea011602350206c008c0e7ed.bmp"/>
    </p>
    <p>
     图1  MCU的I/O连接LCD模块
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/d65098d7df89bc56f9e961e4d219bc36.bmp"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/5e548f13d045397532d21591b639de89.png"/>
    </p>
    <p>
     图3总线时序
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/5fed4d79f86633007aaae28918d23be5.png"/>
    </p>
    <p>
     图4  GUI软件层次
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/17fb9f67e8df4c02d9d94b1bae39ed49.png"/>
    </p>
    <p>
     图5窗口服务器与客户端
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/0ad3272d207e0ffc6929adaa7715de1e.png"/>
    </p>
    <p>
     图6消息编码
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/ca8aebedd7ae242a1b5c2bd4cde234c6.png"/>
    </p>
    <p>
     图7窗口对象设计
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/6a841c5a2c2e6f7bf6224ade3dc9ccce.png"/>
    </p>
    <p>
     图8窗口对象群
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/4fb43e55bf7b36c5474893a027e11c50.png"/>
    </p>
    <p>
     图9窗口与邻居窗口寻址
    </p>
    ...
    <p>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/1551f192c87c95d945cde38c8c65f0af.png"/>
    </p>
    <p>
     图10 状态栏
    </p>
    ...
    <p>
     ...
     <a href="http://download.csdn.net/detail/jiangjunjie_2005/9508662">
