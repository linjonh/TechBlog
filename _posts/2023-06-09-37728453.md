 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-plain">信息: MLog clients using java 1.4+ standard logging.
...
2014-7-12 19:29:22 org.apache.catalina.startup.HostConfig deployDirectory</code></pre>
    <br/>
    <strong>
     <span style="font-size:14px">
      2、错误原因
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f796f7532336861693435:2f61727469636c652f64657461696c732f3337373238343533" class_="artid" style="display:none">
 </p>
</div>
