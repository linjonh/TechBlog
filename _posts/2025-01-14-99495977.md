...
[SW2]irf-port-configuration active</code></pre>
     ...
     <pre><code>//相关注释参考SW2，我就只将不同的配置注释写出来了
...
[SW1-Ten-GigabitEthernet1/0/49]quit
[SW1]irf-port-configuration   active   //激活IRF端口配置</code></pre>
     <p>
     ...
     <pre><code>[SW1]interface Bridge-Aggregation  2     //创建聚合链路，编号为2，与SW3的聚合链路对应
...
[SW1-Bridge-Aggregation3]quit</code></pre>
     ...
     <pre><code>//下面是将SW1的端口加入到相应的聚合链路中，并配置为trunk类型
[SW1]in g1/0/1
 ...
 * indicates the device is the master.
 ...
 Domain ID                   : 0</code></pre>
     ...
     <pre><code>&lt;SW1&gt;dis irf configuration                      //查看IRF的端口信息
 ...
 2        2        Ten-GigabitEthernet2/0/49     disable</code></pre>
     ...
     <pre><code>&lt;SW1&gt;dis irf topology                      //查看IRF的拓扑信息
                              Topology Info
 -------------------------------------------------------------------------
               IRF-Port1                IRF-Port2
 ...
 2           UP         1             DIS        ---         2c63-c480-0300
     ...
     <pre><code>&lt;SW1&gt;dis mad verbose     //查看当前MAD的状态信息
...
MAD BFD disabled.</code></pre>
     ...
     <pre><code>&lt;SW1&gt;dis link-aggregation verbose     //查看LACP的链路聚合信息
