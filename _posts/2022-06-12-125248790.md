...
description: "文章浏览阅读3.感知控制的通信目的将设备传感设备(数据采集设备及其连同的控制设备)所感知的数据在较短"
keywords: "物联网通信技术"
categories: ['期末专栏']
tags: ['网络协议', '网络', '物联网']
artid: "125248790"
...
<div class="blog-content-box">
    ...
    <ol>
     ...
     <li>
      <p>
       ...
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b66c55fd9608fdabfd41084156b74026.png"/>
      </p>
     </li>
     <li>
      <p>
     ...
     <li>
      <p>
       ZigBee网络协议栈框架结构
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/42b184a46a4ce8a6823c11d83aa54fae.png"/>
      </p>
     </li>
     <li>
      <p>
     ...
     <li>
      <p>
       计算机网络是通过通信链路将地理位置分散的、具有独立功能的计算机系统连接起来，根据某种协议进行数据传输，实现资源共享和分布式处理的系统
       <br/>
     ...
     <li>
      <p>
       基本服务集BSS：一个AP和若干个移动站；扩展服务集ESS：两个或两个以上基本服务集
      </p>
     </li>
     <li>
      <p>
       LMDS 本地多点分配系统；WiMAX 全球微波接入的互操作性；FDMA 频分多址；TDMA 时分多址；CDMA 码分多址
      </p>
     </li>
     <li>
      <p>
       移动通信网中的基本技术实际上是多种多址技术的综合
      </p>
     </li>
     <li>
      <p>
       GPRS网络示意图
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/cbf521c712dc10a3af0a76f9c87fdc47.png"/>
      </p>
     </li>
     <li>
      <p>
       两个或两个以上采用了不同的接入技术，或者是采用相同的无线接入技术但网络设备在网络带宽、存储/计算/处理等资源上有明显差距的无线通信系统智能地融合在一起，构成异构无线网络
      </p>
     </li>
     <li>
      <p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34373534373632352f:61727469636c652f64657461696c732f313235323438373930" class_="artid" style="display:none">
 </p>
</div>
