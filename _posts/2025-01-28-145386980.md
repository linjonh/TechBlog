...
<span class="token comment"># 加载预训练模型和 Tokenizer</span>
model_name <span class="token operator">=</span> <span class="token string">"gpt2"</span> <span class="token comment"># 使用 GPT-2 模型</span>
...
input_text <span class="token operator">=</span> <span class="token string">"角色 A: 我觉得今天的天气真不错。"</span>
