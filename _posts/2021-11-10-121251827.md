 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="492" src="https://i-blog.csdnimg.cn/blog_migrate/05b7a71e3d31f56fc74dad841db08330.png" width="717"/>
    </p>
    <p>
     2.使用说明
    </p>
    <p>
     <img alt="" height="823" src="https://i-blog.csdnimg.cn/blog_migrate/7de92a173d6dee8a772791720920c4f5.png" width="1038"/>
    </p>
    <p>
     2.1选择方法：指定搜索帮助表数据来源
    </p>
    ...
    <p>
     <img alt="" height="152" src="https://i-blog.csdnimg.cn/blog_migrate/17a0510431d6442d51655e82e144fb30.png" width="516"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="642" src="https://i-blog.csdnimg.cn/blog_migrate/b92492219ea9104da72d5fe731da2386.png" width="820"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="342" src="https://i-blog.csdnimg.cn/blog_migrate/3fad5d5ab14e0e3983a9cddeab7f20fa.png" width="698"/>
    </p>
    <p>
    ...
    <pre><code>FUNCTION zfi_sh_car_type_f4_exit.
*"----------------------------------------------------------------------
*"*"本地接口：
*"  TABLES
...
ENDFUNCTION.</code></pre>
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f51756e656e64696e672f:61727469636c652f64657461696c732f313231323531383237" class_="artid" style="display:none">
 </p>
</div>
