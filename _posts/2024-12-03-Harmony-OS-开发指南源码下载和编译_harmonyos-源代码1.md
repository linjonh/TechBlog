  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/63a5518930da0aaf01288d0de63281cb.png">
      <br/>
      <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/1e210328c1ebf43f08d3b6c5f5c13b48.png">
       <br/>
       <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/b33ef47128c98c8f7435bd7477b88e67.png">
        <br/>
        <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/c48c4e02a8c89024e691ce2136abee07.png">
         <br/>
         <img alt="htt" src="https://i-blog.csdnimg.cn/blog_migrate/db24a03f167ed02efa4eb94fd177bff5.png"/>
        </img>
       </img>
      </img>
     </img>
    ...
    <p>
     ...
     <br/>
     <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/c7aabb06a81ad5512f8cccd15149c969.png"/>
    </p>
    <h4>
     <a id="_18">
     </a>
    ...
    <h2>
     <a id="sudo_apt_install_curl__curl_84">
     </a>
    ...
    <h2>
     <a id="git_config_global_username_yourname_100">
     </a>
     git config --global user.name “yourname”
    </h2>
    <h2>
     <a id="git_config_global_useremail_youremailaddress_101">
     </a>
    ...
    <h2>
     <a id="_bashrc_gnninjaLLVMhcgen_160">
     </a>
    ...
    <h2>
     <a id="python38pythonvirtualenv_207">
     </a>
    ...
    <h2>
     <a id="_virtualenvpip3_install_210">
     </a>
    ...
    <h2>
     <a id="_setuptools__kconfiglib_213">
     </a>
    ...
    <h2>
     <a id="pip3_install_upgrade_ignoreinstalled_six_218">
     </a>
     pip3 install --upgrade --ignore-installed six
    </h2>
    <h2>
     <a id="_bashrc_python_deactivate__220">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="img" src="https://i-blog.csdnimg.cn/blog_migrate/466ef46e388a94034f2bbae2f47150c0.png"/>
    </p>
    <p>
     <strong>
