 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre class="has"><code class="language-html">&lt;el-select
  v-model="userId"
  filterable
...
computed: {
    ...
    <pre class="has"><code class="language-javascript">userFilter(query = '') {
...
getUserWhiteList() {
  HttpRequest.post("/api/admin/community/getUserWhiteList").then(
    ...
    <pre class="has"><code class="language-javascript">addValueOptions () {
            if (this.userId) {
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34313834393436322f:61727469636c652f64657461696c732f313033323334333336" class_="artid" style="display:none">
 </p>
</div>
