...
description: "文章浏览阅读3.1k次，点赞50次，自Java语言诞生以来，从早期的版本迭代，到中期的稳定与成熟，再"
keywords: "java未来方向"
categories: ['杂谈']
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="hljs">public class HelloWorld {  
    ...
    <pre><code class="hljs">public class BasicTypes {  
    public static void main(String[] args) {  
        int x = 10;  
        if (x &gt; 5) {  
    ...
    <pre><code class="hljs">public class OuterClass {  
...
public class CollectionsExample {  
    ...
    <pre><code class="hljs">// Java 5.0 之前的代码  
...
List&lt;String&gt; list = new ArrayList&lt;String&gt;();  
list.add("Hello");  
String s = list.get(0); // 不需要强制类型转换</code></pre>
    <p>
     <strong>
      与后来时期的不同
     </strong>
    ...
    <pre><code class="hljs">// Java 5.0 之后的代码  
@Override  
...
// ...  
out.println("Hello, World!");</code></pre>
    <p>
    </p>
    <p>
     <strong>
    ...
    <pre><code class="hljs">// Java 7之前的代码  
List&lt;String&gt; list = new ArrayList&lt;String&gt;();  
  
// Java 7及之后的代码  
List&lt;String&gt; list = new ArrayList&lt;&gt;(); // 使用钻石操作符，类型由左侧推断</code></pre>
    <p>
...
try (BufferedReader reader = new BufferedReader(new FileReader("file.txt"))) {  
    ...
    <pre><code class="hljs">// Java 8之前的代码  
...
// Java 8及之后的代码  
Comparator&lt;String&gt; comparator = (s1, s2) -&gt; s1.compareTo(s2); // 使用Lambda表达式</code></pre>
    <p>
...
List&lt;Integer&gt; evenNumbers = numbers.stream()  
                                   .filter(n -&gt; n % 2 == 0)  
                                   .collect(Collectors.toList()); // 使用Stream API进行过滤和收集</code></pre>
    <p>
    ...
    <pre><code class="hljs">// Java 10之前的代码  
List&lt;String&gt; list = new ArrayList&lt;&gt;();  
  
// Java 10及之后的代码（从Java 11起正式成为标准特性）  
var list = new ArrayList&lt;String&gt;(); // 使用var关键字进行类型推断</code></pre>
    <p>
    ...
    <ol>
     <li>
      ...
      <a href="https://www.amazon.com/Core-Java-Volume-Fundamentals-11th/dp/0135166306" rel="nofollow" title="Java核心技术卷Ⅰ">
       Java核心技术卷Ⅰ
      </a>
     </li>
     <li>
      ...
      <a href="https://www.amazon.com/Effective-Java-3rd-Joshua-Bloch/dp/0134685997" rel="nofollow" title="Effective Java中文版">
       Effective Java中文版
      </a>
     </li>
     <li>
      ...
      <a href="https://docs.oracle.com/javase/8/docs/" rel="nofollow" title="Oracle官方文档">
       Oracle官方文档
      </a>
     </li>
     <li>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/6a188f18690cab30df7158e7e149af7c.jpeg">
     </img>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33373033313936332f:61727469636c652f64657461696c732f313336363233353731" class_="artid" style="display:none">
 </p>
</div>
