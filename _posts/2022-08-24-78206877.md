 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="710" src="https://img-blog.csdn.net/20171011183903467?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvc3VwZXJpdDQwMQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center" width="338">
      <br/>
     </img>
    </p>
    <p>
...
//获取到的myproperties.properties的值value2：myname		
    ...
    <pre><code class="language-java">String path = request.getSession().getServletContext().getRealPath("/config/sysconfig.properties");
		System.out.println("doGet读取到的/WEB-INF/config/sysconfig.properties:path:"+path);
		String url = request.getSession().getServletContext().getRealPath("/WEB-INF/config/config.properties");
		System.out.println("doGet读取到的/WEB-INF/config/config.properties:url:"+url);
		/**
    ...
    <p>
     <span style="font-size:18px">
      <a href="http://blog.csdn.net/qhwc2009/article/details/45824815" rel="noopener noreferrer" target="_blank">
    ...
    <p>
     <span style="font-size:18px">
      <a href="http://blog.csdn.net/wjl_mgqs/article/details/7554741" rel="noopener noreferrer" target="_blank">
    ...
    <p>
     <span style="font-size:18px">
      <a href="http://www.cnblogs.com/duoting/p/4141044.html" rel="nofollow noopener noreferrer" target="_blank">
    ...
    <p>
     <span style="font-size:18px">
      <a href="http://blog.csdn.net/mar_ljh/article/details/39693979" rel="noopener noreferrer" target="_blank">
    ...
    <pre><code class="language-java">package utils.readFile;
...
public class SysConfig {
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f73757065726974343031:2f61727469636c652f64657461696c732f3738323036383737" class_="artid" style="display:none">
 </p>
</div>
