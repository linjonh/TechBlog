 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     代码地址：
     <a class="link-info" href="https://gitee.com/jay_musu/games-and-tools.git" rel="nofollow" title="https://gitee.com/jay_musu/games-and-tools.git">
      https://gitee.com/jay_musu/games-and-tools.git
     </a>
    </p>
    <h2>
     一、创建新项目
    ...
    <p>
     <img alt="" height="307" src="https://i-blog.csdnimg.cn/blog_migrate/8751d8f4a8837fe515e59e56c8e8031c.png" width="395"/>
    </p>
    <h2>
     二、主要的游戏界面
    </h2>
    ...
    <pre><code class="language-java">package com.snake.view;
...
//		repaint();
    ...
    <pre><code class="language-java">package com.snake.controller;
...
public class SnakeStart {
    ...
    <p>
     <img alt="" height="129" src="https://i-blog.csdnimg.cn/blog_migrate/9f6610cca3be91f2d1c5d31b07227d17.png" width="293"/>
    </p>
    <p>
     <strong>
      游戏界面
    ...
    <p>
     <img alt="" height="742" src="https://i-blog.csdnimg.cn/blog_migrate/1e92f88e91b89cf016fb4dce2bcd9e28.png" width="904"/>
    </p>
    <p>
     <img alt="" height="742" src="https://i-blog.csdnimg.cn/blog_migrate/1c5a91458e5b5b1431c425e1f4dcd7ff.png" width="904"/>
    </p>
    <p>
    </p>
   </div>
...
<p class="artid" style="display:none">68747470733a:2f2f626c6f672e6373646e2e6e65742f6a61795f6d7573752f:61727469636c652f64657461696c732f313237383139373134</p>
