 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/4b987efcf76845b918ba9a22aec27825.png"/>
    </p>
    <p>
...
&lt;/body </code></pre>
    ...
    <pre><code class="language-html">//食物类
function Food(x，y，w) {
var t= this;
t.x=x;
t.y=y;
...
return false;
    ...
    <pre><code class="language-html">//蛇块类
...
return false;
    ...
    <pre><code class="language-html">//蛇类
...
snake interval = setInterval(t.move，speed);//定时移动蛇
    ...
    <pre><code class="language-html">//取得键盘方向
...
break;
    ...
    <pre><code class="language-html">//移动蛇
t.move = function()
var newHead;
//是否碰撞到了场地的壁
...
for(var i=1;i&lt; snakes.length; i++)if(snakesil.equal(snakes[0T)) gameover();
    ...
    <pre><code class="language-html">//给蛇增加长度(在尾巴加)
t.growth = function()
...
* snake 类结束 */</code></pre>
    ...
    <pre><code class="language-html">//场地类,生成一个画布和豆、蛇
function Farm()
var t = this;
ctx.fillStyle ='white';
...
t.snake= new Snake(100，100，5，500); //初始 5 节长度,位置(100,100)处//*彼啊画钻班等滁癌报蛇t.snake.init();
    ...
    <pre><code class="language-html">var canvas = document.getElementById("canvas”)
...
<p class="artid" style="display:none">68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34313634303231382f:61727469636c652f64657461696c732f313331343535393434</p>
