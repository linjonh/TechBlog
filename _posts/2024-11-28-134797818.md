 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="hljs">"terminal.integrated.env.osx": {
    ...
    <pre><code class="hljs">"env": {"PYTHONPATH":"${workspaceRoot}"},
"envFile": "${workspaceRoot}/.env",</code></pre>
    <p>
    ...
    <pre><code>"code-runner.fileDirectoryAsCwd": true,
    "code-runner.executorMap": {
        "javascript": "node",
      "python": "set PYTHONIOENCODING=utf-8 &amp;&amp; set PYTHONPATH=. &amp;&amp; python -u",
      "go": "go run",
    },
    "code-runner.runInTerminal": true</code></pre>
    <p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f7275616e6a69616e63657368697a6c2f:61727469636c652f64657461696c732f313334373937383138" class_="artid" style="display:none">
 </p>
</div>
