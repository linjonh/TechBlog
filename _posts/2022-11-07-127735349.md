...
description: "文章浏览阅读2k次。大数据(big data)，或称巨量资料，指的是所涉及的资料量规模巨大到无法透过"
...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2756deac96ad0f4ae3414801bc38945d.png"/>
    </p>
    <h5>
     <a id="2__15">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/0617d79e407ca32ae472ecfc26703dd3.png"/>
    </p>
    <h4>
     <a id="__34">
     </a>
    ...
    <p>
     <a href="https://www.finebi.com/solutions/bd?utm_source=seo&amp;utm_medium=seo&amp;utm_campaign=bi-paper&amp;utm_term=csdn" rel="nofollow">
      帆软大数据展示平台
     </a>
     可以提取、分析和显示数据，并以多种丰富形式、更加直观的方式，展示数据探索结果。
     <a href="https://www.finebi.com?utm_source=seo&amp;utm_medium=seo&amp;utm_campaign=bi-paper&amp;utm_term=csdn" rel="nofollow">
      帆软Finebi
     </a>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34383139323334362f:61727469636c652f64657461696c732f313237373335333439" class_="artid" style="display:none">
 </p>
</div>
