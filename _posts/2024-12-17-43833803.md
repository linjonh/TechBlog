  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     ...
     <a href="http://blog.csdn.net/yongh701/article/details/43833561" rel="noopener noreferrer" target="_blank">
      点击打开链接
     </a>
    ...
    <p>
     <img alt="" src="https://img-blog.csdn.net/20150215111336226">
      <br/>
     </img>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://img-blog.csdn.net/20150215112715272">
      <br/>
     </img>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://img-blog.csdn.net/20150215111250110">
      <br/>
     </img>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://img-blog.csdn.net/20150215111851924">
      <br/>
     </img>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://img-blog.csdn.net/20150215112130480">
      <br/>
     </img>
    </p>
    <p>
    ...
    <pre><code class="language-java">System.out.println("赌大小的游戏，输入0代表小，输入1代表大");
int n = 0;
try {
...
int resultArr[] = new int[3];</code></pre>
    ...
    <pre><code class="language-java">switch (n) {
case 0:
	for (int i = 0; i &lt; 3; i++) {
...
case 1:
    ...
    <a href="http://blog.csdn.net/yongh701/article/details/43667981" rel="noopener noreferrer" target="_blank">
     点击打开链接
    </a>
    ...
    <pre><code class="language-java">boolean isAllIdentical = true;
...
public class Random_Probability {
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f796f6e6768373031:2f61727469636c652f64657461696c732f3433383333383033" class_="artid" style="display:none">
 </p>
</div>
