  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/59e3e4d6e6193dd0b26a285ce3d8e726.png#pic_center">
      <br/>
      <strong>
       2，编写TestCase（测试用例）
      </strong>
...
Process finished with exit code 0
    ...
    <pre><code>class SumTest(unittest.TestCase):
    '''测试Math类中的sum函数'''
    @classmethod
    def setUpClass(cls):
...
if __name__ == '__main__':
    ...
    <pre><code>开始执行测试用例&lt;class '__main__.SumTest'&gt;...
...
fp.close()
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2adc45321386162f83e354a7c17f971a.png#pic_center">
      <br/>
      <strong>
       浏览器打开该文件，内容如下：
      </strong>
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/3391e91fbe12d4b3b3c9f0cfe1d61c0c.png#pic_center">
       <br/>
       <strong>
        2，美化版测试报告
       </strong>
...
fp.close()
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/af276eba3ceabd5e0a5f58fe84325b9d.png#pic_center">
      <br/>
      两种报告模板可根据自己喜好任意选择。
     </img>
    </p>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/d61025f37b15ed9dcdae25e101f475d5.png#pic_center"/>
    </p>
   </div>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f417361617361312f:61727469636c652f64657461696c732f313039343032333334" class_="artid" style="display:none">
 </p>
</div>
