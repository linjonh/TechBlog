...
description: "文章浏览阅读4.8k次，点赞2次，本文主要由如何保证服务的可用性也就是系统监控问题逐步引出 Java"
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/48db5b65fc091e661038cbb9805ccc45.jpeg">
      <br/>
      可以看到，
      <strong>
    ...
    <pre><code>package cn.carlzone.learn.agent;
...
&lt;/project&gt;
    ...
    <pre><code>-javaagent: /Users/carl/.m2/repository/cn/carlzone/learn/agent-test/1.0-SNAPSHOT/agent-test-1.0-SNAPSHOT.jar=carlgood
</code></pre>
    <p>
     其中 carlgood 为上文中传入permain方法的agentArgs参数。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/fcad53326757fb877c215be2279f6dc9.png"/>
    </p>
    <p>
     运行我们的主程序:
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/19d092ec5a0f46c4681c81891271f6c9.png">
      <br/>
      本来当前
      <code>
...
public class Bootstrap {
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/1838bee46e7ad20593b425615d4a8c0f.png">
      <br/>
      编写 A 程序代码：
     </img>
    </p>
    <pre><code>public class AgentMainTest {
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/5a0030bf9be25c65da2ba0e0cfc8c205.png">
      <br/>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/5fa136d0e072561952a045f126fe2fc2.png"/>
     </img>
    </p>
    <h3>
     <a id="4_296">
    ...
    <ul>
     <li>
      <a href="https://www.jianshu.com/p/63c328ca208d" rel="nofollow">
       Java Agent简介
      </a>
     </li>
     <li>
      <a href="https://alibaba.github.io/arthas/" rel="nofollow">
       Arthas 用户文档
      </a>
     </li>
    </ul>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f753031323431303733332f:61727469636c652f64657461696c732f313034383738313131" class_="artid" style="display:none">
 </p>
</div>
