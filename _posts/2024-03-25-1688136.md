...
description: "文章浏览阅读1.9k次。小论遗留操作系统向Linux系统迁移方法 康华 ：主要从事 Linux 操作"
keywords: "oldos内测地址"
categories: ['内核开发经验交流']
tags: ['数据结构', '存储', '任务', 'linux内核', 'linux', 'api']
artid: "1688136"
image:
...
<div class="blog-content-box">
       ...
       <font size="1">
        <font face="Times New Roman">
         ...
         <span style="FONT-SIZE: 9pt">
          ...
          。其所合写的Linux专栏见
          <span lang="EN-US" style="FONT-SIZE: 10.5pt; COLOR: black; FONT-FAMILY: 'Times New Roman'; mso-fareast-font-family: 宋体; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">
           <a href="http://www.csdn.net/subject/linux/">
            <font color="#000080">
 ...
 便最终演化为这个适配层。请看下图。
    ...
    <div>
     <img alt="" src="https://p-blog.csdn.net/images/p_blog_csdn_net/kanghua/porting.bmp">
     </img>
    </div>
    <div>
    </div>
  ...
  如进程控制块TCB等），这些数据结构必须在迁移后必须仍能被各个进程访问。
     ...
     <div style="MARGIN-LEFT: 63pt; TEXT-INDENT: -21pt">
      u
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f6b616e676875:612f61727469636c652f64657461696c732f31363838313336" class_="artid" style="display:none">
 </p>
</div>
