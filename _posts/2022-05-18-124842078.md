  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     ...
     <a href="http://www.ed2000.com/ShowFile.asp?FileID=275505" rel="nofollow">
    ...
    <pre><code>CAMERA_LIST_T *CCameraDS::GetCameraList()
{
...
BOOL CCaptureVideo::BindToVideoDev(int deviceId, IBaseFilter **pFilter)
{
    ...
    <pre><code>HRESULT CCaptureVideo::SetVideoSize(int nPreview,CString strRGBBytes,int nFrameRate,int iWidth , int iHeight)
{
	HRESULT hr=E_FAIL;
	if(m_pCaptureGraphBulid==NULL)
		return hr;
    ...
    <pre><code>HRESULT CCaptureVideo::CreateVideoRender(int nType)
{
	HRESULT hr = NOERROR;
	if(m_pWindowRender)
	{
    ...
    <pre><code>	hr = CreateCaptureSampleGrabber(m_strRGBByte);
	if(FAILED(hr))
	{
...
//	hr = m_pVideoWin-&gt;put_MessageDrain((OAHWND)m_hWnd);
    ...
    <pre><code>HRESULT CCaptureVideo::StartPreview()
{
	HRESULT hr=NOERROR;
	if(m_pMediaCon==NULL)
	{
    ...
    <pre><code>void CCaptureVideo::OnThreadDeal()
{
	BYTE *pData=NULL;
	long lDatasize=0;
    ...
    <pre><code>        virtual HRESULT STDMETHODCALLTYPE ISampleGrabber：：SetCallback( 
...
//		TRACE("BufferCB:%d-%d-%d-%d\r\n", m_nIndex, m_nDataType, now_tick - first_tick, lBufferSize);
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34323131333331302f:61727469636c652f64657461696c732f313234383432303738" class_="artid" style="display:none">
 </p>
</div>
