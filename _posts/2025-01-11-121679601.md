  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-tomorrow-night" id="content_views">
    ...
    <p>
     ...
     RTP Header格式如下：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/f991d9696f7b103d8c6b7d98e7e0972d.png"/>
    </p>
    <h3>
     <a id="21__8">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2365a6f5998ee418d773510707ceedbd.png">
      <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/eceaa805b2a61dfe88e9b8dac49e0dd9.png"/>
    </p>
    <p>
     如上图，发送端的音视频流并没有对齐，但是周期地发送SR包，接收端得到音视频SR包的RTP时间戳、NTP时间戳后通过线性回归得到NTP时间戳Tntp和RTP时间戳Trtp时间戳的对应关系
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/687a422f8fa6635fcca38d5cf941e6bf.png">
      <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/23809e483626a7a7d76c6e9cd88a386c.png">
      <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2926c199b56cb50005fa9bd024c603a4.png">
      <br/>
    ...
    <pre><code>stream_synchronization.cc:34
StreamSynchronization::ComputeRelativeDelay
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/1c0ac8bf3209717ca3407778dcd501f7.png"/>
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/f781a212da98fe24e2689610a2ee753d.png"/>
    </p>
...
render_delay_ms_(kDefaultRenderDelayMs),
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/4011e448ab7e653545a3e1b305b2fb29.png">
      <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/f780dfbad1a57ab2e873f84ab025e27d.png"/>
     <br/>
     同步器的外部输入有：
    </p>
    <ul>
...
extra_video_delay_ms -&gt; 视频最小播放延迟
    ...
    <pre><code>stream_synchronization.cc:64
StreamSynchronization::ComputeDelays
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/bb76642fb5a687bce7d34fc9e324dfa2.png"/>
     <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/13a8b3e68c4fb098ab5c9640a42a9cb6.png"/>
     <br/>
    ...
    <pre><code>timestamp_extrapolator.cc:137
TimestampExtrapolator::ExtrapolateLocalTime
</code></pre>
    <h5>
     <a id="3512__googleCurrentDelayMs_153">
     </a>
     3.5.1.2 视频当前延迟 googleCurrentDelayMs
    </h5>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/5b70873c3ab231b4a1ba931d8a709e89.png"/>
     <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/0e1a083e033b9a032e1cc8189ac44029.png"/>
     <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/bd946661dc36621d697bea3c083df6f6.png"/>
     <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6aa1a74c4dcc7d8b1766a25e433a11a1.png"/>
    </p>
    <ul>
     <li>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f6c6975686f6e677869616e676d2f:61727469636c652f64657461696c732f313231363739363031" class_="artid" style="display:none">
 </p>
</div>
