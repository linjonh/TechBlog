 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code>npm/cnpm i -g node-gyp</code></pre>
    <p>
     （4）全局安装window-build-tools;(由于下载下来的模块需要编译，所以需要这个工具，如果你本身安装了vs，就不需要这个东西，能自动检测到)
    </p>
    <pre><code>npm i --g --production windows-build-tools </code></pre>
    <p>
     （4）安装node-java模块；
    </p>
    <p>
    ...
    <p>
     <img alt="" height="728" src="https://i-blog.csdnimg.cn/blog_migrate/433ab640579dd83381fcb64f7b4876da.png" width="1200"/>
    </p>
    <p>
     （2） 导入相关jar包（Jedis为例）
    </p>
    ...
    <p>
     <img alt="" height="729" src="https://i-blog.csdnimg.cn/blog_migrate/01c439c49b87f8fcd2adf047bd842d23.png" width="1200"/>
    </p>
    <p>
     导入jar，点击项目结构进入
    </p>
    <p>
     <img alt="" height="699" src="https://i-blog.csdnimg.cn/blog_migrate/f31f8c586e9467c6641c0414a533f7bd.png" width="1162"/>
    </p>
    <p>
     然后选择刚刚放置好的jars，点击勾选，确认即可
    </p>
    <p>
     <img alt="" height="500" src="https://i-blog.csdnimg.cn/blog_migrate/040975ffe23a7f4f40145bb9e1e15f86.png" width="631"/>
    </p>
    <p>
     <img alt="" height="696" src="https://i-blog.csdnimg.cn/blog_migrate/8c43a2115533503170c011835265d050.png" width="1156">
...
public class JedisTool {
    ...
    <p>
     <img alt="" height="709" src="https://i-blog.csdnimg.cn/blog_migrate/50a73b2d3657c03ede0a703708dfddf3.png" width="1165"/>
    </p>
    <p>
     填写主类，这里改成接口类也是可以的（手动改，无法选择接口类）、点击完成、然后点击build--》build artifacts--》build
    </p>
    <p>
     <img alt="" height="196" src="https://i-blog.csdnimg.cn/blog_migrate/4ce715c514815eecba682a6ade3ce942.png" width="282">
      <img alt="" height="226" src="https://i-blog.csdnimg.cn/blog_migrate/f469215f6afb12ebeef130517d113653.png" width="328">
       <img alt="" height="315" src="https://i-blog.csdnimg.cn/blog_migrate/7a12ae37ed3ec1eb2b6093029c9207f8.png" width="289"/>
      </img>
     </img>
    </p>
    <p>
    ...
    <pre><code class="language-javascript">let java = require("java"); //引入nodejs的java模块
...
setInterval(() =&gt; {
  ...
  jedisTool.usePipeline(100000);
    ...
    <p>
     <a href="https://www.npmjs.com/package/java" rel="nofollow">
      node-java文档
     </a>
    ...
    <p>
     <img alt="" height="149" src="https://i-blog.csdnimg.cn/blog_migrate/a02e5c833546130f6aa9343fd9309eb4.png" width="677"/>
    </p>
    <h2>
     <span style="color:#86ca5e;">
      6、补充
 ...
 <p alt="68747470733a2f2f626c6f67:2e6373646e2e6e65742f7169616e6c697869616f6d6167652f:61727469636c652f64657461696c732f313035303538343634" class_="artid" style="display:none">
 </p>
</div>
