 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-sql">gsql -d postgres -U gaussdb -W'passwd123@123';
create database mydb;</code></pre>
    <p>
     第2关：创建表
    </p>
    <h4>
...
\c testdb;
passwd123@123
create table t_emp(id int,name varchar(32),deptid int,salary float);</code></pre>
    <p>
     第3关：使用主键约束
    </p>
    <h4>
...
create table t_user2(name varchar(32),phone varchar(11),email varchar(32),primary key(name,phone));</code></pre>
    <p>
     第4关：添加常用约束
    </p>
    <h4>
...
create table t_user(id serial primary key,username varchar(32) unique not null,sex varchar(4) default '男');
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f7366726c3030312f:61727469636c652f64657461696c732f313330373535363834" class_="artid" style="display:none">
 </p>
</div>
