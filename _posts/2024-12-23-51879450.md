 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <span style="font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px">
     一 常见的WEB服务器和应用服务器
    </span>
    <p style="margin:10px auto; padding-top:0px; padding-bottom:0px; font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px">
     <span style="font-family:Arial; margin:0px; padding:0px">
    ...
    <span style="font-family:Arial; margin:0px; padding:0px; font-size:14px; line-height:21px">
     Tomcat
    </span>
    <span style="font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px">
    </span>
    ...
    <br style="margin:0px; padding:0px; font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px"/>
    <span style="font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px">
     二 web服务器和应用服务器比较
    </span>
    <br style="margin:0px; padding:0px; font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px"/>
    ...
    <div style="margin:0px; padding:0px; font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px">
     <a href="http://www.cnblogs.com/itech/archive/2009/08/18/1548860.html" rel="nofollow noopener noreferrer" target="_blank">
    ...
    <p>
     <span style="font-family:Verdana,Arial,Helvetica,sans-serif; font-size:14px; line-height:21px">
      <a href="http://www.cnblogs.com/zhaoyl/archive/2012/10/10/2718575.html" rel="nofollow noopener noreferrer" target="_blank">
