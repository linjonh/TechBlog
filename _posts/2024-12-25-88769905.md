  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <div class="article fmt article__content">
     ...
     <pre><code> 1. 前端单元测试  （Unit Test以下简称 - UT）
 2. 前端e2e测试
</code></pre>
     <p>
      第1点
     ...
     <p>
      <span class="img-wrap">
       <img alt="clipboard.png" src="https://i-blog.csdnimg.cn/blog_migrate/7bded86483b1416044c3c4b60af20a36.png" title="clipboard.png"/>
      </span>
     </p>
     <p>
     ...
     <p>
      <span class="img-wrap">
       <img alt="clipboard.png" src="https://i-blog.csdnimg.cn/blog_migrate/01b4ec4817120e82b3c040db5f0c7e84.png" title="clipboard.png"/>
      </span>
     </p>
     <p>
     ...
     <pre><code>1. 你写的是个util类，是会被其他类调用的那种？
...
3. 你写的是一个开源项目
     ...
     <pre><code>1.测试团队是否兵强马壮  （基于人海战术的人肉e2e测试）
...
6.每一个迭代周期，留给前端开发的时间是否很紧张 （前端写完业务代码，也要有时间写e2e代码）
     ...
     <p>
      <span class="img-wrap">
       <img alt="clipboard.png" src="https://i-blog.csdnimg.cn/blog_migrate/cf920ec0fbd51a1f7916273d662bd9eb.png" title="clipboard.png"/>
      </span>
      <br/>
     ...
     <pre><code>1. 前端需要对自己写的业务代码负责，写UT又不可靠，那就只有写基与功能模块的AT了
...
module.exports = function UserModule(){
    ...
    // other operations
     ...
     <pre><code>1. 新功能不需要急着写AT，应该交给QA人肉测试，待功能上线后再慢慢补齐
