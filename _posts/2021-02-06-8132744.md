---
layout: post
title: java创建MySQL数据库连接池未完
date: 2021-02-06 21:23:04 +0800
categories: [数据库]
tags: []
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=8132744
    alt: java创建MySQL数据库连接池未完
artid: 8132744
...
                                            ,"jdbc:mysql://192.168.1.19:3306/test"
                                            ,"test"
                                            ,"root");
   //新建数据库连接库
   connPool.createPool();
...
    }  
    ...
    <p>
     <img alt="" src="https://img-my.csdn.net/uploads/201210/31/1351668547_4410.jpg">
      <br/>
     </img>
    </p>
    <br/>
