...
description: "文章浏览阅读5.获取打开小程序任意页面的链接,适用于从短信、邮件、服务端调用  短信打开小程序的三种"
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-github-gist" id="content_views">
    ...
    <pre><code>获取打开小程序任意页面的链接,适用于从短信、邮件、微信外网页等场景打开小程序。 
...
4、NFC标签打开小程序
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34333239343536302f:61727469636c652f64657461696c732f313231323634353134" class_="artid" style="display:none">
 </p>
</div>
