...
int main() {
    ...
    <h3 id="%E4%BA%8C%E3%80%81%E6%9C%8D%E5%8A%A1%E7%AB%AF%E5%AE%9E%E7%8E%B0">
     2.客户端
    </h3>
    <pre><code class="language-cpp">#include&lt;iostream&gt;
using namespace std;
...
#pragma comment(lib, "Ws2_32.lib")</code></pre>
    ...
    <h3 id="%C2%A02.%E5%88%9B%E5%BB%BA%E5%A5%97%E6%8E%A5%E5%AD%97(socket%E5%87%BD%E6%95%B0)" style="background-color:transparent;">
     2.创建套接字(socket函数)
    </h3>
    <p>
     还是先找帮助文档
...
if (sock == INVALID_SOCKET) {
    ...
    <h3 id="%C2%A03.%E5%88%9B%E5%BB%BA%E6%9C%8D%E5%8A%A1%E7%AB%AFsockaddr%EF%BC%8C%E5%A5%97%E6%8E%A5%E5%AD%97%E7%BB%91%E5%AE%9A%E6%9C%8D%E5%8A%A1%E7%AB%AF%E7%9A%84IP%E5%92%8C%E7%AB%AF%E5%8F%A3%E5%8F%B7(bind%E5%87%BD%E6%95%B0)" style="background-color:transparent;">
     3.创建服务端sockaddr，套接字绑定服务端的IP和端口号(bind函数)
    </h3>
    <p>
     <strong>
...
err = bind(sock, (sockaddr*)&amp;addrUDPServer, sizeof(addrUDPServer));</code></pre>
    ...
    <h3 id="4.%E5%81%9A%E6%94%B6%E5%8F%91%E7%9A%84%E5%87%86%E5%A4%87%EF%BC%8C%E5%88%9B%E5%BB%BA%E5%AE%A2%E6%88%B7%E7%AB%AFsockaddr(%E4%B8%8D%E7%94%A8%E8%B5%8B%E5%80%BC)" style="background-color:transparent;">
     4.做收发的准备，创建客户端sockaddr(不用赋值)
    </h3>
...
int addrUDPClientSize = sizeof(addrUDPClient);</code></pre>
    ...
    <h3 id="5.%E6%8E%A5%E6%94%B6%E6%95%B0%E6%8D%AE(recvfrom%E5%87%BD%E6%95%B0)" style="background-color:transparent;">
     5.接收数据(recvfrom函数)
    </h3>
    <p>
...
if (nRecvNum &gt; 0) {
    ...
    <h3 id="%C2%A06.%E5%8F%91%E9%80%81%E6%95%B0%E6%8D%AE(sendto)" style="background-color:transparent;">
     6.发送数据(sendto)
    </h3>
    <p>
...
if (nSendNum == SOCKET_ERROR) {
    ...
    <h3 id="%C2%A07.%E5%85%B3%E9%97%AD%E5%A5%97%E6%8E%A5%E5%AD%97" style="background-color:transparent;">
     7.关闭套接字
    </h3>
    <pre><code class="language-cpp">closesocket(sock);</code></pre>
    <h3 id="8.%E5%8D%B8%E8%BD%BD%E5%BA%93%C2%A0" style="background-color:transparent;">
     8.卸载库
    </h3>
    ...
    <h3 id="1.%E5%8A%A0%E8%BD%BD%E5%BA%93">
     1.加载库
    </h3>
    ...
    <h3 id="2.%E5%88%9B%E5%BB%BAsocket">
     2.创建socket
    </h3>
    ...
    <h3 id="3.%E5%81%9A%E6%94%B6%E5%8F%91%E7%9A%84%E5%87%86%E5%A4%87%EF%BC%8C%E5%88%9B%E5%BB%BA%E6%9C%8D%E5%8A%A1%E7%AB%AFsockaddr(%E7%94%A8%E6%9C%8D%E5%8A%A1%E7%AB%AFIP%E5%92%8C%E7%AB%AF%E5%8F%A3%E5%8F%B7%E8%B5%8B%E5%80%BC)%C2%A0">
     3.做收发的准备，创建服务端sockaddr(用服务端IP和端口号赋值)
    </h3>
    <p>
