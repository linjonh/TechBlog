...
date: 2024-06-24 22:22:01 +0800
description: "文章浏览阅读6.5k次，点赞2次，此文档介绍并定义所使用的*数据库文件格式SQLite.10 数据库"
keywords: "sqlite文档"
categories: ['Android']
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     此文档介绍并定义所使用的*数据库文件格式SQLite.
    </p>
    <h3 style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     10 数据库文件
    </h3>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     ...
     <a href="http://www.helplib.net/s/sqlite/9/494.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
      windows mobile 设备中心
     </a>
    ...
    <h4 style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     11 页
    </h4>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <ul style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    ...
    <a id="database_header" name="database_header" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <h4 style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     12 数据库头
    </h4>
    ...
    <br style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px"/>
    <table border="1" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(0,0,0)" width="80%">
     <tbody style="font-size:10pt">
      <tr style="font-size:10pt">
       <th style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        偏移
       </th>
       <th style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        大小
      ...
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        0
       </td>
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        16
       </td>
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        字符串头: "SQLite 格式300 "
       </td>
      </tr>
      <tr style="font-size:10pt">
      ...
      <tr style="font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        pages 中的数据库文件大小的更改"in-header数据库大小"
       </td>
      </tr>
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
      ...
      <tr style="font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        根最大的页号为视图定义页auto-vacuum 或incremental-vacuum 模式, 或零中时, 否则.
       </td>
      </tr>
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        数据库文本文件组值1表示UTF-8值为2意味着UTF-16le值为3表示UTF-16be
       </td>
      </tr>
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        代理以读/写和"user 版本"
        <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_schema_version" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
         user_version 大全
        </a>
        .
       </td>
      ...
      <tr style="font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        为incremental-vacuum true (非零)模式为false (0)否则
       </td>
      </tr>
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
      ...
      <tr style="font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        "
        <a href="http://www.sqlite.org/fileformat2.html#validfor" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
         version-valid-for 编号
        </a>
        .
       </td>
      </tr>
      <tr style="font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        <a href="http://www.helplib.net/s/sqlite/9/567.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
    ...
    <br style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px"/>
    <h5 style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
     121 magic 头字符串
    </h5>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <a id="usable_size" name="usable_size" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <a id="chngctr" name="chngctr" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <a id="filesize" name="filesize" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     ...
     <a href="http://www.sqlite.org/fileformat2.html#chngctr" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
      更改计数器
     </a>
     在偏移位置完全匹配24 4字节
     <a href="http://www.sqlite.org/fileformat2.html#validfor" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
    ...
    <ol style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
     <li style="font-size:10pt" value="1">
      1, 可以被所有的SQLite 回版本300
     </li>
     <li style="font-size:10pt" value="2">
      格式2将同一表中的行的能力具有可变数目的列, 为了支持
      <a href="http://www.helplib.net/s/sqlite/9/202.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
       ALTER TABLE ...ADD COLUMN
      </a>
      功能阅读和编写格式支持SQLite 版本3中新增21在2005-02-19 3
     </li>
     <li style="font-size:10pt" value="3">
      格式3添加了能力通过添加额外的列
      <a href="http://www.helplib.net/s/sqlite/9/202.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
       ALTER TABLE ...ADD COLUMN
      </a>
     ...
     <li style="font-size:10pt" value="4">
      格式4导致SQLite 尊重上的DESC 关键字索引声明(将忽略DESC 关键字中没有为格式1、2和34 的格式.)添加两个新的boolean 类型值(记录
      <a href="http://www.sqlite.org/fileformat2.html#serialtype" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
       串行类型
      </a>
    ...
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     ...
     <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_legacy_file_format" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
      legacy_file_format 大全
     </a>
    ...
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     ...
     <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_default_cache_size" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
      default_cache_size 大全
     </a>
     .
    </p>
    <h5 style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    ...
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     ...
     <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_auto_vacuum" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
      auto_vacuum
     </a>
     和
     <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_incremental_vacuum" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
      incremental_vacuum
     </a>
    ...
    <a id="validfor" name="validfor" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <h5 style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    ...
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
     ...
     <a href="http://www.helplib.net/s/sqlite/9/11.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
      VFS
     </a>
    ...
    <a id="freelist" name="freelist" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <h4 style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <a id="cell_payload" name="cell_payload" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <table border="1" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(0,0,0)" width="80%">
     <tbody style="font-size:10pt">
      ...
      <tr style="font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        一个表示视图定义标志值2表示该页面是内部索引视图定义页值为5表示该页是一个内部表视图定义页一个值为10 表明该页为叶索引视图定义页一个值为13 表明该页为叶表视图定义页其他任何值为id1 页类型是一个错误
       </td>
      </tr>
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
      ...
      <tr style="font-size:10pt">
       ...
       <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        内容区域的单元格要变换的第一个字节一个零值为用来表示一个偏移位置, 16.7m 发生在空的根元素, 包含在页面当您使用65536-byte
       </td>
      </tr>
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <a id="varint" name="varint" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    </span>
    <p style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
    ...
    <blockquote style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
    ...
    <a id="cellformat" name="cellformat" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(4,74,100)">
    </a>
    <span style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px">
     视图定义单元格格式
    </span>
    ...
    <table border="1" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(0,0,0)" width="80%">
     <tbody style="font-size:10pt">
      <tr style="font-size:10pt">
       <th rowspan="2" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        数据类型
       </th>
       <th colspan="4" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        出现在......
       </th>
       <th rowspan="2" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        说明
    ...
    <br style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px"/>
    <table style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:13px; color:rgb(0,0,0)">
     <tbody style="font-size:10pt">
      <tr style="font-size:10pt">
       <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        ...
        <p style="font-size:10pt">
         指针地图上或ptrmap 页面的是空白页面插入到数据库中要使操作
         <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_auto_vacuum" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          auto_vacuum
         </a>
         和
         ...
         在"导航"模式更有效在数据库中其他网页类型通常具有指针从父与子表例如, 内部视图定义页面中包含其子id1 指向网页和溢出某一个指针字段中设置证书链中的链接一个ptrmap 页面中包含链接信息在相对方向上, 从子父
        </p>
        <p style="font-size:10pt">
        ...
        <ol style="font-size:10pt">
         ...
         <li style="font-size:10pt">
          一个单元格负载第一页的溢出链该值已超出该视图定义包含该单元格的内容页面溢出
         </li>
         <li style="font-size:10pt">
          发生溢出链中的页行或列的第一个页该值已溢出先前的页的链
         </li>
         <li style="font-size:10pt">
          非root 用户视图定义页该值已父视图定义页
         </li>
        </ol>
        <p style="font-size:10pt">
        ...
        <a id="record_format" name="record_format" style="font-size:10pt; color:rgb(4,74,100)">
        </a>
        <h4 style="font-size:10pt">
         21 记录格式
        </h4>
        ...
        <p style="font-size:10pt">
         记录格式提供的使用
         <a href="http://www.sqlite.org/fileformat2.html#varint" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          长度可变的整数
         </a>
         或
         <a href="http://www.sqlite.org/fileformat2.html#varint" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
        ...
        <a id="serialtype" name="serialtype" style="font-size:10pt; color:rgb(4,74,100)">
        </a>
        <p style="font-size:10pt">
        ...
        <br style="font-size:10pt"/>
        <table border="1" style="font-size:10pt" width="80%">
         <tbody style="font-size:10pt">
          <tr style="font-size:10pt">
           <th style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            串行类型
          ...
          <tr style="font-size:10pt">
           ...
           <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            big-endian 24 位twos-complement 整数
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
           ...
           <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            big-endian 32 位twos-complement 整数
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
           ...
           <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            big-endian 正向twos-complement 整数
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
           ...
           <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            big-endian 64 位twos-complement 整数
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
           ...
           <td align="left" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            big-endian IEEE 数字754-2008 64 位浮点数
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
          ...
          <tr style="font-size:10pt">
           ...
           <td align="left" class="c7" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt; font-style:italic">
            未使用保留的扩展
           </td>
          </tr>
          <tr style="font-size:10pt">
        ...
        <ol style="font-size:10pt">
         ...
         <li style="font-size:10pt">
          数值(串口类型1至9)next 并按照数字顺序进行排序
         </li>
         <li style="font-size:10pt">
          文本值(甚至串行12 和更大的)排序的顺序由列
          <a href="http://www.sqlite.org/datatype3.html#collation" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
           比较函数
          </a>
         </li>
         <li style="font-size:10pt">
          BLOB 值(奇数串行类型13 和更大的)确定memcmp() 顺序最后进行排序.
         </li>
        </ol>
        <p style="font-size:10pt">
         一个
         ...
         对于每一个列是必要的计算中的文本.SQLite 定义三种内置的比较功能:
        </p>
        <blockquote style="font-size:10pt">
         <table border="0" cellspacing="10" style="font-size:10pt">
          <tbody style="font-size:10pt">
           <tr style="font-size:10pt">
            <td style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
             BINARY
            </td>
            <td style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
           ...
           <tr style="font-size:10pt">
            ...
            <td style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
             类似BINARY 只不过大写ASCII 字符(''a 通过''z '' '' )将页它们的小写形式相当于运行就是这样的比较注意只有ASCII 字符都case-foldedNOCASE 不实现一个通用unicode caseless 比较
            </td>
           </tr>
           <tr style="font-size:10pt">
            <td style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        ...
        <p style="font-size:10pt">
         其他特定于应用程序的比较函数可以添加到SQLite 使用
         <a href="http://www.helplib.net/s/sqlite/9/569.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          sqlite3_create_collation( )
         </a>
         接口.
        </p>
        <p style="font-size:10pt">
         默认的比较函数的所有字符串是BINARY可选中指定的比较顺序的函数表的列可以是
         <a href="http://www.helplib.net/s/sqlite/9/203.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          CREATE TABLE
         </a>
         使用COLLATE 子句的语句
         <a href="http://www.sqlite.org/lang_createtable.html#tablecoldef" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          列定义
         </a>
         仅当使用了列的索引是, 在执行比较函数中指定的
         <a href="http://www.helplib.net/s/sqlite/9/203.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          CREATE TABLE
         </a>
         语句用于该列中的索引.默认情况下.虽然此可重写的使用COLLATE 子句的select 语句中
         <a href="http://www.helplib.net/s/sqlite/9/518.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          CREATE INDEX
         </a>
         语句.
        </p>
        ...
        <p style="font-size:10pt">
         架构中的每个普通SQL 表在数据库中支持事务磁盘上的表视图定义在表中的每一项都视图定义对应于SQL 表中的某一行"
         <a href="http://www.sqlite.org/lang_createtable.html#%E6%9C%AA%E5%AF%B9id" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          未对id
         </a>
         键盘的SQL 是64 位有符号整数对于表中的每一项都页p_id1
        </p>
        <p style="font-size:10pt">
         将每个SQL 表的内容存储在数据库中文件的第一个组合用各种列中的值为byte 数组在记录格式然后将应用程序的字节数组作为存储在表中的输入项视图定义值在记录的顺序相同中列的顺序SQL 表定义如果SQL 表, 其中包含
         <a href="http://www.sqlite.org/lang_createtable.html#rowid" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          INTEGER PRIMARY KEY
         </a>
         列(别名
         <a href="http://www.sqlite.org/lang_createtable.html#%E6%9C%AA%E5%AF%B9id" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
         ...
         该列中), 则出现在记录作为NULL 值SQLite将一直使用该表视图定义key , 而不是使用NULL 值在引用
         <a href="http://www.sqlite.org/lang_createtable.html#rowid" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          INTEGER PRIMARY KEY
         </a>
         列.
        ...
        <p style="font-size:10pt">
         如果
         <a href="http://www.sqlite.org/datatype3.html#%E7%9B%B8%E4%BC%BC%E6%80%A7" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          相似性
         </a>
         在列是否REAL , 并且含有数值的列可以转换为整数在不损失信息(如果该值包含不明确的小数部分和太大, 无法表示为整数), 则该列会存储在记录为整数SQLite转换回浮点值当从记录提取它
        </p>
        <h4 style="font-size:10pt">
         2SQL 的索引%4表示形式
        </h4>
        <p style="font-size:10pt">
         每个SQL 索引, 不管是通过显式地声明变量.
         <a href="http://www.helplib.net/s/sqlite/9/518.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          CREATE INDEX
         </a>
         语句或UNIQUE 约束所隐含的, 对应于一个索引id1 在数据库文件有多个条目索引视图定义中的相应的表中的每一行密钥添加到索引视图定义是一个记录中的正在编入索引的列都有
         <a href="http://www.sqlite.org/lang_createtable.html#%E6%9C%AA%E5%AF%B9id" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          未对id
         </a>
         表行在表中每行的, 因为有一个唯一的未对id 和所有键可以在索引中包含未对id , 在索引中的所有项都是唯一的
        </p>
        <p style="font-size:10pt">
        ...
        <blockquote style="font-size:10pt">
         <pre style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">CREATE TABLE sqlite_master( 
请键入文字, 
名称文本.
tbl_name 文本.
rootpage 整数, 
sql 文本
        ...
        <p style="font-size:10pt">
         在sqlite_master类型列将下列文本串: 'able ", ''index ", ''view ", 或'rigger "根据定义的类型的对象'able'' string 是用于普通和
         <a href="http://www.helplib.net/s/sqlite/9/528.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          虚拟表
         </a>
         .
        </p>
        ...
        <p style="font-size:10pt">
         在sqlite_mastersql 列存储SQL 文本, 它描述对象此SQL 文本.
         <a href="http://www.helplib.net/s/sqlite/9/203.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          CREATE TABLE
         </a>
         ,
         <a href="http://www.helplib.net/s/sqlite/9/18.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
         ...
         ,
         <a href="http://www.helplib.net/s/sqlite/9/514.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          CREATE VIEW
         </a>
         或
         <a href="http://www.helplib.net/s/sqlite/9/509.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          CREATE TRIGGER
         </a>
         如果数据库中的语句, 当它是主数据库中的特定文件
         <a href="http://www.helplib.net/s/sqlite/9/149.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          数据库连接
         </a>
         将重新创建该对象在文本)通常是一个副本sysconst.bak 语句用于创建该对象但应用normalizations , 使文字符合以下规则:
        </p>
        <ul style="font-size:10pt">
         <li style="font-size:10pt">
        ...
        <p style="font-size:10pt">
         在sqlite_mastersql 列是一副本sysconst.bak CREATE 文本.创建此对象的语句中, 除了标准化如上面所述, 也可以修改由后续的
         <a href="http://www.helplib.net/s/sqlite/9/202.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          ALTER TABLE
         </a>
         语句.
        ...
        <a id="rollbackjournal" name="rollbackjournal" style="font-size:10pt; color:rgb(4,74,100)">
        </a>
        <h3 style="font-size:10pt">
         30 安装的"回滚日记
        </h3>
        <p style="font-size:10pt">
         在安装的"回滚日志是一个文件与每个SQLite 相关联的数据库文件, 它包含用来将数据库文件还原到它的初始状态的事务在安装的"回滚日记文件始终位于同一个目录作为文件和数据库有相同的名称数据库文件, 但替换为"
         <tt style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
          -journal
         </tt>
         "附加只能存在一个日志回滚相关联的数据库和因此, 只能有一个事务来说, 打开针对单个数据库
        </p>
        <p style="font-size:10pt">
        ...
        <ol style="font-size:10pt">
         ...
         <li style="font-size:10pt">
          可以被改写代码日志回滚使用无效标题.文本(例如, 所有的zeros) .
         </li>
        </ol>
        有三种方法的提交事务对应于DELETE, TRUNCATE, 和PERSIST 设置, 分别
        <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_journal_mode" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
         journal_mode 大全
        </a>
        .
        <p style="font-size:10pt">
        ...
        <table border="1" style="font-size:10pt" width="80%">
         <tbody style="font-size:10pt">
          ...
          <tr style="font-size:10pt">
           ...
           <td style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            标题字符串: 0xd9 、0xd5 0x05 , 0xf9 , 0x20 , 0xa1 , 0x63 , 0xd7
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        ...
        <ol style="font-size:10pt">
         <li style="font-size:10pt">
          初始化nonce 的校验和到校验和值在日记中找到页眉在偏移位置12 .
         </li>
         <li style="font-size:10pt">
          初始化索引xn-200 (其中n是数据库的大小以字节为单位的页面.
         </li>
         <li style="font-size:10pt">
          解释要四个字节的偏移量x至页面为4字节大端字节无符号整数向校验和的值的整数
         </li>
         <li style="font-size:10pt">
          subtrace 200 x.
         </li>
        ...
        <a id="walformat" name="walformat" style="font-size:10pt; color:rgb(4,74,100)">
        </a>
        <h3 style="font-size:10pt">
         40 Write-Ahead 日志
        </h3>
        <p style="font-size:10pt">
         开始
         <a href="http://www.sqlite.org/releaselog/3_7_0.html" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          版本370
         </a>
         , SQLite 支持新的事务控制机制称为"
         <a href="http://www.helplib.net/s/sqlite/9/494.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
         ...
         "当数据库处于WAL 模式, 该数据库的所有连接, 必须使用WAL特定数据库将使用一个回滚日记或一个WAL, , 但不能同时在相同的时间WAL始终位于同一个目录作为文件和数据库具有相同的名称数据库文件, 但替换为"
         <tt style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
          -wal
         </tt>
         "追加.
        ...
        <table border="1" style="font-size:10pt" width="80%">
         <tbody style="font-size:10pt">
          ...
          <tr style="font-size:10pt">
           ...
           <td style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            magic number0x377f0682 或0x377f0683
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        ...
        <br style="font-size:10pt"/>
        <p style="font-size:10pt">
         wal-header 由于下列原因是零个或多个帧每个框架由24-byte frame-header 后面跟一个
         <span style="font-size:10pt">
          page-size
         </span>
         字节的页数据frame-header为六个big-endian 32 位无符号整数值, 如下所示:
        </p>
        <span style="font-size:10pt">
         WAL 框架页眉格式
        </span>
        ...
        <table border="1" style="font-size:10pt" width="80%">
         <tbody style="font-size:10pt">
          ...
          <tr style="font-size:10pt">
           ...
           <td style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
            checksum-1 : 累计checksum 通过和其中包括此页
           </td>
          </tr>
          <tr style="font-size:10pt">
           <td align="center" style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
        ...
        <ol style="font-size:10pt">
         <li style="font-size:10pt">
          <p style="font-size:10pt">
           在"frame-header salt-1 和salt-2 值在wal-header 盐值相匹配
          </p>
         </li>
         <li style="font-size:10pt">
          <p style="font-size:10pt">
           在最终的8个字节的校验和值frame-header 完全匹配的校验和计算的连续WAL 页眉和8个字节和所有帧的内容并包括在当前帧中
          </p>
         </li>
        </ol>
        <a id="walcksm" name="walcksm" style="font-size:10pt; color:rgb(4,74,100)">
        </a>
        <h4 style="font-size:10pt">
         42 校验和算法
        </h4>
        ...
        <blockquote style="font-size:10pt">
         <pre style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">s0 =s1 =0
...
#导致s0 和s1 
        ...
        <p style="font-size:10pt">
         上
         <a href="http://www.sqlite.org/wal.html#ckpt" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          检查点
         </a>
         刷新WAL 首先, 使用xsync 持久存储的方法
         <a href="http://www.helplib.net/s/sqlite/9/165.shtml" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          VFS
         </a>
         然后有效WAL 传递到数据库中文件的内容最后, 该数据库已被另一个程序使用的条目数持久存储使用xsync 方法调用在您的xsync 操作作为写入栅-所有通用属性之前, 必须首先完成xsync 在xsync 开始运行之后的所有写入一个文件
        </p>
        <p style="font-size:10pt">
         在每次检查点, WAL 页眉salt-1 值增加和salt-2 值为randomized这将防止新旧帧WAL 被认为是有效的很长的时间和操作在一起了下列一个崩溃
        </p>
        <a id="walread" name="walread" style="font-size:10pt; color:rgb(4,74,100)">
        </a>
        <h4 style="font-size:10pt">
         44 读取器算法
        </h4>
        ...
        <a id="walindexformat" name="walindexformat" style="font-size:10pt; color:rgb(4,74,100)">
        </a>
        <h4 style="font-size:10pt">
         45 WAL-Index 格式
        </h4>
        <p style="font-size:10pt">
         从概念上讲, 到的wal-index 是共享的内存, wal-index 当前VFS 实现使用mmapped 文件为: mmapped 文件不在同一个目录作为数据库和具有相同的名称作为具有"数据库
         <tt style="font-family:宋体,Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:10pt">
          -shm
         </tt>
         "后缀附加由于wal-index 是共享的内存, SQLite 不支持
         <a href="http://www.sqlite.org/%E5%A4%A7%E5%85%A8.html#%E5%A4%A7%E5%85%A8_journal_mode" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          journal_mode=WAL
         </a>
         在网络上文件系统当客户机安装在不同的计算机上所有用户的数据库必须能共享相同的内存
        </p>
        <p style="font-size:10pt">
         在wal-index 的目的在于快速这个问题的答案:
        </p>
        <blockquote class="c8" style="font-size:10pt; font-style:italic">
        ...
        <p style="font-size:10pt">
         ...
         在下一段的值为"mxframe "〗中定义的
         <a href="http://www.sqlite.org/fileformat2.html#walread" rel="nofollow" style="font-size:10pt; color:rgb(115,69,89)">
          第5节4
         </a>
         可被在事务开始处然后从WAL , 它定义了这个最大帧读取器将使用的端点
        </p>
        <p style="font-size:10pt">
...
#导致s0 和s1 
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f6368656e67686169323031:312f61727469636c652f64657461696c732f37333336393036" class_="artid" style="display:none">
 </p>
</div>
