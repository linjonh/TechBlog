 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-bash">npm install java --save</code></pre>
    <p>
    ...
    <pre><code class="language-javascript">const java = require("java")
...
console.log(list2.getSync(1))//b</code></pre>
    <p>
     运行程序，打印信息如下：
     <img alt="" class="left" src="https://i-blog.csdnimg.cn/blog_migrate/b2bc0cfb23f52b5c7712b045828eb61d.png"/>
    </p>
    <p>
...
public class Test{
    ...
    <p style="text-align:center;">
     <img alt="" class="left" src="https://i-blog.csdnimg.cn/blog_migrate/f4a9bfe5bb663020bbd1cf9a854c47b3.png"/>
    </p>
    <p>
     准备js调用java代码test.js：
    </p>
...
console.log(res)</code></pre>
    ...
    <p style="text-align:center;">
     <img alt="" class="left" src="https://i-blog.csdnimg.cn/blog_migrate/8372861391a1d7e4eb4d851aa77a4437.png"/>
    </p>
    <p>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f6665696e6966692f:61727469636c652f64657461696c732f313237373430303034" class_="artid" style="display:none">
 </p>
</div>
