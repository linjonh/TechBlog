...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/891c086b8beb482cb51db1764c38be71.png#pic_center"/>
    </p>
    <p>
     <strong>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/728ef90926d1466f8f7b7b05b1b33387.png#pic_center"/>
    </p>
    <p>
     2.敲命令npm run build 此命令为编译命令，如果你的Node.js版本和源码程序版本兼容性较好，期间不会有警告提示，如果有警告提示(红体字)只要没停止运行就不用管
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a2bddba1d8a247a58d96f60dac5f6475.png#pic_center"/>
    </p>
    <p>
     3.命令执行完以后会在根目录生成dist文件夹，此文件夹下的所有文件就是admin编译后的文件，把他复制到对应的public/admin下面即可
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c373080143a7490ab85d4eda45715848.png#pic_center"/>
    </p>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0e9eb2a68db342aaa89d8e9413a7ab77.png#pic_center"/>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34333438333930302f:61727469636c652f64657461696c732f313436313935383234" class_="artid" style="display:none">
 </p>
</div>
