 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre class="has"><code class="language-bash">#示例，会优先从/home/xiaowp/include路径去搜索#include &lt;xxx.h&gt;的头文件
gcc foo.c -I/home/xiaowp/include -o foo</code></pre>
    <p>
    ...
    <pre class="has"><code class="language-bash"># cpp -v
...
End of search list.</code></pre>
    ...
    <pre class="has"><code>#添加动态链接库搜索路径
gcc foo.c -L/home/xiaowp/lib -lfoo -o foo

#添加静态链接库搜索路径
gcc foo.c -L/home/xiaowp/lib -static -lfoo -o foo</code></pre>
    <p>
    ...
    <pre class="has"><code class="language-bash"># 查看glib库的包名
$ pkg-config --list-all|grep glib*
glib-2.0  GLib - C Utility Library</code></pre>
    <p>
    ...
    <pre class="has"><code># 编译glib应用程序，方法1
...
gcc `pkg-config glib-2.0 --cflags --libs` glib_test.c -o glib_test</code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f753031303432393833312f:61727469636c652f64657461696c732f313033313530383933" class_="artid" style="display:none">
 </p>
</div>
