 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <span style="color:#0d0016;">
      <img alt="" src="https://i-blog.csdnimg.cn/direct/1ffe4e3b4c9642d0ac8ffb77ec316303.jpeg"/>
     </span>
    </p>
    <p>
     <strong>
    ...
    <pre><code class="language-java">//估计硬编码码率, 可以根据实际机型调整
public static int estimate_video_hardware_kbps(int width, int height, int fps, boolean is_h264) {
    ...
    <pre><code class="language-java">if (videoEncodeType == 1) {
 ...
 * @return {0} if successful
 */
public native int SetVideoHWEncoderMaxBitrate(long handle, long hw_max_bitrate);</code></pre>
    <p>
     <span style="color:#0d0016;">
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f72656e687569313131322f:61727469636c652f64657461696c732f313433313430383230" class_="artid" style="display:none">
 </p>
</div>
