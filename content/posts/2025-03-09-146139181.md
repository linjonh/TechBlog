...
## 思路和时间复杂度
  ...
  2. 时间复杂度： ![O\(n\)](https://latex.csdn.net/eq?O%28n%29)

两个数组的建立是![O\(n\)](https://latex.csdn.net/eq?O%28n%29)，然后遍历求当前雨水高度时，如果呈现U字形，在底部正中央需要遍历所有元素，在偏离两侧的节点中，会逐渐减少，应该是小于![O\(n^2\)](https://latex.csdn.net/eq?O%28n%5E2%29)
