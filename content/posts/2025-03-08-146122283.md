  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/366a01e781cd4a598fee01ae6bccd67d.png"/>
    </p>
    <h3>
    ...
    <p style="text-align:center">
     <img alt="f(x) = w^T x + b" class="mathcode" src="https://latex.csdn.net/eq?f%28x%29%20%3D%20w%5ET%20x%20&amp;plus;%20b"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="P(y=1|x) = \frac{1}{1 + e^{A f(x) + B}}" class="mathcode" src="https://latex.csdn.net/eq?P%28y%3D1%7Cx%29%20%3D%20%5Cfrac%7B1%7D%7B1%20&amp;plus;%20e%5E%7BA%20f%28x%29%20&amp;plus;%20B%7D%7D"/>
    </p>
    <p>
     其中：
    </p>
     ...
     <li>
      ...
      <ul>
       ...
       <li>
        ...
        <br/>
        <br/>
        <img alt="v\sum_{i=1}^{N} \left[ y_i \log P(y=1|x_i) + (1 - y_i) \log (1 - P(y=1|x_i)) \right]i=1" class="mathcode" src="https://latex.csdn.net/eq?v%5Csum_%7Bi%3D1%7D%5E%7BN%7D%20%5Cleft%5B%20y_i%20%5Clog%20P%28y%3D1%7Cx_i%29%20&amp;plus;%20%281%20-%20y_i%29%20%5Clog%20%281%20-%20P%28y%3D1%7Cx_i%29%29%20%5Cright%5Di%3D1"/>
       </li>
       <li>
        这个公式与
        <strong>
...
[[0.39216467 0.60783533]
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f49545f4f5241434c452f:61727469636c652f64657461696c732f313436313232323833" class_="artid" style="display:none">
 </p>
</div>
