 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-cs">  public class Person : Interface1, Interface2//默认public
  {
  }</code></pre>
    <p>
     接口则是多继承，一个接口可以继承多个接口
    </p>
    <pre><code class="language-cs">interface Interface2:Interface1,Interface3
{   
    ...
    <pre><code class="language-cs">DataSet set = new DataSet()
...
type.GetMethods();
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f6868773139393131322f:61727469636c652f64657461696c732f313436313136303632" class_="artid" style="display:none">
 </p>
</div>
