...
合并后的数据已保存到 C:\TELCEL_MEXICO_BOT\A\合并后的数据表.xlsx</code></pre>
    <p>
     vlookup后的异常值处理
    </p>
    <pre><code class="hljs"># 读取数据
df_grade = pd.read_excel(grade_path)
    班级    学号  语文   数学  英语
0  C01  S001  99   84  88
1  C01  S002  66   95  77
...
9  C01  S010  89   99  67   0  0</code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f35363237363630372f:61727469636c652f64657461696c732f313436303634323830" class_="artid" style="display:none">
 </p>
</div>
