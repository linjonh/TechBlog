 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-javascript">for (let i = 0; i &lt; total; i++)
                    {
    ...
    <pre><code>假设已知切片的级别、行号和列号，求对应的 bundlx 文件：
...
（4）读取切片
offset 之后 length 个字节，就是切片的图片流。</code></pre>
    <p>
    ...
    <pre><code>假设已知切片的级别、行号和列号，求对应的 bundle 文件：
...
offset 之后 length 个字节，就是切片的图片流。</code></pre>
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f74767264646d73732f:61727469636c652f64657461696c732f313436323330333139" class_="artid" style="display:none">
 </p>
</div>
