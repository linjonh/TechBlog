...
1. record\_type（记录的类型，0-普通，1-目录项，2-最小，3-最大）
2. next\_record(下一条记录)
...
1. 结果值从最好到最坏依次是:
   ...
   system > ⭐️const️ > eq\_ref > ⭐️ref > fulltext > ref\_or\_null > index\_merge > unique\_subquery > index\_subquery > ⭐️range（底线） > index > ALL
