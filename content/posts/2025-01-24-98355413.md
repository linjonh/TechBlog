---
arturl_encode: "68747470733a2f2f626c6f67:2e6373646e2e6e65742f77656978696e5f3330343537343635:2f61727469636c652f64657461696c732f3938333535343133"
layout: post
...
![](https://i-blog.csdnimg.cn/blog_migrate/e857b34a4aab1bdcb5f4fc1a83e1b424.webp?x-image-process=image/format,png)

菜单命令是alt+菜单项的第一个字母，可以调试，在第一次用的时候，可以需要配置一下目录，如下：

![](https://i-blog.csdnimg.cn/blog_migrate/07351b16c253732235821a4a693fecf9.webp?x-image-process=image/format,png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/2955e00427cdc7bd79785687e9988195.webp?x-image-process=image/format,png)

3、dev-C++：是windows下一款开发c/c++的开发环境，使用gcc为编译器，遵循标准，功能比较强大，语法高亮，可以进行单步调试（这对排除错误很重要),进行断点设置等功能，遵循C标准，是一款很强大的开发工具。

![](https://i-blog.csdnimg.cn/blog_migrate/9025bf06ec4af43b64f0852d3b4e7efd.webp?x-image-process=image/format,png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ac58528f7551f81a027289e5ed6e7a13.webp?x-image-process=image/format,png)

5、啊哈C 轻量级c语言编程软件 v2.0 绿色免费版

啊哈C是一个不错的轻量级C语言编程入门软件，使用gcc内核编译，支持语法高亮，代码折叠，编译错误提示等，界面简介，操作方便，非常适合C语言学习入门使用。

![](https://i-blog.csdnimg.cn/blog_migrate/c99375c9fd75e00ba8ef99e97d45fc7c.webp?x-image-process=image/format,png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/1cf1c77eccf347df8e604c4906f05491.webp?x-image-process=image/format,png)
