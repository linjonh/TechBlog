...
找到：PASS\_MAX\_DAYS     99999

改为：PASS\_MAX\_DAYS       30
...
需要全部清空的话：[root@localhost ~]# vim  ~/.bash\_logout
...
root@localhost ~]# echo “export TMOUT=30” >> ~/.bash\_profile #终端30秒不做任何操作将自动注销

[root@localhost ~]# source ~/.bash\_profile #使其生效
