...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/153cc28e1f1d4f28bfdf0165358e4fb8.png"/>
    </p>
    <hr/>
    <h3>
     <a id="_5">
    ...
    <div class="toc">
     ...
     <ul>
      <li>
       <a href="#20240927_0" rel="nofollow">
        计算机前沿技术-人工智能算法-大语言模型-最新研究进展-2024-09-27
       </a>
      </li>
      <li>
       <ul>
        ...
        <li>
         <a href="#1_VisScience_An_Extensive_Benchmark_for_Evaluating_K12_Educational_Multimodal_Scientific_Reasoning_10" rel="nofollow">
      ...
      <li>
       <a href="#VisScience__K12__13" rel="nofollow">
      ...
      <li>
       <ul>
        ...
        <li>
         <a href="#2_CIBench_Benchmarking_Contextual_Integrity_of_AI_Assistants_on_Synthetic_Data_51" rel="nofollow">
        ...
        <li>
         <a href="#3_Drift_to_Remember_92" rel="nofollow">
          3. Drift to Remember
         </a>
        </li>
        <li>
        ...
        <li>
         <a href="#4_OAEILLM_A_Benchmark_Dataset_for_Understanding_Large_Language_Model_Hallucinations_in_Ontology_Matching_131" rel="nofollow">
        ...
        <li>
         <a href="#5_The_use_of_GPT4o_and_Other_Large_Language_Models_for_the_Improvement_and_Design_of_SelfAssessment_Scales_for_Measurement_of_Interpersonal_Communication_Skills_166" rel="nofollow">
        ...
        <li>
         <a href="#6_Normalized_Narrow_Jump_To_Conclusions_Normalized_Narrow_Shortcuts_for_Parameter_Efficient_Early_Exit_Transformer_Prediction_206" rel="nofollow">
        ...
        <li>
         <a href="#7_Will_Large_Language_Models_be_a_Panacea_to_Autonomous_Driving_254" rel="nofollow">
        ...
        <li>
         <a href="#8_LoopResidual_Neural_Networks_for_Iterative_Refinement_299" rel="nofollow">
        ...
        <li>
         <a href="#9_LLMs_are_OneShot_URL_Classifiers_and_Explainers_340" rel="nofollow">
        ...
        <li>
         <a href="#10_Can_Large_Language_Models_Logically_Predict_Myocardial_Infarction_Evaluation_based_on_UK_Biobank_Cohort_382" rel="nofollow">
    ...
    <hr/>
    <h3>
     <a id="1_VisScience_An_Extensive_Benchmark_for_Evaluating_K12_Educational_Multimodal_Scientific_Reasoning_10">
     </a>
     1. VisScience: An Extensive Benchmark for Evaluating K12 Educational Multi-modal Scientific Reasoning
    </h3>
    <p>
    ...
    <h2>
     <a id="VisScience__K12__13">
     </a>
     VisScience: 评估 K12 教育多模态科学推理能力的一个广泛的基准
    </h2>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/585c9372e98a4859b5b1c003bbb33c6f.png"/>
    </p>
    <h3>
     <a id="_15">
     </a>
    ...
    <ul>
     ...
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8007fd781e0443e288435c5db4a75e62.png"/>
     </li>
    </ul>
    <h3>
     <a id="_30">
    ...
    <ul>
     ...
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/db5fd2420948492d94759c8c47e97609.png">
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/afbbf299488c48d78998cb62b3ace87a.png"/>
      </img>
     </li>
    </ul>
    <h3>
    ...
    <h3>
     <a id="2_CIBench_Benchmarking_Contextual_Integrity_of_AI_Assistants_on_Synthetic_Data_51">
     </a>
     2. CI-Bench: Benchmarking Contextual Integrity of AI Assistants on Synthetic Data
    </h3>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e631e1d05a31497db984aa4acf5cd927.png"/>
    </p>
    <h3>
     <a id="_58">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1fe8353bd9634870a98afc383b1942cf.png"/>
    </p>
    <h3>
     <a id="_65">
     </a>
    ...
    <ul>
     ...
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c817b4c0f59646cabfe844faf53efc3f.png"/>
     </li>
    </ul>
    <h3>
     <a id="_74">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3381ad05c74b49268851f68fac84898b.png">
      <br/>
    ...
    <ul>
     ...
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/39782f62eb9b43ef8740298b97bb26a1.png">
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ba08aeca48dd449ea2f5cf3e588d485e.png"/>
      </img>
     </li>
    </ul>
    <h3>
    ...
    <h3>
     <a id="4_OAEILLM_A_Benchmark_Dataset_for_Understanding_Large_Language_Model_Hallucinations_in_Ontology_Matching_131">
     </a>
     4. OAEI-LLM: A Benchmark Dataset for Understanding Large Language Model Hallucinations in Ontology Matching
    </h3>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/2a60a46be6b54c4a83e09a1345dcb1e9.png"/>
     <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8b52d04b34924a32abea3a689959722f.png"/>
    </p>
    <h3>
     <a id="_157">
     </a>
    ...
    <h3>
     <a id="5_The_use_of_GPT4o_and_Other_Large_Language_Models_for_the_Improvement_and_Design_of_SelfAssessment_Scales_for_Measurement_of_Interpersonal_Communication_Skills_166">
     </a>
     5. The use of GPT-4o and Other Large Language Models for the Improvement and Design of Self-Assessment Scales for Measurement of Interpersonal Communication Skills
    </h3>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e5b1a1d59f694e9aaaf5e1c9debc8aa3.png"/>
     <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c34b4c284c7848c58245c95fbb41c0e8.png"/>
    </p>
    <h3>
     <a id="_199">
     </a>
    ...
    <h3>
     <a id="6_Normalized_Narrow_Jump_To_Conclusions_Normalized_Narrow_Shortcuts_for_Parameter_Efficient_Early_Exit_Transformer_Prediction_206">
     </a>
     6. Normalized Narrow Jump To Conclusions: Normalized Narrow Shortcuts for Parameter Efficient Early Exit Transformer Prediction
    </h3>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/33af634474df44bdb4bca98a4b0cdd66.png"/>
     <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/68fa39d2f3584c619855978e82ccbfdd.png"/>
    </p>
    <h3>
     <a id="_244">
     </a>
    ...
    <h3>
     <a id="7_Will_Large_Language_Models_be_a_Panacea_to_Autonomous_Driving_254">
     </a>
     7. Will Large Language Models be a Panacea to Autonomous Driving?
    </h3>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c36e6e8bce7149c4972e0aa3e92a7f6a.png"/>
    </p>
    <p>
     大型语言模型会是自动驾驶的灵丹妙药吗？
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/6aa6b36299e642d882a73642d2583919.png"/>
    </p>
    <h3>
     <a id="_267">
     </a>
    ...
    <h3>
     <a id="8_LoopResidual_Neural_Networks_for_Iterative_Refinement_299">
     </a>
     8. Loop-Residual Neural Networks for Iterative Refinement
    </h3>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/08813fbf816942f2b52029b01f79c9fc.png"/>
    </p>
    <h3>
     <a id="_327">
     </a>
    ...
    <h3>
     <a id="9_LLMs_are_OneShot_URL_Classifiers_and_Explainers_340">
     </a>
     9. LLMs are One-Shot URL Classifiers and Explainers
    </h3>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1cce8548ae9342c79eba8e0827c15dc1.png"/>
    </p>
    <p>
     LLMs作为一次性URL分类器和解释器
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b3292f6df1f341cf8094b4e4ad08ee67.png"/>
    </p>
    <p>
    ...
    <h3>
     <a id="10_Can_Large_Language_Models_Logically_Predict_Myocardial_Infarction_Evaluation_based_on_UK_Biobank_Cohort_382">
     </a>
     10. Can Large Language Models Logically Predict Myocardial Infarction? Evaluation based on UK Biobank Cohort
    </h3>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8d70d4c6964a4d3db0c0acbf272d88e1.png"/>
    </p>
    <p>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f667966323030372f:61727469636c652f64657461696c732f313432353833333532" class_="artid" style="display:none">
 </p>
</div>
