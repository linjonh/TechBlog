...
* **应用场景**
  ...
  public static final long JWT\_TTL = 60 \* 60 \* 1000L \* 24 \* 14; // 有效期14天
    
  public static final String JWT\_KEY = “SDFGjhdsfalshdfHFdsjkdsfds121232131afasdfac”;
...
* **配置权限授权**
  ...
  .antMatchers(“/edit/\*\*”).hasAuthority(“EDIT\_PRIVILEGE”) // 仅具有 EDIT\_PRIVILEGE 权限的用户可以访问
