 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="802" src="https://i-blog.csdnimg.cn/direct/2f2dbf5d86d2451ab6238d14bea972a3.png" width="754"/>
    </p>
    <p>
...
Matrix&amp; mix_zifu(short x_ref,short y_ref,Matrix&amp; mx,Zifu&amp; zf){
    ...
    <pre><code class="hljs">//生成长20,高100,颜色为白色的矩阵对象
Matrix matrix(20,100,255,255,255);  //3个255表示白色</code></pre>
    <p>
     假设字符基点和矩阵基点重合,调用以下函数即可生成图形:
    </p>
    <pre><code class="hljs">//假设zf1是传入的字符对象,数字"1"的点集合,他可能来自数据库,可能来自文件
mix_zifu(0,0,matrix,zf1);    </code></pre>
    <p>
     <span style="color:#fe2c24">
      注意
     </span>
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f6a6c6c7773312f:61727469636c652f64657461696c732f313436323338303931" class_="artid" style="display:none">
 </p>
</div>
