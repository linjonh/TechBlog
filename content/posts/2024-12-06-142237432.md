...
<h2> 3. NavigationView 组件与 Material Design 集成
</h2>
<h3>
...
<pre><code class="language-xml">&lt;menu xmlns:android="**_"&gt;
...
<pre><code class="language-java">// 为 NavigationView 中的每个菜单项设置点击事件
...
<pre><code class="language-xml">&lt;!-- 在 menu_drawer.xml 中设置菜单项图标和文本 --&gt;
&lt;item
...
<pre><code class="language-java">// 示例：使用 ObjectAnimator 实现平移动画
...
<pre><code class="language-java">// activity_main.xml 布局文件
&lt;android.support.v4.widget.DrawerLayout
xmlns:android="\*\*\*"
android:id="@+id/drawer_layout"
android:layout_width="match_parent"
