...
依赖名称中带有 Scala 版本（如 `flink-streaming-scala\_2.12`），表示该依赖是为特定 Scala 版本编译的。
...
<artifactId>flink-streaming-scala\_2.12</artifactId>
...
| \*\*示例依赖\*\* | `flink-streaming-scala\_2.12` | `flink-streaming-java` |
