 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="图片" height="477" src="https://i-blog.csdnimg.cn/img_convert/2c7a82f4b438e65a344a953bf7340807.jpeg" width="720"/>
    </p>
    <h3>
     二、Cache的工作方式
    </h3>
    ...
    <p class="img-center">
     <img alt="图片" height="453" src="https://i-blog.csdnimg.cn/img_convert/97da83f3c5778cd5dacf3d989e525ff7.jpeg" width="720"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="440" src="https://i-blog.csdnimg.cn/img_convert/93d373dcdd2018a95b7c0323a2fb1549.jpeg" width="646"/>
    </p>
    <p>
    </p>
    <p class="img-center">
     <img alt="图片" height="450" src="https://i-blog.csdnimg.cn/img_convert/aa57d93440fe98df18143f51bf6fc939.jpeg" width="633"/>
    </p>
    <h4>
     2.2程序运行中的角色
    </h4>
    ...
    <p class="img-center">
     <img alt="图片" height="211" src="https://i-blog.csdnimg.cn/img_convert/e61bc2e77b495f618ea76f38e1d0745b.jpeg" width="720"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="395" src="https://i-blog.csdnimg.cn/img_convert/06111c138a84e35fb27894676e09de41.jpeg" width="720"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="203" src="https://i-blog.csdnimg.cn/img_convert/cf87a5886242820ace46e2da6024fb81.jpeg" width="720"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="393" src="https://i-blog.csdnimg.cn/img_convert/5192fc61f14dacf08f119ad76272a91d.jpeg" width="720"/>
    </p>
    <p>
     Cache 的基本参数如下：
    </p>
    ...
    <p class="img-center">
     <img alt="图片" height="168" src="https://i-blog.csdnimg.cn/img_convert/84fde3a6022cda5ea3b5f082560779f2.jpeg" width="720"/>
    </p>
    <p>
     导出的基本参数如下：
    </p>
    ...
    <p class="img-center">
     <img alt="图片" height="465" src="https://i-blog.csdnimg.cn/img_convert/8021489aa847c8d15840b51981897701.jpeg" width="455"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="319" src="https://i-blog.csdnimg.cn/img_convert/e8e0cda3175dfbff41d1d0f276bbf8ca.jpeg" width="720"/>
    </p>
    <ul>
     <li>
      <p>
    ...
    <p class="img-center">
     <img alt="图片" height="361" src="https://i-blog.csdnimg.cn/img_convert/577f75d1920ceb40f3ece6df2202eb38.jpeg" width="720"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="441" src="https://i-blog.csdnimg.cn/img_convert/7637c92bcc0f75e902c0f05305b69e3e.jpeg" width="637"/>
    </p>
    <p>
    ...
    <pre><code>void add_array(int *data1, int *data2, int result, int size)
{
	int i;
	for (i == 0; i &lt; size; i++) {
    ...
    <p class="img-center">
     <img alt="图片" height="367" src="https://i-blog.csdnimg.cn/img_convert/8e8071bc50df43c7907a8433495162f8.jpeg" width="641"/>
    </p>
    <p>
     ⑶组相连
    </p>
    ...
    <table style="width:275px">
     <tbody>
      ...
      <tr>
       ...
       <td>
        这行数据有效，数据和内存中数据一致，多个cache中存在这个数据副本
       </td>
      </tr>
      <tr>
       <td>
    ...
    <table style="width:690px">
     <tbody>
      ...
      <tr>
       ...
       <td>
        总线侦听到一个来自其他CPU的读缓存请求。收到信号的CPU先检查自己的高速缓存中是否有缓存该数据，然后广播应答信号
       </td>
      </tr>
      <tr>
       <td>
       ...
       <td>
        总线侦听到一个来自其他CPU的写缓存请求。收到信号的CPU先检查自己的高速缓存中是否有缓存该数据，然后广播信号
       </td>
      </tr>
      <tr>
       <td>
       ...
       <td>
        总线侦听到更新请求，请求其他CPU做一些额外事情。其他CPU收到请求后，若CPU上有缓存副本，则需要做额外一些更新操作，比如无效本地的高速缓存行等
       </td>
      </tr>
      <tr>
       <td>
       ...
       <td>
        总线侦听到刷新请求。收到请求的CPU把自己的高速缓存行的内容写回到主内存中
       </td>
      </tr>
      <tr>
       <td>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f5368755368656e6754754d2f:61727469636c652f64657461696c732f313436303030333433" class_="artid" style="display:none">
 </p>
</div>
