...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <h2 id="rtx与其他实时操作系统的比较">
     RTX与其他实时操作系统的比较
    </h2>
    <p>
     原文地址：
     <a href="http://www.vme.cn/e/action/ShowInfo.php?classid=14&amp;id=502" rel="nofollow">
    ...
    <p>
     ...
     <br/>
     <img alt="RTX结构" src="https://img-blog.csdn.net/20170306154028854?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQveGVsbG9x/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast" title=""/>
    </p>
    <p>
    ...
    <ol>
     <li>
      RTX2011支持多至32个处理器的系统，是上一个RTX版本的处理器量的四倍还要多些。RTX工具和通用工具的更新来支持31RTSS处理器的展示。
     </li>
     <li>
      RTX2011有6个运行时版本，给到客户提升的选项来选择嵌入式系统需要的均衡的多处理功能的级别。
     </li>
     <li>
      RTX工具也包含在所有RTX2011运行时编辑中。
     </li>
     <li>
      RTX2011支持Windows7，Windows Vista直到SP2的版本，Windows XP直到SP3，Windows Embedded Standard 2009，和Windows Embedded Standard 7。
     </li>
     <li>
      RTX2011提供了：RTX和RT-TCP/IP头文件和库文件；支持Microsoft Visual Studio（2005、2008和2010）；Microsoft WinDbg 扩展；网络驱动和资源；例子应用和文档说明和如何开发RTSS应用展示。
     </li>
     <li>
      RTX运行时提供了：实时子系统；工具和实用工具集来诊断问题和监视RTX环境的性能。
     </li>
     <li>
      更新的RTX控制面板来提供一个更加详细的子系统状态。
     </li>
     <li>
      在RTSS进程中通过FastSemaphores添加了新的轻量级的同步器。
     </li>
     <li>
      RTX API DLL为Windows提供的应用（Rtapi_w32.dll）现在可以动态被加载。
     </li>
     <li>
      加强了的子系统追踪功能允许其可以从开始一个日志的对话之前就捕获到其信息。这个功能也可以通过RTX控制面板或者RTX属性API来更改。
     </li>
     <li>
      允许在一个64位操作系统上，安装一个不带运行时的RTX SDK。
     </li>
     <li>
      可以为RTX运行时与第三方安装简单地整合提供安装混合模块。
     </li>
     <li>
      Windows Embedded Standard 7已被安装包支持。Including RTX Runtime with Windows Embedded Standard 7文档现在已可以作为一个指导来展示如何利用ICE将RTX包含至其中。
     </li>
     <li>
      RTX现在允许最小的进程槽数为1（之前的最小是10）。
     </li>
    </ol>
   </div>
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f78656c6c6f71:2f61727469636c652f64657461696c732f3630353830313230" class_="artid" style="display:none">
 </p>
</div>
