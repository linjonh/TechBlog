  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <a href="https://www.servbay.com" rel="nofollow" title="Web服务器">
      Web服务器
     </a>
    ...
    <pre><code class="hljs">display_errors = On
...
error_reporting = E_ALL</code></pre>
    ...
    <p>
     <img alt="" height="925" src="https://i-blog.csdnimg.cn/direct/e46b5eb273594255bc083ae8126ab74c.png" width="1280"/>
    </p>
    <p>
    ...
    <p>
     ...
     <a href="https://www.servbay.com" rel="nofollow" title="开发环境">
      开发环境
     </a>
    ...
    <p>
     <img alt="" height="757" src="https://i-blog.csdnimg.cn/direct/05760609744e4c44a16c3d21347bb26c.png" width="1280"/>
    </p>
    <p>
...
sudo apt-get dist-upgrade</code></pre>
    ...
    <pre><code class="hljs">sudo apt-get install mysql-server
sudo mysql_secure_installation</code></pre>
    ...
    <pre><code class="hljs">sudo apt-get install php</code></pre>
    <p>
    ...
    <pre><code class="hljs">sudo apt-get install phpmyadmin</code></pre>
    <p>
     完成后，你需要配置 Apache 配置文件以包含 phpmyadmin，这可以通过执行以下操作来完成：
    </p>
    <pre><code class="hljs">sudo echo -e "\nInclude /etc/phpmyadmin/apache.conf" &gt;&gt; /etc/apache2/apache2.conf</code></pre>
    <p>
     现在你需要做的就是启动 Apache 和 MySQL，一切都会正常工作。使用以下命令执行此操作：
    </p>
    <pre><code class="hljs">sudo service apache2 start &amp;&amp; service mysql start</code></pre>
    <p>
    ...
    <pre><code class="hljs">sudo apt install logrotate -y</code></pre>
    <p>
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f466c616b79353539312f:61727469636c652f64657461696c732f313436323031393035" class_="artid" style="display:none">
 </p>
</div>
