...
R是一种用于统计计算和图形的编程语言和软件环境。R语言由Ross Ihaka和Robert
Gentleman在1993年在新西兰奥克兰大学统计系创建。R是GNU项目的一部分，并且其源代码在GNU通用公共许可证下发布。

### 2\. R语言安装与环境配置

  * **安装R** ：可以从[R官方网站](https://www.r-project.org/)下载并安装适用于您操作系统的R版本。
