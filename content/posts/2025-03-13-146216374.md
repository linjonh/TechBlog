---
arturl_encode: "68747470733a2f2f62:6c6f672e6373646e2e6e65742f736576656e39375f746f702f:61727469636c652f64657461696c732f313436323136333734"
layout: post
title: "SpringCloud带你走进微服务的世界"
date: 2025-03-13 08:15:00 +08:00
...
![](https://i-blog.csdnimg.cn/img\_convert/604d509d127f01275a858d454952f40d.png)
单体架构的优缺点如下：
\*\*优点：\*\*
\* 架构简单
\* 部署成本低
...
![](https://i-blog.csdnimg.cn/img\_convert/ea29bca6a879fa323d4ed851c49099da.png)
分布式架构的优缺点：
\*\*优点：\*\*
\* 降低服务耦合
\* 有利于服务升级和拓展
...
![](https://i-blog.csdnimg.cn/img\_convert/ceef1307c4232c28284a7e3a02c7994b.png)
...
其中常见的组件包括：
![](https://i-blog.csdnimg.cn/img\_convert/a0881358105828b85a41e44b7b4ee6aa.png)
...
![](https://i-blog.csdnimg.cn/img\_convert/69d20afc383d00e8f037747672a3118c.png)
#### 服务拆分示例
以课前资料中的微服务cloud-demo为例，其结构如下：
![](https://i-blog.csdnimg.cn/img\_convert/6968c4c383f3e138df8044f700d3b38a.png)
cloud-demo：父工程，管理依赖
...
![](https://i-blog.csdnimg.cn/img\_convert/83d1339ab085f691051182c2ffa4ae6e.png)
根据id查询订单，返回值是Order对象，如图：
![](https://i-blog.csdnimg.cn/img\_convert/515c38b44d40c42ff574ea96b92f8dc7.png)
其中的user为null
在user-service中有一个根据id查询用户的接口：
![](https://i-blog.csdnimg.cn/img\_convert/091f1928e095214c58ebe9c278c4ee59.png)
查询的结果如图：
![](https://i-blog.csdnimg.cn/img\_convert/2c238221d0ff40ac719bdbb81608d42c.png)
##### 案例需求：
修改order-service中的根据id查询订单业务，要求在查询订单的同时，根据订单中包含的userId查询出用户信息，一起返回。
![](https://i-blog.csdnimg.cn/img\_convert/cdde7e290032adcaab4c66c529aaa973.png)
...
![](https://i-blog.csdnimg.cn/img\_convert/2fb1114f716ca7704241396b1cb542d5.png)
#### 提供者与消费者
在服务调用关系中，会有两个不同的角色：
\*\*服务提供者\*\*
...
![](https://i-blog.csdnimg.cn/img\_convert/715f4875bd1b2191cdca902ba5f48846.png)
...
![](https://i-blog.csdnimg.cn/img\_convert/237e57a6c150f803ac92b045ecfd619e.png)
大家思考几个问题：
...
![](https://i-blog.csdnimg.cn/img\_convert/391250574ee816ad90b067a42b80cf21.png)
...
因此，接下来我们动手实践的步骤包括：
![](https://i-blog.csdnimg.cn/img\_convert/f70b40a1f3aeb25215a23f98e8d5ba14.png)
#### 搭建eureka-server
...
看到下面结果就是成功了：
![](https://i-blog.csdnimg.cn/img\_convert/9fb672579c62885b6f199a1a1592bbbf.png)
#### 服务注册
...
然后，在弹出的窗口中，填写信息：
![](https://i-blog.csdnimg.cn/img\_convert/1420b9081358827942d70df4ff8b7ba7.png)
启动两个user-service实例：
![](https://i-blog.csdnimg.cn/img\_convert/4eb1f356f1a4de1df37d321289d0a2cf.png)
查看eureka-server管理页面：
![](https://i-blog.csdnimg.cn/img\_convert/4c018e8f7b06e2374a452c9ee67dbcf2.png)
#### 服务发现
...
![](https://i-blog.csdnimg.cn/img\_convert/0cc2672351db322c06dc78eee1178bf1.png)
修改order-service服务中的cn.seven.order.service包下的OrderService类中的queryOrderById方法。修改访问的url路径，用服务名代替ip、端口：
![](https://i-blog.csdnimg.cn/img\_convert/198fcd8c5c9c514fb782687277594119.png)
...
![](https://i-blog.csdnimg.cn/img\_convert/aed7d0c2c4b999a9af1277c85805638d.png)
...
![](https://i-blog.csdnimg.cn/img\_convert/976fcaa808e4f79ad7c051e1bb76887b.png)
#### 源码跟踪
...
![](https://i-blog.csdnimg.cn/img\_convert/3d5774115a925fa2a55f0b8495c9bcb1.png)
...
##### LoadBalancerClient
继续跟入execute方法：
![](https://i-blog.csdnimg.cn/img\_convert/2b9c7d9a88bc23882f327fc517ca1314.png)
代码是这样的：
\* getLoadBalancer(serviceId)：根据服务id获取ILoadBalancer，而ILoadBalancer会拿着服务id去eureka中获取服务列表并保存起来。
\* getServer(loadBalancer)：利用内置的负载均衡算法，从服务列表中选择一个。本例中，可以看到获取了8082端口的服务
放行后，再次访问并跟踪，发现获取的是8081：
![](https://i-blog.csdnimg.cn/img\_convert/483e39d2663e262441889b130dada62e.png)
果然实现了负载均衡。
##### 负载均衡策略IRule
在刚才的代码中，可以看到获取服务使通过一个
`getServer`
方法来做负载均衡:
![](https://i-blog.csdnimg.cn/img\_convert/6255a72767d95eca4fbaaa6a90af2aa7.png)
我们继续跟入：
![](https://i-blog.csdnimg.cn/img\_convert/68442973c5ccf482859b139b25428a2f.png)
继续跟踪源码chooseServer方法，发现这么一段代码：
![](https://i-blog.csdnimg.cn/img\_convert/76df8c14cec31b1b32db68caef568785.png)
我们看看这个rule是谁：
![](https://i-blog.csdnimg.cn/img\_convert/a423f8bfff70f4a6aa349de1ef760733.png)
这里的rule默认值是一个
`RoundRobinRule`
，看类的介绍：
![](https://i-blog.csdnimg.cn/img\_convert/3b124b9a4cf50239c74da21ab99de12d.png)
这不就是轮询的意思嘛。
到这里，整个负载均衡的流程我们就清楚了。
##### 总结
SpringCloudRibbon的底层采用了一个拦截器，拦截了RestTemplate发出的请求，对地址做了修改。用一幅图来总结一下：
![](https://i-blog.csdnimg.cn/img\_convert/57a98783b2746781935b41001e954b88.png)
基本流程如下：
...
![](https://i-blog.csdnimg.cn/img\_convert/c8aad8b6d3b7c7d696544dd5a42cf36a.png)
不同规则的含义如下：
| \*\*内置负载均衡规则类\*\* | \*\*规则描述\*\* |
| --- | --- |
| RoundRobinRule | 简单轮询服务列表来选择服务器。它是Ribbon默认的负载均衡规则。 |
| AvailabilityFilteringRule | 对以下两种服务器进行忽略： （1）在默认情况下，这台服务器如果3次连接失败，这台服务器就会被设置为“短路”状态。短路状态将持续30秒，如果再次连接失败，短路的持续时间就会几何级地增加。 （2）并发数过高的服务器。如果一个服务器的并发连接数过高，配置了AvailabilityFilteringRule规则的客户端也会将其忽略。并发连接数的上限，可以由客户端的 `..ActiveConnectionsLimit` 属性进行配置。 |
...
![](https://i-blog.csdnimg.cn/img\_convert/1c3da038944e2ff4b1c05d62dfabdaaf.png)
正常情况下各个节点相互配置，完成用户请求的处理工作
![](https://i-blog.csdnimg.cn/img\_convert/2bfd04262a478ff5b396bef7fe5b6bf9.png)
当某种请求增多，造成"服务T"故障的情况时，会延伸的造成"服务U"不可用，及继续扩展，如下
![](https://i-blog.csdnimg.cn/img\_convert/9cd8b4f2c3322ac3caab32a743969166.png)
最终造成下面这种所有服务不可用的情况
![](https://i-blog.csdnimg.cn/img\_convert/b417996e4f50397db5f8fe9307655fa3.png)
...
##### 场景介绍
先来看下正常服务调用的情况
![](https://i-blog.csdnimg.cn/img\_convert/7b526add0eae800f70ac550325a98490.png)
当consumer调用provider服务出现问题的情况下:
![](https://i-blog.csdnimg.cn/img\_convert/f4fce69809b1ffd72bbae168ceb88cbd.png)
此时我们对consumer的服务调用做降级处理
![](https://i-blog.csdnimg.cn/img\_convert/e25679b4a0d5429bfa97a63a7068ad83.png)
#####
##### 实现案例
...
![](https://i-blog.csdnimg.cn/img\_convert/fefe869c6c0bb7fd31e54d2225a2c8e0.png)
##### 合并请求的场景
![](https://i-blog.csdnimg.cn/img\_convert/7010e8180a6fab4442ba6bdf971b6aba.png)
##### 什么情况下使用请求合并
在微服务架构中，我们将一个项目拆分成很多个独立的模块，这些独立的模块通过远程调用来互相配合工作，但是，在高并发情况下，通信次数的增加会导致总的通信时间增加，同时，线程池的资源也是有限的，高并发环境会导致有大量的线程处于等待状态，进而导致响应延迟，为了解决这些问题，我们需要来了解 Hystrix 的请求合并。
##### 请求合并的缺点
...
public Future getUserId(Integer id){
System.out.println("\*\*\*\*\*id\*\*\*\*\*");
return null;
}
@HystrixCommand
public List batchUser(List ids){
for (Integer id : ids) {
System.out.println(id);
}
List list = new ArrayList<>();
...
Future f1 = service.getUserId(1);
Future f2 = service.getUserId(1);
Future f3 = service.getUserId(1);
System.out.println("\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*");
...
```
![](https://i-blog.csdnimg.cn/img\_convert/8a54f29ff0030b13a7d59f2e3db469fc.png)
#### 熔断
熔断其实是在降级的基础上引入了重试的机制。当某个时间内失败的次数达到了多少次就会触发熔断机制，具体的流程如下
![](https://i-blog.csdnimg.cn/img\_convert/2dffd1f8d95a70d0c5df10b93bfed7c5.png)
案例核心代码
```java
@HystrixCommand(fallbackMethod = "fallback",
commandProperties = {
//默认 20 个;10s 内请求数大于 20 个时就启动熔断器，当请求符合熔断条件时将触发 getFallback()。
@HystrixProperty(name= HystrixPropertiesManager.CIRCUIT\_BREAKER\_REQUEST\_VOLUME\_THRESHOLD,
value="10"),
//请求错误率大于 50%时就熔断，然后 for 循环发起请求，当请求符合熔断条件时将触发 getFallback()。
@HystrixProperty(name=HystrixPropertiesManager.CIRCUIT\_BREAKER\_ERROR\_THRESHOLD\_PERCENTAGE,
value="50"),
//默认 5 秒;熔断多少秒后去尝试请求
@HystrixProperty(name=HystrixPropertiesManager.CIRCUIT\_BREAKER\_SLEEP\_WINDOW\_IN\_MILLISECONDS,
value="5000"),
})
public List getUsers(){
// 1. 服务发现
...
```
![](https://i-blog.csdnimg.cn/img\_convert/a1243c279b377ee258cf489afd8e0d6e.png)
#### 隔离
...
在没有使用线程池隔离时：
![](https://i-blog.csdnimg.cn/img\_convert/b3ba67fd05cf95500672adf112abda86.png)
当接口A压力增大，接口C同时也会受到影响
![](https://i-blog.csdnimg.cn/img\_convert/2db71497cd4104b6b96dd8655bf5f582.png)
使用线程池的场景
![](https://i-blog.csdnimg.cn/img\_convert/b98c0980097e4456b7f8f18d24fe2f0d.png)
当服务接口A访问量增大时，因为接口C在不同的线程池中所以不会受到影响
![](https://i-blog.csdnimg.cn/img\_convert/5dd83b9fd040259ef00a308c782f5e0f.png)
...
public List getUsersThreadPool(Integer id){
...
```
相关参数的描述
![](https://i-blog.csdnimg.cn/img\_convert/2c33da46f6891aaffb3697c8ac8e93ff.png)
##### 信号量隔离
信号量隔离其实就是我们定义的队列并发时最多支持多大的访问，其他的访问通过托底数据来响应，如下结构图
![](https://i-blog.csdnimg.cn/img\_convert/61ef0c1dc551a275db8b2de31a271a56.png)
```java
@HystrixCommand(
fallbackMethod = "fallBack"
,commandProperties = {
@HystrixProperty(name=HystrixPropertiesManager.EXECUTION\_ISOLATION\_STRATEGY
,value = "SEMAPHORE") // 信号量隔离
,@HystrixProperty(name=HystrixPropertiesManager.EXECUTION\_ISOLATION\_SEMAPHORE\_MAX\_CONCURRENT\_REQUESTS
,value="100" // 信号量最大并发度
)
}
)
public List getUsersSignal(Integer id){
System.out.println("--------》" + Thread.currentThread().getName());
// 1. 服务发现
// 获取服务提供者的信息 ServiceInstance封装的有相关的信息
ServiceInstance instance = loadBalancerClient.choose("eureka-provider");
...
```
![](https://i-blog.csdnimg.cn/img\_convert/9162abf9e3c5c9b0f1d33b78bbf07ebf.png)
##### 两者的区别
线程池隔离和信号量隔离的区别
![](https://i-blog.csdnimg.cn/img\_convert/99749bcf7f9238cf8f07020329663335.png)
### Feign远程调用
基于Netflix Feign 实现，整合了Spring Cloud Ribbon 与Spring Cloud Hystrix， 它提供了一种声明式服务调用的方式。
先来看我们以前利用RestTemplate发起远程调用的代码：
![](https://i-blog.csdnimg.cn/img\_convert/d5432dddbc9211ac03e5dd8598f488f8.png)
存在下面的问题：
\* 代码可读性差，编程体验不统一
\* 参数复杂URL难以维护
...
![](https://i-blog.csdnimg.cn/img\_convert/14ec01efdad46734cbb5767ceffa2919.png)
是不是看起来优雅多了。
##### 总结
使用Feign的步骤：
1. 引入依赖
...
![](https://i-blog.csdnimg.cn/img\_convert/ceb01d722facab2cdc7926013dcc792b.png)
Debug方式启动order-service服务，可以看到这里的client，底层就是Apache HttpClient：
![](https://i-blog.csdnimg.cn/img\_convert/1bd0d84b474f0f524b9b47984934e53c.png)
总结，Feign的优化：
1. 日志级别尽量用basic
...
feign客户端：
![](https://i-blog.csdnimg.cn/img\_convert/185a382f2fd472ad3c25d0a120c58f55.png)
UserController：
![](https://i-blog.csdnimg.cn/img\_convert/6d47f280e4c053d01d4e7fef8e62e553.png)
有没有一种办法简化这种重复的代码编写呢？
##### 继承方式
一样的代码可以通过继承来共享：
1. 定义一个API接口，利用定义方法，并基于SpringMVC注解做声明。
2. Feign客户端和Controller都集成改接口
![](https://i-blog.csdnimg.cn/img\_convert/d13648079761bc638918ada81972586d.png)
优点：
\* 简单
\* 实现了代码共享
缺点：
...
![](https://i-blog.csdnimg.cn/img\_convert/075f9a69fbdcb18c472d6901c0550523.png)
###### 抽取
首先创建一个module，命名为feign-api，
项目结构：
![](https://i-blog.csdnimg.cn/img\_convert/8e3009a75c05526f9a98360abf727972.png)
...
\* 限流
架构图：
![](https://i-blog.csdnimg.cn/img\_convert/5c20fad81bbbc911863cd798a007e440.png)
\* \*\*权限控制\*\*
...
![](https://i-blog.csdnimg.cn/img\_convert/2373f080c41f2301702b61ebe4ace679.png)
##### 网关路由的流程图
整个访问的流程如下：
![](https://i-blog.csdnimg.cn/img\_convert/9f4a72d20aa50f879528426be21f0d7d.png)
总结：
网关搭建步骤：
...
![](https://i-blog.csdnimg.cn/img\_convert/a58a9b71ed2eec21d8fbb72d4770d799.png)
##### 路由过滤器的种类
...
![](https://i-blog.csdnimg.cn/img\_convert/ae86c22516219594d95f04af029482f2.png)
排序的规则是什么呢？
...
##### 模拟跨域问题
可以在浏览器控制台看到下面的错误：
![](https://i-blog.csdnimg.cn/img\_convert/f93b29ab0a881fddcd67dc28db0af405.png)
...
\* [《SpringBoot》史上最全SpringBoot相关注解介绍](https://mp.weixin.qq.com/s/MgC\_iK536FxTLgm7CJMlqQ)
