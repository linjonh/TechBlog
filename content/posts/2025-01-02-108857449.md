...
> node\_modules 目录不会参与编译、上传和打包中
>   
> miniprogram\_npm 目录，里面会存放构建打包后的 npm 包，也就是小程序真正使用的 npm 包。
...
* [miniprogram\_npm 和 nodes\_modules 文件夹的区别](https://developers.weixin.qq.com/miniprogram/dev/devtools/npm.html#Tips)
