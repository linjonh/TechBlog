   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <div>
     <div class="note-content">
      ...
      <pre><code class="sql">for each row in t1 matching range {
 ...
 if buffer is not empty {
    for each row in t3 {
     for each t1, t2 combination in join buffer {
      ...
      <pre><code class="sql">mysql&gt; explain select ename,dname from dept d inner join emp e on d.deptno = e.deptno;
+----+-------------+-------+------------+------+---------------+------+---------+------+------+----------+--------------------------------------------+
...
2 rows in set, 1 warning (0.00 sec)
      ...
      <pre><code class="sql">mysql&gt; explain format=tree select /*+ no_bka(e, d) */ename,dname from dept d inner join emp e on d.deptno = e.deptno\G  
*************************** 1. row ***************************
...
1 row in set (0.00 sec)
      ...
      <pre><code class="sql">-- 是否加hint，都是走BKA算法
...
1 row in set (0.00 sec)
      ...
      <pre><code class="sql">-- 非等值连接居然也用hash join(8.0.18 后尽可能的使用hash join已经支持非等值连接了)
...
select /*+ bnl(e, d)*/e.*
 ...
 on e.deptno &gt; d.deptno\G
      ...
      <pre><code class="sql">mysql&gt; explain format=tree 
    -&gt; select e.*
    -&gt;   from emp e
    -&gt;  inner join dept d
    -&gt;  on e.deptno = d.deptno\G
...
mysql&gt; 
      ...
      <ol>
       <li>
        <a href="https://links.jianshu.com/go?to=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F8.0%2Fen%2Fnested-join-optimization.html" rel="nofollow noopener noreferrer" target="_blank">
         https://dev.mysql.com/doc/refman/8.0/en/nested-join-optimization.html
        </a>
       </li>
       <li>
        <a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwww.cnblogs.com%2Fwanbin%2Fp%2F9592943.html" rel="nofollow noopener noreferrer" target="_blank">
         https://www.cnblogs.com/wanbin/p/9592943.html
        </a>
       </li>
       <li>
        <a href="https://links.jianshu.com/go?to=https%3A%2F%2Fblog.csdn.net%2Fddhe9527%2Farticle%2Fdetails%2F103659977" rel="nofollow noopener noreferrer" target="_blank">
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6361696875617975616e342f:61727469636c652f64657461696c732f313436313336373834" class_="artid" style="display:none">
 </p>
</div>
