...
# 战神服务器IP修改,战神引擎开区教程\_多服务器架设多版本教程
...
引擎启动成功今后，就需要在游戏列表上面加上二区的信息，因为列表文件是在一区服务器上面，咱们来到一区服务器，进入D:\mud2.0\logincenter\logincenter\_win\config这个文件夹，找到serverlist.json文件，用N++编辑器打开，在里面增加二区的信息。
