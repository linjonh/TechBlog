 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code>public class NettyRpcClient {
    ...
...
public class RpcResponse {
    ...
    <pre><code>public class HessianSerialization {
    //序列化：将对象序列化成字节数组
    ...
    <pre><code>public class HessianSerializationTest {
    ...
    <pre><code>public class RpcDecoder extends ByteToMessageDecoder {
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f6d6a756e7a2f:61727469636c652f64657461696c732f313436333033373737" class_="artid" style="display:none">
 </p>
</div>
