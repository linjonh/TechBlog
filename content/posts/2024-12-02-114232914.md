...
# java8 计算时间差\_Java 8：计算两个LocalDateTime之间的差
...
static final int MINUTES\_PER\_HOUR = 60;

static final int SECONDS\_PER\_MINUTE = 60;

static final int SECONDS\_PER\_HOUR = SECONDS\_PER\_MINUTE \* MINUTES\_PER\_HOUR;
...
long hours = seconds / SECONDS\_PER\_HOUR;

long minutes = ((seconds % SECONDS\_PER\_HOUR) / SECONDS\_PER\_MINUTE);

long secs = (seconds % SECONDS\_PER\_MINUTE);
