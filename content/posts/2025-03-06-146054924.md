...
* Linux 入门：vim 鼠标不能右键粘贴、跨系统复制粘贴\_vim 中当鼠标右键功能无法使用时，如何开启 - CSDN 博客
    
  -
  <https://blog.csdn.net/foryouslgme/article/details/52688285>
* Vim 配置#Vim 中使用鼠标功能\_zsh vim 鼠标插入模式 - CSDN 博客
    
  <https://blog.csdn.net/qq_27968607/article/details/54966912>
* 解决配置 vim 之后不能鼠标右键复制问题\_vim 里的鼠标右键 - CSDN 博客
