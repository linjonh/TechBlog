...
-r--r--r--. 1 root root 1455 Oct 25 2023 extra\_files.json
...
-r--r--r--. 1 root root 81657 Mar 15 11:41 accel-config-3.5.3-2.el9.x86\_64.rpm
-r--r--r--. 1 root root 54604 Mar 15 11:41 accel-config-libs-3.5.3-2.el9.i686.rpm
-r--r--r--. 1 root root 54176 Mar 15 11:41 accel-config-libs-3.5.3-2.el9.x86\_64.rpm
#### 7.1.5 如果我们要安装zsh-5.8-9.el9.x86\_64.rpm包，则使用下面的命令
root@localhost Packages]# rpm -i zsh-5.8-9.el9.x86\_64.rpm
...
============================================================================================
Installing:
httpd x86\_64 2.4.57-5.el9 appstream 52 k
...
[baseos]
name=baseos
baseurl=http://47.108.86.156/rhel9.0/x86\_64/dvd/BaseOS/
gpgcheck=0
[appstream]
name=appstream
baseurl=http://47.108.86.156/rhel9.0/x86\_64/dvd/AppStream
gpgcheck=0
#http://47.108.86.156/rhel9.0/x86\_64/dvd/BaseOS/和http://47.108.86.156/rhel9.0/x86\_64/dvd/AppStream是网络连接，
#baseurl：这个参数指定了软件仓库的 URL 地址。在这个例子中，baseurl 设置为http://47.108.86.156/rhel9.0/x86\_64/dvd/BaseOS/ 和 http://47.108.86.156/rhel9.0/x86\_64/dvd/AppStream/，这意味着 DNF 将从这个远程服务器上下载所需的软件包。
#### 7.3.3 查看网络仓库
[root@localhost yum.repos.d]# cd
