...
# MySQL数据库常用SQL运维
### 调整数据库和表的字符集和排序规则
alter database dbname CHARACTER SET utf8mb4 collate utf8mb4\_general\_ci;
alter table t1 convert to CHARSET utf8mb4 collate utf8mb4\_general\_ci;
//将排序方式调整为大小写不敏感的utf8mb4\_general\_ci
调整数据库索引
alter table xxx drop index ix\_xx; //删除索引
alter table xxx add unique index uk\_xx (dataid(128),group\_id(128)); //创建唯一索引