  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <img alt="" height="241" src="https://i-blog.csdnimg.cn/direct/7f4a9769ac234b3f8ea4b58be393a485.png" width="1237"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="794" src="https://i-blog.csdnimg.cn/direct/a9b2819987bf450e94767f80a48d8890.png" width="865"/>
    </p>
    <p>
     接下来介绍各层的实现方法：
    </p>
    ...
    <p>
     <img alt="" height="142" src="https://i-blog.csdnimg.cn/direct/fc7998dac79c42cc83a77ed8f90c5ebf.png" width="432"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="534" src="https://i-blog.csdnimg.cn/direct/b79432a767d444e699bc42f481e4914c.png" width="966"/>
    </p>
    <pre><code class="hljs">
#embed.py
import torch
...
class PositionalEncoder(nn.Module):
    ...
    <p>
     <img alt="" height="445" src="https://i-blog.csdnimg.cn/direct/7f86a7cb761d408e97441b0fdbb0857f.png" width="1095"/>
    </p>
    <p>
     <img alt="" height="780" src="https://i-blog.csdnimg.cn/direct/87a91e24bbd44a058c851e981f97df72.png" width="1157"/>
    </p>
    <p>
     解释：
    </p>
    <p>
     <img alt="" height="570" src="https://i-blog.csdnimg.cn/direct/7cb3fff06f9f48ad98256d72860cd1aa.png" width="862"/>
    </p>
    <p>
     <img alt="" height="265" src="https://i-blog.csdnimg.cn/direct/a141155daf07460ebb1761b4019a4fa0.png" width="669"/>
    </p>
    <p>
     关于qkv的维度：
    </p>
    <p>
     <img alt="" height="757" src="https://i-blog.csdnimg.cn/direct/112f01e0332541dd9c4a826b3040cf9c.png" width="1211"/>
    </p>
    <h2>
     前馈层
    </h2>
    <p>
     <img alt="" height="301" src="https://i-blog.csdnimg.cn/direct/ce2b5c4881104ffea2f2ffc0efecd999.png" width="1108"/>
    </p>
    <p>
    </p>
    <pre><code class="hljs">#Sublayer.py
import torch
import torch.nn as nn
...
class Norm(nn.Module):
    ...
    <p>
     <img alt="" height="481" src="https://i-blog.csdnimg.cn/direct/f83678ed813c426bac6cfd181b4ec250.png" width="1142"/>
     <br/>
     <a href="https://www.bilibili.com/video/BV1TZ421j7Ke?spm_id_from=333.788.recommend_more_video.-1&amp;vd_source=bddc5089f1e8d115a9524dd967d5e53f" rel="nofollow" title="【官方双语】直观解释注意力机制，Transformer的核心 | 【深度学习第6章】_哔哩哔哩_bilibili">
     </a>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="665" src="https://i-blog.csdnimg.cn/direct/943fa94dec3d42c99ec9d4e71ddbb7d9.png" width="969"/>
    </p>
    <h2>
     编码器和解码器结构
    </h2>
    <p>
     <img alt="" height="692" src="https://i-blog.csdnimg.cn/direct/7d2bbd3116994fe8953549db4ef49bd7.png" width="1142"/>
    </p>
    <pre><code class="hljs">#layers
import torch
import torch.nn as nn
...
class Transformer(nn.Module):
    ...
    <p>
     <img alt="" height="616" src="https://i-blog.csdnimg.cn/direct/2c8b7dcdf5384708852f0ea95a7d88c0.png" width="994"/>
    </p>
    <p>
     <img alt="" height="433" src="https://i-blog.csdnimg.cn/direct/2c500584dfc24c1586a3b2e1b3001cee.png" width="970"/>
    </p>
    <p>
     <img alt="" height="591" src="https://i-blog.csdnimg.cn/direct/45ffe76aabf5404097d0ab38acbad095.png" width="949"/>
    </p>
    <p>
     <img alt="" height="365" src="https://i-blog.csdnimg.cn/direct/cef97838c9c14d748b3bcba6aa73d1fc.png" width="930"/>
    </p>
    <h2>
     训练和测试
    </h2>
...
if __name__ == "__main__":
    ...
    words = 'Let me see.'
    print(translate(words, custom_string=True))</code></pre>
    <p>
     源码地址(可运行):
     <a href="https://github.com/intro-llm/intro-llm-code/blob/main/chs/ch2-foundations/Transformer/main.py" title="intro-llm-code/chs/ch2-foundations/Transformer/main.py at main · intro-llm/intro-llm-code">
      intro-llm-code/chs/ch2-foundations/Transformer/main.py at main · intro-llm/intro-llm-code
     </a>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f36353633393030392f:61727469636c652f64657461696c732f313436303638323833" class_="artid" style="display:none">
 </p>
</div>
