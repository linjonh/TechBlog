...
作者：
[张国军\_Suger](https://blog.csdn.net/qq_41890694)
...
的JetbrainsIdesCrack-4.2-release.jar文件，选择文件，按住左键，拖动，拖到Linux系统的IntelliJ IDEA 2018.3.5的安装目录下的bin目录下，比如我的安装目录是/usr/local/IntelliJ\_IDEA\_2018.3.5/bin/，如下图所示。
