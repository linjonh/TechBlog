 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-rust">fn function_name(parameter_list) -&gt; ReturnType {
    // 函数体
    // 返回值（可选）
}</code></pre>
    <p>
    ...
    <pre><code class="language-rust">// 隐式返回
...
fn main() {
    ...
    <p>
     <img alt="" height="430" src="https://i-blog.csdnimg.cn/direct/d5df3f150feb48cba862552203721096.png" width="712"/>
    </p>
    <p>
     （2）不可变借用
    </p>
    ...
    <pre><code class="language-rust">fn borrow_test(s: &amp;String){
...
fn main() {
    ...
    <p>
     <img alt="" height="388" src="https://i-blog.csdnimg.cn/direct/239a0030d24b4cc2a4d20d604c2a50f5.png" width="1017"/>
    </p>
    <p>
     （3）可变借用
    </p>
    ...
    <pre><code class="language-rust">fn increment_by_reference(x: &amp;mut i32) {
    *x += 1; // 修改引用指向的值
}
...
fn main() {
    ...
    <pre><code class="language-rust">//阶乘递归
...
fn main() {
    ...
    <p>
     <img alt="" height="370" src="https://i-blog.csdnimg.cn/direct/48167612abf942e1a2bbfb10a0345d4a.png" width="1012"/>
    </p>
    <p>
     5.生命周期与函数
    </p>
    ...
    <pre><code class="language-rust">//规则一 每个引用参数都有其自己的生命周期 foo等价foo2
fn foo(x: &amp;i32) -&gt; &amp;i32 { x }
...
fn longest2(x: &amp;str, y: &amp;str) -&gt; &amp;str {
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35303235333938352f:61727469636c652f64657461696c732f313436323831363231" class_="artid" style="display:none">
 </p>
</div>
