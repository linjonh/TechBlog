...
source venv/bin/activate</code></pre>
    ...
    <p>
     <img alt="" height="425" src="https://i-blog.csdnimg.cn/blog_migrate/6dbf458cf1abc2f95437314002d23ac8.png" width="700"/>
    </p>
    <p>
     依赖（packages）的导出与再安装
    </p>
    <pre><code>1:当你准备在其他电脑上部署你的代码，你可以用:
pip freeze &gt; requirements.txt 创建一个requirements.txt文件。

2:requirements.txt文件描述了你在虚拟环境中所安装的包，在其他电脑上，可以通过:
pip install -r requirements.txt 来恢复配置。</code></pre>
    <p>
     ========================================
    </p>
    <p>
    ...
    <p>
     <img alt="" height="309" src="https://i-blog.csdnimg.cn/blog_migrate/814f396e608047d104e0e3573f6f845d.png" width="700"/>
    </p>
    <p>
     VSCODE配置方法2
    </p>
    ...
    <p>
     <img alt="" height="307" src="https://i-blog.csdnimg.cn/blog_migrate/e40720364e644f35b9ebedd6d818099f.png" width="700"/>
    </p>
    <p>
     <span style="color:#fe2c24;">
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f627a303434362f:61727469636c652f64657461696c732f313232393735313633" class_="artid" style="display:none">
 </p>
</div>
