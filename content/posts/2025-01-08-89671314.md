...
3. 安装完成后，配置环境变量。
   ...
   配置方法：右击我的电脑–>属性–>高级系统设置–>环境变量–>创建一个叫PYTHON\_HOME的系统变量，如下图所示：变量值指向你安装python所在的文件夹。
     
   ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5b9afdb2b51b034007a2ce520376bc51.png)
4. 配置玩PYTHON\_HOME以后，需要在path环境变量中引入该值，引入方法如下：
     
   ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5647684b610fccfcbf56361aa9c6bb41.png)
     
   点击Path后，点击编辑，然后在变量值的地方创建两个%%，将PYTHON\_HOME填入两个%%中，注意结束时候的“；”。
