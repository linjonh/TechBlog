...
# 安装java虚拟机 jvm\_一、安装JDK1、 JVM(Java Virtual Machine—Java虚拟机)JRE(Java Runtime Environment—Java运行...
...
3、系统变量自带是没有JAVA\_HOME这个变量，需要自己编辑如下：
...
-->输入Bil的路径(如我的路径是：C:Program FilesJavajdk1.8.0\_60lib)
