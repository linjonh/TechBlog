...
我们最新的 semantic\_text 迭代带来了大量改进。除了简化 \_source 中的表示之外，其好处还包括减少冗长程度、更高效的磁盘利用率以及更好地与其他 Elasticsearch 功能集成。你现在可以使用突出显示来检索与你的查询最相关的块。也许最重要的是，它现在是一个正式发的功能！
...
让我们稍微扩展一下最后一点，因为它涵盖了几个领域。通过这种简化，semantic\_text 字段现在可以用作
...
请参阅
[semantic\_text 文档](https://www.elastic.co/guide/en/elasticsearch/reference/master/semantic-text.html#semantic-text-highlighting "semantic_text 文档")
，了解如何使用高亮功能的更多信息。
