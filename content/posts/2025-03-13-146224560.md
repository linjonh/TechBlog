...
![image.png](https://i-blog.csdnimg.cn/img\_convert/566f38291ae634db216bd49155614029.png)
...
![6401.gif](https://i-blog.csdnimg.cn/img\_convert/f35050d9b4b7263fed4cf7312ba5925b.gif)
> 📌 注意
>
...
![640.webp](https://i-blog.csdnimg.cn/img\_convert/b3eb23d985cec2cfd24d0ccd852328af.webp?x-oss-
...
![6401.webp](https://i-blog.csdnimg.cn/img\_convert/7422e2cb3216a35ec8768c204d928f59.webp?x-oss-
process=image/format,png)
...
![6402.webp](https://i-blog.csdnimg.cn/img\_convert/7645d01a529bba07eb822affeccace8c.webp?x-oss-
process=image/format,png)
##### csv、txt文件
\* \*\*字符集\*\* ：SQLark 提供 172 种字符集编码自动识别，可覆盖绝大多数场景，用户也可以手动切换字符集。
\* \*\*分隔符\*\* ：SQLark 自动识别常见的行分隔符、列分隔符和文本识别符：
![6403.webp](https://i-blog.csdnimg.cn/img\_convert/815d847bf21cef16318b2ad4a7be22c0.webp?x-oss-
process=image/format,png)
用户可以根据实际情况手动调整，也支持\*\*自定义行/列分隔符、文本识别符\*\* 。
![6404.webp](https://i-blog.csdnimg.cn/img\_convert/0c5d44a295d6b20ca34f6e84f0b4d646.webp?x-oss-
process=image/format,png)
##### json、xml文件
\* \*\*标签\*\* ：SQLark 自动解析 json 和 xml 文件中的数据结构，快速抽取数组/对象/元素数据进行导入。
![6405.webp](https://i-blog.csdnimg.cn/img\_convert/deff477b36e812f305ab74ea02a9389d.webp?x-oss-
process=image/format,png)
...
![6406.webp](https://i-blog.csdnimg.cn/img\_convert/60a6a9f114c668e74d9b62faab4118c8.webp?x-oss-
process=image/format,png)
对于自动匹配不准的列，用户可以手动调整映射关系，SQLark 提供\*\*列名提示\*\* 来辅助用户调整：
![6401.gif](https://i-blog.csdnimg.cn/img\_convert/5a837eafdeacbcd0511319b1a6375b9b.gif)
对于映射关系调整过程中可能出现\*\*遗漏列\*\* ，或\*\*重复列\*\* 的情况，SQLark 实时检测并给出提示，避免用户误操作。
![640.webp](https://i-blog.csdnimg.cn/img\_convert/e910a5ac1ccd056faccf76d65cf02746.webp?x-oss-
process=image/format,png)
#### 3.导入
确认好字段间的映射关系，就可以直接导入。
导入过程中，可以看到\*\*实时日志\*\* ，掌握导入进度，对于导入异常的情况，也可以根据日志信息及时调整。
![6401.webp](https://i-blog.csdnimg.cn/img\_convert/ada292fcb38ee5a2cb44e84fd5e459a2.webp?x-oss-
process=image/format,png)
### 总结
