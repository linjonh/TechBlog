---
layout: post
title: "解读云原生下的可观察性发展方向"
date: 2021-01-22 14:42:33 +0800
description: "简介： 非常有幸参加了云原生社区Meetup北京站，有机会和众多业内的大牛一起讨论云原生相关的技术和"
keywords: "opentelemetry skywalking"
categories: ['云栖号技术分享']
tags: ['无标签']
artid: "112984597"
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=112984597
    alt: "解读云原生下的可观察性发展方向"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=112984597
featuredImagePreview: https://bing.ee123.net/img/rand?artid=112984597
---
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <blockquote>
     <p>
      A system is said to be observable if, for any possible evolution of
      <a href="https://en.wikipedia.org/wiki/State_space_representation" rel="nofollow">
       state and control vectors
      </a>
      , the current state can be estimated using only the information from outputs.
     </p>
    </blockquote>
    <p>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/622fd83b84b70378b28841d8753c980b.png"/>
    </p>
    <h2>
     可观察性的未来
    </h2>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/1106b12c39f19a06a52d34b24a562466.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/b9516faada3d56b5d50d958577ff6e25.png"/>
    </p>
    <p>
    ...
    <pre><code>1. 最开始我们通过各式各样的预设报警发现异常（通常是Metrics/Logging）
2. 发现异常后，打开监控大盘查找异常的曲线，并通过各种查询/统计找到异常的模块（Metrics）
3. 对这个模块以及关联的日志进行查询/统计分析，找到核心的报错信息（Logging）
4. 最后通过详细的调用链数据定位到引起问题的代码（Tracing）</code></pre>
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/9fefd0f33a2ff334280262176be3edbc.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/950beeeb5acd1793b5a9cd9d71a29022.png"/>
    </p>
    <ol>
     <li>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/d5a95659d52bb5b8d5f59db087838f50.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/d6f20e90d3049a0db8328ff47a15e609.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/88925b3de436dbbd3437b175a74ae81a.png"/>
    </p>
    <p>
    ...
    <ol>
     <li>
      统一协议：OpenTelemetry为我们带来了Metric、Tracing、Logging（正在制定中，LogModel已经定义完毕）的统一标准，三者都有相同的元数据结构，可以轻松实现互相关联
     </li>
     <li>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/413eb0ae10d915e3e432c8150469a30e.png"/>
    </p>
    <h2>
     可观察性的未来方向
    </h2>
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/154fcadd85c00228c51cc19b0de1c722.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/21ed64e8d3b101400b50d53ca34c7d91.png"/>
    </p>
    <h2>
     阿里云SLS在可观察性相关的工作
    </h2>
    ...
    <p>
     <img alt="image.png" src="https://i-blog.csdnimg.cn/blog_migrate/3f95b01167f16245f8d20ee2eeabbc14.png"/>
    </p>
    <h2>
     总结
    </h2>
    ...
    <p>
     <a href="https://developer.aliyun.com/article/780609?utm_content=g_1000232729" rel="nofollow">
      原文链接
     </a>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f79756e7169696e73696768742f:61727469636c652f64657461696c732f313132393834353937" class_="artid" style="display:none">
 </p>
</div>
