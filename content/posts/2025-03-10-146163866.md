...
if __name__ == "__main__":
    ...
    <pre><code class="language-python"># 升级pip
...
pyinstaller --version</code></pre>
    ...
    <pre><code class="language-bash">where python</code></pre>
    <p>
    ...
    <p>
     <img alt="" height="666" src="https://i-blog.csdnimg.cn/direct/ac0c2d4457da429aa4b16de19d3823f9.png" width="632"/>
    </p>
    <p>
     情况2：单条命令行运行报错
    </p>
    ...
    <pre><code class="language-python"># 进阶版（带图标，需确认图标文件名正确）
pyinstaller --onefile --noconsole --name "TextRecorder" --icon=app.ico text_recorder.py</code></pre>
    <h2>
     4. 检查打包文件
    </h2>
    <ol>
...
if __name__ == "__main__":
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34363730343938392f:61727469636c652f64657461696c732f313436313633383636" class_="artid" style="display:none">
 </p>
</div>
