...
begin
    ...
    <pre><code class="language-sql">call 存储过程名();</code></pre>
    <p>
     <strong>
      删除存储过程
     </strong>
    </p>
    <pre><code class="language-sql">drop procedure [if exists] 存储过程名;</code></pre>
    <h3>
     使用参数
    </h3>
    <pre><code class="language-sql">create procedure 存储过程名(
...
begin
    ...
    <pre><code class="language-sql">set @varName</code></pre>
    <pre><code class="language-sql"># 传入参数（只读）
...
# 结果：1 2 1
    ...
    <pre><code class="language-sql"># 传出参数（只写）
...
call mypro2(@var);
select @var;
# 结果：null null 2</code></pre>
    <pre><code class="language-sql"># 传入传出参数（可读可写）
...
# 结果：1 2 2</code></pre>
    ...
    <pre><code class="language-sql">declare 变量名 变量的数据类型[default 默认值];</code></pre>
    <pre><code class="language-sql">create procedure mypro(in i int)
begin
...
select @var;</code></pre>
    ...
    <pre><code class="language-sql">if 条件 then
    逻辑代码;
[elseif 条件 then
    逻辑代码;]
[else
    ...
    逻辑代码
until 循环条件 end repeat;</code></pre>
    <h3>
     特点
    </h3>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" class="left" src="https://i-blog.csdnimg.cn/direct/99ea760bcf114d4884b72291abeb8417.png"/>
    </p>
    <h2>
     自定义函数
    </h2>
    ...
    <pre><code class="language-sql">create function 函数名([参数1数据类型[,参数2数据类型, …. ]])
returns 返回值类型
begin
    函数逻辑代码
end;</code></pre>
    ...
    <pre><code class="language-sql">select 函数名([参数1,参数2 ... ]);</code></pre>
    <h3>
     删除函数
    </h3>
    <pre><code class="language-sql">drop function [if exists] 函数名;</code></pre>
    <pre><code class="language-sql">drop function if exists maxSal;
...
select maxSal () ;</code></pre>
    <h3>
     练习
    </h3>
    <p style="text-align:center">
     <img alt="" class="left" src="https://i-blog.csdnimg.cn/direct/2d045192e327445b8df9c5ea21ea22dc.png"/>
    </p>
    <h2>
     游标
    </h2>
    ...
    <pre><code class="language-sql">declare 游标名 cursor for 查询语句;</code></pre>
    <h3>
     打开游标
    </h3>
    <pre><code class="language-sql">open 游标名;</code></pre>
    <h3>
     读取游标数据到变量中
    </h3>
    <pre><code class="language-sql">fetch 游标名 into 变量名1[,变量名2 ... ];</code></pre>
    <h3>
     关闭游标
    </h3>
    <pre><code class="language-sql">close 游标名;</code></pre>
    <h3>
     多次读取游标中的数据
    </h3>
    <h4>
    ...
    <pre><code class="language-sql">create procedure test_cursor()
begin
  #先声明变量
...
begin
  ...
  close mycuesor;
    ...
    <p>
     <img alt="" class="left" src="https://i-blog.csdnimg.cn/direct/735207dff5be4e19809f4ec8b5f1b98d.png">
      <img alt="" class="left" src="https://i-blog.csdnimg.cn/direct/66ff9df69fe44741a509922a59c8a7c8.png"/>
     </img>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323430325f38343239383937332f:61727469636c652f64657461696c732f313436313635383637" class_="artid" style="display:none">
 </p>
</div>
