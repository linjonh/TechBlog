...
有2网站学flask：
[Flask 应用\_w3cschool](https://www.w3cschool.cn/flask/flask_application.html)
...
要将 WSGI 中间件添加到您的 Flask 应用程序，请包装应用程序的 attribute。例如，要应用 Werkzeug 的中间件来运行 Nginx 后面：wsgi\_app
