 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     打开浏览器打开网址：
     <a class="link-info" href="https://www.plantuml.com/plantuml/uml/SyfFKj2rKt3CoKnELR1Io4ZDoSa700001" rel="nofollow" title="Plant server">
      Plant server
     </a>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/26b0612da7514764976b6d159fa1684e.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/b8a1aa54856242a4976756477397fe22.png"/>
    </p>
    <h2>
     总结
    </h2>
    <ol>
     ...
     <li>
      这个方案的缺点是生成的是图片，应该还有其他可以直接导入PlantUml语言的软件，我这里没有寻找，如果大家找到了，请放到我的留言区，不胜感激
     </li>
    </ol>
   </div>
  </div>
 </article>
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f6971616e6368616f2f:61727469636c652f64657461696c732f313436303437313430" class_="artid" style="display:none">
 </p>
</div>
