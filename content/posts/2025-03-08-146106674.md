...
| vcredist\_x64.exe | Microsoft Visual C++ 运行时库的安装程序，用于支持需要该库的应用程序。 |
...
将下载的MongoDB安装包mongodb-linux-x86\_64-rhel70-5.0.30.tgz上传至
**虚拟机Hadoop1**
的/export/software目录。
...
在
**虚拟机Hadoop1**
执行如下命令将mongodb-linux-x86\_64-rhel70-5.0.30重命名为mongodb-5.0.30。
