---
arturl_encode: "68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343034333935322f:61727469636c652f64657461696c732f313436313039373634"
layout: post
title: "RedisSpringboot集成Redis"
date: 2025-03-08 06:13:51 +08:00
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c050ec341de5412b976eedecc6fdbf76.png)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7cf038a7cab345f28335f5f03e682e4f.png)

### 集成lettuce

* 是什么：Lettuce是一个Redis的Java驱动包，Lettuce翻译为生菜，就是吃的那种生菜
* lettuce VS Jedis
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b053010e9104414382de7a247a847262.png)
* 改POM
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/13af70cf90c247eb958f15f3c1471163.png)
* 业务类
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/08904274e967488aa8b1ba9093e2470a.png)
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/090808beeb7f4544b9ffaee3362a9d9d.png)
...
* 主启动
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a0c866e18c774920b1d6291a1ede2434.png)
* 业务类-配置类
...
* 测试
  ...
  + 序列化问题
    ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8be709c359ee434cb7cdb133a59aa2fe.png)
  + 为什么会这样？RedisTemplate使用的是JDK序列化方式（默认）惹的祸
    ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/09e4193fe89b48ada6aa8ff0ee0c4035.png)
      
    ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e55ebc8cf9e04fb1a0331678d665f79b.png)
    ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e245c94d24214f3f8035ae779b8c3980.png)
  ...
  5. 微服务客户端再次读写访问试试
     + 故障现象
       ...
       - 经典故障-故障演练：Redis Cluster集群部署采用了3主3从拓扑结构，数据读写访问master节点，slave节点负责备份。当master宕机主从切换成功，redis手动OK，but 2个经典故障
         ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/2558753fad5047b696b42d641fc9556d.png)
     + 导致原因：SpringBoot 2.X版本，Redis默认的连接池采用Lettuce，当Redis集群节点发生变化后，Letture默认是不会刷新节点拓扑
     + 解决方案

       1. 排除lettuce采用Jedis（不推荐）
          ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/2934de75eda8440095949da578bb443b.png)
       2. 修改源码，重写连接工厂实例（极度不推荐）
       3. 刷新节点集群拓扑动态感应
          ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7fc3b73bad10429280a745d0bea43a3c.png)
          - 解决方法：
            * 调用 RedisClusterClient.reloadPartitions
            * 后台基于时间间隔的周期刷新
            * 后台基于持续的断开和移动、重定向的自适应更新
     + 第二次改写YML
       ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ca604759d915444fbb6f9779d683954e.png)