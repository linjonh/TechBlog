 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-tomorrow-night-eighties" id="content_views">
    ...
    <p>
     <img alt="need_search_image_by_title" src=""/>
    </p>
    <p>
...
&amp;#x20;   private static final String ACTION\_USB\_PERMISSION = "com.example.USB\_PERMISSION";
...
&amp;#x20;       usbManager = (UsbManager) getSystemService(Context.USB\_SERVICE);
...
&amp;#x20;           if (device.getVendorId() == YOUR\_VENDOR\_ID &amp;&amp; device.getProductId() == YOUR\_PRODUCT\_ID) {

&amp;#x20;               usbDevice = device;

&amp;#x20;               // 请求USB权限

&amp;#x20;               usbManager.requestPermission(usbDevice, PendingIntent.getBroadcast(this, 0, new Intent(ACTION\_USB\_PERMISSION), 0));
...
&amp;#x20;           if (ACTION\_USB\_PERMISSION.equals(action)) {

&amp;#x20;               boolean granted = intent.getBooleanExtra(UsbManager.EXTRA\_PERMISSION\_GRANTED, false);
...
&amp;#x20;                       UsbInterface usbInterface = usbDevice.getInterface(YOUR\_INTERFACE\_INDEX);

&amp;#x20;                       UsbEndpoint usbEndpoint = usbInterface.getEndpoint(YOUR\_ENDPOINT\_INDEX);
...
&amp;#x20;                           Toast.makeText(MainActivity.this, "数据发送成功", Toast.LENGTH\_SHORT).show();

&amp;#x20;                       } else {

&amp;#x20;                           Toast.makeText(MainActivity.this, "数据发送失败", Toast.LENGTH\_SHORT).show();
...
&amp;#x20;                           Toast.makeText(MainActivity.this, "数据接收失败", Toast.LENGTH\_SHORT).show();
...
&amp;#x20;                   Toast.makeText(MainActivity.this, "USB权限未授予", Toast.LENGTH\_SHORT).show();
...
&amp;#x20;   }
    ...
    <p>
     <img alt="外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传" src="https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=https%3A%2F%2Fp3-search.byteimg.com%2Fobj%2Flabis%2Ff0eade8e4901f8562d9fbfec08befb99&amp;pos_id=img-n9XF75IE-1741414878199"/>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f33383134383638302f:61727469636c652f64657461696c732f313436313135393233" class_="artid" style="display:none">
 </p>
</div>
