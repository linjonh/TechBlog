 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="670" src="https://i-blog.csdnimg.cn/blog_migrate/7a0cd10f09fe2af04edbceb4ae7b515b.png" width="1076"/>
    </p>
    <p>
     3、添加python37.lib，项目-&gt;属性-&gt;链接器-&gt;输入-&gt;附加依赖项：
    </p>
    <p>
     <img alt="" height="671" src="https://i-blog.csdnimg.cn/blog_migrate/8d55005265eb9dcd8699d01db4b072e9.png" width="1067"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="931" src="https://i-blog.csdnimg.cn/blog_migrate/89988a55786f16714e3b934914aad6b4.png" width="1200"/>
    </p>
    <p>
     5、python demo代码
    </p>
...
if __name__=='__main__':
   pass</code></pre>
    <p>
     ...
     <a href="https://blog.csdn.net/suiyingy/article/details/119053434">
      C++ gbk与utf8互转
     </a>
     。
    </p>
...
int main()
{
    ...
    <p>
     ...
     <a href="https://download.csdn.net/download/suiyingy/20446312">
      callpython.zip
     </a>
     ；32位python或64位python安装方式见：
     <a href="https://blog.csdn.net/suiyingy/article/details/119059002">
      conda 安装32位python
     </a>
     。
    </p>
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f73756979696e67792f:61727469636c652f64657461696c732f313139303436323530" class_="artid" style="display:none">
 </p>
</div>
