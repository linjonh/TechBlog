...
X(e^{j\omega})=\sum\_{n=-\infty}^{\infty}x[n]e^{-j\omega n}, \quad x^\*[-n] \stackrel{DTFT}{\longleftrightarrow} X^\*(e^{j\omega})\\ X(z)=\sum^{\infty}\_{n=-\infty}x[n]z^{-n}=\sum^{\infty}\_{n=-\infty}x[n]r^{-n}e^{-j\omega n},\quad x^\*[-n] \stackrel{z}{\longleftrightarrow} X^\*(\frac{1}{z^\*})
...
H(z)=\frac{\prod\_{m=1}^M(1-c\_mz^{-1})}{\prod\_{n=1}^N(1-d\_nz^{-1})} =>\\ H^\*(z)=\frac{\prod\_{m=1}^M(1-c\_m^\*(z^\*)^{-1})}{\prod\_{n=1}^N(1-d\_n^\*(z^\*)^{-1})}=>\\ H^\*(\frac{1}{z^\*}) = \frac{\prod\_{m=1}^M(1-c\_m^\*z)}{\prod\_{n=1}^N(1-d\_n^\*z)}
...
j
θ
z=d\_n=re^{j\theta}=>z=\frac{1}{d\_n^\*}=\frac{1}{r}e^{j\theta}\\ z=c\_m=re^{j\theta}=>z=\frac{1}{c\_m^\*}=\frac{1}{r}e^{j\theta}
...
=
1
H\_{ap}(z)=\frac{z^{-1}-a^\*}{1-az^{-1}}=>\\ |H\_{ap}(e^{j\omega})|=|\frac{e^{-j\omega}-a^\*}{1-ae^{-j\omega}}|=|e^{j\omega}\frac{(e^{j\omega}-a)^\*}{e^{j\omega}-a}| = 1
...
H\_{ap}(z)=\prod\_{k=1}^M\frac{z^{-1}-d\_k}{1-d\_kz^{-1}}\prod\_{k=1}^M\frac{(z^{-1}-e\_k^\*)(z^{-1}-e\_k)}{(1-e\_kz^{-1})(1-e\_k^\*z^{-1})}
...
c
∗
H(z)=H\_1(z)(z^{-1}-z\_c^\*) \times \frac{1-z\_c^\*}{1-z\_c^\*}=>H\_1(z)(1-z\_c^\*) \times \frac{z^{-1}-z\_c^\*}{1-z\_c^\*}
