...
public class UserController {
    ...
    <pre id="KOw9X"><code>@RequestMapping(value = "/users", method = RequestMethod.GET)
public String getAllUsers() {
    ...
    <pre id="ojseA"><code>@RequestMapping("/search")
public String searchUser(@RequestParam("username") String username) {
    ...
    <pre id="KBk5p"><code>@RequestMapping("/users")
...
public class UserDao {
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f7368616f7a68656e67303530332f:61727469636c652f64657461696c732f313436313834373139" class_="artid" style="display:none">
 </p>
</div>
