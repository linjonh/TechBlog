...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="580" src="https://i-blog.csdnimg.cn/direct/9e21fb6006884cec9602d28e5d49372e.png" width="551"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
     图3-1 操作流程图
    </p>
    ...
    <p>
     <img alt="" height="610" src="https://i-blog.csdnimg.cn/direct/e808b0c0264345d9919e64795b9c067f.jpeg" width="377"/>
    </p>
    <p>
     <img alt="" height="342" src="https://i-blog.csdnimg.cn/direct/90abdd35b48548789315b5c6bdc027a9.jpeg" width="369"/>
    </p>
    <h2 style="margin-left:0; margin-right:0; text-align:center">
     <a name="_Toc14354">
      第四章
    ...
    <p style="margin-left:0; margin-right:0; text-align:justify">
     <img alt="" height="450" src="https://i-blog.csdnimg.cn/direct/92230bf20cd84090b901f1a4dfc30f6e.jpeg" width="362"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:justify">
     <img alt="" height="449" src="https://i-blog.csdnimg.cn/direct/b935cfb4ef324719bb0cf35525b5be06.jpeg" width="326"/>
    </p>
    <h3 style="margin-left:0; margin-right:0">
     <a name="_Toc21648">
      4.3
    ...
    <p style="margin-left:0; margin-right:0; text-align:justify">
     <img alt="" height="269" src="https://i-blog.csdnimg.cn/direct/9a78ad91208840c5a320799b73f9fb66.jpeg" width="288"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
    ...
    <p style="margin-left:0; margin-right:0; text-align:justify">
     <img alt="" height="269" src="https://i-blog.csdnimg.cn/direct/e32898385eb8492293476fdd32d9ccc4.jpeg" width="239"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
    ...
    <table border="1" cellspacing="0" style="width:99.96%">
     <tbody>
      <tr>
       <td style="background-color:#e5e5e5; border-color:black; width:22.36%">
        <p style="margin-left:0; margin-right:0; text-align:center">
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:30.4%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          注释
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:23.78%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          类型
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:23.4%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          空
         </span>
      ...
      <tr>
       <td style="background-color:white; border-color:black; width:22.36%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          id (
         </span>
       ...
       <td style="background-color:white; width:30.4%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          主键
         </span>
       ...
       <td style="background-color:white; width:23.78%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          int(11)
         </span>
       ...
       <td style="background-color:white; width:23.4%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          不允许为空
         </span>
    ...
    <table border="1" cellspacing="0" style="width:99.96%">
     <tbody>
      <tr>
       <td style="background-color:#e5e5e5; border-color:black; width:19.12%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          字段
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:37.24%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          注释
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:24.5%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          类型
         </span>
      ...
      <tr>
       <td style="background-color:white; border-color:black; width:19.12%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          id (
         </span>
       ...
       <td style="background-color:white; width:37.24%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          主键
         </span>
       ...
       <td style="background-color:white; width:24.5%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          int(11)
         </span>
       ...
       <td style="background-color:white; width:19.12%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          不允许为空
         </span>
    ...
    <table border="1" cellspacing="0" style="width:99.96%">
     <tbody>
      <tr>
       <td style="background-color:#e5e5e5; border-color:black; width:20.74%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          字段
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:31.48%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          注释
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:27.92%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          类型
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:19.84%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          空
         </span>
      ...
      <tr>
       <td style="background-color:white; border-color:black; width:20.74%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          id (
         </span>
       ...
       <td style="background-color:white; width:31.48%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          主键
         </span>
       ...
       <td style="background-color:white; width:27.92%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          int(11)
         </span>
       ...
       <td style="background-color:white; width:19.84%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          不允许为空
         </span>
    ...
    <table border="1" cellspacing="0" style="width:99.96%">
     <tbody>
      <tr>
       <td style="background-color:#e5e5e5; border-color:black; width:20.48%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          字段
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:29.96%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          注释
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:26.48%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          类型
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:23.04%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          空
         </span>
      ...
      <tr>
       <td style="background-color:white; border-color:black; width:20.48%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          id (
         </span>
       ...
       <td style="background-color:white; width:29.96%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          主键
         </span>
       ...
       <td style="background-color:white; width:26.48%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          bigint(20)
         </span>
       ...
       <td style="background-color:white; width:23.04%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          不允许为空
         </span>
    ...
    <p class="img-center">
     <a href="http://localhost:8080/phpMyAdmin4.8.5/db_datadict.php?db=fufeiwendaxitong%26table=yonghu%26server=1%26target=" rel="nofollow">
      <img alt="打开新的 phpMyAdmin 窗口" height="299" src="https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=data%3Aimage%2Fpng%3Bbase64%2CiVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAMAAABFaP0WAAAAAXNSR0ICQMB9xQAAAANQTFRFAAAAp3o92gAAAAF0Uk5TAEDm2GYAAAAJcEhZcwAAHYcAAB2HAY%2Fl8WUAAAAZdEVYdFNvZnR3YXJlAE1pY3Jvc29mdCBPZmZpY2V%2F7TVxAAAAC0lEQVQY02NgAAEAAAYAAcHprd0AAAAASUVORK5CYII%3D&amp;pos_id=RwWBxiaR" width="534"/>
     </a>
    </p>
    <p class="img-center">
     <a href="http://localhost/phpMyAdmin4.8.5/db_datadict.php?db=jibingfangkong&amp;table=yonghu&amp;server=1&amp;target=" rel="nofollow">
      <img alt="打开新的 phpMyAdmin 窗口" height="299" src="https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=data%3Aimage%2Fpng%3Bbase64%2CiVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAMAAABFaP0WAAAAAXNSR0ICQMB9xQAAAANQTFRFAAAAp3o92gAAAAF0Uk5TAEDm2GYAAAAJcEhZcwAAHYcAAB2HAY%2Fl8WUAAAAZdEVYdFNvZnR3YXJlAE1pY3Jvc29mdCBPZmZpY2V%2F7TVxAAAAC0lEQVQY02NgAAEAAAYAAcHprd0AAAAASUVORK5CYII%3D&amp;pos_id=mmsUWDU1" width="534"/>
     </a>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
     表4-5 论坛信息表
    ...
    <table border="1" cellspacing="0" style="width:99.96%">
     <tbody>
      <tr>
       <td style="background-color:#e5e5e5; border-color:black; width:28.92%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          字段
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:29.04%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          注释
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:23.26%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          类型
         </span>
       ...
       <td style="background-color:#e5e5e5; border-color:black; width:18.76%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          空
         </span>
      ...
      <tr>
       <td style="background-color:white; border-color:black; width:28.92%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          id (
         </span>
       ...
       <td style="background-color:white; width:29.04%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          主键
         </span>
       ...
       <td style="background-color:white; width:23.26%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          int(11)
         </span>
       ...
       <td style="background-color:white; width:18.76%">
        <p style="margin-left:0; margin-right:0; text-align:center">
         <span style="color:black">
          不允许为空
         </span>
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/97aaceba86df4d619215ca1d8e0869fb.png" width="1210"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
     图5-1 问题帖子管理界面
    </p>
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/97a7b16eade94339961629a7bb82dcdc.png" width="1210"/>
    </p>
    <h4 style="margin-left:0; margin-right:0">
     <a name="_Toc23047">
     </a>
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/4c2268bf87b1401683b4e9364cce495c.png" width="1210"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
     图5-3 新闻信息管理界面
    </p>
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/19ac5bba064b46a1a79b49208388ea16.png" width="1210"/>
    </p>
    <h4 style="margin-left:0; margin-right:0">
     <a name="_Toc16542">
     </a>
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/8338c77a9e824e3d803f725e6627a0b4.png" width="1210"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
     图5-5 轮播图管理界面
    </p>
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/b2f8229d40a349b096230d4c486c354f.png" width="1210"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
     图5-6 新闻信息界面
    </p>
    ...
    <p style="margin-left:0; margin-right:0; text-align:justify">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/7022a38e38c34993aaa0b0f9a4ec55c7.png" width="1210"/>
    </p>
    <h4 style="margin-left:0; margin-right:0">
     <a name="_Toc961">
      5.2.3
    ...
    <p style="margin-left:0; margin-right:0; text-align:justify">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/8151cd18e7b14b1bad2eb29d12050142.png" width="1210"/>
    </p>
    <p style="margin-left:0; margin-right:0; text-align:center">
     图5-8 回答帖子界面
    </p>
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/d66ff5fceb004ae9b5b2deb7767c25ee.png" width="1210"/>
    </p>
    <h4 style="margin-left:0; margin-right:0">
     <a name="_Toc4015">
      5.2.5
    ...
    <p style="margin-left:0; margin-right:0; text-align:center">
     <img alt="" height="577" src="https://i-blog.csdnimg.cn/direct/baf85088dc7544faa19a9f89ba527326.png" width="1210"/>
    </p>
    <blockquote>
     <p>
      大家
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f68756e67656c69616e7368753132332f:61727469636c652f64657461696c732f313436313334373736" class_="artid" style="display:none">
 </p>
</div>
