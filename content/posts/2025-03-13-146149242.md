...
∂
x
\frac{\partial (A\_c C)}{\partial t} = -\frac{\partial (Q C)}{\partial x}
...
∂
t
d=\frac{\partial Q}{\partial x}+\frac{\partial A\_{c}}{\partial t}
...
∂
x
h=\left\{\begin{array}{l}\frac{\partial Q}{\partial x}+\frac{\partial A\_{c}}{\partial x} \\ \frac{\partial\left(A\_{c} C\right)}{\partial t}+\frac{\partial(Q C)}{\partial x}\end{array}\right.
...
,
f
M S E\_{Q, u}+M S E\_{Q, f}+M S E\_{C, u}+M S E\_{C, f}
...
1. M
   ...
   2
   M S E\_{Q, u}=\frac{1}{N\_u} \sum\_{i=1}^{N\_u}\left[Q\left(x\_i, t\_i ; w, b\right)-Q\_i^*\right]^2
...
2. M
   ...
   2
   \text{MSE}\_{Q,f} = \frac{1}{N\_f} \sum\_{j=1}^{N\_f} \left[ f\_Q(x\_j, t\_j; w, b) \right]^2
