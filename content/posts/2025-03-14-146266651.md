...
8
(1)
L(N) = \left( \frac{N\_{c}}{N} \right)^{\alpha\_{N}}, \alpha\_{n}\sim 0.076, N\_{c}\sim 8.8\times 10^13\\ L(D) = \left( \frac{D\_{c}}{C} \right)^{\alpha\_{D}}, \alpha\_{D}\sim 0.095, D\_{c}\sim 5.4\times 10^13\\ L(C) = \left( \frac{C\_{c}}{C} \right)^{\alpha\_{C}}, \alpha\_{C}\sim 0.050, C\_{c}\sim 3.1\times 10^8\tag{1}
...
D
(2)
L(N,D) = \left( (\frac{N\_{c}}{N})^{\alpha\_{N}/\alpha\_{D}} + \frac{D\_{c}}{D}\right)^{\alpha\_{D}}\tag{2}
