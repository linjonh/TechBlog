...
    }
    ...
    <pre><code class="language-java">import org.springframework.jdbc.core.JdbcTemplate;
...
    }
    ...
    <pre><code class="language-java">   Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydatabase", "username", "password");</code></pre>
    <p>
...
   ResultSet resultSet = statement.executeQuery("SELECT * FROM users");</code></pre>
    ...
    <pre><code class="language-java">   int rowsAffected = statement.executeUpdate("UPDATE users SET name='John' WHERE id=1");</code></pre>
    <p>
     <br/>
     5.处理结果集：
     <br/>
...
    }
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f4d6579726c4e6f74466f756e642f:61727469636c652f64657461696c732f313436313338373337" class_="artid" style="display:none">
 </p>
</div>
