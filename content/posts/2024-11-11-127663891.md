...
| hy\_del.php | 会员删除 |
| ht/dingzuo  场地 | caidan\_1ji.php | 场地类型管理 |
| dingzuo\_add.php | 场地录入页面 |
| dingzuo\_add\_act.php | 场地录入程序处理 |
| dingzuo\_list.php | 场地列表 |
| dingzuo\_del.php | 场地删除 |
| dingzuo\_xiugai.php | 场地修改页面 |
| dingzuo\_xiugai\_act.php | 场地修改程序处理 |
| yuyue\_list.php | 场地预约列表 |
| yuyue\_del.php | 场地删除 |
| yuyue\_leixing\_xiugai.php | 场地处理页面 |
| yuyue\_leixing\_xiugai\_act.php | 场地处理程序 |
...
| 场地预约 | wx\_dingzuo\_fenlei.php | 获取分类列表 |
| wx\_dingzuo\_list.php | 根据日期、分类 获取场地的数据 |
| wx\_dingzuo\_yuyue\_add.php | 提交信息 |
...
| wx\_dingzuo\_yuyue\_list\_byUserid.php | 获取用户预约列表 |
| wx\_dingzuo\_yuyue\_del\_byUserid.php | 取消预约 |
