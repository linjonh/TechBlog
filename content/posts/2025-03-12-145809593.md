---
layout: post
title: "苍穹外卖实战附源码-DAY1"
date: 2025-03-12 15:49:44 +0800
description: "跟随up一起完成项目并学习到开发知识"
keywords: "苍穹外卖实战附源码-DAY1"
categories: ['项目', 'Java']
tags: ['后端', 'Spring', 'Boot']
artid: "145809593"
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=145809593
    alt: "苍穹外卖实战附源码-DAY1"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=145809593
featuredImagePreview: https://bing.ee123.net/img/rand?artid=145809593
cover: https://bing.ee123.net/img/rand?artid=145809593
image: https://bing.ee123.net/img/rand?artid=145809593
img: https://bing.ee123.net/img/rand?artid=145809593
---
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     1.通过nginx成功打开包装后的前端网页
    </p>
    <p class="img-center">
     <img alt="" height="750" src="https://i-blog.csdnimg.cn/direct/a878ef81ba9943abbd74274120ab0f42.png" width="1296"/>
    </p>
    <hr/>
    <h2>
     二、导入sky的数据库 sky.sql 数据
    </h2>
    <pre><code class="language-sql">CREATE DATABASE  IF NOT EXISTS `sky_take_out` ;
USE `sky_take_out`;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='用户信息';</code></pre>
    <hr/>
    <h2>
     三、后端基础测试
    </h2>
    <p>
     通过Maven的生命周期compile进行编译，以下报错原因在于Lombok的版本与JDK版本没有对应
    </p>
    <p>
     <img alt="" height="302" src="https://i-blog.csdnimg.cn/direct/0b80bd66ff77461ab81166b7ca5166d3.png" width="1779"/>
    </p>
    <p>
     解决方法：通过修改lombok中版本为1.8.30，并且JDK改为21就解决了，能够成功complie
    </p>
    <p>
     修改后的pom.xml
    </p>
...
&lt;/project&gt;
    ...
    <p class="img-center">
     <img alt="" height="535" src="https://i-blog.csdnimg.cn/direct/3eb61ac7ea6c41bf9d63e4977d662c36.png" width="1302"/>
    </p>
    <hr/>
    <p>
     四、启动项目并断点测试
    ...
    <p class="img-center">
     <img alt="" height="312" src="https://i-blog.csdnimg.cn/direct/33c8043dd4ff4985926c94bbf33f53b8.png" width="1095"/>
    </p>
    <p>
     4.2 打开前端nginx文件
    </p>
    <p class="img-center">
     <img alt="" height="421" src="https://i-blog.csdnimg.cn/direct/fbccfe9010dc4897b1eb44d7a9ffcb1a.png" width="1082"/>
    </p>
    <hr/>
    <h2>
     四、nginx介绍
    ...
    <p class="img-center">
     <img alt="" height="509" src="https://i-blog.csdnimg.cn/direct/cc41f58521b540d1ac45e221acaabd4a.png" width="1162"/>
    </p>
    <p>
     4.2 使用nginx好处
    </p>
    <p class="img-center">
     <img alt="" height="659" src="https://i-blog.csdnimg.cn/direct/9e3c385c2a6f4892bbc84a7b919aca31.png" width="1117"/>
    </p>
    <p>
     4.3 nginx配置
    </p>
    <pre><code class="hljs"># 反向代理,处理管理端发送的请求
        location /api/ {
    ...
    <blockquote>
     <p>
      核心在于proxy_pass。
      <br/>
      后端本来是localhost:8080,而前端请求是localhost/api/user/login通过代理后请求实际上是 http://localhost:8080/admin/user/login
     </p>
    </blockquote>
    <p>
     4.4 负载均衡配置：
    </p>
    <pre><code class="hljs">upstream webservers{
    ...
    <p class="img-center">
     <img alt="" height="486" src="https://i-blog.csdnimg.cn/direct/1a87ed51a5c047cea51677b9bd2247ad.png" width="1122"/>
    </p>
    <p>
     Nginx反向代理设置
    </p>
...
public class PageResult implements Serializable {  
    ...
    <p class="img-center">
     <img alt="" height="610" src="https://i-blog.csdnimg.cn/direct/a9a88f96048a4b16bccbe8eb0e02f5e8.png" width="1091"/>
    </p>
    <p>
     设计对应的传输类DTO和视图类VO
    </p>
...
public class EmployeePageQueryDTO implements Serializable {  
    ...
    <p class="img-center">
     <img alt="" height="394" src="https://i-blog.csdnimg.cn/direct/5bc6f0f1658b4c158cc52e78d15206fe.png" width="1165"/>
    </p>
    <p>
     5.3 自定义异常类
    </p>
    ...
    <p class="img-center">
     <img alt="" height="465" src="https://i-blog.csdnimg.cn/direct/59129b23e70d4bc1a0050f0b1822ce4a.png" width="1162"/>
    </p>
    <p>
     异常类案例：
    </p>
...
public class AccountNotFoundException extends BaseException {  
    ...
    <p>
     在项目中有许多字段是多次使用的，并且是固定值，所以用常量类来装配这些字段
    </p>
    <p class="img-center">
     <img alt="" height="570" src="https://i-blog.csdnimg.cn/direct/198fcd407f904d929f98687ec1442103.png" width="1190"/>
    </p>
    <p>
    </p>
   </div>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f646f67786978692f:61727469636c652f64657461696c732f313435383039353933" class_="artid" style="display:none">
 </p>
</div>
