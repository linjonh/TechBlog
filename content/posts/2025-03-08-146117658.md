 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h3 id="%E7%AC%AC%E4%B8%80%E6%AD%A5%EF%BC%9A%E6%B7%BB%E5%8A%A0%E7%94%A8%E6%88%B7%E8%BF%9B%E7%A8%8B%E8%99%9A%E6%8B%9F%E7%A9%BA%E9%97%B4" name="%E7%AC%AC%E4%B8%80%E6%AD%A5%EF%BC%9A%E6%B7%BB%E5%8A%A0%E7%94%A8%E6%88%B7%E8%BF%9B%E7%A8%8B%E8%99%9A%E6%8B%9F%E7%A9%BA%E9%97%B4">
     第一步：添加用户进程虚拟空间
    </h3>
    <p>
...
typedef struct __cctaskstruct
{
 ...
    uint32_t stack_magic; // Magic value for stack overflow detection
    ...
    <pre><code class="language-cpp">// Physical Memory Pools definition
...
typedef struct __mem_pool
{
 ...
    CCLocker lock;
    ...
    <pre><code class="language-cpp">// Function to initialize the physical memory pools
static void init_memory_pool(const uint32_t all_memory)
{
 ...
    verbose_ccputs("     memory pool init done\n");
    ...
    <pre><code class="language-cpp">/* Allocate virtual memory pages from the specified pool (kernel or user).
...
​
 ...
    return (void *)vaddr_start; // Return the starting virtual address of the allocated pages
    ...
    <pre><code class="language-cpp">/* Allocate 4KB of memory from the user space and return the corresponding
 * virtual address */
...
​
 ...
    return (void *)vaddr;
    ...
    <pre><code class="language-cpp">/* Associate the address vaddr with the physical address in the pf pool,
 * supports only single page allocation */
void *get_a_page(PoolFlag pf, uint32_t vaddr) {
​
    MemoryPool* mem_pool = pf &amp; PF_KERNEL ? &amp;kernel_pool : &amp;user_pool;
...
​
 ...
    return (void *)vaddr;
    ...
    <pre><code class="language-cpp">/* Get the physical address mapped to the virtual address */
uint32_t addr_v2p(uint32_t vaddr) {
 ...
    return ((*pte &amp; PG_FETCH_OFFSET) + (vaddr &amp; PG_OFFSET_MASK));
    ...
    <h3 id="%E5%87%86%E5%A4%87%E5%86%B2%E5%90%91%E6%88%91%E4%BB%AC%E7%9A%84%E7%89%B9%E6%9D%83%E7%BA%A73%EF%BC%88%E7%94%A8%E6%88%B7%E7%89%B9%E6%9D%83%E7%BA%A7%EF%BC%89" name="%E5%87%86%E5%A4%87%E5%86%B2%E5%90%91%E6%88%91%E4%BB%AC%E7%9A%84%E7%89%B9%E6%9D%83%E7%BA%A73%EF%BC%88%E7%94%A8%E6%88%B7%E7%89%B9%E6%9D%83%E7%BA%A7%EF%BC%89">
     准备冲向我们的特权级3（用户特权级）
    </h3>
    <p>
...
​
 ...
    uint32_t ss;       // Stack segment
    ...
    <h3 id="%E8%AE%A8%E8%AE%BA%E4%B8%8B%E6%88%91%E4%BB%AC%E5%88%9B%E5%BB%BA%E7%94%A8%E6%88%B7%E7%BA%BF%E7%A8%8B%E7%9A%84%E5%9F%BA%E6%9C%AC%E6%AD%A5%E9%AA%A4" name="%E8%AE%A8%E8%AE%BA%E4%B8%8B%E6%88%91%E4%BB%AC%E5%88%9B%E5%BB%BA%E7%94%A8%E6%88%B7%E7%BA%BF%E7%A8%8B%E7%9A%84%E5%9F%BA%E6%9C%AC%E6%AD%A5%E9%AA%A4">
     讨论下我们创建用户线程的基本步骤
    </h3>
    <p>
    ...
    <p>
     <img alt="" height="1171" src="https://i-blog.csdnimg.cn/direct/fd79d15549bd490eb5ee2fa193aabf5c.png" width="793"/>
    </p>
    <pre><code class="language-cpp">/* Execute a user process */
...
​
 ...
    set_intr_status(old_status); // Restore the interrupt state
} // if u feel puzzled, see below!</code></pre>
    <p>
    ...
    <h4 id="%E6%9B%B4%E5%8A%A0%E8%AF%A6%E7%BB%86%E7%9A%84%E5%88%86%E6%9E%90%E4%BB%A3%E7%A0%81" name="%E6%9B%B4%E5%8A%A0%E8%AF%A6%E7%BB%86%E7%9A%84%E5%88%86%E6%9E%90%E4%BB%A3%E7%A0%81">
     更加详细的分析代码
    </h4>
    <p>
     我们更详细的分析一下代码。首先，我们在之前的博客就提到了要处理Flags的事情，这里再把我们selectors.h文件中关于EFLAGS寄存器的事情再看看
    </p>
    <pre><code class="language-cpp">#define EFLAGS_MBS  (1 &lt;&lt; 1)    // Must be set to 1.
...
#define EFLAGS_IOPL_0   (0 &lt;&lt; 12)   // IOPL = 0, restricts I/O access to kernel mode.</code></pre>
    <p>
     这个没啥好说的，我们下一步看看我们的process.c文件下的函数
    </p>
    <pre><code class="language-cpp">extern void intr_exit(void);
...
static void start_process(void *filename_) {
 ...
                 : "memory"); // Switch to the user process context
    ...
    <pre><code class="language-cpp">+---------------------------+ &lt;- 高地址（栈底）
|        ss (0x73)         |  用户数据段选择子
+---------------------------+
|        esp               |  指向用户栈的顶端
+---------------------------+
...
+---------------------------+ &lt;- 低地址（栈顶）</code></pre>
    ...
    <p>
     <img alt="" height="378" src="https://i-blog.csdnimg.cn/direct/5f566487dc6546feb59f7744a49b2947.png" width="430"/>
    </p>
    <p>
    ...
    <pre><code class="language-cpp">#define USER_STACK3_VADDR  (KERNEL_V_START - PG_SIZE)</code></pre>
    <p>
     更好说明，我把代码单独给出来：
    </p>
    <pre><code class="language-cpp">    proc_stack-&gt;esp =
        (void *)((uint32_t)get_a_page(PF_USER, USER_STACK3_VADDR) +
                 PG_SIZE);             // Set up user stack</code></pre>
    <p>
    ...
    <pre><code class="language-cpp">/* Activate the page directory */
...
​
 ...
    asm volatile("movl %0, %%cr3" : : "r"(pagedir_phy_addr) : "memory");
    ...
    <pre><code class="language-cpp">void activate_process_settings(TaskStruct *p_thread) {
...
​
 ...
    }
    ...
    <h3 id="%E8%AF%B4%E4%B8%80%E8%AF%B4BSS%E6%AE%B5" name="%E8%AF%B4%E4%B8%80%E8%AF%B4BSS%E6%AE%B5">
     说一说BSS段
    </h3>
    <p>
    ...
    <pre><code class="language-bash">ELF Header:
...
​
 ...
   10     .eh_frame_hdr 
   11     
   12     .init_array .fini_array .data.rel.ro .dynamic .got </code></pre>
    <p>
    ...
    <pre>  LOAD           0x0000000000006000 0x0000000000006000 0x0000000000006000
                 0x000000000001ecc1 0x000000000001ecc1  R E    0x1000</pre>
    <p>
    ...
    <pre>  LOAD           0x000000000002f0f0 0x000000000002f0f0 0x000000000002f0f0
                 0x0000000000002388 0x0000000000002e10  RW     0x1000</pre>
    <p>
    ...
    <h3 id="%E7%BB%A7%E7%BB%AD%E7%9C%8Bprocess.c%E4%B8%AD%E7%9A%84%E5%87%BD%E6%95%B0" name="%E7%BB%A7%E7%BB%AD%E7%9C%8Bprocess.c%E4%B8%AD%E7%9A%84%E5%87%BD%E6%95%B0">
     继续看process.c中的函数
    </h3>
    <pre><code class="language-cpp">/* Create a new page directory, copying the kernel space entries from the
...
​
 ...
                           // page directory
    ...
    <p>
     <img alt="" height="619" src="https://i-blog.csdnimg.cn/direct/355d055f0e914162a00f5fdefee908d2.png" width="960"/>
    </p>
    <p>
     看到这个表，我们这个表中，只需要内核页表的入口导入到每一个用户进程的页表上就好了。
    </p>
    <pre><code class="language-cpp">/* Create the user process's virtual address bitmap */
static void create_user_vaddr_bitmap(TaskStruct *user_prog) {
 ...
    bitmap_init(&amp;user_prog-&gt;userprog_vaddr.virtual_mem_bitmap);
    ...
    <h3 id="%E6%B7%BB%E5%8A%A0%E7%94%A8%E6%88%B7%E7%BA%BF%E7%A8%8B%E6%BF%80%E6%B4%BB" name="%E6%B7%BB%E5%8A%A0%E7%94%A8%E6%88%B7%E7%BA%BF%E7%A8%8B%E6%BF%80%E6%B4%BB">
     添加用户线程激活
    </h3>
    <p>
     我们还差对schedule的处理
...
void u_prog_b(void) { 
 ...
    } 
    ...
    <pre>&gt; nm middleware/kernel.bin | grep -P "u_prog|test_var"
c00091c0 B test_var_a
c00091c4 B test_var_b
c0001609 T u_prog_a
c0001627 T u_prog_b</pre>
    <p>
    ...
    <p>
     <img alt="" height="604" src="https://i-blog.csdnimg.cn/direct/2dd5503ea14e4f3d8c0bccdd937e9e75.png" width="1064"/>
    </p>
    <p>
     <img alt="" height="596" src="https://i-blog.csdnimg.cn/direct/42e8477a21024dd88f0415253c85c442.png" width="1089"/>
    </p>
    <p>
    ...
    <pre>(0) [0x000000001643] 002b:c0001643 (unk. ctxt): jmp .-17  (0xc0001634)    ; ebef
&lt;bochs:11&gt; sreg
...
idtr:base=0xc0009360, limit=0x17f</pre>
    <h3>
     下一篇
    </h3>
    <p>
     <a class="has-card" href="https://blog.csdn.net/charlie114514191/article/details/146130681" title="从0开始的操作系统手搓教程28：实现Syscall架构体系-CSDN博客">
    ...
    <p>
     <a class="has-card" href="https://github.com/Charliechen114514/CCOperateSystem/tree/main/Documentations/10_Implement_User_Thread" title="CCOperateSystem/Documentations/10_Implement_User_Thread at main · Charliechen114514/CCOperateSystem">
      <span class="link-card-box" contenteditable="false">
       <span class="link-title">
        CCOperateSystem/Documentations/10_Implement_User_Thread at main · Charliechen114514/CCOperateSystem
       </span>
       <span class="link-link">
        <img class="link-link-icon" src="https://csdnimg.cn/release/blog_editor_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=P1C7">
         https://github.com/Charliechen114514/CCOperateSystem/tree/main/Documentations/10_Implement_User_Thread
        </img>
       </span>
      </span>
     </a>
 ...
 <p alt="68747470733a2f2f626c6f672e63:73646e2e6e65742f636861726c69653131343531343139312f:61727469636c652f64657461696c732f313436313137363538" class_="artid" style="display:none">
 </p>
</div>
