...
> frame\_count = int(capture.get(cv2.CAP\_PROP\_FRAME\_COUNT))
>
> frame\_width = int(capture.get(cv2.CAP\_PROP\_FRAME\_WIDTH))
>
> frame\_height = int(capture.get(cv2.CAP\_PROP\_FRAME\_HEIGHT))
