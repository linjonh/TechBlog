 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     <a href="https://blog.csdn.net/qq_41813208/article/details/105480515">
      上一篇我们用三台Ubuntu搭建了MySQL集群服务器
     </a>
    </p>
    <p>
     或
     <a href="https://blog.csdn.net/qq_41813208/article/details/105424946">
      docker搭建了MySQL集群服务器
     </a>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="274" src="https://i-blog.csdnimg.cn/blog_migrate/f0077e008a3da11167f7cef26a74f550.png" width="801"/>
    </p>
    <p>
     对应sql
    </p>
    <pre><code class="language-sql">CREATE USER `haproxy`@`%` IDENTIFIED WITH mysql_native_password;</code></pre>
    <p>
    </p>
    <p>
    </p>
    ...
    <pre><code>apt install haproxy -y</code></pre>
    <p>
     修改配置文件
    </p>
    <pre><code class="language-bash">vim /etc/haproxy/haproxy.cfg</code></pre>
    <p>
...
option  tcpka  </code></pre>
    ...
    <p>
     <a href="http://localhost:4001/dbs" rel="nofollow">
    ...
    <p>
     <img alt="" height="310" src="https://i-blog.csdnimg.cn/blog_migrate/aa62eff94c8bf0418f02a2c67ddce3d8.png" width="853"/>
    </p>
    <p>
     以及通过haproxy的ip 端口3306可以管理mysql数据库   这个也就是暴露在外部使用的数据库服务器ip
    </p>
    <p>
     <img alt="" height="400" src="https://i-blog.csdnimg.cn/blog_migrate/d09ce65b74757ce3d0b240f282fbf42f.png" width="344"/>
    </p>
    <p>
    ...
    <pre><code class="language-bash">apt install keepalived -y</code></pre>
    <p>
     查看本机网卡
    </p>
    <pre><code class="language-bash">ifconfig</code></pre>
    <p>
     <img alt="" height="337" src="https://i-blog.csdnimg.cn/blog_migrate/8600656029ed24fc08bc1aa8b0c089f3.png" width="863"/>
    </p>
    <p>
    </p>
    <p>
...
virtual_server 192.168.117.244 443 {
    ...
    <pre><code>service keepalived restart</code></pre>
    <p>
    </p>
    <p>
    </p>
    ...
    <p>
     <img alt="" height="161" src="https://i-blog.csdnimg.cn/blog_migrate/25c76d6a9969d3a0400bbc84468f3ba4.png" width="581"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="365" src="https://i-blog.csdnimg.cn/blog_migrate/5e58da32beef6c59e0e8e2fbe8133862.png" width="879"/>
    </p>
    <p>
     <img alt="" height="372" src="https://i-blog.csdnimg.cn/blog_migrate/6e3b408a622cdc68b449d078ae6c68fe.png" width="638">
     </img>
    </p>
    <p>
     如果你还想进一步学习：
     <a href="https://blog.csdn.net/qq_41813208/article/details/105496993">
      搭建Nginx集群+Haproxy集群
     </a>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34313831333230382f:61727469636c652f64657461696c732f313035343830353239" class_="artid" style="display:none">
 </p>
</div>
