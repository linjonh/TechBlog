 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     1、整合前面连篇文章（
     <a href="http://blog.csdn.net/cyxlzzs/article/details/7999212">
      Lucene学习——IKAnalyzer中文分词（一）
     </a>
     和
     <a href="http://blog.csdn.net/cyxlzzs/article/details/7998304">
      Lucene学习——初探搜索引擎
     </a>
     ），使该搜索引擎雏形支持中文站点
    </p>
    ...
    <pre><code class="language-java">package org.cyxl.lucene.test;
...
//		doc.add(new Field("content",reader));
    ...
    <pre><code class="language-plain">加载扩展词典：ext.dic
...
http://www.pongo.cn
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f4359584c5a5a:532f61727469636c652f64657461696c732f38303030333835" class_="artid" style="display:none">
 </p>
</div>
