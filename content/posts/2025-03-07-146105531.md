 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><img alt="" height="1077" src="https://i-blog.csdnimg.cn/direct/89075e29873a473a9149354632f8dacf.png" width="1147">
</img></pre>
    <p>
    </p>
    <h3>
...
class MultiHeadAttention(nn.Module):
    ...
    <blockquote>
     <pre>class PositionalEncoding(nn.Module):
    "实现位置编码"
    ...
    <blockquote>
     <pre>class EncoderLayer(nn.Module):
    ...
    <blockquote>
     <pre>class DecoderLayer(nn.Module):
    def __init__(self, d_model, n_heads, d_ff, dropout=0.1):
...
print(output.shape)</pre>
    ...
    <p>
     <img alt="" height="47" src="https://i-blog.csdnimg.cn/direct/771f6373d7b14b05a33d23a36baf2cca.png" width="423"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35393930373339342f:61727469636c652f64657461696c732f313436313035353331" class_="artid" style="display:none">
 </p>
</div>
