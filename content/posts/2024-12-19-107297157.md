...
# WebRTC音视频同步详解
#### WebRTC音视频同步详解
\* [1 WebRTC版本](#1\_WebRTC\_1)
\* [2 时间戳](#2\_\_3)
\* + [2.1 视频时间戳](#21\_\_8)
+ [2.2 音频时间戳](#22\_\_16)
+ [2.3 NTP时间戳](#23\_NTP\_19)
\* [2 延迟](#2\_\_30)
\* [3 同步](#3\_\_37)
\* + [3.1 一张图看懂音视频同步](#31\_\_38)
+ [3.2 音视频相对延迟](#32\_\_55)
+ [3.3 期望目标延迟](#33\_\_70)
+ - [3.3.1 期望视频目标延迟](#331\_\_85)
- [3.3.2 期望音频目标延迟](#332\_\_99)
+ [3.4 音视频同步](#34\_\_107)
+ [3.5 渲染时间](#35\_\_132)
+ - [3.5.1 视频渲染时间](#351\_\_133)
- \* [3.5.1.1 期望接收时间](#3511\_\_136)
\* [3.5.1.2 视频当前延迟 - googCurrentDelayMs](#3512\_\_\_googCurrentDelayMs\_149)
\* [3.5.1.3 计算渲染时间](#3513\_\_165)
- [3.5.2 音频渲染时间](#352\_\_174)
## 1 WebRTC版本
m74
## 2 时间戳
音视频采样后会给每个音频采样、视频帧打一个时间戳，打包成RTP后放在RTP头中，称为RTP时间戳，RTP时间戳的单位依赖于音视频流各自的采样率。
RTP Header格式如下：
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/643af90624a47706001e2d87226e5e0e.png)
### 2.1 视频时间戳
...
### 2.2 音频时间戳
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/9e8d11f61fba8df0122b0b133b5611d9.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/2bedcba98db77a68784dc29871e24367.png)
...
## 3 同步
### 3.1 一张图看懂音视频同步
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/2d89f276b454623c11e17f3c582bf367.png)
...
\* 正确设置音视频各自的播放延迟。
### 3.2 音视频相对延迟
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/66751023c65b77a2c96942737063a2ca.png)
如上图：
最近一对音视频包的相对延迟 = (T
video\\_recv
- T
...
>
> StreamSynchronization::ComputeRelativeDelay
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/b9146e65d9d8078693e4a9f141db6a3d.png)
```
当前音视频流相对延迟 = 最近一对音视频包的相对延迟 + 音视频目标延迟之差
```
#### 3.3.1 期望视频目标延迟
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/b532446de60ddcd636c8790701fc18a6.png)
```
...
#### 3.3.2 期望音频目标延迟
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/ff059e76f75655f11e3d35e1a8822f86.png)
...
### 3.4 音视频同步
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/8e32713d40ffd6ea1b7b927e7be17de9.png)
同步器的外部输入有：
...
```
extra\_audio\_delay\_ms -> 音频最小播放延迟
extra\_video\_delay\_ms -> 视频最小播放延迟
```
...
### 3.5 渲染时间
#### 3.5.1 视频渲染时间
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/c7a34130fe6ec861c98524d0f42a5d11.png)
该图是计算视频渲染时间的总体描述图，仍然比较复杂，以下分几个部分描述。
##### 3.5.1.1 期望接收时间
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/6bf1d6d7db843d5c864d8dc65f747ac6.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/99835b1bf540342bd0dd3e5c430e0d15.png)
...
##### 3.5.1.3 计算渲染时间
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/105110fb922c942108f908f1074fc6b4.png)
...
#### 3.5.2 音频渲染时间
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/47a09300dd4b8b01ac88f59aff8b3fe3.png)
...
>
> ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/632ea0efb3c0eccf0caead2501dfad2a.png)
