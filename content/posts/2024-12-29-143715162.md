...
【问题现象】安全弹框部分场景下无法点击授权，SaveButton在onClick事件下返回失败信息“TEMPORARY\_AUTHORIZATION\_FAILED”。
...
【解决措施】AVCodec Kit新增接口获取轨道起始时间信息 OH\_MD\_KEY\_TRACK\_START\_TIME单位错误导致此问题。后续版本规划解决。
