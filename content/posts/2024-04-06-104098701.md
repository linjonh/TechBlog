 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="按察使趁风使柁" src="https://i-blog.csdnimg.cn/blog_migrate/29948037d7e383806c8ff0b015a01133.png">
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/eb877b78bc267e5c69b4cce7c7db52fb.png"/>
     </img>
    </p>
    <h2>
     <font color="green">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/4a865f630a6a68b52179ff12eee510fa.png"/>
    </p>
    <h3>
     我们在分别介绍一下这三个文件
    </h3>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/39f263310eb8989019ae5e2f76b2a762.png"/>
    </p>
    <h4>
     <font color="green">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/220a652afed280dee5c2b10b2fe9a656.png"/>
    </p>
    <h3>
     <font color="green">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a84c4ca0877aaf96995cbf763275cbe2.png"/>
    </p>
    <h4>
     <font color="green">
      (3) 后端的程序编写，我就直接上代码了
...
protected void onDestroy() {
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/3f2a6d293e96f91af600cbfa0c4bd2bf.png"/>
    </p>
    <h4>
     小白上路，如有不妥，望请见谅。
    </h4>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34333036343037372f:61727469636c652f64657461696c732f313034303938373031" class_="artid" style="display:none">
 </p>
</div>
