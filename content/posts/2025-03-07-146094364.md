 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-javascript">npm i pdfjs-dist -S</code></pre>
    <p>
     然后在vue页面中引入：
    </p>
    <pre><code class="language-javascript">import * as pdfjsLib from "pdfjs-dist/legacy/build/pdf.js";
import * as pdfjsWorker from "pdfjs-dist/legacy/build/pdf.worker.entry.js";
pdfjsLib.GlobalWorkerOptions.workerSrc = pdfjsWorker;</code></pre>
    <p>
     下面是在methods里面写的方法：
    </p>
    <pre><code class="language-javascript">// 通过前台用pdf转图片
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f7a726578616d2f:61727469636c652f64657461696c732f313436303934333634" class_="artid" style="display:none">
 </p>
</div>
