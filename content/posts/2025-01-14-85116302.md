...
根据PEP285中Review部分第6条所述，bool类是从int类继承而来的，这样可以极大的简化实现（C代码中调用PyInt\_Check()的地方仍将继续工作）。
...
我们可以通过dis模块来查看while\_one和while\_true的字节码，下面的程序是对刚才的程序进行了一定的简化后的版本。
...
if\_x\_eq\_true: 0.212558031082

if\_x: 0.144327878952
