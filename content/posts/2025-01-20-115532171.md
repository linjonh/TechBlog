 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h3 id="%E2%80%8B%E2%80%8B%E2%80%8B%E2%80%8B%E2%80%8B%E2%80%8B%E2%80%8B%E4%BA%8C%E3%80%81%E6%95%B0%E6%8D%AE%E5%8F%91%E5%B8%83%E4%B8%8E%E8%AE%A2%E9%98%85">
     二、数据发布与订阅
    </h3>
    <h4 id="1%20%E6%A6%82%E8%BF%B0">
     <br/>
     1 概述
    </h4>
    <p>
    ...
    <h4 id="2%C2%A0%C2%A0%20%C2%A0%E5%B9%B3%E5%8F%B0%E6%97%A0%E5%85%B3%E6%A8%A1%E5%9E%8B">
     <br/>
     2    平台无关模型
    </h4>
    <p>
    ...
    <table align="center" border="1" cellspacing="0">
     <tbody>
      <tr>
       <td style="vertical-align:top;width:196.3pt;">
        <p style="margin-left:0cm;">
         <strong>
          编码
         </strong>
       ...
       <td style="vertical-align:top;width:164.95pt;">
        <p style="margin-left:0cm;">
         <strong>
          含义
         </strong>
       ...
       <td style="vertical-align:top;width:53.55pt;">
        <p style="margin-left:0cm;">
         <strong>
          数值
         </strong>
    ...
    <p>
     <img alt="" height="380" src="https://i-blog.csdnimg.cn/blog_migrate/414d13d44002f1f76da4b16c032a9d3c.png" width="554"/>
    </p>
    <p>
     <a name="_Ref9517835">
      图
    ...
    <p>
     <img alt="" height="476" src="https://i-blog.csdnimg.cn/blog_migrate/f9ae62ccc46d255bfe58a0b7a1c2abae.png" width="554"/>
    </p>
    <p>
     <a name="_Ref9518444">
      图
    ...
    <p>
     <img alt="" height="278" src="https://i-blog.csdnimg.cn/blog_migrate/43ca5a9b86fd07d8d9fc4d3f77850afc.png" width="326"/>
    </p>
    <p>
     <a name="_Ref9517971">
      图
    ...
    <p>
     <img alt="" height="313" src="https://i-blog.csdnimg.cn/blog_migrate/371b6f369414dc7f8851f5307196f29d.png" width="554"/>
    </p>
    <p>
     <a name="_Ref9518013">
      图
    ...
    <p>
     <img alt="" height="388" src="https://i-blog.csdnimg.cn/blog_migrate/25cf08635b374c6ffc2efa6d9e89dd75.png" width="554"/>
    </p>
    <p>
     <a name="_Ref9518467">
      图
    ...
    <p>
     <img alt="" height="345" src="https://i-blog.csdnimg.cn/blog_migrate/3d55d33c55dc040a7bd0200ebb4891cc.png" width="554"/>
    </p>
    <p>
     <a name="_Ref9518485">
      图
    ...
    <p>
     <img alt="" height="536" src="https://i-blog.csdnimg.cn/blog_migrate/1befa8f921e32c95edd8b87b66943044.png" width="554"/>
    </p>
    <p>
     <a name="_Ref9518501">
      图
    ...
    <p>
     <img alt="" height="611" src="https://i-blog.csdnimg.cn/blog_migrate/cac853b8b7761cfe265e630bec8f4c05.png" width="532"/>
    </p>
    <p>
     <a name="_Ref9518517">
      图
    ...
    <table align="left" border="1" cellspacing="0" style="margin-left:6.75pt;width:0px;">
     <tbody>
      <tr>
      ...
      <tr>
       <td style="width:155.7pt;">
        <p style="margin-left:0cm;">
         DataWriterMessageMode
        </p>
       </td>
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos允许用户控制报文的信息，已减少报文的内容
        </p>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos控制DataReader接收的来自不同DataWriter的数据样本之间的顺序。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos用于声明和判断DomainParticipant的存活性。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos控制DataReader获取DataWriter发送的“历史数据”的与否以及数据来源。
        </p>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos允许应用向Publisher和Subscriber附加额外的信息。
        </p>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos指定ZRDDS服务如何判断一个DataWriter是否存活。
        </p>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       <td style="width:155.7pt;">
        <p style="margin-left:0cm;">
         DDSMsgStatisticsInfo
        </p>
       </td>
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos允许用户配置报文统计信息的发布信息。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos控制ZRDDS服务是否允许多个DataWriter同时更新同一数据实例下的数据对象。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos是Ownership的扩展，当且仅当ownership.kind = EXCLUSIVE_OWNERSHIP_QOS时，ownership_strength. value的取值有意义。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos决定Publisher和Subscriber创建的DataWriter和DataReader所属的“逻辑分区”，从而控制之间的数据通信。
        </p>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos控制DataReader如何处理它所管理的数据实例的样本的生命周期。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos用于配置DomainParticipant的线程数量。
        </p>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos指明一个DataReader在每个最小周期中希望收到最多一包数据。
        </p>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos用于配置发送DomainParticipant消息的目的地址，可以用于发现不同域的DomainParticipant。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos允许用户向创建的Entity对象（DomainParticipant、DataWriter、DataReader）附加额外信息。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos控制了DataWriter如何处理它管理实例的生命周期。
        </p>
       </td>
      </tr>
      <tr>
       ...
       <td style="width:248.05pt;">
        <p style="margin-left:0cm;">
         该Qos定义了多种设置可以配置DataWriter如何为内部资源分配和使用物理内存。
        </p>
       </td>
      </tr>
     </tbody>
    ...
    <table border="1" cellspacing="0" style="margin-left:-.25pt;width:0px;">
     <tbody>
      <tr>
       <td colspan="2" style="vertical-align:top;width:7cm;">
        <p style="margin-left:0cm;">
         <strong>
          Listeners
         </strong>
      ...
      <tr>
       <td rowspan="13" style="width:106.35pt;">
        <p style="margin-left:0cm;">
         <strong>
          DomainParticpants
         </strong>
      ...
      <tr>
       <td rowspan="7" style="width:92.1pt;">
        <p style="margin-left:0cm;">
         <strong>
          DataReaders
         </strong>
      ...
      <tr>
       <td rowspan="4" style="width:92.1pt;">
        <p style="margin-left:0cm;">
         <strong>
          DataWriters
         </strong>
    ...
    <p>
     <img alt="" height="456" src="https://i-blog.csdnimg.cn/blog_migrate/84db121d855c7ca24bdbbce63807d9eb.png" width="554"/>
    </p>
    <p>
     <a name="_Ref9518619">
      图
    ...
    <table border="1" cellspacing="0" style="width:414.8pt;">
     <tbody>
      ...
      <tr>
       <td rowspan="7" style="width:70.65pt;">
        <p style="margin-left:0cm;">
         <span style="color:#000000;">
          DataReader
         </span>
    ...
    <pre><code class="language-html">//@copy // Modification History
//@copy
...
Bar barfield;//@resolve-name false
    ...
    <table border="1" cellspacing="0" style="width:410.85pt;">
     <tbody>
      <tr>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f6a6a31323334356a6a3139383939392f:61727469636c652f64657461696c732f313135353332313731" class_="artid" style="display:none">
 </p>
</div>
