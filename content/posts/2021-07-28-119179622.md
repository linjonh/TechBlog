...
环境变量安装可以参考：
[Win 10安装Python及环境变量配置\_LYJ\_viviani的博客-CSDN博客\_python安装教程win10](http://blog.csdn.net/lyj_viviani/article/details/51763101 "Win 10安装Python及环境变量配置_LYJ_viviani的博客-CSDN博客_python安装教程win10")
...
：
[Can‘t find Python executable “ python“， you can set the PYTHON env variable\_哼,小呀么小胖子的博客-CSDN博客](https://blog.csdn.net/qq_43412333/article/details/107771709 "Can‘t find Python executable “ python“， you can set the PYTHON env variable_哼,小呀么小胖子的博客-CSDN博客")

[参考自](https://blog.csdn.net/weixin_36222137/article/details/78463543 "参考自")
：
[Error: Can't find Python executable "python", you can set the PYTHON env variable.解决办法\_yhy\_的博客-CSDN博客](https://blog.csdn.net/weixin_36222137/article/details/78463543 "Error: Can't find Python executable \"python\", you can set the PYTHON env variable.解决办法_yhy_的博客-CSDN博客")
