...
登录虚拟机安装phpstudy并启动，搭建pikachu平台  然后记得关闭windows10的防火墙以免有影响，还有phpstudy扩展设置下参数开关里的magic\_quotes\_gpc关闭或取消勾选。打开cmd查看记住ip，返回物理机访问w10ip下的pikachu，可以看到pikachu靶场创建成功，准备另一台虚拟机用于作客户端主机
