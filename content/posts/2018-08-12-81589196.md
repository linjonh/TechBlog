...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre class="has"><code class="language-python">BaseException  # 所有异常的基类
 +-- SystemExit  # 解释器请求退出
 ...
 +-- Exception  # 常规异常的基类
    ...
    <p>
     详细说明请参考：
     <a href="https://docs.python.org/3/library/exceptions.html#base-classes" rel="nofollow">
    ...
    <pre class="has"><code class="language-python">from requests.exceptions import ConnectionError, ReadTimeout</code></pre>
    <p style="text-indent:0;">
     或者直接这样也是可以的：
    </p>
    <pre class="has"><code class="language-python">from requests import ConnectionError, ReadTimeout</code></pre>
    <p style="text-indent:0;">
     requests模块内置异常类的层次结构如下：
    </p>
    <pre class="has"><code class="language-python">IOError
...
Warning
 +-- RequestsWarning  # 请求的基本警告
    ...
    <p>
     详细说明及源码请参考：
     <a href="http://www.python-requests.org/en/master/_modules/requests/exceptions/#RequestException" rel="nofollow">
...
if __name__ == '__main__':
    ...
    <pre class="has"><code class="language-python">class MyError(Exception):
...
try:
    ...
    print("open exception: %s: %s" %(e.errno, e.strerror))</code></pre>
    <h3>
     2.3 捕获多个异常
    </h3>
    <p style="text-indent:50px;">
    ...
    <pre class="has"><code class="language-python">str1 = 'hello world'
try:
    int(str1)
    ...
    <pre class="has"><code class="language-python">raise [Exception [, args [, traceback]]]</code></pre>
    <p>
    ...
    <pre class="has"><code class="language-python">def not_zero(num):
    try:
        if num == 0:
...
not_zero(0)
    ...
    <p>
     ...
     <a href="https://docs.python.org/2/library/traceback.html" rel="nofollow">
      https://docs.python.org/2/library/traceback.html
     </a>
    </p>
    <pre class="has"><code class="language-python">import traceback
...
ZeroDivisionError: division by zero</code></pre>
    ...
    <pre class="has"><code class="language-python">traceback.print_exc(file=open('tb.txt','w+'))</code></pre>
    <p>
     参考博文：
    </p>
    <p>
     <a href="https://blog.csdn.net/lina_acm/article/details/54808910">
      except as e中的‘e’的作用总结
     </a>
    </p>
    <p>
     <a href="https://blog.csdn.net/mengtao0609/article/details/55049059">
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f706f6c79686564726f6e78:2f61727469636c652f64657461696c732f3831353839313936" class_="artid" style="display:none">
 </p>
</div>
