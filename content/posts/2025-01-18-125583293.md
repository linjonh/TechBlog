...
**3、GPIO配置：将PB9，PB10，PB11，PB12都设置为GPIO\_OUTPUT,速度为：Hight；**
...
**LCD\_Init函数**
会不同，基本一致的函数有：
**void  SPIv\_WriteData(u8 Data)，void Lcd\_WriteIndex(u8 Index)，void Lcd\_WriteData(u8 Data)，void LCD\_WriteReg(u8 Index,u16 Data)，void Lcd\_WriteData\_16Bit(u16 Data)，void Lcd\_Reset(void)。**
