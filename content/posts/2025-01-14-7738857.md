 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     <a href="http://mobile.51cto.com/android-244391.htm" rel="nofollow noopener noreferrer" target="_blank">
      Android SDK
     </a>
    ...
    <p>
     ...
     <a href="http://mobile.51cto.com/android-253214.htm" rel="nofollow noopener noreferrer" target="_blank">
      <strong>
       Eclipse w/ADT
      </strong>
     </a>
    ...
    <p>
     ...
     <a href="http://mobile.51cto.com/hot-245959.htm" rel="nofollow noopener noreferrer" target="_blank">
      Android Development Tools(ADT)
     </a>
     插件的组合(注：开发者可以通过Android网站下载ADT)。
    </p>
    <center>
     <img alt="Eclipse" class="fit-image" height="227" src="https://i-blog.csdnimg.cn/blog_migrate/b2709bfdd3b7bbc88a42b60df8d0f67b.png" width="498">
     </img>
    </center>
    ...
    <center>
     <img alt="The SDK and AVD Manager" class="fit-image" height="279" src="https://i-blog.csdnimg.cn/blog_migrate/971ef89037746ec1be92e6eff90ed96c.png" width="498">
     </img>
    </center>
    <p style="text-align:center">
     <strong>
    ...
    <center>
     <img alt="Dalvik Debug Monitor Server" class="fit-image" height="296" src="https://i-blog.csdnimg.cn/blog_migrate/edba2833fe5d237a51880a577367408a.png" width="498">
     </img>
    </center>
    <p style="text-align:center">
     <strong>
    ...
    <center>
     <img alt="The Android Emulator" class="fit-image" height="462" src="https://i-blog.csdnimg.cn/blog_migrate/f52af65e6121a7304f020d484646fd48.png" width="498">
     </img>
    </center>
    <p style="text-align:center">
     <strong>
    ...
    <center>
     <img alt="The Hierarchy Viewer" class="fit-image" height="302" src="https://i-blog.csdnimg.cn/blog_migrate/6d9a6fea571dbd82a0b1b44eae8e3edd.png" width="498">
     </img>
    </center>
    <p style="text-align:center">
     <strong>
    ...
    <center>
     <img alt="Draw 9-Patch" class="fit-image" height="362" src="https://i-blog.csdnimg.cn/blog_migrate/4424fb65c00b9c146977cd0b5231bc92.png" width="498">
     </img>
    </center>
    <p style="text-align:center">
     <strong>
