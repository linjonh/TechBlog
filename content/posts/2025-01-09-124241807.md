 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-tomorrow-night" id="content_views">
    ...
    <pre><code>类型说明符数组名[常量表达式],......;
</code></pre>
    <p>
     数组声明的示例如下：
    </p>
    <pre><code>int sum[10];//声明整型数组sum,共10个元素
...
void main()//主函数
{
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/dbaf0f94274d0f143811d090379d3094.jpeg"/>
    </p>
    <ul>
     <li>
      循环结构
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/760ebc1b2dc3a48e481ea919c5988ffc.jpeg"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/20166d1045ec2574a6921edc7c689c89.jpeg"/>
    </p>
    <p>
     其中x和y均为整型数据，当自
     <code>
...
void main()//主函数
{
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34303432353634302f:61727469636c652f64657461696c732f313234323431383037" class_="artid" style="display:none">
 </p>
</div>
