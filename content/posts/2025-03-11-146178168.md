 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     之前在
     <a href="https://blog.csdn.net/weixin_57904199/article/details/142615315" title="STM32 f407 CAN收发 基于HAL库和Cubemx配置_stm32f407can收发程序-CSDN博客">
      STM32 f407 CAN收发 基于HAL库和Cubemx配置_stm32f407can收发程序-CSDN博客
     </a>
    ...
    <pre><code class="language-cpp">CAN_FilterTypeDef  CAN2_filter1;  // Define the filter structure
...
while(HAL_CAN_ConfigFilter(&amp;hcan2, &amp;CAN2_filter1) != HAL_OK); </code></pre>
    <h3 style="background-color:transparent">
     首先，CAN1_filter1.SlaveStartFilterBank这个参数怎么设置？
    </h3>
    <p>
     <img alt="" height="301" src="https://i-blog.csdnimg.cn/direct/fcbf0b34fdca41e6b6ca7c27c114070d.png" width="1022"/>
    </p>
    <p>
     <strong>
    ...
    <p>
     <img alt="" height="109" src="https://i-blog.csdnimg.cn/direct/d2b02ecadef744dfb8d22fe93db1d97d.png" width="837"/>
    </p>
    <p>
     这张表很好的概括了设置方法：
    </p>
    <p>
     <img alt="" height="665" src="https://i-blog.csdnimg.cn/direct/21458ee0e5b749b6b72ac0c2ba1884b0.png" width="991"/>
    </p>
    <p>
     要看懂这张表，首先要明白掩码的意义。放张图，不细说：
    </p>
    <p>
     <img alt="" height="146" src="https://i-blog.csdnimg.cn/direct/8a138715e0b34ae5acaab44921fc3add.png" width="970"/>
    </p>
    <p>
     然后必须要明白，标准ID是11位，扩展ID是29位！
    </p>
    <p>
     <img alt="" height="172" src="https://i-blog.csdnimg.cn/direct/df5e21bf72af4956ada18518ad9b0dd6.png" width="840"/>
    </p>
    <p>
     <strong>
    ...
    <pre><code class="language-cpp">  CAN2_filter1.FilterMode = CAN_FILTERMODE_IDMASK;  // 
  CAN2_filter1.FilterScale = CAN_FILTERSCALE_32BIT; // 
  CAN2_filter1.FilterIdHigh = (0x18F60000 &gt;&gt; 13) &amp; 0xFFFF;
  CAN2_filter1.FilterIdLow = (0x18F60000 &lt;&lt; 3) &amp; 0xFFF8;
  CAN2_filter1.FilterMaskIdHigh = (0xFFFF0000 &gt;&gt; 13) &amp; 0xFFFF;   
  CAN2_filter1.FilterMaskIdLow = (0xFFFF0000 &lt;&lt; 3) &amp; 0xFFF8;     </code></pre>
    <p>
     <strong>
    ...
    <pre><code class="language-cpp">  CAN1_filter1.FilterMode = CAN_FILTERMODE_IDLIST;  // 
  ...
  CAN1_filter1.FilterMaskIdLow = 0x0000; </code></pre>
    <h3>
     多组过滤器如何配置？
    </h3>
    <p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35373930343139392f:61727469636c652f64657461696c732f313436313738313638" class_="artid" style="display:none">
 </p>
</div>
