...
`Redis` 命令高度一致）
* `jedis` 可以通过 `maven` 下载![image.png](https://i-blog.csdnimg.cn/img\_convert/7093b123ccf5379b83f2a9bab702d40a.png)

redis.clients
jedis
5.1.5
## Windows 环境下
![image.png](https://i-blog.csdnimg.cn/img\_convert/d1a16601f623d57a4b2a353ef955e1a4.png)
...
##### 端口转发
![image.png](https://i-blog.csdnimg.cn/img\_convert/a37f06014984a8f8eb8bc577294895a1.png)
...
* * *
![](https://i-blog.csdnimg.cn/img\_convert/5f62dd3de92ee9173dcc6d3675ddbaf8.png)
...
![image.png](https://i-blog.csdnimg.cn/img\_convert/5311ba33b9ea628eee19e5abb98cfb92.png)
* 此时客户端的程序访问 `127.0.0.1:8888` 就相当于是访问 `Linux` 服务器的 `6379` 了
* 访问本地端口，就相当于访问远程服务器上的端口
* * *
只需要进行简单的配置，后续就把云服务器的端口就当成一个本地的端口使用即可
## mac 环境下
![image.png](https://i-blog.csdnimg.cn/img\_convert/62f9e9cd740f56575d78b34512ab5f4d.png)
