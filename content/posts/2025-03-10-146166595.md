...
<div class="blog-content-box">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <ol>
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b9e98afd59c1882557aae3ba6cad758b.png"/>
     </li>
    </ol>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b4469385148ea87ff1109f7366a983ef.png">
      <br/>
      ConfigFileApplicationListener 类部分源码如下所示。
     </img>
    </p>
    <pre><code>// Note the order is from least to most specific (last one wins)
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/28498f78c7527ef23c36648b860e41c9.png"/>
    </p>
    <h6>
     <a id="_55">
     </a>
    ...
    <p>
     ...
     <a href="https://docs.spring.io/spring-boot/docs/current-SNAPSHOT/reference/htmlsingle/#boot-features-external-config" rel="nofollow">
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/c1872d103d3d237da2663ed82e8cdee4.png"/>
    </p>
    <p>
     <strong>
      文章参考：
    ...
    <ul>
     <li>
      <a href="https://www.cnblogs.com/tabCtrlShift/p/9075008.html" rel="nofollow">
     ...
     <li>
      <a href="https://blog.csdn.net/andy_zhang2007/article/details/84193556">
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37343832343131322f:61727469636c652f64657461696c732f313436313636353935" class_="artid" style="display:none">
 </p>
</div>
