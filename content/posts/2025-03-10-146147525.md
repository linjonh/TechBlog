...
> 场景：根据\_id查询到的内容如下，如何使用\_source根据S\_0001的内容查询该文档
>
> { "hits":{ "total":1, "hits":[ { "\_index":"tian-abc-20250308", "\_type":"\_doc", "\_id":"202503080001" "\_source":{ "requestParams":{ "S\_0001":"hhh1", "S\_0002":"hhh2" }, "reason":"1", "version":12 } } ] } }
...
一般是根据"\_id"直接删除一条，需要指定索引名，太麻烦，懒得用，直接写好用的：根据查询条件直接删除索引，可以模糊匹配，但建议不要设置太宽的索引范围，（比如某个文档中没有上述的requestParams或者S\_0001字段，都会报错）
