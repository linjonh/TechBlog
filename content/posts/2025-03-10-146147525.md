 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <blockquote>
     <pre>GET /tian-abc-20250308/_mapping
</pre>
    </blockquote>
    <h5>
     根据字段查询：
...
POST /tian-abc-20250308/_search
{
  "query": {
    ...
    <pre><code class="hljs">POST /tian-abc-20250308/_search
{
  "query": {
    "nested": {
      "path": "requestParams",
    ...
    <pre><code class="hljs">GET /tian-abc-20250308/_search
{
  "runtime_mappings": {
    "S_0001_runtime": {
      "type": "keyword",
  ...
  "query": {
    ...
    <pre><code class="hljs">//conflicts=proceed是忽略冲突项，比如删除正在修改的数据会报错，这个会忽略冲突
...
POST /tian-abc-2025*/_delete_by_query
{
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f53687954616e2f:61727469636c652f64657461696c732f313436313437353235" class_="artid" style="display:none">
 </p>
</div>
