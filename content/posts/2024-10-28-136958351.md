 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/677e1ba9cc8ac773954e64f84f371ccc.png#pic_center"/>
    </p>
    <h2>
     <a id="_10">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/7fced6569c8b70a538c9644e4f7ca5e2.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/e437e0103941d4823b6ff7da8f95ee88.png"/>
    </p>
    <p>
     一、技术实现
    </p>
    ...
    <pre><code class="prism language-java"># 初始化<span class="token class-name">Kubernetes</span>集群时配置<span class="token class-name">Pod</span> <span class="token constant">IP</span> <span class="token constant">CIDR</span>网段 
...
metadata<span class="token operator">:</span>  
  name<span class="token operator">:</span> my<span class="token operator">-</span>service  
spec<span class="token operator">:</span>  
  selector<span class="token operator">:</span>  
    app<span class="token operator">:</span> my<span class="token operator">-</span>app  
  ports<span class="token operator">:</span>  
    <span class="token operator">-</span> protocol<span class="token operator">:</span> <span class="token constant">TCP</span>  
      port<span class="token operator">:</span> <span class="token number">80</span>  
      targetPort<span class="token operator">:</span> <span class="token number">8080</span>
</code></pre>
    <p>
    ...
    <ol>
     <li>
      规划先行：在开发初期，进行充分的项目规划和需求分析，明确项目的目标和范围，避免后期
      <strong>
       需求变更和重构带来的时间浪费
      </strong>
      。
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f35333834373835392f:61727469636c652f64657461696c732f313336393538333531" class_="artid" style="display:none">
 </p>
</div>
