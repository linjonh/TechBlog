...
我的错误就是因为，PATH=;D:\development\java\jdk1.8.0\_151;%JRE\_HOME%\jre\bin 后面的符号是中文分号而不是英文分号导致的，解决办法进入右键点击我的电脑-属性-高级-环境变量更改path，将里面所有路径都改为英文路径。
...
D:\Program Files\Java\jre1.8.0\_121\bin\javaw.exe / /加入这两行就可以了（当然具体地址以自己的地址为准）
...
原文：https://blog.csdn.net/qq\_34734303/article/details/83009409
