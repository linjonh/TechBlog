...
# 编辑 BaseOS 源文件（以 x86\_64 架构为例）
sudo vi /etc/yum.repos.d/BaseOS.repo
# 添加以下内容：
[BaseOS]
name=BaseOS
baseurl=https://repo.huaweicloud.com/openeuler/openEuler-20.03-LTS/OS/x86\_64/
enabled=1
gpgcheck=1
gpgkey=https://repo.huaweicloud.com/openeuler/openEuler-20.03-LTS/OS/x86\_64/RPM-GPG-KEY-openEuler
##### \*\*2\. 清理 Docker 缓存\*\*
如果之前拉取的镜像有错误，可以清理缓存：
