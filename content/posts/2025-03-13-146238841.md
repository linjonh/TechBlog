 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-bash">wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.102/bin/apache-tomcat-9.0.102.tar.gz</code></pre>
    <p>
     安装 javajdk。
    </p>
    <pre><code class="language-bash">yum install java-1.8.0-openjdk.x86_64 -y</code></pre>
    <p>
    ...
    <pre><code class="language-bash">/etc/alternatives/jre_openjdk/
...
└── ...其他资源文件...</code></pre>
    ...
    <pre><code class="language-bash">tar xzf apache-tomcat-9.0.102.tar.gz -C /usr/local</code></pre>
    <p>
    </p>
    <h3>
     1.3.启动
...
bash startup.sh                     # 运行启动脚本，启动服务</code></pre>
    <p>
     <img alt="" height="227" src="https://i-blog.csdnimg.cn/direct/d682c8f2ea1c4994a4bc09b52be7ab5a.png" width="1554"/>
    </p>
    <p>
     <img alt="" height="115" src="https://i-blog.csdnimg.cn/direct/7462a7b6be9942fd8391a8de63cabbf3.png" width="1534"/>
    </p>
    <p>
     浏览器可访问到 Tomcat，安装成功。
    </p>
    <p>
     <img alt="" height="832" src="https://i-blog.csdnimg.cn/direct/93da573b3e2d43a2aa8bc0f367b9df53.png" width="1600">
     </img>
    </p>
    <p>
    </p>
    ...
    <pre><code class="language-bash">vim /usr/local/tomcat/conf/tomcat.conf    # 创建文件写入以下内容
​
JAVA_HOME=/etc/alternatives/jre_openjdk/</code></pre>
    <p>
    </p>
    <h3>
    ...
    <pre><code class="language-bash">vim /usr/bin/tomcat
​
#!/bin/bash
case $1 in
  start)
 ...
  stop)
  /usr/local/tomcat/bin/shutdown.sh
    ...
    <pre><code class="language-bash">chmod +x /usr/bin/tomcat </code></pre>
    <p>
    </p>
    <h3>
     2.2.编写系统服务脚本
    ...
    <pre><code class="language-bash">vim /lib/systemd/system/tomcat.service
​
[Unit]
Description=Tomcat
...
WantedBy=multi-user.target</code></pre>
    ...
    <pre><code class="language-bash">useradd -s /sbin/nologin -M tomcat</code></pre>
    <p>
     修改目录文件权限。
    </p>
    <pre><code class="language-bash">chown -R tomcat.tomcat /usr/local/tomcat/</code></pre>
    <p>
    ...
    <p>
     <img alt="" height="381" src="https://i-blog.csdnimg.cn/direct/b8a19e38bf1749259109a65bebac7fb3.png" width="1577"/>
    </p>
    <p>
     浏览器可访问。
    </p>
    <p>
     <img alt="" height="1249" src="https://i-blog.csdnimg.cn/direct/2ba08c4ff9c741e09c9d59878bbb1c5a.png" width="2608"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f615f323337333137393437332f:61727469636c652f64657461696c732f313436323338383431" class_="artid" style="display:none">
 </p>
</div>
