...
使用搭建的iso镜像包：chinaskills\_cloud\_iaas.iso
...
[root@controller ~]# mount -o loop CentOS-7-x86\_64-DVD-1804.iso /mnt/
  
[root@controller ~]# cp -rvf /mnt/\* /opt/centos/
  
[root@controller ~]# umount /mnt/

[root@controller ~]# mount -o loop chinaskills\_cloud\_iaas.iso /mnt/
...
**INTERFACE\_IP=192.168.100.10/192.168.100.20（controllerIP/computeIP）**
  
INTERFACE\_NAME=ens34 （外部网络网卡名称，也就是第二块网卡的名称）
  
Physical\_NAME=provider （外部网络适配器名称）
...
STORAGE\_LOCAL\_NET\_IP=192.168.100.20
...
#glance image-create --name CentOS7.5 --disk-format qcow2 --container-format bare --progress < /opt/images/CentOS\_7.5\_x86\_64\_XD.qcow2
...
#crudini --set /etc/nova/nova.conf libvirt virt\_type qemu
