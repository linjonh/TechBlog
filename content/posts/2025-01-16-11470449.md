...
Enter file in which to save the key (/home/hadoop/.ssh/id\_rsa):
...
Your identification has been saved in/home / hadoop /.ssh/id\_rsa.

Your public key has been saved in/home / hadoop /.ssh/id\_rsa.pub.
...
**[hadoop @Master.ssh]# cat id\_rsa.pub > authorized\_keys**
...
**[hadoop@ Master ~] $mkdir ~/hadoop\_installs**
...
**[hadoop@ Master hadoop\_installs]$ tar –zxvf hadoop-1.0.1.tar.gz**
...
**根目录**
为：
/home/hadoop/hadoop\_installs/hadoop-1.0.1
...
export  JAVA\_HOME=/usr/java/jdk1.6.0\_13

export  JRE\_HOME=/usr/java /jdk1.6.0\_13/jre
...
export  HADOOP\_HOME=/home/hadoop/hadoop\_installs/hadoop-1.0.1
...
**进入
/home/hadoop/hadoop\_install/hadoop-1.0.1/conf
，配置
Hadoop
配置文件**
