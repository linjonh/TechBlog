 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-sql">--创建分区表 此表尚未创建
...
select * from student partition(p3);</code></pre>
    <p>
     将已存在的表修改为分区表：
    </p>
    <pre><code class="language-sql">--创建sales表
CREATE TABLE sales(
...
--查询分区数据
SELECT * FROM sales_range PARTITION(part4);</code></pre>
    <p>
     分表场景:
    </p>
    <ul>
 ...
 <p alt="68747470733a2f2f626c6f67:2e6373646e2e6e65742f7461696261697368656e6c6f6e672f:61727469636c652f64657461696c732f313138373531303233" class_="artid" style="display:none">
 </p>
</div>
