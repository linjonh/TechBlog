 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     作者：来自 Elastic
     <a href="https://www.elastic.co/search-labs/author/han-xiang-choong" rel="nofollow" title="Han Xiang Choong">
      Han Xiang Choong
     </a>
    </p>
    <p>
    ...
    <p>
     这是
     <a class="link-info" href="https://elasticstack.blog.csdn.net/article/details/144532173" rel="nofollow" title="之前在 Searchlabs 发布">
      之前在 Searchlabs 发布
     </a>
     的
     <strong>
    ...
    <div class="img-center">
     <figure class="image">
      <img alt="" src="https://i-blog.csdnimg.cn/direct/264aafd09d0b4a6f8a903aebda7f25a5.webp">
       <figcaption>
    ...
    <p>
     完整代码位于此
     <a class="link-info" href="https://github.com/elastic/elasticsearch-labs/tree/intelligent-hybrid-search/supporting-blog-content/intelligent_hybrid_search_chatapp" title="Github repo">
      Github repo
     </a>
     中。
    </p>
    ...
    <pre><code class="hljs">pip install elasticsearch==8.17.1 langchain==0.3.15 streamlit==1.37.1</code></pre>
    <p>
     并运行以下命令来启动应用程序：
    </p>
    <pre><code class="hljs">streamlit run news_search_agent.py</code></pre>
    <p>
    ...
    <p>
     ...
     <a class="link-info" href="https://github.com/launchnlp/POLITICS?tab=readme-ov-file" title="POLITICS 数据集">
      POLITICS 数据集
     </a>
     。
    </p>
    <p>
     ...
     <a class="link-info" href="https://elasticstack.blog.csdn.net/article/details/134396254" rel="nofollow" title="Retrieval-Augmented Generation">
      Retrieval-Augmented Generation
     </a>
     ，RAG），就像你所做的那样。或许可以参考
     <a class="link-info" href="https://elasticstack.blog.csdn.net/article/details/141472711" rel="nofollow" title="其他 SearchLabs 文章">
      其他 SearchLabs 文章
     </a>
     中记录的流程。
    </p>
    ...
    <pre><code class="hljs">Review Singapore's economic state in 2020</code></pre>
    <p>
     完美！我们会得到什么答案？
    </p>
    <h3 id="answer-1:">
    ...
    <pre><code class="hljs">The context provided does not contain specific information about Singapore's economic state in 2020. Therefore, I am unable to provide a review of Singapore's economy for that year based on the given context. If you have more specific information or another document, I would be happy to help with that.</code></pre>
    <p>
     嗯，这很奇怪。让我们看看搜索结果……
    </p>
    <p>
    </p>
    <h3 id="search-results-1:">
     Search results 1:
    </h3>
    <pre><code class="hljs">Result 1:
...
Fund trimmed its global outlook for 2019 and 2020.</code></pre>
    <p>
    ...
    <pre><code class="hljs">Investor centric review of magnachip, 2018</code></pre>
    <p>
     答案有没有更好一些？
    </p>
    <h3 id="answer-2:">
    ...
    <pre><code class="hljs">In 2018, Microchip Technology Inc. (NASDAQ: MCHP) faced significant challenges following its acquisition of Microsemi Corp. for approximately $10.15 billion, which was completed on May 29, 2018. The acquisition was presented as a strategic move that would be "immediately accretive" to Microchip's earnings.</code></pre>
    <p>
    ...
    <div class="img-center">
     <figure class="image">
      <img alt="" src="https://i-blog.csdnimg.cn/direct/d5d758aa381b48b7ad5960211de2a024.webp">
       <figcaption>
    ...
    <div class="img-center">
     <figure class="image">
      <img alt="" src="https://i-blog.csdnimg.cn/direct/29d1119431a34b97aacbefea5a7bfa84.webp">
       <figcaption>
    ...
    <p>
     ...
     <a class="link-info" href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-range-query.html" rel="nofollow" title="范围">
      范围
     </a>
     和过滤器、
     <a class="link-info" href="https://www.elastic.co/guide/en/elasticsearch/reference/current/full-text-queries.html" rel="nofollow" title="几何/地理空间搜索、关键词、术语和模糊匹配与布尔运算符">
      几何/地理空间搜索、关键词、术语和模糊匹配与布尔运算符
     </a>
    ...
    <p>
     Elastic 允许
     <a class="link-info" href="https://www.elastic.co/guide/en/elasticsearch/client/eland/current/overview.html" rel="nofollow" title="通过 Eland 上传这些模型">
      通过 Eland 上传这些模型
     </a>
     ，并在数据
     <a class="link-info" href="https://www.elastic.co/guide/en/machine-learning/current/ml-nlp.html" rel="nofollow" title="接入管道中利用它们的 NLP 功能">
      接入管道中利用它们的 NLP 功能
     </a>
    ...
    <pre><code class="hljs">PUT _inference/completion/azure_openai_gpt4o_completion
{
    "service": "azureopenai",
    "service_settings": {
        "api_key": "------------",
    ...
    <pre><code class="hljs">PUT _ingest/pipeline/bignews_pipeline
{
  "processors": [
    {
      "script": {
    ...
    <pre><code class="hljs">POST _reindex?slices=auto&amp;wait_for_completion=false
{
  "conflicts": "proceed", 
  "source": {
    "index": "bignews",
  ...
  "dest": {
    ...
    <pre><code class="hljs">title: "Kane Co. president John Kane on giving - Innovations"
...
text: ...</code></pre>
    <p>
     ...
     <a class="link-info" href="https://developers.google.com/maps/documentation/geocoding/overview" rel="nofollow" title="Google 的地理编码 API">
      Google 的地理编码 API
     </a>
    ...
    <div class="img-center">
     <figure class="image">
      <img alt="" src="https://i-blog.csdnimg.cn/direct/272a6626173f419a86fd74ebb149f2e8.webp">
       <figcaption>
        文档视图和在丰富后的映射
       </figcaption>
      </img>
    ...
    <p>
     ...
     ），这个过程已经有
     <a class="link-info" href="https://www.elastic.co/guide/en/elasticsearch/reference/current/semantic-search-semantic-text.html" rel="nofollow" title="很好的文档说明">
      很好的文档说明
     </a>
    ...
    <p>
     ...
     和
     <code>
      <a class="link-info" href="https://www.elastic.co/guide/en/machine-learning/current/ml-nlp-elser.html" rel="nofollow" title="ELSER_V2">
       ELSER_V2
      </a>
     </code>
     对数据进行了分块和嵌入，我可以像这样使用稀疏向量查询：
    </p>
    <pre><code class="hljs">GET bignews_final/_search
{
  "query": {
      "nested": {
    ...
    <pre><code class="hljs">Hurricane Matthew to Smash into Gitmo by Tuesday Evening (2016 Oct)
...
heavy rainfall and storm surge,' hurricane center says (2020 Jul)</code></pre>
    <p>
    ...
    <pre><code class="hljs">GET bignews_final/_search
  {
    ...
    <pre><code class="hljs">Tropical Storm Isaac poses potential threat (2012 Jul)
A look at Caribbean damage from Hurricane Sandy (2012 Oct)
Green Stories Of 2012: Environmental News In Review (2012 Dec)</code></pre>
    <p>
     情况确实有所改善，得到了准确的新闻报道。
    </p>
    <p>
    ...
    <p>
     有一篇关于
     <a class="link-info" href="https://elasticstack.blog.csdn.net/article/details/142670830" rel="nofollow" title="使用 LLMs 生成 Query DSL">
      使用 LLMs 生成 Query DSL
     </a>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/72bbc0b6840a42babb48d7cb316e8be2.webp"/>
    </p>
    <p>
     使用
     <a class="link-info" href="https://python.langchain.com/docs/introduction/" rel="nofollow" title="Langchain">
      Langchain
     </a>
     ，我们可以将工具定义为 Python 函数。在这里，我有一个函数，它接收一些参数，这些参数将由 LLM 提供，然后构建一个 Elasticsearch 查询并使用
     <a class="link-info" href="https://www.elastic.co/guide/en/elasticsearch/client/python-api/current/index.html" rel="nofollow" title="Python 客户端">
      Python 客户端
     </a>
     发送。如果每个变量存在，它将被添加到查询条件中，然后这些条件将附加到一个条件列表中。这些条件将被组装成一个完整的 Elasticsearch 查询，其中包括一个向量搜索组件，最终作为搜索请求的一部分发送出去。
    </p>
    <pre><code class="hljs">def rag_search(query: str, dates: str, categories: str, geographic_location: str, entities: str):
    ...
    <pre><code class="hljs">result_docs = []
for hit in hits:
    source = hit["_source"]
    ...
    <pre><code class="hljs">GET bignews_final/_search
{
  ...
  "size ": 10
    ...
    <h3 id="test-1:-singapore-economy-in-review-2020">
    ...
    <pre><code class="hljs">** LLM Answer **
...
In Singapore, Central Bank Eases Currency Policy (2015 Jan)</code></pre>
    <p>
     <strong>
      Agentic 搜索答案：
     </strong>
...
** Agent Function Call ** 
{
  ...
  'entities': ''
    ...
    <h3 id="test-2:-summarize-microsoft-strategy-in-the-second-half-of-the-last-decade">
...
Microsoft reveals permanent work-from-home policy (2020 Mar)</code></pre>
    <p>
    </p>
    <p>
     <strong>
...
** Agent Function Call ** 
{
  ...
  'entities': 'Microsoft'
    ...
    <h3 id="test-3:-elastic-nv-investor-review-2010-2023">
...
Elastic Nominates Alison Gleeson to Board of Directors (2019 Nov)</code></pre>
    <p>
     <strong>
      Agentic 搜索答案：
     </strong>
    ...
    <pre><code class="hljs">PUT _ingest/pipeline/bignews_pipeline
{
  "processors": [
    ...
    <p>
     ...
     <a class="link-info" href="https://github.com/elastic/elasticsearch-labs?tab=readme-ov-file#python-notebooks?cta=read-notebook&amp;tech=github&amp;plcmt=cross%20module&amp;pg=search-labs" title="示例笔记本">
      示例笔记本
     </a>
     ，开始
    ...
    <p>
     原文：
     <a href="https://www.elastic.co/search-labs/blog/agentic-llm-intelligent-hybrid-search" rel="nofollow" title="Beyond vectors: Intelligent hybrid search with agents - Elasticsearch Labs">
      Beyond vectors: Intelligent hybrid search with agents - Elasticsearch Labs
     </a>
    </p>
   </div>
  </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f5562756e7475546f7563682f:61727469636c652f64657461696c732f313436313639333436" class_="artid" style="display:none">
 </p>
</div>
