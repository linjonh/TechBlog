  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <a class="link-info" href="https://blog.csdn.net/BIT_Legend/article/details/146104686" title="StarCoder 微调《个人编程助手: 训练你自己的编码助手》">
      StarCoder 微调《个人编程助手: 训练你自己的编码助手》
     </a>
     】中 5.1 之前的章节。
    </p>
    <p>
     模型训练的相关知识可以参考
     <a class="link-info" href="https://blog.csdn.net/BIT_Legend/article/details/122455702" title="Torch的编程方式示例以及必备知识">
      Torch的编程方式示例以及必备知识
     </a>
     ，可以直接使用第一部分的手写字体分类模型作为当前教程的示例模型，只需要在脚本最后加入如下代码便可将模型保存为 .pth 模型。注意在上载 model 的代码里依然还是要定义一遍模型，或者 import 之前的模型定义 py 文件，否则
     <a href="https://blog.csdn.net/wtl1992/article/details/130613470" title="报错">
      报错
     </a>
     。
    </p>
...
# 虽然保存了模型结构和模型参数，但是在load之前还是要定义一遍model才行，或者直接import model</code></pre>
    <h2>
     二、model 转换 .onnx 并在 GPU 上利用 python 代码推理
    </h2>
    <p>
     Torch model 模型通过如下代码可以转换为 .onnx 模型。参考
     <a class="link-info" href="https://gitee.com/legend8818/laneaf-refine/blob/master/onnx/pth2onnx.py" rel="nofollow" title="链接">
      链接
     </a>
     。
    </p>
    <pre><code class="language-python">torch.onnx.export(model, input, onnx_path, verbose=True, opset_version=12, input_names=input_names, output_names=output_names) 
...
# output_names 定义 onnx 中输出的名称列表
    ...
    <p>
     ...
     <a class="link-info" href="https://onnxruntime.ai/docs/execution-providers/CUDA-ExecutionProvider.html#requirements" rel="nofollow" title="链接">
      链接
     </a>
     。安装命令如下：
    </p>
    <pre><code class="language-bash">pip install onnxruntime-gpu==1.18.1 -i https://pypi.tuna.tsinghua.edu.cn/simple</code></pre>
    <p>
    ...
    <pre><code class="language-python">providers = ['CUDAExecutionProvider']
...
onnx_pred = m.run(output_names, {"input": image})</code></pre>
    <h2>
     三、TensorRT 安装
    </h2>
    <p>
    ...
    <pre><code class="language-bash">// TensorRT 8.5 以上的版本用以下命令
...
&gt;&gt;&gt; assert tensorrt.Builder(tensorrt.Logger())</code></pre>
    <p>
     C++ 版本 TensorRT 的安装分为
     <a class="link-info" href="https://blog.csdn.net/weixin_48592526/article/details/128061210?spm=1001.2101.3001.6650.7&amp;utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-7-128061210-blog-137957471.235%5Ev43%5Epc_blog_bottom_relevance_base3&amp;depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-7-128061210-blog-137957471.235%5Ev43%5Epc_blog_bottom_relevance_base3&amp;utm_relevant_index=14" title=" .deb 和 . tar 的方式">
      .deb 和 . tar 的方式
     </a>
     ，一般选用 .tar 的方式。
    </p>
    <p>
     首先去
     <a class="link-info" href="https://developer.nvidia.com/tensorrt/download" rel="nofollow" title="官网">
      官网
     </a>
    ...
    <p>
     <img alt="" height="596" src="https://i-blog.csdnimg.cn/direct/00b7fa7866bb49759143574921c78a37.png" width="1645"/>
    </p>
    <pre><code class="language-bash">tar -xzvf TensorRT-8.4.3.1.Linux.x86_64-gnu.cuda-11.6.cudnn8.4.tar.gz
...
source ~/.bashrc</code></pre>
    <p>
     ...
     <a class="link-info" href="https://blog.csdn.net/danshiming/article/details/131828483" title="链接">
      链接
     </a>
     。
    </p>
    ...
    <p>
     ...
     <a class="link-info" href="https://blog.csdn.net/Justin_JGT/article/details/137957471" title="链接 1">
      链接 1
     </a>
     <a class="link-info" href="https://huaweicloud.csdn.net/63808c02dacf622b8df8a645.html?spm=1001.2101.3001.6650.6&amp;utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7Eactivity-6-125472418-blog-128061210.235%5Ev43%5Epc_blog_bottom_relevance_base3&amp;depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7Eactivity-6-125472418-blog-128061210.235%5Ev43%5Epc_blog_bottom_relevance_base3&amp;utm_relevant_index=13" rel="nofollow" title="链接 2">
      链接 2
     </a>
     <a class="link-info" href="https://blog.csdn.net/qq_42761751/article/details/143781498" title="链接3">
      链接3
     </a>
     。这里主要使用第一种方法，关于第一种方法的详细介绍可以参考
     <a class="link-info" href="https://blog.csdn.net/old_power/article/details/145317306" title="链接">
      链接
     </a>
     。大部分情况只需要用到下面这两句命令。
    </p>
    <pre><code class="language-bash">trtexec --onnx=2Dmodel.onnx --saveEngine=2Dmodel.trt

// 转换为 fp16 模型
trtexec --onnx=2Dmodel.onnx --saveEngine=2Dmodel.trt --fp16</code></pre>
    <h2>
     五、.trt 模型在 C++ 下进行推理
    </h2>
    <p>
    ...
    <p>
     <a class="link-info" href="https://blog.csdn.net/weixin_43603658/article/details/129938954" title="CUDA 流">
      CUDA 流
     </a>
    ...
    <p>
     ...
     <a class="link-info" href="https://docs.nvidia.com/deeplearning/tensorrt/latest/index.html" rel="nofollow" title="最新版本">
      最新版本
     </a>
     <a class="link-info" href="https://docs.nvidia.com/deeplearning/tensorrt/archives/index.html" rel="nofollow" title="历史版本">
      历史版本
     </a>
     )、Quick Start Guide (
     <a class="link-info" href="https://docs.nvidia.com/deeplearning/tensorrt/latest/getting-started/quick-start-guide.html" rel="nofollow" title="最新版本">
      最新版本
     </a>
     历史版本可以从官方文档进入)、API 说明 (
     <a class="link-info" href="https://docs.nvidia.com/deeplearning/tensorrt/api/c_api/index.html" rel="nofollow" title="最新版本">
      最新版本
     </a>
     历史版本可以从官方文档进入)、
     <a class="link-info" href="https://docs.nvidia.com/deeplearning/tensorrt/latest/api/migration-guide.html" rel="nofollow" title="版本变化 API 变化说明 ">
      版本变化 API 变化说明
     </a>
     和代码 (
     <a class="link-info" href="https://github.com/NVIDIA/TensorRT/tree/release/10.8" title="最新版本">
      最新版本
     </a>
     <a class="link-info" href="https://github.com/NVIDIA/TensorRT/tree/release/8.4" title="历史版本">
      历史版本
     </a>
     )。
    </p>
    <p>
     ...
     <a class="link-info" href="https://blog.csdn.net/wtlll/article/details/137862290" title="不需要再主动调用 destroy() 函数进行对象销毁">
      不需要再主动调用 destroy() 函数进行对象销毁
     </a>
    ...
    <p>
     <a class="link-info" href="https://huaweicloud.csdn.net/63808c02dacf622b8df8a645.html?spm=1001.2101.3001.6650.6&amp;utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7Eactivity-6-125472418-blog-128061210.235%5Ev43%5Epc_blog_bottom_relevance_base3&amp;depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7Eactivity-6-125472418-blog-128061210.235%5Ev43%5Epc_blog_bottom_relevance_base3&amp;utm_relevant_index=13" rel="nofollow" title="Pytorch 导出 onnx 模型，C++ 转化为 TensorRT 并实现推理过程">
      Pytorch 导出 onnx 模型，C++ 转化为 TensorRT 并实现推理过程
     </a>
     对应
     <a class="link-info" href="https://github.com/Adenialzz/Hello-AIDeployment/blob/master/HAID/tensorrt/resnet/src/main.cpp" title="Git 代码">
      Git 代码
     </a>
    </p>
    <p id="articleContentId">
     <a class="link-info" href="https://blog.csdn.net/long630576366/article/details/130284646" title="torch 转 ONNX 模型转 TensorRT C++ 推理">
      torch 转 ONNX 模型转 TensorRT C++ 推理
     </a>
    </p>
    <p id="articleContentId">
     <a class="link-info" href="https://blog.csdn.net/qq_39333636/article/details/141202925" title="TensorRT 的使用流程 c++ 和 python">
...
class IPMdet {
    ...
    <pre><code class="language-cpp">#include "IPMdet.h"
...
int main() {
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f4249545f4c6567656e642f:61727469636c652f64657461696c732f313436313036373137" class_="artid" style="display:none">
 </p>
</div>
