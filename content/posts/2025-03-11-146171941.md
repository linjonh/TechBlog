 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="512" src="https://i-blog.csdnimg.cn/direct/dab07a3ce44140daa197e1625660efe4.png" width="1005"/>
    </p>
    <h4>
     实现逻辑
    </h4>
    ...
    <p>
     <img alt="" height="490" src="https://i-blog.csdnimg.cn/direct/0441f7225df34c72803272d9303b1d06.png" width="750"/>
    </p>
    <p>
     <img alt="" height="479" src="https://i-blog.csdnimg.cn/direct/92e2f3a3a55b4a738b35b2fa4d77e34e.png" width="798"/>
    </p>
    <h4 style="background-color:transparent">
     第二步、将工具加载到vs中
    </h4>
    <pre><code class="language-cs">Pma = (CogPMAlignTool)CogSerializer.LoadObjectFromFile("./pma.vpp");
Col = (CogCompositeColorMatchTool)CogSerializer.LoadObjectFromFile("./col.vpp");</code></pre>
    <h4 style="background-color:transparent">
     第三步、将PMA匹配到的每个保险丝位置信息传给复合颜色匹配工具，然后在代码中运行此工具，获取匹配结果并将结果展示在label
    </h4>
    <pre><code class="language-cs">for (int i = 0; i &lt; Pma.Results.Count; i++)
{
...
this.label1.Text = $"红色:{dic["红色"]}, 蓝色: {dic["蓝色"]}, 绿色: {dic["绿色"]}, 橙色: {dic["橙色"]}, 黄色: {dic["黄色"]}";</code></pre>
    <h3>
     完整代码
    </h3>
    <pre><code class="language-cs">public partial class Form1 : Form
{
    ...
    <p>
     <img alt="" height="562" src="https://i-blog.csdnimg.cn/direct/8d9ba92ccb804ffebe3ffcec9e5f640f.png" width="994"/>
    </p>
    <h4 style="background-color:transparent">
     实现逻辑
    </h4>
    ...
    <p>
     <img alt="" height="444" src="https://i-blog.csdnimg.cn/direct/d5c458332e43433b878911d6f4fdb140.png" width="810"/>
    </p>
    <h4 style="background-color:transparent">
    ...
    <p>
     <img alt="" height="444" src="https://i-blog.csdnimg.cn/direct/cd847cb67ad64d20b5020242e4c1adaf.png" width="810"/>
    </p>
    ...
    <pre><code class="language-cs">public partial class Form1 : Form
{
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f71715f333531373238393639372f:61727469636c652f64657461696c732f313436313731393431" class_="artid" style="display:none">
 </p>
</div>
