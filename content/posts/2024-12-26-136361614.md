...
然后进入对应的appid文件夹，然后复制\_\_APP\_\_.wxapkg的文件路径就可以了
...
然后打开访达，然后点左上角的前往，然后点击前往文件夹，然后输入我们复制的地址，点击进去就可以了，然后里面会有很多appid，找到我们上面查找的appid 点击进去，然后再点击知道看到\_\_APP\_\_.wxapkg文件就可以了
