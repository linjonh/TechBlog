 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p class="img-center">
     <img alt="" height="128" src="https://i-blog.csdnimg.cn/direct/810b0022694a4e72bfde6d45e3449bfd.png" width="256"/>
    </p>
    <h2>
     StatusTracker介绍
    </h2>
    ...
    <p class="img-center">
     <img alt="" height="397" src="https://i-blog.csdnimg.cn/direct/8b7cc0a9dcac470a8d82958f97d12413.png" width="1280"/>
    </p>
    ...
    <pre><code class="language-cpp">         sp&lt;Camera3Device&gt; parent;
198      {
...
237      }</code></pre>
    ...
    <pre><code class="language-cpp">if (mStateTransitions.size() &gt; 0 &amp;&amp; parent.get()) {
...
mStateTransitions.clear();</code></pre>
    <p>
    </p>
    <h3>
     StatusTracker代码实现中的几个点
    </h3>
    <pre><code class="language-cpp">//StatusTracker工作线程退出需要Camera3Device主动触发
...
bool StatusTracker::threadLoop()
{
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f686f6e67796579696e672f:61727469636c652f64657461696c732f313436303937353135" class_="artid" style="display:none">
 </p>
</div>
