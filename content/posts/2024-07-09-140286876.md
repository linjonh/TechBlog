...
数据集下载：
[shapenetcore\_partanno\_segmentation\_benchmark\_v0.zip](https://shapenet.cs.stanford.edu/ericyi/shapenetcore_partanno_segmentation_benchmark_v0.zip)
  
若上面的数据集没法下载，可以走网盘：
[shapenetcore\_partanno\_segmentation\_benchmark\_v0.zip](https://pan.baidu.com/s/1e1EmaB6p7ELjtGNJkN-RHg?pwd=f546)
...
数据集下载：https://shapenet.cs.stanford.edu/ericyi/shapenetcore\_partanno\_segmentation\_benchmark\_v0.zip
...
### 4.1 分类模型训练：train\_classification.py
...
### 4.2 分类模型测试：show\_cls.py

#### 1，utils文件夹下的 **show\_cls.py** 文件用于分类模型测试
...
### 5.1 分割模型训练：train\_segmentation.py
...
### 5.2 分割任务测试：show\_seg.py

#### 1，utils文件夹下的 **show\_seg.py** 文件用于分割模型测试
...
参考博客：https://blog.csdn.net/qq\_45369294/article/details/121041403

#### 3，直接拿来用

[render\_balls\_so.dll免费下载](https://pan.baidu.com/s/1gOiE5yhYG5lqDdoQvtZbxA?pwd=3m4a)
