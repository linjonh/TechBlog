...
[(25条消息) Java回调方法(CallBack)\_Amosstan的博客-CSDN博客\_java 回调](https://blog.csdn.net/Amosstan/article/details/114963704 "(25条消息) Java回调方法(CallBack)_Amosstan的博客-CSDN博客_java 回调")