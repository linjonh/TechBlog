...
>          * @throws Exception
>          */
>       public  void getVedioImg(String videofile, String framefile,OSS
> ossClient){
>           //截取封面图
>               try {
...
>                 try (RandomAccessFile tempFileStream = new
...
> FFmpegFrameGrabber(videofile);
>     //            grabber.start();
>     //            // 提取封面图像
>     //            Java2DFrameConverter converter = new
...
> PutObjectRequest(OssProperties.BUCKET_NAME, framefile.substring(1), new
> ByteArrayInputStream(imageBytes), metadata);
>  
>                 // 创建PutObject请求。
