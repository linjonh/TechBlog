---
arturl_encode: "68747470733a2f2f626c:6f672e6373646e2e6e65742f4d6f6e6b657950726f6769726c:2f61727469636c652f64657461696c732f3639323237303834"
layout: post
...
第一种，可以参考
[根据参数查询表格数据](http://datatables.club/manual/daily/2016/04/21/option-ajax-data.html)
...
，我们依然可以使用
[`column().search()
API`](https://datatables.net/reference/api/column%28%29.search%28%29)
方法，具体往下看
...
[`search()
API`](https://datatables.net/reference/api/search%28%29)
...
来把默认的搜索框隐藏
（详见
[DataTables 之 DOM](http://datatables.club/manual/daily/2016/05/11/option-dom.html)
）
...
ps：你还可以传正则表达式 参考
[正则表达式搜索](http://datatables.club/manual/daily/2016/05/11/option-search-regex.html)
...
* [给每一列添加搜索框](http://datatables.club/example/api/multi_filter.html)
* [给每一列添加下拉框搜索](http://datatables.club/example/api/multi_filter_select.html)
...
[`filter()
API`](https://datatables.net/reference/api/filter%28%29)
