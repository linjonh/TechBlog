 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-TypeScript">setlocal enabledelayedexpansion </code></pre>
    <p>
    ...
    <pre><code class="language-TypeScript">chcp 65001</code></pre>
    <p>
    ...
    <pre><code class="language-TypeScript">start /wait notepad</code></pre>
    <p>
    ...
    <pre><code class="language-TypeScript">chcp 65001 &gt;nul
@echo off
...
@pause</code></pre>
    ...
    <pre><code class="language-TypeScript">@echo off
setlocal enabledelayedexpansion
...
@pause
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34393938343735372f:61727469636c652f64657461696c732f313436323136303336" class_="artid" style="display:none">
 </p>
</div>
