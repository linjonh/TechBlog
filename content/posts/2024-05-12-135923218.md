 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     <img alt="" height="1024" src="https://i-blog.csdnimg.cn/blog_migrate/a5469a6884975ec553a2b2ce09161b6b.png" width="1024"/>
    </p>
    <p>
     <strong>
      （图片由AI生成）
    ...
    <p>
     ...
     <img alt="" height="327" src="https://i-blog.csdnimg.cn/blog_migrate/2e9cffa9bee3266736b2614ed227019a.png" width="623"/>
    </p>
    <p>
     2.在控制台窗口输入命令“mode con cols=100 lines=30”
    </p>
    <p>
     <img alt="" height="611" src="https://i-blog.csdnimg.cn/blog_migrate/f99d415efe1330c537e01ee20cbf2581.png" width="1200"/>
    </p>
    <p>
     3.单击回车，控制台窗口便变为指定大小
    </p>
    <p>
     <img alt="" height="1200" src="https://i-blog.csdnimg.cn/blog_migrate/75f279fd8490deb8e7a211e5f67e6798.png" width="1200"/>
    </p>
    <p>
...
int main()
{
    ...
    <p>
     <img alt="" height="469" src="https://i-blog.csdnimg.cn/blog_migrate/b57a19cb545dad501aaa22ace2be0609.png" width="633"/>
    </p>
    <h3>
     2.3控制台屏幕上的坐标COORD
    </h3>
    ...
    <pre><code class="language-cpp">COORD pos = {10,15};//给坐标赋值</code></pre>
    <h3>
...
hOutput = GetStdHandle(STD_OUTPUT_HANDLE);</code></pre>
    ...
    <pre><code class="language-cpp">WINBASEAPI WINBOOL WINAPI GetConsoleCursorInfo(
...
GetConsoleCursorInfo(hOutput, &amp;CursorInfo);//获取控制台光标信息</code></pre>
    ...
    <pre><code class="language-cpp">typedef struct _CONSOLE_CURSOR_INFO {
    DWORD dwSize;
    BOOL bVisible;
    ...
    <pre><code class="language-cpp">CursorInfo.bVisible = false; //隐藏控制台光标
</code></pre>
    <h3>
...
int main() 
{
    ...
    <pre><code class="language-cpp">SHORT GetAsyncKeyState(int vKey);</code></pre>
    <p>
     <code>
      GetAsyncKeyState
     </code>
...
void GameStart(pSnake ps)
{
    ...
    <pre><code class="language-cpp">//欢迎界面
void WelcomeToGame()
{
	HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
    ...
    <pre><code class="language-cpp">//创建地图
void CreateMap()
{
	//打印上边界
	SetPos(0, 0);
    ...
    <pre><code class="language-cpp">void GameRun(pSnake ps)
{
    ...
    <pre><code class="language-cpp">#define KEY_PRESS(vk) ((GetAsyncKeyState(vk)&amp;0x1)?1:0) //按键按下</code></pre>
    <h4>
...
void PrintHelpInfo()
{
    ...
    <pre><code class="language-cpp">//暂停
void Pause()
{
	while (1)
	{
...
void SnakeMove(pSnake ps)
{
    ...
    <pre><code class="language-cpp">bool NextIsFood(pSnake ps, pSnakeNode pNext)
{
    ...
    <pre><code class="language-cpp">void EatFood(pSnake ps, pSnakeNode pNext)
{
	//是食物就吃掉
	//头插，不释放尾结点
    ...
    <pre><code class="language-cpp">void NotEatFood(pSnake ps, pSnakeNode pNext)
{
    ...
    <pre><code class="language-cpp">bool KillByWall(pSnake ps)
{
    ...
    <pre><code class="language-cpp">bool KillBySelf(pSnake ps)
{
...
void GameEnd(pSnake ps)
{
    ...
    <pre><code class="language-cpp">Snake.h
#pragma once
#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
#include &lt;windows.h&gt;
...
void GameEnd(pSnake ps);//游戏结束</code></pre>
    <h3>
     5.2源文件Snake.cpp
    </h3>
...
int main()
{
    ...
    <p>
     <img alt="" height="1181" src="https://i-blog.csdnimg.cn/blog_migrate/ef73864a104ed90e16555bdcd98fdd99.png" width="1200"/>
    </p>
    <p>
     （有点让人眼前一黑的感觉，请见谅）
    </p>
    <p>
     <img alt="" height="1200" src="https://i-blog.csdnimg.cn/blog_migrate/49b07dfe7caeef51471c571eba468208.png" width="1200">
      <img alt="" height="1200" src="https://i-blog.csdnimg.cn/blog_migrate/f37a3c07e119a460208c59dd9b2dd4a8.png" width="1200"/>
     </img>
    </p>
    <p>
     <img alt="" height="1200" src="https://i-blog.csdnimg.cn/blog_migrate/3d443a39aa213f51e188950ae2f99fb5.png" width="1200"/>
    </p>
    <p>
     <img alt="" height="1200" src="https://i-blog.csdnimg.cn/blog_migrate/9ca8e791d9330d4ee1d24ccc43397be4.png" width="1200"/>
    </p>
    <p>
     <img alt="" height="1200" src="https://i-blog.csdnimg.cn/blog_migrate/2cc39c8778fd960d45c392bcbd29c1c7.png" width="1200"/>
    </p>
    <p>
     <img alt="" height="1190" src="https://i-blog.csdnimg.cn/blog_migrate/ee16d4c98d7678d44ab27b07c501236e.png" width="1200"/>
    </p>
    <h2 style="background-color:transparent;">
     6.结语及拓展分析
    </h2>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f77786b323232373831343834372f:61727469636c652f64657461696c732f313335393233323138" class_="artid" style="display:none">
 </p>
</div>
