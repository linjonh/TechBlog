...
upstream bakend {
   ...
   server192.168.100.20:80;
    ...
    <pre><code>配置指令:balancesource</code></pre>
    <p>
     使用cookie 进行识别
    </p>
    <p>
    ...
    <pre><code>配置指令:cookie  SESSION_COOKIE  insert indirect nocache</code></pre>
    <p>
     配置例子如下：
    </p>
...
server web02 192.168.100.20:8080 check cookie web02</code></pre>
    <h4>
     会话保持的缺点：
    </h4>
    <p>
...
session.save_path = "tcp://192.168.100.10:11211"</code></pre>
    <p>
     <strong>
      使用Redis存储Session
     </strong>
...
session.save_path ="tcp://localhost:6379"</code></pre>
    <p>
     <strong>
      提醒
     </strong>
    ...
    <p>
     ...
     <a href="https://link.zhihu.com/?target=http%3A//xn--manage-2w2rx8ukkj.py/" rel="nofollow" title="请运行manage.py">
      请运行manage.py
     </a>
    ...
    <p>
     <a href="http://www.danga.com/memcached/" rel="nofollow" title="Memcache">
      Memcache
     </a>
     由于是一款基于
     <a href="http://monkey.org/~provos/libevent/" rel="nofollow" title="Libevent">
      Libevent
     </a>
    ...
    <p>
     <br/>
     <img alt="" height="558" src="https://i-blog.csdnimg.cn/blog_migrate/112e3359e9f7f985413fbf427128f32c.png" width="640"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="511" src="https://i-blog.csdnimg.cn/blog_migrate/dfbe3780952639381b5ec5f15352d6be.png" width="631"/>
    </p>
    <h4>
    </h4>
   </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34353539353638322f:61727469636c652f64657461696c732f313036373138313432" class_="artid" style="display:none">
 </p>
</div>
