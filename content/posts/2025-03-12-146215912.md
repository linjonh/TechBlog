...
public class MinIoConfiguration {
    ...
    <blockquote>
     <pre>/**要改成使用预签名URL，让前端直接与MinIO交互，减轻服务器负担。
 * 生成上传预签名URL（PUT）
 * @param fileName
 * @return
 */
...
&lt;/template&gt;</pre>
    ...
    <p>
     <img alt="" height="550" src="https://i-blog.csdnimg.cn/direct/b2503212f40f4d6c9688f30f4a2a561e.png" width="990"/>
    </p>
    <p>
     上传测试结果：
     <br/>
    ...
    <p>
     <img alt="" height="172" src="https://i-blog.csdnimg.cn/direct/f9609004e87846b4a3c9c6b76ba3096e.png" width="485">
      <img alt="" height="99" src="https://i-blog.csdnimg.cn/direct/57521bb66dd649738bd81feb6c26df8a.png" width="821"/>
     </img>
    </p>
    <p>
     下载测试：
    ...
    <p>
     <img alt="" height="534" src="https://i-blog.csdnimg.cn/direct/018459a3954148139d0b9564dcad06b1.png" width="1132"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323330335f38303535363731392f:61727469636c652f64657461696c732f313436323135393132" class_="artid" style="display:none">
 </p>
</div>
