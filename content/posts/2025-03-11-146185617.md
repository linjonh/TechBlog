  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     1’b0时进行倒计时；
     <br/>
     <img alt="￼" src="https://i-blog.csdnimg.cn/direct/18e81cea549943cda90c8f91f02ff9d9.png"/>
    </p>
...
module top_module(
    ...
    <p>
     ...
     <br/>
     <img alt="￼" src="https://i-blog.csdnimg.cn/direct/2c8a0ec65d714dd9be4111c8ce7881a3.png"/>
    </p>
    <pre><code class="prism language-verilog">
module top_module(
    input clk,
    ...
    <h2>
     <a id="3Branch_history_shift_95">
     </a>
     3.Branch history shift
    </h2>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/74af2c3859654be78b03433807ef4c41.png"/>
    </p>
    <p>
     题目理解
     <br/>
...
module top_module(
    ...
    <h2>
     <a id="4Branch_direction_predictor_145">
     </a>
    ...
    <p>
     <img alt="￼" src="https://i-blog.csdnimg.cn/direct/375909eb105842fca58788f67428d5fa.png"/>
    </p>
    <pre><code class="prism language-verilog">
module top_module(
    input clk,
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f6c695f6b696e2f:61727469636c652f64657461696c732f313436313835363137" class_="artid" style="display:none">
 </p>
</div>
