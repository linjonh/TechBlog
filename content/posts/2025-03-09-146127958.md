...
layout: post
title: "kafka-docker版"
date: 2025-03-09 09:54:10 +0800
description: "kafka、docker、分布式"
keywords: "kafka-docker版"
categories: ['未分类']
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/7ba9c0d179930afeca131a9489cebc8a.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/4a4c20471a59821d58c537a15f56b3f6.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/6a8ab97574de798c4b46d82105b150fe.png"/>
    </p>
    <p>
     2、消息队列的两种模式
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/5d450a06c08943c2385c7936b81ec345.png"/>
    </p>
    <p>
     （2）发布/订阅模式
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/8d1c64316bffb80e5d7890d099adfc54.png"/>
    </p>
    <h4>
     <a id="13_Kafka__55">
     </a>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/9bfc7c40c40de71afd7a26bc925fbe8c.png"/>
    </p>
    <p>
    ...
    <table>
     ...
     <tbody>
      ...
      <tr>
       ...
       <td>
        192.168.100.104:2181
       </td>
       <td>
        192.168.100.104:2182
       </td>
       <td>
        192.168.100.104:2183
       </td>
      </tr>
      <tr>
       <td>
      ...
      <tr>
       ...
       <td>
        192.168.100.104:9022
       </td>
       <td>
        192.168.100.104:9093
       </td>
       <td>
        192.168.100.104:9094
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/c03c20214c6f45a1f943e682b7e739ab.png"/>
    </p>
    <p>
    ...
    <table>
     ...
     <tbody>
      <tr>
       ...
       <td>
        生产者连接集群所需的 broker 地址清单。例如 192.168.100.104:9092。可以设置 1 个或者多个，中间用逗号隔开。注意这里并非需要所有的 broker 地址，因为生产者从给定的 broker 里查找到其他 broker 信息。
       </td>
      </tr>
      <tr>
       <td>
      ...
      <tr>
       ...
       <td>
        允许最多没有返回 ack 的次数，默认为 5，开启幂等性要保证该值是 1-5 的数字。 幂等性即1
        <sup>
         n
        </sup>
        =1。
      ...
      <tr>
       ...
       <td>
        当消息发送出现错误的时候，系统会重发消息。retries表示重试次数。默认是 int 最大值，2147483647。 如果设置了重试，还想保证消息的有序性，需要设置 MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION=1 否则在重试此失败消息的时候，其他的消息可能发送成功了。
       </td>
      </tr>
      <tr>
       <td>
...
public void AsyncSendMsg(String topic,String msg) {
    ...
    <pre><code>CustomProducer customProducer = new CustomProducer();
...
public void AsyncSendMsgCallback(String topic,String msg,Callback callback) {
    ...
    <pre><code>public void test2() throws InterruptedException {
...
class MyCallback implements Callback{
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/c96d6c16b0ea59009a0100b8aff53829.png"/>
    </p>
    <p>
     2、生产者发送消息的分区策略
    </p>
...
public void AsyncSendMsgCallback(String topic,String key,String msg) {
    ...
    <pre><code>public void test5() throws InterruptedException {
...
public void AsyncSendMsgAndCallback(String topic, Partitioner partitioner,String msg) {
    ...
    <pre><code>        KafkaConfig.properties.put(ProducerConfig.PARTITIONER_CLASS_CONFIG,partitioner.getClass().getName());
    ...
    <pre><code>public void test6() throws InterruptedException {
...
public static void setCompressionType(String compressionType) {
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/1b40c0a9bc7f112182268f0741703205.png"/>
    </p>
    <p>
...
public static void setRetries(int times) {
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/e2d709d895d9044b901edc34c358bcd3.png"/>
    </p>
    <p>
     其中：
    </p>
 ...
 */
    ...
    <pre><code>    KafkaProducer&lt;String, String&gt; kafkaProducer = null;
...
public void test7() throws InterruptedException {
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/fe07593e715085b9f87a34fb9e8a9c8f.png"/>
     1、pull (拉)模式:
    </p>
    <p>
     客户端主动从服务端拉取数据。
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/61105b41c278af166b135ea503e22cbe.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/60ad57d3226bcd25c6ef0426f45f7558.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/fadb7423bbd8048bc3e91afcd36dbd9b.png"/>
    </p>
    <p>
...
public void subscribe(List&lt;String&gt; topics, String groupId){
    ...
    <pre><code>CustomConsumer customConsumer = new CustomConsumer();
    ...
    <table>
     ...
     <tbody>
      <tr>
       ...
       <td>
        消费者和 coordinator 之间的心跳时间，默认 3s。 该条目的值必须小于 session.timeout.ms，也不应该高于 session.timeout.ms 的 1/3。
       </td>
      </tr>
      <tr>
       <td>
       ...
       <td>
        消费者和 coordinator 之间连接超时时间，默认 45s。超 过该值，该消费者被移除，消费者组执行再平衡。
       </td>
      </tr>
      <tr>
       <td>
       ...
       <td>
        消费者处理消息的最大时长，默认是 5 分钟。超过该值，该 消费者被移除，消费者组执行再平衡。 partition.assignment.strategy 消 费 者 分 区 分 配 策 略 ， 默 认 策 略 是 Range + CooperativeSticky。Kafka 可以同时使用多个分区分配策略。 可 以 选 择 的 策 略 包 括 ： Range 、 RoundRobin 、 Sticky 、 CooperativeSticky
       </td>
      </tr>
     </tbody>
    </table>
...
public void test6(){
    ...
    <pre><code>public void test8() throws InterruptedException {
...
public void subscribe(List&lt;String&gt; topics,String groupId,String strategy ){
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/4460cbc2755cb81328fd02d7d81397f8.png"/>
    </p>
    <p>
...
public void subscribe(List&lt;String&gt; topics, String groupId, Date date ){
    ...
    <pre><code>public void test8() throws ParseException {
...
public void subscribe(List&lt;String&gt; topics, String groupId,CustomProducer customProducer){
    ...
    <pre><code>public void test9() throws ParseException {
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/f08e2785265c1fb35a8fdda60f701a96.png"/>
    </p>
    <p>
     kafka的事务确保两点：
    </p>
...
public void subscribeTransaction(List&lt;String&gt; topics, String groupId){
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/b5cb5d8dc3c2f43a47d1721054bb2b7c.png"/>
    </p>
    <p>
     3、Broker 重要参数
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/358cd474a2d1b2555e8b1ae88781c16a.png"/>
    </p>
    <p>
     说明：日志存储参数配置
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/4cf97df970ee04f1045610bd29413f1e.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/97c514396f005aeabc8bdb3b96bd76c9.png"/>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37333735333836352f:61727469636c652f64657461696c732f313436313237393538" class_="artid" style="display:none">
 </p>
</div>
