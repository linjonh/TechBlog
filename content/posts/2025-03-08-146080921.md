 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <h3>
     一、项目框架
     <img alt="" height="371" src="https://i-blog.csdnimg.cn/direct/3944796efa014ded99e4dd4cf96c78dd.jpeg" width="643"/>
    </h3>
    <h4>
     1.1 Server端：
    </h4>
...
func (this *Server) Start() {
    ...
    <pre><code class="language-Go">package main //server.go和main.go都属于main包，不需要再Import
...
func main() {
    ...
    <p>
     ...
     <br/>
     <img alt="" height="493" src="https://i-blog.csdnimg.cn/direct/a451ef042799427c94285a2b32726c79.png" width="1097"/>
    </p>
    <h4>
     2.1封装一个User类
    </h4>
...
func (this *Server) Start() {
    ...
    <pre><code class="language-Go">//user的goroutine，从client-&gt;onlinemap-&gt;message channel的线
func (this *Server) Handler(conn net.Conn) {//创建成功与客户端建立好连接的套接字
	//处理上线的用户
	// fmt.Println("链接建立成功！")
	user := NewUser(conn)
    ...
    <pre><code class="language-Go">//用户上线的业务
...
func (this *User) DoMessage(msg string) {
    ...
    <pre><code class="language-Go">//给当前User对应的客户端发送消息
...
func (this *User) DoMessage(msg string) {
    ...
    <pre><code class="language-Go">else if len(msg) &gt; 7 &amp;&amp; msg[:7]=="rename|"{
		//消息格式：renanme|张三
    ...
    <pre><code class="language-Go">//当前的handler不能结束-该goroutine就会死亡，子goroutine就会死亡
	for {
    ...
    <pre><code class="language-Go">else if len(msg) &gt; 4 &amp;&amp; msg[:3] == "to" {
		//消息格式：to|张三|消息内容
		//&lt;1.获取对方的用户名
...
func main() {
    ...
    <pre><code class="language-Go">var serverIp string
var serverPort int
...
func main() {
    ...
    <pre><code class="language-Go">func (client *Client) menu() bool {
	var flag int
	fmt.Println("************************************")
	fmt.Println("1.公聊模式")
	fmt.Println("2.私聊模式")
...
func (client *Client) Run() {
    ...
    <pre><code class="language-Go">func (client *Client) UpdateName() bool {
	fmt.Println("&gt;&gt;&gt;&gt;&gt;请输入用户名&lt;&lt;&lt;&lt;&lt;")
    ...
    <pre><code class="language-Go">func (client *Client) PublicChat() {
	//提示用户输入消息
	var chatMsg string
    ...
    <pre><code class="language-Go">func (client *Client) PrivateChat() {
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f4231393237363336333833382f:61727469636c652f64657461696c732f313436303830393231" class_="artid" style="display:none">
 </p>
</div>
