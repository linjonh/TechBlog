 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <pre><code>import { relationalStore } from '@kit.ArkData'
...
export default class DBUtils {
  ...
  static init(callback: Function = (state: boolean, msg?: string) =&gt; {
    ...
    <pre><code>import { common } from '@kit.AbilityKit'
...
onCreate(want: Want, launchParam: AbilityConstant.LaunchParam): void {
    ...
    <pre><code>// 数据库文件的默认存储路径，可通过 customDir修改路径
const context = AppUtils.getContext()
console.log(`${TAG} db dir: `, context.databaseDir)
</code></pre>
    <blockquote>
    ...
    <pre><code>DBUtils db dir:  /data/storage/el2/database/entry
</code></pre>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/d591c5b1fb904bce9860a2aaa2646c65.png"/>
    </p>
    <blockquote>
     <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/09c0ddc9f43e4c75906e5949cbbde977.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f95c3be5d5834943a09ff5345a9c6fac.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a0c72fbdef4b414ba8e2b812a4356506.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1c9cc67453d34d5296b8b8c47d4dec29.png#pic_center"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0ba8e97ba02e46c6860236aa11d8f426.png#pic_center"/>
    </p>
    <h3>
     <a id="_219">
     </a>
...
class OperateType {
  ...
  static readonly QUERY: number = 5
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f7b2a5cab17d4191a81e3354515fbb2a.png#pic_center"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0b2597990dd8490191fe32ee4b1b1cb7.png#pic_center"/>
    </p>
    <p>
...
function btnStyle(type: number, call?: (r: string) =&gt; void) {
  ...
  .onClick(() =&gt; {
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/5d90e63280694a67a7606a47caf86ee9.png#pic_center"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/350065bc8acd466ba16f639f47939165.png#pic_center"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/9871c7c5fc6e44e1bdca49fb4064d2b4.png#pic_center"/>
    </p>
    <p>
...
function btnStyle(type: number, call?: (r: string) =&gt; void) {
  ...
  .onClick(() =&gt; {
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a49713e60e1743a1984881a53d3e612d.png#pic_center"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/15ddb37cd0164589a929394ceb3617db.png#pic_center"/>
    </p>
    <p>
...
function btnStyle(type: number, call?: (r: string) =&gt; void) {
  ...
  .onClick(() =&gt; {
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/d8784e9784d7458a890b43bbed718e35.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3e9a87a1d46244d498660086da010806.png#pic_center"/>
    </p>
    <p>
    ...
    <pre><code> // 数据库版本号是0时，创建数据表语句的SQL语句
const CREATE_TABLE_USER =
  'CREATE TABLE IF NOT EXISTS USER(ID INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, age INTEGER NOT NULL, sex INTEGER NOT NULL, height REAL, weight REAL)'
...
relationalStore.getRdbStore(context, STORE_CONFIG).then((store: relationalStore.RdbStore) =&gt; {
  ...
  console.error(`${TAG} db create error: `, err.message)
    ...
    <pre><code> //  新增staffId字段，创建数据表语句的SQL语句
...
relationalStore.getRdbStore(context, STORE_CONFIG).then((store: relationalStore.RdbStore) =&gt; {
  ...
  console.error(`${TAG} db create error: `, err.message)
    ...
    <pre><code>DBUtils query success:  [{
    "ID": 1,
    "age": 18,
    "height": 160,
    "name": "lili",
    ...
    <pre><code>//  去除weight字段，创建数据表语句的SQL语句
...
relationalStore.getRdbStore(context, STORE_CONFIG).then((store: relationalStore.RdbStore) =&gt; {
  ...
  console.error(`${TAG} db create error: `, err.message)
    ...
    <pre><code>static async transaction(isError: boolean = true){
    // 开启事务
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f687a77323031372f:61727469636c652f64657461696c732f313436313633343838" class_="artid" style="display:none">
 </p>
</div>
