...
2. 提示2：用这段代码将abc\_1.csv转化成999.vsysvarc
3. 提示3：很好，继续优化这段代码，如果csv中name属性值为空，那么不创建这一行的系统变量
4. 提示4：验证这段代码，将abc\_2.csv转化成987.vsysvar
