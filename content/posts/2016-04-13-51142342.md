---
layout: post
title: "什么是机器学习,一文让你了解机器学习的历史和真谛"
date: 2016-04-13 13:04:07 +0800
description: "作者：计算机的潜意识在本篇文章中，我将对机器学习做个概要的介绍。本文的目的是能让即便完全不了解机器学"
keywords: "一文读懂机器学习的前世今生"
categories: ['Ml']
tags: ['无标签']
artid: "51142342"
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=51142342
    alt: "什么是机器学习,一文让你了解机器学习的历史和真谛"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=51142342
featuredImagePreview: https://bing.ee123.net/img/rand?artid=51142342
---
...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     作者：计算机的潜意识
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="284" src="https://i-blog.csdnimg.cn/blog_migrate/ba5e7d67f748e796574f96da1a022b2c.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="304" src="https://i-blog.csdnimg.cn/blog_migrate/3ab0fe3423344cebfbd4b07ff7927c62.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="500"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图2 语音助手产品
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <span style="line-height:25.2px; color:rgb(51,102,255)">
      <span style="font-weight:700; color:rgb(64,64,64)">
       1.一个故事说明什么是机器学习
      </span>
     </span>
    </p>
    ...
    <h3 id="articleHeader0" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="font-weight:700">
      <span style="line-height:44.1px; color:rgb(255,102,0)">
       1.一个故事说明什么是机器学习
      </span>
     </span>
    </h3>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <a href="http://www.36dsj.com/wp-content/uploads/2015/01/320.jpg" rel="nofollow noopener noreferrer" style="color:rgb(0,95,169); text-decoration:none; background-color:transparent" target="_blank">
      <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="313" src="https://i-blog.csdnimg.cn/blog_migrate/e15672024a0e6515ba5c8395f190471e.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
     </a>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图3 决策树模型
    ...
    <h3 id="articleHeader1" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="font-weight:700">
      <span style="line-height:44.1px; color:rgb(255,102,0)">
       2.机器学习的定义
      </span>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="313" src="https://i-blog.csdnimg.cn/blog_migrate/e1de37dacd3b55d175d6e076a1491a05.png" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图4 房价的例子
    </p>
    ...
    <blockquote style="padding:5px 10px; margin:10px 0px 10px 25px; font-size:17.5px; border:2px solid rgb(239,239,239); line-height:31.5px; color:rgb(85,85,85); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="289" src="https://i-blog.csdnimg.cn/blog_migrate/b963d0f2e918598ae2e862528f16c816.png" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图5 机器学习与人类思考的类比
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <span style="font-weight:700">
      <span style="line-height:25.2px; color:rgb(255,102,0)">
       3.机器学习的范围
      </span>
     </span>
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="345" src="https://i-blog.csdnimg.cn/blog_migrate/4bbca8f14da2c8b43479fbde498c6bdf.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     ...
     两者的主要区别在于前者是从工业界发展起来的概念，后者则主要源自计算机学科。在著名的 《Pattern Recognition And Machine Learning》这本书中，Christopher M. Bishop在开头是这样说的“模式识别源自工业界，而机器学习来自于计算机学科。不过，它们中的活动可以被视为同一个领域的两个方面，同时在过去的10 年间，它们都有了长足的发展”。
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <span style="line-height:25.2px; color:rgb(255,102,0)">
      <span style="font-weight:700; color:rgb(64,64,64)">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     ...
     这几年数据挖掘的概念实在是太耳熟能详。几乎等同于炒作。但凡说数据挖掘都会吹嘘 数据挖掘如何如何，例如从数据中挖出金子，以及将废弃的数据转化为价值等等。但是，我尽管可能会挖出金子，但我也可能挖的是“石头”啊。这个说法的意思 是，数据挖掘仅仅是一种思考方式，告诉我们应该尝试从数据中挖掘出知识，但不是每个数据都能挖掘出金子的，所以不要神话它。一个系统绝对不会因为上了一个 数据挖掘模块就变得无所不能(这是IBM最喜欢吹嘘的)，恰恰相反，一个拥有数据挖掘思维的人员才是关键，而且他还必须对数据有深刻的认识，这样才可能从 数据中导出模式指引业务的改善。大部分数据挖掘中的算法是机器学习的算法在数据库中的优化。
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <span style="font-weight:700">
      <span style="line-height:25.2px; color:rgb(255,102,0)">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     ...
     。统计学习是个与机器学习高度重叠的学科。因为机器学习中的大多数方法来自统计学，甚 至可以认为，统计学的发展促进机器学习的繁荣昌盛。例如著名的支持向量机算法，就是源自统计学科。但是在某种程度上两者是有分别的，这个分别在于：统计学 习者重点关注的是统计模型的发展与优化，偏数学，而机器学习者更关注的是能够解决问题，偏实践，因此机器学习研究者会重点研究学习算法在计算机上执行的效 率与准确性的提升。
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <span style="font-weight:700">
      <span style="line-height:25.2px; color:rgb(255,102,0)">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     ...
     图像处理技术用于将图像处理为适合进入机器学习模型中的输入，机器学习则负责 从图像中识别出相关的模式。计算机视觉相关的应用非常的多，例如百度识图、手写字符识别、车牌识别等等应用。这个领域是应用前景非常火热的，同时也是研究 的热门方向。随着机器学习的新领域深度学习的发展，大大促进了计算机图像识别的效果，因此未来计算机视觉界的发展前景不可估量。
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <span style="line-height:25.2px; color:rgb(255,102,0)">
      <span style="font-weight:700; color:rgb(64,64,64)">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     ...
     。自然语言处理技术主要是让机器理解人类的语言的一门领域。在自然语言处理技 术中，大量使用了编译原理相关的技术，例如词法分析，语法分析等等，除此之外，在理解这个层面，则使用了语义理解，机器学习等技术。作为唯一由人类自身创 造的符号，自然语言处理一直是机器学习界不断研究的方向。按照百度机器学习专家余凯的说法“听与看，说白了就是阿猫和阿狗都会的，而只有语言才是人类独有 的”。如何利用机器学习技术进行自然语言的的深度理解，一直是工业和学术界关注的焦点。
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     可以看出机器学习在众多领域的外延和应用。机器学习技术的发展促使了很多智能领域的进步，改善着我们的生活。
    </p>
    <h3 id="articleHeader2" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="font-weight:700">
      <span style="line-height:44.1px; color:rgb(255,102,0)">
       4.机器学习的方法
      </span>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="291" src="https://i-blog.csdnimg.cn/blog_migrate/a67413df992a12f36b380e0dda2a89c4.png" style="border:0px; vertical-align:middle; max-width:100%" width="600">
      <br style="line-height:10px"/>
      图7 逻辑回归的直观解释
     </img>
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="229" src="https://i-blog.csdnimg.cn/blog_migrate/39fe97c942ef61c181561eef152c4640.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="322" src="https://i-blog.csdnimg.cn/blog_migrate/88494e231c4abaaf595bc9889a1be4b7.png" style="border:0px; vertical-align:middle; max-width:100%" width="593"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图9 神经网络的逻辑架构
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="200" src="https://i-blog.csdnimg.cn/blog_migrate/9f68c697fe509993b5b7a925f651838e.gif" style="border:0px; vertical-align:middle; max-width:100%" width="320"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图10 LeNet的效果展示
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="188" src="https://i-blog.csdnimg.cn/blog_migrate/820a5233e3e68dd9b04ff28310bb7672.png" style="border:0px; vertical-align:middle; max-width:100%" width="240"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图11 支持向量机图例
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="356" src="https://i-blog.csdnimg.cn/blog_migrate/1492de9efa6c8787cadb88ee4f283a89.gif" style="border:0px; vertical-align:middle; max-width:100%" width="444"/>
     <br style="line-height:10px"/>
     图12 三维空间的切割
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
    ...
    <h3 id="articleHeader3" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="font-weight:700">
      <span style="line-height:44.1px; color:rgb(255,102,0)">
       5.机器学习的应用–大数据
      </span>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="207" src="https://i-blog.csdnimg.cn/blog_migrate/1fe969451bf7e24a9fb2e338eb16bfb8.png" style="border:0px; vertical-align:middle; max-width:100%" width="634"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图13 Google成功预测H1N1
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="421" src="https://i-blog.csdnimg.cn/blog_migrate/6d263d1170b54faac995e0169c99e431.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
     <br style="line-height:10px"/>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="490" src="https://i-blog.csdnimg.cn/blog_migrate/0372895f3a5e0d946dfcb68434e8accc.png" style="border:0px; vertical-align:middle; max-width:100%" width="522"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="75" src="https://i-blog.csdnimg.cn/blog_migrate/a93ba1c285d62a943611f135fb9e3fd7.png" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图15 机器学习准确率与数据的关系
    </p>
    ...
    <h3 id="articleHeader4" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="font-weight:700">
      <span style="line-height:44.1px; color:rgb(255,102,0)">
       6.机器学习的子类–深度学习
      </span>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="268" src="https://i-blog.csdnimg.cn/blog_migrate/4dab0af1304b7b4185ea14d5bfa404c1.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
    ...
    <ul style="margin:0px 2px 0px 45px; padding:0px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; line-height:25.2px">
     <li style="line-height:25.2px">
      <span style="font-weight:700">
       2012年6月
      </span>
      ，《纽约时报》披露了Google Brain项目，这个项目是由Andrew Ng和Map-Reduce发明人Jeff Dean共同主导，用16000个CPU Core的并行计算平台训练一种称为“深层神经网络”的机器学习模型，在语音识别和图像识别等领域获得了巨大的成功。Andrew Ng就是文章开始所介绍的机器学习的大牛(图1中右者)。
     </li>
     <li style="line-height:25.2px">
      <span style="font-weight:700">
       2012年11月，
      </span>
      微软在中国天津的一次活动上公开演示了一个全自动的同声传译系统，讲演者用英文演讲，后台的计算机一气呵成自动完成语音识别、英中机器翻译，以及中文语音合成，效果非常流畅，其中支撑的关键技术是深度学习；
     </li>
     <li style="line-height:25.2px">
      <span style="font-weight:700">
       2013年1月
      </span>
      ，在百度的年会上，创始人兼CEO李彦宏高调宣布要成立百度研究院，其中第一个重点方向就是深度学习，并为此而成立深度学习研究院(IDL)。
     </li>
     <li style="line-height:25.2px">
      <span style="font-weight:700">
       2013年4月
      </span>
      ，《麻省理工学院技术评论》杂志将深度学习列为2013年十大突破性技术(Breakthrough Technology)之首。
     </li>
    </ul>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="283" src="https://i-blog.csdnimg.cn/blog_migrate/99d96ebc004110f8a0d3d1db6914de47.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图17 深度学习的发展热潮
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <a href="http://www.36dsj.com/wp-content/uploads/2015/01/196.jpg" rel="nofollow noopener noreferrer" style="color:rgb(0,95,169); text-decoration:none; background-color:transparent" target="_blank">
      <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="288" src="https://i-blog.csdnimg.cn/blog_migrate/e2d2217d2e5bf85811d8116c0e3eb00f.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
     </a>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图18 百度识图
    ...
    <h3 id="articleHeader5" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="font-weight:700">
      <span style="line-height:44.1px; color:rgb(255,102,0)">
       7.机器学习的父类–人工智能
      </span>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="511" src="https://i-blog.csdnimg.cn/blog_migrate/4ece05ec9fe7dc3182742bfb258f6802.png" style="border:0px; vertical-align:middle; max-width:100%" width="531"/>
     <br style="line-height:10px"/>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     ...
     <span style="font-weight:700">
      <span style="line-height:25.2px; color:rgb(255,0,0)">
       “智慧”。而智慧的最佳体现是什
      </span>
     </span>
     么？
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="248" src="https://i-blog.csdnimg.cn/blog_migrate/f9f431851df81b735fbb9df072a86d7a.png" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图20 机器学习与智慧
    </p>
    ...
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px">
     <img alt="一文读懂机器学习，大数据/自然语言处理/算法全有了……" height="375" src="https://i-blog.csdnimg.cn/blog_migrate/d95428902578867dc5ab7b6f6d3d61aa.jpeg" style="border:0px; vertical-align:middle; max-width:100%" width="600"/>
    </p>
    <p style="margin-top:10px; margin-bottom:10px; line-height:25.2px; color:rgb(64,64,64); font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-size:14px; text-align:center">
     图21 马斯克与人工智能
    </p>
    ...
    <h3 id="articleHeader6" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="line-height:44.1px; color:rgb(255,102,0)">
      <span style="font-weight:700; color:rgb(64,64,64)">
       8.机器学习的思考–计算机的潜意识
      </span>
    ...
    <h3 id="articleHeader7" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="line-height:44.1px; color:rgb(255,102,0)">
      <span style="font-weight:700; color:rgb(64,64,64)">
       9.总结
      </span>
    ...
    <h3 id="articleHeader8" style="font-family:'Microsoft YaHei',Verdana,sans-serif,SimSun; font-weight:500; line-height:1.1; color:rgb(64,64,64); margin-top:20px; margin-bottom:10px; font-size:1.75em; border-bottom-width:1px; border-bottom-style:solid; border-bottom-color:rgb(238,238,238); padding:0px 0px 5px">
     <span style="font-weight:700">
      <span style="line-height:44.1px; color:rgb(255,102,0)">
       10.后记
      </span>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f797977616e31333134353230:2f61727469636c652f64657461696c732f3531313432333432" class_="artid" style="display:none">
 </p>
</div>
