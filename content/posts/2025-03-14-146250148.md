 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" height="287" src="https://i-blog.csdnimg.cn/img_convert/4bcffbe881986b5a69a44e3a171c3a4c.png" width="1080"/>
    </p>
    <p>
    </p>
    <h5>
    ...
    <pre><code>byte[] data = new byte[]{1, 2, 3};
ByteBuffer buffer = ByteBuffer.wrap(data);
System.out.println(buffer.capacity());
//输出显示ByteBuffer的capacity是3，因为字节数组data的大小是3</code></pre>
    <p>
    </p>
    <p>
     <strong>
    ...
    <pre><code>buffer.limit(1);
System.out.println(buffer.limit());</code></pre>
    <p>
    </p>
    <p>
     <strong>
    ...
    <p class="img-center">
     <img alt="" height="252" src="https://i-blog.csdnimg.cn/img_convert/0cea4488696f7fe8937e1feee2f952ef.png" width="1080"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <pre><code>public class BufferDemo {
    ...
    <pre><code>//适用于从磁盘文件读数据出来，或者从网络里读数据进来
ByteBuffer buffer1 = ByteBuffer.allocate(10);
//如果用direct模式分配Buffer，整体性能可以比普通模式稍微高些
ByteBuffer buffer2 = ByteBuffer.allocateDirect(10);</code></pre>
    <p>
    </p>
    <h5>
    ...
    <pre><code>一.ByteBuffer.allocateDirect(100)
分配一个Direct缓冲区，效率更高。
...
把数组全部写入缓冲区，以及从缓冲区读取全部数据到数组里去。</code></pre>
    <p>
    </p>
    <p>
     下面是这些API方法的使用示例：
    ...
    <pre><code>public class BufferDemo2 {   
    public static void main(String[] args) throws Exception {
...
一般在读取了一遍数据后，还想要再次重新读取一遍数据时，就可以使用rewind，此时limit是不变的。 </code></pre>
    <p>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" height="259" src="https://i-blog.csdnimg.cn/img_convert/a2c95b19567d10e69855c55566637ff9.png" width="1080"/>
    </p>
    <p>
    </p>
    <h5>
    ...
    <pre><code>public class FileChannelDemo {
    public static void main(String[] args) throws Exception {
        //构造一个传统的文件输出流
    ...
    <pre><code>public class FileChannelDemo2 {
    ...
    <pre><code>public class FileChannelDemo3 {
    public static void main(String[] args) throws Exception {
    ...
    <pre><code>public class FileLockDemo1 {
    public static void main(String[] args) throws Exception {
        //新建一个输入流
        FileInputStream in = new FileInputStream("/Users/demo/Downloads/hello.txt"); 
        FileChannel channel = in.getChannel();
    ...
    <pre><code>public class FileLockDemo2 {
    public static void main(String[] args) throws Exception {
    ...
    <p class="img-center">
     <img alt="" height="972" src="https://i-blog.csdnimg.cn/img_convert/b776a291108e67bcbaecbb741015f171.jpeg" width="1100"/>
    </p>
    <p>
    </p>
    <p>
...
public class SocketClient {
    ...
    <blockquote>
     ...
     <p>
      ...
      <a href="https://www.cnblogs.com/mjunz/p/18771272" rel="nofollow" title="Netty基础—4.NIO的使用简介 - 东阳马生架构 - 博客园">
       Netty基础—4.NIO的使用简介 - 东阳马生架构 - 博客园
      </a>
     </p>
     <p>
      <strong>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f736467666166675f32352f:61727469636c652f64657461696c732f313436323530313438" class_="artid" style="display:none">
 </p>
</div>
