...
[暗黑引擎 -- Shodan常用搜索语法\_web安全工具库的博客-CSDN博客\_shodan搜索语法](https://blog.csdn.net/weixin_41489908/article/details/110404340 "暗黑引擎 -- Shodan常用搜索语法_web安全工具库的博客-CSDN博客_shodan搜索语法")
...
[Zoomeye-钟馗之眼语法参考\_Pika\_mia的博客-CSDN博客\_zoomeye语法](https://blog.csdn.net/qq_42716969/article/details/105994291 "Zoomeye-钟馗之眼语法参考_Pika_mia的博客-CSDN博客_zoomeye语法")

[zoomeye用户使用手册\_ncafei的博客-CSDN博客\_zoomeye](https://blog.csdn.net/ncafei/article/details/63683377 "zoomeye用户使用手册_ncafei的博客-CSDN博客_zoomeye")
...
功能差别：一键排除干扰数据、证书有效性提取验证、正则表达式语法查询、精准匹配icon、port\_size语法查询、一对一技术支持
...
[FOFA语句\_NoOne\_52的博客-CSDN博客\_fofa语句](https://blog.csdn.net/weixin_45682070/article/details/109546750 "FOFA语句_NoOne_52的博客-CSDN博客_fofa语句")
...
icp.web\_name="奇安信"      搜索ICP备案网站名中含有“奇安信”的资产
...
header.status\_code="402"      搜索HTTP请求返回状态码为”402”的资产
...
ip.country="JP" and web.similar\_id="1f66e247d07c85e43b036fb7c57f8459"
...
ip.country="JP" and app.name==("Apache" and app.version=="2.4.6") and header.status\_code="200"
...
[https://github.com/0x727/Space\_view](https://github.com/0x727/Space_view "https://github.com/0x727/Space_view")
