...
print("最终结果:", result)
    ...
    <pre><code>在连接 - step_1的管道中,foo_meta_function被调用 - [上一节名称是]： + [下一节名称是]：step_1
...
最终结果: {'foo': '#end#', 'bar': ['000', 'a', 'b', 'c']}
    ...
    <p>
     <img alt="" height="1098" src="https://i-blog.csdnimg.cn/direct/d0b2e2bbcd164bfc83a184ac26ac3bd4.png" width="1041"/>
    </p>
    <p>
    </p>
   </div>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f626967636172702f:61727469636c652f64657461696c732f313436323936303436" class_="artid" style="display:none">
 </p>
</div>
