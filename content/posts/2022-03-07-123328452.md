...
[记录下第一次使用renren-fast-vue的踩坑记录，请认真看完\_睡竹的博客-CSDN博客\_renren-fast-vue](https://blog.csdn.net/weixin_42675423/article/details/122384324 "记录下第一次使用renren-fast-vue的踩坑记录，请认真看完_睡竹的博客-CSDN博客_renren-fast-vue")
...
TRUNCATE TABLE `QRTZ\_BLOB\_TRIGGERS`
  
TRUNCATE TABLE `QRTZ\_CALENDARS`
  
TRUNCATE TABLE `QRTZ\_CRON\_TRIGGERS`
  
TRUNCATE TABLE `QRTZ\_FIRED\_TRIGGERS`
  
TRUNCATE TABLE `QRTZ\_JOB\_DETAILS`
  
TRUNCATE TABLE `QRTZ\_LOCKS`
  
TRUNCATE TABLE `QRTZ\_PAUSED\_TRIGGER\_GRPS`
  
TRUNCATE TABLE `QRTZ\_SCHEDULER\_STATE`
  
TRUNCATE TABLE `QRTZ\_SIMPLE\_TRIGGERS`
  
TRUNCATE TABLE `QRTZ\_SIMPROP\_TRIGGERS`
  
TRUNCATE TABLE `QRTZ\_TRIGGERS`
