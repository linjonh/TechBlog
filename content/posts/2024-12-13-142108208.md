...
<pre><code class="language-cpp">// 假设已经连接了 readyRead 信号到槽函数
...
<pre><code class="language-cpp">// 设置组播的 TTL（Time-To-Live）
...
<h2> 5. QUdpSocket 在 UDP 通信系统中的实践应用
</h2>
<p>
