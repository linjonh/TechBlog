...
[https://blog.csdn.net/yellow\_hill/article/details/142597007?spm=1001.2014.3001.5501](https://blog.csdn.net/yellow_hill/article/details/142597007?spm=1001.2014.3001.5501 "https://blog.csdn.net/yellow_hill/article/details/142597007?spm=1001.2014.3001.5501")
...
>   
> Based on: Qt 6.7.2 (MSVC 2019, x86\_64)
>   
...
> 11:15:35: Starting K:\Prj-Astro\prj\_app\_GUI\Astro\_Vision\_Demo1\.qtcreator\Python\_3\_6\_64\_bit\_venv\Scripts\python.exe -u widget.py...
>   
...
>   
> 11:15:35: K:\Prj-Astro\prj\_app\_GUI\Astro\_Vision\_Demo1\.qtcreator\Python\_3\_6\_64\_bit\_venv\Scripts\python.exe 退出，退出代码: 1
>   
> {1 ?} {2?}
>
> 11:16:12: Starting K:\Prj-Astro\prj\_app\_GUI\Astro\_Vision\_Demo1\.qtcreator\Python\_3\_6\_64\_bit\_venv\Scripts\python.exe -u widget.py...
>   
> Traceback (most recent call last):
>   
> File "widget.py", line 4, in <module>
...
> ModuleNotFoundError: No module named 'PySide6'
>   
> 11:16:12: K:\Prj-Astro\prj\_app\_GUI\Astro\_Vision\_Demo1\.qtcreator\Python\_3\_6\_64\_bit\_venv\Scripts\python.exe 退出，退出代码: 1
>   
> {1 ?} {2?}
...
> K:\Prj-Astro\prj\_app\_GUI\Astro\_Vision\_Demo1>^Z
>   
> K:\Prj-Astro\prj\_app\_GUI\Astro\_Vision\_Demo1>pip install pyside6
>   
...
> Collecting pyside6
>   
> Using cached PySide6-6.7.3-cp39-abi3-win\_amd64.whl.metadata (5.5 kB)
>   
> Collecting shiboken6==6.7.3 (from pyside6)
>   
> Using cached shiboken6-6.7.3-cp39-abi3-win\_amd64.whl.metadata (2.6 kB)
>   
> Collecting PySide6-Essentials==6.7.3 (from pyside6)
>   
> Using cached PySide6\_Essentials-6.7.3-cp39-abi3-win\_amd64.whl.metadata (3.8 kB)
>   
> Collecting PySide6-Addons==6.7.3 (from pyside6)
>   
> Using cached PySide6\_Addons-6.7.3-cp39-abi3-win\_amd64.whl.metadata (4.1 kB)
>   
> Using cached PySide6-6.7.3-cp39-abi3-win\_amd64.whl (539 kB)
>   
> Using cached PySide6\_Addons-6.7.3-cp39-abi3-win\_amd64.whl (123.6 MB)
>   
> Downloading PySide6\_Essentials-6.7.3-cp39-abi3-win\_amd64.whl (68.9 MB)
>   
> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 68.9/68.9 MB 4.0 MB/s eta 0:00:00
>   
> Downloading shiboken6-6.7.3-cp39-abi3-win\_amd64.whl (1.1 MB)
>   
...
> :-1: error: ModuleNotFoundError: No module named 'ui\_form'
...
其实这段自动生成的代码的最开始，已经有了很明确的注解，看下面，你需要生成一个ui\_form.py的文件。

> # Important:
>   
>
> **# You need to run the following command to generate the ui\_form.py file**
>   
> #     pyside6-uic form.ui -o ui\_form.py, or
>   
> #     pyside2-uic form.ui -o ui\_form.py
>   
> from ui\_form import Ui\_Widget
...
会生成ui\_form.py的文件，然后，在重新运行QT Creator，就可以出来你的界面了。