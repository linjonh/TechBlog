 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <pre><code class="language-python">#随机种子固定，随机结果也固定
...
# 这意味着所有的随机操作都将基于这个种子值来进行初始化，从而确保了实验的可重复性。
    ...
    <pre><code class="language-python">train_transform = transforms.Compose(  #进行模型变换
    [
...
val_transform = transforms.Compose(  #进行模型变换
    ...
    <pre><code class="language-python">class food_Dataset(Dataset):
    ...
    <pre><code class="language-python">class semiDataset(Dataset):
    ...
    <pre><code class="language-python">def get_semi_loader(no_label_loder,model,device,thres):
    ...
    <pre><code class="language-python">#模型框架
class myModel(nn.Module):
    ...
    <pre><code class="language-python">def train_val(model,train_loader,val_loader,no_label_loader,device,epochs,optimizer,loss,thres,save_path):
    model = model.to(device)
    semi_loader=None
    ...
    <pre><code class="language-python">train_path=r"D:\python_data\classify\food_classification\food-11_sample\training\labeled"
...
epochs=4
thres =0.1
train_val(model,train_loader,val_loader,no_label_loader,device,epochs,optimizer,loss,thres,save_path)</code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f44323436303539363432312f:61727469636c652f64657461696c732f313436313033333033" class_="artid" style="display:none">
 </p>
</div>
