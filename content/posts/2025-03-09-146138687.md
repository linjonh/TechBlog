...
下载前，需要查看 RabbitMQ 和 Erlang 的对应版本，版本不对应会有问题，可打开此链接：[Erlang Version Requirements | RabbitMQ](https://www.rabbitmq.com/docs/which-erlang) 查看版本对应关系。

比如我下载的rabbitmq 是 3.10.11 版本，那它适配的 erlang 最低是24.2，最高时25.2，所以我下载的 erlang 是
25.1.1 的：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/6beac53203a54d128a6c6e07756dfa74.png)

erlang 下载地址：<https://www.erlang.org/>  
Rabbitmq 下载地址：<https://github.com/rabbitmq/rabbitmq-
server/releases/tag/v3.10.11>，需要哪个版本，就在地址最后修改就可以了。
...
访问：http://虚拟机地址:15672  
会出现一下页面：![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/6e7fc4c93aa74a1aa01c5b7af7ef68f2.png)  
填写前面设置的用户名和密码，即可登录：  
