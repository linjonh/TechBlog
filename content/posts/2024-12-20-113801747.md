...
set path=%xp%\m4s\_cvt\bin;%path%
  
ffmpeg -i video.m4s -i audio.m4s -c:v copy -strict experimental out\_file.mp4
  
cmd /k

ffmpeg 链接:https://pan.baidu.com/s/11H4c\_gE0yGHa8TnwWlEoeA 提取码:6kga