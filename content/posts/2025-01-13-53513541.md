 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <br/>
    <br/>
    <pre><code class="language-python">#以下为python源程序
...
while True:
    <span style="white-space:pre">	</span># Move servo on channel O between extremes.
<span style="white-space:pre">	</span>channel=int(input('pleas input channel:'))
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f71715f3234303337313937:2f61727469636c652f64657461696c732f3533353133353431" class_="artid" style="display:none">
 </p>
</div>
