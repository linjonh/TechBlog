...
---|---  
COLOR_BGR2RGBA  Python：cv.COLOR_BGR2RGBA  |  在 RGB 和 BGR 色彩空间之间转换（带或不带 Alpha 通道）  
COLOR_BGR2BGR565  Python：cv.COLOR_BGR2BGR565  |  在 RGB/BGR 和 BGR565 之间转换（16 位图像）  
...
[cv：：WINDOW_AUTOSIZE](https://docs.opencv.org/4.11.0/d0/d90/group__highgui__window__flags.html#ggabf7d2c5625bc59ac130287f925557ac3acf621ace7a54954cbac01df27e47228f
"cv：：WINDOW_AUTOSIZE") 标志创建的，则图像将以其原始大小显示，但它仍受屏幕分辨率的限制。否则，将缩放图像以适合窗口。
...
>
> 此函数后应调用
> [cv：：waitKey](https://docs.opencv.org/4.11.0/d7/dfc/group__highgui.html#ga5628525ad33f52eab17feebcfba38bd7
> "cv：：waitKey") 或 [cv：:p
> ollKey](https://docs.opencv.org/4.11.0/d7/dfc/group__highgui.html#ga6d20fbd3100ec3badc1eaa653aff99d7
> "cv：:p ollKey") 来执行 GUI
...
> estroyWindow](https://docs.opencv.org/4.11.0/d7/dfc/group__highgui.html#ga851ccdd6961022d1d5b4c4f255dbab34
> "cv：:d estroyWindow")。
>
...
>
> 函数
> [waitKey](https://docs.opencv.org/4.11.0/d7/dfc/group__highgui.html#ga5628525ad33f52eab17feebcfba38bd7
> "waitKey") 和
> [pollKey](https://docs.opencv.org/4.11.0/d7/dfc/group__highgui.html#ga6d20fbd3100ec3badc1eaa653aff99d7
...
[FILLED](https://docs.opencv.org/4.11.0/d6/d6e/group__imgproc__draw.html#ggaf076ef45de481ac96e0ab3dc2c29a777a89c5f6beef080e6df347167f85e07b9e
"FILLED")）表示函数必须绘制填充矩形  
lineType| 线路的类型。  
shift| 点坐标中的小数位数。
