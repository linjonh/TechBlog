...
# 正确：包含协商头作为缓存key
location /data {
proxy\_cache\_key "$uri$http\_accept$http\_accept\_language";
proxy\_cache\_valid 200 1h;
}
1. ​\*\*移动端特殊处理\*\*
// 识别移动设备返回优化内容
...
\* Python: `werkzeug.http.parse\_accept\_header`
