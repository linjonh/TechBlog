 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <h2 id="计算机中的网络安全" style="margin-left:0; margin-right:0; text-align:left">
     <strong>
    ...
    <h3 id="机密性" style="margin-left:0; margin-right:0">
     <strong>
      机密性
     </strong>
    </h3>
    ...
    <h4 id="密码学" style="margin-left:0; margin-right:0">
     <strong>
      密码学
     </strong>
    </h4>
    ...
    <h5 id="对称秘钥体系" style="margin-left:0; margin-right:0">
     <strong>
    ...
    <h5 id="des算法" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       DES算法
      </span>
    ...
    <pre class="highlighter-hljs" style="margin-left:0; margin-right:0"><code class="language-undefined">58,50,42,34,26,18,10,2,
...
63,55,47,39,31,23,15,7,
    ...
    <pre class="highlighter-hljs" style="margin-left:0; margin-right:0"><code class="language-undefined">40,8,48,16,56,24,64,32,
...
33,1,41, 9,49,17,57,25,
    ...
    <h5 id="3des" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       3DES
      </span>
    ...
    <h5 id="aes" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       AES
      </span>
    ...
    <h5 id="密码块链接" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       密码块链接
      </span>
    ...
    <h5 id="cbc" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       CBC
      </span>
    ...
    <h4 id="公开秘钥加密" style="margin-left:0; margin-right:0">
     <strong>
      公开秘钥加密
     </strong>
    </h4>
    ...
    <h4 id="rsa算法" style="margin-left:0; margin-right:0">
     <strong>
      RSA算法
     </strong>
    </h4>
    ...
    <h5 id="秘钥的生成" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       秘钥的生成
      </span>
    ...
    <ol style="margin-left:0; margin-right:0">
     <li>
      <p style="margin-left:auto; margin-right:auto">
       选择两个大素数， 这个值越大越好， 甚至已经超出了常规意义上的 大数值。 该值越大， 破解RSA算法越困难。 推荐公司使用时， p q 两个数的乘积 需要 为 1024bit数量级。
      </p>
     </li>
     <li>
      <p style="margin-left:auto; margin-right:auto">
    ...
    <h5 id="加解密过程" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       加解密过程
      </span>
    ...
    <h5 id="工作原理" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       工作原理
      </span>
    ...
    <pre class="highlighter-hljs" style="margin-left:0; margin-right:0"><code class="language-lua">a ^ b <span style="color:#0000ff">mod</span> n = ((a <span style="color:#0000ff">mod</span> n)^b) <span style="color:#0000ff">mod</span> n 
</code></pre>
    <p style="margin-left:auto; margin-right:auto">
     则上述公式可以变为:
    </p>
    <pre class="highlighter-hljs" style="margin-left:0; margin-right:0"><code class="language-lua">m^ed <span style="color:#0000ff">mod</span> n
</code></pre>
    <p style="margin-left:auto; margin-right:auto">
     因此现在就需要证明:
    </p>
    ...
    <h5 id="rsa的大素数选择" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       RSA的大素数选择
      </span>
    ...
    <h6 id="素性测试" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       素性测试
      </span>
    ...
    <h5 id="会话秘钥" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       会话秘钥
      </span>
    ...
    <h3 id="完整性" style="margin-left:0; margin-right:0">
     <strong>
      完整性
     </strong>
    </h3>
    ...
    <h4 id="密码散列函数" style="margin-left:0; margin-right:0">
     <strong>
      密码散列函数
     </strong>
    </h4>
    ...
    <h4 id="报文鉴别" style="margin-left:0; margin-right:0">
     <strong>
      报文鉴别
     </strong>
    </h4>
    ...
    <h4 id="数字签名" style="margin-left:0; margin-right:0">
     <strong>
      数字签名
     </strong>
    </h4>
    ...
    <h4 id="公钥认证" style="margin-left:0; margin-right:0">
     <strong>
      公钥认证
     </strong>
    </h4>
    ...
    <h3 id="端点鉴别" style="margin-left:0; margin-right:0">
     <strong>
      端点鉴别
     </strong>
    </h3>
    ...
    <h3 id="ssl" style="margin-left:0; margin-right:0">
     <strong>
      SSL
     </strong>
    </h3>
    ...
    <h4 id="宏观描述" style="margin-left:0; margin-right:0">
     <strong>
      宏观描述
     </strong>
    </h4>
    ...
    <h4 id="完整描述" style="margin-left:0; margin-right:0">
     <strong>
      完整描述
     </strong>
    </h4>
    ...
    <h3 id="网络安全的保障" style="margin-left:0; margin-right:0">
     <strong>
      网络安全的保障
     </strong>
    </h3>
    ...
    <h4 id="防火墙" style="margin-left:0; margin-right:0">
     <strong>
      防火墙
     </strong>
    </h4>
    ...
    <p style="margin-left:auto; margin-right:auto">
     ...
     的作用于内部和外部网络的环境间产生一种保护的屏障，从而实现对计算机不安全网络因素的阻断。
    </p>
    <p style="margin-left:auto; margin-right:auto">
    ...
    <h5 id="传统的分组过滤器" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       传统的分组过滤器
      </span>
    ...
    <h5 id="状态分组过滤器" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       状态分组过滤器
      </span>
    ...
    <h5 id="应用程序网关" style="margin-left:0; margin-right:0">
     <strong>
      <span style="color:#333333">
       应用程序网关
      </span>
    ...
    <h3 id="总结" style="margin-left:0; margin-right:0">
     <strong>
      总结
     </strong>
    </h3>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323430315f38383735323436342f:61727469636c652f64657461696c732f313436323638363430" class_="artid" style="display:none">
 </p>
</div>
