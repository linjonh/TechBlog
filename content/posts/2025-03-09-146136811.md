 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre>response = requests.post(url, headers=headers, data=data,proxies=proxies)
...
print(response.text)</pre>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/f03e29f301c44def859a580b1a694f29.png"/>
    </p>
    <h2>
     总结
    </h2>
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f6666323736363935383239322f:61727469636c652f64657461696c732f313436313336383131" class_="artid" style="display:none">
 </p>
</div>
