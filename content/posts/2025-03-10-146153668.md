...
<span class="token keyword">SHOW</span> VARIABLES <span class="token operator">LIKE</span> <span class="token string">'%validate_password%'</span><span class="token punctuation">;</span>
    ...
    <h5>
     <a id="__validate_password____215">
     </a>
    ...
    <pre><code class="prism language-bash">ALTER <span class="token environment constant">USER</span> root@localhost IDENTIFIED BY <span class="token string">''</span><span class="token punctuation">;</span>
</code></pre>
    <p>
     或
    </p>
    <pre><code class="prism language-bash">SET <span class="token assign-left variable">PASSWORD</span><span class="token operator">=</span><span class="token string">''</span><span class="token punctuation">;</span>
</code></pre>
    <p>
...
<span class="token keyword">CREATE</span> <span class="token keyword">USER</span> remote IDENTIFIED <span class="token keyword">WITH</span> mysql_native_password <span class="token keyword">BY</span> <span class="token string">''</span><span class="token punctuation">;</span>
    ...
    <pre><code class="prism language-sql"><span class="token comment">--------    降低密码强度,  创建用户, 无密码 , 赋予最大权限和root角色, 设置root角色为默认角色, 刷新权限 --------</span>
...
<span class="token variable">$MysqlFirstLoginCodeCommand</span>
    ...
    <h5>
     <a id="Fedora41MySQL844rootlocalhost_remote_3306_395">
     </a>
...
mysql <span class="token parameter variable">-uremote</span>
    ...
    <h4>
     <a id="validate_password__validate_password_437">
     </a>
    ...
    <h5>
     <a id="_validate_password_MySQL_498">
     </a>
...
UNINSTALL PLUGIN validate_password<span class="token punctuation">;</span>
    ...
    <h5>
     <a id="_validate_password____536">
     </a>
...
<span class="token comment">-- 返回值：100（最高强度）</span>
    ...
    <h3>
     <a id="validate_passwordchanged_characters_percentage_1017">
     </a>
     validate_password.changed_characters_percentage
    </h3>
    <p>
