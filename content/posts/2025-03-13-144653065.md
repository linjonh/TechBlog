 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-html">&lt;!--  springMVC的前端控制器--&gt;
    &lt;servlet&gt;
...
    &lt;/servlet-mapping&gt;</code></pre>
    ...
    <pre><code class="language-html">&lt;context:component-scan base-package="cn.dsscm.controller"/&gt;
    &lt;mvc:annotation-driven/&gt;</code></pre>
    ...
    <pre><code class="language-java">return "redirect:queryUser";</code></pre>
    <p>
     2.转发到用户修改页面:
    </p>
    <pre><code class="language-java">return "forward:editUser";</code></pre>
    <h2>
     <br/>
     数据交互与绑定:
    </h2>
    ...
    <pre><code class="language-java">@RequestMapping("/selectUser")
Public String selectUser(@RequestParam(value="user_id")Integer id) {...}</code></pre>
    <p>
...
public class UserController {
    ...
    <pre><code class="language-java">@RequestMapping( {"/index", "/"} )</code></pre>
    <p>
    ...
    <pre><code class="language-java">@RequestMapping(value="/welcome", method=RequestMethod.GET, params="username")
public String welcome(String username) {...}</code></pre>
    <p>
...
public String giao(String username, Map&lt;String, Object&gt; model){}</code></pre>
    <p>
     4.@ModelAttribute:
    </p>
    <p>
    ...
    <pre><code class="language-java">public String giao(Integer[] ids)</code></pre>
    <h4>
     3.绑定集合:
    </h4>
    <p>
    ...
    <pre><code class="language-html">["abc", 13, false, null]</code></pre>
    <p>
     可以在一个数组中存储多种类型的数据,
    </p>
    <p>
    ...
    <pre><code class="language-html">http://.../queryItems?id=1
http://.../items/1</code></pre>
    <p>
    </p>
    <h2>
     文件上传和下载与拦截器机制:
    ...
    <pre><code class="language-html">&lt;a href="${pageContext.request.contextPath }/download?filename=001.jpg"&gt;文件下载&lt;/a&gt;</code></pre>
    <p>
...
public ResponseEntity&lt;byte[]&gt; fileDownload(HttpServletRequest request, 
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323330315f37393939373331302f:61727469636c652f64657461696c732f313434363533303635" class_="artid" style="display:none">
 </p>
</div>
