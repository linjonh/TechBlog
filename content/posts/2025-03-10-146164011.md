...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.sigmoid(output)</code></pre>
    <h5>
     四、模型训练
    </h5>
    <h6>
    ...
    <pre><code class="hljs">criterion = nn.BCELoss()  # 或者使用Dice Loss的自定义实现
optimizer = torch.optim.Adam(model.parameters(), lr=0.001, weight_decay=1e-5)</code></pre>
    <h6>
     4.2 训练策略
    </h6>
    <ul>
    ...
    <pre><code class="hljs">num_epochs = 50
for epoch in range(num_epochs):
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323430315f38323335353431362f:61727469636c652f64657461696c732f313436313634303131" class_="artid" style="display:none">
 </p>
</div>
