...
@Select("SELECT u.id, u.name, u.email, o.id as order\_id, o.amount as order\_amount " +
"FROM users u LEFT JOIN orders o ON u.id = o.user\_id WHERE u.id=#{id}")
@Results({
