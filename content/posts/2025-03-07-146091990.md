...
> environment:
>
> - elasticsearch\_url=http://10.1.1.97:9200
>
> depends\_on:
>
> - elasticsearch
...
如果我们的es报： max virtual memory areas vm.max\_map\_count [65530] is too low, increase to at least [262144]

这是虚拟机太小

需要在：/etc/sysctl.conf 添加上：vm.max\_map\_count=262144

最后启动配置：sysctl -w vm.max\_map\_count=262144
