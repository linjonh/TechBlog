 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="图片" height="500" src="https://i-blog.csdnimg.cn/img_convert/b3b453458207b727f76ff57dafaf6af5.jpeg" width="500"/>
    </p>
    <h2>
     Pandas库可视化基础
    </h2>
    ...
    <pre><code>pip install pandas matplotlib -i https://mirrors.aliyun.com/pypi/simple/</code></pre>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="449" src="https://i-blog.csdnimg.cn/img_convert/6f50b53be59a8f57abe0e9d56c019605.jpeg" width="400"/>
    </p>
    <ul>
     <li>
      <p>
    ...
    <pre><code>举例：准备一个DataFrame数据，我们用于生成不同的图表
import pandas as pd
...
print(df)</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="160" src="https://i-blog.csdnimg.cn/img_convert/7f68947d9c1b098d8132e8d6f8f14eac.jpeg" width="400"/>
    </p>
    <h2>
    ...
    <pre><code>df.plot(kind='line',title='line',x='name',y='math',grid=True,figsize=(4,3))
或者df.plot.line(title='line',x='name',y='math',grid=True,figsize=(4,3))</code></pre>
    <p>
     执行后图如下：
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="365" src="https://i-blog.csdnimg.cn/img_convert/009b4124ad3a385de8ced6aa7713cb12.jpeg" width="400"/>
    </p>
    <p>
     完整代码如下：
    </p>
...
plt.show() #展示图形</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="339" src="https://i-blog.csdnimg.cn/img_convert/d049d9e5b7aaa0f5e296eabd6e87a75b.jpeg" width="400"/>
    </p>
    <p>
     举例：在折线图上显示数值
    </p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="317" src="https://i-blog.csdnimg.cn/img_convert/015ab300c817940656c0a957974fa340.jpeg" width="400"/>
    </p>
    <h2>
    ...
    <pre><code>df.plot.bar(x='name',y=['math','english','yuwen'],colormap='viridis')</code></pre>
    <p>
     执行后结果如下：
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="275" src="https://i-blog.csdnimg.cn/img_convert/6d20c9aa752a5185e27c42e1c705a552.jpeg" width="400"/>
    </p>
    <p>
     colormap 常见的颜色如下：
    </p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="332" src="https://i-blog.csdnimg.cn/img_convert/3d2f984e60d74295b47fc34bad97be08.jpeg" width="400"/>
    </p>
    <h2>
    ...
    <pre><code>df.plot.barh(x='name',subplots=True)</code></pre>
    <p>
     执行后如下：
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="图片" height="326" src="https://i-blog.csdnimg.cn/img_convert/f6e841b3fa12ade735801c1ddd3dfe2a.jpeg" width="400"/>
    </p>
    <p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="344" src="https://i-blog.csdnimg.cn/img_convert/3200daa1e2bb787d6eb67add8f70ca6a.jpeg" width="400"/>
    </p>
    <p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="336" src="https://i-blog.csdnimg.cn/img_convert/d337e09ec86972768c9cb82180fa9ebc.jpeg" width="400"/>
    </p>
    <p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="322" src="https://i-blog.csdnimg.cn/img_convert/4240133e12796eff62e4789b8e8262de.jpeg" width="400"/>
    </p>
    <p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="326" src="https://i-blog.csdnimg.cn/img_convert/54340bf607fff64893a2aced7bff1c92.jpeg" width="400"/>
    </p>
    <p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="320" src="https://i-blog.csdnimg.cn/img_convert/989438e0e407bddca0c75024cb0482bb.jpeg" width="400"/>
    </p>
    <p>
...
plt.show()</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="327" src="https://i-blog.csdnimg.cn/img_convert/0fe9e0d7e38cc84937b6eb18b5fe4102.jpeg" width="400"/>
    </p>
    <p>
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f6b796d70706364732f:61727469636c652f64657461696c732f313436303831343638" class_="artid" style="display:none">
 </p>
</div>
