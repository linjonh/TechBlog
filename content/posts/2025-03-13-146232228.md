 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code>sudo yum install -y epel-release yum-utils</code></pre>
    <p>
     2. 添加 Remi 仓库 Remi 仓库包含了丰富的 PHP 版本，你可以从中选择 PHP 7.3 进行安装。
    </p>
    <pre><code>sudo yum install -y http://rpms.remirepo.net/enterprise/remi-release-7.rpm</code></pre>
    <p>
     3. 启用 PHP 7.3 源
    </p>
    ...
    <pre><code>sudo yum install -y php php-cli php-fpm php-mysqlnd php-zip php-devel php-gd php-mcrypt php-mbstring php-curl php-xml php-pear php-bcmath php-json</code></pre>
    <p>
    ...
    <pre><code>sudo systemctl start php-fpm</code></pre>
    <p>
     设置开机自启：
    </p>
    <pre><code>sudo systemctl enable php-fpm</code></pre>
    <p>
     检查服务状态：
    </p>
    ...
    <pre><code>sudo firewall-cmd --zone=public --add-port=9000/tcp --permanent
sudo firewall-cmd --reload</code></pre>
    ...
    <pre><code class="hljs">sudo chown -R nginx:nginx /etc/nginx/deepseek</code></pre>
    <p>
     用下面的命令，来查看是否修改成功：
    </p>
    <pre><code class="hljs">ls -ahl</code></pre>
    <p>
     --------------------------------
    </p>
    <p>
    ...
    <pre><code class="hljs">sudo bash -c 'echo "&lt;?php phpinfo(); ?&gt;" &gt; /etc/nginx/deepseek/info.php'</code></pre>
    <p>
    ...
    <pre><code class="hljs"># 处理 api.php 请求
location = /api.php {
    ...
    <pre><code class="hljs"># 处理 info.php 请求
location = /info.php {
    fastcgi_pass   127.0.0.1:9000;
    fastcgi_index  index.php;
    ...
    <pre><code class="hljs">http://192.168.137.130/info.php</code></pre>
    <p>
     如果显示如下页面，则代表成功：
    </p>
    <p>
     <img alt="" height="582" src="https://i-blog.csdnimg.cn/direct/17a064e886974434a56170da07becc96.png" width="1316"/>
    </p>
    <p>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34313432323935342f:61727469636c652f64657461696c732f313436323332323238" class_="artid" style="display:none">
 </p>
</div>
