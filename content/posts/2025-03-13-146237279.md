...
&lt;/dependency&gt;</code></pre>
    <pre><code class="language-java">@ServerEndpoint("/ws")
...
public class MsgTestController {
    ...
    <pre><code class="language-bash">SEND
sendHeader:222222222
destination:/app/msg/test/1
content-length:8

这是一条消息fgfsgfg</code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f753031303335313736362f:61727469636c652f64657461696c732f313436323337323739" class_="artid" style="display:none">
 </p>
</div>
