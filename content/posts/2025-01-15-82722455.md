...
| ∫ 1 2 x d x \int\_{1}^{2}{x}dx       ∫           1       2  ​      x  d  x | \int\_{1}^{2}{x}dx |
...
| lim ⁡ n → + ∞ \lim\_{n\rightarrow+\infty}       lim           n  →  +  ∞  ​ | \lim\_{n\rightarrow+\infty} |
...
| --- | --- |
| ∑ a \sum{a}      ∑     a | \sum{a} |
| ∑ n = 1 100 a n \sum\_{n=1}^{100}{a\_n}       ∑           n  =  1       1  0  0  ​       a          n  ​ | \sum\_{n=1}^{100}{a\_n} |
...
| --- | --- |
| ∏ x \prod{x}      ∏     x | \prod{x} |
| ∏ n = 1 99 x n \prod\_{n=1}^{99}{x\_n}       ∏           n  =  1       9  9  ​       x          n  ​ | \prod\_{n=1}^{99}{x\_n} |
...
| --- | --- |
| ln ⁡ 2 \ln2      ln    2 | \ln2 |
| log ⁡ 2 8 \log\_28       lo g          2  ​     8 | \log\_28 |
