...
cd /opt mount -o loop dm8\_20240116\_x86\_rh7\_64.iso /mnt
...
数据库安装完成后，需要切换至 root 用户执行上图中的命令 /home/dmdba/dmdbms/script/root/root\_installer.sh 创建 DmAPService，否则会影响数据库备份。
