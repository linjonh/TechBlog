...
sub\_str = text[2:10:3]  # 获取索引2开始，每隔3取的字符'cfi...'
...
phone\_pattern = r'^\d{3}-\d{4}-\d{4}$'
  
print(re.match(phone\_pattern, "123-4567-8901").group())  # 匹配成功返回完整字符串
