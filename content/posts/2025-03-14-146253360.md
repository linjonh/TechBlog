...
这里给出地址：
[https://github.com/PaddlePaddle/PaddleX/blob/release/3.0-beta1/docs/installation/paddlepaddle\_install.md](https://github.com/PaddlePaddle/PaddleX/blob/release/3.0-beta1/docs/installation/paddlepaddle_install.md "https://github.com/PaddlePaddle/PaddleX/blob/release/3.0-beta1/docs/installation/paddlepaddle_install.md")
...
[https://github.com/PaddlePaddle/PaddleX/blob/release/3.0-beta1/docs/pipeline\_usage/tutorials/ocr\_pipelines/seal\_recognition.md](https://github.com/PaddlePaddle/PaddleX/blob/release/3.0-beta1/docs/pipeline_usage/tutorials/ocr_pipelines/seal_recognition.md "https://github.com/PaddlePaddle/PaddleX/blob/release/3.0-beta1/docs/pipeline_usage/tutorials/ocr_pipelines/seal_recognition.md")
他的结果都是每个样本的预测结果均为
`dict`
...
当然他的这个res.print()里面的ocr\_result字段其实还包含了一个score，是用来给识别出来的印章进行一个评分，满分为1 ，如果识别的文字不是很准确或者文字根本就没有识别出来，可以查看这个得分来进行一个评判。比如我的page6就没有被识别出文字，但是有socre。
