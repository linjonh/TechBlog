 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="346" src="https://i-blog.csdnimg.cn/direct/889778a32eb44586a6182aeb5944f89a.png" width="896"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="438" src="https://i-blog.csdnimg.cn/direct/623e3db5ccc0413fb8ff1c86ada0e360.png" width="917"/>
    </p>
    <h3>
     二、写tomcat逻辑
    </h3>
    ...
    <pre><code class="language-java">ServerSocket serverSocket = new ServerSocket(9090);
while(true){
    ...
    <pre><code class="language-java">BufferedReader bufferedReader = new BufferedReader(new                             
         InputStreamReader(socket.getInputStream()));
String s = bufferedReader.readLine();</code></pre>
    <p>
     可以看到，浏览器中第一行有请求方式和访问路径，我们是以字符串形式接收的第一行数据，所以可以通过split()方法将请求方式和访问路径分开
     <img alt="" height="802" src="https://i-blog.csdnimg.cn/direct/aa2620de7e2347eca082adf72d968ea7.png" width="1916"/>
    </p>
    <pre><code class="language-java">String[] s1 = s.split(" ");</code></pre>
    <p>
     <strong>
    ...
    <p>
     <img alt="" height="615" src="https://i-blog.csdnimg.cn/direct/251038ce0a8a4b7596d60bc9a1cb706d.png" width="1369"/>
    </p>
    <h3>
    ...
    <pre><code class="language-java">public class HttpServletRequest {
    private String url;
    ...
    <p>
     <img alt="" height="626" src="https://i-blog.csdnimg.cn/direct/37b0ebc9feb84279a55bb671c942de7e.png" width="1377"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="925" src="https://i-blog.csdnimg.cn/direct/77b89251d65a475cb59c4b4a09af130a.png" width="1825"/>
    </p>
    <p>
    ...
    <pre><code class="language-java">package com.qcby.servlet;
...
public @interface WebSocket {
    ...
    <pre><code class="language-java">import com.qcby.servlet.HttpServlet;
...
public class FindServletAllPath {
    ...
    <pre><code class="language-java">import com.qcby.httpServletRe.HttpServletRequest;
import com.qcby.httpServletRe.HttpServletResponse;
...
public class FirstServlet extends HttpServlet {
    ...
    <pre><code class="language-java">if(FindServletAllPath.map.containsKey(request.getUrl())){
...
public class ResponseUtil {
    ...
    <pre><code class="language-java">import com.qcby.ResponseUtil;
...
public class HttpServletResponse {
    ...
    <p>
     <img alt="" height="1080" src="https://i-blog.csdnimg.cn/direct/6e770c3781724bf8be85766c6fbf7734.png" width="1920"/>
    </p>
    <p>
     <img alt="" height="1080" src="https://i-blog.csdnimg.cn/direct/f9745a6f95f0419f833c291e5465c958.png" width="1920"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323430335f38373438363030362f:61727469636c652f64657461696c732f313436313137373932" class_="artid" style="display:none">
 </p>
</div>
