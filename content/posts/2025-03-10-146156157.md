...
String ciphertext = DES.encryptDES(plaintext, DES.PASSWORD\_CRYPT\_KEY);

System.out.println("明文：" + plaintext);

System.out.println("密钥：" + DES.PASSWORD\_CRYPT\_KEY);

System.out.println("密文：" + ciphertext);

System.out.println("解密后：" + DES.decryptDES(ciphertext, DES.PASSWORD\_CRYPT\_KEY));
...
note.setError\_code(StatusCode.SUCCESS\_CODE);

note.setError\_message("获取数据成功！");
...
note.setError\_code(StatusCode.ERROR\_CODE);

note.setError\_message(StatusCode.ERROR\_MESSAGE);
