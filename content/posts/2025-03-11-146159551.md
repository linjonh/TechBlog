...
下载地址https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-8.17.3-linux-x86\_64.tar.gz
...
使用ctrl + c 退出 ，查看新的配置文件注释掉cluster.initial\_master\_nodes: [“slave1”]
