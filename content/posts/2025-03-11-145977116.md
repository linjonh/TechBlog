...
* IMREAD\_COLOR 以 BGR 8 位格式加载图像。这是此处使用的
  **默认值**
  。
* IMREAD\_UNCHANGED按原样加载图像（包括 Alpha 通道，如果存在）
...
|  |  |
| --- | --- |
| COLOR\_BGR2GRAY Python：cv.COLOR\_BGR2GRAY | 在 RGB/BGR 和灰度之间转换， [颜色转换](https://docs.opencv.org/4.11.0/de/d25/imgproc_color_conversions.html#color_convert_rgb_gray "颜色转换") |