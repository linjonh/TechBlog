...
这里用的是 CentOS-7-x86\_64-DVD-2009，可自行官网下载
...
X2goclient客户机的链接：https://pan.baidu.com/s/1P6fpjQ\_kcIw\_OxU6fNZQaQ
...
在最后一行添加内容：.host:/ /mnt/hgfs/ fuse.vmhgfs-fuse allow\_other 0 0
...
1.下载地址：https://download.docker.com/linux/static/stable/x86\_64/
...
# server\_addr为FRPS服务器IP地址

server\_addr = x.x.x.x

# server\_port为服务端监听端口，bind\_port
...
local\_ip = 192.168.0.201 (本地虚拟机IP ，ifconfig查看)
...
sudo vi /etc/ssh/sshd\_config  （修改配置文件）
