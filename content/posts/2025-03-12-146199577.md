 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="480" src="https://i-blog.csdnimg.cn/direct/2f0389b9e99e496f8a454e840b1932e2.png" width="747"/>
    </p>
    <p>
    </p>
    <h3>
    ...
    <h3>
     <img alt="" height="435" src="https://i-blog.csdnimg.cn/direct/803dcaa8121c47058f691f2968502359.png" width="820">
      <strong>
       1.2 策略目录结构
      </strong>
     </img>
...
│           └── type3.te</code></pre>
    ...
    <h3>
     <img alt="" height="326" src="https://i-blog.csdnimg.cn/direct/267a5f01696a4d978fdec4e18dbc4fc2.png" width="850">
      <strong>
       1.4 基础策略文件
      </strong>
     </img>
    ...
    <h3>
     <img alt="" height="521" src="https://i-blog.csdnimg.cn/direct/7266c1e0296f46079a4045df5244d359.png" width="878">
      <strong>
       1.5 SELinux模式开关
      </strong>
     </img>
...
什么类型：tclass=file
通用公式为：allow {scontext} {tcontext}:{tclass} {denied权限}</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>allow hdcd selinuxfs:file open;</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>allow subject object:class permissions;</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>neverallow subject object:class permissions;</pre>
       </td>
      </tr>
     </tbody>
    </table>
...
')
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>10                                     u:object_r:sa_render_service:s0
...                                    ...
7002                                   u:object_r:sa_ui_appearance:s0
8001                                   u:object_r:sa_ca_daemon_service:s0
10000                                  u:object_r:sa_activation_sa:s0</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>type sa_activation_sa, sa_service_attr</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    "services" : [{
            "name" : "activation_sa",
            "path" : ["/system/bin/sa_main", "/system/profile/activation_sa.json"],
            "uid" : "system",
            "gid" : ["system", "shell"],
            "start-mode" : "boot",
            "secon" : "u:r:activation_sa:s0"
        }
    ]
}</pre>
       </td>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>type activation_sa, sadomain, domain;</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>binder_call(activation_sa, samgr);
allow activation_sa sa_activation_sa:samgr_class { get add };</pre>
       </td>
      </tr>
     </tbody>
    </table>
...
[   51.714712] audit: type=1400 audit(1502631546.543:335): avc:  denied  { search } for  pid=1443 comm="ps" name="606" dev="proc" ino=27789 scontext=u:r:sh:s0 tcontext=u:r:activation_sa:s0 tclass=dir permissive=1</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>allow sh activation_sa:dir { getattr search };
allow sh activation_sa:file { read open getattr };</pre>
       </td>
      </tr>
     </tbody>
    </table>
    ...
    <table>
     <tbody>
      <tr>
       <td>
        <pre>allow system_basic_hap_attr activation_sa:binder { call transfer };
allow system_basic_hap_attr sa_activation_sa:samgr_class { get };</pre>
       </td>
      </tr>
     </tbody>
    </table>
 ...
 <p alt="68747470733a2f2f626c6f67:2e6373646e2e6e65742f79616e675f7175616e5f79616e672f:61727469636c652f64657461696c732f313436313939353737" class_="artid" style="display:none">
 </p>
</div>
