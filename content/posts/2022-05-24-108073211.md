...
* [直播间到商详页面携带参数：room\_id](https://mp.weixin.qq.com/wxamp/broadcast/doc?type=1&token=612941116&lang=zh_CN&st=598#b3)
...
2) room\_id：点击直播组件页面里的货架商品跳转到商家小程序的商品详情页面时，会带上房间号参数
...
* cover\_img 封面图片url
* start\_time 直播计划开始时间，列表按照 start\_time 降序排列
* end\_time 直播计划结束时间
* anchor\_name 主播名
* goods 商品列表
* live\_status 直播状态   101: 直播中, 102: 未开始, 103: 已结束, 104: 禁播, 105: 暂停中, 106: 异常，107:已过期（直播状态解释可参考
