 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/2fb705973d2d44cb90623b735884756a.png#pic_center"/>
    </p>
    <h3>
     <a id="C_36">
     </a>
...
int main() {
    ...
    <pre><code class="prism language-Java">// 频道类
class TVChannel {
...
public class Main {
    ...
    <ol>
     ...
     <li>
      <strong>
       TVChannelCollection 接口
      </strong>
      ：定义了创建迭代器、获取频道数量和获取指定索引频道的方法。
     </li>
     <li>
      <strong>
       TVChannelIterator 接口
      </strong>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f46616c6c696e67476f642f:61727469636c652f64657461696c732f313436303732343730" class_="artid" style="display:none">
 </p>
</div>
