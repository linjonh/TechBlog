...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <ol>
     ...
     <li>
      第三代语言（3GL）：高级语言 特征：是设计更容易被人们所理解的程序语言告诉计算机执行什么任务和执行任务的步骤，是
      <strong>
       过程化
      </strong>
     ...
     <li>
      第四代语言（4GL）：应用语言 特征：只需要告诉计算机要执行什么任务，而不需要指定执行步骤，是
      <strong>
       非过程化
      </strong>
      的，最典型的代表就是数据库语言SQL。
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f6c617469636f:2f61727469636c652f64657461696c732f3934353032303038" class_="artid" style="display:none">
 </p>
</div>
