...
如图所示，通过定义一个类，设置route\_base基本路由，之后通过@expose定义具体的api接口及restful方法，之后通过appbuilder.add\_api将类添加，即可定义一个后端接口。
...
* 异步任务代码开发：myapp/tasks/async\_task.py
