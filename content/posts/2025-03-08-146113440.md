...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/824a17c07e364e859f71fc874cd580f1.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ec3e1ff73b854303839800b67e8de666.png"/>
     </img>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/20ff13eeb3c14bd3b4dd5e4d317ecd1e.png">
      <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/42eb53f11ad2403e84448a83d68861d9.png">
      <br/>
      登录后，会看到ENCSHV2的默认首页【设备状态】：
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0271fd38899949f5a8b6de600f3bf2fb.png"/>
     </img>
    </p>
    <p>
     第二步：进入【解码设置】功能页
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b428a86c5a564d868806afeb41d093da.png">
      <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/d042d05170034bcea563cf91c75a0947.png">
      <br/>
      选择“自定义 RTMP”并输入上一步设置好的推流地址，并点击【开始直播】即可开始推流，不出意外可以看到画面已经被送到ENCSHV2并通过HDMI输出给了导播台。
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1e73c0cb239b4877b21d7170bceab18d.png"/>
      <br/>
      查看ENCSHV2设备状态页，可以看到Net1频道接收到的视频：
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b279c173778840649d189bcfd46038cc.png"/>
     </img>
    </p>
    <h3>
     <a id="_53">
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34313438363033342f:61727469636c652f64657461696c732f313436313133343430" class_="artid" style="display:none">
 </p>
</div>
