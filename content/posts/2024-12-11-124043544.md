...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
     ...
     <ul>
      ...
      <li>
       <ul>
        ...
        <li>
         <ul>
          <li>
           <a href="#Spring_Cloud_31" rel="nofollow">
            Spring Cloud
           </a>
          </li>
          <li>
           <a href="#Dubbo_55" rel="nofollow">
            Dubbo
           </a>
          </li>
         </ul>
        ...
        <li>
         <a href="#__Service_Mesh_67" rel="nofollow">
        ...
        <li>
         <ul>
          <li>
           <a href="#Istio_84" rel="nofollow">
            Istio
           </a>
          </li>
          <li>
           <a href="#Envoy_105" rel="nofollow">
            Envoy
           </a>
          </li>
         </ul>
        ...
        <li>
         <a href="#Kubernetes__Service_Mesh___128" rel="nofollow">
      ...
      <li>
       <ul>
        ...
        <li>
         <a href="#Kubernetes__157" rel="nofollow">
          Kubernetes 之于微服务架构
         </a>
        </li>
        <li>
         <a href="#DevOps__165" rel="nofollow">
          DevOps 之于微服务架构
         </a>
        </li>
       </ul>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/7caa25c1954f3fb0b0fbebbedf9578d6.png"/>
    </p>
    <h3>
     <a id="_24">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/413ba9076e2cc4a30e58d8159581e6af.png#pic_center"/>
    </p>
    <h4>
     <a id="Spring_Cloud_31">
     </a>
     Spring Cloud
    </h4>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/ae27142cd5ac86b29aa3013921da4206.png"/>
    </p>
    <h3>
     <a id="__Service_Mesh_67">
     </a>
     下一代微服务框架 — Service Mesh
    </h3>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/756015e114c42a37fd9b213d8dc7df1f.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/42a9f32071a0194b1d0d6ff4eabd8342.png"/>
    </p>
    <h4>
     <a id="Istio_84">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/60931e68b5f7318a0895107a7ed598b8.png"/>
    </p>
    <h4>
     <a id="Envoy_105">
     </a>
    ...
    <h3>
     <a id="Kubernetes__Service_Mesh___128">
     </a>
     Kubernetes + Service Mesh = 完整的微服务框架
    </h3>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/ab27e30c9fcc4fa49a42ef0329da4649.png"/>
    </p>
    <h2>
     <a id="_147">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/831dbfb564c3f74c0807fecd55b471a8.png#pic_center"/>
    </p>
    <h3>
     <a id="Kubernetes__157">
     </a>
     Kubernetes 之于微服务架构
    </h3>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/49b6780043ac5c02ec6123e07b078667.png#pic_center"/>
    </p>
    <p>
     微服务架构 DevTestOps 开发方式，将一个大臃肿的整体产品开发队伍切分为根据不同微服务的划分的产品队伍，以及一个大的整体的平台队伍负责运营管理，两者之间通过 API 交互，做到了松耦合隔绝。
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/3749dfb649e5361c8ac5322d1a5489e1.png#pic_center"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/619ecd65ae1e97c45dde391a775a3fbe.png#pic_center"/>
    </p>
    <h2>
     <a id="___198">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a64c6e809d5de023046854308a82266c.png#pic_center"/>
    </p>
    <p>
     云原生应用架构具有下述特点：
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a4fe511db3b9f9996e685c470755d563.png#pic_center"/>
    </p>
   </div>
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f4a6d696c6b2f:61727469636c652f64657461696c732f313234303433353434" class_="artid" style="display:none">
 </p>
</div>
