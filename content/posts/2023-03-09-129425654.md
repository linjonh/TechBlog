...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    <pre><code class="language-plain">
<code class="language-plaintext">package com.xx.framework.web.service;
...
public class WebSocketService {
    ...
    <pre><code class="language-plain">
<code class="language-plaintext">server {
        listen       443 ssl;
...
            rewrite ^/ws$ / break;
    ...
    <pre><code class="hljs">类型：SecurityConfig
 
.antMatchers("/login", "/register", "/captchaImage","/rinter/**","/websocket/**").permitAll()</code></pre>
    <p>
     前端vue：
    </p>
...
&lt;/style&gt;</code></pre>
    <pre><code class="hljs">main.js文件配置：
...
mounted() {
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34303434343235332f:61727469636c652f64657461696c732f313239343235363534" class_="artid" style="display:none">
 </p>
</div>
