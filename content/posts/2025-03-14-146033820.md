 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-java">/// 设置按钮
    ...
    <pre><code class="language-java">        // 长按事件
    ...
    <pre><code class="language-java">button.setOnTouchListener(new View.OnTouchListener() {
    @Override
    ...
    <pre><code class="language-java">// 禁用按钮（变灰且不可点击）
...
&lt;/shape&gt;
    ...
    <p>
     <img src="https://i-blog.csdnimg.cn/direct/c3d4ea89b1eb4fde9f34b1a1b261c1e5.png"/>
    </p>
    <p>
    </p>
    <h3>
    ...
    <pre><code class="language-XML">&lt;selector xmlns:android="http://schemas.android.com/apk/res/android"&gt;
    &lt;!-- 按下状态 --&gt;
...
&lt;/selector&gt;</code></pre>
    ...
    <p>
     <img src="https://i-blog.csdnimg.cn/direct/1d2a1a4f297d4fe4b0016c555a1cc1ff.png"/>
    </p>
    <h3>
    </h3>
    <h3>
...
&lt;/shape&gt;</code></pre>
    ...
    <p>
     <img src="https://i-blog.csdnimg.cn/direct/e585115e290d430aa5eef21c8b621ad9.png"/>
    </p>
    <h3>
    </h3>
    <h2>
...
&lt;/selector&gt;
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f33393333393430372f:61727469636c652f64657461696c732f313436303333383230" class_="artid" style="display:none">
 </p>
</div>
