 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="734" src="https://i-blog.csdnimg.cn/direct/1577911b593d4f939d0a66d21f07534e.png" width="830"/>
    </p>
    <p>
     dp
    </p>
    ...
    <pre><code class="language-java">for (int j = 0; j &lt; k + 2; j++) {
            for (int l = 0; l &lt; 2; l++) {
...
// 初始化状态，第 j 次交易未持有股票时利润为 0
 for (int j = 1; j &lt; k + 2; j++) {
    ...
    <p>
     <img alt="" height="230" src="https://i-blog.csdnimg.cn/direct/737f520d23a04e22a7998285553988e2.png" width="1462"/>
    </p>
    <p>
...
public class StockTrading {
    ...
    <p>
     <img alt="" height="230" src="https://i-blog.csdnimg.cn/direct/ea7367e9dbd640d2b7cda1ab1d488fb5.png" width="1462"/>
    </p>
    <p>
...
public class StockTrading {
    ...
    <p>
     网课：
     <a href="https://www.bilibili.com/video/BV1ho4y1W7QK/?vd_source=16990fb82cf949bf092be3927b65898e" rel="nofollow" title="买卖股票的最佳时机【基础算法精讲 21】_哔哩哔哩_bilibili">
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323330315f38303130333737332f:61727469636c652f64657461696c732f313436313338333730" class_="artid" style="display:none">
 </p>
</div>
