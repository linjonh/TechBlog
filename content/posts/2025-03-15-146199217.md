  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/c3ab0106fec54cf5b9932d3bece27df0.png"/>
    </p>
    <p>
     其中
    </p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/b306c3e3821146189d4ab04678b47146.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/f3c33e22cff24f0f9ea0877ba4a5d378.png"/>
    </p>
    <p>
     Springboot选择3.x即可，但是不要选择不稳定版，不稳定版就是后缀带有SNAPSHOT的。
    </p>
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/e8e0359784494500a63007875c381174.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/a4566551ed854a80b7553864329d691e.png"/>
    </p>
    <p>
     如果为首次创建，会弹出一个这样的选项，一定要点，这是下载响应的依赖文件的，后续再创建就没有这个选项了。
    </p>
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/1fd976b8591e4ebab9c1db6447d26a07.png"/>
    </p>
    <p>
     创建好后，我们目录中其实有几个目录根本用不到，可以删除。
    </p>
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/d5e836ebc77a46c182d71ca511a29a3d.png"/>
    </p>
    <p>
...
public class hello {
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/c16e1e6010d74e24af35e8074b6000db.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/43407357e100466c92bf9b642661a3a7.png"/>
    </p>
    <p>
     点击send，观察响应。（注意重新启动Java程序）
    </p>
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/a8d7430e43a4417ea793189e62c86096.png"/>
    </p>
    <p>
...
public class Student {
    ...
    <pre><code class="hljs"> @RequestMapping("/r2")
    ...
    <p>
     <img alt="" height="1032" src="https://i-blog.csdnimg.cn/direct/ce2ee52f69794c5d88dae117e07e95cb.png" width="1507"/>
    </p>
    <h3>
     4.设置别名和必填/非必填参数
    </h3>
    ...
    <pre>使用@RequestParam注解</pre>
    <pre><code class="hljs"> @RequestMapping("/r3")
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f777579756e68616e673132333435362f:61727469636c652f64657461696c732f313436313939323137" class_="artid" style="display:none">
 </p>
</div>
