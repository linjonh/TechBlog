...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/714b0de45515b7de7f609cf40e6d370a.png"/>
    </p>
    <p>
     自由软件基金会是在1985年10月由理查德·斯托曼建立的美国民间非营利组织，并提出“自由软件”的概念，即要尊重用户自由，为了该自由提出了Copyleft（自由）概念，就是Copyright（版权）的反义词，该自由包含如下几点要求：
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/02ce7aa1a9ec9ced917f68fa28163d81.png"/>
    </p>
    <p>
     因此，自由软件是必须100%提供源码，但是“自由软件”并不是完全免费，发布“自由软件”的作者可以选择适当的收费（收费价格需合理），也可以免费。
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/fc3b916dc20f0cdcb6b24792275e7762.png"/>
    </p>
    <p>
     Free是自由
    </p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/66c6bb59f43b5a83c479c8ce252873e2.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/8a27d07c8913700116c60b76bcfd9d57.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/60bdfd20f72029bf7255d081cf308f7f.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/ff22c5dd4edc37a3930902b863b67b07.png"/>
    </p>
    <p>
     目前被OSI组织批准的开源协议有BSD协议、MIT协议、Apache协议等接近上百种协议，许多协议的内容差别并不大，因此常用主流的协议如下几种：
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/ab87ad2228530e4285b855cc68732a9c.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/f4aa8e75cb41c7702f2b355bb6475f78.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/55a41d233497706c295d80ff900087ae.jpeg"/>
    </p>
    <p>
     如果开源许可证要求新的软件也需要免费开源时（如GPL协议），则必须开放新软件源码；如果开源许可证没有明确要求，则用户可以选择性的开放（如BSD）。
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/48c9184979b762f2bb7c8a9748fd2588.jpeg"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/3f3c73eacfccdf1bb3206e52551d4486.png"/>
    </p>
    <p>
     <strong>
      Copyleft许可证
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/6578839919bf25698cdd6708851d26c9.png"/>
    </p>
    <p>
     <strong>
      2.2、BSD与GPL许可证
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/0764c20ad769a33569d78ee830be8864.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/b328317720a811dce4817410d58376fd.png"/>
    </p>
    <p>
     其二、在各个源代码文件头需要说明发布时间及用户权利与免责条款等。
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/03471998b031d2207c14977505f24b1b.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/34c52ea1f5472206e82632dac6f29ee7.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/3c48eca191bbaa7f53e8c381b88f454f.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/5d26c004990af05135ddc4d7754e729b.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/1f3a39cca94b45288a801f06eda011ca.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/c0093ea2760e763d90ceb59c3c560fcb.png"/>
    </p>
    <p>
     其中3个使用条件大概的意思如下表描述：
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/695914211278230278a7d0494b0be189.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/8be899a97089be721daef95c040b5619.png"/>
    </p>
    <p>
     代码A.c
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/e4801a3710c7c927c598c76820f07a97.png"/>
    </p>
    <p>
     软件B.c
    </p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/a91d133177a93cf518debfd4306639a5.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/f65f1d1ab6ed31773488421b8c167ad5.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/bb501ffa0e15e807ee92038b939e2437.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/e846532617f0fd493e78781f72c71704.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7d173b0cf46dc6f79e1efcf529b3a62f.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/274e76bc3c9a060c4fdaeb5faa5cc74d.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/655d31c19ac5f58193a2f539be810130.png"/>
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/c6c1350930d88c7382b8e295fca23a69.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/92d4632f87505c01f691b9aa4ea3bf97.png"/>
    </p>
    <p>
     代码A.c
    </p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7ce809a9c9e2764971ec2aa6cb711537.png"/>
    </p>
    <p>
     软件B.c
    </p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/323f4d0c0c4fb18caaca8ee61b5f8b1e.png"/>
    </p>
    <p>
     LGPL协议代码使用举例：
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/c2ea65779556f9f87271085c2a99adde.png"/>
    </p>
    <p>
     库文件A.h
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/8634c08479bcc09c8ffabd7af36dfec5.png"/>
    </p>
    <p>
     代码B.c
    </p>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f676f6f647368616e7a692f:61727469636c652f64657461696c732f313230353637333139" class_="artid" style="display:none">
 </p>
</div>
