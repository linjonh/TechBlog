 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-java">public class UpdateService extends Service {
...
//                return super.onStartCommand(intent, flags, startId);
    ...
    <pre>UpdateListener</pre>
    <pre><code class="language-java">public interface UpdateListener {
    /**
     * @description 开始升级
    ...
    <pre>DownLoadManager</pre>
    <pre><code class="language-java">public class DownLoadManager {
...
//                Log.i("XXXX", "run: progress:" + progress);
    ...
    <pre><code class="language-Kotlin"> var intent = Intent(this@MainActivity, UpdateService::class.java).apply {
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33383837353736372f:61727469636c652f64657461696c732f313436313136333838" class_="artid" style="display:none">
 </p>
</div>
