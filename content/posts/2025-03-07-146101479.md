 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-cpp">QT += core gui opengl</code></pre>
    <h2>
     2. 初始化 OpenGL 环境
    </h2>
    <p>
    ...
    <pre><code class="language-cpp">class MyOpenGLWidget : public QOpenGLWidget {
    Q_OBJECT
...
protected:
    ...
    <pre><code class="language-cpp">GLuint VBO, VAO;
GLfloat vertices[] = {
    // 顶点坐标，按顺序排列
    -1.0f,  1.0f, 0.0f,
    -1.0f, -1.0f, 0.0f,
...
glBindVertexArray(0);
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34333238373736332f:61727469636c652f64657461696c732f313436313031343739" class_="artid" style="display:none">
 </p>
</div>
