...
## 背景
[【MQ】一套为海量消息和高并发热点消息，提供高可用精准延时服务的解决方案](https://blog.csdn.net/Carefree\_State/article/details/145536456?spm=1001.2014.3001.5502)
...
\*\*URL：\*\*
\* `http://rabbithost:15672/api/exchanges/{virtualHost}/{exchange}?msg\_rates\_age=60&msg\_rates\_incr=5`
\*\*Method：\*\*
\* `GET`
\*\*Header：\*\*
...
@GetMapping("/exchanges/{virtualHost}/{exchange}?msg\_rates\_age=60&msg\_rates\_incr=5")
...
参考文章：[文章](https://blog.csdn.net/qq\_34623557/article/details/125490493?ops\_request\_misc=%257B%2522request%255Fid%2522%253A%2522ad419b8755f492410cd82465f56d3413%2522%252C%2522scm%2522%253A%252220140713.130102334.pc%255Fblog.%2522%257D&request\_id=ad419b8755f492410cd82465f56d3413&biz\_id=0&utm\_medium=distribute.pc\_search\_result.none-
task-blog-2~blog~first\_rank\_ecpm\_v1~rank\_v31\_ecpm-1-125490493-null-
null.nonecase&utm\_term=feign&spm=1018.2226.3001.4450)
