...
# mysql数据库连接配置路径\_关于修改数据库连接为域名的通知！
...
define('DB\_USER', 'MYSQL登录用户');

define('DB\_PASSWORD', 'MYSQL密码');

define('DB\_NAME', '数据库名');

define('DB\_HOST', '服务器地址');

2.shopex4.7

配置文件路径

\include\mall\_config.php
...
\data\sql\_config.php

配置文件信息

define('DB\_USER', '数据库用户');

define('DB\_PASSWORD', '数据库密码');

define('DB\_NAME', '数据库名');

define('DB\_HOST', '数据库地址');
