...
根据网络名称查询裸金属服务器的指定IP地址。GET /v2.1/{project\_id}/servers/{server\_id}/ips/{vpc\_id}参数说明请参见表1。请求参数无无请求样例GET https://{ECS Endpoint}/v2.1/c685484a8cc2416b97260938705deb65/servers/