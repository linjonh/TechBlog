 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <h3>
     <a id="Brief_Introduction_to_NoSQL_Databases_1">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6d17a51982e1ac6101a68e6c97807ebc.png"/>
    </p>
    <p>
     表中的几类NoSQL数据库简要介绍如下。
    </p>
