 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <pre><code>kubectl create secret generic password --from-literal=password=1qaz\!QAZ
...
password:  8 bytes
    ...
    <pre><code># 创建pod，加载将secret加载到环境变量
vi pod-secret.yaml 
kind: Pod
metadata:
  name: pod-cm
...
1qaz!QAZ/etc/secret #           # 明文密码，不安全
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f7869616f66656e676b616e672f:61727469636c652f64657461696c732f313436323331363738" class_="artid" style="display:none">
 </p>
</div>
