...
my\_list = [3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5]
...
X\_train, X\_test, y\_train, y\_test = train\_test\_split(iris['data'], iris['target'], random\_state=0)
...
s3.create\_bucket(Bucket='my-bucket')

bucket = s3.Bucket('my-bucket')

bucket.put\_object(Key='test.txt', Body=b'Hello, World!')
