 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <div style="white-space:pre-wrap; line-height:1.75; font-size:14px; display:inline!important">
     <span style="font-weight:bold">
      错误：
     </span>
    </div>
    <span style="font-size:14px; white-space:pre-wrap; text-align:justify">
    ...
    <p>
     <span style="font-size:14px; white-space:pre-wrap; color:rgb(63,63,63); font-weight:bold">
      解决方案
     </span>
     <span style="font-size:14px; white-space:pre-wrap; color:rgb(63,63,63)">
      <strong>
       ：
      </strong>
     </span>
     <span style="font-size:14px; white-space:pre-wrap; color:rgb(0,56,132)">
      <a href="https://github.com/wurstmeister/kafka-docker/issues/85" rel="noopener noreferrer" style="font-size:14px; white-space:pre-wrap" target="_blank">
       https://github.com/wurstmeister/kafka-docker/issues/85https://github.com/wurstmeister/kafka-docker/issues/85
      </a>
     </span>
    </p>
    <p>
     <span style="color:rgb(63,63,63); font-size:14px; white-space:pre-wrap">
    ...
    <div style="white-space:pre-wrap; line-height:1.75">
     <span style="font-weight:bold; color:rgb(79,79,79); text-align:justify">
      <br/>
     </span>
    </div>
    <div style="white-space:pre-wrap; line-height:1.75">
    ...
    <p>
     一种：
     <span style='margin-bottom:0px; padding:0px; border:0px; font-size:15px; line-height:inherit; font-family:Arial,"Helvetica Neue",Helvetica,sans-serif; vertical-align:baseline; color:rgb(36,39,41); text-align:left'>
      kafka.javaapi.*：
      <br/>
     </span>
    </p>
...
import kafka.producer.ProducerConfig;</code></pre>
    另一种：
    <span style='margin-bottom:0px; padding:0px; border:0px; font-size:15px; line-height:inherit; font-family:Arial,"Helvetica Neue",Helvetica,sans-serif; vertical-align:baseline; color:rgb(36,39,41); text-align:left'>
     org.apache.kafka.*:
    </span>
    ...
    <p style="text-align:left">
     <span style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif; color:#242729">
...
&lt;/dependencies&gt;</code></pre>
    <span style='color:rgb(36,39,41); font-family:Arial,"Helvetica Neue",Helvetica,sans-serif; font-size:15px'>
     <strong>
      2.1 老版本Producer：
     </strong>
    </span>
...
public class KafkaConsumerNew {
    ...
    <p style="margin-bottom:0px; padding-top:0px; padding-bottom:0px; word-wrap:break-word; word-break:normal; text-align:start; color:rgb(51,51,51); font-family:Arial; font-size:14px; line-height:26px">
    ...
    <p style="margin-bottom:0px; padding-top:0px; padding-bottom:0px; word-wrap:break-word; word-break:normal; text-align:start; color:rgb(51,51,51); font-family:Arial; font-size:14px; line-height:26px">
     <span style='margin:0px; padding:0px; font-family:"Microsoft YaHei"; font-size:18px'>
      注明出处：
      <a href="http://blog.csdn.net/lavorange/article/details/78970977" rel="noopener noreferrer" target="_blank">
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f6c61766f72616e6765:2f61727469636c652f64657461696c732f3738393730393737" class_="artid" style="display:none">
 </p>
</div>
