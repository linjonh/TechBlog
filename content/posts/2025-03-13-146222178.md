...
"linux")-glibc2.5-x86\_64.tar（可前往官网自行下载：[http://dev.mysql.com/downloads/mysql/）](http://dev.mysql.com/downloads/mysql/%EF%BC%89
...
7、解压安装包
# tar -zxvf mysql-5.7.17-linux-glibc2.5-x86\_64.tar.gz
8、将解压好的文件夹重命名为mysql
# mv 解压出来的文件夹名 mysql
9、进入安装mysql软件目录
# cd /usr/local/mysql
...
# ./mysql\_install\_db --user=mysql --basedir=/usr/local/mysql/
