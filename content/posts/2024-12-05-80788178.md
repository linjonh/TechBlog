...
# 实体类注解出错： Could not determine type for: java.util.Set, at table: adm\_role

配置了User与Role的多对多关系，启动测试，提示如下错误：

Could not determine type for: java.util.Set, at table: adm\_role, for columns: [org.hibernate.mapping.Column(users)]
