---
arturl_encode: "68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343639313630382f:61727469636c652f64657461696c732f313230333336343237"
layout: post
...
* [技术方案实践: 前端轮询方案实现 & 思考](#____0)
* [前言](#_4)
* [正文](#_10)
* + [0. 什么叫轮询？](#0__12)
  + [1. 轮询接口定义 & 数据结构](#1____16)
  + [2. 轮询方案 1: 使用定时器](#2__1__61)
  + [3. 轮询方案 2: 使用尾递归](#3__2__99)
  + - [3.1 增加取消机制](#31__144)
    - [3.2 增加组件卸载时终止轮询机制](#32__188)
    - [3.3 防止并发场景](#33__218)
  + [4. 轮询方案 3: 定制轮询引擎](#4__3__232)
  + - [4.1 核心轮询方法](#41__257)
    - [4.2 constructor 构造函数 & start、pause、continue 操作](#42_constructor___startpausecontinue__298)
    - [4.3 回调注册 onDataRecieve & 状态通知 notify](#43__onDataRecieve___notify_347)
    - [4.4 自定义钩子](#44__391)
* [结语](#_430)
* [其他资源](#_436)
* + [参考连接](#_438)
...
| Title | Link |
| --- | --- |
| fetch获取后台的数据，解析Response中的body信息解决方案 | <https://blog.csdn.net/oopxiajun2011/article/details/117123843> |
| [转] 学会fetch的用法 | <https://www.cnblogs.com/chris-oil/p/8430447.html> |
| Fetch使用方法 | <https://www.cnblogs.com/zhuzhenwei918/p/7249691.html> |
| JS 实战: 一文了解 5 种文件上传场景(React + Koa 实现) | <https://blog.csdn.net/weixin_44691608/article/details/119046366> |
| Koa 提交和接收 JSON 表单数据 | <https://blog.csdn.net/weixin_30367873/article/details/97888705> |
| fetch请求设置Content-Type失败？ | <https://segmentfault.com/q/1010000011796178/a-1020000011805467> |
| koa2 使用 koa-body 代替 koa-bodyparser 和 koa-multer | <http://www.ptbird.cn/koa-body.html> |
| fetch 发送post请求， 后台接收不到数据，body是undefined。 | <https://www.imooc.com/wenda/detail/534185> |
