...
这样通过终端创建的uni-app项目，在webstorm上node\_module目录与常规web项目是一样，整个开发期间都可以在webstorm上直接调试运行：
...
### 9. HBuilderX 与WebStorm配合开发uni\_app
...
【采用Vite方法创建】导致无法生成package.json文件,且不会自动安装node\_modules的库,为此【Hbuilder X】创建的uni-app,无法在webstorm正常编译！
...
> **更多详情参考：**
>
> [Webstorm 玩转uni-app 项目 微信小程序 移动端项目方案\_Lan.W的博客-CSDN博客](https://blog.csdn.net/LlanyW/article/details/132452734?csdn_share_tail=%7B%22type%22%3A%22blog%22%2C%22rType%22%3A%22article%22%2C%22rId%22%3A%22132452734%22%2C%22source%22%3A%22LlanyW%22%7D "Webstorm 玩转uni-app 项目 微信小程序 移动端项目方案_Lan.W的博客-CSDN博客")
