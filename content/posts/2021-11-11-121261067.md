...
使用wx.getUserInfo方法 withCredentials为true时，可获取encryptedData，里面有union\_id.后端需要进行对称解密。
...
[微信小程序——页面栈及路由跳转\_五柳-CSDN博客\_小程序中的redirect会不会进入路由栈](https://blog.csdn.net/qq_42049445/article/details/104536394 "微信小程序——页面栈及路由跳转_五柳-CSDN博客_小程序中的redirect会不会进入路由栈")
...
开发者服务器调用微信登录凭证校验API（https://api.weixin.qq.com/sns/jscode2session）获取openid和session\_key。
