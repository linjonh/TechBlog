...
##### 1.2 卷积运算的数学本质
卷积操作是CNN的核心，其数学表达式为：
![\(f \* g\)\(i, j\) = \\sum\_{m} \\sum\_{n} f\(m, n\) \\cdot g\(i - m, j -
n\)](https://latex.csdn.net/eq?%28f%20\*%20g%29%28i%2C%20j%29%20%3D%20%5Csum\_%7Bm%7D%20%5Csum\_%7Bn%7D%20f%28m%2C%20n%29%20%5Ccdot%20g%28i%20-%20m%2C%20j%20-%20n%29)
...
print("训练完成！")
torch.save(model,'data/cnn\_model.pth') # 保存训练模型
\* \* \*
#### 六、总结
