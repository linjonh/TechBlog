...
这里演示BCM\_gpio 22输出控制，串接一个220欧姆、led灯珠到GND，进行亮、灭灯控制。
...
**这里我们选择的名称为"BCM\_GPIO.22"，对应的是BCM编码"22"，wPi编码"3"，而实际的物理插槽BOARD编码是"15"。**
因此实际接线应该使用插槽编码为15的口线。

gpio工具使用的是BCM编码。设置BCM\_GPIO.22口为输出模式， 写”1”灯亮，写”0”灯灭。
