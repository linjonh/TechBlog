 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="590" src="https://i-blog.csdnimg.cn/direct/d2d01aa7c57a492a96c8db0d40732a23.png" width="1726"/>
    </p>
    <h3>
     二、环境搭建
    </h3>
...
sudo yum install jsoncpp-devel
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/da02c14ea434568534bab8a7817b05f5.png"/>
    </p>
    <h4>
     2.3 引入httplib库
    </h4>
    <p>
     ...
     即可。
     <a href="https://github.com/yhirose/cpp-httplib" title="源码地址">
      源码地址
     </a>
    </p>
    <p>
    ...
    <pre name="code"><code>git clone https://github.com/yhirose/cpp-httplib.git</code></pre>
    <h4>
     2.4 MySQL数据库
    </h4>
    <p>
    ...
    <pre name="code"><code>sudo yum install -y mariadb-server</code></pre>
    <ul>
     <li>
      安装 MariaDB 命令行客户端
     </li>
    </ul>
    <pre name="code"><code>sudo yum install -y mariadb 
</code></pre>
    <ul>
    </ul>
    <ul>
    ...
    <pre name="code"><code>sudo yum install -y mariadb-libs</code></pre>
    <p>
    ...
    <pre name="code"><code>sudo yum install -y mariadb-devel</code></pre>
    <p>
     <strong>
      安装完成后，以下是启动数据库的命令：
     </strong>
    ...
    <pre name="code"><code>systemctl start mariadb</code></pre>
    <p>
    ...
    <pre name="code"><code>systemctl enable mariadb</code></pre>
    <ul>
     <li>
      查看服务状态
     </li>
    </ul>
    <pre name="code"><code>systemctl status mariadb</code></pre>
    <p>
    ...
    <pre name="code"><code>mysql -uroot</code></pre>
    <p>
     <strong>
      更改配置：
     </strong>
    ...
    <p>
     <img alt="" height="310" src="https://i-blog.csdnimg.cn/direct/e3689ba091bb4fe4a4877e8e5c35887a.png" width="785"/>
    </p>
    <ul>
     <li>
      在
    ...
    <p>
     <img alt="" height="536" src="https://i-blog.csdnimg.cn/direct/b1f80f0ba46445f2b98a31d3045f9f9a.png" width="830"/>
    </p>
    <ul>
     <li>
      在
    ...
    <pre><code>collation-server = utf8_general_ci
init-connect = 'SET NAMES utf8'
character-set-server = utf8
sql-mode = TRADITIONAL
</code></pre>
    <p>
     <img alt="" height="753" src="https://i-blog.csdnimg.cn/direct/59282b33d2bd4473a27b4625dd6d3553.png" width="1090"/>
    </p>
    <h3>
     三、第三方库的认识
    </h3>
...
int main()
{
    ...
    <p>
     <img alt="" height="244" src="https://i-blog.csdnimg.cn/direct/78c68a65601c48d187e16ca7eae5cad3.png" width="635"/>
    </p>
    <h4>
     3.3 JsonCpp实现反序列化
    </h4>
...
int main()
{
    ...
    <p>
     <img alt="" height="184" src="https://i-blog.csdnimg.cn/direct/bd9055dacd174a4b9aa4a9f0beb2fa0a.png" width="458"/>
    </p>
    <h4>
     3.4 认识MySQL数据库的API
    </h4>
    ...
    <p>
     <a href="https://blog.csdn.net/m0_61088872/article/details/142406928?fromshare=blogdetail&amp;sharetype=blogdetail&amp;sharerId=142406928&amp;sharerefer=PC&amp;sharesource=m0_61088872&amp;sharefrom=from_link" title="MySQL:函数式编程连接MySQL库_mysqlconnection.h mysql.h-CSDN博客">
    ...
    <pre name="code"><code>gcc -o mysql_test mysql_test.c -L/usr/lib64/mysql -lmysqlclient</code></pre>
    <p>
     注意在进行编译的时候需要使用
     <code>
      -L
...
namespace aod
{
  class FileUtil
  {
    ...
    <pre name="code"><code>#include &lt;unistd.h&gt;
int access(const char *path, int amode);</code></pre>
    <p>
     其中
     <code>
      path
...
注：后三种可以使用或“|”的方式，一起使用，如W_OK|R_OK
    ...
    <pre name="code"><code>#include &lt;sys/stat.h&gt;
int stat(const char *path, struct stat *buf);</code></pre>
    <p>
     其中
     <code>
      path
    ...
    <pre name="code"><code>#include &lt;sys/stat.h&gt;
int mkdir(const char *path, mode_t mode);</code></pre>
    <h4>
     4.2 Json 工具类的设计
    </h4>
    <p>
  ...
  class JsonUtil
  {
    ...
    <pre><code>drop database if exists aod_system;
...
create table if not exists tb_video(
    ...
    <p>
     <img alt="" height="270" src="https://i-blog.csdnimg.cn/direct/0552c0aea8e6429bbac4ebe3feaf3afb.png" width="958"/>
    </p>
    <h4>
     5.2 数据管理类的设计
    </h4>
    ...
    <pre><code>#ifndef __MY_DATA__ //防止头文件重复包含
#define __MY_DATA__ 
#include "util.hpp"
#include &lt;cstdlib&gt;
#include &lt;mutex&gt;
...
bool RunModule()
{
    ...
    <pre><code class="hljs">static void Insert(const httplib::Request&amp; req, httplib::Response&amp; rsp)
{   
    ...
    <pre><code class="hljs"> static void Update(const httplib::Request&amp; req, httplib::Response&amp; rsp)
 {
    ...
    <pre><code class="hljs">static void Delete(const httplib::Request&amp; req, httplib::Response&amp; rsp)
{
    //1. 获取要删除的视频id
    ...
    <pre><code class="hljs">static void SelectOne(const httplib::Request&amp; req, httplib::Response&amp; rsp)
{
    ...
    <pre><code class="hljs">static void SelectAll(const httplib::Request&amp; req, httplib::Response&amp; rsp)
{
    ...
    <pre><code class="hljs">#include "server.hpp"
int main()
{
    ...
    <p>
     ...
     完成。
     <a href="https://www.postman.com/downloads/" rel="nofollow" title="Postman下载地址">
      Postman下载地址
     </a>
    </p>
    <p>
...
&lt;/html&gt;
    ...
    <ul>
     ...
     <li>
      <p>
       源码：
       <a href="https://gitee.com/fengxi740/learning-projects.git" rel="nofollow" title="fengxi740/学习项目">
        fengxi740/学习项目
       </a>
      </p>
     </li>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f36313038383837322f:61727469636c652f64657461696c732f313436303737363732" class_="artid" style="display:none">
 </p>
</div>
