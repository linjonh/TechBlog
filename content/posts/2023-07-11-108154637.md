 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     解决方法1：(参考文章：
     <a href="https://youtrack.jetbrains.com/issue/IDEA-209978" rel="nofollow">
    ...
    <p>
     <img alt="" height="852" src="https://i-blog.csdnimg.cn/blog_migrate/181fa8d008f65342048002b4bd3929ed.png" width="1200"/>
    </p>
    <p>
    ...
    <pre><code>-Dcompiler.ref.index=false</code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f797868363533332f:61727469636c652f64657461696c732f313038313534363337" class_="artid" style="display:none">
 </p>
</div>
