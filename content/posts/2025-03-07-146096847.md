...
[视频讲解](http://【LeetCode%20146.%20LRU%20缓存【高频面试题】】https://www.bilibili.com/video/BV1UL411c7qA?vd_source=e3deceee985042380e0ee3397ba19c28)
...
如果是单链表的话，删除一个节点时，需要从头遍历，找到**前驱节点** ，才能修改 `prev->next`，导致 **O(n) 的时间复杂度** 。
