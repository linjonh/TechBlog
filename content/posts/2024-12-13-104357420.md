...
在使用mysql replication时，有时候会担心，如果主库和备库的数据不一致，怎么办？之前，自己用过一个非常笨的办法，就是，根据生产库的中的主键，从information\_schema中，把生产库中的表和字段全部查出来，然后查询每个字段的数据，一一对比。这样的话，在数据量特别大的情况下，耗时简直恐怖。
...
[difftype\_sql.txt](http://blog.itpub.net/blog/downLoad/fileid/42678)

[difftype\_differ.txt](http://blog.itpub.net/blog/downLoad/fileid/42679)

[difftype\_unified.txt](http://blog.itpub.net/blog/downLoad/fileid/42680)

[difftype\_context.txt](http://blog.itpub.net/blog/downLoad/fileid/42681)
