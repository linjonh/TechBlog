 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="图片" height="287" src="https://i-blog.csdnimg.cn/img_convert/8266c8ed202e5d4df8ac34b1ababd7fe.png" width="1080"/>
    </p>
    <p>
     <strong>
      (2)Buffer缓冲区的4个核心概念
...
System.out.println(buffer.limit());</code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="252" src="https://i-blog.csdnimg.cn/img_convert/220803af33f6c3224b9075e75169ea4e.png" width="1080"/>
    </p>
    <p>
     下面是一个使用Buffer缓冲区的示例：
    </p>
...
一般在读取了一遍数据后，还想要再次重新读取一遍数据时，就可以使用rewind，此时limit是不变的。 </code></pre>
    ...
    <p class="img-center">
     <img alt="图片" height="259" src="https://i-blog.csdnimg.cn/img_convert/1ef6e802ae7387881cc0253e40f47768.png" width="1080"/>
    </p>
    <p>
     <strong>
      (3)基于FileChannel将数据写入磁盘文件
    ...
    <p class="img-center">
     <img alt="图片" height="486" src="https://i-blog.csdnimg.cn/img_convert/8fe90df43b92769078039694a88ae170.png" width="550"/>
    </p>
    <p>
...
public class SocketClient {
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f6d6a756e7a2f:61727469636c652f64657461696c732f313436323434373335" class_="artid" style="display:none">
 </p>
</div>
