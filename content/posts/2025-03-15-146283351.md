...
imageRepository: registry.aliyuncs.com/google\_containers
  
...
  
确保你将 imageRepository 设置为 registry.aliyuncs.com/google\_containers，这是阿里云提供的用于替代 registry.k8s.io 的镜像源。
