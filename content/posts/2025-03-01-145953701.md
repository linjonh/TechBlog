 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <pre><code>ollama run deepseek - r1:版本号
</code></pre>
    <p>
...
namespace DeepSeekAPIDemo.Controllers
{
    ...
    <pre><code>private readonly Uri _modelEndpoint = new Uri("http://localhost:11434");
...
public async Task&lt;IActionResult&gt; AskQuestion([FromBody] string question)
    ...
    <pre><code>var chatClient = new OllamaApiClient(_modelEndpoint, _modelName);
var responseBuilder = new System.Text.StringBuilder();
...
public class AIController : ControllerBase
{
    ...
    <pre><code>public class AIViewModel
{
...
@using (Html.BeginForm())
{
    ...
    <pre><code>private async void btnAsk_Click(object sender, EventArgs e)
{
...
&lt;/Window&gt;
    ...
    <pre><code>private async void btnAsk_Click(object sender, RoutedEventArgs e)
{
    ...
    <pre><code>private async void btnAsk_Click(object sender, EventArgs e)
{
    ...
    <pre><code>private static MemoryCache _cache = new MemoryCache(new MemoryCacheOptions());
...
public async Task&lt;IActionResult&gt; AskQuestion([FromBody] string question)
{
    ...
    <pre><code>private static Lazy&lt;ConnectionMultiplexer&gt; _lazyConnection = new Lazy&lt;ConnectionMultiplexer&gt;(() =&gt;
{
...
await foreach (var update in chatClient.GetStreamingResponseAsync(question))
{
    ...
    <pre><code>var questions = new[] { "问题1", "问题2", "问题3" };
...
var results = await Task.WhenAll(tasks);
    ...
    <ul>
     <li>
      <p>
       ...
       <a href="http://127.0.0.1:11434" rel="nofollow">
        127.0.0.1:11434
       </a>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343036343930382f:61727469636c652f64657461696c732f313435393533373031" class_="artid" style="display:none">
 </p>
</div>
