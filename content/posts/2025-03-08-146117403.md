...
\* 包括：对象`{}`，数组`[]`、函数`(){}`
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/9d3e542a189c47b682a6211bc6473cbf.png#pic\_center)
### 2.2 基础类型数据-Number
\* 声明定义
// 字面量声明
var num = 1;
...
xs[aa] = 2
console.log(xs)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/96216a0571284f29a163855de22c53f3.png#pic\_center)