...
langgenius/dify![](https://csdnimg.cn/release/blog\_editor\_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-
...
>
> location /e {
> proxy\_pass http://plugin\_daemon:5002;
> proxy\_set\_header Dify-Hook-Url ://;
> include proxy.conf;
> }
>
> location / {
...
## 部署ollama
Linux上安装ollama
> curl -fsSL https://ollama.com/install.sh -o ollama\_install.sh
>
> chmod +x ollama\_install.sh
>
> sh ollama\_install.sh
即可完成ollama的安装
