---
arturl_encode: "68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33373730353532352f:61727469636c652f64657461696c732f313234353131373432"
layout: post
title: "大数据之Zookeeper"
date: 2022-04-30 13:34:18 +08:00
...
* [1. Zookeeper 入门](#1_Zookeeper__1)
* + [1.1 概述](#11__2)
  + [1.2 特点](#12__7)
  + [1.3 数据结构](#13__16)
  + [1.4 应用场景](#14__20)
* [2. Zookeeper 安装](#2_Zookeeper__47)
* + [2.1 下载地址](#21__48)
  + [2.2 本地模式安装部署](#22__51)
  + [2.3 分布式安装部署](#23__80)
  + [2.4 配置参数解读](#24__159)
* [3. Zookeeper 内部原理](#3_Zookeeper__183)
* + [3.1 选举机制](#31__184)
  + [3.2 节点类型](#32__206)
  + [3.3 Stat 结构体](#33_Stat__236)
  + [3.4 监听器原理](#34__263)
  + [3.5 写数据流程](#35__280)
* [4. Zookeeper 实战](#4_Zookeeper__283)
* + [4.1 客户端命令行操作](#41__284)
  + [4.2 API 操作](#42_API__332)
  + - [4.3.1 IDEA 环境搭建](#431_IDEA__333)
    - [4.3.2 创建 ZooKeeper 客户端](#432__ZooKeeper__371)
    - [4.3.4 获取子节点并监听节点变化](#434__418)
    - [4.3.5 判断 Znode 是否存在](#435__Znode__461)
  + [4.3 监听服务器节点动态上下线案例](#43__469)
* [5 zookeeper框架](#5_zookeeper_583)
* + [5.1 org.apache.zookeeper](#51_orgapachezookeeper_584)
  + [5.2 zkclient](#52_zkclient_585)
  + - [5.2.1 简介](#521__588)
    - [5.2.2 Maven依赖](#522_Maven_602)
    - [5.2.3 ZkClient 的设计](#523_ZkClient__610)
    - [5.2.4 重要处理流程说明](#524__616)
    - [5.2.5 客户端处理变更（Watcher通知）](#525_Watcher_638)
    - [5.2.6 序列化处理](#526__669)
    - [5.2.7 ZkClient如何解决使用ZooKeeper客户端遇到的问题的呢?](#527_ZkClientZooKeeper_675)
    - [5.2.8 API介绍](#528_API_681)
    - [5.2.9 demo](#529_demo_697)
  + [5.3 Curator](#53_Curator_939)
  + - [5.3.1 简介](#531__940)
    - [5.3.2 版本问题](#532__958)
    - [5.3.3 CuratorFramework](#533_CuratorFramework_962)
    - [5.3.4 curator-recipes](#534_curatorrecipes_970)
    - [5.3.5 知识点](#535__972)
    - [5.3.6 Maven依赖](#536_Maven_980)
    - [5.3.7 api](#537_api_999)
    - [5.3.8 使用Curator高级API特性之Cache缓存监控节点变化](#538_CuratorAPICache_1119)
* [5.4 使用Curator创建/验证ACL(访问权限列表)](#54_CuratorACL_1639)
* + - [5.4.1 连通Zk时，就指定登录权限](#541_Zk_1640)
    - [5.4.2写一个把明文的账号密码转换为加密后的密文的工具类](#542_1665)
    - [5.4.3使用自定义工具类AclUtils，一次性给多个用户赋Acl权限](#543AclUtilsAcl_1688)
    - [5.4.4级联创建节点，并赋予节点操作权限](#544_1700)
    - [5.4.5读取节点数据](#545_1711)
    - [5.4.6修改具有ACL权限节点的data数据](#546ACLdata_1723)
    - [5.4.7两种方法判断node节点是否存（优先使用第一种）](#547node_1732)
* [7 分布式锁](#7__1771)
* + [7.1.重入式排它锁InterProcessMutex](#71InterProcessMutex_1788)
  + [7.2.不可重入排它锁InterProcessSemaphoreMutex](#72InterProcessSemaphoreMutex_1803)
  + [7.3.可重入读写锁InterProcessReadWriteLock 、InterProcessLock](#73InterProcessReadWriteLock_InterProcessLock_1807)
  + [7.4.多锁对象容器(多共享锁) ，将多个锁作为单个实体管理，InterProcessMultiLock、InterProcessLock](#74_InterProcessMultiLockInterProcessLock_1810)
  + [7.5.代码](#75_1817)
* [8.分布式计数器](#8_1876)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/42ff9072a85a37ddfe9ca52b0e18de8c.png)

### 1.2 特点

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/42b9ec4a284bfa870d18efb3968fc017.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/12938d7df7a78a9597ccafd086e4cbdb.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6860121ddf11ab1f41e92b0682fe1b9c.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/bb3dc27950e58ed6685259aac58763ee.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4b83a6958fd3a2349bc260f0a39ed0b3.png)
  
软负载均衡
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/db67d515f0b31e2098c4525b6659e5af.png)
  
在 Zookeeper 中记录每台服务器的访问数，让访问数最少的服务器去处理最新的客户端请求。
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6bac2e6bad0abf6911c9f70d947fb7f6.png)
...
export ZOOKEEPER\_HOME=/hadoop/zookeeper-3.5.6
...
① 将 /usr/local/zookeeper/conf 这个路径下的 zoo\_sample.cfg 修改为 zoo.cfg
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a7bb676db70518a1c5cce4075fe5ad27.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1fe8ef4d75c6ab72536f42b097c7b2e4.png)

### 3.5 写数据流程

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/57ac07316fd98ff4f81dc3e73aa07dfe.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/764f0fae19d935611709b6c389988e0c.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/56e651ad7e9513a8bfe1faca514d3663.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/249f770da5aa6424101c29c390eebc6d.png)
  
为节点注册Watcher
  
Zookeeper 原始API的三个方法：getData，getChildren、exists，ZKClient都提供了相应的代理方法，比如exists，
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e36e1ccb6b11319aa7f91d3b2ea28827.png)
  
hasListeners是看有没有与该数据节点绑定的listener

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/83c720303560a68238f23376571ffc68.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d0656f2f5d158933bedeb926d3bd1855.png)
