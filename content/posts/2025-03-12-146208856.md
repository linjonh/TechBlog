...
<div class="blog-content-box">
   ...
   <div class="markdown_views prism-dracula" id="content_views">
    ...
    <ul>
     ...
     <li>
      ...
      <br/>
      <img height="300" src="https://i-blog.csdnimg.cn/direct/98cf769b31b949958306452508cce80b.png" width="1000"/>
     </li>
    </ul>
    <h3>
     <a id="3_12">
    ...
    <img height="350" src="https://i-blog.csdnimg.cn/direct/8ed7b71880e64836a985f8ff8eeb78a4.png" width="700">
     <ul>
      <li>
       ...
       <br/>
       <img height="30" src="https://i-blog.csdnimg.cn/direct/8976fbb249a145ac8e0a28b3726901d1.png" width="200"/>
      </li>
     </ul>
     <p>
      PKM为了减少计算，k采用了分块的思想。qi每次检索可以获得2个分数，一个是kj块的分数，另一个是kj种每个key的分数，基于这2个分数相加得到一个二维逻辑查询表，从value中抽取出相应的向量进行加权求和。公式如下：
      <br/>
      <img height="60" src="https://i-blog.csdnimg.cn/direct/7de708933f54431e9adf21ecfd3310a1.png" width="500">
       <br/>
       <img height="300" src="https://i-blog.csdnimg.cn/direct/36bf918dafb447a1ae46483ec37063a8.png" width="500">
        <br/>
        <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ff00c93f121b42cda6f196a0416101fb.png"/>
       </img>
      </img>
     </p>
     <p>
     ...
     <p>
      ...
      <br/>
      <img alt="[图片]" src="https://i-blog.csdnimg.cn/direct/b62a185e15774890b3792d0afca6fa26.png"/>
     </p>
     <p>
      <strong>
       小trick
     ...
     <ul>
      ...
      <li>
       <p>
        ...
        <br/>
        <img height="80" src="https://i-blog.csdnimg.cn/direct/9a87672c27a74004b9c267a94999d0fa.png" width="700"/>
       </p>
       <p>
        但同时也带来了新问题：Srow X C X Scol的比较低效。因此，将C拆分为2个低秩矩阵：
        <br/>
        <img height="60" src="https://i-blog.csdnimg.cn/direct/abc1469372f34e7190a1b503526fc33a.png" width="800"/>
       </p>
      </li>
     </ul>
     <p>
     ...
     <img height="90" src="https://i-blog.csdnimg.cn/direct/7a58083d1e654cf4a650b7caf04f07bb.png" width="400">
      <p>
       其中λi表示u，t。
       <br/>
       τ：常量，论文采用0.15
      ...
      <ul>
       <li>
        <p>
         ...
         <br/>
         <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b9bfc9e23dbf4948bfeb473d500c93c6.png"/>
        </p>
       </li>
       <li>
        <p>
       ...
       <li>
        <p>
         ...
         <br/>
         <img height="500" src="https://i-blog.csdnimg.cn/direct/5cb011068316494eb5d406a6ede1eb82.png" width="450"/>
        </p>
       </li>
      </ul>
      <h3>
      ...
      <ul>
       <li>
        <p>
         模型对比
         <br/>
         <img alt="[图片]" src="https://i-blog.csdnimg.cn/direct/128f212ebb5245e0b4b7c6b7bd034d36.png"/>
        </p>
       </li>
       <li>
        <p>
         ...
         越稀疏loss越高，推理速度越快
         <br/>
         <img alt="[图片]" src="https://i-blog.csdnimg.cn/direct/050c06619ec24d7ba76b1668e3a500e7.png"/>
        </p>
       </li>
       <li>
        <p>
        ...
        <ul>
         <li>
          ...
          <br/>
          <img alt="[图片]" src="https://i-blog.csdnimg.cn/direct/54464e7b3ccc49e4861ec5bab3730cba.png"/>
         </li>
        </ul>
       </li>
      </ul>
      <p>
       <img alt="[图片]" src="https://i-blog.csdnimg.cn/direct/0a83835fe7a94c519560662f0ae5f0fe.png"/>
      </p>
     </img>
    </img>
   </div>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34333932323930312f:61727469636c652f64657461696c732f313436323038383536" class_="artid" style="display:none">
 </p>
</div>
