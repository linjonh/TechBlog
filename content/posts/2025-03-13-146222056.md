...
本文将基于近期发布的[模型降阶及融合仿真工具](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F\_\_biz%3DMzAxMjM1NDE5NA%3D%3D%26mid%3D2648312369%26idx%3D1%26sn%3D455e8f899907dbe65c8060145ddf8494%26scene%3D21%23wechat\_redirect
...
![](https://i-blog.csdnimg.cn/img\_convert/c15c36104189d3517ebf3d54a61f45d0.webp?x-oss-
process=image/format,png)
ROM Builder、DeepSeek辅助下的ROM Builder的差异概述
通过下图所示的流程对比示意，可以清晰明白二者在操作流程层面的差异。
![](https://i-blog.csdnimg.cn/img\_convert/afd5066e657c490dac4bcd3a72d4412e.webp?x-oss-
process=image/format,png)
复杂模型到降阶模型的流程对比
\*\*2.1 ROM Builder\*\*
\*\*\_降阶流程\_\*\*
...
![](https://i-blog.csdnimg.cn/img\_convert/d13a8f4cb9fded43daed4e9b4ece6a73.webp?x-oss-
process=image/format,png)
ROM Builder降阶流程
\*\*\_ROM Builder使用流程分析\_\*\*
...
![](https://i-blog.csdnimg.cn/img\_convert/bddc015497718387ed2e51b90324bfc0.webp?x-oss-
process=image/format,png)
...
![](https://i-blog.csdnimg.cn/img\_convert/475268c9b7ede62d0a2fe3c171d57a01.webp?x-oss-
process=image/format,png)
第二阶段流程
第二阶段DeepSeek更新提示符、参数组合、以及获取验证指标的输出示例如下：
![](https://i-blog.csdnimg.cn/img\_convert/f9943963a5631744e506543a9bb09da7.webp?x-oss-
process=image/format,png)
第二阶段示例
\*\*\_优势\_\*\*
...
![](https://i-blog.csdnimg.cn/img\_convert/9084af056951705d3f3e248de050c7d5.webp?x-oss-
process=image/format,png)
车辆动力学模型
在利用DeepSeek辅助下的ROM Builder对车辆动力学模型进行自动化降阶时，输入输出变量选取如下：
![](https://i-blog.csdnimg.cn/img\_convert/15ef936819b3b964ac27c76ad5aadb9a.webp?x-oss-
process=image/format,png)
\*\*3.2 降阶模型结果\*\*
车辆动力学模型自动化降阶过程中，DeepSeek更新参数组合、以及判断验证指标的具体输出如下：
![](https://i-blog.csdnimg.cn/img\_convert/770b142ab97626fac3febc9ac3be9eae.webp?x-oss-
process=image/format,png)
车辆动力学模型自动化降阶流程
车辆动力学模型自动化降阶流程演示
对车辆动力学模型的自动化降阶结果如下图：
![](https://i-blog.csdnimg.cn/img\_convert/805b9892326dece68fb4ccbeedfb8014.webp?x-oss-
process=image/format,png)
降阶结果对比（蓝色为原始输出，红色为预测输出）
降阶模型与原模型的输出变量的精度如下表所示：
![](https://i-blog.csdnimg.cn/img\_convert/24c7b98286f9194cb4c456516884e27f.webp?x-oss-
process=image/format,png)
\*\*3.3总结\*\*
