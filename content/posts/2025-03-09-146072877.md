 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <table>
     ...
     <tbody>
      ...
      <tr>
       ...
       <td>
        描述程序在运行时的内存布局（如代码段、数据段、栈等），用于加载和执行程序。
       </td>
      </tr>
      <tr>
       <td>
       ...
       <td>
        描述文件的节（section）信息（如代码、数据、符号表等），用于链接和调试。
       </td>
      </tr>
      <tr>
       <td>
       ...
       <td>
        实际的代码、数据、字符串表、符号表等内容。
       </td>
      </tr>
     </tbody>
    </table>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/30d8450ffb91440c8a1b3f259c5db49c.png">
      <br/>
      常见的节
     </img>
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b73b5e987bb449aa8dde5ea56cc22f6c.png"/>
    </p>
    <h3>
     <a id="22_ELFsection_49">
     </a>
    ...
    <pre><code class="prism language-cpp"><span class="token comment">// hello.c</span>
...
<span class="token comment">// code.c</span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span><span class="token string">&lt;stdio.h&gt;</span></span>
<span class="token keyword">void</span> <span class="token function">run</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{<!-- --></span>
...
<span class="token punctuation">}</span>
    ...
    <blockquote>
     <p>
      ...
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f3c27bca5f68468cba93f5f1123d3af1.png"/>
     </p>
    </blockquote>
    <blockquote>
     <p>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/315c20069b9841878788d1072a92c351.png"/>
     </p>
    </blockquote>
    <h3>
     <a id="32__85">
    ...
    <blockquote>
     ...
     <ol>
      <li>
       被程序相关的进程看到：动态库地址映射到进程的地址空间
      </li>
      <li>
       被进程调用：在地址空间中进行跳转
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/d89970f1c0c944e6b218d44ce0242b7c.png">
        <br/>
    ...
    <ol>
     ...
     <li>
      <mark>
       动态链接：这是关键的⼀步， _start 函数会调⽤动态链接器的代码来解析和加载程序所依赖的动态库（shared_libraries）。动态链接器会处理所有的符号解析和重定位，确保程序中的函数调⽤和变量访问能够正确地映射到动态库中的实际地址。
      </mark>
     </li>
     <li>
    ...
    <blockquote>
     <p>
      ...
      搜索这个缓存⽂件
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/16692c764f7a4ce2ab7c808b08dffc72.png"/>
     </p>
    </blockquote>
    <h4>
     <a id="321__118">
    ...
    <blockquote>
     <ol>
      ...
      <li>
       ...
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/142333df493341d6ac9a68ad7db933e9.png"/>
      </li>
     </ol>
    </blockquote>
    <h2>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f6d616b655f6461795f6461795f75702f:61727469636c652f64657461696c732f313436303732383737" class_="artid" style="display:none">
 </p>
</div>
