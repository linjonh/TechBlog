...
op.add\_argument('user-data-dir=C:\Documents and Settings\Administrator\Local Settings\Application Data\Google\Chrome\User Data')
  
dr=webdriver.Chrome(chrome\_options=op)
