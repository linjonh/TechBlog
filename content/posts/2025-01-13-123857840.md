...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <pre><code class="prism language-bash">- 外部 IP：一般使用Node节点的IP地址，即物理网卡的IP地址。
 ...
 - ClusterIP：Service的IP地址，此为虚拟IP地址。
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/108696a718e351ef68ebded94d385b05.png">
      <br/>
    ...
    <p>
     位置架构
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/526f1b98ddd7e6771a694538e6bc3450.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/35f1a6f05ae51c33f84d4b2deab39e18.png"/>
    </p>
    <h3>
     <a id="2NodePod_55">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/fb3d7ba24ca64c7c73800a13197fb860.png"/>
    </p>
    <h3>
     <a id="3NodePod_59">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/4ea99c9397f47a1c1523a5be6a6c915e.png"/>
    </p>
    <h2>
     <a id="Kubeproxy_63">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/cc6cd01b0eecca6ab1457182c7dafacf.png"/>
    </p>
    <ul>
     <li>
    ...
    <p>
     <a href="https://www.kubernetes.org.cn/2059.html" rel="nofollow">
      引用地址1
     </a>
     <br/>
     <a href="https://www.2cto.com/net/201702/595150.html" rel="nofollow">
      引用地址2
     </a>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34333530343839322f:61727469636c652f64657461696c732f313233383537383430" class_="artid" style="display:none">
 </p>
</div>
