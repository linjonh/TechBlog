  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <a href="https://gitee.com/link?target=https%3A%2F%2Fgn.googlesource.com%2Fgn%2F%2B%2Fmain%2Fdocs%2Freference.md" rel="nofollow" title="官网手册">
      官网手册
     </a>
     。
    </p>
...
ohos_source_set("helloworld") {
  ...
  use_exceptions = []
    ...
    <p class="img-center">
     <img alt="icon-note.gif" src="https://i-blog.csdnimg.cn/img_convert/3781e7b92747984141d5fdc4916891b9.gif"/>
    </p>
    <p>
     <strong>
      注意
    ...
    <ul>
     ...
     <li>
      Sanitizer配置详见：
      <a href="https://gitee.com/openharmony/docs/blob/master/zh-cn/device-dev/subsystems/subsys-build-reference.md#Sanitizer%E4%BD%BF%E7%94%A8%E8%AF%B4%E6%98%8E" rel="nofollow" title="Sanitizer使用说明">
       Sanitizer使用说明
      </a>
     </li>
    </ul>
...
ohos_prebuilt_static_library("helloworld") {
  ...
  license_as_sources = []
    ...
    <p class="img-center">
     <img alt="icon-note.gif" src="https://i-blog.csdnimg.cn/img_convert/c80aac83caf608612d6e674b3927ad01.gif"/>
    </p>
    <p>
     <strong>
      注意
    ...
    <p>
     hap模板详见：
     <a href="https://gitee.com/openharmony/docs/blob/master/zh-cn/device-dev/subsystems/subsys-build-gn-hap-compilation-guide.md" rel="nofollow" title=" HAP编译构建指导">
      HAP编译构建指导
     </a>
    </p>
    <h4>
    ...
    <p>
     rust模板详见：
     <a href="https://gitee.com/openharmony/docs/blob/master/zh-cn/device-dev/subsystems/subsys-build-rust-compilation.md" rel="nofollow" title=" Rust模块配置规则和指导">
      Rust模块配置规则和指导
     </a>
    </p>
    <h4>
...
ohos_sa_profile("helloworld") {
  ...
  subsystem_name = ""                  # 子系统名
    ...
    <p class="img-center">
     <img alt="icon-note.gif" src="https://i-blog.csdnimg.cn/img_convert/63870f84d7e096760c095dd78c54e180.gif"/>
    </p>
    <p>
     <strong>
      注意
    ...
    <ul>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="模块添加流程" height="603" src="https://i-blog.csdnimg.cn/img_convert/ecc03feef1115f2746f4af7ee237021a.png" width="746"/>
      </p>
     </li>
    </ul>
    <p>
   ...
   "component": {                                            # 部件属性
      ...
      <p class="img-center">
       <img alt="icon-note.gif" src="https://i-blog.csdnimg.cn/img_convert/10752e35483a132b96dbfce03b69836c.gif"/>
      </p>
      <p>
       <strong>
        注意
 ...
 "子系统名new": {                   # 新增子系统new
  ...
  },
  {
    ...
    <p>
     主要有两种编译方式，
     <a href="https://gitee.com/openharmony/docs/blob/master/zh-cn/device-dev/subsystems/subsys-build-all.md#%E7%BC%96%E8%AF%91%E5%91%BD%E4%BB%A4" rel="nofollow" title="命令行方式和hb方式">
      命令行方式和hb方式
     </a>
     ，这里以命令行方式为例。
    </p>
    ...
    <pre><code>./build.sh --build-target 模块名
</code></pre>
    <p>
     也可以编译相应产品，以编译hispark_taurus_standard为例，编译命令如下：
    </p>
    <pre><code>./build.sh --product-name hispark_taurus_standard --build-target 模块名 --ccache
</code></pre>
    <p>
     还可以编译模块所在的部件：
    </p>
    <pre><code>./build.sh --product-name hispark_taurus_standard --build-target musl --build-target 模块名 --ccache
</code></pre>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f62656e636f313938362f:61727469636c652f64657461696c732f313436313935373831" class_="artid" style="display:none">
 </p>
</div>
