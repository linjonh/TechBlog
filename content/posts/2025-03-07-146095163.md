 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-java">package com.tfjybj.library.template;
...
//        judeFileExists(file1);
    ...
    <p>
     最后上效果图：
     <br/>
     <img alt="" height="731" src="https://i-blog.csdnimg.cn/direct/da1cd64e531c49ed9e7b167d720e0253.png" width="934"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f7469677565722f:61727469636c652f64657461696c732f313436303935313633" class_="artid" style="display:none">
 </p>
</div>
