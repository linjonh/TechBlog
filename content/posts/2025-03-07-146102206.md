...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/393cd6c253514509868a48e40d872490.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/d3494530648642d281cdf1e6f0c063bd.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/9e4c1a4bf0b941a1adfbfab045e85cae.png#pic_center"/>
    </p>
    <h2>
     <a id="_vs__65">
     </a>
         ...
         <span class="katex-display">
          <span class="katex">
           <span class="katex-mathml">
            ...
            D_{\text{CurrentVolume}} = \frac{\text{TargetVolume} - \text{CurrentVolume}}{\text{FadeDurationInSeconds}}
           </span>
         ...
         <span class="katex-display">
          <span class="katex">
           <span class="katex-mathml">
            ...
            \text{CurrentVolume} += D_{\text{CurrentVolume}} \times \text{time step}
           </span>
           <span class="katex-html">
            <span class="base">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1511a4dc428342adb91a52b86275a69f.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e6852c728137440e982b05c04a9eacf5.png#pic_center"/>
    </p>
    <h2>
     <a id="dimensional_analysis_dVolume_121">
     </a>
     通过量纲分析（dimensional analysis）计算
     <code>
      dVolume
     </code>
     （音量变化量）
      ...
      <span class="katex-display">
       <span class="katex">
        <span class="katex-mathml">
         ...
         \Delta t_{\text{sample}} = \frac{1}{\text{SamplesPerSecond}}
        </span>
        <span class="katex-html">
         <span class="base">
      ...
      <span class="katex-display">
       <span class="katex">
        <span class="katex-mathml">
         ...
         dVolume = V_{\text{rate}} \times {\Delta t_{\text{sample}}}
        </span>
        <span class="katex-html">
         <span class="base">
          <span class="strut" style="height: 0.6944em;">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3e51deec91a24ed4afa69f2602f68ef5.png#pic_center"/>
    </p>
    <h2>
     <a id="Win32RefreshRate__60_161">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ff77b58ce8c64fbd822bb3124a1664be.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a8bc3c0e45bd4a37a18edb1d868f9c1b.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f74bb91762f64ef7a0bf18f291c3cb94.png#pic_center"/>
    </p>
    <h2>
     <a id="_180">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/029f4ee36fe04596bccddcaca891570e.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7b3bb0adcacb484c8a6c9f974876c8e5.png#pic_center"/>
    </p>
    <h2>
     <a id="_197">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ba8e504c3f684908b780da363535b6dd.png#pic_center"/>
    </p>
    <h2>
     <a id="linear_interpolation_206">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e39a2669a2d24a69bab69acf7d82c10c.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c45c455f1f64465fa8b0e8d70773331b.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ee507f3bdb124e3687ae4e52bbfe70cb.png#pic_center"/>
    </p>
    <h2>
     <a id="assertion_237">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/04b495df13b240d2bf4becbe093ccc7a.png#pic_center"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/fa604fa4fdb74b53bc8ed22ab5ac1e20.png#pic_center"/>
    </p>
    <h2>
     <a id="spatialization_270">
     </a>
    ...
    <h2>
     <a id="linear_interpolation_dVolume__282">
     </a>
     如果最终方案不是线性插值（linear interpolation），那
     <code>
      dVolume
     </code>
     是怎么处理的？
    ...
    <h2>
     ...
     ，我不确定为什么要在表达式中使用它，但这似乎是通常的做法……应该没什么坏处吧？
    </h2>
    <p>
    ...
    <h2>
     <a id="hardclipcompressorlimiter_tanh_softclipping_307">
     </a>
     你不能直接对音频做硬削波（hard-clip）。如果不使用压缩器（compressor）或限制器（limiter），至少需要使用
     <code>
      tanh
     </code>
     之类的软削波（soft-clipping）方法
    </h2>
    <p>
    ...
    <h2>
     <a id="audio_file_compression_310">
     </a>
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f544d313639353634383136342f:61727469636c652f64657461696c732f313436313032323036" class_="artid" style="display:none">
 </p>
</div>
