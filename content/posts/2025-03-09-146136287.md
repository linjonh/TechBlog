  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <img alt="" height="777" src="https://i-blog.csdnimg.cn/direct/fb55d7ed051243ecb6f935e13a2057c2.png" width="1318"/>
    </p>
    <p>
     <img alt="" height="316" src="https://i-blog.csdnimg.cn/direct/88d2abe6888a4c2bad231640c555743f.png" width="879"/>
    </p>
    <p>
     先通过stm32 cubemx来初始化io口，因为按下去对应的是down，因此我们默认输入口为pull-up。在这里我们选择扫描两次，每次扫描三个按键。因此我们设定两个ROW为输出口，COL1~COL3为输入口。
     <img alt="" height="965" src="https://i-blog.csdnimg.cn/direct/024baafa4f0547eba881e6071a818c44.png" width="2080">
     </img>
    </p>
    <h2>
     task.h设定
    ...
    <pre><code class="hljs">#define KB1 0x11
#define KB2 0x12
#define KB3 0x13
#define KB4 0x14
#define KB5 0x15
...
typedef enum      //oled屏幕的状态（状态机
{
    ...
    <pre><code class="hljs">void BSP_Init()
{
	OLED_Init();
  ...
  HAL_GPIO_Init(GPIOA, &amp;GPIO_InitStruct);
    ...
    <pre><code class="hljs">uint16_t Key_Num;
...
void Key_Proc()
{
    ...
    <pre><code class="hljs">case State_Key:
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f36393331383431302f:61727469636c652f64657461696c732f313436313336323837" class_="artid" style="display:none">
 </p>
</div>
