 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" height="911" src="https://i-blog.csdnimg.cn/img_convert/551b5d0eeacd67a64a84c810d56c4937.png" width="1920"/>
    </p>
    <h4>
    ...
    <p class="img-center">
     <img alt="如何开发用友BIP接口" height="911" src="https://i-blog.csdnimg.cn/img_convert/4d5833207b5092bc054c8183f211fd5e.png" width="1920"/>
    </p>
    <p>
    </p>
    <p class="img-center">
     <img alt="金蝶云星空API接口配置" height="911" src="https://i-blog.csdnimg.cn/img_convert/1fd9654c00bb0590dde1eae79b2fdf74.png" width="1920"/>
    </p>
    <h4>
     ...
     <li>
      ...
      <ul>
       <li>
        ...
        : 查询起始时间，通常使用上次同步时间（LAST_SYNC_TIME）。
       </li>
       <li>
        <code>
         end_time
  ...
  "params": {
    ...
    <p class="img-center">
     <img alt="企业微信与OA系统接口开发配置" height="911" src="https://i-blog.csdnimg.cn/img_convert/97921c1d690ea6d68f077061294a563d.png" width="1920"/>
    </p>
    <p>
    </p>
    <p class="img-center">
     <img alt="用友与SCM系统接口开发配置" height="911" src="https://i-blog.csdnimg.cn/img_convert/3104ee8208708bc4aa3a41b292f63449.png" width="1920"/>
    </p>
    <h4>
    ...
    <ol>
     ...
     <li>
      ...
      <pre><code>"modified": "{<!-- -->{modified|datetime}}"</code></pre>
     </li>
     <li>
      <p>
       <strong>
    ...
    <pre><code>"main_sql": "REPLACE INTO wdt_wms_stockin_purchase_querywithdetail (stockin_id, order_no, warehouse_no, status, modified, created_time, remark, logistics_type_name, check_time, purchase_id, purchase_no, goods_count, provider_no, provider_name, logistics_no, logistics_name, goods_amount, total_price, tax_amount, total_stockin_price, flag_name, operator_name) VALUES"</code></pre>
    <p>
    ...
    <p class="img-center">
     <img alt="用友与外部系统接口集成开发" height="911" src="https://i-blog.csdnimg.cn/img_convert/27010b0eedb094939472666ec4177b90.png" width="1920"/>
    </p>
    <p>
    </p>
    <p class="img-center">
     <img alt="钉钉与WMS系统接口开发配置" height="911" src="https://i-blog.csdnimg.cn/img_convert/c22f141d4b759679929991ddd529a574.png" width="1920"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f434c5f494e2f:61727469636c652f64657461696c732f313436323330333938" class_="artid" style="display:none">
 </p>
</div>
