...
layout: post
title: "Seata-分布式事务解决方案"
date: 2025-03-09 11:03:48 +08:00
description: "Seata--分布式事务解决方案"
keywords: "Seata--分布式事务解决方案"
categories: ['Springcloud']
tags: ['分布式', 'Springcloud']
artid: "146128977"
image:
...
**适用场景**
：强一致性需求，支持XA协议的数据库（如MySQL 5.7+）

#### 2.3 TCC模式（手动补偿）

**原理**
：Try-Confirm-Cancel 三阶段控制
...
| **排错** | 检查undo\_log表记录，查看seata-server控制台日志 |
