 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <pre><code class="hljs">import matplotlib
...
matplotlib.use('TkAgg')</code></pre>
    ...
    <p>
     最后的图像是这样的
     <br/>
     <img alt="" height="600" src="https://i-blog.csdnimg.cn/direct/7e70910f3410437d84461fa4bfc11374.png" width="900"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37343935383737352f:61727469636c652f64657461696c732f313436313032363231" class_="artid" style="display:none">
 </p>
</div>
