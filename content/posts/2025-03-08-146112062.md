 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="823" src="https://i-blog.csdnimg.cn/direct/d643ba1cb0854da3bde5aa0752f34647.png" width="1879"/>
    </p>
    <p>
     技术栈：
    </p>
    ...
    <p>
     <img alt="" height="570" src="https://i-blog.csdnimg.cn/direct/fccf296c29c54e05b0624cbad3a26521.png" width="263"/>
    </p>
    <p>
     这里只展示关键代码：
    </p>
    <pre>@File: consumers.py</pre>
...
class Message(models.Model):
    ...
    <pre>routing.py</pre>
    <pre><code class="language-python"># @File: routing.py
# desc:
...
websocket_urlpatterns = [
    ...
    <pre>@File: urls.py</pre>
    <pre><code class="language-python"># @File: urls.py
# desc:
...
urlpatterns = [
    ...
    <pre># ASGI配置文件
# asgi.py</pre>
    <pre><code class="language-python"># ASGI配置文件
# asgi.py
...
&lt;/html&gt;</code></pre>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33393230383533362f:61727469636c652f64657461696c732f313436313132303632" class_="artid" style="display:none">
 </p>
</div>
