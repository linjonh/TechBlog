 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-javascript"> // 1.创建工作簿，可以为工作簿添加属性
  ...
  return buffer
    ...
    <pre><code class="language-javascript">// import { createCellPos } from './translateNumToLetter'
...
export {
  exportExcel
    ...
    <p>
     2:
     <a href="https://blog.csdn.net/zinchliang/article/details/120262185?utm_medium=distribute.pc_relevant.none-task-blog-2~default~baidujs_baidulandingword~default-0-120262185-blog-107179708.235^v43^pc_blog_bottom_relevance_base5&amp;spm=1001.2101.3001.4242.1&amp;utm_relevant_index=2" title="luckysheet导出excel表格(使用exceljs，支持图片)-CSDN博客">
      luckysheet导出excel表格(使用exceljs，支持图片)-CSDN博客
     </a>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f36323634363834312f:61727469636c652f64657461696c732f313436323233383132" class_="artid" style="display:none">
 </p>
</div>
