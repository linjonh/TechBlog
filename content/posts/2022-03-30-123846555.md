 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-javascript">const setRem = () =&gt; {
...
export default setRem;
    ...
    <pre><code class="language-javascript">const reScreenSize = (wid) =&gt; {
    if (wid &lt;= 1400) return;
    let w = document.documentElement.clientWidth; // 获取设备的宽度
    let n =
      10 * (w / 1920) &gt; 40
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/a188a965d7872305ab9cf332ca9a7264.png"/>
    </p>
    <p>
     3000*2000 100% 设备下显示
    </p>
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/61a5b70c9e001b26037344622e92810d.png"/>
    </p>
    <blockquote>
     <p>
      开发小贴士：
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f52657365745f58632f:61727469636c652f64657461696c732f313233383436353535" class_="artid" style="display:none">
 </p>
</div>
