...
ngx_init_cycle(ngx_cycle_t *old_cycle)
{
    ...
    <h3>
     <a href="https://blog.csdn.net/weixin_41812346/article/details/146166983?sharetype=blogdetail&amp;sharerId=146166983&amp;sharerefer=PC&amp;sharesource=weixin_41812346&amp;spm=1011.2480.3001.8118" title="ngx_regex_create_conf-CSDN博客">
      ngx_regex_create_conf-CSDN博客
     </a>
    </h3>
    <hr/>
    <h4>
    ...
    <pre><code>senv = environ;</code></pre>
    <pre><code>ngx_memzero(&amp;conf, sizeof(ngx_conf_t));</code></pre>
    <pre><code>conf.args = ngx_array_create(pool, 10, sizeof(ngx_str_t));</code></pre>
    <h4>
     <a href="https://blog.csdn.net/weixin_41812346/article/details/146095766?sharetype=blogdetail&amp;sharerId=146095766&amp;sharerefer=PC&amp;sharesource=weixin_41812346&amp;spm=1011.2480.3001.8118" title="Ubuntu 下 nginx-1.24.0 源码分析 - ngx_init_cycle 函数-CSDN博客">
      Ubuntu 下 nginx-1.24.0 源码分析 - ngx_init_cycle 函数-CSDN博客
     </a>
    </h4>
    <pre><code>if (conf.args == NULL) {
        ngx_destroy_pool(pool);
        return NULL;
    }</code></pre>
    <pre><code>    conf.temp_pool = ngx_create_pool(NGX_CYCLE_POOL_SIZE, log);
    ...
    <pre><code>    conf.ctx = cycle-&gt;conf_ctx;
    conf.cycle = cycle;
    conf.pool = pool;
    conf.log = log;
    conf.module_type = NGX_CORE_MODULE;
    conf.cmd_type = NGX_MAIN_CONF;</code></pre>
    <h4>
    </h4>
    <h4>
     <a href="https://blog.csdn.net/weixin_41812346/article/details/146095766?sharetype=blogdetail&amp;sharerId=146095766&amp;sharerefer=PC&amp;sharesource=weixin_41812346&amp;spm=1011.2480.3001.8118" title="Ubuntu 下 nginx-1.24.0 源码分析 - ngx_init_cycle 函数-CSDN博客">
    ...
    <pre><code>    if (ngx_conf_param(&amp;conf) != NGX_CONF_OK) {
        environ = senv;
    ...
    <h3>
     <a href="https://blog.csdn.net/weixin_41812346/article/details/146187598?sharetype=blogdetail&amp;sharerId=146187598&amp;sharerefer=PC&amp;sharesource=weixin_41812346&amp;spm=1011.2480.3001.8118" title="ngx_conf_param -CSDN博客">
      ngx_conf_param -CSDN博客
     </a>
    </h3>
    <p>
    </p>
    <pre><code>    if (ngx_conf_parse(&amp;conf, &amp;cycle-&gt;conf_file) != NGX_CONF_OK) {
        environ = senv;
        ngx_destroy_cycle_pools(&amp;conf);
        return NULL;
    }</code></pre>
    ...
    <h3>
     <a href="https://blog.csdn.net/weixin_41812346/article/details/146192178?sharetype=blogdetail&amp;sharerId=146192178&amp;sharerefer=PC&amp;sharesource=weixin_41812346&amp;spm=1011.2480.3001.8118" title="ngx_conf_parse-CSDN博客">
      ngx_conf_parse-CSDN博客
     </a>
    </h3>
    <p>
    </p>
