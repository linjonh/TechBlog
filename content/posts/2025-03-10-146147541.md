...
> # 上传es安装包
>   
> put e:/software/elasticsearch-7.4.0-linux-x86\_64.tar.gz

**2、解压**

> # 将elasticsearch-7.4.0-linux-x86\_64.tar.gz解压到opt文件夹下. -C 大写
>   
> tar -zxvf elasticsearch-7.4.0-linux-x86\_64.tar.gz  -C /opt
...
> 1）. 解压缩：elasticsearch-7.14.0-windows-x86\_64.zip，放到软件安装目录
>   
...
> tar -zxvf kibana-7.4.0-linux-x86\_64.tar.gz -C /opt

1.3
**、修改kibana配置**

> vim /opt/kibana-7.4.0-linux-x86\_64/config/kibana.yml
...
> # 切换到kibana的bin目录
>   
> cd /opt/kibana-7.4.0-linux-x86\_64/bin
>   
> # 启动
>   
> ./kibana --allow-root
...
> 1. 解压缩：kibana-7.14.0-windows-x86\_64.zip，放到软件安装目录
>   
