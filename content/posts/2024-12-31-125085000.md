...
将\_\_APP\_\_.wxapkg放到解密包的子文件当中
...
使用wxpcxcxdec.py文件对\_\_APP\_\_.wxapkg操作，在当前目录打开Powershell
...
成功之后会生成一个dec\_\_\_APP\_\_.wxapkg文件，将该文件剪切到如图所示目录下
...
此时apkg文件夹下多出一个dec\_\_\_APP\_\_文件夹
...
参考链接：
[https://www.bilibili.com/video/BV1or4y1y7Se?spm\_id\_from=333.337.search-card.all.click](https://www.bilibili.com/video/BV1or4y1y7Se?spm_id_from=333.337.search-card.all.click "https://www.bilibili.com/video/BV1or4y1y7Se?spm_id_from=333.337.search-card.all.click")