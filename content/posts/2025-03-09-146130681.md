---
arturl_encode: "68747470733a2f2f626c6f672e63:73646e2e6e65742f636861726c69653131343531343139312f:61727469636c652f64657461696c732f313436313330363831"
layout: post
title: "从0开始的操作系统手搓教程28实现Syscall架构体系"
date: 2025-03-09 12:48:00 +08:00
...
### 需要一个syscall\_table来装载系统服务表——以getpid为例子

我们还差syscall\_table没有做，这个是interrupt.S中要求的，我们，来看看syscall\_init.c文件中，我写了啥：
...
就是这样的。allocate\_pid简单的对我们的线程pid分配做递增分配，在创建线程的时候调用allocate\_pid获取线程的pid，以及在线程子系统初始化的初始化一下锁，不然会出问题。
...
对接的就是我们在syscall\_init中写的sys\_getpid上
...
[CCOperateSystem/Documentations/11\_advanced\_kernel/11.1\_syscall\_code at main · Charliechen114514/CCOperateSystem

![](https://csdnimg.cn/release/blog_editor_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=P1C7)
https://github.com/Charliechen114514/CCOperateSystem/tree/main/Documentations/11\_advanced\_kernel/11.1\_syscall\_code](https://github.com/Charliechen114514/CCOperateSystem/tree/main/Documentations/11_advanced_kernel/11.1_syscall_code "CCOperateSystem/Documentations/11_advanced_kernel/11.1_syscall_code at main · Charliechen114514/CCOperateSystem")