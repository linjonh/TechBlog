...
打开注册表的HKEY\_LOCAL\_MACHINE/SYSTEM/CURRENTCONTROLSET/CONTROL/TERMINAL SERVER/WDS/RDPWD/TDS/TCP
  
右边键值中 PortNumber这个值修改为需要修改的端口数.注意使用十进制(例 34678)
  
3、
  
打开注册表的HKEY\_LOCAL\_MACHINE/SYSTEM/CURRENTCONTROLSET/CONTROL/TERMINAL SERVER/WINSTATIONS/RDP-TCP/
