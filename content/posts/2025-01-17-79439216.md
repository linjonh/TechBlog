...
description: "机器学习入门好文，强烈推荐转载 2017年02月01日 23:44:3064729导读：在本篇文章中"
keywords: "1. 以下哪项是机器学习中的一个基本概念,指的是模型的参数通过训练数据进行调"
categories: ['机器学习']
tags: ['无标签']
artid: "79439216"
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=79439216
    alt: "机器学习基本概念"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=79439216
featuredImagePreview: https://bing.ee123.net/img/rand?artid=79439216
---
...
<div class="blog-content-box">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <div class="article_content csdn-tracking-statistics tracking-click" style="margin:0px 0px 30px;padding:20px 30px 0px;color:rgb(69,69,69);">
     <div class="htmledit_views" style="margin-bottom:0px;padding:0px;">
      <h3 style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;margin-top:10px;padding:0px;background-color:rgb(255,255,255);">
       <a style="margin:0px;padding:0px;font-weight:400;">
        <br/>
       </a>
      </h3>
      <div style="margin:0px 0px 20px;padding:0px;color:rgb(69,69,69);background-color:rgb(255,255,255);line-height:1.8;font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;">
       <div class="rich_media_meta_list" style="margin:0px;padding:0px;">
        <span style="margin:0px;padding:0px;font-size:18px;">
         <span class="rich_media_meta rich_media_meta_text" style="margin:0px;padding:0px;font-style:italic;">
         </span>
       ...
       <div class="rich_media_content" style="margin:0px;padding:0px;">
        <blockquote style="margin-top:10px;margin-bottom:10px;border:2px solid rgb(239,239,239);padding:5px 10px;font-style:italic;">
         <p style="margin:10px auto;line-height:1.8;">
          <span style="margin:0px;padding:0px;font-size:18px;">
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="399" src="http://images.cnitblog.com/blog/673793/201412/291235317785665.png" style="border:0px;" width="844">
           <br/>
           <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="353" src="http://images.cnitblog.com/blog/673793/201411/190845269685692.jpg" style="border:0px;" width="582"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="365" src="http://images.cnitblog.com/blog/673793/201412/302230238567547.jpg" style="border:0px;" width="701"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/05289d82985e9d186fef9abdbc5b7225.png" style="border:0px;">
           <br/>
           <em>
            图4 房价的例子
           </em>
        ...
        <pre style="margin-bottom:0px;padding-right:0px;padding-left:0px;font-size:14px;line-height:22px;white-space:pre-wrap;"><span style="margin:0px;padding:0px;font-size:18px;">　　房价 = 面积 * a + b</span></pre>
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
         </span>
        </p>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="383" src="http://images.cnitblog.com/blog/673793/201412/221227224214301.png" style="border:0px;" width="796"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="490" src="http://images.cnitblog.com/blog/673793/201412/221213379524716.png" style="border:0px;" width="855">
           <br/>
           <em>
            图6 机器学习与相关学科
           </em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="364" src="http://images.cnitblog.com/blog/673793/201412/221209098439656.png" style="border:0px;" width="956">
           <br/>
           <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="322" src="http://images.cnitblog.com/blog/673793/201412/221224194835024.png" style="border:0px;" width="593">
           <br/>
           <em>
            图9 神经网络的逻辑架构
           </em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="302" src="http://images.cnitblog.com/blog/673793/201412/242108049057308.gif" style="border:0px;" width="488"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="118" src="http://images.cnitblog.com/blog/673793/201412/242108416558480.gif" style="border:0px;" width="482"/>
          <em>
           图10 LeNet的效果展示
          </em>
         </span>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="282" src="http://images.cnitblog.com/blog/673793/201412/100907289157780.png" style="border:0px;" width="359"/>
          <em>
           图11 支持向量机图例
          </em>
         </span>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          ...
          <br/>
          <img alt="" class="aligncenter" height="356" src="http://images.cnitblog.com/blog/673793/201412/100907449932793.gif" style="border:0px;" width="444"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="207" src="http://images.cnitblog.com/blog/673793/201412/242044433744851.png" style="border:0px;" width="634"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="421" src="http://images.cnitblog.com/blog/673793/201412/242049525625891.jpg" style="border:0px;" width="600"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="490" src="http://images.cnitblog.com/blog/673793/201412/301631492162492.png" style="border:0px;" width="522"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="382" src="http://images.cnitblog.com/blog/673793/201412/242050441877753.png" style="border:0px;" width="856"/>
          <br/>
          <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="338" src="http://images.cnitblog.com/blog/673793/201412/242119267339172.png" style="border:0px;" width="717"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="327" src="http://images.cnitblog.com/blog/673793/201412/301558029039641.png" style="border:0px;" width="646"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="410" src="http://images.cnitblog.com/blog/673793/201412/301611254811216.png" style="border:0px;" width="426"/>
          <br/>
          <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="349" src="http://images.cnitblog.com/blog/673793/201412/301636181536962.png" style="border:0px;" width="847"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
        ...
        <p style="margin:10px auto;line-height:1.8;">
         <span style="margin:0px;padding:0px;font-size:18px;">
          <img alt="" class="aligncenter" height="435" src="http://images.cnitblog.com/blog/673793/201412/292123300283048.png" style="border:0px;" width="696"/>
         </span>
        </p>
        <p style="margin:10px auto;line-height:1.8;">
         <em>
      ...
      <div style="margin:0px;padding:0px;color:rgb(69,69,69);background-color:rgb(255,255,255);font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;">
       <span style="margin:0px;padding:0px;font-size:18px;">
        厚积薄发，行胜于言@飞鸟各投林
       </span>
      </div>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f7a68616e6762696a756e31323330:2f61727469636c652f64657461696c732f3739343339323136" class_="artid" style="display:none">
 </p>
</div>
