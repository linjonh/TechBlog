   ...
   <div class="htmledit_views" id="content_views">
    <blockquote>
     <p>
      ...
      <a href="https://github.com/shansongliu/MuMu-LLaMA/blob/main/llama/mumu_llama.py" title="mumu_llama.py">
       mumu_llama.py
      </a>
      给出。
     </p>
    ...
    <p>
     ...
     <a href="https://huggingface.co/docs/transformers/main/model_doc/llama" rel="nofollow" title="HuggingFace">
      HuggingFace
     </a>
     。
    </p>
    ...
    <ul>
     <li>
      <a href="https://huggingface.co/M2UGen/M2UGen-MusicGen-small" rel="nofollow" title="MuMu-LlaMA 与 MusicGen Small">
       MuMu-LlaMA 与 MusicGen Small
      </a>
     </li>
     <li>
      <a href="https://huggingface.co/M2UGen/M2UGen-MusicGen-medium" rel="nofollow" title="含 MusicGen 培养基的 MuMu-LlaMA">
       含 MusicGen 培养基的 MuMu-LlaMA
      </a>
     </li>
     <li>
      <a href="https://huggingface.co/M2UGen/M2UGen-AudioLDM2" rel="nofollow" title="MuMu-LlaMA 与 AudioLDM2">
    ...
    <ul>
     <li>
      <a href="https://huggingface.co/m-a-p/MERT-v1-330M" rel="nofollow" title="MERT">
       MERT
      </a>
     </li>
     <li>
      <a href="https://huggingface.co/google/vit-base-patch16-224-in21k" rel="nofollow" title="ViT">
       ViT
      </a>
     </li>
     <li>
      <a href="https://huggingface.co/google/vivit-b-16x2-kinetics400" rel="nofollow" title="ViViT">
       ViViT
      </a>
     </li>
     <li>
      <a href="https://huggingface.co/facebook/musicgen-medium" rel="nofollow" title="MusicGen">
       MusicGen
      </a>
     </li>
     <li>
      <a href="https://huggingface.co/cvssp/audioldm2-music" rel="nofollow" title="AudioLDM 2">
       AudioLDM 2
      </a>
     </li>
    </ul>
    ...
    <ol>
     ...
     <li>
      展示MU-LLaMA生成多样化字幕的能力，支持T2M-Gen模型开发。
     </li>
    </ol>
    <p>
    ...
    <p>
     ...
     ：适配器前向计算
     <br/>
     <img alt="" height="44" src="https://i-blog.csdnimg.cn/direct/6b92e77317e3406c861c6e883aa545e3.png" width="562"/>
    </p>
    <hr/>
    <h4>
     5. 实验与结果
    ...
    <p>
     <img alt="" height="273" src="https://i-blog.csdnimg.cn/direct/46cebee1d4674ee786525eae8a392833.png" width="880"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="533" src="https://i-blog.csdnimg.cn/direct/2c03fef327864ad09ffe6e6c24615785.png" width="800"/>
    </p>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       <a href="https://github.com/crypto-code/Music-Representation-Comparison" title="在这里">
        在这里
       </a>
       查看。我们还提供了用于从
       <a href="https://www.kaggle.com/datasets/googleai/musiccaps" rel="nofollow" title="MusicCaps">
        MusicCaps
       </a>
       和
       <a href="https://mirg.city.ac.uk/codeapps/the-magnatagatune-dataset" rel="nofollow" title="MagnaTagATune">
        MagnaTagATune
       </a>
    ...
    <p class="img-center">
     <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/assets/MU-LLaMA.png">
      <img alt="" height="299" src="https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=https%3A%2F%2Fgithub.com%2Fshansongliu%2FMU-LLaMA%2Fraw%2FLLaMA-2%2Fassets%2FMU-LLaMA.png&amp;pos_id=AQWpHxvE" width="534"/>
     </a>
    </p>
    <div style="text-align:start">
     <h3>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       微调，可以
       <a href="https://huggingface.co/mu-llama/MU-LLaMA/tree/main" rel="nofollow" title="在此处">
        在此处
       </a>
    ...
    <div style="text-align:start">
     <pre class="has"><code class="language-notranslate">&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;span style="color:#1f2328"&gt;&lt;span style="color:var(--fgColor-default, var(--color-fg-default))"&gt;&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;code&gt;.
├── ...
├── MU-LLaMA                
│   ├── ckpts
│   │   │── LLaMA
...
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/requirements.txt" title="requirements.txt">
        requirements.txt
       </a>
       中给出。可以使用
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MU-LLaMA/gradio_app.py" title="gradio_app.py">
        gradio_app.py
       </a>
       运行演示。
      </span>
    ...
    <div style="text-align:start">
     <pre class="has"><code class="language-notranslate">&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;span style="color:#1f2328"&gt;&lt;span style="color:var(--fgColor-default, var(--color-fg-default))"&gt;&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;code&gt;python gradio_app.py --model ./ckpts/checkpoint.pth --llama_dir ./ckpts/LLaMA
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
     <div>
     </div>
    </div>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       <a href="https://github.com/MTG/mtg-jamendo-dataset" title="MTG-Jamendo">
        MTG-Jamendo
       </a>
       进行评估。您可以
       <a href="https://huggingface.co/datasets/mu-llama/MusicQA" rel="nofollow" title="在此处">
        在此处
       </a>
       下载生成的 MusicQA 数据集。
      </span>
...
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
    ...
    <div style="text-align:start">
     <pre class="has"><code class="language-notranslate">&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;span style="color:#1f2328"&gt;&lt;span style="color:var(--fgColor-default, var(--color-fg-default))"&gt;&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;code&gt;find ./MTT/audios -mindepth 2 -type f -exec mv -t ./MTT/audios -i '{}' +
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
     <div>
     </div>
    </div>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       通过运行
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MusicQA/musiccaps_process.py" title="musiccaps_process.py">
        musiccaps_process.py
       </a>
       、
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MusicQA/MTT_process.py" title="MTT_process.py">
        MTT_process.py
       </a>
       和
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MusicQA/MTG_process.py" title="MTG_process.py">
        MTG_process.py
       </a>
       ，您可以从每个数据集生成问答对，并通过运行
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MusicQA/generate_dataset.py" title="generate_dataset.py">
        generate_dataset.py
       </a>
       生成用于预训练、微调和评估的最终数据集。
      </span>
...
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MU-LLaMA/pretrain.sh" title="Alpaca">
        Alpaca
       </a>
    ...
    <div style="text-align:start">
     <pre class="has"><code class="language-notranslate">&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;span style="color:#1f2328"&gt;&lt;span style="color:var(--fgColor-default, var(--color-fg-default))"&gt;&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;code&gt;./pretrain.sh ./ckpts/LLaMA-2 ./configs/pretrain.yaml ./ckpts/MU-LLaMA_Pretrain
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
     <div>
     </div>
    </div>
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MU-LLaMA/pretrain.sh" title="pretrain.sh">
        pretrain.sh
       </a>
       文件中修改超参数。
      </span>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MU-LLaMA/finetune.sh" title="finetune.sh">
        finetune.sh
       </a>
       脚本结合使用。
      </span>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       ...
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/MU-LLaMA/inference.py" title="inference.py">
        inference.py
       </a>
       脚本。
      </span>
...
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
    ...
    <div style="text-align:start">
     <pre class="has"><code class="language-notranslate">&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;span style="color:#1f2328"&gt;&lt;span style="color:var(--fgColor-default, var(--color-fg-default))"&gt;&lt;span style="background-color:var(--bgColor-muted, var(--color-canvas-subtle))"&gt;&lt;code&gt;usage: generate_llama-adapter.py [-h] [--model MODEL] [--llama_dir LLAMA_DIR]
...
&lt;/code&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;</code></pre>
    ...
    <p style="text-align:start">
     <span style="color:#1f2328">
      <span style="background-color:#ffffff">
       生成后，
       <a href="https://github.com/shansongliu/MU-LLaMA/blob/LLaMA-2/ModelEvaluations/evaluate.py" title="evaluate.py">
        evaluate.py
       </a>
    ...
    <table border="1" cellspacing="0" style="width:max-content">
     <thead>
      <tr>
       <th>
        <strong>
    ...
    <ul>
     <li>
      <a href="https://github.com/OpenGVLab/LLaMA-Adapter" title="OpenGVLab/LLaMA 适配器">
       OpenGVLab/LLaMA 适配器
      </a>
     </li>
     <li>
      <a href="https://github.com/yizhilll/MERT" title="伊兹希尔/MERT">
       伊兹希尔/MERT
      </a>
     </li>
    </ul>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34323338303731312f:61727469636c652f64657461696c732f313436313038323138" class_="artid" style="display:none">
 </p>
</div>
