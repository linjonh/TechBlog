...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h3 class="post-heading" id="游戏场景分类">
     游戏场景分类
    </h3>
    <p>
    ...
    <h3 class="post-heading" id="游戏引擎推荐">
     游戏引擎推荐
    </h3>
    <p>
    ...
    <h6 class="post-heading" id="Egret">
     <a href="https://www.egret.com/index" rel="external noopener noreferrer" target="_blank">
      Egret
     </a>
    </h6>
    <p>
     <img alt="" src="http://misc.aotu.io/cssie/egret.png"/>
    </p>
    <p>
    ...
    <h6 class="post-heading" id="LayaAir">
     <a href="https://www.layabox.com/" rel="external noopener noreferrer" target="_blank">
      LayaAir
     </a>
    </h6>
    <p>
    ...
    <h6 class="post-heading" id="Pixi-js">
     <a href="http://www.pixijs.com/" rel="external noopener noreferrer" target="_blank">
      Pixi.js
     </a>
    </h6>
    <p>
    ...
    <h6 class="post-heading" id="Phaser">
     <a href="http://phaser.io/" rel="external noopener noreferrer" target="_blank">
      Phaser
     </a>
    </h6>
    <p>
    ...
    <h6 class="post-heading" id="CreateJS">
     <a href="https://www.createjs.com/" rel="external noopener noreferrer" target="_blank">
      CreateJS
     </a>
    </h6>
    <p>
     <img alt="" src="http://misc.aotu.io/cssie/createjs.jpg"/>
    </p>
    <p>
     <small style="display:block; text-align:center; color:#999">
      CreateJs 周边产品
    ...
    <h6 class="post-heading" id="Hilo">
     <a href="http://hiloteam.github.io/" rel="external noopener noreferrer" target="_blank">
      Hilo
     </a>
    </h6>
    <p>
    ...
    <h6 class="post-heading" id="Cocos2d-x">
     <a href="http://www.cocos.com/" rel="external noopener noreferrer" target="_blank">
      Cocos2d-x
     </a>
    </h6>
    <p>
    ...
    <h6 class="post-heading" id="lufylegend-js">
     <a href="http://www.lufylegend.com/" rel="external noopener noreferrer" target="_blank">
      lufylegend.js
     </a>
    </h6>
    <p>
    ...
    <h6 class="post-heading" id="Three-js">
     <a href="https://threejs.org/" rel="external noopener noreferrer" target="_blank">
      Three.js
     </a>
    </h6>
    <p>
     <img alt="" src="http://misc.aotu.io/cssie/threejs.jpg"/>
    </p>
    <p>
     <small style="display:block; text-align:center; color:#999">
      Three.js 示例案例
    ...
    <h6 class="post-heading" id="PlayCanvas">
     <a href="https://playcanvas.com/" rel="external noopener noreferrer" target="_blank">
      PlayCanvas
     </a>
    </h6>
    <p>
    ...
    <p>
     ...
     <a href="https://zhuanlan.zhihu.com/snsgame" rel="external noopener noreferrer" target="_blank">
      专栏
     </a>
     。
    </p>
    <h3 class="post-heading" id="参考资料">
     参考资料
    </h3>
    <p>
     <a href="https://www.zhihu.com/question/20079322" rel="external noopener noreferrer" target="_blank">
      目前有哪些比较成熟的 HTML5 游戏引擎？
     </a>
    </p>
    <p>
     <a href="http://www.jianshu.com/p/0469cd7b1711" rel="external noopener noreferrer" target="_blank">
      HTML5游戏引擎深度测评
     </a>
    </p>
    <p>
    ...
    感谢您的阅读，本文由
    <a href="https://aotu.io" rel="nofollow noopener noreferrer" target="_blank">
     凹凸实验室
    </a>
    版权所有。如若转载，请注明出处：凹凸实验室（
    <a href="https://aotu.io/notes/2017/12/27/h5-game-engine-recommend/" rel="nofollow noopener noreferrer" target="_blank">
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f6976616e383230383139:2f61727469636c652f64657461696c732f3738393336393633" class_="artid" style="display:none">
 </p>
</div>
