...
>
> response = dynamodb.create\_table(
>   
> TableName='UserSession',
>   
> BillingMode='PAY\_PER\_REQUEST',  # 按需计费模式
>   
> KeySchema=[
>   
> {'AttributeName': 'session\_id', 'KeyType': 'HASH'}
>   
> ],
>   
> AttributeDefinitions=[
>   
> {'AttributeName': 'session\_id', 'AttributeType': 'S'}
>   
> ]
>   
> )
...
>   
> .withPrimaryKey("product\_id", "p123")
>   
...
>   
> .withReturnValues(ReturnValue.UPDATED\_NEW);
