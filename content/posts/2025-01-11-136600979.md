...
新增系统变量，变量名是 Java\_Home ，变量值是 变量值的安装目录 ，可以点击浏览目录选择
...
新建，两个环境变量，%Java\_Home%\bin  和 %Java\_Home%\jre\bin
...
变量名是 CLASSPATH ，变量值是 .;%JAVA\_HOME%\lib\dt.jar;%JAVA\_HOME%\lib\tools.jar;
