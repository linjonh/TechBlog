 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/76314d20d20251793d048338b0f41fab.png"/>
    </p>
    <p>
     解决方法
     <br/>
...
return array(
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/6a930ddbd03d7adf462fcc812fc021bb.png"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7bf193ad3b4d0917ceb10b6efdb54961.png"/>
    </p>
    <p>
     <br/>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/30348e6e39e26c459387509e9fda5d99.png"/>
    </p>
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/65d72160d2cbf6cf9ecde6d5d17d5f65.png"/>
    </p>
    <p>
     3、重启服务，看使用的服务，选择apache重启或者nginx，服务重启后就ok了。
    </p>
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/53d60ae6f13c65b3dde8202ae5b8f30b.png"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34363034393430332f:61727469636c652f64657461696c732f313235303730363737" class_="artid" style="display:none">
 </p>
</div>
