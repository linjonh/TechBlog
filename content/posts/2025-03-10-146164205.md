 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="186" src="https://i-blog.csdnimg.cn/direct/4e024d5fd49042ca8371cef7433a9b38.png" width="1117"/>
    </p>
    <p>
     其中：
     <br/>
    ...
    <p>
     <img alt="" height="156" src="https://i-blog.csdnimg.cn/direct/c9585aee35044bafac44c5f8618e5d82.png" width="1254"/>
    </p>
    <p>
     其中：
     <br/>
     <img alt="" height="154" src="https://i-blog.csdnimg.cn/direct/ebe5c43c37b540fd9be817affe99b1e0.png" width="1503">
      。
     </img>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="120" src="https://i-blog.csdnimg.cn/direct/bd2b2852ef3e4df190f0ed321df62a3b.png" width="1452"/>
    </p>
    <p>
     其中：
     <img alt="" height="140" src="https://i-blog.csdnimg.cn/direct/e81826e658614fcaa658f16c791d4ea8.png" width="1264"/>
    </p>
    <h4>
     3. 贝叶斯算法的实现步骤
    </h4>
...
train_test_split(x_whole,y_whole,test_size=0.2,random_state=1000)
    ...
    <pre><code class="language-python"># 下采样解决样本不均衡问题
...
data_c = pd.concat([positive_eg, negative_eg])
    ...
    <pre><code class="language-python"># 使用下采样后的数据进行训练
x_train = data_c.drop(0, axis=1)
y_train = data_c.iloc[:,-1]
new_x_train, new_x_test, new_y_train, new_y_test =\
 train_test_split(x_train_w ,y_train_w , test_size=0.3, random_state=0)</code></pre>
    <h5>
     3.4 构建模型并训练
    </h5>
...
print(metrics.classification_report(new_y_test,test_predicted))</code></pre>
    <h4>
    </h4>
    <h4>
     4. 贝叶斯算法的优缺点
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f36383131343433392f:61727469636c652f64657461696c732f313436313634323035" class_="artid" style="display:none">
 </p>
</div>
