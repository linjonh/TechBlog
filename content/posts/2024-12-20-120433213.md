...
**相关链接：**
[最简单的基于FFmpeg的封装格式处理：视音频复用器（muxer）\_雷霄骅(leixiaohua1020)的专栏-CSDN博客\_muxer](https://blog.csdn.net/leixiaohua1020/article/details/39802913 "最简单的基于FFmpeg的封装格式处理：视音频复用器（muxer）_雷霄骅(leixiaohua1020)的专栏-CSDN博客_muxer")