---
layout: post
title: "Linux-find命令在目录中查找文件超详解"
date: 2024-11-30 18:44:03 +0800
description: "find 是Linux中强大的搜索命令，不仅可以按照文件名搜索文件，还可以按照权限、大小、时间、in"
keywords: "使用find命令查找根目录下的文件"
categories: ['未分类']
tags: ['无标签']
artid: "104068510"
image:
  path: https://api.vvhan.com/api/bing?rand=sj&artid=104068510
  alt: "Linux-find命令在目录中查找文件超详解"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=104068510
featuredImagePreview: https://bing.ee123.net/img/rand?artid=104068510
---
...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     ...
     中强大的搜索命令，不仅可以按照文件名搜索文件，还可以按照权限、大小、时间、inode 号等来搜索文件。但是 find 命令是直接在硬盘中进行搜索的，如果指定的搜索范围过大，find命令就会消耗较大的系统资源，导致服务器压力过大。所以，在使用 find 命令搜索时，不要指定过大的搜索范围。
     <br/>
     <br/>
     find 命令的基本信息如下：
    </p>
    ...
    <p>
     <br/>
     <img alt="" class="has" src="https://i-blog.csdnimg.cn/blog_migrate/c0e813c4cabfe4904c1430d0b9805f1f.png">
      <br/>
      图 1 find时间轴
     </img>
    </p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f33393839313033302f:61727469636c652f64657461696c732f313034303638353130" class_="artid" style="display:none">
 </p>
</div>
