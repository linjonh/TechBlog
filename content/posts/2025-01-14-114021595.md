...
5. 设置JAVA\_HOME——变量名填写：JAVA\_HOME设置JAVA\_HOME
...
写：.;%JAVA\_HOME%\jre1.8.0\_191\lib设置CLASSPATH

7. 设置Path

找到系统变量Path，新建值：%JAVA\_HOME%\jre1.8.0\_191\lib设置Path
