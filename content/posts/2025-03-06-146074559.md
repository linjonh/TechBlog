 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-cpp">uint8_t Serial_TxPacket[4];
uint8_t Serial_RxPacket[4];
uint8_t Serial_RxFlag;//接收一个数据包就置Flag</code></pre>
    <p>
     2.封装一个Serial_SendPacket函数，我想要的效果是，调用一下这个函数，TxPacket数组的4个数据就会自动加上包头包尾发送出去
    </p>
    <pre><code class="language-cpp">void Serial_SendPacket(void)
{
    ...
    <pre><code class="language-cpp">    Serial_TxPacket[0]=0x02;
	Serial_TxPacket[1]=0x04;
	Serial_TxPacket[2]=0x06;
	Serial_TxPacket[3]=0x08;</code></pre>
    <p>
     4.结果,按复位发送数据
    </p>
    <p>
     <img alt="" height="844" src="https://i-blog.csdnimg.cn/direct/65a9813c61674e84b8fb949439da0b09.png" width="1260"/>
    </p>
    <h2>
     二：HEX数据包接收
    </h2>
    ...
    <p>
     <img alt="" height="655" src="https://i-blog.csdnimg.cn/direct/869d5a76eaf243f9ade273e0e5cceec7.png" width="1200"/>
    </p>
    <p>
...
void USART1_IRQHandler(void)
{
    ...
    <p>
     <img alt="" height="919" src="https://i-blog.csdnimg.cn/direct/e0d9671bea3140d59dd4dd6b6644623a.jpeg" width="1277"/>
    </p>
    <p>
    </p>
    <h2>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f727879303732372f:61727469636c652f64657461696c732f313436303734353539" class_="artid" style="display:none">
 </p>
</div>
