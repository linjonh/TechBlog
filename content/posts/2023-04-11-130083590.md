...
> 参考文章：
> [(33条消息) 用python自带的tkinter做游戏（一）—— 贪吃蛇 篇\_python tkinter游戏\_Juni Zhu的博客-CSDN博客](https://blog.csdn.net/znix1116/article/details/116102909 "(33条消息) 用python自带的tkinter做游戏（一）—— 贪吃蛇 篇_python tkinter游戏_Juni Zhu的博客-CSDN博客")
