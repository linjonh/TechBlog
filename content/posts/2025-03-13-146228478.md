 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="hljs">$ python -m pip install --user pygame </code></pre>
    <h4>
     1.1开始游戏项目
    </h4>
    <h5>
    ...
    <pre><code class="language-python">//首先，导入模块sys 和pygame.模块pygame 包含开发游戏所需的功能。玩家退
...
if __name__ == '__main__':
    ...
    <p>
     <img alt="" height="542" src="https://i-blog.csdnimg.cn/direct/5312f6fe159740d39383ed85016f05a2.png" width="779"/>
    </p>
    <h5>
     1.1.2设置背景色
    </h5>
...
if __name__ == '__main__':
    ...
    <h4>
     <img alt="" height="707" src="https://i-blog.csdnimg.cn/direct/fcc9b2310c1e489eb95338548d66ee6e.png" width="1263">
      1.2添加飞船图像
     </img>
    </h4>
    <p>
...
if __name__ == '__main__':
    ...
    <p>
     <img alt="" height="743" src="https://i-blog.csdnimg.cn/direct/0b6c17be448f443dbf804a615cbc928f.png" width="1279"/>
    </p>
    <h4>
    ...
    <pre><code class="language-python">    def _check_events(self):
        """响应按键和鼠标事件"""
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
    ...
    <pre><code class="language-python">    def __init__(self,ai_game):
        """初始化飞船并设置其初始位置"""
...
class Bullet(Sprite):
    ...
    def __init__(self,ai_game):
        ...
        #存储用小数表示的子弹位置
        self.y=float(self.rect.y)                               #3</code></pre>
    <p>
    ...
    <pre><code class="language-python"> def __init__(self): 
        --snip-- 
        self.ship = Ship(self) 
        self.bullets = pygame.sprite.Group() </code></pre>
    <p>
     然后在while 循环中更新子弹的位置：
    </p>
    <p>
  ...
  --snip--</code></pre>
    ...
    <pre><code class="language-python"> # 子弹设置
        self.bullet_speed = 1.0
        self.bullet_width = 3
        self.bullet_height = 15
        self.bullet_color = (252, 170, 60)
        self.bullets_allowed = 3 </code></pre>
    <p>
    ...
    <pre><code class="language-python"> def _update_bullets(self): 
        """更新子弹的位置并删除消失的子弹。""" 
        # 更新子弹的位置。 
        self.bullets.update() 
        # 删除消失的子弹。 
    ...
    <h4>
     效果图
     <img alt="" height="759" src="https://i-blog.csdnimg.cn/direct/22b5e54ba70c45d1bb3bd10b222bfa4c.png" width="1296"/>
    </h4>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37343333333235302f:61727469636c652f64657461696c732f313436323238343738" class_="artid" style="display:none">
 </p>
</div>
