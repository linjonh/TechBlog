  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     ...
     ”组合（比如：“跨境电商支付系统测试专家，覆盖多币种汇率异常场景”）。
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/30c492f75ca34c1cb4541383e8f0b517.png"/>
    </p>
    <p>
    ...
    <p>
     点击“上传附件”图标，直接上传需求文档。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/80957c0f8a8b40c5a94726a9e84af2a5.png">
      <br/>
      分析需求文档：
     </img>
    </p>
    <pre><code class="prism language-html">你是一个拥有十年测试经验的资深测试工程师，请解析我提供的需求文档的核心功能点，输出结构化测试分析框架：
1. 识别所有功能模块及其边界条件；
...
- 生成汇率换算流程图（包含失败重试机制）；
    ...
    <pre><code class="prism language-html">#指令模板将
...
3. 自动化适配："生成Robot Framework/Pytest脚本模板"
    ...
    <pre><code class="prism language-html">根据以下需求文档生成全场景测试覆盖矩阵：
1. 正向场景：所有功能正常流程组合；
...
- 性能：建议100并发测试支付接口响应时间
    ...
    <pre><code class="prism language-html"># 边界值测试
...
- XSS攻击：输入<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript"><span class="token function">alert</span><span class="token punctuation">(</span><span class="token punctuation">)</span></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">&gt;</span></span>校验过滤机制
...
- API版本：同时验证v1和v2接口
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34303330333832322f:61727469636c652f64657461696c732f313436313731353531" class_="artid" style="display:none">
 </p>
</div>
