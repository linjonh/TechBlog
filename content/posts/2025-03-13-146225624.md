 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-bash">$perl -c run_PMseq.V8.pl
...
run_PMseq.V8.pl syntax OK</code></pre>
    <p>
     检查的时候发现这个错误。
    </p>
    <p>
    ...
    <p>
     <img alt="" height="321" src="https://i-blog.csdnimg.cn/direct/240d911346e042b298b85c59dbd1d927.png" width="1162"/>
    </p>
    <p>
    ...
    <pre><code class="language-perl">package Add_mismatch;</code></pre>
    <p>
     原因是，我在  run_PMseq.V8.pl脚本里面这样调用的：
    </p>
    <pre><code class="language-perl">use Map_PMDB;
use Add_mismatch;</code></pre>
    <p>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f753031343231303034382f:61727469636c652f64657461696c732f313436323235363234" class_="artid" style="display:none">
 </p>
</div>
