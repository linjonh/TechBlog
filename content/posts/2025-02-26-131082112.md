...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-dracula" id="content_views">
     ...
     <ul>
      ...
      <li>
       <ul>
        ...
        <li>
         <a href="#PGCUGCAIGC_25" rel="nofollow">
          发展梳理：从PGC到UGC再到AIGC
         </a>
        </li>
        <li>
         <ul>
          <li>
           <a href="#PGC_26" rel="nofollow">
            PGC：企业和平台是内容创作的主体
           </a>
          </li>
          <li>
           <a href="#UGC_29" rel="nofollow">
            UGC：用户成为内容创作主体
           </a>
          </li>
          <li>
           <a href="#AIGC_32" rel="nofollow">
            AIGC
           </a>
          </li>
         </ul>
        ...
        <li>
         <ul>
          <li>
           <a href="#AIAI_36" rel="nofollow">
            AI图像：AI绘画趋于普遍
           </a>
          </li>
          <li>
           <a href="#AIAIMusicLM_40" rel="nofollow">
      ...
      <li>
       <ul>
        <li>
         <a href="#AI_62" rel="nofollow">
          字节跳动：发力AI视频生成
         </a>
        </li>
        <li>
         <a href="#AIAI_71" rel="nofollow">
          百度：全栈布局AI技术，以AI虚拟数字人发力
         </a>
        </li>
        <li>
         <a href="#AIGC_74" rel="nofollow">
          谷歌：推出多种AIGC产品
         </a>
        </li>
       </ul>
      ...
      <li>
       <ul>
        ...
        <li>
         <ul>
          <li>
           <a href="#OmniverseAI_178" rel="nofollow">
            Omniverse平台：AI实现内容生产
           </a>
          </li>
          <li>
           <a href="#Magic3D3D_197" rel="nofollow">
            Magic3D：3D模型智能生成应用
           </a>
          </li>
         </ul>
      ...
      <li>
       <ul>
        ...
        <li>
         <ul>
          <li>
           <a href="#Dreamwriter_209" rel="nofollow">
            文字生成：腾讯推出自动化新闻撰稿机器人Dreamwriter
           </a>
          </li>
          <li>
           <a href="#MetaMakeAVideo_218" rel="nofollow">
            视频生成：Meta公司推出文字生成短视频系统Make-A-Video
           </a>
          </li>
          <li>
           <a href="#AI_219" rel="nofollow">
      ...
      <li>
       <ul>
        <li>
         <a href="#AIAIGC_231" rel="nofollow">
          技术趋势：AI技术迭代深化AIGC发展
         </a>
        </li>
        <li>
         <ul>
          <li>
           <a href="#AIGC_234" rel="nofollow">
            深度学习技术迭代，AIGC内容产出更加智能
           </a>
          </li>
          <li>
           <a href="#AIGC_243" rel="nofollow">
            多模态技术发展，AIGC模型通用化能力更强
           </a>
          </li>
          <li>
           <a href="#MaaS_248" rel="nofollow">
            MaaS有望成为现实
           </a>
          </li>
         </ul>
        ...
        <li>
         <ul>
          <li>
           <a href="#To_BAIGC_254" rel="nofollow">
            To B端的AIGC产品丰富，赋能企业发展
           </a>
          </li>
          <li>
           <a href="#To_CAIGC_255" rel="nofollow">
    ...
    <blockquote>
     <p>
      <img alt="[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-jGIAEtJ0-1686103924629)(https://note.youdao.com/yws/res/86163/WEBRESOURCE9eece921db05e86c43e7fb175ff93637)]" src="https://i-blog.csdnimg.cn/blog_migrate/a41222aa3337619c6503381aef434f9f.png"/>
     </p>
    </blockquote>
    <p>
    ...
    <blockquote>
     <p>
      <img alt="[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-nmFdEzHd-1686103924629)(https://note.youdao.com/yws/res/86267/WEBRESOURCE0d1d3ae3a1ac7441121867c45b82c103)]" src="https://i-blog.csdnimg.cn/blog_migrate/2b516a89d17cbdb95d5439679d42befe.png"/>
     </p>
    </blockquote>
    <h4>
     <a id="_264">
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f7a656e6772616f6c692f:61727469636c652f64657461696c732f313331303832313132" class_="artid" style="display:none">
 </p>
</div>
