...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <a href="https://link.zhihu.com/?target=http%3A//VB.NET" rel="nofollow" title="http://VB.NET">
      http://VB.NET
     </a>
    ...
    <p>
     ...
     <a href="https://link.zhihu.com/?target=http%3A//ASP.NET" rel="nofollow" title="http://ASP.NET">
      http://ASP.NET
     </a>
     Core2.0和 Entity Framework Core 2.0。
    </p>
    <p>
     <img alt="" height="369" src="https://i-blog.csdnimg.cn/blog_migrate/d03807438a7854bc1ab602245ddb3711.png" width="849"/>
    </p>
    <h4>
     <strong>
      .NET Core的特点
    ...
    <p>
     ...
     <a href="https://link.zhihu.com/?target=https%3A//github.com/dotnet/core" title="https://github.com/dotnet/core">
    ...
    <p>
     <a href="https://link.zhihu.com/?target=https%3A//docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-7" rel="nofollow" title="https://docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-7">
      https://docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-7
     </a>
    </p>
    <p>
     <a href="https://link.zhihu.com/?target=https%3A//docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-8" rel="nofollow" title="https://docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-8">
    ...
    <p>
     ...
     <a href="https://link.zhihu.com/?target=https%3A//www.c-sharpcorner.com/article/visual-studio-2019-new-features/" rel="nofollow" title="https://www.c-sharpcorner.com/article/visual-studio-2019-new-features/">
      https://www.c-sharpcorner.com/article/visual-studio-2019-new-features/
     </a>
    </p>
    <h4>
     <strong>
    ...
    <p>
     <a href="https://link.zhihu.com/?target=https%3A//docs.microsoft.com/en-us/aspnet/core/host-and-deploy/docker/%3Fview%3Daspnetcore-2.2" rel="nofollow" title="https://docs.microsoft.com/en-us/aspnet/core/host-and-deploy/docker/?view=aspnetcore-2.2">
    ...
    <p>
     <img alt="" height="508" src="https://i-blog.csdnimg.cn/blog_migrate/0dbc4f99a7afc801399353bf478911ee.png" width="692"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <ul>
     <li>
      .NET 5.0 已经部署到
      <a href="https://link.zhihu.com/?target=http%3A//dot.net" rel="nofollow" title="http://dot.net">
       http://dot.net
      </a>
      和
      <a href="https://link.zhihu.com/?target=http%3A//Bing.com" rel="nofollow" title="http://Bing.com">
       http://Bing.com
      </a>
      托管数月，已经得到了实战检验。
     </li>
    ...
    <ol>
     <li>
      <p>
       跨平台：.NET Core 是跨平台的，可以在 Windows、Linux 和 macOS 上运行，这意味着您可以创建一次应用程序并在多个操作系统上运行它。
      </p>
     </li>
     <li>
      <p>
       高效性和可扩展性：.NET Core 具有高效性和可扩展性，在处理高负载应用程序时效果很好，它还具有一些性能调整和增强，可以提高应用程序的性能。
      </p>
     </li>
     <li>
      <p>
       开源且社区支持：.NET Core 是开源的，这意味着您可以在 GitHub 上查看源代码、讨论问题、提出建议和参与开发。同时，有一个强大的社区支持 .NET Core，你可以从社区中获取帮助和支持。
      </p>
     </li>
     <li>
      <p>
       安全性：.NET Core 具有内置的安全功能，可保护应用程序免受许多常见的 Web 安全漏洞。
      </p>
     </li>
    </ol>
    <p>
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f5a79724a61766173637269702f:61727469636c652f64657461696c732f313331333631313936" class_="artid" style="display:none">
 </p>
</div>
