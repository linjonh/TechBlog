...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a08ead5e785e4b6180740219387c7fff.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/162bbd1943ea4b24aa96996ff15e244a.png"/>
    </p>
    <h3>
     <a id="D__46">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8099e7807ea9422592907623597bd920.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a08ead5e785e4b6180740219387c7fff.png"/>
     </img>
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/28a894bd07c84046990ba97b3c25f5a0.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/6c9133aa639447c6912e5a4471b31fbf.png">
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a08ab8691d1849fcb7240e626b488c1f.png">
        <br/>
        <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a72a42ec839a48aba5265a2de8cf5a9a.png"/>
       </img>
      </img>
     </img>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b0d95d7d7abb4b7587aad96fd71676f7.png"/>
    </p>
    <h3>
     <a id="C__71">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8515009d6d644f06bab68d47c532aba5.png"/>
     <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/56abfddbd3f749c2b2f83adb7a0382a4.png"/>
    </p>
    <h3>
     <a id="DCBNet_82">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1cf4f97d25404343995859d8609ea9a8.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/bf7e8e88424f4f6c9868029ef8086bbf.png"/>
    </p>
    <h3>
     <a id="E__CBNet__86">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b35d9e3f7724414aba4a65676a0aed54.png"/>
    </p>
    <h4>
     <a id="2__117">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1699a9d5ac6f43409f8444afcf67a12e.png"/>
    </p>
    <p>
    ...
    <h3>
     <a id="C_CBNet__Swin_Transformer__131">
     </a>
    ...
    <ol>
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c5cbc3e294bd49a794eb08d3344c140a.png"/>
     </li>
    </ol>
    <p>
     高效性（Efficiency）：
     ...
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b930ac6f2155444f84f3fce07ba36dc9.png"/>
    </p>
    <ol start="2">
     <li>
      对 Swin Transformer 的泛化能力
      <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/94b28e2ac70146adb231c21e5a00c8d3.png"/>
     <br/>
     3) 对特殊骨干网络的泛化能力
     <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/4d573beb5e0e4e49ace413b564c4543f.png"/>
    </p>
    <ol start="4">
     <li>
      对主流检测器的适配能力
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e4c75853c24348b08e38a19c3fd2e20e.png"/>
     </li>
    </ol>
    <h3>
     <a id="D_DetectoRS_161">
     </a>
    ...
    <p>
     ...
     。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3ed8b405d99247b8974f23cc4f57a642.png"/>
     <br/>
     <strong>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c0d3a04564674e8f9d19f1ecf3b8c3ca.png"/>
    </p>
    <h3>
     <a id="E_CBNet__170">
     </a>
    ...
    <p>
     ...
     。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7935476b7bbd4f208246304cdedb2506.png"/>
     <br/>
     2) 与模型集成的兼容性
     <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/6a1a3ead9683496fbce974d20ff58e23.png"/>
    </p>
    <h3>
     <a id="F__183">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/657d6734d1d24a149e7d65714e6dbabb.png"/>
     <br/>
    ...
    <p>
     ...
     。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c4aaf47519844e3583a51a0d9661539a.png"/>
    </p>
    <p>
     此外，我们通过代理任务的
     <strong>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f4c585ff221341ed82d24521cc650678.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/cf20333c199d4691b6874c8fd4ff8dc3.png"/>
    </p>
    <h4>
     <a id="4CBNet__214">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/267c44a8aff54028bd571aa611b5b083.png"/>
     <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8ec13c549590482f81bee60b33051d9c.png"/>
     <br/>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34313632373634322f:61727469636c652f64657461696c732f313436303431303339" class_="artid" style="display:none">
 </p>
</div>
