 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atelier-sulphurpool-light" id="content_views">
      ...
      <li>
       <ul>
        <li>
         <ul>
          <li>
           <a href="#Neo4j_3" rel="nofollow">
            **Neo4j的安装和开发环境的搭建**
           </a>
          </li>
          <li>
           <a href="#Neo4j__Java_API_38" rel="nofollow">
            **Neo4j 原生的 Java API**
           </a>
          </li>
          <li>
           <a href="#Neo4j_Cypher_Java_API_161" rel="nofollow">
    ...
    <p>
     <a href="https://neo4j.com/download/other-releases/" rel="nofollow">
      https://neo4j.com/download/other-releases/
     </a>
     ，从上述链接选择合适的版本下载即可。
    </p>
    <p>
     <a href="https://www.w3cschool.cn/neo4j/neo4j_exe_environment_setup.html" rel="nofollow">
      Neo4j-环境设置
     </a>
    </p>
    <p>
     <a href="https://www.w3cschool.cn/neo4j/neo4j_zip_environment_setup.html" rel="nofollow">
      Neo4j - Zip环境设置
     </a>
    </p>
    <p>
    ...
    <p>
     可以参考
     <a href="https://www.w3cschool.cn/neo4j/neo4j_java_environment_setup.html" rel="nofollow">
      这里
     </a>
     搭建开发环境。当然，也可以在 IDEA 的 maven 工程中添加如下依赖，就这么简单。
    </p>
    <pre><code>        &lt;!-- Neo4j dependency --&gt;
        &lt;dependency&gt;
    ...
    <p>
     <img alt="Neo4j Java架构" src="https://i-blog.csdnimg.cn/blog_migrate/cb2eda4708d2cd3b63419af3497e1c84.png"/>
    </p>
    <p>
    ...
    <h4>
     <a id="Neo4j__Java_API_38">
     </a>
     <strong>
      Neo4j 原生的 Java API
     </strong>
    </h4>
    <pre><code>import org.neo4j.graphdb.*;
...
enum MyRelationshipTypes implements RelationshipType {
    ...
    <pre><code>./bin/neo4j.bat console
</code></pre>
    <p>
     输出如下
    </p>
    <pre><code>2017-11-01 03:24:32.585+0000 INFO  ======== Neo4j 3.2.6 ========
...
2017-11-01 03:24:37.571+0000 INFO  Remote interface available at http://localhost:7474/
    ...
    <p>
     此时，在
     <a href="http://localhost:7474/" rel="nofollow">
      http://localhost:7474/
     </a>
     能够看到如下图
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a2229b16362ffe0c0cf42dc2207cf667.png"/>
    </p>
    <h4>
     <a id="Neo4j_Cypher_Java_API_161">
     </a>
     <strong>
      Neo4j Cypher Java API
     </strong>
...
Done successfully
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f796974656e67746f6e67776569736869:2f61727469636c652f64657461696c732f3830343831303939" class_="artid" style="display:none">
 </p>
</div>
