...
import torchvision
mnist_dataset = torchvision.datasets.MNIST(root='./data', download=True)</code></pre>
    <p>
     下载mnist数据集
    </p>
    <p>
...
plt.show()</code></pre>
    ...
    <p>
     <img alt="" height="669" src="https://i-blog.csdnimg.cn/direct/1aefe0430db84ad8be3f372ab4b9a6d5.png" width="699"/>
    </p>
    <p>
    </p>
    <pre><code class="hljs">image.shape#图片的大小</code></pre>
    <pre>torch.Size([1, 28, 28])
</pre>
    <pre><code class="hljs">train_data = torch.stack([mnist_dataset[i][0] for i in range(64)])  # 图像数据
...
# 定义损失函数
loss_func = F.cross_entropy</code></pre>
    <pre><code class="hljs"># 训练模型
num_epochs = 10  # 训练轮数
...
print("Training complete.")</code></pre>
    <p>
     <img alt="" height="394" src="https://i-blog.csdnimg.cn/direct/2b4f59d9a05946b39abac43bba9f5a96.png" width="459"/>
    </p>
    <p>
     这是单层
    </p>
    <pre><code class="hljs">from torch import nn
...
print("Training complete.")</code></pre>
    <p>
     <img alt="" height="335" src="https://i-blog.csdnimg.cn/direct/b6460a71896d46e0b7e06dcaacb940e5.png" width="417"/>
    </p>
    <ul>
     <li>
      <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f36313336303730312f:61727469636c652f64657461696c732f313436323239313432" class_="artid" style="display:none">
 </p>
</div>
