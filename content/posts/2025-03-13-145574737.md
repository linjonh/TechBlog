 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-github-gist" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7535c03ea7964c62b4090edf07592e69.png#pic_center"/>
    </p>
    <h2>
     <a id="WPF_NET__19">
     </a>
    ...
    <pre><code>// 以一个简单的WPF应用启动代码在.NET Core环境下的变化为例
using System;
...
public partial class MainWindow : Window
{
    ...
    <pre><code>&lt;Window x:Class="ResponsiveWpfApp.MainWindow"
...
&lt;/Window&gt;
    ...
    <pre><code>&lt;Window x:Class="AnimationWpfApp.MainWindow"
        xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
...
&lt;/Window&gt;
    ...
    <pre><code>// 使用Prism框架创建一个简单的WPF应用
...
public class MainViewModel : BindableBase
{
    ...
    <p>
     原文地址：
     <a href="https://blog.csdn.net/weixin_43151418/article/details/145574737">
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34333135313431382f:61727469636c652f64657461696c732f313435353734373337" class_="artid" style="display:none">
 </p>
</div>
