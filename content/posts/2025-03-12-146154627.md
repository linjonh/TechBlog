...
之前在NXP的板子上，移植过了
[ARM Linux 移植 tslib、Qt和OpenCV\_linux qt tslib-CSDN博客](https://blog.csdn.net/pyh1322712308/article/details/145656108 "ARM Linux 移植 tslib、Qt和OpenCV_linux qt tslib-CSDN博客")
...
和之前移植 tslib 一样，海思是会对 /dev/fb0 进行封装的。这边改动 sample\_tde.c 的源码，原来的 tde 是要将背景图和一些图片循环输出到屏幕的，这边我们直接不要这么做，而是直接刷新屏幕即可。
...
来到函数
static HI\_VOID circumrotate(HI\_U32 u32CurOnShow)
