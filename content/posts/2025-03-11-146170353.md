...
[ d\_i = \frac{|Ax\_i + By\_i + Cz\_i + D|}{\sqrt{A^2 + B^2 + C^2}} ]
...
[ \min\_{A,B,C,D} \sum\_{i=1}^N (Ax\_i + By\_i + Cz\_i + D)^2 ]
...
1. **中心化数据**
   ...
   [ x\_i' = x\_i - \bar{x}, \quad y\_i' = y\_i - \bar{y}, \quad z\_i' = z\_i - \bar{z} ]
...
2. **构建矩阵方程**
   ...
   [ \begin{bmatrix} x\_1' & y\_1' & z\_1' \\ x\_2' & y\_2' & z\_2' \\ \vdots & \vdots & \vdots \\ x\_N' & y\_N' & z\_N' \end{bmatrix} \begin{bmatrix} A \\ B \\ C \end{bmatrix} = \mathbf{0} ]
...
1. **计算协方差矩阵**
   ...
   [ \mathbf{C} = \frac{1}{N} \sum\_{i=1}^N (\mathbf{p}\_i - \bar{\mathbf{p}})(\mathbf{p}\_i - \bar{\mathbf{p}})^T ]
