...
keywords: "FPGA|Verilog-自己写的SPI驱动"
categories: ['未分类']
tags: ['Fpga']
artid: "146153158"
image:
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" height="718" src="https://i-blog.csdnimg.cn/img_convert/09730c494672fb0f6be82accb3347b22.png" width="935"/>
    </p>
    <p>
    </p>
    <p class="img-center">
     <img alt="" height="99" src="https://i-blog.csdnimg.cn/img_convert/b4a447cc9d144e9f6b7eca4e32955dc4.png" width="719"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" height="510" src="https://i-blog.csdnimg.cn/img_convert/f925e32b0b412011d497cd2ff27da047.png" width="570"/>
    </p>
    <p>
    </p>
    <p class="img-center">
     <img alt="" height="592" src="https://i-blog.csdnimg.cn/img_convert/0b3756305fd9a1603c4d0a5a0c078a8e.png" width="1389"/>
    </p>
    <p>
     4. 仿真效果展示
    </p>
    ...
    <p class="img-center">
     <img alt="" height="906" src="https://i-blog.csdnimg.cn/img_convert/014db9c1d5f3295c61cbc7dd6746c8fc.png" width="1787"/>
    </p>
    <p>
     仿真上板通过
    </p>
    ...
    <pre><code class="language-cpp">module spi_driver1(
    input                               clk                        ,
    input                               rst                        ,
    input                               MISO                       ,
    output reg                          MOSI                       ,// 1
...
always @(*) begin
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34353935363437352f:61727469636c652f64657461696c732f313436313533313538" class_="artid" style="display:none">
 </p>
</div>
