...
<div class="blog-content-box">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <ol>
     <li>
      ...
      <pre><code class="hljs"> systemctl status docker.service</code></pre>
      <p>
       如果服务没有运行，你可以使用以下命令启动它：
      </p>
      <pre><code class="hljs"> systemctl start docker.service</code></pre>
      <p>
      </p>
     </li>
     <li>
      ...
      <pre><code class="hljs"> sudo systemctl enable docker.service</code></pre>
      <p>
      </p>
     </li>
    </ol>
    ...
    <ol>
     ...
     <li>
      ...
      <pre><code class="hljs">docker run --restart=always （容器id或者容器名）</code></pre>
      <p>
      </p>
     </li>
     <li>
      ...
      <pre><code class="hljs">docker update --restart=always 容器ID或名称</code></pre>
      <p>
    ...
    <pre><code class="hljs"> docker inspect 容器id或者名</code></pre>
    <p>
     找到下面这个名字，就能看到里面是什么策略了
    </p>
    <p>
     <img alt="" height="295" src="https://i-blog.csdnimg.cn/direct/3a9401e91f4c47d1bf6233d9c685e1b4.png" width="753"/>
    </p>
    <p>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f36333130373832332f:61727469636c652f64657461696c732f313436313536303836" class_="artid" style="display:none">
 </p>
</div>
