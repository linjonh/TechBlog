...
> 【多选题】下列选项中,不能获取字典tel\_book中Alice的电话号码的是
>   
...
> 【单选题】用于判定文件是否可读的函数为
>   
> A. is\_readable() B. filectime() C. fileatime() D. filesize()
>   
> 参考答案：is\_readable()
...
> 请简述open语句中三个参数分别具有哪些作用:open(f\_name，‘r’， encoding=”utf—8”)。
>   
> 文件名+只读方式+编码格式
...
> 【填空题】要想在Python程序中主动抛出异常,可以使用\_\_\_\_和\_\_\_\_语句。
>   
> 参考答案：raise,assert
...
> 当引用from datetime import time时，会生成一个时分秒对象time\_a=time(11,11,11)。
>   
> ???
