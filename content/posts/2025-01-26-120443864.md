...
React项目配置时参考博客：
[react-BrowserRouter-nginx-二级目录配置\_mollerlala的博客-CSDN博客\_nginx react 二级目录](https://blog.csdn.net/mollerlala/article/details/96427751 "react-BrowserRouter-nginx-二级目录配置_mollerlala的博客-CSDN博客_nginx react 二级目录")
