 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-java">// 策略接口：定义算法的抽象
public interface PaymentStrategy {
    ...
    <pre><code class="language-java">// 具体策略：支付宝支付
...
public class WechatPayStrategy implements PaymentStrategy {
    ...
    <pre><code class="language-java">// 上下文类：负责调用策略
public class PaymentContext {
    ...
    <pre><code class="language-java">// 1. 定义策略接口
...
public class OrderController {
    ...
    <p>
     <a href="https://www.runoob.com/design-pattern/strategy-pattern.html" rel="nofollow" title="策略模式 | 菜鸟教程">
      策略模式 | 菜鸟教程
     </a>
    </p>
    <p>
     <a href="https://blog.csdn.net/studyhard_/article/details/119047732" title="基于SpringBoot的策略模式多实现类注入（Map注入）_springboot 注入map-CSDN博客">
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34363237343931312f:61727469636c652f64657461696c732f313436313035343833" class_="artid" style="display:none">
 </p>
</div>
