...
Process: 9276 ExecStart=/usr/sbin/mysqld $MYSQLD\_OPTS (code=exited, status=3)
  
Process: 9246 ExecStartPre=/usr/bin/mysqld\_pre\_systemd (code=exited, status=0/SUCCESS)
