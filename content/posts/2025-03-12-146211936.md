...
[never\_give\_up - Bugku CTF平台](https://ctf.bugku.com/challenges/detail/id/88.html "never_give_up - Bugku CTF平台")
...
3. a这里要使用file\_get\_contents的漏洞，可以使用php://input和data://text/plain，但是我的bp版本高好像php://input没用了，所以这里用后者代替把字符串输进去
