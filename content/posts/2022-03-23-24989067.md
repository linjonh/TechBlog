...
os.popen('route add -host 192.168.88.105 dev wlan0')
os.popen('route add -host 192.168.88.106 gw 192.168.88.1 dev wlan0')
os.popen('route del -host 192.168.88.105 dev wlan0')</code></pre>
    <br/>
    <p>
    </p>
    <p>
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f6c796832353239:2f61727469636c652f64657461696c732f3234393839303637" class_="artid" style="display:none">
 </p>
</div>
