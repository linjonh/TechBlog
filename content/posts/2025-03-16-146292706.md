 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="535" src="https://i-blog.csdnimg.cn/direct/8ee1454402ee417dbf7ab549e58a9286.png" width="1703"/>
    </p>
    <p>
    </p>
    <h3>
    ...
    <p>
     <a href="https://blog.csdn.net/a_2373179473/article/details/146238841" title="Tomcat 安装-CSDN博客">
      Tomcat 安装-CSDN博客
     </a>
    </p>
    <p>
    ...
    <pre><code class="language-bash">vim /usr/local/tomcat/webapps/ROOT/test.jsp 
​
...
&lt;/html&gt;</code></pre>
    ...
    <pre><code class="language-bash">systemctl enable --now tomcat.service</code></pre>
    <p>
     <img alt="" height="405" src="https://i-blog.csdnimg.cn/direct/0798a85cb61842a0a17a97a458ee2c7e.png" width="1611"/>
    </p>
    <p>
    ...
    <pre><code class="language-bash">yum install memcached -y</code></pre>
    <p>
     <strong>
      修改 memcache 配置文件
     </strong>
    ...
    <pre><code class="language-bash">vim /etc/sysconfig/memcached 
​
PORT="11211"
USER="memcached"
MAXCONN="1024"
CACHESIZE="64"
OPTIONS="-l 0.0.0.0,::1"</code></pre>
    <p>
    </p>
    <h4>
    ...
    <p>
     <a href="https://github.com/magro/memcached-session-manager/wiki/SetupAndConfiguration" title="SetupAndConfiguration · magro/memcached-session-manager Wiki · GitHub">
      SetupAndConfiguration · magro/memcached-session-manager Wiki · GitHub
     </a>
    </p>
    <p>
     <img alt="" height="748" src="https://i-blog.csdnimg.cn/direct/8bfc560aed994231a183e1bb59d34fe9.png" width="1600"/>
    </p>
    <p>
     <img alt="" height="596" src="https://i-blog.csdnimg.cn/direct/a47eacafca1d49d6b3a71341a3c5dce3.png" width="1586"/>
    </p>
    <p>
     xshell 上传所需模块，拷贝模块到 /usr/local/tomcat/lib 目录下。
    </p>
    <p>
     <img alt="" height="184" src="https://i-blog.csdnimg.cn/direct/b2532d1de9a540d2aec6f342f4a24d12.png" width="1433"/>
    </p>
    <pre><code class="language-bash">cp *.jar /usr/local/tomcat/lib/</code></pre>
    <p>
    </p>
    <h4>
     3.2.4.修改 Tomcat 配置
    </h4>
    <pre><code class="language-bash">vim /usr/local/tomcat/conf/context.xml   # 在 &lt;Context&gt; 模块里添加以下内容
​
 ...
            /&gt;</code></pre>
    <p>
     <img alt="" height="507" src="https://i-blog.csdnimg.cn/direct/ef48109ffa1444de934b520b36a89188.png" width="1589"/>
    </p>
    <p>
     <strong>
      参数说明
    ...
    <pre><code class="language-bash">vim /etc/nginx/conf.d/vhosts.conf 
​
upstream tomcat {
...
​
 ...
        }
    ...
    <pre><code class="language-bash">systemctl enable --now nginx</code></pre>
    <p>
    </p>
    <hr/>
    <p>
    ...
    <p>
     <img alt="" height="709" src="https://i-blog.csdnimg.cn/direct/f73da4bf4e98482ca42668e175ffa116.png" width="1586"/>
    </p>
    <p>
     <img alt="" height="1311" src="https://i-blog.csdnimg.cn/direct/9023519e4d4845c3b47d507f8a085e20.png" width="2274"/>
    </p>
    <p>
     添加 hosts 解析，Proxy 主机的 IP 和 Nginx 配置文件里所配置的域名，添加并保存。
    </p>
    <p>
     <img alt="" height="80" src="https://i-blog.csdnimg.cn/direct/c76220ff4ced468fbfcab38d58d3a488.png" width="1598"/>
    </p>
    <p>
    </p>
    <h3>
    ...
    <p>
     ...
     <a href="www.timinglee.org" rel="nofollow">
      www.timinglee.org
     </a>
     解析到 Nginx 代理服务器的 IP 地址，从而能够使用浏览器访问系统应用。
    </p>
    <p>
     <img alt="" height="407" src="https://i-blog.csdnimg.cn/direct/8b6d44e045f94895b77e1ffbfce3d3f2.png" width="1602"/>
    </p>
    <p>
    </p>
    <h3>
    ...
    <p>
     在浏览器中输入
     <a href="www.timinglee.org/test.jsp" rel="nofollow">
    ...
    <p>
     <img alt="" height="447" src="https://i-blog.csdnimg.cn/direct/c01e273917114b269eb9945d7da17f06.png" width="1604"/>
    </p>
    <p>
    </p>
    <h3>
    ...
    <pre><code class="language-bash">systemctl stop tomcat.service    # 停止 192.168.67.10 主机的 Tomcat 服务</code></pre>
    <p>
     <img alt="" height="572" src="https://i-blog.csdnimg.cn/direct/8e117eb613304af88416afb6924d6f46.png" width="1597"/>
    </p>
    <p>
    </p>
    <h3>
    ...
    <p>
     <img alt="" height="536" src="https://i-blog.csdnimg.cn/direct/6855dd9ffee94ff7b1cd38e5945de52f.png" width="1603"/>
    </p>
    <hr/>
    <p>
    </p>
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f615f323337333137393437332f:61727469636c652f64657461696c732f313436323932373036" class_="artid" style="display:none">
 </p>
</div>
