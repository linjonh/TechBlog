 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-bash">mediainfo a.mp4</code></pre>
    <p>
     输出结果：
    </p>
    <pre><code>General
...
Alternate group                          : 1</code></pre>
    ...
    <pre><code class="language-bash">ffprobe -v quiet -print_format json -show_format -show_streams -show_error -show_chapters a.mp4</code></pre>
    <pre><code>{
    "streams": [
        {
            "index": 0,
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f33393831303535382f:61727469636c652f64657461696c732f313236323236323432" class_="artid" style="display:none">
 </p>
</div>
