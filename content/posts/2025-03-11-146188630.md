  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/ba9a28fbf52f4472865b8622e96487de.png"/>
    </p>
    <p>
     在 C语言中，除了
     <a class="link-info" href="https://xiecoding.cn/view/451.html" rel="nofollow" title="while 和 do while">
      while 和 do while
     </a>
     ，使用 for 语句也可以实现循环结构。
    </p>
    ...
    <pre><code class="language-cpp">for(表达式1;表达式2;表达式3)
{
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/75d7500ab7e1870625bbd3a2ccd31eed.gif"/>
    </p>
    <p style="text-align:center">
     图 1 for语句的执行流程图
    </p>
...
int main()
{
   ...
   return 0; //程序结束
    ...
    <pre><code class="language-cpp">int number = 1;
...
for (number = 1; number &lt;= 20;) { // 省略表达式3，但通常这里会是number++
    ...
    <pre><code class="language-cpp">for (isum = 0, icount = 1; icount &lt; 100; icount++) {
    isum = isum + icount;
}</code></pre>
    <p>
     或者执行两次循环变量自加操作，代码如下：
    </p>
    <pre><code class="language-cpp">for (icount = 1; icount &lt; 100; icount++, icount++) {
    isum = isum + icount;
}</code></pre>
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/70135f8c6f4d4ed4a157e379be926383.png"/>
    </p>
   </div>
  </div>
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f7a646f656f2f:61727469636c652f64657461696c732f313436313838363330" class_="artid" style="display:none">
 </p>
</div>
