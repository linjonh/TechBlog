 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h3 id="section19868856124713">
     简介
    </h3>
    <p>
    </p>
    <h4 id="section61471815111">
     定义
    </h4>
    <p>
    </p>
    ...
    <h3 id="section172701342205911">
     获取DVID
    </h3>
    <pre><code class="language-java">private String getDVID() {
    return AccountAbility.getAccountAbility().getDistributedVirtualDeviceId();
}</code></pre>
    <h2>
     UUID
    </h2>
    <h3 id="section10966203442315">
     简介
    </h3>
    <p>
    </p>
    ...
    <h3 id="section1454103911471">
     获取UUID
    </h3>
    <pre><code class="language-java">import java.util.UUID
UUID uuid  =  UUID.randomUUID() </code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34373039343733332f:61727469636c652f64657461696c732f313331353732353632" class_="artid" style="display:none">
 </p>
</div>
