...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="295" src="https://i-blog.csdnimg.cn/blog_migrate/70ab1af47de92f89b4b9b87c27df0d11.png" width="331"/>
    </p>
    <p>
    </p>
    <h4>
    ...
    <pre><code class="language-java">        MediaExtractor extractor = new MediaExtractor();
        try {
            //设置数据源
        ...
        //获取轨道数量
        trackCount = extractor.getTrackCount();</code></pre>
    <p>
     <strong>
      2、遍历音轨数量，得到想要的轨道
     </strong>
    </p>
    <pre><code class="language-java">        //查找需要的视频轨道与音频轨道index
    ...
    <pre><code class="language-java">        File videoFile = new File(videoPath);
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f796f6f6e65726c6f6f702f:61727469636c652f64657461696c732f313038303238353037" class_="artid" style="display:none">
 </p>
</div>
