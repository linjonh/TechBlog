...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="157" src="https://i-blog.csdnimg.cn/direct/1b4359756dcd4cceb341de0f2794174a.png" width="691"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="442" src="https://i-blog.csdnimg.cn/direct/4754f1e07a6d48468d5ecb906b3f1a90.png" width="692"/>
    </p>
    <p>
    </p>
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="239" src="https://i-blog.csdnimg.cn/direct/6ce5b5c33b174cb7a7ad8bfde8f6dd27.png" width="692"/>
    </p>
    ...
    <p class="img-center">
     <img alt="" height="335" src="https://i-blog.csdnimg.cn/direct/5b3e274406b64d3b8db839b01cdcceae.png" width="225"/>
    </p>
    <p>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="163" src="https://i-blog.csdnimg.cn/direct/53175e096114447db0eeda6a8776d828.png" width="692"/>
    </p>
    ...
    <p>
     <img alt="" height="286" src="https://i-blog.csdnimg.cn/direct/f60f9260e612470cbea8f048111bd157.png" width="693"/>
    </p>
    <p>
    </p>
    <h5>
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="322" src="https://i-blog.csdnimg.cn/direct/a49a3125729d483bbddb4e8faac3b5e5.png" width="695"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     如果想要把YUV格式的图像显示到LCD屏幕上就要做相应的转换，如下图。
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="262" src="https://i-blog.csdnimg.cn/direct/ac08ba144c564863b642f32f2a4c84cb.png" width="691"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <span style="background-color:#ffffff">
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="167" src="https://i-blog.csdnimg.cn/direct/65d55c38e095405aac5797743f53eec6.png" width="691"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <span style="background-color:#ffffff">
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="198" src="https://i-blog.csdnimg.cn/direct/b08e3f94bef64dcaa83dbfa010d87ad2.png" width="692"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <strong>
      <span style="color:#fe2c24">
    ...
    <p>
     <img alt="" height="159" src="https://i-blog.csdnimg.cn/direct/a08f6e935b24451b933ec119cf62b634.png" width="692"/>
    </p>
    <h5>
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="212" src="https://i-blog.csdnimg.cn/direct/e58ae7ba3be340d4904651f7796a397e.png" width="692"/>
    </p>
    <h5 style="margin-left:0.0001pt; margin-right:0px; text-align:justify">
     (5)为了让摄像头可以把采集的图像存储在申请的帧缓存中，所以需要把申请的帧缓存入队
    </h5>
    <p>
     <img alt="" height="284" src="https://i-blog.csdnimg.cn/direct/05ab9c2e49034f0793bc8d9249d25492.png" width="692"/>
    </p>
    <h5>
     (6)缓存区入队之后，用户可以启动图像捕捉，然后摄像头就可以循环的把图像存入缓存区
    </h5>
    <p>
     <img alt="" height="84" src="https://i-blog.csdnimg.cn/direct/2e552ec4266648fc9a6f7926f1c0da6d.png" width="692"/>
    </p>
    <h5>
     (7)依次把缓存区出队，然后用户对缓存区存储的图像数据进行处理，但是要实现超时处理
    </h5>
    <p>
     <img alt="" height="344" src="https://i-blog.csdnimg.cn/direct/7185b19066f04cdd9a7b1b199f6de2e0.png" width="692"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <span style="background-color:#ffffff">
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="350" src="https://i-blog.csdnimg.cn/direct/89fab06573b844869bdcfed72705b836.png" width="691"/>
    </p>
    <h5 style="margin-left:0.0001pt; margin-right:0px; text-align:justify">
     (8)把出队的缓存区中的YUYV格式的颜色分量转换为RGB格式的颜色分量并显示在LCD上
    </h5>
    <p>
     <img alt="" height="344" src="https://i-blog.csdnimg.cn/direct/95fd01c6db40405484785e3c8ac81508.png" width="692"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <span style="background-color:#ffffff">
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="536" src="https://i-blog.csdnimg.cn/direct/d51fb506e8be40e088e25e7c94dfbf0f.png" width="692"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <strong>
    ...
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <img alt="" height="434" src="https://i-blog.csdnimg.cn/direct/514dae55fbd6459096b752aa1a5c9553.png" width="692"/>
    </p>
    <p style="margin-left:.0001pt; margin-right:0; text-align:justify">
     <span style="color:#fe2c24">
      <strong>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37333638333632372f:61727469636c652f64657461696c732f313436303635323039" class_="artid" style="display:none">
 </p>
</div>
