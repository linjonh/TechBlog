 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-sql">DROP TABLE IF EXISTS `tb_base_user`;
...
SET FOREIGN_KEY_CHECKS = 1;</code></pre>
    ...
    <pre><code class="language-XML">&lt;update id="increaseFailNum" parameterType="string"&gt;
        UPDATE tb_base_user
...
&lt;/update&gt;</code></pre>
     ...
     * @return
     */
    int increaseFailNum(String oaId);</code></pre>
    <p>
...
public class PasswordUtil {
    ...
    <pre><code class="language-java">package com.lz.boot.lzwork.security.service.impl;
...
public class UserDetailsImpl implements UserDetails {
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33353431383235302f:61727469636c652f64657461696c732f313436323438343532" class_="artid" style="display:none">
 </p>
</div>
