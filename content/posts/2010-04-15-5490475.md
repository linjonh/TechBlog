...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="敏捷开发中的Java代码质量保证步骤" height="323" src="http://articles.csdn.net/uploads/allimg/100308/103A44647-0.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    ...
    <p>
     <img alt="Eclipse代码样式设置窗口" height="394" src="http://articles.csdn.net/uploads/allimg/100308/103A42306-1.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图2.Eclipse代码样式设置窗口
    </p>
    ...
    <p>
     <img alt="创建新的代码格式配置" height="468" src="http://articles.csdn.net/uploads/allimg/100308/103A4Mc-2.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图3.创建新的代码格式配置
    </p>
    ...
    <p>
     <img alt="创建新的代码格式配置" height="515" src="http://articles.csdn.net/uploads/allimg/100308/103A42501-3.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图4.创建新的代码格式配置
    </p>
    ...
    <p>
     <img alt="FindBugs的配置选项" height="570" src="http://articles.csdn.net/uploads/allimg/100308/103A43B0-4.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图5.FindBugs的配置选项
    </p>
    ...
    <p>
     <img alt="运行FindBugs" height="118" src="http://articles.csdn.net/uploads/allimg/100308/103A46139-5.jpg" style="text-align: center; margin: 0px auto; display: block;" width="458"/>
    </p>
    <p align="center" style="text-align: center;">
     图6.运行FindBugs
    </p>
    ...
    <p>
     <img alt="FindBugs检查结果" height="185" src="http://articles.csdn.net/uploads/allimg/100308/103A4K53-6.jpg" style="text-align: center; margin: 0px auto; display: block;" width="434"/>
    </p>
    <p align="center" style="text-align: center;">
     图7.FindBugs检查结果
    </p>
    ...
    <p>
     ...
     <a class="fllink" href="http://www.chinabyte.com/keyword/%E6%A8%A1%E5%9D%97/" rel="nofollow noopener noreferrer" target="_blank">
    ...
    <p>
     <img alt="Mockito示例" height="199" src="http://articles.csdn.net/uploads/allimg/100308/103A43506-7.jpg" style="text-align: center; margin: 0px auto; display: block;" width="473"/>
    </p>
    <p align="center" style="text-align: center;">
     图8.Mockito示例
    </p>
    ...
    <p>
     <img alt="运行测试覆盖分析" height="280" src="http://articles.csdn.net/uploads/allimg/100308/103A41U8-8.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图9.运行测试覆盖分析
    </p>
    ...
    <p>
     <img alt="查看测试覆盖分析结果" height="443" src="http://articles.csdn.net/uploads/allimg/100308/103A4K96-9.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图10.查看测试覆盖分析结果
    </p>
    ...
    <p>
     <img alt="导出测试覆盖分析结果" height="233" src="http://articles.csdn.net/uploads/allimg/100308/103A4FE-10.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图11.导出测试覆盖分析结果
    </p>
    ...
    <p>
     <img alt="测试覆盖分析报告" height="435" src="http://articles.csdn.net/uploads/allimg/100308/103A45V1-11.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图12.测试覆盖分析报告
    </p>
    ...
    <p>
     ...
     <a class="fllink" href="http://www.chinabyte.com/keyword/%E8%87%AA%E5%8A%A8%E5%8C%96/" rel="nofollow noopener noreferrer" target="_blank">
      <span style="color: #888888;">
       自动化
      </span>
     </a>
     。搭建自动的构建
     <a class="fllink" href="http://server.chinabyte.com/" rel="nofollow noopener noreferrer" target="_blank">
      <span style="color: #888888;">
       服务器
      </span>
     </a>
    ...
    <p>
     <img alt="申请一个新的构建" height="453" src="http://articles.csdn.net/uploads/allimg/100308/103A4G60-12.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图13.申请一个新的构建
    </p>
    <p>
     <img alt="构建申请界面" height="519" src="http://articles.csdn.net/uploads/allimg/100308/103A44419-13.jpg" style="text-align: center; margin: 0px auto; display: block;" width="419"/>
    </p>
    <p align="center" style="text-align: center;">
     图14.构建申请界面
    </p>
    ...
    <p>
     <img alt="构建结果" height="488" src="http://articles.csdn.net/uploads/allimg/100308/103A46406-14.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图15.构建结果
    </p>
    ...
    <p>
     <img alt="构建定义" height="498" src="http://articles.csdn.net/uploads/allimg/100308/103A42418-15.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图16.构建定义
    </p>
    ...
    <p>
     <img alt="自动测试报告" height="450" src="http://articles.csdn.net/uploads/allimg/100308/103A464X-16.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图17.自动测试报告
    </p>
    ...
    <p>
     <img alt="Jupiter代码评审界面" height="461" src="http://articles.csdn.net/uploads/allimg/100308/103A43433-17.jpg" style="text-align: center; margin: 0px auto; display: block;" width="485"/>
    </p>
    <p align="center" style="text-align: center;">
     图18.Jupiter代码评审界面
    </p>
    ...
    <p>
     ...
     <a class="fllink" href="http://com.chinabyte.com/%E6%95%B0%E6%8D%AE%E5%BA%93/" rel="nofollow noopener noreferrer" target="_blank">
      <span style="color: #888888;">
       数据库
      </span>
     </a>
    ...
    <p>
     <img alt="Codestriker报告界面" height="438" src="http://articles.csdn.net/uploads/allimg/100308/103A42624-18.jpg" style="text-align: center; margin: 0px auto; display: block;" width="498"/>
    </p>
    <p align="center" style="text-align: center;">
     图19.Codestriker报告界面
    </p>
    ...
    <p>
     此文转载于
     <a href="http://java.csdn.net/a/20100308/259219.html" rel="nofollow">
 ...
 <p alt="6874:7470733a2f2f626c6f672e6373646e2e6e65742f6c68393532:392f61727469636c652f64657461696c732f35343930343735" class_="artid" style="display:none">
 </p>
</div>
