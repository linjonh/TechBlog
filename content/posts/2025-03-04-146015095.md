...
| ` var data = context.Data.LoadFromTextFile<ModelInput>("data.csv",
separatorChar: ',');`  
| ` var pipeline = context.Transforms.Text.FeaturizeText("Features", "Text")`  
| ` .Append(context.BinaryClassification.Trainers.SdcaLogisticRegression());`  
| ` var model = pipeline.Fit(data);`  
| ` var predictionEngine = context.Model.CreatePredictionEngine<ModelInput,
ModelOutput>(model);`  
...
| `var context = new MLContext();`  
---|---  
| `var data = context.Data.LoadFromTextFile<ModelInput>("sales.csv",
separatorChar: ',');`  
