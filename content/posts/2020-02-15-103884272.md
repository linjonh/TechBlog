---
arturl_encode: "68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343833393038342f:61727469636c652f64657461696c732f313033383834323732"
layout: post
title: "Milvus带你实现轻松搭建以图搜图系统"
date: 2020-02-15 18:42:13 +08:00
...
![](https://i-blog.csdnimg.cn/blog_migrate/9661a6c7b13f435cba3dcb34947d1997.png)
...
下载地址：http://host.robots.ox.ac.uk/pascal/VOC/voc2012/VOCtrainval\_11-May-2012.tar
...
![](https://i-blog.csdnimg.cn/blog_migrate/48390319fc0f50b894873bc070ee8caf.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/1bfb6748c2a60d00aa2d9d2433c2d0e1.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/628e63da10d1bb7e8b4d9de4284fa81c.png)
...
当获取到图片的特征向量之后，再将这些向量利用 Milvus 的 insert\_vectors 的接口导入 Milvus 里面:
...
得到待搜索图片的向量之后，再调用 Milvus 的 search\_vectors 的接口进行相似向量检索：
...
https://github.com/milvus-io/bootcamp/blob/0.6.0/solutions/pic\_search/README.md

Step 1 启动 Milvus Docker

详细步骤可以参考链接：

https://milvus.io/cn/docs/v0.6.0/guides/get\_started/install\_milvus/install\_milvus.md
...
![](https://i-blog.csdnimg.cn/blog_migrate/dc736f3c53080a59fa9abf5afd8c9de2.png)

在路径框中填入图片路径进行加载，等待图片全部转换成向量并加载到 Milvus之后就可以进行图片检索了：

![](https://i-blog.csdnimg.cn/blog_migrate/6b5260933d839145f71235f5c2f35c74.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/c737bcdc3765612d1de2ecc05f81b8d3.png)

© 2019 ZILLIZ™

![](https://i-blog.csdnimg.cn/blog_migrate/a58bb5491b48bfbd559412ea99629e0b.png)