...
// 使用另一个集合初始化
ArrayList&lt;String&gt; list3 = new ArrayList&lt;&gt;(list);</code></pre>
    <blockquote>
     <ul>
      <li>
    ...
    <h6>
     1.
     <a href="https://www.lanqiao.cn/problems/178/learning/" rel="nofollow" title="全球变暖 - 蓝桥云课">
      全球变暖 - 蓝桥云课
     </a>
    </h6>
    <p style="text-align:center">
     <img alt="" height="502" src="https://i-blog.csdnimg.cn/direct/2ffd9bf30f1046d0a4010cad12182c2e.png" width="382"/>
    </p>
...
public class Main {
    ...
    <h6>
     2.
     <a href="https://www.lanqiao.cn/problems/124/learning/" rel="nofollow" title="密码脱落 - 蓝桥云课">
      密码脱落 - 蓝桥云课
     </a>
    </h6>
    <p>
     <img alt="" height="291" src="https://i-blog.csdnimg.cn/direct/945d48b20dd04adea9fe8cca250eb8d0.png" width="354">
      <img alt="" height="296" src="https://i-blog.csdnimg.cn/direct/0828dcf9d90b46f198cddc92d81be1bd.png" width="316"/>
     </img>
    </p>
...
public class Main {
    ...
    <h6>
     3.
     <a href="https://www.lanqiao.cn/problems/205/learning/" rel="nofollow" title="错误票据 - 蓝桥云课">
      错误票据 - 蓝桥云课
     </a>
    </h6>
    <p style="text-align:center">
     <img alt="" height="507" src="https://i-blog.csdnimg.cn/direct/3c0e75fc9447458282c84739c53e3122.png" width="417"/>
    </p>
    <p>
     题挺简单的，就是加瓦的一些相关用法不熟。。。。。
    </p>
...
//            System.out.print(num + " ");
    ...
    <h6>
     4.
     <a href="https://www.lanqiao.cn/problems/182/learning/" rel="nofollow" title="小朋友崇拜圈 - 蓝桥云课">
      小朋友崇拜圈 - 蓝桥云课
     </a>
    </h6>
    <p>
     <img alt="" height="334" src="https://i-blog.csdnimg.cn/direct/bea59b90a0644aee9a8e3736814bcef0.png" width="339">
      <img alt="" height="319" src="https://i-blog.csdnimg.cn/direct/76e1048dfe9f440a845501f9b618018c.png" width="343"/>
     </img>
    </p>
    <pre><code class="language-java">import java.util.*;
...
public class Main {
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37333037323238322f:61727469636c652f64657461696c732f313436313739383638" class_="artid" style="display:none">
 </p>
</div>
