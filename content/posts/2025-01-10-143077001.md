...
- 运行 iperf
  ...
  <pre><code class="language-bash"># 更新包列表并安装 iperf3
  sudo apt update
...
<pre><code class="language-bash"># 安装 Homebrew
...
<h2> 3. 如何使用 iperf 进行 TCP 和 UDP 测试
</h2>
<h3>
3.1 iperf TCP 测试指南
</h3>
...
<li>
<p>
在客户端运行 iperf 命令，并指定服务器的 IP 地址和需要的参数。
<code>
...
<li>
<p>
观察输出结果，iperf 会显示每个报告间隔的吞吐量、延迟、丢包等数据，并在测试结束后显示总的数据摘要。
</p>
</li>
</ol>
<h3>
...
<li>
<p>
分析输出结果，iperf 将显示 UDP 数据包发送和接收的速率，以及数据包的丢失情况等信息。
</p>
</li>
</ol>
<p>
...
<ol>
<li>
从 iperf 的官方网站或其他可信源下载 iperf 的 Windows 版本。
</li>
<li>
解压下载的 zip 文件到指定目录。
</li>
<li>
在该目录下打开命令提示符（cmd）并执行以下命令以启动 iperf 服务器：
</li>
</ol>
<p>
<code>
...
<pre><code class="language-bash">iperf3 -c **_._**._._ -t 60 -P 2
</code></pre>
<p>
这条命令表示，客户端将与服务器地址为
<strong>
...
<ol>
<li>
在客户端运行 iperf3 客户端程序，连接到服务器并执行测试：
</li>
</ol>
<p>
<code>
...
<pre><code class="language-bash"># 带宽计算示例 iperf 命令
iperf -s -V
</code></pre>
<p>
<strong>
...
<pre><code class="language-bash"># 用于测试延迟和丢包率的 iperf 命令
