...
需要将<button>组件的open-type值设置为getPhoneNumber，当用户点击并同意之后，可以通过bindgetphonenumber事件回调获取到微信服务器返回的加密数据， 然后在第三方服务端结合session\_key以及app\_id进行解密获取手机号。
...
原文地址：https://blog.csdn.net/weixin\_41818665/article/details/79509792