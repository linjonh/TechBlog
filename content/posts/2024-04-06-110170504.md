...
# python标识符包括哪些\_为小白扫盲：Python入门必备知识
...
以下划线开头的标识符有特殊含义，单下划线开头的标识符，如：\_xxx ，表示不能直接访问的类属性，需通过类提供的接口进行访问，不能用 from xxx import \* 导入；双下划线开头的标识符，如：\_\_xx，表示私有成员；双下划线开头和结尾的标识符，如：\_\_xx\_\_，表示 Python 中内置标识，如：\_\_init\_\_() 表示类的构造函数。
