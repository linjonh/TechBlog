 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h2 id="%E4%B8%80%E3%80%81%E5%90%8E%E7%AB%AF%E5%AE%9E%E7%8E%B0" name="%E4%B8%80%E3%80%81%E5%90%8E%E7%AB%AF%E5%AE%9E%E7%8E%B0">
     一、后端实现
    </h2>
    <ul>
     <li>
    ...
    <pre><code class="language-java">public class AesUtils {
...
public class RsaKeyManager {
    ...
    <pre><code class="language-java">public class DecryptedHttpInputMessage implements HttpInputMessage {
...
public class RSAController {
    ...
    <h2 id="%C2%A0%E4%BA%8C%E3%80%81%E5%89%8D%E7%AB%AF%E5%AE%9E%E7%8E%B0%EF%BC%88Vue2%EF%BC%89" name="%C2%A0%E4%BA%8C%E3%80%81%E5%89%8D%E7%AB%AF%E5%AE%9E%E7%8E%B0%EF%BC%88Vue2%EF%BC%89">
     二、前端实现（Vue2）
    </h2>
    <ul>
     <li>
    ...
    <pre><code class="language-java">npm install crypto-js</code></pre>
    <ul>
     <li>
...
function wrapKey(key) {
    ...
    <pre><code class="language-javascript">service.interceptors.request.use(async config =&gt; {
    ...
    <h2 id="%E4%B8%89%E3%80%81%E8%A1%A5%E5%85%85" name="%E4%B8%89%E3%80%81%E8%A1%A5%E5%85%85">
     三、补充
    </h2>
    <ul>
     <li>
    ...
    <pre><code class="language-java">@PostMapping("/secure-data")
@NeedDecrypt
public String handleSecureData(@RequestBody Map&lt;String, Object&gt; decryptedData) {
    ...
    <h3 id="%C2%A01.%E5%A2%9E%E5%BC%BA%E5%AE%89%E5%85%A8%E6%8E%AA%E6%96%BD" name="%C2%A01.%E5%A2%9E%E5%BC%BA%E5%AE%89%E5%85%A8%E6%8E%AA%E6%96%BD">
     1.增强安全措施
    </h3>
    <ul>
     <li>
    ...
    <pre><code class="language-java">// 前端每次请求生成新密钥
const aes = generateAesKey()</code></pre>
    <ul>
     <li>
      <p>
       <strong>
    ...
    <pre><code class="language-java">// 后端解密后可添加HMAC校验
...
if(!verifyHMAC(decryptedData, hmac, aesKey)) {
    ...
    <pre><code class="language-java">// 前端添加时间戳和随机数
config.data.timestamp = Date.now()
config.data.nonce = Math.random().toString(36).substr(2)</code></pre>
    <h2 id="%C2%A0%E5%9B%9B%E3%80%81%E6%9C%80%E5%90%8E%E8%AF%B4%E6%98%8E" name="%C2%A0%E5%9B%9B%E3%80%81%E6%9C%80%E5%90%8E%E8%AF%B4%E6%98%8E">
     四、最后说明
    </h2>
    <p>
     <strong>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f35343432313230302f:61727469636c652f64657461696c732f313436323334393436" class_="artid" style="display:none">
 </p>
</div>
