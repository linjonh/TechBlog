...
* + [1、安装：](#1_5)
  ...
  + - [（1）明确主程序职责](#1_241)
    ...
    - [（3）游戏背景](#3_283)
    - * [①背景交替滚动的思路](#_284)
      * [②在plane\_main.py中显示背景精灵](#plane_mainpy_307)
      * [③简化背景精灵的创建](#_321)
    - [（4）敌机](#4_354)
    - * [①使用定时器添加敌机](#_356)
      * [②设计Enemy类](#Enemy_378)
    ...
    - * [①绘制英雄](#_481)
      ...
      * [⑧碰撞检测](#_645)
* [五、游戏设计完成，运行图片](#_673)
* [附录一：plane\_main.py](#plane_mainpy_680)
* [附录二：plane\_sprites.py](#plane_spritespy_800)
* [附录三：飞机大战设计图片](#_932)
...
> > 例如：指定screen接收返回值。
> >   
> > screen = pygame.display.set\_mode((480, 700))。
...
SCREN\_RECT = pygame.Rect(0, 0, 480, 700)
...
> self.hero = Hero()
>   
> self.hero\_group = pygame.sprite.Group(self.hero)

在
`__update_sprites`
，让 英雄精灵组 调用 update和 draw 方法。

> self.hero\_group.update()
>   
> self.hero\_group.draw(self.screen)
...
elif self.rect.right > SCREEN\_RECT.right:
  
self.rect.right = SCREEN\_RECT.right
