 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <h2 id="1.%E7%AE%80%E4%BB%8B" style="background-color:transparent;">
     1.简介
    </h2>
    <p>
    ...
    <p>
     <img alt="" height="160" src="https://i-blog.csdnimg.cn/direct/a30fafd7d8564f9aab8d0156f21b613d.png" width="710"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <p>
     官方网站：
     <a href="https://aivideo.hunyuan.tencent.com/" rel="nofollow" title="https://aivideo.hunyuan.tencent.com/">
      https://aivideo.hunyuan.tencent.com/
     </a>
    </p>
    <p>
     论文地址：
     <a href="https://github.com/Tencent/HunyuanVideo/blob/main/assets/hunyuanvideo.pdf" title="HunyuanVideo/assets/hunyuanvideo.pdf at main · Tencent/HunyuanVideo · GitHub">
      HunyuanVideo/assets/hunyuanvideo.pdf at main · Tencent/HunyuanVideo · GitHub
     </a>
    </p>
    <p>
     github地址：
     <a href="https://github.com/Tencent/HunyuanVideo" title="GitHub - Tencent/HunyuanVideo: HunyuanVideo: A Systematic Framework For Large Video Generation Model Training">
      GitHub - Tencent/HunyuanVideo: HunyuanVideo: A Systematic Framework For Large Video Generation Model Training
     </a>
    </p>
    <p>
     hugging face权重：
     <a href="https://huggingface.co/tencent/HunyuanVideo/tree/main" rel="nofollow" title="https://huggingface.co/tencent/HunyuanVideo/tree/main">
      https://huggingface.co/tencent/HunyuanVideo/tree/main
     </a>
    </p>
    <p>
     效果体验地址：
     <a href="https://video.hunyuan.tencent.com/" rel="nofollow" title="腾讯混元文生视频">
      腾讯混元文生视频
     </a>
    </p>
    <p>
    ...
    <h2 id="2.%E6%95%88%E6%9E%9C%E5%B1%95%E7%A4%BA" style="background-color:transparent;">
     2.效果展示
    </h2>
    <p>
    ...
    <p>
     <img alt="" height="483" src="https://i-blog.csdnimg.cn/direct/af280e4d208342b1a0c4bb339fca4dfd.png" width="998"/>
    </p>
    <p>
     真实画面，电影镜头。一枚巨大的炸弹在高空爆炸，火焰和碎片四溅。摄像机从低角度向上拍摄炸弹爆炸的瞬间，火光照亮了战场的废墟。一个小男孩士兵的脸在爆炸的光芒中显得惊恐万分，尘土和火焰在他身后交织，场面令人震惊。
    </p>
    <p>
     <img alt="" height="505" src="https://i-blog.csdnimg.cn/direct/2fa5793069c040ffb31623aee53471eb.png" width="1000"/>
    </p>
    <p>
     <img alt="" height="500" src="https://i-blog.csdnimg.cn/direct/ded3c17a34d2480ebfb53e269553ac13.png" width="1011"/>
    </p>
    <p>
     四人在下潜至烟囱区时发现深度远超预期，装备不足以支持他们继续下潜，因此决定返回水面。深海洞穴，四名潜水员。
    </p>
    <p>
     <img alt="" height="505" src="https://i-blog.csdnimg.cn/direct/8cd34414f0374daca29a51865505e46c.png" width="1003"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="500" src="https://i-blog.csdnimg.cn/direct/f4ccf5293f2c4dbab7ef1570170152d7.png" width="1009"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <h2 id="3.%E8%AE%BA%E6%96%87%E8%AF%A6%E8%A7%A3">
     3.论文详解
    </h2>
    <h3 id="%E4%BB%8B%E7%BB%8D">
     介绍
    </h3>
    <p>
    ...
    <h4 id="%E6%95%B0%E6%8D%AE%E8%BF%87%E6%BB%A4">
     数据过滤
    </h4>
    <p>
     作者采用了一系列技术来预处理原始数据。
    ...
    <ol>
     ...
     <li>
      接下来，作者使用OpenCV中的拉普拉斯算子来
      <strong>
       识别一个清晰的帧，作为每个视频剪辑的起始帧。
      </strong>
     </li>
     <li>
      使用内部VideoCLIP模型，我们计算这些视频剪辑的Embedding。这些Embedding有两个目的：
      <ol>
       <li>
        基于Embedding的余弦距离对相似片段进行重复数据删除;
       </li>
       <li>
        我们应用k-means 来获得10000个概念质心，用于重新排序和平衡。
       </li>
      </ol>
     </li>
    </ol>
    ...
    <p>
     <img alt="" height="358" src="https://i-blog.csdnimg.cn/direct/fea0bfe82c95442ebd01a5bba52cc1ea.png" width="1012"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <h4 id="%E6%95%B0%E6%8D%AE%E6%A0%87%E6%B3%A8">
     数据标注
    </h4>
    <p>
     <strong>
    ...
    <h3 id="%E6%A8%A1%E5%9E%8B%E7%BB%93%E6%9E%84">
     模型结构
    </h3>
    <h4 id="3D%E5%8F%98%E5%88%86%E8%87%AA%E5%8A%A8%E7%BC%96%E7%A0%81%E5%99%A8" style="background-color:transparent;">
     3D变分自动编码器
    </h4>
    <p>
     作者训练了一个3D-VAE来将像素空间的视频和图像压缩到一个紧凑的潜在空间中。为了同时处理视频和图像，作者使用了CausalConv3D。对于一个形状为(T + 1) × 3 × H × W的视频，作者的3D VAE将其压缩成形状为
     <img alt="(\frac{T}{ c_t} + 1) \times C \times (\frac{H}{ c_s}) \times (\frac{W}{ c_s})" class="mathcode" src="https://latex.csdn.net/eq?%28%5Cfrac%7BT%7D%7B%20c_t%7D%20&amp;plus;%201%29%20%5Ctimes%20C%20%5Ctimes%20%28%5Cfrac%7BH%7D%7B%20c_s%7D%29%20%5Ctimes%20%28%5Cfrac%7BW%7D%7B%20c_s%7D%29"/>
    ...
    <p>
     参考：
     <a href="https://blog.csdn.net/sherlockMa/article/details/142917608?spm=1001.2014.3001.5501" title="CogVideoX-5b及I2V详解（包含代码、论文详解）-CSDN博客">
      CogVideoX-5b及I2V详解（包含代码、论文详解）-CSDN博客
     </a>
    </p>
    <p>
     参考：
     <a href="https://blog.csdn.net/sherlockMa/article/details/143018659?spm=1001.2014.3001.5501" title="Pyramid Flow：北大开源的视频生成模型-CSDN博客">
      Pyramid Flow：北大开源的视频生成模型-CSDN博客
     </a>
    </p>
    <p>
     <img alt="" height="198" src="https://i-blog.csdnimg.cn/direct/e1d2f82ad7724a2b9bae95b3840963aa.png" width="857"/>
    </p>
    <p>
     <strong>
      训练
    ...
    <p>
     <img alt="Loss = L_1+0.1L_{lpips}+0.05L_{adv}+10^{-6}L_{kl}" class="mathcode" src="https://latex.csdn.net/eq?Loss%20%3D%20L_1&amp;plus;0.1L_%7Blpips%7D&amp;plus;0.05L_%7Badv%7D&amp;plus;10%5E%7B-6%7DL_%7Bkl%7D"/>
    </p>
    <p>
     在训练过程中，作者采用
     <strong>
    ...
    <p>
     <img alt="" height="762" src="https://i-blog.csdnimg.cn/direct/392359a7a6574cae81c7a7f3ff4fddbc.png" width="1200"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <ol>
     ...
     <li>
      它支持图像和视频的统一生成，简化了训练过程并提高了模型的可扩展性。
     </li>
     <li>
      它更有效地利用了现有的大型语言模型（LLM）相关的加速能力，提高了训练和推理效率。模型结构如下图所示。
     </li>
    </ol>
    <p>
     <img alt="" height="752" src="https://i-blog.csdnimg.cn/direct/1b40d971cd5f4f5894658158a1f3c5a3.png" width="1200"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <ul>
     <li>
      ...
      <img alt="k_t\times k_h\times k_w" class="mathcode" src="https://latex.csdn.net/eq?k_t%5Ctimes%20k_h%5Ctimes%20k_w"/>
      的3D卷积分割成形状为
      <img alt="\frac{T}{k_t}\cdot \frac{H}{k_h}\cdot \frac{W}{k_w}" class="mathcode" src="https://latex.csdn.net/eq?%5Cfrac%7BT%7D%7Bk_t%7D%5Ccdot%20%5Cfrac%7BH%7D%7Bk_h%7D%5Ccdot%20%5Cfrac%7BW%7D%7Bk_w%7D"/>
      的1D token序列。
     </li>
     <li>
      对于文本分支，首先使用大
    ...
    <p>
     <img alt="L_{generation} = E_{t,x_0,x_1} \left \| v_t -u_t \right \|^2" class="mathcode" src="https://latex.csdn.net/eq?L_%7Bgeneration%7D%20%3D%20E_%7Bt%2Cx_0%2Cx_1%7D%20%5Cleft%20%5C%7C%20v_t%20-u_t%20%5Cright%20%5C%7C%5E2"/>
    </p>
    <p>
    ...
    <ol>
     ...
     <li>
      图像阶段2（混合比例训练）：作者发现在512px图像上微调后的模型在256px图像生成上的性能会严重下降，这可能影响到随后基于256px视频的视频预训练。因此，
      <strong>
       作者进行了混合比例训练
      </strong>
      ，
    ...
    <ol>
     <li>
      过滤掉没有音频流的视频或静音率超过80%的视频。
     </li>
     <li>
      采用帧级音频检测模型来检测音频流中的语音，音乐和一般声音。基于这种分析，我们将数据分为四个不同的类别：纯声音，语音，音乐和纯音乐。
     </li>
     <li>
      为了优先考虑高质量的数据，我们训练了模型来计算视听一致性得分，该得分量化了每个视频的视觉和听觉分量之间的对齐。使用这个评分系统结合音频类别标签，我们系统地从每个类别中抽取部分数据，从原始数据集中保留大约250，000小时用于预训练。
     </li>
     <li>
      对于监督微调阶段，我们进一步完善我们的选择，策划数百万个高质量剪辑的子集（80，000小时）。
     </li>
    </ol>
    <p>
     <span style="color:#f3f3f4;">
    ...
    <p>
     <img alt="" height="597" src="https://i-blog.csdnimg.cn/direct/fa4618e61c7c4739805a519c08737bef.png" width="1151"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <p>
     <img alt="" height="635" src="https://i-blog.csdnimg.cn/direct/d23c90f08aeb43cc80851365e5da55bc.png" width="1200"/>
    </p>
    <p>
     <strong>
      微调
    ...
    <p>
     <img alt="" height="735" src="https://i-blog.csdnimg.cn/direct/2830049b14fa413ea227234e1bd13715.png" width="1200"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <p>
     ...
     <img alt="z^{ref} \in R^{1\times c\times h\times w}" class="mathcode" src="https://latex.csdn.net/eq?z%5E%7Bref%7D%20%5Cin%20R%5E%7B1%5Ctimes%20c%5Ctimes%20h%5Ctimes%20w%7D"/>
     ，其中c = 16。然后，我们沿着时间维度重复t次，并在信道维度上与zt级联，以得到修改的噪声输入
     <img alt="\hat{z_{t}} \in R^{t\times2 c\times h\times w}" class="mathcode" src="https://latex.csdn.net/eq?%5Chat%7Bz_%7Bt%7D%7D%20%5Cin%20R%5E%7Bt%5Ctimes2%20c%5Ctimes%20h%5Ctimes%20w%7D"/>
     。为了实现可控的动画，采用了各种适配器。我们在下面描述它们。
    </p>
    <p>
     <img alt="" height="412" src="https://i-blog.csdnimg.cn/direct/8ed673f8a9234a8c97c580475422072d.png" width="1091"/>
    </p>
    ...
    <p>
     <img alt="" height="824" src="https://i-blog.csdnimg.cn/direct/79f57d8e6ddc4b35909ca6aa976c9754.png" width="1102"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <p>
     ...
     <strong>
      ...
      <img alt="z_{pose}" class="mathcode" src="https://latex.csdn.net/eq?z_%7Bpose%7D"/>
      的潜在空间。
     </strong>
     ...
     ，作为
     <img alt="\hat{z}_t + z_{pose}" class="mathcode" src="https://latex.csdn.net/eq?%5Chat%7Bz%7D_t%20&amp;plus;%20z_%7Bpose%7D"/>
     。注意，
     <img alt="\hat{z}_t" class="mathcode" src="https://latex.csdn.net/eq?%5Chat%7Bz%7D_t"/>
     包含参考图像的外观信息。我们使用预训练T2V权重的全参数微调作为初始化
    </p>
    <p>
     <img alt="" height="781" src="https://i-blog.csdnimg.cn/direct/e1341a4c11b44f9580ffd66b9a139eae.png" width="1079"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <p>
     ...
     ，如
     <img alt="z_{exp} \in R^{t\times n\times c}" class="mathcode" src="https://latex.csdn.net/eq?z_%7Bexp%7D%20%5Cin%20R%5E%7Bt%5Ctimes%20n%5Ctimes%20c%7D"/>
     ，其中n是每帧令牌的数量。通常，我们设置n = 16。与姿势条件不同，我们
     <strong>
      使用交叉注意注入
      <img alt="z_{exp}" class="mathcode" src="https://latex.csdn.net/eq?z_%7Bexp%7D"/>
     </strong>
     ，因为
     <strong>
      <img alt="\hat{z}" class="mathcode" src="https://latex.csdn.net/eq?%5Chat%7Bz%7D"/>
     </strong>
     和
     <strong>
      <img alt="z_{exp}" class="mathcode" src="https://latex.csdn.net/eq?z_%7Bexp%7D"/>
     ...
     <strong>
      将第i个DiT层之后的隐藏状态表示为
      <img alt="h_{i}" class="mathcode" src="https://latex.csdn.net/eq?h_%7Bi%7D"/>
      ，表达式
      <img alt="z_{exp}" class="mathcode" src="https://latex.csdn.net/eq?z_%7Bexp%7D"/>
      到
      <img alt="h_{i}" class="mathcode" src="https://latex.csdn.net/eq?h_%7Bi%7D"/>
     ...
     ：
     <strong>
      <img alt="h_i+Attn_{exp}(h_i,z_{exp},z_{exp})*M_{face}" class="mathcode" src="https://latex.csdn.net/eq?h_i&amp;plus;Attn_%7Bexp%7D%28h_i%2Cz_%7Bexp%7D%2Cz_%7Bexp%7D%29*M_%7Bface%7D"/>
     </strong>
     ，其中
     <strong>
      <img alt="M_{face}" class="mathcode" src="https://latex.csdn.net/eq?M_%7Bface%7D"/>
     </strong>
     是引导
     <strong>
      <img alt="z_{exp}" class="mathcode" src="https://latex.csdn.net/eq?z_%7Bexp%7D"/>
    ...
    <p>
     <img alt="" height="753" src="https://i-blog.csdnimg.cn/direct/f4e656651a414214820215d269480f3a.png" width="1079"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <p>
     <img alt="" height="565" src="https://i-blog.csdnimg.cn/direct/c07c2c17b9b342bbbb61ce8ee814224e.png" width="1097"/>
    </p>
    <p>
     <img alt="" height="663" src="https://i-blog.csdnimg.cn/direct/7aee139dcefa4b2f8e16a64a0b688b66.png" width="1079"/>
    </p>
    <p>
     <span style="color:#f3f3f4;">
      -
    ...
    <h2 id="4.%E4%BB%A3%E7%A0%81%E8%AF%A6%E8%A7%A3">
     4.代码详解
    </h2>
    <h3 id="%E7%8E%AF%E5%A2%83%E5%AE%89%E8%A3%85" style="background-color:transparent;">
     环境安装
    </h3>
    <p>
    ...
    <pre><code># 1. Prepare conda environment
...
python -m pip install git+https://github.com/Dao-AILab/flash-attention.git@v2.5.9.post1</code></pre>
    <p>
     当然，你也可以直接使用官方提供的docker
    </p>
    <pre><code># 1. Use the following link to download the docker image tar file (For CUDA 12).
...
docker run -itd --gpus all --init --net=host --uts=host --ipc=host --name hunyuanvideo --security-opt=seccomp=unconfined --ulimit=stack=67108864 --ulimit=memlock=-1 --privileged  docker_image_tag</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    ...
    <p>
     <img alt="" height="195" src="https://i-blog.csdnimg.cn/direct/8bfa3100180b4759bcfa098dbeae96ee.png" width="889"/>
     <strong>
      接着下载LLM
     </strong>
    ...
    <p>
     ...
     ：
     <a href="https://huggingface.co/openai/clip-vit-large-patch14" rel="nofollow" title="https://huggingface.co/openai/clip-vit-large-patch14">
...
python3 sample_video.py \
    ...
    <table>
     ...
     <tbody>
      ...
      <tr>
       ...
       <td>
        Embeded Classifier free guidance scale，自由引导比例
       </td>
      </tr>
      <tr>
       <td style="width:206px;">
       ...
       <td>
        Shift factor for flow matching schedulers，移位系数
       </td>
      </tr>
      <tr>
       <td style="width:206px;">
      ...
      <tr>
       ...
       <td>
        使用 CPU 卸载模型加载，以节省更多内存，这是生成高分辨率视频所必需的
       </td>
      </tr>
      <tr>
       <td style="width:206px;">
    ...
    for i, sample in enumerate(samples):
        ...
        logger.info(f'Sample save to: {save_path}')</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    </p>
    <h3 id="%E6%A8%A1%E5%9E%8B%E5%88%9D%E5%A7%8B%E5%8C%96" style="background-color:transparent;">
     模型初始化
    </h3>
    <pre><code class="language-python"># Load models   # 加载模型
hunyuan_video_sampler = HunyuanVideoSampler.from_pretrained(models_root_path, args=args)</code></pre>
    <p>
    ...
    <p>
     ...
     <strong>
      功能包括初始化vae、text_encoder、扩散模型等核心部件，然后通过cls初始化并返回一个实例
     </strong>
     ，而
     <strong>
      HunYuanVideoSampler类继承了父类的from_pretrained()方法，因此这里cls返回的是HunYuanVideoSampler的实例
     </strong>
    </p>
    <p>
     为了方便查看，我删去了部分代码：
    </p>
    <pre><code class="language-python">class Inference(object):
    ...
    @classmethod
    ...
    <pre><code class="language-python">class HunyuanVideoSampler(Inference):
    def __init__(...):
        super().__init__(...)
        ...
        self.default_negative_prompt = NEGATIVE_PROMPT      # 负面提示词</code></pre>
    <p>
     其中，load_diffusion_pipeline()如下
    </p>
    <pre><code class="language-python">def load_diffusion_pipeline(...):
    ...
    <pre><code class="language-python">PROMPT_TEMPLATE_ENCODE = (
...
PROMPT_TEMPLATE = {
    ...
    <h3 id="%E6%A8%A1%E5%9E%8B%E7%94%9F%E6%88%90">
     模型生成
    </h3>
    <p>
     主文件中：
    </p>
    <pre><code class="language-python">outputs = hunyuan_video_sampler.predict()</code></pre>
    <p>
...
def predict(...):
    ...
    <h4 id="HunyuanVideoPipeline.__call__()">
     HunyuanVideoPipeline.__call__()
    </h4>
    <pre><code class="language-python">samples = self.pipeline</code></pre>
    <p>
    ...
    <ol>
     <li>
      参数检查（对应官方注释0-2）：检查输入参数的有效性。没什么可说的，就不细讲了。
     </li>
     <li>
      编码提示词（对应官方注释3）：分别用llm和clipL(如果有)将正负文本提示转换为嵌入向量。
     </li>
     <li>
      准备时间步（对应官方注释4）：设置时间步长用于去噪过程。
     </li>
     <li>
      准备潜在变量（对应官方注释5）：初始化潜在变量。
     </li>
     <li>
      去噪循环（对应官方注释7）：通过多次迭代逐步减少噪声，生成最终的图像或视频帧。
     </li>
     <li>
      解码潜在变量（对应官方注释7）：将潜在变量解码为最终的图像或视频。
     </li>
     <li>
      返回结果：根据 output_type 返回生成的图像或视频。
     </li>
    </ol>
    <p>
     <span style="color:#f3f3f4;">
    ...
    <h4 id="%E7%BC%96%E7%A0%81%E6%8F%90%E7%A4%BA%E8%AF%8D" style="background-color:transparent;">
     编码提示词
    </h4>
    <p>
     这里就是使用大语言模型和clip对正负提示词进行编码
    </p>
    <pre><code class="language-python"># 3. Encode input prompt  分别用llm和clipL对文本进行编码
lora_scale = (
...
if self.text_encoder_2 is not None:
    ...
    <pre><code class="language-python">if self.do_classifier_free_guidance:     # 7.5&gt;1，默认会执行，将正负提示和掩码进行拼接
    ...
    if prompt_mask_2 is not None:
        prompt_mask_2 = torch.cat([negative_prompt_mask_2, prompt_mask_2])</code></pre>
    <h4 id="%E8%8E%B7%E5%8F%96%E6%97%B6%E9%97%B4%E6%AD%A5%E9%95%BF">
     获取时间步长
    </h4>
    <p>
     这里的目的是从调度器（scheduler）中获取时间步长
    </p>
    <pre><code class="language-python"># 4. Prepare timesteps
...
timesteps, num_inference_steps = retrieve_timesteps(    # 从调度器（scheduler）中获取时间步长
    ...
    **extra_set_timesteps_kwargs,
    ...
    <h4 id="%E5%87%86%E5%A4%87%E6%BD%9C%E5%9C%A8%E5%8F%98%E9%87%8F" style="background-color:transparent;">
     准备潜在变量
    </h4>
    <pre><code class="language-python"># 5. Prepare latent variables
...
latents = self.prepare_latents(
    ...
    <pre><code class="language-python">if latents is None:
    latents = randn_tensor(
        shape, generator=generator, device=device, dtype=dtype      # 调用 randn_tensor 生成随机噪声
    )
else:
    latents = latents.to(device)</code></pre>
    <p>
    ...
    <ol>
     <li>
      初始化进度条：使用 self.progress_bar 初始化一个进度条，总步数为 num_inference_steps。
     </li>
     <li>
      扩展潜在变量：
      <ol>
       <li>
        扩展潜在变量：根据 do_classifier_free_guidance 参数，决定是否对潜在变量 latents 进行扩展。如果启用，则将 latents 复制一份并拼接；否则保持不变。
       </li>
       <li>
        添加时间步长：调用 scheduler.scale_model_input 方法，将时间步长 t 添加到扩展后的潜在变量中。
       </li>
       <li>
        扩展时间步长和指导权重：将时间步长 t 扩展为与潜在变量形状相同的张量，并根据 embedded_guidance_scale 计算指导权重。
       </li>
      </ol>
     </li>
     <li>
      预测噪声残差：使用 self.transformer 预测噪声残差 noise_pred。
     </li>
     <li>
      执行引导：如果启用了分类器自由引导，对噪声残差进行引导处理。
      <ol>
       <li>
        如果启用了分类器自由引导（self.do_classifier_free_guidance为True），则将噪声预测结果noise_pred拆分为无条件部分noise_pred_uncond和有条件部分noise_pred_text。
       </li>
       <li>
        然后，根据引导比例self.guidance_scale调整噪声预测结果，使其偏向有条件部分。
       </li>
      </ol>
     </li>
     <li>
      调整噪声：如果启用了引导重缩放 (guidance_rescale)，进一步调整噪声。
      <ol>
       <li>
        如果同时启用了分类器自由引导和噪声预测的重新缩放（self.guidance_rescale大于0.0），则调用rescale_noise_cfg函数对噪声预测结果进行重新缩放。
       </li>
      </ol>
     </li>
     <li>
      计算前一个噪声样本：使用 self.scheduler.step 计算前一个噪声样本 latents。
     </li>
     <li>
      回调函数：在特定步骤调用回调函数 callback_on_step_end 和 callback，更新相关变量。
     </li>
     <li>
      更新进度条：在特定步骤更新进度条。
     </li>
    </ol>
    <pre><code class="language-python"># if is_progress_bar:
with self.progress_bar(total=num_inference_steps) as progress_bar:
    for i, t in enumerate(timesteps):
        ...
        if i == len(timesteps) - 1 or (
            ...
            if callback is not None and i % callback_steps == 0:
                ...
                callback(step_idx, t, latents)</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    </p>
    <h4 id="transformer%E6%9E%B6%E6%9E%84" style="background-color:transparent;">
     DiT的transformer架构
    </h4>
    <p>
     transformer的forward()函数的整体流程如下：
    </p>
    <pre><code class="language-python">class HYVideoDiffusionTransformer(ModelMixin, ConfigMixin):
    ...
    <h5 id="time_in%20%E6%97%B6%E9%97%B4%E5%B5%8C%E5%85%A5" style="background-color:transparent;">
     time_in 时间嵌入
    </h5>
    <p>
    ...
    <ol>
     <li>
      使用 timestep_embedding 函数生成时间步 t 的正弦嵌入向量 t_freq。
     </li>
     <li>
      将生成的嵌入向量 t_freq 转换为与 self.mlp 层权重相同的数据类型。
     </li>
     <li>
      使用 self.mlp 层对转换后的嵌入向量进行处理，生成最终的嵌入向量 t_emb。
     </li>
     <li>
      返回生成的嵌入向量 t_emb。
     </li>
    ...
    def forward(self, t):
        ...
        return t_emb</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    </p>
    <h5 id="text_modulation%20clip%E5%A4%84%E7%90%86%E7%9A%84%E5%90%91%E9%87%8F%E5%92%8C%E6%97%B6%E9%97%B4%E6%AD%A5%E5%90%91%E9%87%8F%E8%9E%8D%E5%90%88">
     text_modulation clip处理的向量和时间步向量融合
    </h5>
    <p>
     在输入transformer之前，我们已经用clip将文本处理好了，现在，我们需要使用MLP将clip的文本向量转换为和时间步向量尺寸相同的向量
    </p>
    <pre><code># text modulation
self.vector_in = MLPEmbedder(
    ...
    <pre><code>class MLPEmbedder(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -&gt; torch.Tensor:
        return self.out_layer(self.silu(self.in_layer(x)))</code></pre>
    <p>
    ...
    <pre><code># text modulation
vec = vec + self.vector_in(text_states_2)   # 时间步+clipl的向量</code></pre>
    <p>
    </p>
    <h5 id="%E5%9B%BE%E5%83%8F%20Patchify">
     图像 Patchify
    </h5>
    <p>
     在HYVideoDiffusionTransformer的__init__()函数中定义了img_in，也就是用于对图像切片的类PatchEmbed
    </p>
    <pre><code>self.img_in = PatchEmbed(
    ...
    <ol>
     <li>
      投影变换：通过 self.proj(x) 将输入张量 x 的形状从 [b, 3, t, h, w] 变换为
      <img alt="\left[ b, embeddim, \left\lfloor \frac{t}{patch size} \right\rfloor, \left\lfloor \frac{h}{patch size} \right\rfloor, \left\lfloor \frac{w}{patch size} \right\rfloor \right]" class="mathcode" src="https://latex.csdn.net/eq?%5Cleft%5B%20b%2C%20embeddim%2C%20%5Cleft%5Clfloor%20%5Cfrac%7Bt%7D%7Bpatch%20size%7D%20%5Cright%5Crfloor%2C%20%5Cleft%5Clfloor%20%5Cfrac%7Bh%7D%7Bpatch%20size%7D%20%5Cright%5Crfloor%2C%20%5Cleft%5Clfloor%20%5Cfrac%7Bw%7D%7Bpatch%20size%7D%20%5Cright%5Crfloor%20%5Cright%5D"/>
      。
     </li>
     <li>
      展平操作：如果 self.flatten 为 True，则将张量展平并转置，使其形状变为
    ...
    <h5 id="MLLM%E6%96%87%E6%9C%AC%20Refiner">
     MLLM文本 Refiner
    </h5>
    <p>
     使用带门控的自注意力，用于精细化处理单个令牌（Token）
    </p>
    <pre><code>elif self.text_projection == "single_refiner":
    txt = self.txt_in(txt, t, text_mask if self.use_attention_mask else None)   # SingleTokenRefiner</code></pre>
    <p>
     具体如下：
    </p>
    <pre><code>class SingleTokenRefiner(nn.Module):
    def __init__(...):
    ...
    <h5 id="%E5%8F%8C%E6%B5%81DiT">
     双流DiT
    </h5>
    <p>
     在transformer中的初始化方法
    </p>
    <pre><code># double blocks
self.double_blocks = nn.ModuleList(
    ...
    <pre><code class="language-python">class MMDoubleStreamBlock(nn.Module):
    ...
    <pre><code>self.img_mod = ModulateDiT(
    hidden_size,
    factor=6,
...
self.img_norm1 = nn.LayerNorm(
    ...
    <pre><code>class ModulateDiT(nn.Module):
    def __init__(...):
    ...
    def forward(self, x: torch.Tensor) -&gt; torch.Tensor:
        return self.linear(self.act(x))</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    </p>
    <h5 id="%E5%8D%95%E6%B5%81DiT">
     单流DiT
    </h5>
    <pre><code># single blocks
self.single_blocks = nn.ModuleList(
    ...
    <pre><code class="language-python">class MMSingleStreamBlock(nn.Module):
    ...
    def forward() -&gt; torch.Tensor:
        ...
        # 5.应用gate
        return x + apply_gate(output, gate=mod_gate)</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    ...
    <pre><code class="language-python">self.final_layer = FinalLayer(
    self.hidden_size,
    self.patch_size,
    self.out_channels,
    ...
    **factory_kwargs,
    ...
    <pre><code class="language-python">def unpatchify(self, x, t, h, w):
    ...
    imgs = x.reshape(shape=(x.shape[0], c, t * pt, h * ph, w * pw))     # 将张量重塑为 (N, C, T * pt, H * ph, W * pw) 并返回。</code></pre>
    <p>
    </p>
    <p>
     <span style="color:#f3f3f4;">
    ...
    <h4 id="%E8%A7%A3%E7%A0%81" style="background-color:transparent;">
     解码
    </h4>
    <p>
    ...
    <ol>
     <li>
      检查输出类型：如果 output_type 不是 "latent"，则继续执行后续步骤；否则，直接将 latents 赋值给 image。
     </li>
     <li>
      调整 latents 的维度：
      <ol>
       <li>
        如果 latents 的形状为 (b, c, h, w)，也就是图片，并且 vae 是 AutoencoderKLCausal3D 类型，则在第2维扩展 latents，形状变为形状为 (b, c, 1, w)，并设置 expand_temporal_dim 为 True。
       </li>
       <li>
        如果 latents 的形状为 (b, c, f, h, w)，则不进行任何操作。
       </li>
       <li>
        其他形状的 latents 将引发 ValueError。
       </li>
      </ol>
     </li>
     <li>
      ...
      <ol>
       <li>
        如果 vae 配置中有 shift_factor，则对 latents 进行缩放和偏移。
       </li>
       <li>
        否则，仅进行缩放。
       </li>
     ...
     <li>
      ...
      <ol>
       <li>
        使用 torch.autocast 进行自动混合精度计算。
       </li>
       <li>
        如果启用了 enable_tiling，则启用平铺解码。
       </li>
       <li>
        调用 self.vae.decode 方法解码 latents，生成 image。
       </li>
      </ol>
     </li>
     <li>
      ...
      <ol>
       <li>
        如果 expand_temporal_dim 为 True 或 image 的第2维为1，则压缩 image 的第2维。
       </li>
      </ol>
     </li>
    </ol>
    ...
    image = latents</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    </p>
    <h3 id="%E4%BF%9D%E5%AD%98%E8%A7%86%E9%A2%91" style="background-color:transparent;">
     保存视频
    </h3>
    <pre><code class="language-python"># Save samples
for i, sample in enumerate(samples):
    sample = samples[i].unsqueeze(0)
    ...
    save_videos_grid(sample, save_path, fps=24)     # 保存视频样本
    logger.info(f'Sample save to: {save_path}')     # 打印保存路径</code></pre>
    <p>
     保存视频的函数
    </p>
    <pre><code class="language-python">def save_videos_grid(videos: torch.Tensor, path: str, rescale=False, n_rows=1, fps=24):
    ...
    imageio.mimsave(path, outputs, fps=fps)     # 将所有图像帧保存为视频文件</code></pre>
    <p>
     <span style="color:#f3f3f4;">
      -
     </span>
    ...
    <h2 id="5.%E6%80%BB%E7%BB%93" style="background-color:transparent;">
     5.总结
    </h2>
    <p>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f736865726c6f636b4d612f:61727469636c652f64657461696c732f313434323635303237" class_="artid" style="display:none">
 </p>
</div>
