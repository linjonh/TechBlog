...
GROUP BY GROUPING SETS (
    ...
    <pre><code class="language-sql">-- 生成国家-省份-城市三级统计
GROUPING SETS (
...
GROUP BY GROUPING SETS ((region), ())
    ...
    <pre><code class="language-sql">SELECT 
    SUM(amount) / NULLIF(COUNT(region), 0) AS avg_amount</code></pre>
    <h5>
     2. 排序逻辑优化
    </h5>
...
。</code></pre>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34313932343533362f:61727469636c652f64657461696c732f313436313835343639" class_="artid" style="display:none">
 </p>
</div>
