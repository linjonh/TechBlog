...
1. "User=SYSDBA;Password=masterkey;Database=ray\_linn.fdb;Charset=NONE;ServerType=1"
...
1. FbConnection connection =
   new
   FbConnection(
   "User=SYSDBA;Password=masterkey;Database=ray\_linn.fdb;Charset=NONE;ServerType=1"
   );
2. connection.Open();
