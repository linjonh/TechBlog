...
T
\boldsymbol{x} = (x\_1, x\_2, \cdots, x\_n)^{\rm T}
...
\frac{\partial y}{\partial \boldsymbol{x}} = \begin{bmatrix} \dfrac{\partial y}{\partial x\_1} \\ \dfrac{\partial y}{\partial x\_2} \\ \vdots \\ \dfrac{\partial y}{\partial x\_n} \end{bmatrix}
