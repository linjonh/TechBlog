...
x = self.valueEmbedding(x.reshape(-1, self.seg\_num\_x, self.seg\_len))
...
[112, 5, 12]  # [batch\*feature, segments, segment\_length]
  
|
  
v  嵌入
  
[112, 5, 512]  # [batch\*feature, segments, d\_model]
