...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-tomorrow-night" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/9cdaf3a3d8464bb18a369716b3f7c3ca.png">
      <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/d359be665c3b49c780b96dc102d026b7.png"/>
    </p>
    <blockquote>
     <p>
    ...
    <pre><code class="prism language-python">        <span class="token keyword">for</span> item <span class="token keyword">in</span> ma_stand_s<span class="token punctuation">.</span>lod<span class="token punctuation">:</span>
            <span class="token keyword">if</span> item<span class="token punctuation">.</span>meta<span class="token punctuation">.</span>pid <span class="token keyword">in</span> insert_pids<span class="token punctuation">:</span>
                <span class="token comment"># 插入数据</span>
                insert_data<span class="token punctuation">.</span>append<span class="token punctuation">(</span><span class="token punctuation">{<!-- --></span>
                    <span class="token operator">**</span>filter_dict_by_keys<span class="token punctuation">(</span>item<span class="token punctuation">.</span>meta<span class="token punctuation">.</span><span class="token builtin">dict</span><span class="token punctuation">(</span>exclude_none<span class="token operator">=</span><span class="token boolean">True</span><span class="token punctuation">)</span> <span class="token punctuation">,</span><span class="token punctuation">[</span><span class="token string">'pid'</span><span class="token punctuation">,</span><span class="token string">'create_time'</span><span class="token punctuation">,</span><span class="token string">'update_time'</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token punctuation">,</span>   <span class="token comment"># 包含 pid、create_time、update_time、data_time</span>
                    <span class="token operator">**</span>item<span class="token punctuation">.</span>data 
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1c41b4fd7fe94f4c93a67a87dd5b0f22.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/18cbc4a7992d4593aaa4515e41223aaa.png">
       <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/dfb251013dab4620994c80a5c2f0bbb6.png">
      <br/>
      再次执行插入时，不会重复插入记录，但是时间开销是有的。所以，目前更合适小批量插入的情况。
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b25fe8d6b258475f98f1a2aab7dbadd8.png">
       <br/>
       ...
       的，这个倒是不错。
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/414e91c1b26a49618ef0fa107b5ef201.png"/>
      </img>
     </img>
    </p>
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e2f9e5f4b24640b09c903211c8cc10d6.png"/>
     <br/>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f79756b616930383030382f:61727469636c652f64657461696c732f313436313238383830" class_="artid" style="display:none">
 </p>
</div>
