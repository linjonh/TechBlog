 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     Windows 版的 Redis 官方已不再维护，你可以使用
     <strong>
      微软提供的 Redis for Windows 版本
     </strong>
     或者
     <strong>
    ...
    <ol>
     <li>
      ...
      <ul>
       <li>
        <a href="https://github.com/microsoftarchive/redis/releases" title="点击这里下载 Redis for Windows">
         点击这里下载 Redis for Windows
        </a>
        （推荐下载
        <code>
...
&lt;/dependency&gt;</code></pre>
    ...
    <pre><code class="language-XML">#配置redis
