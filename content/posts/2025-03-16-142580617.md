 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     详细介绍参考：
     <a href="https://cloud.tencent.com/developer/article/2377154" rel="nofollow" title="【开源项目推荐】Apache Superset——最优秀的开源数据可视化与数据探索平台-腾讯云开发者社区-腾讯云 (tencent.com)">
    ...
    <pre><code>git clone https://github.com/apache/superset.git</code></pre>
    <p>
     进入目录，并启动。
    </p>
...
docker-compose up</code></pre>
    ...
    <pre><code class="language-bash">superset-superset-worker-beat   latest    a9c41aaf3fa5   30 hours ago    2.05GB
...
sudo docker pull xx.xx.xx.xx:5000/registry:latest</code></pre>
    <p>
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f79756d696e672f:61727469636c652f64657461696c732f313432353830363137" class_="artid" style="display:none">
 </p>
</div>
