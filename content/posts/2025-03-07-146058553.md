...
2
\text{MSE} = \frac{1}{2n} \sum\_{i=1}^{n} (y\_i - \hat{y}\_i)^2
...
\boldsymbol{x\_1} = \boldsymbol{W\_1}\boldsymbol{x} + \boldsymbol{b\_1} \\ \boldsymbol{\sigma(x\_1)} = leaky\\_Relu(\boldsymbol{x\_1}) \\ \boldsymbol{x\_2} = \boldsymbol{W\_2}\boldsymbol{\sigma(x\_1)} + \boldsymbol{b\_2} \\ \boldsymbol{\sigma(x\_2)} = leaky\\_Relu(\boldsymbol{x\_2}) \\ \boldsymbol{y} = \boldsymbol{W\_3}\boldsymbol{\sigma(x\_2)} + \boldsymbol{b\_3} \\ \boldsymbol{\sigma(y)} = leaky\\_Relu(\boldsymbol{y})
...
\frac{d(\text{MSE})}{d\sigma(y)} = \frac{1}{n} \sum\_{i=1}^{n} (\sigma(y\_i) - \hat{y}\_i)
...
\text{MSE} = \frac{1}{2} ((y\_1 - \hat{y}\_1)^2 + (y\_2 - \hat{y}\_2)^2 + (y\_3 - \hat{y}\_3)^2)
...
\frac{d(MSE)}{dy} = \begin{bmatrix} \frac{\partial (MSE)}{\partial y\_1} \\ \frac{\partial(MSE)}{\partial y\_2} \\ \frac{\partial(MSE)}{\partial y\_3} \\ \end{bmatrix} = \begin{bmatrix} y\_1 - \hat{y\_1} \\ y\_2 - \hat{y\_2} \\ y\_3 - \hat{y\_3}\\ \end{bmatrix}
...
\frac{d(MSE)}{dy} = \begin{bmatrix} \frac{1}{n} \sum\_{i=1}^{n} y\_1 - \hat{y\_1^i} \\ \frac{1}{n} \sum\_{i=1}^{n} y\_2 - \hat{y\_2^i} \\ \frac{1}{n} \sum\_{i=1}^{n} y\_3 - \hat{y\_3^i}\\ \end{bmatrix}
...
\frac{d(MSE)}{dy} = \begin{bmatrix} \frac{1}{n} \cdot \alpha \cdot \sum\_{i=1}^{n} y\_1 - \hat{y\_1^i} \\ \frac{1}{n} \cdot 1 \cdot \sum\_{i=1}^{n} y\_2 - \hat{y\_2^i} \\ \frac{1}{n} \cdot 1 \cdot \sum\_{i=1}^{n} y\_3 - \hat{y\_3^i}\\ \end{bmatrix}
...
b
3
\boldsymbol{y} = \boldsymbol{W\_3}\boldsymbol{\sigma(x\_2)} + \boldsymbol{b\_3}
...
\begin{bmatrix} y \\ \end{bmatrix} = \begin{bmatrix} w\_{11}^3 & w\_{12}^3 \\ \end{bmatrix} \cdot \begin{bmatrix} \sigma(x\_{11}^2) \\ \sigma(x\_{21}^2) \end{bmatrix}
...
y = w\_{11}^3 \cdot \sigma(x\_{11}^2) + w\_{12}^3\cdot \sigma(x\_{21}^2)
...
\frac{dy}{d\boldsymbol{W\_3}} = \begin{bmatrix} \frac{\partial y}{\partial w\_{11}^3} &\frac{\partial y}{\partial w\_{12}^3} \end{bmatrix} = \begin{bmatrix} \sigma(x\_{11}^2) & \sigma(x\_{21}^2) \end{bmatrix}
...
\boldsymbol{W'\_3} = \begin{bmatrix} w\_{11}^3 - \alpha \cdot \frac{d(MSE)}{d\sigma(y)}\frac{d\sigma(y)}{dy} \sigma(x\_{11}^2) & w\_{12}^3 - \alpha \cdot \frac{d(MSE)}{d\sigma(y)} \frac{d\sigma(y)}{dy}\sigma(x\_{21}^2) \end{bmatrix}
...
Δ
y
\boldsymbol{\Delta\_{\sigma(x\_2)}} = \boldsymbol{W\_3^T} \cdot \boldsymbol{\Delta\_y}
