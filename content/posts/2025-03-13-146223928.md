...
import torch
import numpy as np
input\_tensor = torch.tensor([0.0, 1.0, 2.0, 3.0, 4.0])
normalized\_tensor = torch.atan(input\_tensor) \* (2.0 / np.pi)
print(normalized\_tensor)
输出：
...
# 使用 torch.atan 归一化数据
normalized\_tensor = torch.atan(input\_tensor) \* (2.0 / np.pi)
print("Input Tensor:", input\_tensor)
print("Normalized Tensor:", normalized\_tensor)
输出：
...
processed\_angles = torch.atan(angles)
print("Angles (radians):", angles)
print("Processed Angles:", processed\_angles)
输出：
...
transformed\_tensor = torch.atan(input\_tensor) \* (2.0 / np.pi)
print("Input Tensor:", input\_tensor)
print("Transformed Tensor:", transformed\_tensor)
输出：
Input Tensor: tensor([0., 1., 2., 3., 4.])
