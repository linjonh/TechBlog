 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h4>
     <img alt="" height="444" src="https://i-blog.csdnimg.cn/direct/43a85f65c029448bbbd13994c991dbea.png" width="2230"/>
    </h4>
    <p>
     <strong>
      MaskGCT 结构
    ...
    <p>
     <img alt="" height="476" src="https://i-blog.csdnimg.cn/direct/4f8b41757d254a21bb823dd6fcdca8dc.png" width="3202"/>
    </p>
    <h3>
     测试网站
    </h3>
    ...
    <p>
     <a href="https://sparktts.org/" rel="nofollow" title="Spark TTS - Text-to-Speech AI Model">
    ...
    <ul>
     <li>
      Go to
      <strong>
       <a href="https://github.com/SparkAudio/Spark-TTS" title="Spark-TTS GitHub">
        Spark-TTS GitHub
       </a>
      </strong>
     </li>
    ...
    <pre><code>conda create -n sparktts python=3.12 -y
conda activate sparktts</code></pre>
    <h3>
     <strong>
    ...
    <p style="text-align:center">
     <img alt="" height="264" src="https://i-blog.csdnimg.cn/direct/8269b82b6aa440a8a2dfee87faa9c751.png" width="673"/>
    </p>
    <p>
     <strong>
      安装 PyTorch
    ...
    <pre><code>conda install pytorch==2.5.1 torchvision==0.20.1 torchaudio==2.5.1 pytorch-cuda=12.4 -c pytorch -c nvidia</code></pre>
    <h3>
     <strong>
...
git clone https://huggingface.co/SparkAudio/Spark-TTS-0.5B pretrained_models/Spark-TTS-0.5B</code></pre>
    <h4>
     遇到问题
    </h4>
    <p>
    ...
    <pre><code>variable KMP_DUPLICATE_LIB_OK=TRUE to allow the program to continue to execute, but that may cause crashes or silently produce incorrect results. For more information, please see http://www.intel.com/software/products/support/.</code></pre>
    <p>
     办法
    </p>
    <p>
    ...
    <pre><code>D:\Users\Yao\anaconda3\Library\bin\libiomp5md.dll</code></pre>
    <p>
     2 设置临时环境变量：KMP_DUPLICATE_LIB_OK=TRUE
    </p>
    <pre><code>  set KMP_DUPLICATE_LIB_OK=TRUE</code></pre>
    <p>
     也在windows 下设置了。
    </p>
    <h4>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/f2addbf8f66c43268a88222c2aa27d0e.png"/>
    </p>
    <p>
...
print(audio_output_path)
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f79616f6a696177616e2f:61727469636c652f64657461696c732f313436313634313534" class_="artid" style="display:none">
 </p>
</div>
