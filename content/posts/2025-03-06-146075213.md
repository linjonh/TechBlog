 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <h3>
     <a id="httpsdevmysqlcomdocrefman57eninnodbconsistentreadhtml_13">
     </a>
     <a href="https://dev.mysql.com/doc/refman/5.7/en/innodb-consistent-read.html" rel="nofollow">
      一致性非锁定读
     </a>
    </h3>
    <ul>
    ...
    <h3>
     <a id="httpsdevmysqlcomdocrefman57eninnodblockingreadshtml_18">
     </a>
     <a href="https://dev.mysql.com/doc/refman/5.7/en/innodb-locking-reads.html" rel="nofollow">
      锁定读
     </a>
    </h3>
    <p>
...
<span class="token keyword">private</span><span class="token operator">:</span>
  trx_id_t m_low_limit_id<span class="token punctuation">;</span>      <span class="token comment">/* 大于等于这个 ID 的事务均不可见 */</span>

  trx_id_t m_up_limit_id<span class="token punctuation">;</span>       <span class="token comment">/* 小于这个 ID 的事务均可见 */</span>
...
<span class="token punctuation">}</span>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/195bf5b4c97849b384276dada1f21a27.png"/>
    </p>
    <h2>
     <a id="_124">
     </a>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33393837313537392f:61727469636c652f64657461696c732f313436303735323133" class_="artid" style="display:none">
 </p>
</div>
