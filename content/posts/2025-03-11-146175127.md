...
#### 1、context\_click(element) # 右击 2、double\_click(element)  #双击 3、double\_and\_drop(source, target)  # 拖拽 4、move\_to\_element(element)  # 悬停 【重点】 5、perform()  # 执行以上事件的方法 【重点】
...
driver.implicitly\_wait(30) # 一般情况下设置30秒
