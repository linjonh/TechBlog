...
![](https://i-blog.csdnimg.cn/direct/6be28c0ad4cd4669a1dbab113931639e.png)![](https://i-blog.csdnimg.cn/direct/16eb7cfb5901482294c5a24c6714ba16.png)

#### 百度原因：

  1. **事件冒泡** ：在 Vue 中，事件默认是会冒泡的。当你点击某个操作列按钮时，事件会从该元素冒泡到它的父元素。如果 `el-table` 的 `@row-click` 被监听，它会捕获到这一冒泡事件并触发对应的处理方法。
