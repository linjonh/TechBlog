...
| **READ\_UNCOMMITTED** | ✔️ | ✔️ | ✔️ | 最低隔离级别，性能高但数据一致性差 |
| **READ\_COMMITTED** | ✖️ | ✔️ | ✔️ | 避免脏读（Oracle 默认） |
| **REPEATABLE\_READ** | ✖️ | ✖️ | ✔️ | 避免脏读和不可重复读（MySQL 默认） |
