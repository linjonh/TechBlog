 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <h6>
     <a id="_node__v20180____npm_1110_0">
     </a>
...
npm install -g @vue/cli
    ...
    <pre><code>// 加上这个，vue build后，发布的页面不会出现白板
module.exports = {
    ...
    <pre><code>// package.json
{
  ...
  ...
    ...
    <h4>
     <a id="Electronelectronbuilder_178">
     </a>
    ...
    <pre><code>// package.json
{
  ...
  ...
    ...
    <ul>
     <li>
      <h6>
       <a id="electronelectronbuilderyml_223">
       </a>
...
nsis:
  ...
  createStartMenuShortcut: true # 创建开始菜单快捷方式
    ...
    <ul>
     <li>
      <h5>
       <a id="_dotenvwebpack__dotenvflow_256">
       </a>
       安装 dotenv-webpack dotenv-flow
      </h5>
     </li>
    </ul>
    <pre><code>npm install dotenv-webpack dotenv-flow --save-dev
</code></pre>
    <ul>
     <li>
      <h5>
       <a id="vueconfigjs_262">
       </a>
       修改vue.config.js
      </h5>
     </li>
