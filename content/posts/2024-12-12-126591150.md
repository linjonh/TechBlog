---
arturl_encode: "68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343732373038302f:61727469636c652f64657461696c732f313236353931313530"
layout: post
...
[<live-pusher>](https://developers.weixin.qq.com/miniprogram/dev/component/live-pusher.html " <live-pusher>")
和
[<live-player>](https://developers.weixin.qq.com/miniprogram/dev/component/live-player.html "<live-player>")
标签的支持：
...
* 符合类目要求的小程序，需要在小程序管理后台的【设置】>【接口设置】中自助开通该组件权限，如下图所示：
  ...
  ![](https://i-blog.csdnimg.cn/blog_migrate/4317bb4c000fdabd5c4a8c7587af4f16.png)
...
[Windows SDK](https://cloud.tencent.com/document/product/647/32689 "Windows SDK")
。
...
* **src**
  ...
  `.flv`
  结尾） ，腾讯云推流 URL 的获取方法见
  [如何生成推流 URL](https://cloud.tencent.com/document/product/454/7915 "如何生成推流 URL")
  。
...
* **debug**
  ...
  [FAQ](https://cloud.tencent.com/document/product/454/7946 "FAQ")
  中有详细说明。
