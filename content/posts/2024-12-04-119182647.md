...
> GET
>   
> https://api.weixin.qq.com/cgi-bin/token?grant\_type=client\_credential&appid=你的小程序appid&secret=你的小程序secret

**2、获取二维码**

> POST
>   
> https://api.weixin.qq.com/wxa/getwxacodeunlimit?access\_token= 获取到的access\_token
>   
> body参数：
>   
> scene: ‘a=1’,//跳转带参
