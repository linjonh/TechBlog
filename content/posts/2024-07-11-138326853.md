...
# 程序媛的mac修炼手册-- 2024如何彻底卸载Python\_mac系统如何清除python安装环境
...
上述命令执行后，将列出/usr/local/bin目录中所有包含单词‘python’的文件。找到你想卸载的Python版本相关联的文件，输入以下命令行，将file\_name替换为你要删除的文件的实际名称。
