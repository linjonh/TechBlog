---
arturl_encode: "68747470733a2f2f626c6f:672e6373646e2e6e65742f6279746564616e63656f73706f2f:61727469636c652f64657461696c732f313436313534373534"
layout: post
title: "vArmor云原生容器安全的多场景应用实践"
date: 2025-03-10 16:06:03 +08:00
...
[AppArmor LSM](https://en.wikipedia.org/wiki/AppArmor "AppArmor LSM")
，
[BPF LSM](https://docs.kernel.org/bpf/prog_lsm.html "BPF LSM")
和
[Seccomp](https://en.wikipedia.org/wiki/Seccomp "Seccomp")
...
![](https://i-blog.csdnimg.cn/direct/b5e545f3f9d249c1a0730f62accb9bfd.png)
...
![](https://i-blog.csdnimg.cn/direct/a9ed41b24ed7438da7521917ad0b2c90.png)
...
* **行为建模模式**
  ：使用实验功能 ——
  [行为建模模式](https://www.varmor.org/zh-cn/docs/main/guides/policies_and_rules/policy_modes/behavior_modeling/ "行为建模模式")
  ，对目标应用进行建模。建模完成后使用
  [策略顾问](https://www.varmor.org/zh-cn/docs/main/guides/policy_advisor "策略顾问")
  来生成沙箱策略模版，辅助沙箱策略的制定。
...
[内置规则](https://www.varmor.org/zh-cn/docs/main/guides/policies_and_rules/built_in_rules "内置规则")
和
[自定义规则](https://www.varmor.org/zh-cn/docs/main/guides/policies_and_rules/custom_rules "自定义规则")
...
例如，在拥有 CAP\_SYS\_ADMIN capability 的容器中，通过改写宿主机的 core\_pattern 来逃逸容器是常见的攻击手法。如下所示，攻击者可以通过挂载新的 procfs、重新挂载 procfs、移动 procfs 挂载点等方式获取宿主机 core\_pattern 文件的写权限。
...
[使用说明](https://www.varmor.org/zh-cn/docs/main/guides/policies_and_rules/policy_modes/behavior_modeling/#%E4%BD%BF%E7%94%A8%E8%AF%B4%E6%98%8E "使用说明")
...
1. [PEACH: A Tenant Isolation Framework for Cloud Applications](https://www.datocms-assets.com/75231/1671033753-peach_whitepaper_ver1-1.pdf "PEACH: A Tenant Isolation Framework for Cloud Applications")
2. [Kubernetes Privilege Escalation: Excessive Permissions in Popular Platforms](https://www.paloaltonetworks.com/apps/pan/public/downloadResource?pagePath=/content/pan/en_US/resources/whitepapers/kubernetes-privilege-escalation-excessive-permissions-in-popular-platforms "Kubernetes Privilege Escalation: Excessive Permissions in Popular Platforms")
3. [Pod Security Standards](https://kubernetes.io/docs/concepts/security/pod-security-standards/ "Pod Security Standards")
4. [2024 Data Breach Investigations Report](https://www.verizon.com/business/resources/Te3/reports/2024-dbir-data-breach-investigations-report.pdf "2024 Data Breach Investigations Report")
5. [#BrokenSesame: Accidental ‘write’ permissions to private registry allowed potential RCE to Alibaba Cloud Database Services](https://www.wiz.io/blog/brokensesame-accidental-write-permissions-to-private-registry-allowed-potential-r "#BrokenSesame: Accidental ‘write’ permissions to private registry allowed potential RCE to Alibaba Cloud Database Services")
