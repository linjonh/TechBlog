...
#### 源码地址
https://github.com/geeeeeeeek/python\_hospital
#### 演示地址
...
CREATE DATABASE IF NOT EXISTS python\_hospital DEFAULT CHARSET utf8 COLLATE utf8\_general\_ci
(4) 恢复xxx.sql数据。在mysql下依次执行如下命令：
mysql> use python\_hospital;
...
##### 常见问题
\* 连接后端失败怎么办？
编辑前端的constants.js文件，将base\_url设置为你自己电脑的ip和端口
\* 需要什么数据库版本？
