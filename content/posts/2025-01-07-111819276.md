...
# datatable筛选条件\_DataTables 多条件查询、多列搜索
...
$(\_$this.selector + '\_wrapper .dataTables\_filter').append(searchHTML);

//重写搜索事件

$(\_$this.selector + '\_wrapper .dataTables\_filter input').bind('keyup',
...
"url": "../assets/lib/datatables/datatables\_language.json"
...
checkboxClass: 'icheckbox\_minimal',
