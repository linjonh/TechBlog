 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     <img alt="" height="473" src="https://i-blog.csdnimg.cn/blog_migrate/afc6ddfe21f4e64e3227296e6bd5498f.png" width="842"/>
    </p>
    <p>
     <a href="https://blog.csdn.net/hzp666/article/details/96854876" title="https://blog.csdn.net/hzp666/article/details/96854876">
      https://blog.csdn.net/hzp666/article/details/96854876
     </a>
     转载：
     <a href="http://developer.51cto.com/art/201003/189724.htm" rel="nofollow" title="点击打开链接">
      点击打开链接
     </a>
    </p>
    <p>
    ...
    <ul>
     <li>
      <a href="http://developer.51cto.com/art/200509/3236.htm" rel="nofollow" title="使用Java JDK中Java.net包控制UDP协议">
       使用Java JDK中Java.net包控制UDP协议
      </a>
     </li>
     <li>
      <a href="http://developer.51cto.com/art/200512/12849.htm" rel="nofollow" title="通过Java.net.Socket 类抓取网页内容">
       通过Java.net.Socket 类抓取网页内容
      </a>
     </li>
     <li>
      <a href="http://developer.51cto.com/art/200610/32990.htm" rel="nofollow" title="通过java.net.Socket类抓取网页内容">
       通过java.net.Socket类抓取网页内容
      </a>
     </li>
     <li>
      <a href="http://developer.51cto.com/art/200707/50555.htm" rel="nofollow" title="通过Java.net包建立双向通讯">
       通过Java.net包建立双向通讯
      </a>
     </li>
     <li>
      <a href="http://developer.51cto.com/art/200906/127443.htm" rel="nofollow" title="用来访问HTTP服务器的仿java.net功能类">
    ...
    <p>
     b)
     <a href="http://lib.csdn.net/base/javase" rel="nofollow" title="Java">
      Java
     </a>
     的GC不能关闭网络连接打开的文件句柄，如果没有执行close()则文件句柄将一直存在，而不能被关闭。也可以考虑设置socket的最大打开数来控制这个问题。对
     <a href="http://lib.csdn.net/base/operatingsystem" rel="nofollow" title="操作系统">
      操作系统
     </a>
     做相关的设置，增加最大文件句柄数量。ulimit -a可以查看系统目前资源限制，ulimit -n 10240则可以修改，这个修改只对当前窗口有效。
    </p>
    <p>
     <img alt="" height="206" src="https://i-blog.csdnimg.cn/blog_migrate/ab00441dcade12d3ce2476c11ebe690c.png" width="400"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f687a70363636:2f61727469636c652f64657461696c732f3936383534383736" class_="artid" style="display:none">
 </p>
</div>
