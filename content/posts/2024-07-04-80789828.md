...
SELECT \* from  ag\_actv  LIMIT 1050

我们得到是 ag\_actv 表中的1050行记录
...
SELECT \* from  (SELECT \* from ag\_actv   LIMIT 1050) sq WHERE sq.seq\_num  not in  (SELECT seq\_num  from ag\_actv  LIMIT 1000)
