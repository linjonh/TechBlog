---
arturl_encode: "68747470733a2f2f626c6f672e63:73646e2e6e65742f636861726c69653131343531343139312f:61727469636c652f64657461696c732f313436313237393135"
layout: post
title: "IMX6ULL驱动开发Linux篇01"
date: 2025-03-09 09:51:05 +08:00
...
笔者后续可能会使用SD卡传递到板子上，我们的NXP官方有根据自己家的烧录做过mfgtools文件，自然，我们有一个相应的适配文件imx\_v7\_mfg\_defconfig，所以魔改这个，当然，imx\_v7\_defconfig也是可以的，就是没办法扔到mfgtools搞烧写了。
...
还有一个事情，修改Makefile（arch/arm/boot/dts下的Makefile文件），添加设备树文件进去，不然找不到的，在CONFIG\_SOC\_IMX6ULL那个地方，我们添加上自己的设备树文件，但是注意是dtb文件，因为这是编译的目标
...
![](https://i-blog.csdnimg.cn/direct/08dedbb9ed5c474ba1ec53ce3c74402a.png)
...
![](https://i-blog.csdnimg.cn/direct/797c848cfe174b5ebc73c91d98ab88f6.png)
...
我们需要删除掉SNVS\_TAMPER7 和 SNVS\_TAMPER8这两个引脚。
...
依次对fec1和fec2，修改pinctrl-0加入pinctrl\_enet1\_reset,之后再添加下面的这些信息
...
最后，我们要做的是——修改一下drivers/net/ethernet/freescale/fec\_main.c
