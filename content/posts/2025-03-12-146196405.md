 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-dracula" id="content_views">
    ...
    <pre><code class="prism language-bash">当前显示页位置：<span class="token punctuation">[</span>n<span class="token punctuation">]</span>
保留页范围：n-1 <span class="token operator">&lt;</span>-<span class="token operator">&gt;</span> n+1
</code></pre>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/84018d1ca76d41159460847539de72c1.png"/>
    </p>
    <ol start="2">
     <li>
      6个Fragment场景示例
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/60d1e51660bf476fbd0fc2cd455aecbb.png"/>
    </p>
    <h3>
     <a id="_49">
     </a>
    ...
    <ol start="2">
     <li>
      Fragment 生命周期控制
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e5687b75282443168b67b78abddd70aa.png"/>
     </li>
     <li>
      两种适配器区别
     </li>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c0827525a0a34444bd2010f854048d72.png"/>
    </p>
    <h3>
     <a id="_67">
     </a>
...
override fun onDestroyView() {
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f797a706272696768742f:61727469636c652f64657461696c732f313436313936343035" class_="artid" style="display:none">
 </p>
</div>
