...
# android应用编译失败 ResXMLTree\_node size 类错误，以及 android studio 项目内搜索
...
ResXMLTree\_node size 0 is smaller than header size 0x45. 类似这样的错误，提示中看不出任何有用的内容，网上搜索也没多少资料，很难定位问题在哪儿出现的。
