---
layout: post
title: "v0.29.1-敏感词性能优化之内部类迭代器内部类"
date: 2025-09-06T19:10:23+0800
description: "至于多的那一次边界检查，HotSpot JIT 会自动优化大部分边界检查，不需要过度担心。压测时发现 init 内部类，和默认的 for 循环迭代器其实还是会造成额外的性能开销。以前为了整合 format、check 接口，模仿 netty 的 init 写法。压测时发现 init 重复初始化，导致额外的开销，还是改成直接普通的集合类。可以考虑优化一下，后续统一在 opencc4j 中优化。说明：原先依赖的 opencc4j，有点重。也就是大约 21.3% 的提升。5 次，压 5W 次。"
keywords: "v0.29.1 敏感词性能优化之内部类+迭代器内部类"
categories: ['Nlp']
tags: ['敏感词', '性能优化', '开源', 'Nlp', 'Github']
artid: "151261091"
arturl: "https://blog.csdn.net/ryo1060732496/article/details/151261091"
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=151261091
    alt: "v0.29.1-敏感词性能优化之内部类迭代器内部类"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=151261091
featuredImagePreview: https://bing.ee123.net/img/rand?artid=151261091
cover: https://bing.ee123.net/img/rand?artid=151261091
image: https://bing.ee123.net/img/rand?artid=151261091
img: https://bing.ee123.net/img/rand?artid=151261091
---
...
[v0.29.3 依赖的繁简体转换 opencc4j 优化](https://houbb.github.io/2025/08/29/sensitive-word-v0.29.3-opencc4j-opt)
