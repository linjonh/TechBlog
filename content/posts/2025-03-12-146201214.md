 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="917" src="https://i-blog.csdnimg.cn/direct/1e8c889e7efc4c738688b0ebf7bc8dd2.png" width="1445"/>
    </p>
    <p>
     代码如下：
    </p>
...
// 将加密结果设置为jmeter参数
vars.put("AES_value",value);</code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f72616d73657931372f:61727469636c652f64657461696c732f313436323031323134" class_="artid" style="display:none">
 </p>
</div>
