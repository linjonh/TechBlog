...
if __name__ == '__main__':
    ...
    <p>
     ...
     <a href="http://views.py/" rel="nofollow" title="views.p">
      views.p
     </a>
     <a href="http://views.py/" rel="nofollow" title="y">
      y
     </a>
...
def register_user(request):
    if request.method == 'POST':
        ...
        return JsonResponse({'status': 'error','message': 'Only POST method is allowed'}, status = 405)</code></pre>
    <p>
     3. 基于 FastAPI 框架
    </p>
    <p>
...
print(f"The result of addition is: {result}")</code></pre>
    <p>
     2. json-rpc
    </p>
    <p>
...
if __name__ == '__main__':
    ...
    <pre><code class="language-python">import jsonrpclib

server = jsonrpclib.Server('http://localhost:8001')
result = server.multiply(4, 6)
print(f"The result of multiplication is: {result}")</code></pre>
    <p>
     3. gRPC
    </p>
    <p>
...
if __name__ == '__main__':
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f32393439313636332f:61727469636c652f64657461696c732f313436323837313336" class_="artid" style="display:none">
 </p>
</div>
