...
(1) JAVA\_HOME（写JDK安装目录）
  
(2) CLASSPATH（.;%JAVA\_HOME%\lib\dt.jar; %JAVA\_HOME%\lib\tools.jar;%JAVA\_HOME%\bin）
  
(3) PATH（;%JAVA\_HOME%\bin）
...
.;%JAVA\_HOME%\lib\dt.jar;%JAVA\_
  
HOME%\lib\tools.jar;%JAVA\_HOME
