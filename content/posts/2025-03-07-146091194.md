...
> 用示例讲解下渲染进程到主进程的单向通信
>   
> 初始版本项目结构可参考项目：https://github.com/ylpxzx/electron-forge-project/tree/init\_project
...
>   
> 完整项目示例：https://github.com/ylpxzx/electron-forge-project/tree/render\_to\_main
