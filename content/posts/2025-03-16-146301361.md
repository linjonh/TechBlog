 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <h2>
     <a class="link-info" href="https://leetcode.cn/problems/remove-all-adjacent-duplicates-in-string/description/" rel="nofollow" title="1.删除字符串中所有相邻的重复字符">
      1.删除字符串中所有相邻的重复字符
     </a>
     <img alt="" height="801" src="https://i-blog.csdnimg.cn/direct/4a68c64f010a40b39d5b9ba82d85d7ce.png" width="1353"/>
    </h2>
    <p>
    ...
    <p>
     ...
     <span style="background-color:#ff9900">
      <img alt="" height="843" src="https://i-blog.csdnimg.cn/direct/a9fd6c3358b44d43a26e800bca1d6d35.png" width="1881"/>
     </span>
    </p>
    <p>
...
public:
    ...
    <hr/>
    <h2>
     <a class="link-info" href="https://leetcode.cn/problems/backspace-string-compare/description/" rel="nofollow" title="2.比较含退格的字符串">
      2.比较含退格的字符串
     </a>
     <img alt="" height="994" src="https://i-blog.csdnimg.cn/direct/b5e672bcbe0645b486f0c3f59f69ead5.png" width="1359"/>
    </h2>
    <p>
     <strong>
      解法1：使用栈来模拟
    ...
    <pre><code class="language-cpp">bool _backspaceCompare(string s, string t) 
{
...
string reBulidString(string str)
{
    ...
    <pre><code class="language-cpp">    bool backspaceCompare(string s, string t) 
    {
    ...
    <hr/>
    <h2>
     <a class="link-info" href="https://leetcode.cn/problems/basic-calculator-ii/description/" rel="nofollow" title="3.基本计算器2">
      3.基本计算器2
     </a>
     <img alt="" height="858" src="https://i-blog.csdnimg.cn/direct/8e40bc7bf6094961a55012ff4e616f3b.png" width="1337"/>
    </h2>
    <p>
     <strong>
      解法：栈模拟
...
public:
    ...
    <hr/>
    <h2>
     <a class="link-info" href="https://leetcode.cn/problems/decode-string/description/" rel="nofollow" title="4.字符串解码">
      4.字符串解码
     </a>
     <img alt="" height="966" src="https://i-blog.csdnimg.cn/direct/fd4b767d6c5f454180759738ec139cb4.png" width="1215"/>
    </h2>
    <p>
...
public:
    ...
    <hr/>
    <h2>
     <a class="link-info" href="https://leetcode.cn/problems/validate-stack-sequences/description/" rel="nofollow" title="5.验证栈序列">
      5.验证栈序列
     </a>
     <img alt="" height="828" src="https://i-blog.csdnimg.cn/direct/1533d795003b48d68ddbcfed6d63ea78.png" width="1137"/>
    </h2>
    <p>
...
public:
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f787363323030347a796a2f:61727469636c652f64657461696c732f313436333031333631" class_="artid" style="display:none">
 </p>
</div>
