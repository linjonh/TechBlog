...
* + [Tool.h (usart.c配置使用到这里的 \*\*MY\_NVIC\_Init()\*\* 函数)](#Toolh_usartc_MY_NVIC_Init__31)
  + [usart.h](#usarth_68)
  + [usart.c](#usartc_104)
  + [main.c](#mainc_281)
  + [现象结果](#_411)
* [三、编写为wifi模块服务的文件。](#wifi_415)
* + [esp\_8622wifi.h](#esp_8622wifih_418)
  + [esp\_8622wifi.c](#esp_8622wific_443)
  + [main.c](#mainc_633)
  + [现象结果](#_673)
...
串口3与ATK\_ESP8266WIFI模块交互，用来发送AT指令，接收WIFI模块的响应信息。
  
配置如下：

### Tool.h (usart.c配置使用到这里的 **MY\_NVIC\_Init()** 函数)
