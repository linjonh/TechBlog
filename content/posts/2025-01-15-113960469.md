...
# pycharm查询mysql数据库\_如何使用PyCharm查看SQLite数据库中的哪些数据？
...
restaurant\_id = Column(Integer, ForeignKey("restaurant.id"))

restaurant = relationship(Restaurant)

engine = create\_engine('sqlite:///restaurant.db')
