...
description: "其它机器学习、深度学习算法的全面系统讲解可以阅读《"
keywords: 机器学习所需数学知识
categories: ['深度学习Deeplearning']
tags: ['深度学习Deeplearning', '机器学习', '数据挖掘']
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=80733205
    alt: 学好机器学习需要哪些数学知识
artid: 80733205
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=80733205
featuredImagePreview: https://bing.ee123.net/img/rand?artid=80733205
---
