...
artid: "54405383"
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=54405383
    alt: "浅谈区块链的现状与未来"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=54405383
featuredImagePreview: https://bing.ee123.net/img/rand?artid=54405383
---
...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p style="color:rgb(85,85,85); padding-top:0px; padding-bottom:0px; margin-top:0px; margin-bottom:0px">
    ...
    <h2 style="margin:0px; padding:0px; color:rgb(85,85,85)">
     <span style="font-family:KaiTi_GB2312; font-size:18px">
    ...
    <div style="color:rgb(85,85,85)">
     <span style="color:#333333">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <img alt="" src="https://img-blog.csdn.net/20161210233054056" style="border:currentColor; max-height:100%; max-width:100%">
        <br/>
       </img>
      </span>
     </span>
    ...
    <div style="color:rgb(85,85,85)">
     <span style="color:#333333">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <img alt="" src="https://img-blog.csdn.net/20161210235006348" style="border:currentColor; max-height:100%; max-width:100%">
        <br/>
       </img>
      </span>
     </span>
    ...
    <div style="color:rgb(85,85,85)">
     <span style="color:#333333">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <img alt="" src="https://img-blog.csdn.net/20161210235327068" style="border:currentColor; max-height:100%; max-width:100%">
        <br/>
       </img>
      </span>
     </span>
    ...
    <h3 style="margin:0px; padding:0px; color:rgb(85,85,85)">
     <span style="font-family:KaiTi_GB2312; font-size:18px">
    ...
    <div style="color:rgb(85,85,85)">
     ...
     <h2 style="margin:0px; padding:0px; line-height:38px">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
    ...
    <div style="color:rgb(85,85,85)">
     <span style="color:#333333">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <img alt="" src="https://img-blog.csdn.net/20161211111920516" style="border:currentColor; max-height:100%; max-width:100%">
        <br/>
       </img>
      </span>
     </span>
    ...
    <div style="color:rgb(85,85,85)">
     ...
     <p style="color:rgb(51,51,51); padding-top:0px; padding-bottom:0px; margin-top:0px; margin-bottom:10px">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <span style="font-weight:700">
        <a href="http://www.oschina.net/p/Microsoft-bletchley" rel="nofollow noopener noreferrer" style="background:0px 0px; color:rgb(0,162,202); text-decoration:none" target="_blank">
     ...
     <div>
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <img alt="" src="https://img-blog.csdn.net/20161211112911998" style="border:currentColor; max-height:100%; max-width:100%">
        <br/>
       </img>
      </span>
     </div>
     <div>
      <span style="color:#0a2ca; font-weight:700">
       <a href="http://www.oschina.net/p/hyperledger-fabric" rel="nofollow noopener noreferrer" style="color:rgb(0,162,202); text-decoration:none" target="_blank">
        <span style="font-family:KaiTi_GB2312; font-size:18px">
         Hyperledger Fabric
        </span>
       </a>
    ...
    <div style="color:rgb(85,85,85)">
     ...
     <ul style="margin:0px 0px 10px; padding:0px 0px 0px 40px; color:rgb(51,51,51); list-style-position:inside">
     ...
     <span style="font-family:KaiTi_GB2312; font-size:18px">
      <span style="color:#0a2ca; font-weight:700">
       <a href="http://www.oschina.net/p/openchain" rel="nofollow noopener noreferrer" style="color:rgb(0,162,202); text-decoration:none" target="_blank">
    ...
    <div style="color:rgb(85,85,85)">
     <span style="color:#333333">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <img alt="" src="https://img-blog.csdn.net/20161211113134523" style="border:currentColor; max-height:100%; max-width:100%">
        <br/>
       </img>
      </span>
     </span>
    ...
    <div style="color:rgb(85,85,85)">
     <span style="color:#333333">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <span style="font-weight:700">
        <a href="http://www.oschina.net/p/bitshares" rel="nofollow noopener noreferrer" style="background:0px 0px; color:rgb(0,162,202); text-decoration:none" target="_blank">
    ...
    <div style="color:rgb(85,85,85)">
     ...
     <p style="color:rgb(51,51,51); padding-top:0px; padding-bottom:0px; margin-top:0px; margin-bottom:10px">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <span style="font-weight:700">
        <a href="https://github.com/IBM-Blockchain/marbles" rel="noopener noreferrer" style="background:0px 0px; color:rgb(0,162,202); text-decoration:none" target="_blank">
         IBM-Blockchain-marbles
        </a>
       </span>
       <br/>
       IBM 本家基于
       <a class="replace_word" href="http://lib.csdn.net/base/bluemix" rel="nofollow noopener noreferrer" style="color:rgb(223,52,52); font-weight:bold; text-decoration:none" target="_blank" title="Bluemix知识库">
        Bluemix
       </a>
       云平台的推荐方案，与bluemix绑定
      </span>
     ...
     <p style="color:rgb(51,51,51); padding-top:0px; padding-bottom:0px; margin-top:0px; margin-bottom:10px">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       实现语言：js on Node.js
       <a href="https://github.com/openchain/openchain" rel="noopener noreferrer" style="background:0px 0px; color:rgb(0,162,202); text-decoration:none" target="_blank">
        <span style="font-weight:700">
         <br/>
        </span>
       </a>
     ...
     <p style="color:rgb(51,51,51); padding-top:0px; padding-bottom:0px; margin-top:0px; margin-bottom:10px">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <a href="https://github.com/HydraChain/hydrachain" rel="noopener noreferrer" style="background:0px 0px; color:rgb(0,162,202); text-decoration:none" target="_blank">
        HydraChain
       </a>
       <br/>
      </span>
     ...
     <p style="color:rgb(51,51,51); padding-top:0px; padding-bottom:0px; margin-top:0px; margin-bottom:10px">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       <a href="https://github.com/myblockchain/myblockchain" rel="noopener noreferrer" style="background:0px 0px; color:rgb(0,162,202); text-decoration:none" target="_blank">
        <span style="font-weight:700">
         myblockchain
        </span>
       </a>
     ...
     <p style="color:rgb(51,51,51); padding-top:0px; padding-bottom:0px; margin-top:0px; margin-bottom:10px">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       forked by:
       <a class="replace_word" href="http://lib.csdn.net/base/mysql" rel="nofollow noopener noreferrer" style="color:rgb(223,52,52); font-weight:bold; text-decoration:none" target="_blank" title="MySQL知识库">
        MySQL
       </a>
       -server
      </span>
    ...
    <div style="color:rgb(85,85,85)">
     <span style="color:#333333">
      <span style="font-family:KaiTi_GB2312; font-size:18px">
       附：
       <a href="http://download.csdn.net/detail/xiangzhihong8/9707967" rel="noopener noreferrer" style="color:rgb(12,137,207); text-decoration:none" target="_blank">
        区块链技术展望深度分析
       </a>
      </span>
     </span>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f71715f3336363137353231:2f61727469636c652f64657461696c732f3534343035333833" class_="artid" style="display:none">
 </p>
</div>
