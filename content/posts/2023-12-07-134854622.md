...
在表空间项下可以创建表空间，默认存在sys\_default、sys\_global、sysaudit三个表空间。后续我们可以通过右键编辑表空间的属主，当前我们创建普通用户，临时设置表空间属主是system用户。
...
[Kingbase详细安装教程\_Bigdataxy的博客-CSDN博客](https://blog.csdn.net/qq_53271322/article/details/127951921 "Kingbase详细安装教程_Bigdataxy的博客-CSDN博客")
