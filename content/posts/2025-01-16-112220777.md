...
失败：connect to server fail或者msg\_heartbeat\_error
  
2.鉴权通过：
  
成功：auth\_check\_by\_key---------ok或者auth\_check\_by\_token---------ok或者E\_Error\_Code\_check\_Success
  
失败：auth\_check\_by\_key---------failed或者auth\_check\_by\_token---------failed 或者E\_Event\_Code\_Token\_Error或者E\_Error\_Code\_check\_Failure或者E\_Error\_Code\_expired
  
3.打洞：
  
成功：P2PConntrolUnit::p2p\_callback:trans\_success
  
失败：P2PConntrolUnit::p2p\_callback:trans\_failed或者msg\_p2p\_error
  
4.建立UDT连接：
  
成功：P2PConntrolUnit::udtConnect success!
  
失败：P2PConntrolUnit::udtConnect failure!或者msg\_p2p\_error
