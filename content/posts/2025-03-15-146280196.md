...
2)，如下代码所示，test\_dir为指定路径。pattern=test\_\*.py 表示加载以test\_开头的模块中的测试用例，指定运行某模块时pattern参数指定全名即可，如：pattern=‘test\_sum.py’。路径跟pattern参数都可以自定义。
...
https://blog.csdn.net/qaqqqqqaq\_/article/details/135389040
  
https://blog.csdn.net/Asaasa1/article/details/109402334
  
https://blog.csdn.net/Bala\_lala/article/details/123362849
