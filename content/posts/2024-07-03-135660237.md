...
# 报错解决：undefined symbol: \_ZN15TracebackLoggerC1EPKc, version libcudnn\_ops\_infer.so.8
...
这个错误是在 NVIDIA GPU 上使用 PyTorch 2.1.2 和 cuDNN 12.1 时使用 torch.nn.Conv2d 时出现符号查找错误，这意味着 PyTorch 正在尝试在库 libcudnn\_ops\_infer.so.8 中查找名为 \_ZN15TracebackLoggerC1EPKc 的符号，但该符号不存在， 发生这种情况的原因有多种，包括：
...
参考：https://blog.csdn.net/qq\_41368074/article/details/107785536