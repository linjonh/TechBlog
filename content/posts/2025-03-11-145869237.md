 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="588" src="https://i-blog.csdnimg.cn/direct/82a576a30ccd4ef3ade36866f045707d.png" width="684"/>
    </p>
    <p>
     <img alt="" height="493" src="https://i-blog.csdnimg.cn/direct/39f414c2306d47f88e3985265738fba0.png" width="646"/>
    </p>
    <p>
     <img alt="" height="403" src="https://i-blog.csdnimg.cn/direct/60a55db6da7545278faabf91f60629cd.png" width="594"/>
    </p>
    <h4>
     实验步骤
    </h4>
    <h5>
     1、配置OpenGL（详情参见
     <a class="link-info" href="https://blog.csdn.net/2201_75321887/article/details/145869293?spm=1001.2014.3001.5501" title="OpenGL的配置">
      OpenGL的配置
     </a>
     ）
    </h5>
    ...
    <pre><code class="language-cpp">#include &lt;gl/glut.h&gt;</code></pre>
    <h5>
     3、编写方法体
    </h5>
    <h6>
    ...
    <pre><code class="language-cpp">//绘制矩形
void DisplayRectangle(void)
{
    ...
    <pre><code class="language-cpp">//绘制直线
void DisplayLine(void)
{
    ...
    <pre><code class="language-cpp">//绘制三角形
    ...
    <pre><code class="language-cpp">int main(int argc, char* argv[])
{
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323230315f37353332313838372f:61727469636c652f64657461696c732f313435383639323337" class_="artid" style="display:none">
 </p>
</div>
