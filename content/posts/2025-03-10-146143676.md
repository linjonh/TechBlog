 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="hljs">function Subject() {
  this.observers = [];
}
...
// Observer 2 received data: Hello, World!</code></pre>
    <h4>
     3.2 使用 ES6 类实现观察者模式
    </h4>
    <p>
...
// Observer 2 received data: Hello, World!</code></pre>
    ...
    <pre><code class="hljs">document.addEventListener('click', () =&gt; {
  console.log('Document clicked');
    ...
    <pre><code class="hljs">class DataBinding {
  constructor() {
    this.observers = [];
    this.data = {};
  }
...
// View: name updated to Alice</code></pre>
    <h4>
     4.3 状态管理
    </h4>
    <p>
...
// Component: user updated to Alice</code></pre>
    <h3>
     5. 观察者模式的优缺点
    </h3>
    <h4>
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f6c696e615f6d75612f:61727469636c652f64657461696c732f313436313433363736" class_="artid" style="display:none">
 </p>
</div>
