...
>   
> 这样就在/root/.ssh/目录下，生成了id\_rsa.pub和id\_rsa两上文件。接下来，就要将id\_rsa.pub文件上传到B服务器的/root/.ssh/目录下，重命名为authorized\_keys,如果B服务器不存在root/.ssh/目录，则手动创建该目录即可。
...
> 如果需要配置允许多台服务器免密传输，则在目标服务器中的authorized\_keys中添加多个服务器生成的秘钥即可，如图。
>   
