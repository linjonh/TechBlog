...
P\_s(f) = \frac{1}{4}\left[P\_M(f - f\_c) + P\_M(f + f\_c)\right]
...
S(f) = \frac{1}{2}\left[M(f - f\_c) + M(f + f\_c)\right]
...
r(t) = s(t)\cos(2\pi f\_c t) = m(t)\cos^2(2\pi f\_c t) = \frac{1}{2}m(t) + \frac{1}{2}m(t)\cos(4\pi f\_c t)
...
P\_s(f) = \frac{A^2}{4}[\delta(f - f\_c) + \delta(f + f\_c)] + \frac{1}{4}[P\_M(f - f\_c) + P\_M(f + f\_c)]
...
s(t) = m(t)\cos(2\pi f\_c t) - \hat{m}(t)\sin(2\pi f\_c t)
...
=
C
H\_{VSB}(f - f\_c) + H\_{VSB}(f + f\_c) = C
...
| 调制类型 | 输入信号功率 | 带宽 | 解调增益 |
| --- | --- | --- | --- |
| DSB-SC | 1 2 E [ m 2 ] \frac{1}{2}E[m^2]                  2             1  ​   E  [   m          2  ] | 2 f m 2f\_m      2   f          m  ​ | 2 |
| AM | 1 2 ( E [ m 2 ] + A 2 ) \frac{1}{2}(E[m^2] + A^2)                  2             1  ​   (  E  [   m          2  ]    +       A          2  ) | 2 f m 2f\_m      2   f          m  ​ | 2 E [ m 2 ] E [ m 2 ] + A 2 \frac{2E[m^2]}{E[m^2] + A^2}                  E  [   m          2  ]  +   A          2             2  E  [   m          2  ]  ​ |
| SSB | 1 2 E [ m 2 ] \frac{1}{2}E[m^2]                  2             1  ​   E  [   m          2  ] | f m f\_m       f          m  ​ | 1 |
