...
在这个基于AI构建AI的思维探索项目中，我们实现了一个基于BERT的中文AI助手系统。该系统集成了文本分类、命名实体识别和知识库管理等功能，深入了解本项目可以让读者充分了解AI大模型训练和推理的基本原理，该项目使用了三个基础大模型：`bert-
base-chinese，ckiplab/bert-base-chinese-ner``，spacy.lang.zh.Chinese`
旨在展示如何构建一个基础的AI应用系统。
