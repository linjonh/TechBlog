...
ETCD\_ADVERTISE\_CLIENT\_URLS="http://server11:2379"
...
KUBE\_ETCD\_SERVERS="--etcd-servers=http://server11:2379"

KUBE\_ADMISSION\_CONTROL="--admission-control=NamespaceLifecycle,NamespaceExists,LimitRanger,

其中KUBE\_ADMISSION\_CONTROL的原有的SecurityContextDeny和ServiceAccount是权限相关的配置需要去掉。

配置全局配置文件

vim /etc/kubernetes/config

KUBE\_MASTER="--master=http://master:8080"
...
FLANNEL\_ETCD\_ENDPOINTS="http://server11:2379"
...
KUBELET\_HOSTNAME="--hostname-override=node1"

KUBELET\_API\_SERVER="--api-servers=http://master:8080"
