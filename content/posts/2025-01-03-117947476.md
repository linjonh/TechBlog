...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/d1e83051b1c76dff4ca919c9ba07d9e8.png">
      <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a2e66d3e69ea83abfa03c929e6b49d0d.png"/>
    </p>
    <h3>
     <a id="43_ISP__39">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2400da23aae33c50961f16054c6be286.png">
      <br/>
      其中，
      <code>
       IXP
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/21bd60077ec3ae243155e8251c343ea3.png"/>
    </p>
    <h2>
     <a id="_53">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/f486aab48581582cb17f8d3ff6d84b40.png">
      <br/>
      ...
      端系统在功能上可能有很大的差别
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/773b2d6192329f53eb7979cf88af31bf.png"/>
     </img>
    </p>
    <h2>
     <a id="_60">
    ...
    <h4>
     <a id="721CS_ClientServer_CS___65">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/ebc75a14651a95896def989d25151ab4.png"/>
    </p>
    <h4>
     <a id="722P2P__PeertoPeer__P2P__70">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/3620863e0cd3b2e6e5ff93f83ba67b60.png"/>
    </p>
    <h2>
     <a id="_76">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/37ec457d02101fedd1cfae15256fb8bf.png"/>
     <br/>
    ...
    <p>
     ...
     来完成全网的交换任务。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6362d7096bc23a5c0acaa849c86163a9.png"/>
     <br/>
     每一部电话都
     <code>
      直接
    ...
    <p>
     ...
     通话在 A 到 B 的连接上进行
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/75fa96129ecd3df57c2b2ee97a24e1e7.png"/>
    </p>
    <h4>
     <a id="812_109">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2933cecee9bb6f56e0a64101afbfad77.png"/>
    </p>
    <h4>
     <a id="821_117">
     </a>
    ...
    <p>
     ...
     1）报文分组，加首部
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/4ff62816ea164998bfbd922f4d836f9d.png"/>
     <br/>
     2）经路由存储转发
     <br/>
     3）在目的地合并
    ...
    <p>
     分组交换网的示意图：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b7e44a9ac28a6e48f4d6981ebc970771.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/4d668df6277034667fd2c3d441732602.png"/>
    </p>
    <h4>
     <a id="822_128">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6abed5f2d6eb77fc2ef8bf0d065055cf.png"/>
    </p>
    <h4>
     <a id="823_130">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/c6c0444ba564ab61aee9f6add03276c5.png"/>
     <br/>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34353038343938362f:61727469636c652f64657461696c732f313137393437343736" class_="artid" style="display:none">
 </p>
</div>
