 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-cpp">int FunA(string strTest);</code></pre>
    <p>
     对于值传递方法，说明如下：
    </p>
    <ul>
    ...
    <pre class="has"><code class="language-cpp">int FunA(const string strTest)  // 值传递
{
    // some codes
}
...
int FunB(const string &amp; strTest)    // 引用传递，这里加了const关键字，为常引用。优选
{
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f6c696974646172:2f61727469636c652f64657461696c732f3835393832353631" class_="artid" style="display:none">
 </p>
</div>
