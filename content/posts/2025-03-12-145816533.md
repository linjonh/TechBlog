 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="hljs">[rtsp @ 0x55842ed950] video codec set to: hevc
...
[hevc @ 0x55842f07c0] nal_unit_type: 1(TRAIL_R), nuh_layer_id: 0, temporal_id: 0</code></pre>
    <p>
    ...
    <pre><code class="language-cpp">        if (is_key) {
    ...
    <pre><code class="language-cpp">void out_nalu(char *buffer, int size, NaluType naluType) {
    if (naluType == 32) {  // VPS
    ...
    <pre><code class="language-cpp">root@hcss-ecs-b4a9:/home/test/rtp/nalu# ./test7
...
int main() {
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f676d613939392f:61727469636c652f64657461696c732f313435383136353333" class_="artid" style="display:none">
 </p>
</div>
