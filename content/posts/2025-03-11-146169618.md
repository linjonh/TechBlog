 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="305" src="https://i-blog.csdnimg.cn/direct/64e8038af82e427983c2895d86e142fd.png" width="805"/>
    </p>
...
print("Shuffled tensor:\n", shuffled_x.numpy())
    ...
    <pre><code class="language-python">class GSBottleneck(nn.Module):
    ...
    def forward(self, x):
        return self.conv_lighting(x)</code></pre>
    <p>
     我遇到的坑为：
    </p>
    <pre><code class="language-python">class TFGSBottleneck(tf.keras.layers.Layer):
    # GS Bottleneck https://github.com/AlanLi1997/slim-neck-by-gsconv
...
Call arguments received by layer 'tfgs_bottleneck' (type TFGSBottleneck):
  • x=tf.Tensor(shape=(1, 136, 136, 8), dtype=float32)</code></pre>
    <h3>
     解决方案为
    </h3>
    <p>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f753031333539303332372f:61727469636c652f64657461696c732f313436313639363138" class_="artid" style="display:none">
 </p>
</div>
