...
参考：
[虚拟机 ubuntu 20.04 git 设置代理的方法\_ubuntu\_张世争-华为开发者空间 (csdn.net)](https://huaweicloud.csdn.net/6715f8b70636ea24a0c27648.html "虚拟机 ubuntu 20.04 git 设置代理的方法_ubuntu_张世争-华为开发者空间 (csdn.net)")
