...
ALTER DATABASE BIDWHZW SET RECOVERY SIMPLE WITH NO\_WAIT --BIDWHZW为需要清除日志的数据库名称
...
DBCC SHRINKFILE (N’BIDWHZW\_log’ , 11, TRUNCATEONLY) --BIDWHZW\_log为需要清除日志的数据库名日志名称
...
ALTER DATABASE BIDWHZW SET RECOVERY FULL WITH NO\_WAIT --BIDWHZW为需要清除日志的数据库名称
