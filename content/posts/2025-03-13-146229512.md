 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <pre><code>kubectl create configmap tomcat-config --from-literal=tomcat_port=8080 --from-literal=server_name=myapp.tomcat.com
...
Events:  &lt;none&gt;
    ...
    <pre><code>[root@mast01 cm]# mkdir -p mysql-cnf
...
debug.enabled=false
    ...
    <pre><code>vi pod-cm-envfrom.yaml
kind: Pod
metadata:
  name: pod-cm
spec:
...
PWD=/
    ...
    <pre><code>vi pod-cm-volume.yaml 
apiVersion: v1
kind: Pod
metadata:
  name: pod-cm
...
/tmp/config # cat log-level
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f7869616f66656e676b616e672f:61727469636c652f64657461696c732f313436323239353132" class_="artid" style="display:none">
 </p>
</div>
