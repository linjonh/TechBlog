...
## 一、网站分析
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/03d8ca6300524337a170a77c2271f925.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ac10e3e5883c427ea8aa5b4504987aa7.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/07205581e016463d921f939875dad949.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/78ea0257639040afa4bc08f2fcd029dc.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/01eba37cf31141db849a9178e5308acd.png#pic\_center)
## 二、代码
python代码
```c
"""
...
j\_fdata = json.dumps(form\_data,separators=(',', ':'))
# print(j\_fdata) # {"yyyyMM":"2025-03"}
f = open('hf.js',mode='r',encoding='utf-8')
js\_code = f.read()
js = execjs.compile(js\_code)
f\_data = js.call("sr",j\_fdata) # sY9u74F/amMJPfWSxqBnSCFIWBTU0OYMY3zydpKvpto=
form\_data = {
"data": f\_data
}
resp = requests.post(url,headers=headers,data=json.dumps(form\_data,separators=(',', ':')))
print(resp.text)
