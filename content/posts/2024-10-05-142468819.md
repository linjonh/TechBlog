...
## 1.cam\_lidar\_calib (2010c)

Github开源：https://link.zhihu.com/?target=https%3A//github.com/SubMishMar/cam\_lidar\_calib
...
安装完依赖库后就可以编译功能包了，首先是对其中的launch文件进行解读，以其中的cam\_lidar\_calib\_basler\_os.launch
...
[【ROS | OpenCV】在ROS中实现多版本OpenCV、cv\_bridge共存：安装与配置指南\_opencv cvbridge-CSDN博客](https://blog.csdn.net/xuzhengzhe/article/details/136758213 "【ROS | OpenCV】在ROS中实现多版本OpenCV、cv_bridge共存：安装与配置指南_opencv cvbridge-CSDN博客")
...
看报错日志，问题出现在./scripts/visualise\_results.py中的visualize\_results函数上，源代码86行是
