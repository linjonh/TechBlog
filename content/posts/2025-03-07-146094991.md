 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code>cnpm install vue-router --save</code></pre>
    <h4>
     第二步：
    </h4>
    <p>
...
export default router</code></pre>
    ...
    <p>
     <a href="https://github.com/thx/gogocode/tree/main/packages/gogocode-plugin-vue" title="Vue2 到 Vue3 升级插件">
      Vue2 到 Vue3 升级插件
     </a>
    </p>
    <p>
     <a href="https://github.com/thx/gogocode/tree/main/packages/gogocode-plugin-element" title="Element to Element Plus 升级插件">
    ...
    <pre><code>npm i @vue/compat -S</code></pre>
    <p>
...
export default {
  ...
  plugins: [
    ...
    <pre><code>// 启用 Vue 2 兼容模式
import { configureCompat } from '@vue/compat';
configureCompat({ MODE: 'Vue2'});</code></pre>
    <p>
...
app.use(ElementPlus, {
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f7a726578616d2f:61727469636c652f64657461696c732f313436303934393931" class_="artid" style="display:none">
 </p>
</div>
