...
i
,
\begin{align\*} P\_{i}=&X\_{k},i\!=\!1,2,\!\ldots,N,k\!=\!1,2,\!\ldots,i\!-\!1,i\!+\!1,\!\ldots,N, \! \\ \tag{3}\\ x\_{i,j}^{new,P1}=&\begin{cases} {x\_{i,j} +r\left ({
{p\_{i,j} -I\;x\_{i,j}} }\right),} & {F\_{P\_{i}} < F\_{i},} \\ {x\_{i,j} +r\left ({
{x\_{i,j} -\;p\_{i,j}} }\right),} & {F\_{P\_{i}} \ge F\_{i},} \\ \end{cases} \tag{4}\\ X\_{i}=&\begin{cases} {X\_{i}^{new,P1},} & {F\_{i}^{new,P1} < F\_{i},} \\ {X\_{i},} & {F\_{i}^{new,P1} \ge F\_{i},} \\ \end{cases}\tag{5}\end{align\*}
...
i
.
\begin{align\*} x\_{i,j}^{new,P2}=&x\_{i,j} +R \left ({
{2r-1\;} }\right) x\_{i,j}, \tag{6}\\ R=&0.02 \left ({
{1-\frac {t}{T}} }\right), \tag{7}\\ X\_{i}=&\begin{cases} X\_{i}^{new,P2}, & {F\_{i}^{new,P2} < F\_{i},} \\ X\_{i}, & F\_{i}^{new,P2} \ge F\_{i}. \end{cases}\tag{8}\end{align\*}
