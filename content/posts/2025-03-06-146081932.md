...
val_loader = torch.utils.data.DataLoader(test_ds, batch_size=16, shuffle=False)</code></pre>
    <h3>
     获得标准化的东西：
    </h3>
    <pre><code class="language-python">from torchvision.transforms import Normalize
...
record = training(
    ...
    <pre><code class="language-python">def plot_learning_curves(record_dict, sample_step=500):
    # build DataFrame
...
plot_learning_curves(record, sample_step=10000)  #横坐标是 steps</code></pre>
    <p>
     <img alt="" height="572" src="https://i-blog.csdnimg.cn/direct/bec5cfe6af2448009c8eed7233a91ac7.png" width="1241"/>
    </p>
    <p>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35353834333932312f:61727469636c652f64657461696c732f313436303831393332" class_="artid" style="display:none">
 </p>
</div>
