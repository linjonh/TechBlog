 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p class="img-center">
     <img alt="" height="1148" src="https://i-blog.csdnimg.cn/direct/fc128f47445747ffaf42671d4c013e82.png" width="2240"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/4ff553b5a341478aaf3065687a95b7eb.gif">
     </img>
    </p>
    <h3>
     一、界面基础结构搭建
...
&lt;/el-dialog&gt;</code></pre>
    ...
    <pre><code class="language-javascript">import { ref, provide, watchEffect, onMounted } from "vue";
...
const checkStrictly = ref(true); // 父子联动</code></pre>
    <p>
...
menudatas.value = res;
    ...
    <pre><code class="language-javascript">const handleCheckAllChange = (val) =&gt; {
...
treeRef.value.setCheckedKeys([]);
    ...
    <pre><code class="language-javascript">const expandedKeys = ref([]);
...
item.expanded =!expandedKeys.value;
    ...
    <pre><code class="language-javascript">// 父子联动
...
treeRef.value.setCheckedKeys(extractChildPermissionIds(menudatas.value));
    ...
    <pre><code class="language-javascript">// 提交
...
emits("close");
    ...
    <pre><code class="language-css">.containner {
...
border: 1px solid #d3d3d3;
    ...
    <p>
     完整代码实现请参考开源项目：
     <a href="https://gitee.com/zunyi-gabe/vue3-pc-template" rel="nofollow" title="vue3-pc-template">
      vue3-pc-template
     </a>
    </p>
    <blockquote>
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f4a696162657272722f:61727469636c652f64657461696c732f313436313739313433" class_="artid" style="display:none">
 </p>
</div>
