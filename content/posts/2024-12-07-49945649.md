...
2.设置core dump文件的输出位置，一般默认是当前目录，可以通过“echo “1” > /proc/sys/kernel/core\_uses\_pid ”使core文件加上pid号，也可以用“echo ”core保存目录/core-%e-%p-%t“ > /proc/sys/kernel/core\_pattern ” 设置。
