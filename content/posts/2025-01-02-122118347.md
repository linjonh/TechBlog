  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-github-gist" id="content_views">
     ...
     <ul>
      ...
      <li>
       <ul>
        ...
        <li>
         <a href="#QMovieGIF_190" rel="nofollow">
          使用QMovie播放GIF文件
         </a>
        </li>
       </ul>
      ...
      <li>
       <a href="#QMediaPlayer_303" rel="nofollow">
        QMediaPlayer
       </a>
      </li>
      <li>
       <ul>
        <li>
         <a href="#1__394" rel="nofollow">
          1. 播放状态
         </a>
        </li>
        <li>
         <a href="#2__499" rel="nofollow">
          2. 获取媒体元数据
         </a>
        </li>
        <li>
         <a href="#3__531" rel="nofollow">
          3. 播放列表
         </a>
        </li>
       </ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#_QCamera_577" rel="nofollow">
          相机 QCamera
         </a>
        </li>
       </ul>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/be95097d5ec0cf1d32d7579d12f49eca.png"/>
    </p>
    <p>
...
void MainWindow::on_spinBox_valueChanged(int arg1)
{
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a860f107220a1a07526daf8453928f0d.png"/>
    </p>
    <h2>
     <a id="_84">
     </a>
...
Widget::~Widget()
{
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/9a92374a61e6545fb11d2625557445d4.png"/>
    </p>
    <p>
...
movie-&gt;start();
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/448acfd07bf8d3437c78e7aee82be43d.png"/>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/78ce65bed4253d14adf0bf3245f0253c.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/31722a6bc64ec70023aa1d4d9101c150.png"/>
    </p>
    <p>
     然后将widget.cpp中的内容改为：
    </p>
...
void MainWindow::on_spinBox_valueChanged(int arg1)
{
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6e4774b12cde9545643c03370d77e5e8.png"/>
    </p>
    <h2>
     <a id="QMediaPlayer_303">
     </a>
     QMediaPlayer
    </h2>
    <p>
    ...
    <pre><code>void MainWindow::on_horizontalSlider_sliderMoved(int position)
{
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/b1f9509f21d282f7f62ab1f2493bf34a.png"/>
    </p>
    <h3>
     <a id="1__394">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/1c135455b20ddeeea18410a8725ab94a.png"/>
    </p>
    <p>
     另外，当播放器发生错误时会发射error()信号，通过关联该信号可以对相应的错误进行处理。播放器会出现6种不同的错误情况，这6种情况由QMediaPlayer::Error枚举类型定义。其可选值如下：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/bf89fe95a9615fc842cedc2aa8b358a7.png"/>
    </p>
    <p>
     QMediaPlayer进行播放时拥有3种状态，它总是处于这3种状态中的其中一种。这3种状态由QMediaPlayer::State枚举类型定义，其取值见下表：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/9ee66f79fe9bf749410d8c4c0a3a3970.png"/>
    </p>
    <p>
...
void MainWindow::showError(QMediaPlayer::Error error){
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2947c85dcf0311cb2d2dcd259927ff9c.png"/>
    </p>
    <h3>
     <a id="2__499">
     </a>
    ...
    <pre><code>void MainWindow::metaDataAvailableChanged(bool available)
{
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/a5176771610d9fc86270023b73d04fd0.png"/>
    </p>
    <h3>
     <a id="3__531">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/33c3bf2aa1308af1d22ed5c4e0543495.png"/>
    </p>
    <p>
...
player-&gt;setPlaylist(playlist);
    ...
    <p>
     这句删掉。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/656b44e178c23ae5ac4602b0dbff728f.png"/>
    </p>
    <p>
     这个程序运行时会连续循环播放几首音乐。
    </p>
...
foreach(const QCameraInfo &amp;cameraInfo, camera)
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/c340b816381827987c27229673cb1505.png"/>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33393135333732302f:61727469636c652f64657461696c732f313232313138333437" class_="artid" style="display:none">
 </p>
</div>
