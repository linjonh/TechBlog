...
* driver\_route:司机发布的行程记录表
* passager\_route：乘客发布的行程记录表
* bargin\_route：成交的行程记录表
* chat\_partner：聊天的双方参与者
* message：会话记录
...
https://kf.qq.com/product/wx\_xcx.html#hid=hot\_faq
...
(https://developers.weixin.qq.com/ebook?action=get\_post\_info&docid=000ee2c29d4f805b0086a37a254c0a)
...
(https://developers.weixin.qq.com/ebook?action=get\_post\_info&docid=000846df9a03909b0086a50025180a&highline=wx.navigateTo)
...
(https://lbs.qq.com/qqmap\_wx\_jssdk/index.html)

。在本小程序中，我们使用到根据输入关键词获取位置列表接口的详细指导可以参考：获取位置列表接口

(https://lbs.qq.com/qqmap\_wx\_jssdk/method-getsuggestion.html)
