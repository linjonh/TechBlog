...
![img](https://i-blog.csdnimg.cn/blog\_migrate/6cf1cdbda40f5a5f8294f112ccf69efe.png)
![](https://i-blog.csdnimg.cn/blog\_migrate/1e210328c1ebf43f08d3b6c5f5c13b48.png)
![img](https://i-blog.csdnimg.cn/blog\_migrate/a2e5703e92a0a539f59bdc205b7fd663.png)
![img](https://i-blog.csdnimg.cn/blog\_migrate/03d2cbaa8e22685e4d79afd8a1e3fc3c.png)
![htt](https://i-blog.csdnimg.cn/blog\_migrate/cdfeab5d906ab79643935aaf424ff21a.png)
\*\*既有适合小白学习的零基础资料，也有适合3年以上经验的小伙伴深入学习提升的进阶课程，基本涵盖了95%以上HarmonyOS鸿蒙开发知识点，真正体系化！\*\*
\*\*由于文件比较大，这里只是将部分目录大纲截图出来，每个节点里面都包含大厂面经、学习笔记、源码讲义、实战项目、讲解视频，并且会持续更新\*\*
\*\*如果你觉得这些内容对你有帮助，可以添加VX：vip204888 （备注鸿蒙获取）\*\*
![img](https://i-blog.csdnimg.cn/blog\_migrate/183ec64565e91b8920da81e64f15ef26.png)
...
![](https://i-blog.csdnimg.cn/blog\_migrate/7be4391f17f15013dbbbc0a71a1d0bb7.png)
###### 进入配置工程界面，Compile SDK选择“3.1.0(API 9)”，Model 选择“Stage”，其他参数保持默认设置即可。
![](https://i-blog.csdnimg.cn/blog\_migrate/5aafd32cdabcdc7fb78f490de99e0cba.png)
点击Finish，等待十几秒MyApplication工程就创建完成了。
#### 2.ArkTS工程目录结构（Stage模型）
![](https://i-blog.csdnimg.cn/blog\_migrate/69cba417cd1b1c2bdcf5f072b217954c.png)
###### 目录说明：
| | |
| --- | --- |
| | ` |
...
![](https://i-blog.csdnimg.cn/blog\_migrate/911bd11143d817e6fad98a34c567144a.png)
在Device Manager界面，选择Local Emulator(本地模拟器)，点击 New Emulator
![](https://i-blog.csdnimg.cn/blog\_migrate/db23fdbb7603bd127b82fe94a96063a0.png)
一路Next，等待模拟器文件(1G左右)下载完成后，模拟器既完成创建。
##### 启动模拟器(重要)
###### 注意创建完模拟器后，DevEco Studio右上角依然显示的是No Devices，需要我们先在Device Manager中手动启动模拟器
![](https://i-blog.csdnimg.cn/blog\_migrate/c2953db5dba2c26f5c0404c54f3bc15e.png)
启动完成后:
![](https://i-blog.csdnimg.cn/blog\_migrate/c0ce5f67f1d76b5df9a24791c8455ab5.png)
##### 运行程序
点击DevEco Studio右上角的Run按钮，运行程序
![](https://i-blog.csdnimg.cn/blog\_migrate/2ccf3f982ee9d15222e0d06866a33f25.png)
运行成功后：
![](https://i-blog.csdnimg.cn/blog\_migrate/9e7dd25caffc46ee13cb1ab5d4c6a6b1.png)
恭喜完成了第一个HarmonyOS应用。
---
...
![](https://i-blog.csdnimg.cn/blog\_migrate/05ac03a682d33e7a980d9b468cde2d83.png)
![](https://i-blog.csdnimg.cn/blog\_migrate/b447952fb28df1ef6ee73437632aaed0.png)
需要以上视频学习资料小伙伴
请点击→
...
\* 技术特性
\* 系统安全
![](https://i-blog.csdnimg.cn/blog\_migrate/51eeb73be83481d924aa63d141080029.png)
\*\*如何快速入门？\*\*
S)开发手册》
这份手册涵盖了当前鸿蒙 (Harmony OS) 开发技术必掌握的核心知识点
##### 纯血版鸿蒙 (Harmony OS)开发手册部分精彩内容
