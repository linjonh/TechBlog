 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <a href="https://blog.csdn.net/knighthood2001/article/details/137840827" title="https://blog.csdn.net/knighthood2001/article/details/137840827">
      https://blog.csdn.net/knighthood2001/article/details/137840827
     </a>
    </p>
    <p>
     <a href="https://www.cnblogs.com/mik-hello/p/15476839.html" rel="nofollow" title="https://www.cnblogs.com/mik-hello/p/15476839.html">
      https://www.cnblogs.com/mik-hello/p/15476839.html
     </a>
    </p>
    <p>
     <a href="https://blog.csdn.net/knighthood2001/article/details/137840827" title="selenium进行滚轮滚动，并判断是否到底部-CSDN博客">
      selenium进行滚轮滚动，并判断是否到底部-CSDN博客
     </a>
    </p>
    <p>
...
sleep(10)
    ...
    <p>
     <img alt="" height="852" src="https://i-blog.csdnimg.cn/direct/d0769be6e4ff4773bd1ddb9b4c7e5206.png" width="1892"/>
    </p>
    <p>
     2）
    </p>
    ...
    <pre><code>1、整理cookie信息为字典数据，对应的是name和value，保存的一个变量中
2、调用方法添加cookie
	driver.add_cookie(cookie变量)
# 3、刷新页面 --&gt;发送cookie给服</code></pre>
    <p>
     <img alt="" height="951" src="https://i-blog.csdnimg.cn/direct/49178355c28b4a2e81187ef6e7a26d94.png" width="1906"/>
    </p>
    <p>
     这里参考博客：
    </p>
...
driver.quit()  # 关闭浏览器驱动实例，释放资源
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f77656e79756e69636b2f:61727469636c652f64657461696c732f313436313732343038" class_="artid" style="display:none">
 </p>
</div>
