...
2. **安装 Ubuntu 系统**
   ...
   * 安装完成后重启系统。
     ...
     学习链接：https://blog.csdn.net/Z\_Date/article/details/137855618?utm\_source=miniapp\_weixin
...
在根目录下创建一个文件夹module\_test，并编写一个简单的hello.c代码
...
打开文件 /libbb/printable\_string.c，注释掉 printable\_string 函数中 if (c >= 0x7f) break; 的代码行。
  
打开文件 /libbb/unicode.c，修改 unicode\_conv\_to\_printable2 函数中的相关代码。
