...
## add these lines to your ~/.bash\_profile or ~/.profile
...
=
"
COMMON\_FF\_CFG\_FLAGS --enable-demuxer=hls" export COMMON\_FF\_CFG\_FLAGS="
...
"
COMMON\_FF\_CFG\_FLAGS --enable-parser=aac”
...
=
"
COMMON\_FF\_CFG\_FLAGS --enable-parser=h264" export COMMON\_FF\_CFG\_FLAGS="
...
"
COMMON\_FF\_CFG\_FLAGS --disable-protocol=rtp”
  
export COMMON\_FF\_CFG\_FLAGS=“$COMMON\_FF\_CFG\_FLAGS --enable-protocol=rtmp”
...
21. 如何设置硬解?
    ...
    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT\_CATEGORY\_PLAYER, “mediacodec”, 1);
