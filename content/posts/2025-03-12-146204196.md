...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <h2>
     <a id="Particle_State__0">
     </a>
     Particle State （粒子状态）模块
    </h2>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c5488bd6de70410288da78cfbd707ffc.png">
      <br/>
      Particle State 主要用于控制粒子的生存状态，包括死亡、消失、响应事件等。
     </img>
    </p>
    <h3>
     <a id="Particle_State_3">
     </a>
     Particle State
    </h3>
    <h4>
     <a id="Kill_Particles_When_Lifetime_Has_Elapsed_4">
     </a>
    ...
    <h2>
     <a id="Scale_Sprite_Size_10">
     </a>
     Scale Sprite Size（缩放精灵尺寸）模块
    </h2>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8ec91c6eed264971a16a9f6da37cb01c.png">
      <br/>
      Scale Sprite Size 控制粒子的大小随时间变化，适用于渐变效果，比如火焰燃烧变大，烟雾扩散等。
     </img>
    </p>
    <h3>
     <a id="Scale_Sprite_Size_13">
     </a>
     Scale Sprite Size
    </h3>
    <h4>
     <a id="Scale_Sprite_Size_Mode_14">
     </a>
    ...
    <h2>
     <a id="Gravity_Force_22">
     </a>
     Gravity Force（重力力场）模块
    </h2>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1e0af2dbe74a4b79b5aceb2b33618220.png"/>
    </p>
    <p>
     Gravity Force 是 Niagara 中的一个用于模拟重力影响的模块，通常用于让粒子受到 重力加速度 的作用，使其表现得更加真实。例如，模拟雨滴下落、火花掉落、物体自由落体等。
    </p>
    <h3>
     <a id="Gravity_Force_26">
     </a>
     Gravity Force
    </h3>
    <h4>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/202b45534c104cd4977084ee04f892ed.png">
      <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/9e97f0c124814d7fbe7a6ad560c984ef.png">
      <br/>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ed1f54fb9d7d49618893da60ef160670.png"/>
    </p>
    <h2>
     <a id="Solve_Forces_and_Velocity_52">
     </a>
     Solve Forces and Velocity（求解力和速度）模块
    </h2>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f6b110b110f7464080f6c2970d5dd5c6.png">
      <br/>
      Solve Forces and Velocity 主要用于更新粒子的速度、加速度和位置，并整合所有的力（如重力、阻力、风力等）来计算粒子的运动轨迹。
     </img>
    </p>
    <h3>
     <a id="Solve_Forces_and_Velocity_55">
     </a>
    ...
    <h4>
     <a id="Manually_Enable_Rotational_Solver_60">
     </a>
    ...
    <h2>
     <a id="Curl_Noise_Force_62">
     </a>
     Curl Noise Force（卷曲噪声力）模块
    </h2>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/aaa84fd19806476f958a020888a20ef4.png">
      <br/>
    ...
    <h3>
     <a id="Curl_Noise_Force_65">
     </a>
     Curl Noise Force
    </h3>
    <h4>
     <a id="Noise_Strength_66">
     </a>
     Noise Strength（噪声强度）
    </h4>
    <p>
    ...
    <h4>
     <a id="Curl_Noise_Cone_Mask_Angle_80">
     </a>
    ...
    <h4>
     <a id="Curl_Noise_Cone_Mask_Falloff_Angle_86">
     </a>
    ...
    <h4>
     <a id="Curl_Noise_Cone_Mask_Axis_91">
     </a>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33303130303034332f:61727469636c652f64657461696c732f313436323034313936" class_="artid" style="display:none">
 </p>
</div>
