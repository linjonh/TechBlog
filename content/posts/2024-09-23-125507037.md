...
修改 addons/ewei\_shopv2/static/js/app/biz/store/selector.js 中 https://api.map.baidu.com/getscript 为 https://api.map.baidu.com/api
  
修改 addons/ewei\_shopv2/static/js/myconfig-app.js 中 urlArgs: ‘v=’ + version 将 v= 修改为 t=
