...
<div class="blog-content-box">
    ...
    <ol>
     <li>
      <p>
       状态机的设置非常不合理
       <br/>
       <img alt="请添加图片描述" src="https://i-blog.csdnimg.cn/direct/52c6d897e83b414cb2fc0f9dbcfc043e.png"/>
      </p>
     </li>
     <li>
      <p>
       使用两段式状态机，组合逻辑里面竟然使用非阻塞赋值…这是最低级的错误了（在图片中展示了）
       <br/>
       <img alt="请添加图片描述" src="https://i-blog.csdnimg.cn/direct/8263cae59eb54bb88124f8b5b3898728.png"/>
      </p>
     </li>
     <li>
      <p>
       ...
       <br/>
       <img alt="请添加图片描述" src="https://i-blog.csdnimg.cn/direct/d34612010cb44cbc99e9d84f53133f22.png"/>
      </p>
     </li>
     <li>
      <p>
       ...
       第一眼看都不知道怎么个转换关系
       <br/>
       <img alt="请添加图片描述" src="https://i-blog.csdnimg.cn/direct/126b5b2217744f7f991d4bf1fcef6770.png"/>
      </p>
     </li>
    </ol>
    <p>
     ...
     <br/>
     <img alt="请添加图片描述" src="https://i-blog.csdnimg.cn/direct/607079e12110431db95aea4ea2b165b9.png"/>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34353935363437352f:61727469636c652f64657461696c732f313436313430393734" class_="artid" style="display:none">
 </p>
</div>
