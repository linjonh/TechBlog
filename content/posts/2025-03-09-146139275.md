...
**gitlab-ctl tail gitlab-ctl tail nginx/gitlab\_access.log gitlab-ctl tail nginx/gitlab\_error.log less /var/log/gitlab/puma/current**
...
>   参数设置，例如：
>
> workers Integer(ENV['PUMA\_WORKERS'] || 2)
>
...
>   参数配置，示例如下：
>
> threads Integer(ENV['MIN\_THREADS'] || 1), Integer(ENV['MAX\_THREADS'] || 16)
>
...
[linux环境GitLab服务部署安装及使用\_linux安装gitlab-CSDN博客](https://blog.csdn.net/weixin_39393393/article/details/144247317 "linux环境GitLab服务部署安装及使用_linux安装gitlab-CSDN博客")