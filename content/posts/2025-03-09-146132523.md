...
3. greaterThan(QT\_MAJOR\_VERSION,4):QT+=widgets 这条语句的含义是，如果QT\_MAJOR\_VERSION大于4需要增加widgets模块。如果项目仅需支持Qt5，也可直接添加
...
在Qt中，如果要使用信号与槽（signal和slot）的机制就必须加入Q\_OBJECT宏；
