 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="524" src="https://i-blog.csdnimg.cn/direct/6bc00732c60e4929bfce6ef722d2a3a1.png" width="935">
    ...
    <pre><code>​git clone --mirror http://127.0.0.1:3000/TEST/myweb.git new-repo.git
</code></pre>
    <hr/>
    <h4>
     <strong>
    ...
    <pre><code>cd new-repo.git</code></pre>
    <h5>
     <strong>
      (2) 运行清理旧数据命令
     </strong>
...
' --force</code></pre>
    ...
    <pre><code>git remote set-url origin &lt;remote-repo-url&gt;
...
git push origin --force --tags</code></pre>
    ...
    <pre><code class="language-php">[root@localhost .git]# git rev-list --objects --all | while read -r hash path; do size=$(git cat-file -s "$hash"); echo "$size $hash $path"; done | sort -n | tail -5
...
957612815 dae9e0f50fe2012f9220539c8429381a0677c862 public.zip
    ...
    <p>
     <a href="https://gitee.com/help/articles/4232#article-header0" rel="nofollow" title="仓库体积过大，如何减小？ - Gitee.com">
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f6c756f6c756f7975323031332f:61727469636c652f64657461696c732f313436313735323432" class_="artid" style="display:none">
 </p>
</div>
