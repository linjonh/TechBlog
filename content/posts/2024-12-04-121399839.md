...
[GitHub - bytedance/Fastbot\_Android: Fastbot(2.0) is a model-based testing tool for modeling GUI transitions to discover app stability problems

![](https://i-blog.csdnimg.cn/blog_migrate/c61f4ffe638d64fdf70c25b47c532bd2.png)
https://github.com/bytedance/Fastbot\_Android](https://github.com/bytedance/Fastbot_Android "GitHub - bytedance/Fastbot_Android: Fastbot(2.0) is a model-based testing tool for modeling GUI transitions to discover app stability problems")
