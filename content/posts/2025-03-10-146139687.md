 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="hljs">import torch.nn as nn

model = nn.Sequential()
model.add_module("layer1", nn.Linear(784, 256))
model.add_module("relu1", nn.ReLU())
model.add_module("layer2", nn.Linear(256, 10))</code></pre>
    <p>
     <strong>
      特点
     </strong>
    ...
    <pre><code class="hljs">from collections import OrderedDict
...
Sequential(
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f57697334652f:61727469636c652f64657461696c732f313436313339363837" class_="artid" style="display:none">
 </p>
</div>
