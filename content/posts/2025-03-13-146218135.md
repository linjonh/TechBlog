...
对于 100%100% 的数据，保证
n,m≤![10^{5}](https://latex.csdn.net/eq?10%5E%7B5%7D)，li​<ri​，0<li,ri,Li,Ri≤![10^{6}](https://latex.csdn.net/eq?10%5E%7B6%7D)，max⁡{ri−li}≤min⁡{Ri−Li}.
...
我们就可以在输入 li​,ri​ 的时候，标记其中点 `(mp[(l+r)/2]++)`，再做一遍前缀和，最后查询时 [Li​,Ri​]
这个区间的和就是答案。
