 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="409" src="https://i-blog.csdnimg.cn/direct/43a6e15e8b79464bbc0a1e6fb867be26.png" width="908"/>
    </p>
    <p>
    </p>
    <h2>
...
for idx, (key, value) in enumerate(NeuralNetwork(20).named_parameters()):
    print("{:&lt;40}\t{:^10}".format(key, np.prod(value.shape)))</code></pre>
    <p>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35353834333932312f:61727469636c652f64657461696c732f313436303930383436" class_="artid" style="display:none">
 </p>
</div>
