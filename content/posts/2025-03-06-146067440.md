 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-tomorrow-night" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/19377278bff6428bb5dbd1b1b45954d3.png"/>
    </p>
    <h4>
     <a id="12__22">
     </a>
    ...
    <p>
     查看谷歌日历行程、查看邮件、发送邮件。
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0628f8a001da4950a24d9b298180d908.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/d70f483c80db4c9396570958f37d4add.png"/>
    </p>
    <hr/>
    <h3>
     <a id="_30">
    ...
    <pre><code class="prism language-text">You will play the following three roles, please reply in Chinese.
...
- Action: Gmail Send Email
  ...
  "components": {
    ...
    <p>
     <a href="https://www.aixinzhijie.com/article/6840230" rel="nofollow">
      万字长文！何谓Agent，为何Agent？
     </a>
    </p>
    <p>
     <a href="https://zhuanlan.zhihu.com/p/649232438" rel="nofollow">
      GPTs到底是什么？
     </a>
    </p>
    <h4>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ea2080556261459d9e5a70eee5bf18d2.png"/>
    </p>
    <h4>
     <a id="32__515">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3118f1f201094baea549805aeeda35f0.png"/>
    </p>
    <h4>
     <a id="33__518">
     </a>
    ...
    <ol>
     <li>
      <p>
       Instructions + Actions + 内置模版 + 用户输入 = 新 prompt；
      </p>
     </li>
     <li>
      <p>
       LLM 完成参数填充后生成 API 调用指令；
      </p>
     </li>
     <li>
      <p>
       Agent 接收到调用指令判断必填项是否完整：完整则进行接口调用，不完整则循环到 1；
      </p>
     </li>
    </ol>
    <hr/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/adf992d88c8a4a8283b879e84b5f9863.png"/>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6672616e6b3131303530332f:61727469636c652f64657461696c732f313436303637343430" class_="artid" style="display:none">
 </p>
</div>
