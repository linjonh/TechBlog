 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <hr/>
    <h4>
     <img alt="" height="627" src="https://i-blog.csdnimg.cn/direct/f836a78bd50141f09f29629e6c87df67.png" width="802"/>
    </h4>
    <p>
     哈哈，怪物可以换成同学 的qq头像
    </p>
    ...
    <p>
     <img alt="" height="322" src="https://i-blog.csdnimg.cn/direct/60972e79bf1042f1befdb97537db81a5.gif" width="400"/>
    </p>
    <h5>
     ​
     <strong>
    ...
    <ol>
     ...
     <li>
      ...
      <pre><code>- 精灵(Sprite)系统：玩家/敌人/子弹的统一管理
- 基于三角函数的子弹轨迹计算（8方向射击）
- 敌人AI：自动追踪玩家 + 精英怪弹幕攻击
- 动态难度系统：敌人生成速度随玩家等级提升
- 经验球漂浮动画（正弦函数实现）
- 多菜单系统：主菜单/角色选择/游戏内HUD</code></pre>
     </li>
    </ol>
    <hr/>
    <h5>
...
│   │   - game_loop()       # 核心游戏循环</code></pre>
    ...
    def get_attack_directions(self):
        # 角色1：四方向射击 | 角色2：对角线射击
        return ["up", "down", "left", "right"] if self.role_type == 1 else ["up_left", "up_right", ...]</code></pre>
     </li>
     <li>
      <p>
       ​
      ...
      <pre><code>class EliteEnemy(Enemy):
    def shoot(self, target):
        # 45度间隔的8方向弹幕
        for angle in range(0, 360, 45):
            rad = math.radians(angle)
            bullet = EliteBullet(..., math.cos(rad)*speed, math.sin(rad)*speed)</code></pre>
     </li>
     <li>
      <p>
       ​
      ...
      <pre><code># 敌人生成速度随玩家等级提升
enemy_spawn_interval = 60 - (sum(p.level for p in players) * 2)</code></pre>
     </li>
    </ol>
    <hr/>
    <h5>
...
if __name__ == "__main__":
    ...
    if player_count &gt; 0:
        game_loop(player_count, roles)</code></pre>
    <p>
...
if __name__ == "__main__":
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f6c6f6e675f736f6e67732f:61727469636c652f64657461696c732f313436303235363538" class_="artid" style="display:none">
 </p>
</div>
