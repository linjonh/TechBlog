 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code>public class ServiceConfig {
...
public class NettyRpcServer {
    ...
    <pre><code>//RpcRequest类需要修改字段调整为如下所示
...
public class NettyRpcServerHandler extends ChannelInboundHandlerAdapter {
    ...
    <pre><code>public class ReferenceConfig {
...
public class NettyRpcClientHandler extends ChannelInboundHandlerAdapter {
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f6d6a756e7a2f:61727469636c652f64657461696c732f313436333033373838" class_="artid" style="display:none">
 </p>
</div>
