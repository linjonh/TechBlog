 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="446" src="https://i-blog.csdnimg.cn/direct/23bc3be42d1848a3b2849cf105106381.png" width="1280"/>
    </p>
    <h3>
     2.1 简介
    </h3>
    ...
    <pre><code class="language-java">public class WuLinSimpleFactory {
    ...
    <p>
     <img alt="" height="551" src="https://i-blog.csdnimg.cn/direct/96992914eb9e4a62a489fd95e0d79d4e.png" width="1280"/>
    </p>
    <h3>
     3.1 简介
    </h3>
...
public abstract class AbstractCarFactory {
    ...
    <pre><code class="language-java">public class MiniCar extends AbstractCar {
    ...
    <pre><code class="language-java">public class WulinVanCarFactory extends AbstractCarFactory {
    @Override
    ...
    <p>
     <img alt="" height="720" src="https://i-blog.csdnimg.cn/direct/22292c5494f549aab17b23905eda0e73.png" width="1048"/>
    </p>
    <h3>
     4.1 简介
    </h3>
    ...
    <pre><code class="language-java">public abstract class WulinFactory {
    ...
    <pre><code class="language-java">public  abstract  class WulinCarFactory extends WulinFactory{
    @Override
    abstract  AbstractCar newCar();
    ...
    <pre><code class="language-java">public abstract class WulinMaskFactory extends WulinFactory{
    @Override
    AbstractCar newCar() {
        return null;
    }
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f36313439323837312f:61727469636c652f64657461696c732f313436323032313436" class_="artid" style="display:none">
 </p>
</div>
