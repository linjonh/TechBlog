 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code>public interface PostingStrategy {
    ...
    <pre><code>public class PurchaseReceiptPostingStrategy implements PostingStrategy {
    @Override
    ...
    <pre><code>package com.kpl.sys.domain;
...
public class PostingContext {
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343536383831362f:61727469636c652f64657461696c732f313436313931343536" class_="artid" style="display:none">
 </p>
</div>
