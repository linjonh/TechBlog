...
&nbsp;&nbsp;&nbsp;&nbsp;Object&nbsp;userInfo&nbsp;=&nbsp;request.getSession().getAttribute(LoginFilter.USER\_INFO);
...
&nbsp;&nbsp;&nbsp;&nbsp;request.getSession().setAttribute(LoginFilter.USER\_INFO,user);
...
&nbsp;&nbsp;&nbsp;&nbsp;Object&nbsp;user&nbsp;=&nbsp;request.getSession().getAttribute(LoginFilter.USER\_INFO);
...
&nbsp;&nbsp;&nbsp;&nbsp;Object&nbsp;userInfo&nbsp;=&nbsp;request.getSession().getAttribute(USER\_INFO);;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;request.getSession().setAttribute(SSOFilter.USER\_INFO,user);
...
&nbsp;&nbsp;&nbsp;&nbsp;Object&nbsp;userInfo&nbsp;=&nbsp;request.getSession().getAttribute(SSOFilter.USER\_INFO);
