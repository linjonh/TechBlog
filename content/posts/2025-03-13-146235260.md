...
顺利的话，可以在⽤⼾主⽬录⾥找到 .ssh ⽬录，⾥⾯有 id\_rsa 和 id\_rsa.pub 两个⽂件，这两 个就是SSH Key的秘钥对，
**id\_rsa 是私钥，不能泄露出去， id\_rsa.pub 是公钥**
，可以放⼼地告 诉任何⼈。
