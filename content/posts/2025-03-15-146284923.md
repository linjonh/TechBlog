...
namespace MyEnumType
{
    ...
    <pre><code class="prism language-C++">//在蓝图中声明
...
UObject* ObjectPointer;
    ...
    <pre><code class="prism language-C++">//注意，定义结构体名称前要加F前缀，不然编译不通过。
...
struct FMyCustomStruct
{
  ...
  bool IsMan;
    ...
    <pre><code class="prism language-C++">//结构体创建数据表格,需继承FTableRowBase
USTRUCT(BlueprintType)
...
FMyCustomStruct MyCustomStruct;
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f4f53776963682f:61727469636c652f64657461696c732f313436323834393233" class_="artid" style="display:none">
 </p>
</div>
