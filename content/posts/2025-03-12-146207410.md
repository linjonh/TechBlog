  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <blockquote>
     ...
     <p>
      源码仓库地址：
      <a href="https://github.com/xuxueli/xxl-job" title="https://github.com/xuxueli/xxl-job">
    ...
    <p>
     源码结构：
     <img alt="" height="575" src="https://i-blog.csdnimg.cn/direct/f47acf746fa4417099daf53bc06b76d2.png" width="1241"/>
    </p>
    <h3 id="21-系统架构" style="background-color:transparent">
     系统架构
    </h3>
    <blockquote>
     <p>
    ...
    <blockquote>
     ...
     <p>
      <img alt="" height="242" src="https://i-blog.csdnimg.cn/direct/65305055e0a14eaaa11e6b4fa0ec914a.png" width="371"/>
     </p>
    </blockquote>
    <p>
     也可以通过docker-compose.yml文件拉取
    </p>
    <pre><code class="language-bash">version: '3.3'
services:
  xxl-job-admin:
...
commit;
    ...
    <h6>
     <img alt="" height="259" src="https://i-blog.csdnimg.cn/direct/7fa44d9e310247dd9134a842191f76a6.png" width="498"/>
    </h6>
    <table>
     <thead>
      <tr>
    ...
    <p>
     <img alt="" height="122" src="https://i-blog.csdnimg.cn/direct/8d5b1c66c770415e9470765dee0fe914.png" width="1022"/>
    </p>
    <h4>
     访问调度中心
     <a href="http://192.168.2.3:8040/xxl-job-admin/joblog" rel="nofollow" title="：http://192.168.2.3:8040/xxl-job-admin/joblog">
      ：http://192.168.2.3:8040/xxl-job-admin/joblog
     </a>
    </h4>
    <p>
    ...
    <p>
     <img alt="" height="926" src="https://i-blog.csdnimg.cn/direct/0f81b46905c74f05b56e0bd619ed2a52.png" width="2157"/>
    </p>
    <h2 style="background-color:transparent">
    ...
    <pre><code class="language-bash"> &lt;!-- pom.xml --&gt;
        &lt;dependency&gt;
    ...
    <pre><code class="language-bash"># 调度中心地址配置
...
public class XxlJobConfig {
    ...
    <p>
     <img alt="" height="574" src="https://i-blog.csdnimg.cn/direct/949a892ab53d4981b033674a3fa45ea0.png" width="689"/>
    </p>
    <h3>
     启动项目可看到执行器已经自动注册到调度中心
    </h3>
    <p>
     <img alt="" height="1086" src="https://i-blog.csdnimg.cn/direct/3f32ea5358ff40d0b46a320c67b44e15.png" width="2144"/>
    </p>
    <h3>
     新建定时任务
    </h3>
    <p>
     <img alt="" height="762" src="https://i-blog.csdnimg.cn/direct/e2c430f2b2524376907b3514b0d2130d.png" width="895"/>
    </p>
    <h3 style="background-color:transparent">
     操作
    </h3>
    <p>
     <img alt="" height="418" src="https://i-blog.csdnimg.cn/direct/a9bce0c7b6a543b896bc4b2274449a70.png" width="1941"/>
    </p>
    <h3>
     测试成功：
    </h3>
    <p>
     <img alt="" height="827" src="https://i-blog.csdnimg.cn/direct/bbf82e2812ed485abda24d83d166f37e.png" width="1551"/>
    </p>
    <h2>
     示例源码地址：
     <a href="https://gitee.com/survive2/storeWarning" rel="nofollow" title="店铺营业额预警模块（发送邮件）: 店铺营业额预警模块（发送邮件给老板）">
      店铺营业额预警模块（发送邮件）: 店铺营业额预警模块（发送邮件给老板）
     </a>
    </h2>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f36323231343238302f:61727469636c652f64657461696c732f313436323037343130" class_="artid" style="display:none">
 </p>
</div>
