 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <pre><code>之前在做前端项目的时候经常会碰到页面状态发生改变的情况。比如：在设备解绑、解冻，或者是对用户信息进行创建、编辑、删除等操作后。原则上来说页面应该实时显示最新的信息，但是页面是通过ajax请求与数据库中的数据进行同步的。  这种情况下我们必须在这个操作的ajax回调函数中主动对页面信息进行刷新。
...
top.location.reload()刷新最顶端对象（用于多开窗口）
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f73784c445758:2f61727469636c652f64657461696c732f3737363435393936" class_="artid" style="display:none">
 </p>
</div>
