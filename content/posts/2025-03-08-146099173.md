...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f6d25124d45e4c0fbddde119460b98f4.gif#pic\_left)
...
ports:
- containerPort: 80
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/91602bf93955452d9fb3ad6efe16c7a2.png#pic\_left)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/86d40a84dabe4eeda69968b1a1181c5e.png#pic\_left)
2. 执行命令，更改版本，进行金丝雀部署
kubectl set image deployment myapp-v1 myapp=172.16.80.140/myapp/myapp:v2 && kubectl rollout pause deployment myapp-v1
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0df6d66036f84629b43627fd2b65fadc.png#pic\_left)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/da555e9335c24fbf8692d66f6df98db5.png#pic\_left)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7f23dfcf6a044a8fbc4db90d4cebb494.png#pic\_left)
新生成的pod，已经变成了新的版本
业务运行一段时候，版本没有问题，可以取消暂停完全部署
kubectl rollout resume deployment myapp-v1
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/16f43b03d5dc41e197f2ff96b4738d96.png#pic\_left)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8fe4f758746a4643b91bdc87c9db1517.png#pic\_left)
...
pod不可用数量是 5 - 5\_25% = 3.75，向下取整为3，所以可用的4个，不可用的1个会被干掉
