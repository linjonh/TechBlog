...
# Centos内核升级
内核更新包
kernel-lt-5.4.247-1.el7.elrepo.x86\_64.rpm
kernel-lt-devel-5.4.247-1.el7.elrepo.x86\_64.rpm
内核更新包下载地址
更新步骤
1、rpm -ivh kernel-lt-5.4.247-1.el7.elrepo.x86\_64.rpm kernel-lt-
devel-5.4.247-1.el7.elrepo.x86\_64.rpm
2、修改默认启动顺序
sed -i 's#GRUB\_DEFAULT=.\*#GRUB\_DEFAULT=0#g' /etc/default/grub
3、重新生成 GRUB 配置文件
