...
layout: post
title: "第三方组件安全评估指南"
date: 2024-03-03 12:57:00 +0800
description: "文章讨论了第三方组件，特别是开源和闭源组件的安全风险、合规风险和稳定性问题。强调了建立组件全生命周期"
keywords: "第三方开源及依赖组件使用情况清单"
categories: ['未分类']
tags: ['安全']
artid: "131589667"
image:
  path: https://api.vvhan.com/api/bing?rand=sj&artid=131589667
  alt: "第三方组件安全评估指南"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=131589667
featuredImagePreview: https://bing.ee123.net/img/rand?artid=131589667
---
...
* 组件的稳定性 
    ...
    <p>
     <a href="https://hksanduo.github.io/img/20201216-01.png" rel="nofollow" title="正在上传…重新上传取消">
      正在上传…重新上传取消
     </a>
    </p>
    <p>
     <a href="https://hksanduo.github.io/img/20201216-01.png" rel="nofollow" title="20201216-01">
      20201216-01
     </a>
    </p>
    <h4 id="组件的稳定性">
    ...
    <blockquote>
     <ul>
      ...
      <li>
       ...
       <br/>
       <a href="https://zhuanlan.zhihu.com/p/361101335" rel="nofollow" title="关于开源和闭源的探讨(下) - 知乎">
        关于开源和闭源的探讨(下) - 知乎
       </a>
      </li>
     </ul>
...
* 源代码审计
    ...
    <p>
     首先，使用扫描工具Dependency-check对外部依赖库进行扫描，收集整理项目所用外部依赖库，可用Dependency-Check对其进行批量扫描。Dependency-check具体使用方法参见
     <a href="https://jeremylong.github.io/DependencyCheck/dependency-check-cli/arguments.html" rel="nofollow" title="dependency-check-cli – Command Line Arguments">
      dependency-check-cli – Command Line Arguments
     </a>
     。以下将介绍Dependency-Check的命令行使用方式，开发项目组也可将Dependency-Check集成到所使用的软件（如Ant、Maven、Gradle、Jenkins、Sonar等）中使用：
    </p>
    <p>
    ...
    <table>
     <tbody>
      <tr>
       ...
       <td>
        <pre><code>dependency-check –updateonly
</code>Copy</pre>
       </td>
      </tr>
     </tbody>
    ...
    <table>
     <tbody>
      <tr>
       ...
       <td>
        <pre><code>Dependency-check --project &lt;project name&gt; --scan &lt;jar path&gt; --out &lt;result path&gt; --format &lt;XML/HTML/CSV/JSON/JUNIT/ALL&gt; --disableCentral
</code>Copy</pre>
       </td>
      </tr>
     </tbody>
    ...
    <p>
     <a href="https://hksanduo.github.io/img/20201216-02.jpg" rel="nofollow" title="正在上传…重新上传取消">
      正在上传…重新上传取消
     </a>
    </p>
    <p>
     <a href="https://hksanduo.github.io/img/20201216-02.jpg" rel="nofollow" title="20201216-02.jpg">
      20201216-02.jpg
     </a>
    </p>
    <p>
    ...
    <p>
     ...
     <br/>
     <a href="https://hksanduo.github.io/img/20201216-03.jpg" rel="nofollow" title="正在上传…重新上传取消">
      正在上传…重新上传取消
     </a>
    </p>
    <p>
     <a href="https://hksanduo.github.io/img/20201216-03.jpg" rel="nofollow" title="20201216-03.jpg">
      20201216-03.jpg
     </a>
    </p>
    <p>
    ...
    <pre><code>1、引入前扫描：在引入外部依赖库前，对所用版本进行扫描，保证当前使用的外部依赖库版本不存在漏洞，减少后期升级、维护成本。
...
3、定期扫描：定期对系统使用的外部依赖库进行统一扫描，以全面把控和修复不断暴露出的外部依赖库漏洞。
    ...
    <p>
     <a href="https://hksanduo.github.io/img/20201216-04.png" rel="nofollow" title="正在上传…重新上传取消">
      正在上传…重新上传取消
     </a>
    </p>
    <p>
     <a href="https://hksanduo.github.io/img/20201216-04.png" rel="nofollow" title="20201216-04.jpg">
      20201216-04.jpg
     </a>
    </p>
    <p>
     <a href="https://hksanduo.github.io/img/20201216-05.png" rel="nofollow" title="正在上传…重新上传取消">
      正在上传…重新上传取消
     </a>
    </p>
    <p>
     <a href="https://hksanduo.github.io/img/20201216-05.png" rel="nofollow" title="20201216-05.jpg">
      20201216-05.jpg
     </a>
    </p>
    <h3 id="修复方法">
    ...
    <ul>
     <li>
      <a href="https://www.secrss.com/articles/19703" rel="nofollow" title="CNCERT：2019年开源软件风险研究报告 - 安全内参 | 决策者的网络安全知识库">
       CNCERT：2019年开源软件风险研究报告 - 安全内参 | 决策者的网络安全知识库
      </a>
      【CNCERT：2019年开源软件风险研究报告】
     </li>
     <li>
      <a href="https://www.sec-un.org/%E6%B5%85%E8%B0%88%E6%95%8F%E6%8D%B7%E5%BC%80%E5%8F%91%E6%A8%A1%E5%BC%8F%E4%B8%8B%E9%93%B6%E8%A1%8C%E4%B8%9A%E9%87%91%E8%9E%8D%E6%9C%BA%E6%9E%84%E5%BC%80%E6%BA%90%E8%BD%AF%E4%BB%B6%E5%BC%95%E5%85%A5/" rel="nofollow" title="浅谈敏捷开发模式下银行业金融机构开源软件引入风险及管控举措 – 安全村">
       浅谈敏捷开发模式下银行业金融机构开源软件引入风险及管控举措 – 安全村
      </a>
      【浅谈敏捷开发模式下银行业金融机构开源软件引入风险及管控举措】
     </li>
     <li>
      <a href="https://www.freebuf.com/articles/security-management/123359.html" rel="nofollow" title="访问的文章审核中... - FreeBuf网络安全行业门户">
       访问的文章审核中... - FreeBuf网络安全行业门户
      </a>
      【使用第三方库进行软件开发的安全风险研究 】
     </li>
     <li>
      <a href="https://en.wikipedia.org/wiki/Open-source_software_security" rel="nofollow" title="https://en.wikipedia.org/wiki/Open-source_software_security">
       https://en.wikipedia.org/wiki/Open-source_software_security
      </a>
      【Open source software security】
     </li>
     <li>
      <a href="https://www.ibm.com/downloads/cas/O5PR1WLD" rel="nofollow" title="https://www.ibm.com/downloads/cas/O5PR1WLD">
       https://www.ibm.com/downloads/cas/O5PR1WLD
      </a>
      【如何全面提升企业开源治理能力】
     </li>
     <li>
      <a href="http://www.owasp.org.cn/OWASP_Events/3OWASP.pdf" rel="nofollow" title="http://www.owasp.org.cn/OWASP_Events/3OWASP.pdf">
       http://www.owasp.org.cn/OWASP_Events/3OWASP.pdf
      </a>
      【甲方安全&amp;OWASP 项目分享】
     </li>
     <li>
      <a href="https://mawei.blog/2020/dependency-practice-guide-part-one" rel="nofollow" title="用DependencyTrack管理第三方组件安全（一） - 马伟的博客">
       用DependencyTrack管理第三方组件安全（一） - 马伟的博客
      </a>
      【用DependencyTrack管理第三方组件安全】
     </li>
     <li>
      <a href="https://www.secrss.com/articles/19515" rel="nofollow" title="关于软件供应链安全的几点思考 - 安全内参 | 决策者的网络安全知识库">
       关于软件供应链安全的几点思考 - 安全内参 | 决策者的网络安全知识库
      </a>
      【关于软件供应链安全的几点思考】
     </li>
     <li>
      <a href="https://my.oschina.net/oscpyaqxylk/blog/5075907" rel="nofollow" title="关注企业开源供应链：开源有风险，使用需谨慎！ - OSCHINA编辑部的个人空间 - OSCHINA - 中文开源技术交流社区">
       关注企业开源供应链：开源有风险，使用需谨慎！ - OSCHINA编辑部的个人空间 - OSCHINA - 中文开源技术交流社区
      </a>
      【关注企业开源供应链：开源有风险，使用需谨慎！】
     </li>
     <li>
      <a href="https://www.tc260.org.cn/front/postDetail.html?id=20200617152854" rel="nofollow" title="全国信息安全标准化技术委员会">
       全国信息安全标准化技术委员会
      </a>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f36313835363936332f:61727469636c652f64657461696c732f313331353839363637" class_="artid" style="display:none">
 </p>
</div>
