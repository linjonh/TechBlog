 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <a class="has-card" href="https://blog.csdn.net/wlf2030/article/details/145727495?spm=1001.2014.3001.5502" title="从零搭建微服务项目Pro（第1-3章——Quartz定时任务模块整合）-CSDN博客">
      <span class="link-card-box" contenteditable="false">
       ...
       <span class="link-link">
        <img class="link-link-icon" src="https://csdnimg.cn/release/blog_editor_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=P1C7">
         https://blog.csdn.net/wlf2030/article/details/145727495?spm=1001.2014.3001.5502
        </img>
       </span>
      </span>
     </a>
    ...
    <p>
     <a class="has-card" href="https://github.com/wlf728050719/SpringCloudPro2-2" title="wlf728050719/SpringCloudPro2-2">
      <span class="link-card-box" contenteditable="false">
       <span class="link-title">
       ...
       <span class="link-link">
        <img class="link-link-icon" src="https://csdnimg.cn/release/blog_editor_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=P1C7">
         https://github.com/wlf728050719/SpringCloudPro2-2
        </img>
       </span>
      </span>
     </a>
    ...
    <p>
     <a class="has-card" href="https://blog.csdn.net/wlf2030/article/details/145799620" title="从零搭建微服务项目（全）-CSDN博客">
      <span class="link-card-box" contenteditable="false">
       <span class="link-title">
        从零搭建微服务项目（全）-CSDN博客
       </span>
       <span class="link-link">
        <img class="link-link-icon" src="https://csdnimg.cn/release/blog_editor_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=P1C7">
         https://blog.csdn.net/wlf2030/article/details/145799620
        </img>
       </span>
      </span>
     </a>
    ...
    <p class="img-center">
     <img alt="" height="172" src="https://i-blog.csdnimg.cn/direct/2a2738e8100b4dcaba56dd34b7e93882.png" width="164"/>
    </p>
    <hr/>
    <h2>
     一、前置项目准备
    ...
    <p>
     <img alt="" height="27" src="https://i-blog.csdnimg.cn/direct/4a9bed609bc24fcfbdd097e4ed8f8a72.png" width="756"/>
    </p>
    <p>
     2.重命名模块为Pro2_2。
    </p>
    <p>
     <img alt="" height="485" src="https://i-blog.csdnimg.cn/direct/27b4465bcd3d4de3882f4ffe9eff10a3.png" width="888"/>
    </p>
    <p>
     3.父工程pom.xml中&lt;name&gt;改成Pro2_2。
    </p>
    <p>
     <img alt="" height="241" src="https://i-blog.csdnimg.cn/direct/145dd665b824462ab646d59264e48a4f.png" width="428"/>
    </p>
    <p>
     4.选择环境为dev,并重新加载maven。
    </p>
    <p>
     <img alt="" height="489" src="https://i-blog.csdnimg.cn/direct/265f0a93223a45e9b66834cd5de40df5.png" width="838"/>
    </p>
    <p>
     5.启动nacos（安装和启动见第三章）。
    </p>
    <p>
     <img alt="" height="646" src="https://i-blog.csdnimg.cn/direct/60acf653c6b143d3aedb0a7dea65f0ba.png" width="1546"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="440" src="https://i-blog.csdnimg.cn/direct/fad42b8283c745208f06881289d20872.png" width="1200"/>
    </p>
    <p>
     <img alt="" height="417" src="https://i-blog.csdnimg.cn/direct/46fabab506a941078899aeeee7a8ebdd.png" width="883"/>
    </p>
    <p>
     7.配置数据源，更换两服务的resources下yml文件的数据库配置,数据库sql如下：
    </p>
    <p>
     <img alt="" height="474" src="https://i-blog.csdnimg.cn/direct/9ce2f4edc1994355b1bbdbffe4741826.png" width="1553"/>
    </p>
    <p>
     <img alt="" height="366" src="https://i-blog.csdnimg.cn/direct/e36a8bbaa333425e8d92c6fbf21d375c.png" width="250"/>
    </p>
...
(
    ...
    <pre><code class="language-sql">create table tb_task
(
    id              int auto_increment
        primary key,
    ...
    <pre><code class="language-sql">create table tb_task_log
(
    id             int auto_increment
        primary key,
...
(
    ...
    <p>
     <img alt="" height="235" src="https://i-blog.csdnimg.cn/direct/49353235767a4b2dbdb09671d873cdc7.png" width="615"/>
    </p>
    <p>
     测试连接
    </p>
    <p>
     <img alt="" height="764" src="https://i-blog.csdnimg.cn/direct/091cab4b295542f1b4329077f46df74a.png" width="1152"/>
    </p>
    <p>
     8.添加运行配置 服务-&gt;加号-&gt;运行配置类型-&gt;spring boot。
    </p>
    <p>
     <img alt="" height="319" src="https://i-blog.csdnimg.cn/direct/92e55c99099c4ae3a1fcb397b92e41c3.png" width="662"/>
    </p>
    <p>
     9.启动服务，测试接口。
    </p>
    <p>
     <img alt="" height="287" src="https://i-blog.csdnimg.cn/direct/9a67d9980e4b46b185bcd081fc84ba61.png" width="890"/>
    </p>
    <p>
     常规业务测试
    </p>
    <p>
     <img alt="" height="135" src="https://i-blog.csdnimg.cn/direct/b0963fbb415d44e0b8185ea57fd1a6b2.png" width="1951"/>
    </p>
    <p>
     quartz定时模块测试：（确保tb_task中没有数据）
    </p>
    <p>
     <img alt="" height="933" src="https://i-blog.csdnimg.cn/direct/ac101deb44584815b418c4b62be2a610.png" width="1282"/>
    </p>
    <p>
     <img alt="" height="915" src="https://i-blog.csdnimg.cn/direct/283f32dbe0244fb48619c96d73a0dafc.png" width="993"/>
    </p>
    <p>
     <img alt="" height="204" src="https://i-blog.csdnimg.cn/direct/8afce73b81084a8f8b8895386c4b062f.png" width="1382"/>
    </p>
    <hr/>
    <h2>
     二、JSR合并至common模块
    ...
    <p>
     <img alt="" height="165" src="https://i-blog.csdnimg.cn/direct/7dc4e327a2ef4e78a8614bfb80156fa9.png" width="815"/>
    </p>
    <p>
     common的pom内容如下：
    </p>
...
&lt;/project&gt;
    ...
    <p>
     <img alt="" height="749" src="https://i-blog.csdnimg.cn/direct/12939565f84946e7b93686fe9847fe1a.png" width="797"/>
    </p>
    <p>
    ...
    <pre><code class="language-java">package cn.bit.common.jsr.constant;
...
public class Prefix {
    ...
    <pre><code class="language-java">package cn.bit.common.jsr.enums;
...
public enum StringEnum {
    ...
    <pre><code class="language-java">package cn.bit.common.jsr.pojo;
...
public class FileLimit {
    ...
    <p>
     <img alt="" height="176" src="https://i-blog.csdnimg.cn/direct/eb68f36295d04f3db390c5745a608e98.png" width="387"/>
    </p>
    <pre><code class="language-java">package cn.bit.common.exception;
...
public class SysException extends RuntimeException {
  ...
  public SysException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
    ...
    <pre><code class="language-java">package cn.bit.common.jsr.config;
...
public class JSRConfig {
    ...
    <pre><code class="language-java">package cn.bit.common.jsr.annotation;
...
public @interface ValidString {
    ...
    <pre><code class="language-java">package cn.bit.common.jsr.validator;
...
public class StringValidator implements ConstraintValidator&lt;ValidString, String&gt; {
    ...
    <pre><code class="language-java">package cn.bit.common.handler;
...
public class GlobalExceptionHandler {
    ...
    <p>
     <img alt="" height="540" src="https://i-blog.csdnimg.cn/direct/c82ca43a60cb44a1a14142a6a0741895.png" width="610"/>
    </p>
    <pre><code class="language-XML">org.springframework.boot.autoconfigure.EnableAutoConfiguration=\
  cn.bit.common.jsr.config.JSRConfig,\
  cn.bit.common.handler.GlobalExceptionHandler</code></pre>
    <p>
     13.修改order-service的controller作为测试接口
    </p>
    <pre><code class="language-java">package cn.bit.orderservice.controller;
...
&lt;/html&gt;</code></pre>
    ...
    <p>
     <img alt="" height="321" src="https://i-blog.csdnimg.cn/direct/f99f97cde8eb4d92ba7e9a31f06a788b.png" width="1225"/>
    </p>
    <p>
     打开前端页面：
     <br/>
     <img alt="" height="170" src="https://i-blog.csdnimg.cn/direct/93090e5477974a15aebeb17ffbab0e63.png" width="562"/>
    </p>
    <p>
     选择上传一个文档（能够看到返回错误码，以及报错信息文件拓展名错误，上传成功是因为前端是ai生成的，后端没有设置响应码状态所以误判为成功）
    </p>
    <p>
     <img alt="" height="219" src="https://i-blog.csdnimg.cn/direct/84847c1b4d024d519f0b7506ff5fba59.png" width="1394"/>
    </p>
    <p>
     选择上传图片（显示文件命名不符合规范）
    </p>
    <p>
     <img alt="" height="207" src="https://i-blog.csdnimg.cn/direct/0e92c59a7f934579958220fe613750b3.png" width="1441"/>
    </p>
    <p>
     选择上传正确格式图片，成功返回上传的图片名称。
    </p>
    <p>
     <img alt="" height="204" src="https://i-blog.csdnimg.cn/direct/4aecfbd43aa3437e9aabec423adeee52.png" width="623"/>
    </p>
    <hr/>
    <h2>
     最后：
    ...
    <p>
     <img alt="" height="36" src="https://i-blog.csdnimg.cn/direct/2bd308cf63d34579b334705f41e66192.png" width="699"/>
    </p>
    <p>
     <img alt="" height="143" src="https://i-blog.csdnimg.cn/direct/da498064a81c4261b1025058111ff048.png" width="311"/>
    </p>
    <p>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f776c66323033302f:61727469636c652f64657461696c732f313436303430363632" class_="artid" style="display:none">
 </p>
</div>
