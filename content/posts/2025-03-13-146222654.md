...
print(df)
df.to\_excel('D:\\output1.xlsx', index=False)
注意：
...
print(df)
df.to\_excel('D:\\output5.xlsx', index=False)
...
df = pd.DataFrame(data)
print(df)
df.to\_excel('D:\\output2.xlsx', index=False)
...
df = pd.DataFrame(data)
print(df)
df.to\_excel('D:\\output3.xlsx', index=False)
...
df = pd.DataFrame(data)
print(df)
df.to\_excel('D:\\output4.xlsx', index=False)
