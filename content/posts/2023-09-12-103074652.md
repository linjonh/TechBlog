 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     leafserver下载地址：
     <a href="https://codeload.github.com/name5566/leafserver/zip/master" rel="nofollow">
      https://codeload.github.com/name5566/leafserver
     </a>
    </p>
    <h2>
     目录说明
    </h2>
    <pre class="has"><code>leaf/chanrpc 提供了一套基于 channel 的 RPC 机制，用于游戏服务器模块间通讯
...
leaf/util 辅助库</code></pre>
    ...
    <p>
     <img alt="" class="has" height="82" src="https://i-blog.csdnimg.cn/blog_migrate/26ec43c11583adad2b4656c039cea74c.png" width="733"/>
    </p>
    <h2>
     解读这个官网的main
    </h2>
    ...
    <pre class="has"><code class="language-Go">import lconf "github.com/name5566/leaf/conf"
func main() {
    ...
    <pre class="has"><code class="language-Go">type Module interface {
	OnInit()
	OnDestroy()
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f32353439303537332f:61727469636c652f64657461696c732f313033303734363532" class_="artid" style="display:none">
 </p>
</div>
