  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <div id="js_content">
     ...
     <p>
      <img alt="2fc8ecade7a2772f3a2e600c4d5f90ce.png" src="https://i-blog.csdnimg.cn/img_convert/2fc8ecade7a2772f3a2e600c4d5f90ce.png"/>
     </p>
     <p>
     ...
     <p>
      <img alt="b4d76484960da4116e6ca768b3203591.png" src="https://i-blog.csdnimg.cn/img_convert/b4d76484960da4116e6ca768b3203591.png"/>
     </p>
     <h3>
      三、LED基础控制实现：
     </h3>
     ...
     <pre class="has"><code class="language-go">from machine import Pin
import time
...
        time.sleep(1)</code></pre>
     ...
     <pre class="has"><code class="language-go">import network
import time
...
        time.sleep(1)
    print('Connected on {ip}'.format(ip = wlan.ifconfig()[0]))</code></pre>
     <h3>
      五、服务端API设计
     </h3>
     <p>
     ...
     <pre class="has"><code class="language-go">// 根据随机数返回结果
...
response.FailWithMessageCode(500, clientIP+" error", c)
     ...
     <pre class="has"><code class="language-go">import urequests
def check_ledAPI():
...
        return False</code></pre>
     ...
     <pre class="has"><code class="language-go">def ctrl_led():
    p5 = Pin(5, Pin.OUT)
    
    while True:
...
    ctrl_led()</code></pre>
     ...
     <pre class="has"><code class="language-go">MPY: soft reboot
...
led on</code></pre>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f753031343435383639322f:61727469636c652f64657461696c732f313436313236363836" class_="artid" style="display:none">
 </p>
</div>
