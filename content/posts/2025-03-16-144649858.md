 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" height="571" src="https://i-blog.csdnimg.cn/direct/54980c8936324ca3b6f424ef0e7fb06c.jpeg" width="300"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/c833953b7cc1414aa95277f32176aa23.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/49502a1ddc37412bacd6b4d8f97242b6.png"/>
    </p>
    <h3>
     B_代码复用
    </h3>
    ...
    <pre><code class="language-python">def run_main_analyser (df_list,run_strategy,i, sdate1,sdate2,list_analyzer): 
    #......
    cerebro = bt.Cerebro()
    #......
    ...
    <pre><code class="language-python">sel2 = ('基准','经典_MACD', '经典_KDJ', '经典_双均线', '短均线策略', 'EXPMA9单线', '经典布林线策略') 
...
df_analyzer2 = pd.DataFrame(list_analyzer2)</code></pre>
    <p>
     最后，得到的DataFrame进行数据处理，再通过wxPython的ListCtrl控件显示在窗口中就完成了。
    </p>
    <pre><code class="language-python">    df_sorted = df_analyzer2.sort_values(by='近1年', ascending=False)
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/2852d42508d34362ab135198ced3c1b6.png"/>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f626c6f67:2e6373646e2e6e65742f62616964755f32343139303431332f:61727469636c652f64657461696c732f313434363439383538" class_="artid" style="display:none">
 </p>
</div>
