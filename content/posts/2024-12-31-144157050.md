...
点击新建，变量值为%JAVA\_HOME%\bin ，%JAVA\_HOME%\jre\bin并将它移到最前端，然后点击确定。
...
\*
*找到这个路径 计算机\HKEY\_LOCAL\_MACHINE\SOFTWARE\JavaSoft\**
...
将 C:\Windows\System32 路径下原有的三个文件（ java.exe，javax.exe，javac.exe）用新使用的版本java7（自己的java7版本的安装路径 D:\Environment\Java\jdk1.7.0\_80\bin )中相应的文件替换掉！！！
