...
[持续集成Drone如何支持gitlab subgroup子分组构建\_Terry-21的博客-CSDN博客\_gitlab新建subgroup](https://blog.csdn.net/niuxshan/article/details/123255470 "持续集成Drone如何支持gitlab subgroup子分组构建_Terry-21的博客-CSDN博客_gitlab新建subgroup")
