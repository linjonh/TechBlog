 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="216" src="https://i-blog.csdnimg.cn/blog_migrate/fdb925389d4223750539c424ad3465b7.png" width="604"/>
    </p>
    <p>
     <img alt="" height="476" src="https://i-blog.csdnimg.cn/blog_migrate/617c17518054409963b92585f56548d3.png" width="768"/>
    </p>
    <p>
     一：java异常体系
    </p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/84256471059fe8446f26baa131d2554b.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/d7df85f6e21ab479055f4b904577baa7.png"/>
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/9a359100f169a03589d2e85bd83e387a.png"/>
    </p>
    <hr/>
    <p>
...
public class ThisDemo06{
    ...
    <pre><code>public class ThrowsDemo01 {
...
class Math{
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/f4508f5b707c914e0135fe90d570ec22.png"/>
    </p>
    <p>
     在本程序中，主方法不处理任何异常，而交给JAVA中最大头JVM，所以如果在主方法使用了throws关键字，则表示一切异常交给JVM进行处理。
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/5a5307a4e17c5a593c4cb700db4ac21c.png"/>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f36313938333537352f:61727469636c652f64657461696c732f313232383734313633" class_="artid" style="display:none">
 </p>
</div>
