---
arturl_encode: "68747470733a2f2f626c6f:672e6373646e2e6e65742f4c616f5975616e507974686f6e2f:61727469636c652f64657461696c732f313137353237323737"
layout: post
title: "鸿蒙最新功能及承载设备详解HarmonyOS-2及华为全场景新品发布会全纪录"
date: 2024-10-17 15:48:21 +08:00
...
6月2日，华为联手CSDN直播了“
[HarmonyOS 2及华为全场景新品发布会](https://live.csdn.net/room/harmonycommunity/vqo1KndP?utm_medium=distribute.app_letter_persion.544812.nonecase)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3ca445668179963cba94b24e4d110003.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/41f63aac62d49b938c9d9e808750e4a8.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/63cd7ee76d4ec4fd8b52aa7ba1c7b7d5.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1059db861a32634f89fe0aa0a2322f76.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e6d565b0d733fd78cbdb061bbff5e987.png)
  
卡片承载着重要的信息，象便笺一样放到桌面后，锁屏后可以不用解锁就可以看到卡片的信息，可以在多屏展示时，做到每屏设置不同场景。
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5fabbf0b1c3ecd8b077a909e0fb1d072.png)
  
可以将多个应用放到一个文件夹内，轻触文件夹可以将其变为大文件夹存放在桌面，在大文件夹内可以显示文件夹内的应用，并可以直接打开：

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ba48e5b615a190fb2178f4a71653c451.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/755ef2ff61bad830242299f0d6a9954c.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/743aa81921d0bf420ba38ac6cd8373cc.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/182c64050201b13fa93eb9ae2c31d0e7.png)
  
在这方面，王博士重点介绍了两点：

* 动态空间管理，避免内存和存储碎片化，解决越用越慢的问题
    
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a8de87dcd511873a9626b934dcc8afe9.png)
* 使用华为自研的图形栈，使用GPU和CPU联合渲染：
  ...
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ba8b5264a5781eede9280d8b177e9ada.png)

3、在绘图时使用了render service的能力，不再做重复图形的绘制，让视频处理负载大大降低，使得操作更流畅，续航时间更长
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f507014f7b608cd907ec9495153da1cd.png)
  
同样机型使用鸿蒙和安卓的续航时间对比：
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d97befe978446b2901b9488456b43cd8.png)
  
和最新IOS续航时间对比：
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b5367cda26a08a1340fc41898abc3d99.png)

##### 2.9、安全和隐私

多设备协同认证的等级远高于单设备：
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/18595163fd14b2831dc75dbb388d1064.png)
  
符合安全能力的设备才允许加入超级终端：
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d2c4d1900ddd2dd0477629281d7783a2.png)
  
和全球最顶尖的第三方认证机构合作：
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d595bb047e068b47af8384e7f1e94a2e.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/cc2a06e164b7cc227938c4c60ceb56a4.png)
  
支持RAM从小到128K的设备，用分布式的技术打破硬件边界，全新的原子化服务和卡片设计，实现了极致的性能。
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/03874882514be524462eef6f725f4dbf.png)
  
和鸿蒙合作创新的合作伙伴：

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/79916a393db334815a937df461467830.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/17144e96d75e89041eb3be3c7ae25c54.png)
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c67f9f9c9a5f1d2a3d1e3de36263ddca.png)
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/08b9142a69cd5daeaed77f2b65e170ab.png)
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a2b8b3dec69b433350b9b5f5719c3d0a.png)

##### 3.2、升级计划

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c71dea64e44385991547fbeb743af121.png)
...
4. 部分老旧机型明年上半年
   ...
   ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b689616d2d6ecb9785926bd29a52e705.png)
...
5. 华为的产品价格确实不亲民。
   ...
   ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/67beb94db93956f3a7df92fb78dd9998.png)
