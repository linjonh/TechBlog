   ...
   <div class="htmledit_views" id="content_views">
    ...
    <ul>
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250314205306546" height="159" src="https://i-blog.csdnimg.cn/img_convert/1ffe81abb2c3fedba9341c56b1c0f6f2.png" width="1086"/>
      </p>
      <ul>
       <li>
        <p>
    ...
    <p class="img-center">
     <img alt="image-20250314215620769" height="354" src="https://i-blog.csdnimg.cn/img_convert/2b4dce003ceba525c7330972be006274.png" width="541"/>
    </p>
    <h2>
     、交换机端口类型处理数据帧的方式
    </h2>
    ...
    <ul>
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250314222347435" height="874" src="https://i-blog.csdnimg.cn/img_convert/7ca665e0d984f0f2b9a2fb8c140f73da.png" width="1658"/>
      </p>
     </li>
     <li>
      <p>
     ...
     <li>
      ...
      <ul>
       ...
       <li>
        ...
        <p class="img-center">
         <img alt="image-20250316113056671" height="572" src="https://i-blog.csdnimg.cn/img_convert/0c179066c87dfb6f818a812078529c97.png" width="740"/>
        </p>
        <pre>例如VLAN2与VLAN3的通信:
PC1发包到ASW中,经过G1/0/2端口,PVID是2
此时数据包的tag为2,ASW查询发现去PC2,发往g1/0/3
g1/0/3的untagged是3和10;tag2无法剥离,不能通过流量到达不了PC2;</pre>
        <p>
        </p>
       </li>
      </ul>
     ...
     <li>
      ...
      <ul>
       ...
       <li>
        ...
        <p class="img-center">
         <img alt="image-20250316113428622" height="127" src="https://i-blog.csdnimg.cn/img_convert/68bda152ea25f110d2b87a0938bacf07.png" width="935"/>
        </p>
       </li>
      </ul>
     </li>
    ...
    <p class="img-center">
     <img alt="image-20250315202750613" height="334" src="https://i-blog.csdnimg.cn/img_convert/abccdfb6d1b14269a457f08dd88ca0ed.png" width="700"/>
    </p>
    <ul>
     <li>
      <p>
    ...
    <ul>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250315203745739" height="372" src="https://i-blog.csdnimg.cn/img_convert/4a9b4fe1e95b0b1a760592dbed3d76bf.png" width="801"/>
      </p>
     </li>
     <li>
      <p>
      ...
      <p class="img-center">
       <img alt="image-20250316115506709" height="612" src="https://i-blog.csdnimg.cn/img_convert/48b7426e39bfa83347ecca2e9448c778.png" width="1013"/>
      </p>
      <ul>
       <li>
        <p>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250316120207087" height="399" src="https://i-blog.csdnimg.cn/img_convert/2870a346ae61088cee0eda3a5326b99e.png" width="686"/>
      </p>
      <p>
      </p>
      <p class="img-center">
       <img alt="image-20250315204258792" height="379" src="https://i-blog.csdnimg.cn/img_convert/9a120e42f7a725941fc78d30b09cf3a8.png" width="529"/>
      </p>
     </li>
     <li>
      <p>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250316120336392" height="253" src="https://i-blog.csdnimg.cn/img_convert/521753cdf4cc8e3aa49d22a0052bd68a.png" width="546"/>
      </p>
      <ul>
       <li>
        <p>
    ...
    <ul>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250316133016380" height="454" src="https://i-blog.csdnimg.cn/img_convert/84f6862b88e5ce88804cda3d4c48789d.png" width="994"/>
      </p>
     </li>
     <li>
      <p>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250316133246136" height="477" src="https://i-blog.csdnimg.cn/img_convert/bc0d91320276b4f80101c36096366c1a.png" width="1046"/>
      </p>
     </li>
     <li>
      <p>
    ...
    <ul>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250315205027566" height="330" src="https://i-blog.csdnimg.cn/img_convert/8e99f5e1a30723f4622f387a1da71260.png" width="546"/>
      </p>
      <ul>
       <li>
        <p>
     ...
     <li>
      ...
      <p class="img-center">
       <img alt="image-20250315210000956" height="323" src="https://i-blog.csdnimg.cn/img_convert/87171d2452a2b896acaeea3ae1d272a9.png" width="500"/>
      </p>
      <ul>
       <li>
        <p>
      ...
      <table>
       ...
       <tbody>
        <tr>
         ...
         <td>
          用于处理三层转发，基于 DEF_IP 表进行路由查询
         </td>
         <td>
          用于处理二层转发或已知的三层转发表项（如 IPFDB 表）
         </td>
        </tr>
        <tr>
         <td>
         ...
         <td>
          选择与目的 IP 地址匹配最长的路由条目
         </td>
         <td>
          直接匹配目的 MAC 地址或 IP 地址
         </td>
        </tr>
        <tr>
         <td>
     ...
     <li>
      ...
      <ul>
       <li>
        ...
        <p class="img-center">
         <img alt="image-20250316135417723" height="279" src="https://i-blog.csdnimg.cn/img_convert/7b9983dc9e5d600706b3947f8369fd95.png" width="926"/>
        </p>
        <ul>
         <li>
          <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f4c696e5f4a756d70696e672f:61727469636c652f64657461696c732f313436323934363833" class_="artid" style="display:none">
 </p>
</div>
