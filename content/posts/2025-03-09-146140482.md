...
<div class="blog-content-box">
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/79d8acf493b844999a2696516f54fdb5.png"/>
    </p>
    <h4>
     <a id="31_Vectorized_Scene_Learning_6">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1107a96c2e29421199ce01bce50447c0.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/9e519c376cd14011a4174108ae2b477f.png">
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/84492d3d06544406bde7a7c114b891ae.png">
        <br/>
        ...
        <br/>
        <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/938da212d14b4cf99124bfc48a8bfca0.png">
         <br/>
         ...
         <br/>
         <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/eb78ffe3cfa54e1ba34399252a67bb98.png">
          <br/>
    ...
    <h4>
     <a id="32_Vectorized_Scene_Learning_24">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/5dae7894262b44c1b6754b0101a322cc.png">
      <br/>
      第二阶段会继续对ego query进行融合，这个过程中第一阶段的结果Q’ego会作为query，map query会作为key和value进行融合，这一阶段唯一的区别在于计算位置编码时使用了两层的MLP。
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f997d1a712844b2b9fc2fa143cb639af.png">
       <br/>
       完成这两步之后，VAD将两个query以及一些可选项进行叠加，之后作为规划头进行推理。输出的是规划的路径，这里的规划头并不复杂，是一个基于MLP的结构。
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7fb50d52948943bb8a7adfa6d7797f30.png"/>
       <br/>
       这里补了一下backnone、neck和head的概念，深度学习的一个网络可以拆分为三部分：backnone、neck和head。以卷积神经网络为例，backbone就是卷积层，负责提取图像中的特征，提取到的feature map在neck的部分进行整合与加工，之后head会根据具体的任务需求利用neck的处理结果完成不同的任务，这里的planhead，相当于是完成了前面的特征提取部分，送入planning transformer进行具体的规划生成，这一过程使用了更新的ego query作为输入，结合车辆状态等内容，变成了具体的预测轨迹。
      </img>
     </img>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34333834393530352f:61727469636c652f64657461696c732f313436313430343832" class_="artid" style="display:none">
 </p>
</div>
