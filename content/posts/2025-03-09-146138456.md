 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <h3>
     <img alt="" height="1131" src="https://i-blog.csdnimg.cn/direct/ba7bd0c805a04b519cccaf1a365ca917.png" width="1551"/>
    </h3>
    <h3>
     一、引言
    </h3>
    ...
    <ul>
     <li>
      ...
      <a href="https://docs.docker.com/engine/install/ubuntu/" rel="nofollow" title="Ubuntu 官方安装文档">
       Ubuntu 官方安装文档
      </a>
      。在 CentOS 系统上，安装教程见
      <a href="https://docs.docker.com/engine/install/centos/" rel="nofollow" title="CentOS 官方安装文档">
       CentOS 官方安装文档
      </a>
     ...
     <li>
      ...
      <a href="https://docs.docker.com/desktop/install/windows-install/" rel="nofollow" title="Docker Desktop for Windows 官方文档">
       Docker Desktop for Windows 官方文档
      </a>
     ...
     <li>
      ...
      ：
      <a href="https://docs.docker.com/desktop/install/mac-install/" rel="nofollow" title="Docker Desktop for Mac 官方文档">
       Docker Desktop for Mac 官方文档
      </a>
    ...
    <pre><code class="hljs"># 使用官方的Python基础镜像
FROM python:3.9
...
CMD ["python", "app.py"]
    ...
    <pre><code>docker run -p 5000:5000 flask-app
</code></pre>
    <p>
     这里的
     <code>
    ...
    <pre><code>mysql -h 127.0.0.1 -P 3306 -u myuser -p
</code></pre>
    <p>
     这里的
     <code>
...
deploy:
  ...
  script:
    ...
    <ol>
     <li>
      ...
      ：
      <a href="https://docs.docker.com/" rel="nofollow" title="Docker Docs">
       Docker Docs
      </a>
      <br/>
     ...
     <li>
      ...
      ：
      <a href="https://www.docker.com/blog/" rel="nofollow" title="Blog | Docker">
       Blog | Docker
      </a>
      <br/>
 ...
 <p alt="68747470:733a2f2f626c6f672e6373646e2e6e65742f4c4a595f43462f:61727469636c652f64657461696c732f313436313338343536" class_="artid" style="display:none">
 </p>
</div>
