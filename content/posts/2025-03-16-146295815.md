...
# 苹果app上架app store 之苹果开发者账户在mac电脑上如何使用钥匙串访问-发行-APP发布证书ios\_distribution.cer-
优雅草卓伊凡
## 苹果app上架app store 之苹果开发者账户在mac电脑上如何使用钥匙串访问-发行-APP发布证书ios\_distribution.cer-
优雅草卓伊凡
## 背景
...
#### 1\. 打开钥匙串访问
搜索钥匙串，在设置中
![](https://i-blog.csdnimg.cn/img\_convert/6efb3654b6fa9008a3f60b2a46233f4d.png)
密码输入后发现，错了，不在这里，很久没用了 ，
1.在苹果电脑的“聚焦搜索”（点击菜单栏右上角的放大镜图标 ）中输入“钥匙串访问”，然后打开该应用程序。
在电脑上搜索，钥匙串，
![](https://i-blog.csdnimg.cn/img\_convert/0569fe721b36cb4e747c2e6c6bb68ad2.png)
这回对了，点击打开钥匙串访问
![](https://i-blog.csdnimg.cn/img\_convert/ae4b8c507425094a8a4e02dc68e3a106.png)
#### 2\. 创建证书签名请求 (CSR)
1.在“钥匙串访问”应用中，依次点击菜单栏的“钥匙串访问”>“证书助理”>“从证书颁发机构请求证书” 。
![](https://i-blog.csdnimg.cn/img\_convert/f8007410d66b135f092262fae80f017e.png)
2.在弹出的“证书信息”窗口中：
...
![](https://i-blog.csdnimg.cn/img\_convert/b269f40893dbdab01d7c41dd72305ecc.png)
3.在左侧菜单中选择“Certificates, IDs & Profiles”（证书、标识符和描述文件） 。
4.在“Certificates”（证书）部分，点击“+”号创建新证书。
![](https://i-blog.csdnimg.cn/img\_convert/b40c82b63b4ffb7fd45fe4b87f5d6158.png)
...
- 点击“Generate”（生成）。
![](https://i-blog.csdnimg.cn/img\_convert/015dd304ff51fe616e8df92984619701.png)
上传之前保存在本地的文件
![](https://i-blog.csdnimg.cn/img\_convert/d14a9d0b0c207213ce8ae8a2733c0df7.png)
7.生成后，点击“Download”（下载），将证书文件（通常为`.cer`格式）保存到本地。
![](https://i-blog.csdnimg.cn/img\_convert/c0a70eeed60de85f63c6c8d50d8432fd.png)
保存好后即可完成
![](https://i-blog.csdnimg.cn/img\_convert/8ae38127ddea6ae98917f6d048c4d648.png)
#### 4\. 安装发布证书
