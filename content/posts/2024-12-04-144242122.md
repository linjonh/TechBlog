...
[数字后端教程之Innovus report\_property和get\_property使用方法及应用案例](https://editor.csdn.net/md/?articleId=143702284)
...
二.基于TSMC 12nm ARM A72 maia\_cpu + A55 ananke\_core 模块级的物理实现课程
