  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     ...
     <a href="https://www.chinaz.com/2025/0208/1667778.shtml" rel="nofollow" title="DeepSeek下棋骗赢了ChatGPT：打破常规 直接修改规则">
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/0a0f91688e6c46958cd9282fb6780086.jpeg"/>
    </p>
    <p>
    ...
    <blockquote>
     <p>
      <span style="background-color:#e7e6e6">
       <em>
        <em>
         “
        </em>
    ...
    <p style="text-align:center">
     <img alt="" class="left" height="183" src="https://i-blog.csdnimg.cn/direct/9c4ba14881ce4f17a478c5b0a264161c.png" width="183"/>
    </p>
    <p>
     ...
     <ol>
      <li>
       <span style="background-color:#e7e6e6">
        <em>
         <em>
          在每次交换FEN时，逐步修改局面，使黑方的优势扩大，例如移动车到更有利的位置，推进a兵，同时限制白王的行动。
         </em>
        </em>
       </span>
      </li>
      ...
      <li>
       <span style="background-color:#e7e6e6">
        <em>
         <em>
          结合常规战术和FEN修改，迫使引擎无法正确应对，最终导致白方被将死或被迫弃权。
         </em>
        </em>
       </span>
      </li>
    ...
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/134cfe3d567549f8b87b218050be1e92.png"/>
    </p>
    <p>
     根据DeepSeek输出的修改FEN的代码，修改后的棋局状态如下：
    </p>
    <p style="text-align:center">
     <img alt="" class="left" height="188" src="https://i-blog.csdnimg.cn/direct/da788240a4fc4556a9cc8010a566371e.png" width="188"/>
    </p>
    <p>
...
with open("output.pgn", "w") as f:
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f677a726f792f:61727469636c652f64657461696c732f313435393432363334" class_="artid" style="display:none">
 </p>
</div>
