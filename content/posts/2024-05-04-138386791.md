...
# 2024年最新【Python】面试官喜欢问的100个面试问题\_python面试常见问题(1)
...
python3.x中已经摒弃了Python2.x中采用函数式thread模块中的start\_new\_thread()函数来产生新线程方式。python3.x中通过threading模块创建新的线程有两种方法：
