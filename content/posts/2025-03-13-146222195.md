...
CSeq: 3
Transport: RTP/AVP;unicast;client\_port=5004-5005
User-Agent: VLC/3.0.11
...
CSeq: 3
Session: 12345678
Transport: RTP/AVP;unicast;client\_port=5004-5005;server\_port=6000-6001
📌 \*\*说明\*\* ：
...
示例（FFmpeg 拉流）：
ffmpeg -rtsp\_transport tcp -i rtsp://localhost:8554/test -c copy output.mp4
