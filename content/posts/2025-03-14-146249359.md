...
让我们更仔细地检查 `plus\_one` 的第一行操作。当调用 `plus\_one(five)` 时，`plus\_one` 函数体中的 `x` 将会是值
`Some(5)`。接着将其与每个分支比较。
None => None,
...
下一篇[《Rust语言基础15》](https://blog.csdn.net/qq\_36393978/article/details/146249359)
\* \* \*
...
> [本文链接]: https://blog.csdn.net/qq\_36393978/article/details/146249359