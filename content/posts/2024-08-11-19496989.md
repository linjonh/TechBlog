 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-java">GroovyShell shell = new GroovyShell();
...
str1.concat(str2)
    ...
    <pre><code class="language-java">groovy.lang.MissingMethodException: No signature of method: Script1.customConcat() is applicable for argument types: (java.lang.String, java.lang.String) values: [value1, value2]
...
at groovy.lang.GroovyShell.evaluate(GroovyShell.java:518)
    ...
    <pre><code class="language-java">GroovyClassLoader loader = new GroovyClassLoader();
...
Object res = groovyObject.invokeMethod("customConcat", new Object[]{"value1", "value2"});
    ...
    <pre><code class="language-java">Binding binding = new Binding();
...
System.out.println(scrpt.evaluate("str1.concat(str2)"));
    ...
    <pre><code class="language-java">System.out.println(scrpt.invokeMethod("customConcat", new String[]{"value1","value2"}));
</code></pre>
    <br/>
    <br/>
    <br/>
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f6a69616e6774616f5f7374:2f61727469636c652f64657461696c732f3139343936393839" class_="artid" style="display:none">
 </p>
</div>
