...
\* + - [1、VS软件](#1VS\_3)
- [2、三菱软件](#2\_5)
- [3、MX Component](#3MX\_Component\_7)
\* [二、测试过程](#\_12)
\* + - [1、MX Component示例项目路径](#1MX\_Component\_15)
- [2、创建测试项目](#2\_24)
- [3、代码编写](#3\_33)
\* [三、测试结果](#\_55)
## 一、测试前准备
...
打开后直接F5就可以运行测试
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/5a238fa2a1d297c82325cd804407f451.png)
具体测试过程我就不赘述了，网上有很多。
#### 2、创建测试项目
我们这里使用VS2022新建一个windows窗体应用
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/d51143f84644fdf722f7207c468912f4.png)
界面上放一个textBox用于显示数据
再放一个button用于触发读取数据事件
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/6ca98d0add9f78a12060b1b914665576.png)
引用一下act文件
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/b8ac4a6db05796e131c72a6b39aae081.png)
#### 3、代码编写
...
## 三、测试结果
读取32位整数
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/19fb9d47fa636801e821fefd9c2e2790.png)
读取浮点数
由于PLC里面的有效位数是7位，所以PLC里显示的最后以为可能不一样，只要把我们的VS上的有效数位设置成一样的就完全一样了
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog\_migrate/116a14d15b619f341efb350b870ac9c0.png)
如果有更好的方法，欢迎一起分享讨论
Ending~