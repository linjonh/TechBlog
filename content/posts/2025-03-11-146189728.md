...
date: 2025-03-11 22:28:57 +0800
description: "计算机图形学交互式技术实验（鼠标、拾取操作和菜单）——绘制可用鼠标进行修改颜色的五角星和矩形"
keywords: "计算机图形学交互式技术实验（鼠标、拾取操作和菜单）——绘制可用鼠标进行修改颜色的五角星和矩形"
categories: ['计算机图形学']
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="826" src="https://i-blog.csdnimg.cn/direct/d2ebe48ad2344de8949f807da190cdcf.png" width="1224"/>
    </p>
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/b66d725d7ef54cc092f9816c801b05cc.png"/>
    </p>
    <p style="text-align:center">
     <img alt="" src="https://i-blog.csdnimg.cn/direct/f202e70c172d48e299069f2895782628.png"/>
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/direct/31bda01f4395486aa01f02e30350800f.png"/>
    </p>
    <h4>
     3、实验步骤
    </h4>
    ...
    <pre><code class="language-cpp">#include &lt;gl/glut.h&gt;  // 引入GLUT 程序库
#include &lt;stdio.h&gt;   // 为打印选择元素的提示</code></pre>
    <p>
     (2)确定窗口大小
    </p>
    <pre><code class="language-cpp">GLsizei winWidth = 800, winHeight = 540;    // 窗口的宽度和高度</code></pre>
    <p>
     (3)为每个图元赋予对应的RGB变量
    </p>
    <pre><code class="language-cpp">GLfloat red1 = 1.0, green1 = 1.0, blue1 = 1.0; // 第一个图元（五角星）的RGB混合颜色成分
...
GLfloat red3 = 1.0, green3 = 1.0, blue3 = 1.0; // 第三个图元（矩形）的RGB混合颜色成分
    ...
    <pre><code class="language-cpp">const GLint pickSize = 32;//拾取缓冲区的大小
GLuint flag = 0;   // 一个变量为了指定目前的图元-是五角星还是矩形等</code></pre>
    <p>
     (5)构造方法体
    </p>
    <pre><code class="language-cpp">void initial()
{
    ...
    <pre><code class="language-cpp">int  main(int argc, char* argv[])
{
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323230315f37353332313838372f:61727469636c652f64657461696c732f313436313839373238" class_="artid" style="display:none">
 </p>
</div>
