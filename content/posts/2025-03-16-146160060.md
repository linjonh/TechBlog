 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h5 id="示例：创建一个 AFTER INSERT 触发器">
...
SELECT * FROM EmployeeAudit;</code></pre>
    <h4 id="2. DDL 触发器">
     2. DDL 触发器
    </h4>
    <p>
...
SELECT * FROM DDL_Audit;</code></pre>
    <h4 id="3. 登录触发器">
     3. 登录触发器
    </h4>
    <p>
...
-- 测试触发器
-- 注销并重新登录，然后检查审计表
SELECT * FROM master.dbo.LogonAudit;</code></pre>
    <h4 id="总结">
     总结
    </h4>
    <ul>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f36353636343931342f:61727469636c652f64657461696c732f313436313630303630" class_="artid" style="display:none">
 </p>
</div>
