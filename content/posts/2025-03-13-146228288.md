---
arturl_encode: "68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35343336363335362f:61727469636c652f64657461696c732f313436323238323838"
layout: post
title: "HTML页面使用vue3setup语法"
date: 2025-03-13 13:13:12 +08:00
...
<body class="h-screen transition-colors duration-200 flex flex-col overflow-hidden">
    ...
    <script>
        ...
        createApp({
            setup() {
                const sseUrl = ref('http://localhost/dev-api/deepseek/r1/chat?msg=你是谁')
                const messages = ref([])
