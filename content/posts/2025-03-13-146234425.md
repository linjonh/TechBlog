...
keywords: "PySide(PyQt)，使用types.MethodType动态定义事件"
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-python">class MyGraphicsPixmapItem(QGraphicsPixmapItem):
    def __init__(self, pixmap):
        super().__init__(pixmap)
        
    def wheelEvent(self, event):
        self.setScale(self.scale() * (1.001 ** event.delta()))</code></pre>
    <p>
...
app.exec()</code></pre>
    <pre>上面的代码，定义了几个方法，并且将其动态绑定到了图片项的实例，实现了所需的功能。
</pre>
    <p>
     <img alt="" height="342" src="https://i-blog.csdnimg.cn/direct/b7a185f933034003aeb584095b41f52a.gif" width="728"/>
    </p>
    <p>
     types的更多学习笔记见：
     <a href="https://blog.csdn.net/xulibo5828/article/details/146227577" title="Python的types库学习记录-CSDN博客">
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f78756c69626f353832382f:61727469636c652f64657461696c732f313436323334343235" class_="artid" style="display:none">
 </p>
</div>
