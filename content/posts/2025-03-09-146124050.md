...
print(response)</code></pre>
    ...
    <pre><code class="language-python"># 定义结构，定义变量
...
print(response)</code></pre>
    ...
    <pre><code class="language-python"># 添加格式
...
print(response)</code></pre>
    ...
    <pre><code class="language-python"># example 1  reference: from https://www.promptingguide.ai/
prompt = """
...
print(response)</code></pre>
    ...
    <pre><code class="language-python"># example 2 reference: from https://www.promptingguide.ai/
prompt = """
Classify the text into neutral, negative or positive. 
...
print(response)</code></pre>
    ...
    <pre><code class="language-python"># 数学问题需要推理
prompt = """
...
response = generate_responses(prompt)
print(response)</code></pre>
    <pre><code class="language-python"># 如果只是提供examples， 对于强推里的场景不太管用
prompt = """
...
response = generate_responses(prompt)
print(response)</code></pre>
    <pre><code class="language-python"># 解决方案, 说明解题思路 few-shot
...
response = generate_responses(prompt)
print(response)</code></pre>
    <pre><code class="language-python"># 解决方案, 说明解题思路 one-shot
...
print(response)</code></pre>
    ...
    <pre><code class="language-python"># 加入 think step by step, 让模型分解问题，并一步步解决
prompt = """
...
print(response)</code></pre>
    ...
    <p>
     <img alt="" height="264" src="https://i-blog.csdnimg.cn/direct/e20c9347f6f14b718fb8cd0b199d176f.png" width="678"/>
    </p>
    <h4 style="background-color:transparent">
     1.4 Use Cases
    </h4>
...
摄影师拍摄角度、演员的站位要求，演员走动要求，演员表演要求，动作特写要求等等。</pre>
    </blockquote>
    <h5>
     1.4.2 小红书爆款文章
    </h5>
...
print(response)</code></pre>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f4d617263685f412f:61727469636c652f64657461696c732f313436313234303530" class_="artid" style="display:none">
 </p>
</div>
