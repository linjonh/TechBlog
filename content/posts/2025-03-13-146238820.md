...
export const lazier = new Proxy({} as any, {
  get&lt;T extends string&gt;(_: any, key: T) {
    ...
    <pre><code class="language-TypeScript">interface CacheItem {
  value: any;
  expires: number;
}
...
export const lazier = new Proxy({} as any, {
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34303631303736302f:61727469636c652f64657461696c732f313436323338383230" class_="artid" style="display:none">
 </p>
</div>
