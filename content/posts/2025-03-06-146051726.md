...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <a class="link-info" href="https://gitee.com/wang-kaishen/search-engines" rel="nofollow" title="完整代码">
      完整代码
     </a>
    </p>
    <h2>
    ...
    <p>
     <img alt="" height="665" src="https://i-blog.csdnimg.cn/direct/6be55b6a4cb94189b18c1647b1ca25a0.png" width="829"/>
    </p>
    <h3>
     1.2 解析文件（pathFile）
    </h3>
    ...
    <p>
     <img alt="" height="217" src="https://i-blog.csdnimg.cn/direct/3be398c1b1db41f1848cf5f0f3ef3b28.png" width="870"/>
    </p>
    <h4>
     1.2.2 解析Url（pathUrl）
    </h4>
    <p>
     ...
     <img alt="" height="39" src="https://i-blog.csdnimg.cn/direct/03fe11def79c45b8981272e8b81b5c8f.png" width="434">
      ，而后面就是就是本地文档路径了。
     </img>
    </p>
    <p>
     <img alt="" height="208" src="https://i-blog.csdnimg.cn/direct/34349f6baf474660b0fb48342ce9cc5c.png" width="832"/>
    </p>
    <h4>
    ...
    <p>
     <img alt="" height="478" src="https://i-blog.csdnimg.cn/direct/259c9716efb742fba2cfbaa052a0f40e.png" width="1063"/>
    </p>
    <blockquote>
     <p>
    ...
    <p>
     <img alt="" height="790" src="https://i-blog.csdnimg.cn/direct/42e758f62f664456996d9ad4523b6a31.png" width="963"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="365" src="https://i-blog.csdnimg.cn/direct/1ad4467838584e69b1b904f5853f3fee.png" width="843"/>
    </p>
    <blockquote>
     <p>
    ...
    <pre><code class="language-java">private void buildInverted(DocInfo docInfo) {
    class WordCnt {
    ...
    <p>
     <img alt="" height="649" src="https://i-blog.csdnimg.cn/direct/dba0a743848049539f0f07e89667fcd8.png" width="921"/>
    </p>
    <h3 style="background-color:transparent">
     2.4 加载硬盘（load）
    </h3>
    ...
    <p>
     <img alt="" height="529" src="https://i-blog.csdnimg.cn/direct/cf9fe9cafd0941068a4118c94a960421.png" width="1448"/>
    </p>
    <h3>
     2.5 新增文档（addDoc）
    </h3>
    ...
    <p>
     <img alt="" height="364" src="https://i-blog.csdnimg.cn/direct/be2c37fc68ca4cdba3975ee4f9843ea4.png" width="709"/>
    </p>
    <p>
     去停用词的必要性：
    </p>
    ...
    <p>
     <img alt="" height="338" src="https://i-blog.csdnimg.cn/direct/d3caac15fe504a2599206897d4992a6d.png" width="824"/>
    </p>
    <h3>
     3.3 合并
    </h3>
    ...
    <pre><code class="language-java">private List&lt;Weight&gt; mergeResult(List&lt;List&lt;Weight&gt;&gt; source) {
    ...
    <p>
     <img alt="" height="368" src="https://i-blog.csdnimg.cn/direct/68279c2dc7fa472cbac44bc8973353fb.png" width="723"/>
    </p>
    <p>
    ...
    <pre><code class="language-java">private String GenDesc(String content, List&lt;Term&gt; terms) {
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323230315f37363032373735342f:61727469636c652f64657461696c732f313436303531373236" class_="artid" style="display:none">
 </p>
</div>
