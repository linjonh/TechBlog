...
| <!-- res/layout/data\_binding\_example.xml --> |
| --- |
| <DirectionalLayout |
...
|  |
| <Text |
| ohos:id="$+id:text\_view" |
| ohos:width="match\_parent" |
| ohos:height="wrap\_content" |
| ohos:text="{ {user.name}}" /> |
|  |
| <!-- 其他UI组件 --> |
|  |
...
| setUIContent(ResourceTable.Layout\_data\_binding\_example); |
|  |
| // 设置数据上下文 |
...
| <!-- res/layout/two\_way\_binding\_example.xml --> |
| --- |
| <DirectionalLayout |
| xmlns:ohos=" [http://schemas.huawei.com/res/ohos](https://link.zhihu.com/?target=http%3A//schemas.huawei.com/res/ohos "http://schemas.huawei.com/res/ohos") " |
| ohos:width="match\_parent" |
...
| protected void onStart(Intent intent) { |
| super.onStart(intent); |
| setUIContent(ResourceTable.Layout\_two\_way\_binding\_example); |
|  |
| // 设置数据上下文并启用双向绑定 |
