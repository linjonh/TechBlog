...
有了Continue插件，接下来我们就可以接入DeepSeek API了，首先点击Continue中的Select model，选择里面的Add Chat
Model。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d00a6eed4e6b4649b8bbea9e5dd93e83.png#pic_center)

然后我们在Provider中选择Deepseek，在Model中选择DeepSeek Coder，在API
key中填入我们在DeepSeek官网获取的API即可。
