 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="hljs">for epoch in range(num_epoches):
#动态修改参数学习率
    if epoch%5==0:
...
######</code></pre>
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f57697334652f:61727469636c652f64657461696c732f313436313433323237" class_="artid" style="display:none">
 </p>
</div>
