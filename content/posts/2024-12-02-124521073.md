...
现在我最推荐开发者和一般用户使用的是
[Liberica JDK](https://bell-sw.com/)
，它提供了捆绑 JavaFX 的 full 版，支持 macOS x86\_64、Windows x86、Windows x86\_64、Linux x86、Linux x86\_64、Alpine Linux x86\_64、Linux ARMv8、Linux ARMv7 HardFloat、Linux PPC64 LE 等平台，对于需要 32 位环境或者需要在小众平台上工作的用户来说很友好。同时它的 exe 安装包能够方便的配置环境变量，还提供 YUM 和 APT 仓库，提供 Docker 镜像，目前来说应该是对一般用户最友好的 OpenJDK 发行版。