 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-dracula" id="content_views">
    ...
    <pre><code class="prism language-rs">struct User {
    active: bool,
    username: String,
    email: String,
    sign_in_count: u64,
    ...
    <pre><code class="prism language-rs">fn main() {
    let user1 = User {
...
fn main() {
    ...
    <pre><code class="prism language-rs">fn build_user(email: String, username: String) -&gt; User {
    User {
        email: email,
        username: username,
        active: true,
...
fn main() {
    ...
    <pre><code class="prism language-rs">struct Color(i32, i32, i32);
...
fn main() {
    ...
    <pre><code class="prism language-rs">struct AlwaysEqual;
fn main() {
...
fn main() {
    ...
    <pre><code class="prism language-rs">struct Rectangle{
    width: u32,
    height: u32,
}
fn main() {
...
fn area(rectangle: Rectangle) -&gt; u32{
    ...
    <pre><code class="prism language-rs">#[derive(Debug)]
struct Rectangle{
    width: u32,
    height: u32,
}
...
fn main() {
    ...
    <pre><code class="prism language-sh"><span class="token punctuation">[</span>src/main.rs:10:16<span class="token punctuation">]</span> <span class="token number">30</span> * scale <span class="token operator">=</span> <span class="token number">60</span>
<span class="token punctuation">[</span>src/main.rs:14:5<span class="token punctuation">]</span> <span class="token operator">&amp;</span>rect1 <span class="token operator">=</span> Rectangle <span class="token punctuation">{<!-- --></span>
...
fn main() {
    ...
    <pre><code class="prism language-rs">p1.distance(&amp;p2);
(&amp;p1).distance(&amp;p2);
</code></pre>
    <p>
...
fn main() {
    ...
    <pre><code class="prism language-rs">impl Rectangle {
    fn area(&amp;self) -&gt; u32 {
        self.width * self.height
    }
}
...
impl Rectangle {
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33383331383632322f:61727469636c652f64657461696c732f313436313435383034" class_="artid" style="display:none">
 </p>
</div>
