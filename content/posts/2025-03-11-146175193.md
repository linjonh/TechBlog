...
utf8mb4\_general\_ci 是不区分大小写的排序规则。
...
如果 character\_set\_client, character\_set\_connection, character\_set\_results 不是 utf8mb4，可能导致乱码。
...
utf8mb4\_general\_ci 是 不区分大小写 的。
  
utf8mb4\_bin 是 区分大小写 的。
