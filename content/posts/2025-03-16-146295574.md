...
int main(int argc,char*argv[])
{
  ...
  return 0;   
    ...
    <p>
     <img alt="" height="101" src="https://i-blog.csdnimg.cn/direct/a5ecdf9f0c4e42f0877002411e4a7de7.png" width="336"/>
    </p>
    <pre><code class="language-cpp">#include&lt;stdio.h&gt;
#include&lt;string.h&gt;
int main(int argc,char*argv[],char*env[])
{
  ...
  return 0;
    ...
    <h2>
     <img alt="" height="257" src="https://i-blog.csdnimg.cn/direct/1fbfd9121a614b5781ac8afd8f42d380.png" width="471"/>
    </h2>
    <p>
    ...
    <p>
     <img alt="" height="67" src="https://i-blog.csdnimg.cn/direct/65f6040d68cf4f06a80b6ed1bf22f706.png" width="887"/>
    </p>
    <h4>
     1.1.1.作用
    </h4>
    ...
    <p>
     例：
     <img alt="" height="30" src="https://i-blog.csdnimg.cn/direct/3d1e6de9b70a45ff8e17d83fd030550d.png" width="891"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="282" src="https://i-blog.csdnimg.cn/direct/fc11f205bfd742638a9638ecdf6fce97.png" width="533"/>
    </p>
    <p>
     set查变量（环境变量和本地变量）
    </p>
    ...
    <p>
     ...
     <img alt="" height="384" src="https://i-blog.csdnimg.cn/direct/7a9febd7f94b4f86a6c5d30649e1cd69.png" width="454"/>
    </p>
    <h4>
     区域划分：
    </h4>
    <p>
     ...
     <img alt="" height="216" src="https://i-blog.csdnimg.cn/direct/cbcb2fb302364970ab05017b196d6648.png" width="690"/>
    </p>
    <p>
     页表：进程地址空间管理方案：
    </p>
    <p>
     ...
     <br/>
     <img alt="" height="739" src="https://i-blog.csdnimg.cn/direct/8b636d640c0444ab93d54224988cb028.png" width="1034"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="69" src="https://i-blog.csdnimg.cn/direct/d127e50f547a44d6899da9dba1a99816.png" width="307"/>
     <img alt="" height="85" src="https://i-blog.csdnimg.cn/direct/14928bcc228349909999c2f9334fa88b.png" width="1724"/>
    </p>
    <p>
     2.程序获取的env
    </p>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323330325f37393736353230332f:61727469636c652f64657461696c732f313436323935353734" class_="artid" style="display:none">
 </p>
</div>
