...
Variance![](https://csdnimg.cn/release/blog\_editor\_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-
...
104 \* s
只包含小写英文字母。![](https://csdnimg.cn/release/blog\_editor\_html/release2.3.8/ckeditor/plugins/CsdnLink/icons/icon-
...
\_the\*\*largest variance\*\* possible among all \*\*substrings\*\* of\_ `s`.
...
for (int[] row : f1) {Arrays.fill(row, Integer.MIN\_VALUE);}
int res = 0;
