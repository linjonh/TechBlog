 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="1070" src="https://i-blog.csdnimg.cn/direct/b15fb3228e8e41d688bb0bd58a31efa0.png" width="1591"/>
    </p>
    <p>
     需要注意的人， 由于对黑并不计算在赛季（天梯模式）的分数，所以对黑的一些数据，会少一些；
    </p>
    <p>
     <img alt="" height="920" src="https://i-blog.csdnimg.cn/direct/b73773286edf4ce4af107be0dde3c2cf.jpeg" width="2265"/>
    </p>
    <p>
     这个玩家，以下简称
     <strong>
    ...
    <p>
     <img alt="" height="945" src="https://i-blog.csdnimg.cn/direct/f2bd525e29eb47fc88a9b9e5d187abe5.png" width="1408"/>
    </p>
    <p>
     缺失示例：
    </p>
    <p>
     <img alt="" height="1052" src="https://i-blog.csdnimg.cn/direct/4ccc8abedbaf4cc0afd6c42e549cefd6.png" width="1455"/>
    </p>
    <h3>
     1.2抓取数据思路
    </h3>
    ...
    <p>
     <img alt="" height="1158" src="https://i-blog.csdnimg.cn/direct/1cbfbaf3b9254b309523a2d51d9f667e.png" width="2123"/>
    </p>
    <p>
    ...
    <h4>
     <img alt="" height="813" src="https://i-blog.csdnimg.cn/direct/fe98d6a4ad7449ae8aba0f50f6710b15.png" width="2094">
      ③第三步
     </img>
    </h4>
    <p>
    ...
    <p>
     <img alt="" height="872" src="https://i-blog.csdnimg.cn/direct/6d0ef8c3f9024a5ea7988eac0ce4dd97.png" width="1462"/>
    </p>
    <p>
    ...
    <p>
     ...
     <img alt="" height="1122" src="https://i-blog.csdnimg.cn/direct/8a6c4b7c6873470386176ec7f6e29296.jpeg" width="2543"/>
    </p>
    <p>
     ...
     <img alt="" height="869" src="https://i-blog.csdnimg.cn/direct/ae08b21e6e2b4202a777d4562c381198.jpeg" width="1548"/>
    </p>
    <p>
...
# 1.7 补上获取失败的，实测发现偶尔会有数据获取失败的
    def check_data_failure(self,time_str ='2025-03-10 18:40:00'):
        ...
        for g_id in missed_ids:
            url = self.correlation_url_none.replace("GameID=", "GameID={}".format(g_id))
            self.get_correlation_base(url, g_id)</code></pre>
    <h3>
     2.3实例
    </h3>
    <pre><code class="hljs">instance = Zhanji09()
...
instance.check_data_failure("2025-03-12 13:21:55")
    ...
    <p>
     <img alt="" height="186" src="https://i-blog.csdnimg.cn/direct/2cbe1e84e4b54843a188a00a4433b438.png" width="957"/>
    </p>
    <pre><code class="hljs"># 对数据进行清洗，生成两个关键字段
store_path='d:/goushi'
...
df_merge_2 = pd.merge(df_merge_1_dropna_2,df_3,how='inner',on='g_id')</code></pre>
    <p>
     获取胜负，0胜1负
    </p>
    <pre><code class="hljs">def get_win_lost(df):
    return 0 if df['win_id']==df['team_id'] else 1

df_merge_2['win_or_lost'] = df_merge_2.apply(get_win_lost,axis=1)</code></pre>
    <p>
     获取参战率
    </p>
    <pre><code class="hljs">df_merge_3 = pd.merge(df_merge_2,temp_df,how='inner'
...
gc.collect()</code></pre>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f54726176656c4c6967687439322f:61727469636c652f64657461696c732f313436313633303233" class_="artid" style="display:none">
 </p>
</div>
