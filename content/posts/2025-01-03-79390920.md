...
> ps:后面有一篇博客介绍了
>
> * [【Linux学习】Shell命令行参数解析工具getopts是如何使用的？ https://blog.csdn.net/ouyang\_peng/article/details/86493502](https://blog.csdn.net/ouyang_peng/article/details/86493502)
...
* long\_options: 以列表的格式定义，long\_options 后的等号(=)表示如果设置该选项，必须有附加的参数，否则就不附加参数。
