...
地址如有127.0.0.1，你要在配置文件/etc/libvirt/qemu.conf中取消vnc\_listen = "0.0.0.0"这一行的注释，并重启虚拟机。
...
rpm -Uvh python25-2.5.1-bashton1.x86\_64.rpm error: Failed

dependencies: libpython2.5.so.1.0()(64bit) is needed by python25-2.5.1-bashton1.x86\_64
...
Enabling IP forwarding(13)Permission denied: make\_sock: could not bind to address [::]:8774 (13)Permission denied: make\_sock: could not bind to address 0.0.0.0:8774 no listening sockets available, shutting down Unable to open logs Failed to start the CC!
