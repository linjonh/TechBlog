...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <h3>
     <a id="1_AIDL__HIDL__6">
     </a>
     1. AIDL 和 HIDL 的主要区别
    </h3>
    <h4>
     <a id="11AIDLAndroid_Interface_Definition_Language_7">
     </a>
    ...
    <h4>
     <a id="12_HIDLHardware_Interface_Definition_Language_19">
     </a>
    ...
    <table>
     ...
     <tbody>
      ...
      <tr>
       <td>
        IStream /IStreamIn / IStreamOut
       </td>
       <td>
        StreamDescriptor /IStreamIn / IStreamCommon / IStreamOut
       </td>
      </tr>
      <tr>
       <td>
      ...
      <tr>
       ...
       <td>
        在 Android 14 中使用HbL妥现。
       </td>
      </tr>
     </tbody>
    </table>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ae8b9f8b294c401db24ea8e6ad85caf9.jpeg#pic_center">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0780db3b11b0413d9a348b7e0957daab.jpeg#pic_center"/>
     </img>
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f6c6a78313430303035323535302f:61727469636c652f64657461696c732f313436303939343730" class_="artid" style="display:none">
 </p>
</div>
