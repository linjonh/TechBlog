 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <a href="https://www.bilibili.com/video/BV12J41137hu/?spm_id_from=333.337.search-card.all.click&amp;vd_source=89c404dce3c71a91da41a89d2f3b4b6a" rel="nofollow" title="【狂神说Java】Java零基础学习视频通俗易懂_哔哩哔哩_bilibili">
      【狂神说Java】Java零基础学习视频通俗易懂_哔哩哔哩_bilibili
     </a>
    </p>
    <p>
     第1-2章：
     <a href="https://blog.csdn.net/sherlockMa/article/details/143220769?spm=1001.2014.3001.5501" title="Java零基础入门笔记：(1-2)入门（简介、基础知识）-CSDN博客">
      Java零基础入门笔记：(1-2)入门（简介、基础知识）-CSDN博客
     </a>
    </p>
    <p>
     第3章：
     <a href="https://blog.csdn.net/sherlockMa/article/details/145684589?spm=1001.2014.3001.5501" title="Java零基础入门笔记：(3)程序控制-CSDN博客">
      Java零基础入门笔记：(3)程序控制-CSDN博客
     </a>
    </p>
    <p>
     第4章：
     <a href="https://blog.csdn.net/sherlockMa/article/details/145714377?spm=1001.2014.3001.5501" title="Java零基础入门笔记：(4)方法-CSDN博客">
      Java零基础入门笔记：(4)方法-CSDN博客
     </a>
    </p>
    <p>
     第5章：
     <a href="https://blog.csdn.net/sherlockMa/article/details/145810598?spm=1001.2014.3001.5501" title="Java零基础入门笔记：(5)数组-CSDN博客">
      Java零基础入门笔记：(5)数组-CSDN博客
     </a>
    </p>
    <p>
     第6章：
     <a href="https://blog.csdn.net/sherlockMa/article/details/145836667?spm=1001.2014.3001.5501" title="Java零基础入门笔记：(6)面向对象-CSDN博客">
      Java零基础入门笔记：(6)面向对象-CSDN博客
     </a>
    </p>
    <p>
     第7章：
     <a href="https://blog.csdn.net/sherlockMa/article/details/145888225?spm=1001.2014.3001.5501" title="Java零基础入门笔记：(7)异常-CSDN博客">
      Java零基础入门笔记：(7)异常-CSDN博客
     </a>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" height="442" src="https://i-blog.csdnimg.cn/img_convert/f85b0fe00893aa74000c605f0eed68d7.png" width="846"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <pre><code class="language-java">package thread.demo1;
...
public class TestThread1 extends Thread{
    ...
    <pre><code class="language-java">主进程
主进程
线程
线程
线程
...
public class TestThread4 implements Runnable{
    ...
    <pre><code class="language-java">黄牛--&gt;拿到了第9票
小明--&gt;拿到了第10票
老师--&gt;拿到了第10票
老师--&gt;拿到了第8票
黄牛--&gt;拿到了第7票
...
老师--&gt;拿到了第1票
    ...
    <p>
     <img alt="" height="356" src="https://i-blog.csdnimg.cn/direct/d00745bcb9c54500bcccb615589d9782.png" width="612"/>
    </p>
    <p>
...
public class Race implements Runnable{
    ...
    <pre><code class="language-java">乌龟跑了96步
乌龟跑了97步
乌龟跑了98步
乌龟跑了99步
winner is 乌龟</code></pre>
    <p>
     <span style="color:#f3f3f4">
      -
     </span>
    ...
    <pre><code class="language-java">package lesson1;
//多线程同步下载图片
import org.apache.commons.io.FileUtils;
...
class WeddingCompany implements Marry{
    ...
    <pre><code class="language-java">结婚之前,布置现场
结婚！
结婚之后,收尾款</code></pre>
    <p>
     静态代理的核心在于
...
class Like implements ILike{
    ...
    <pre><code class="language-java">I like lambda
I like lambda2
i like lambda3
i like lambda4
i like lambda6</code></pre>
    <p>
     简化
    </p>
    <pre><code class="language-java">package thread.demo1;
...
interface ILove{
    ...
    <p class="img-center">
     <img alt="" height="514" src="https://i-blog.csdnimg.cn/img_convert/95fa67c294717bcca5dc0587932fc0e4.png" width="1412"/>
    </p>
    <p>
    </p>
    <p class="img-center">
     <img alt="" height="672" src="https://i-blog.csdnimg.cn/img_convert/1890e3408f74d53a9b87ed036f57b9d9.png" width="1360"/>
    </p>
    <p class="img-center">
     <img alt="" height="657" src="https://i-blog.csdnimg.cn/img_convert/0edb90513e63b9effe0688946f7d8f6c.png" width="1438"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <pre><code class="language-java">package thread.state;
...
class MyYield implements Runnable{
    ...
    <pre><code class="language-java">a线程开始执行
b线程开始执行
b线程停止执行
a线程停止执行
</code></pre>
...
class MyPriority implements Runnable{
    ...
    <pre><code class="language-java">main---&gt;5
Thread-1---&gt;1
Thread-0---&gt;5
Thread-2---&gt;4
Thread-3---&gt;10</code></pre>
    <p>
     <span style="color:#f3f3f4">
      -
     </span>
...
class BuyTicket implements Runnable{
    ...
    <pre><code class="language-java">黄牛党拿到5
小明拿到5
小红拿到4
小明拿到4</code></pre>
    <p>
...
class Withdraw extends Thread{      //银行：模拟取钱操作
    ...
    <pre><code class="language-java">女方取完结婚基金账户里的钱后，现在手里的钱为50
男方取完结婚基金账户里的钱后，现在手里的钱为100
结婚基金的账户余额为-50
结婚基金的账户余额为-50</code></pre>
    <p>
     这段代码通过多线程向一个共享的
     <code>
      ArrayList
...
public class UnsafeList {
    ...
    <pre><code class="language-java"> public synchronized void t0(){
     // 方法体
 }
</code></pre>
    <p>
    ...
    <pre><code class="language-java"> public synchronized static void t0(){
     // 方法体
 }
</code></pre>
    <p>
    ...
    <pre><code class="language-java"> public void t2() {
       synchronized (o) {
         // 方法体
     }
 }
    ...
    <pre><code class="language-java"> public void t3() {
...
class MakeUp extends Thread {
    ...
    <pre><code class="language-java">灰姑凉获得口红的锁
白雪公主获得镜子的锁
//    (然后陷入僵持...)</code></pre>
    <p>
     如何解决这个问题呢，上面的情况是两人各握着两个锁，所以解决方案是，把另一个想要的锁放在外面
    </p>
    <pre><code class="language-java">    private void makeup() throws InterruptedException {
        if (choice == 0) {
            synchronized (lipstick) {//获得口红的锁
                System.out.println(this.girlName + "获得口红的锁");
                Thread.sleep(1000);
...
class MyThread implements Runnable {
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f736865726c6f636b4d612f:61727469636c652f64657461696c732f313436313135383233" class_="artid" style="display:none">
 </p>
</div>
