...
| --- | --- | --- | --- |
| 带屏摄像头类产品 | Hi3516 | - 音频解码：支持MPEG-4 AAC Profile (AAC LC)格式解码，支持单/双声道，支持MPEG-4(.mp4，.m4a)容器格式。   - 视频解码：支持H.265 HEVC/H.264 AVC格式解码（限自身编码码流），支持MPEG-4(.mp4)容器格式。 | - 音频编码：支持音频AAC\_LC编码，支持单/双声道，支持MPEG-4(.mp4)容器格式。   - 视频编码：支持视频H.264/H.265编码，支持MPEG-4(.mp4)容器格式。 |
| 无屏摄像头类产品 | Hi3518 | - 音频解码：支持MPEG-4 AAC Profile (AAC LC)格式解码，支持单/双声道，支持MPEG-4(.mp4，.m4a)容器格式。   - 视频解码：- | - 音频编码：支持音频AAC\_LC编码，支持单/双声道，支持MPEG-4(.mp4)容器格式。   - 视频编码：支持视频H.264/H.265编码，支持MPEG-4(.mp4)容器格式。 |
| WLAN连接类设备 | Hi3861 | - | - |
