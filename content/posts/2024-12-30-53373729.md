...
按照网上说的某种方法，删除注册表以下项：HKEY\_LOCAL\_MACHINE\Software\Microsoft\MSLicensing。
...
The solution was to delete the REG\_BINARY in
  
**HKEY\_LOCAL\_MACHINE\SYSTEM\CurrentControlSet\Control\TerminalServer\RCM\GracePeriod**
