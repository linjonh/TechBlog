 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     原文地址:
     <a href="https://mp.weixin.qq.com/s/OaC7K55efKsKMYm-_FqaSA" rel="nofollow" title="观察者模式">
      观察者模式
     </a>
     更多内容请关注：
     <strong>
...
+-----------------------------+
    ...
    <pre><code class="hljs">// Observer接口
...
投资者 Jerry 收到通知: Apple 的最新价格为 165.75
    ...
    <pre><code class="hljs">from abc import ABC, abstractmethod
...
if __name__ == "__main__":
    observer_pattern_demo()</code></pre>
    <h5>
     输出
    </h5>
    <pre>Apple 的价格已更新为: 155.0
...
投资者 Jerry 收到通知: Apple 的最新价格为 165.75
    ...
    <pre><code class="hljs">import javax.swing.*;
...
if __name__ == "__main__":
    observer_pattern_monitoring_demo()</code></pre>
    <h5>
     输出
    </h5>
    <pre>数据源更新数据: 1
...
public class ObserverPatternSocialMediaDemo {
    ...
    <pre>Alice 发布新内容: Hello, this is Alice!
...
关注者 Jerry 收到通知: Alice 发布了新内容 - Alice's second post!
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f54696e6159754e756f2f:61727469636c652f64657461696c732f313436313732353937" class_="artid" style="display:none">
 </p>
</div>
