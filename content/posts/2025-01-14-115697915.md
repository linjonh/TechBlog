...
NET\_DVR\_Login\_V30(DeviceIP,m\_nLoginPort,cUserName,cPassword,&devInfo)

2、试试预览
  
m\_llRealHandle[nI] = NET\_DVR\_RealPlay\_V40(m\_lUserID[nI],&struPlayInfo,fRealDataCallBack, this);
...
EasyRTMP\_API Easy\_U32 Easy\_APICALL EasyRTMP\_SendPacket(Easy\_Handle handle, EASY\_AV\_Frame \* frame);
