 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <a href="https://github.com/wygsqsj/videoPath" title="GitHub - wygsqsj/videoPath: 音视频学习路线demo">
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/496c6cc15147dde8be404044f12336b2.png"/>
    </p>
    <p>
    ...
    <p style="text-align:center;">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/f8a5e7af1897dad3f105dd76643cc5c6.png"/>
    </p>
    <h2>
     混音
    </h2>
    ...
    <pre><code> temp1 = (short) ((mixAudio1[i] &amp; 0xff) | ((mixAudio1[i + 1] &amp; 0xff) &lt;&lt; 8));</code></pre>
    <p>
     将2个音频相加即可得到混音后的数据，因为两个short类型的音频相加之后，可能会超过short表示的数值，超过的我们就丢弃了，所以可能会丢失数据，其他的混音方式可以参考：
    </p>
    <p>
     <a href="https://cloud.tencent.com/developer/article/1739900" rel="nofollow" title="Android中一种效果奇好的混音方法详解 - 云+社区 - 腾讯云">
      Android中一种效果奇好的混音方法详解 - 云+社区 - 腾讯云
     </a>
    </p>
    <pre><code>private void mixingAudio() {
    ...
    <p>
     代码示例，具体代码参见
     <a href="https://github.com/wygsqsj/videoPath/blob/master/app/src/main/java/com/wish/videopath/demo5/Demo5Activity.java" title="videoPath/Demo5Activity.java at master · wygsqsj/videoPath · GitHub">
      videoPath/Demo5Activity.java at master · wygsqsj/videoPath · GitHub
     </a>
    </p>
    <pre><code>//Muxer获取音频轨道，得到format，取出数据
getTrack1();
getTrack2();
...
while (!finishWrite) {
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f7779677371736a2f:61727469636c652f64657461696c732f313231343432323731" class_="artid" style="display:none">
 </p>
</div>
