...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="1015" src="https://i-blog.csdnimg.cn/direct/ebbf7df45a89457494701b3e1f9b870b.png" width="1733"/>
    </p>
    <p>
    ...
    <pre>make ARCH=arm CROSS_COMPILE=arm-linux-gnueabihf- mx6ull_14x14_ddr512_emmc_defconfig </pre>
    <blockquote>
     <p>
    ...
    <blockquote>
     <p>
      ...
      <a href="https://blog.csdn.net/charlie114514191/article/details/146100288" title="IMX6ULL驱动开发uboot篇03：UBoot移植_正点原子imxull uboot网卡功能-CSDN博客">
       IMX6ULL驱动开发uboot篇03：UBoot移植_正点原子imxull uboot网卡功能-CSDN博客
      </a>
     </p>
    </blockquote>
    <p>
    ...
    <pre>make ARCH=arm CROSS_COMPILE=arm-linux-gnueabihf- mx6ull_charliechen_emmc_defconfig</pre>
    <p>
     基本格式就是——
     <code>
    ...
    <pre>make ARCH=arm CROSS_COMPILE=arm-linux-gnueabihf- -j($nproc)</pre>
    <p>
     这个就跟我们的板子没有关系了。
    </p>
   </div>
 ...
 <p alt="68747470733a2f2f626c6f672e63:73646e2e6e65742f636861726c69653131343531343139312f:61727469636c652f64657461696c732f313436323733373431" class_="artid" style="display:none">
 </p>
</div>
