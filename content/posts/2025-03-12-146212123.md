...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="127" src="https://i-blog.csdnimg.cn/direct/531055160c1a4974913fbda52654a7be.png" width="615"/>
    </p>
    <h4>
     第二步：在 XAML 中定义控件绑定
    </h4>
    ...
    <pre><code class="language-XML">        &lt;ContentControl Content="{Binding SignalImage}"/&gt;</code></pre>
    <h4>
     第三步：创建 ViewModel
    </h4>
    <p>
    ...
    <pre><code class="language-cs">        DataContext=new MainViewModel();</code></pre>
    <h4>
     结果
    </h4>
    <p>
    ...
    <p>
     <img alt="" height="555" src="https://i-blog.csdnimg.cn/direct/caad5602af914be3ab5eda3e8e8dd5e4.png" width="984"/>
    </p>
    <h4>
     为什么不需要实现
     <code>
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f5331333436313132303731332f:61727469636c652f64657461696c732f313436323132313233" class_="artid" style="display:none">
 </p>
</div>
