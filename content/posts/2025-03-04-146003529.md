...
| RealESRGAN\_X4Plus | 改进的残差注意力机制 | 通用场景/老旧照片修复 | 降噪强度0.2-0.3，增强模式选"平衡" | ★☆ | ★★★ | 综合性能均衡，但高频细节易过曝 |
| SwinIR\_4K | 基于Swin Transformer的特征重建 | 文字/几何图形修复 | 锐度调节0.5-0.7，边缘保护模式开启 | ★★ | ★★★★ | 文字边缘清晰，但生成速度较慢 |
