...
参考：
[1. 基于MSYS2的Mingw-w64 GCC搭建Windows下C++开发环境\_msys2使用mingw64编译](https://blog.csdn.net/ScienceRui/article/details/117392080 "1. 基于MSYS2的Mingw-w64 GCC搭建Windows下C++开发环境_msys2使用mingw64编译")
...
参考：
[Windows下CMake的下载与安装详解\_cmake下载-CSDN博客](https://blog.csdn.net/didi_ya/article/details/123029415 "Windows下CMake的下载与安装详解_cmake下载-CSDN博客")
...
我是mingw64，所以安装mingw-w64-x86\_64-libx264，命令为：
