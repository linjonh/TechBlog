 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-dracula" id="content_views">
    ...
    <pre><code class="prism language-rs">enum IpAddrKind {
    V4,
    V6,
}
</code></pre>
    ...
    <pre><code class="prism language-rs">let four = IpAddrKind::V4;
...
let loopback = IpAddr {
    ...
    <pre><code class="prism language-rs">#![allow(unused)]
fn main() {
enum IpAddr {
    V4(String),
    V6(String),
...
m.call();
    ...
    <pre><code class="prism language-rs">enum Option&lt;T&gt; {
    Some(T),
    None,
}
</code></pre>
    ...
    <pre><code class="prism language-rs">let some_number = Some(5);
...
let absent_number: Option&lt;i32&gt; = None;
    ...
    <pre><code class="prism language-rs">let x: i8 = 5;
...
let sum = x + y;
    ...
    <pre><code class="prism language-rs">enum Coin {
    Penny,
    Nickel,
    Dime,
    Quarter,
...
fn value_in_cents(coin: Coin) -&gt; u8 {
    ...
    <pre><code class="prism language-rs">fn value_in_cents(coin: Coin) -&gt; u8 {
    match coin {
        Coin::Penny =&gt; {
            println!("Lucky penny!");
            1
...
fn main() {
    ...
    <pre><code class="prism language-rs">fn plus_one(x: Option&lt;i32&gt;) -&gt; Option&lt;i32&gt; {
        match x {
            Some(i) =&gt; Some(i + 1),
        }
    }
    ...
    <pre><code class="prism language-rs">let some_u8_value = Some(0u8);
match some_u8_value {
    ...
    <pre><code class="prism language-rs">if let Some(3) = some_u8_value {
    println!("three");
}
</code></pre>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33383331383632322f:61727469636c652f64657461696c732f313436323438323332" class_="artid" style="display:none">
 </p>
</div>
