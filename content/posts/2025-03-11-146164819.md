  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <blockquote>
     <p>
      论文地址：
      <a href="https://paperswithcode.com/paper/end-to-end-object-detection-with-transformers#code" rel="nofollow" title="End-to-End Object Detection with Transformers | Papers With Code">
       End-to-End Object Detection with Transformers | Papers With Code
      </a>
     </p>
     <p>
      代码地址：
      <a href="https://github.com/facebookresearch/detr?tab=readme-ov-file" title="facebookresearch/detr: End-to-End Object Detection with Transformers">
    ...
    <h2 id="%E6%A8%A1%E5%9E%8B%E6%9E%B6%E6%9E%84%EF%BC%9A" name="%E6%A8%A1%E5%9E%8B%E6%9E%B6%E6%9E%84%EF%BC%9A">
     模型架构：
    </h2>
    <p>
     <img alt="" height="250" src="https://i-blog.csdnimg.cn/direct/e4e735548549410ea61883c0f7276ded.png" width="947"/>
    </p>
    <h2 id="%E6%8E%A8%E7%90%86%E6%B5%81%E7%A8%8B%EF%BC%9A" name="%E6%8E%A8%E7%90%86%E6%B5%81%E7%A8%8B%EF%BC%9A">
     推理流程：
    </h2>
    <p>
    ...
    <p>
     <a href="https://blog.csdn.net/lishanlu136/article/details/140502888?spm=1001.2014.3001.5502" title="DETR博客">
      DETR博客
     </a>
    </p>
    <p>
     <img alt="" height="793" src="https://i-blog.csdnimg.cn/direct/9e3d651c2139492f945319c6129b6c72.png" width="1514"/>
    </p>
    <p>
     (
     <a href="https://blog.csdn.net/weixin_44184852/article/details/136123295?ops_request_misc=&amp;request_id=&amp;biz_id=102&amp;utm_term=DETR&amp;utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduweb~default-7-136123295.142^v102^pc_search_result_base7&amp;spm=1018.2226.3001.4187" title="【深入理解DETR】DETR的原理与算法实现_detr算法-CSDN博客">
      【深入理解DETR】DETR的原理与算法实现_detr算法-CSDN博客
     </a>
     , 侵删)
    </p>
    <h2 id="%E4%BB%A3%E7%A0%81%E8%A7%A3%E8%AF%BB%EF%BC%9A" name="%E4%BB%A3%E7%A0%81%E8%A7%A3%E8%AF%BB%EF%BC%9A">
     代码解读：
    </h2>
    <h3 id="model" name="model">
     model
    </h3>
    <p>
     构建模型架构
    </p>
    <h4 id="backbone.py" name="backbone.py">
     backbone.py
    </h4>
    <p>
     实现骨干网络
    ...
    <pre><code class="language-python"># Copyright (c) Facebook, Inc. and its affiliates. All Rights Reserved
"""
Backbone modules.
"""
...
def build_backbone(args):
    ...
    <h4 id="position_encoding.py" name="position_encoding.py">
...
def build_position_encoding(args):
    ...
    <h4 id="transformer.py" name="transformer.py">
     transformer.py
    </h4>
    <p>
     定义transformer结构
...
def _get_activation_fn(activation):
    ...
    <h4 id="matcher.py" name="matcher.py">
     matcher.py
    </h4>
    <p>
     定义匈牙利算法进行二分匹配
...
if __name__ == '__main__':
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37343036323932382f:61727469636c652f64657461696c732f313436313634383139" class_="artid" style="display:none">
 </p>
</div>
