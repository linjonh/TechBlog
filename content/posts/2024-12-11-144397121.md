...
* **Ollama API 参数**
  ...
  def generate\_completion(prompt, model=“qwen2.5:0.5b”):
    
  url = f"{base\_url}/generate"
  ...
  completion = generate\_completion(“介绍一下人工智能。”)
...
* **Ollama API 参数**
  ...
  def generate\_completion\_stream(prompt, model=“qwen2.5:0.5b”):
  ...
  stream\_completion = generate\_completion\_stream(“讲解机器学习的应用。”)
    
  print(“流式生成文本补全:”, stream\_completion)
...
* **Ollama API 参数**
  ...
  def generate\_chat\_completion(messages, model=“qwen2.5:0.5b”):
    
  url = f"{base\_url}/chat"
  ...
  chat\_response = generate\_chat\_completion(messages)
    
  print(“生成对话补全:”, chat\_response)
...
* **Ollama API 参数**
  ...
  def generate\_embeddings(text, model=“qwen2.5:0.5b”):
    
  url = f"{base\_url}/embed"
  ...
  embeddings = generate\_embeddings(“什么是深度学习？”)
...
* **Ollama API 参数**
  ...
  def list\_local\_models():
    
  url = f"{base\_url}/tags"
  ...
  local\_models = list\_local\_models()
    
  print(“列出本地模型:”, local\_models)
...
* **Ollama API 参数**
  ...
  def show\_model\_info(model=“qwen2.5:0.5b”):
    
  url = f"{base\_url}/show"
  ...
  model\_info = show\_model\_info()
    
  print(“模型信息:”, model\_info)
...
* **Ollama API 参数**
  ...
  def create\_model(model\_name=“qwen2.5\_custom”, base\_model=“qwen2.5:0.5b”):
    
  url = f"{base\_url}/create"
    
  data = {
    
  “name”: model\_name,
    
  “modelfile”: f"FROM {base\_model}
  ...
  create\_response = create\_model()
    
  print(“创建模型:”, create\_response)
...
* **Ollama API 参数**
  ...
  def pull\_model(model\_name=“qwen2.5:0.5b”):
    
  url = f"{base\_url}/api/pull"
    
  data = {“name”: model\_name}
  ...
  pull\_response = pull\_model()
    
  print(“拉取模型:”, pull\_response)
...
* **Ollama API 参数**
  ...
  def delete\_model(model\_name=“qwen2.5\_custom”):
    
  url = f"{base\_url}/delete"
  ...
  delete\_response = delete\_model()
    
  print(“删除模型:”, delete\_response)