...
不知道为什么，我这个mac的环境变量配置到zshrc不行，但是配置到bash\_profile就可以了，很诡异，有大佬了解的可以说一下原因。