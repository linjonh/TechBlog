...
mouseEnterAudio = GameObject.Find("MouseEnter\_audio").GetComponent<AudioSource>();

mouseClickAudio = GameObject.Find("MouseClick\_audio").GetComponent<AudioSource>();
...
textColor.GetComponent<TMP\_Text>().color = new Color32(236, 67, 0, 255);
