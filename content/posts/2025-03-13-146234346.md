...
systemctl enable --now httpd</code></pre>
    ...
    <pre><code class="language-bash">upstream webserver {
...
server{
 ...
     index index.html;
    ...
    <pre><code class="language-bash">yum install keepalived -y</code></pre>
    <p>
     编写 Nginx 健康检查脚本。
    </p>
    <p>
    ...
    <pre><code class="language-bash">vim /etc/keepalived/check_nginx.sh
​
...
vrrp_instance VI_1 {
 ...
    }
    ...
    <pre><code class="language-bash">vim /etc/hosts          # 在该文件最后添加以下内容
​
192.168.67.100  www.yunjisuan.com</code></pre>
    <p>
    </p>
    <h3>
     3.1.负载均衡验证
    ...
    <p>
     <img alt="" height="280" src="https://i-blog.csdnimg.cn/direct/36e5326cb1d14d79b23242d6df3fd2ac.png" width="1578"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="855" src="https://i-blog.csdnimg.cn/direct/2a4f00fece3d4f76863da4e37d64f151.png" width="1600"/>
    </p>
    <p>
     <img alt="" height="364" src="https://i-blog.csdnimg.cn/direct/d2fd4a976dc843a0b9fb0c05b484deff.png" width="1577"/>
    </p>
    <h3>
     <strong>
      3.3.观察 VIP 漂移
    ...
    <p>
     <img alt="" height="855" src="https://i-blog.csdnimg.cn/direct/c160e5433d9e4d24aed20f0feb02cb07.png" width="1600"/>
    </p>
    <p>
     客户端循环访问，MASTER 停止 Nginx 服务。
    </p>
    <pre><code class="language-bash">systemctl stop nginx</code></pre>
    <p>
     观察客户端服务无中断，几秒后访问自动恢复正常。
    </p>
    <p>
     <img alt="" height="604" src="https://i-blog.csdnimg.cn/direct/49b85876725e4d72a47a5f71f741acfd.png" width="1586"/>
    </p>
    <p>
     VIP 漂移到备主机。
    </p>
    <p>
     <img alt="" height="701" src="https://i-blog.csdnimg.cn/direct/9c25a9bce1884b249aca8088b49a3655.png" width="1600"/>
    </p>
    <p>
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f615f323337333137393437332f:61727469636c652f64657461696c732f313436323334333436" class_="artid" style="display:none">
 </p>
</div>
