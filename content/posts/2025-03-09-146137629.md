...
在头文件中添加#pragma execution\_character\_set（“utf-8”） ：

在所有用到中文字符的头文件中添加如下代码：#pragma execution\_character\_set（“utf-8”）。
...
如果使用的是MSVC编译器，可以尝试更改编译器设置，例如在项目文件中添加#pragma execution\_character\_set（“utf-8”）。
