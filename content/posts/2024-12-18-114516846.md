...
// 判断验证码是否正确 String sessionValidateCode = (String)req.getSession().getAttribute("SESSION\_VALIDATECODE"); System.out.println(sessionValidateCode); if(!sessionValidateCode.equals(verifyCode)){ out.print(""); }
