 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="694" src="https://i-blog.csdnimg.cn/direct/ceeee351a7034d798096aa102a4edccd.png" width="550"/>
    </p>
    <h4>
...
if (bind(listenSocket, (struct sockaddr *)&amp;serverAddr, sizeof(serverAddr)) == -1) {
    ...
    <pre><code>if (listen(listenSocket, 5) == -1) {
    ...
    <pre><code>struct sockaddr_in clientAddr;
...
if (clientSocket == -1) {
    ...
    <pre><code>int clientSocket = socket(AF_INET, SOCK_STREAM, 0);
if (clientSocket == -1) {
    perror("socket creation failed");
    return -1;
}
...
if (connect(clientSocket, (struct sockaddr *)&amp;serverAddr, sizeof(serverAddr)) == -1) {
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f68786a5f3638362f:61727469636c652f64657461696c732f313436323637333535" class_="artid" style="display:none">
 </p>
</div>
