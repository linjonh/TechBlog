...
y
m
\begin{cases} x\_{c\_1}-x\_{c'\_1}\leq y\_1 \\x\_{c\_2}-x\_{c'\_2} \leq y\_2 \\ \cdots\\ x\_{c\_m} - x\_{c'\_m}\leq y\_m\end{cases}
...
m
′
\begin{cases} x\_{c\_1}\leq y\_1+x\_{c'\_1} \\x\_{c\_2}\leq y\_2+x\_{c'\_2} \\ \cdots\\ x\_{c\_m} \leq y\_m+ x\_{c'\_m}\end{cases}
...
y
m
\begin{cases} x\_{c\_1}-x\_{c'\_1}\geq y\_1 \\x\_{c\_2}-x\_{c'\_2} \geq y\_2 \\ \cdots\\ x\_{c\_m} - x\_{c'\_m}\geq y\_m\end{cases}
...
m
′
\begin{cases} x\_{c\_1}\geq y\_1+x\_{c'\_1} \\x\_{c\_2}\geq y\_2+x\_{c'\_2} \\ \cdots\\ x\_{c\_m} \geq y\_m+ x\_{c'\_m}\end{cases}
