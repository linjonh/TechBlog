...
> -- 合并表或分区的ORC文件
>   
> ALTER TABLE table\_name [PARTITION (partition\_key='value')] CONCATENATE;
...
>   
> ALTER TABLE new\_table RENAME TO old\_table;
...
>   
> hadoop fs -getmerge /user/hive/warehouse/table\_dir/\* merged\_file.txt
>   
> hadoop fs -put merged\_file.txt /user/hive/warehouse/table\_dir/
>
> # 2. 使用Hive的`hadoop jar`命令合并（针对特定格式）
>   
> hadoop jar $HIVE\_HOME/lib/hive-exec.jar -Dmapreduce.job.queuename=default \
>   
> -Dmapreduce.map.memory.mb=2048 \
>   
> org.apache.hadoop.hive.ql.io.HiveFileFormatUtils \
>   
> --combine /user/hive/warehouse/table\_dir/ /user/hive/warehouse/table\_dir\_merged/
