 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="122" src="https://i-blog.csdnimg.cn/direct/ee5c333d61f444b9b733d0360c6aab9d.png" width="771"/>
    </p>
    <p>
     基于若依分离版springboot3搭建 地址：
     <a href="https://www.ruoyi.vip/" rel="nofollow" title="https://www.ruoyi.vip/">
      https://www.ruoyi.vip/
     </a>
    </p>
    <p>
     websocket部分的代码 地址
     <a href="https://gitee.com/dromara/RuoYi-Vue-Plus" rel="nofollow" title="https://gitee.com/dromara/RuoYi-Vue-Plus">
    ...
    <p>
     <img alt="" height="493" src="https://i-blog.csdnimg.cn/direct/ccc91d00e9ca43d1879a0bf619a0e6e3.png" width="220"/>
    </p>
    <ul>
     <li>
      基本配置
    ...
    <pre>WebSocketProperties.java</pre>
    <pre><code class="hljs">package com.beijing.websocket.config.properties;
...
public class WebSocketProperties {
    ...
    <pre>WebSocketConfig.java</pre>
    <pre><code class="hljs">package com.beijing.websocket.config;
...
public class WebSocketConfig {
    ...
    <pre>WebSocketConstants.java</pre>
    <pre><code class="hljs">package com.beijing.websocket.constant;
...
public interface WebSocketConstants {
    ...
    <pre>WebSocketMessageDto.java</pre>
    <pre><code class="hljs">package com.beijing.websocket.dto;
...
public class WebSocketMessageDto implements Serializable {
    ...
    <pre><span style="color:#fe2c24"><strong>重点</strong></span>：PlusWebSocketHandler.java [修改了这个方法 handleBinaryMessage]</pre>
    <p>
     后端在websocket 接收音频消息的地方，进行创建websocket客户端
    </p>
    <pre><code class="hljs">package com.beijing.websocket.handler;
...
//        log.info("[connect] sessionId: {},userId:{},userType:{}", session.getId(), loginUser.getUserId(), loginUser.getUserType());
    ...
    <pre>WebSocketSessionHolder.java</pre>
    <pre><code class="hljs">package com.beijing.websocket.holder;
...
public class WebSocketSessionHolder {
    ...
    <pre>PlusWebSocketInterceptor.java</pre>
    <pre><code class="hljs">package com.beijing.websocket.interceptor;
...
public class PlusWebSocketInterceptor implements HandshakeInterceptor {
    ...
    <pre>WebSocketTopicListener.java
</pre>
    <pre><code class="hljs">package com.beijing.websocket.listener;
...
public class WebSocketTopicListener implements ApplicationRunner, Ordered {
    ...
    <pre>WebSocketUtils.class</pre>
    <pre><code class="hljs">package com.beijing.websocket.utils;
...
//        });
    ...
    <pre>ReqSocketMessageVo.java</pre>
    <pre><code class="hljs">package com.beijing.websocket.vo;
...
public class ReqSocketMessageVo {
    ...
    <pre>RespSocketMessageVo.class</pre>
    <pre><code class="hljs">package com.beijing.websocket.vo;
...
public class RespSocketMessageVo {
    ...
    <pre><code class="hljs">package com.beijing.web.controller.system;
...
//                log.info("接收到识别结果: {}", recognitionResult);
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f33353132333830322f:61727469636c652f64657461696c732f313436323234323532" class_="artid" style="display:none">
 </p>
</div>
