  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <img alt="" height="773" src="https://i-blog.csdnimg.cn/direct/b01ac21cd78648b6ab9c1a3e9b86a2bd.png" width="914"/>
    </p>
    <h4>
     下载依赖：
    </h4>
    <pre><code class="language-java">yarn add vue3-pdf-app
 
or
 
npm install vue3-pdf-app</code></pre>
    <h4>
     配置类：
    </h4>
    <pre> 创建文件 pdfConfig.ts</pre>
    <pre><code class="language-TypeScript">// 工具栏配置项
export const config ={
	// 右侧其他区工具
	sidebar: {
...
&lt;/script&gt;
    ...
    <pre><code class="language-javascript"># vue3-pdf-app插件转中文配置代码
...
editor_ink_canvas_aria_label=用户创建图像</code></pre>
    <h5>
     第二步：
    </h5>
    <p>
    ...
    <p>
     <img alt="" height="121" src="https://i-blog.csdnimg.cn/direct/6ef10b54f2a34a11b437a541cde5bad5.png" width="812"/>
    </p>
    ...
    <p>
     ...
     是一个用于 Vue.js 的
     <a href="https://so.csdn.net/so/search?q=%E8%BD%BB%E9%87%8F%E7%BA%A7&amp;spm=1001.2101.3001.7020" title="轻量级">
      轻量级
     </a>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35313332363437382f:61727469636c652f64657461696c732f313436323635333238" class_="artid" style="display:none">
 </p>
</div>
