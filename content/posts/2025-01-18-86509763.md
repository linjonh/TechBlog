---
layout: post
title: "前端数据可视化之-一亿级关系图"
date: 2025-01-18 19:19:20 +0800
description: "前言在这之前，提起数据可视化，我都是能用echarts尽量用echarts，特效很棒而且用起来简单，"
keywords: "关系图 前端"
categories: ['未分类']
tags: ['无标签']
artid: "86509763"
image:
  path: https://api.vvhan.com/api/bing?rand=sj&artid=86509763
  alt: "前端数据可视化之-一亿级关系图"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=86509763
featuredImagePreview: https://bing.ee123.net/img/rand?artid=86509763
---
  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     ...
     <br/>
     最终实现效果：
     <a href="https://yzbaoo.github.io/cytoscape/" rel="nofollow">
      https://yzbaoo.github.io/cyto...
     </a>
    </p>
    ...
    <p>
     看了上面的需求你会选择用什么库实现? echarts应该是实现不了了(也可能是我对echarts的属性研究不深)，D3？(D3是肯定可以的了)，与其用D3从零开始为什么不找到现有的开源的专门做关系图的库，来实现它，百度了半天也没搜出个一支半截，最终还是看了某查网，发现它们引入了一个叫cytoscape.js的文件，百度了一下（官网：
     <a href="http://js.cytoscape.org/" rel="nofollow">
    ...
    <p>
     这是文档给出的描述，说的很官方，大概意思就是如果你想要“关系”关系图的话你可以使用它，包括分子图、社交网络图一系列想要表达关系的图，并且提供可以用JS原生方法添加交互的API。ok你的关系图做的很牛逼就够了，这正是我们想要的。使用方法很简单，一个div用于盛装画好的图，先引
     <a href="http://www.bootcdn.cn/jquery/" rel="nofollow">
      jquery
     </a>
     ，再引
     <a href="http://www.bootcdn.cn/cytoscape/" rel="nofollow">
      Cytoscape.js
     </a>
     ，然后就可以开始写你的代码了，还支持使用npm安装。
    </p>
    ...
    <p>
     代码：
     <a href="https://github.com/yzbaoo/cytoscape">
      https://github.com/yzbaoo/cyt...
     </a>
     <br/>
     上来，调用cytoscape方法，参数主要包括：
    </p>
    <pre class="has"><code>var cy = cytoscape({
...
//线：
//同理线的事件将‘node’换成‘edge’就行了</code></pre>
    <p>
...
cyRef = (cy) =&gt; {
 ...
 <p alt="687474:70733a2f2f626c6f672e6373646e2e6e65742f6b6b686b3034:2f61727469636c652f64657461696c732f3836353039373633" class_="artid" style="display:none">
 </p>
</div>
