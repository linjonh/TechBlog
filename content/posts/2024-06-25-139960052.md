...
API接口体系：
[TransformDBInstancePayType\_云数据库 RDS\_API调试-阿里云OpenAPI开发者门户](https://api.aliyun.com/api/Rds/2014-08-15/TransformDBInstancePayType "TransformDBInstancePayType_云数据库 RDS_API调试-阿里云OpenAPI开发者门户")
...
对比自建数据库：
[RDS与自建数据库优势对比\_云数据库 RDS](https://support.huaweicloud.com/productdesc-rds/rds_01_0006.html "RDS与自建数据库优势对比_云数据库 RDS")
