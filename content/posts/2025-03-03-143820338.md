...
* #define STOPPED 0        //停止
* #define FOLLOWING\_LINE 1    //巡线状态
* #define NO\_LINE 2        //小车脱离了线
...
跟随线机器人的其他常见情况是发现“NO\_LINE”也就是脱离了线，传感器检测不到黑线，传感器阵列输出为：0 0 0 0 0。在这种情况下，我们可以对其进行编程，使其原地旋转 ，直到找到线并恢复正常的巡线状态。
