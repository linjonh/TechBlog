...
### 还有一点需要注意sql server2014生成脚本后，在sql语句里面会有一句：“ALTER DATABASE [数据库名称] SET DELAYED\_DURABILITY = DISABLED ”，这个是sql server2014才出现的新特性，sql server2014以下都没有，执行会报错，具体的问度娘
