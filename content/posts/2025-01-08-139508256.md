...
3. 进入迁移引导
   ...
   * 输入MySQL源信息
     ...
     JDBC URl尽量更换一下：jdbc:mysql://192.168.1.21:3306/ruoyi\_vue\_05\_21?useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true&nullCatalogMeansCurrent=true
