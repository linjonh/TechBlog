---
arturl_encode: "68747470733a2f:2f626c6f672e6373646e2e6e65742f6b66617368666173662f:61727469636c652f64657461696c732f313436323532323334"
layout: post
...
![](https://i-blog.csdnimg.cn/img_convert/740bfe1cf3df2881510d6bdb41a3e4d6.png)
...
![](https://i-blog.csdnimg.cn/img_convert/97db18aab63265ec38ba3bcf0cd9b04c.png)
...
![](https://i-blog.csdnimg.cn/img_convert/4cd32dcebcd50f89892f84ef64f9d452.png)
...
![](https://i-blog.csdnimg.cn/img_convert/6d6dca2349c802584bab7f368e2ec6cf.png)
...
![](https://i-blog.csdnimg.cn/img_convert/a73493534314e0a9a5cd452985381566.png)

#### 服务拆分示例

以课前资料中的微服务cloud-demo为例，其结构如下：

![](https://i-blog.csdnimg.cn/img_convert/1eccd17dfa23a979de904012259df958.png)
...
![](https://i-blog.csdnimg.cn/img_convert/69e0be2533f5525f39e75daa3ace00bd.png)

根据id查询订单，返回值是Order对象，如图：

![](https://i-blog.csdnimg.cn/img_convert/c0c192eef4c7d938d2597d06e15aad7a.png)

其中的user为null

在user-service中有一个根据id查询用户的接口：

![](https://i-blog.csdnimg.cn/img_convert/ca09bd71ae76e65891d614c2f1f228aa.png)

查询的结果如图：

![](https://i-blog.csdnimg.cn/img_convert/38c8962a9177693311132c38fa6955be.png)

##### 案例需求：

修改order-service中的根据id查询订单业务，要求在查询订单的同时，根据订单中包含的userId查询出用户信息，一起返回。

![](https://i-blog.csdnimg.cn/img_convert/1c79a08fb6dedad30b79664e99ef9d73.png)
...
![](https://i-blog.csdnimg.cn/img_convert/c42748a5d82328177bee3cea1a468fc4.png)
...
![](https://i-blog.csdnimg.cn/img_convert/9e0b40ae2116b46a18003102bd859bee.png)
...
![](https://i-blog.csdnimg.cn/img_convert/07f1702e65206cd8a655a0f33bf261d8.png)
...
![](https://i-blog.csdnimg.cn/img_convert/12123b51bf42ecbfe2f72a681549e951.png)
...
![](https://i-blog.csdnimg.cn/img_convert/b22db90fce06e23e6b86287aaa1e7fc8.png)
...
![](https://i-blog.csdnimg.cn/img_convert/0204e6ba6e7b646fbb17621559f7665d.png)
...
![](https://i-blog.csdnimg.cn/img_convert/afd3bfb174f221d7c10f02cbfc6a4d46.png)

启动两个user-service实例：

![](https://i-blog.csdnimg.cn/img_convert/2140653c99322be05177d65c914c217a.png)

查看eureka-server管理页面：

![](https://i-blog.csdnimg.cn/img_convert/278288bf9895439da4ba8aeb6c8290b3.png)
...
![](https://i-blog.csdnimg.cn/img_convert/e25271780ed7d74b5469f24e2eb14159.png)

修改order-service服务中的cn.seven.order.service包下的OrderService类中的queryOrderById方法。修改访问的url路径，用服务名代替ip、端口：

![](https://i-blog.csdnimg.cn/img_convert/1e98806a8098e20b0a634bed6b79456f.png)
...
2. 有两种情况会导致 Eureka Server 收不到微服务的心跳是微服务自身的原因是微服务与 Eureka 之间的网络故障
...
![](https://i-blog.csdnimg.cn/img_convert/5c8218ab5daf49286ae9b85a2ffb6f71.png)
...
![](https://i-blog.csdnimg.cn/img_convert/9b9522b0345b679a6a2e4d922de6b699.png)
...
![](https://i-blog.csdnimg.cn/img_convert/f0596c8968f6ad5c90769399473c26a1.png)

可以看到这里的intercept方法，拦截了用户的HttpRequest请求，然后做了几件事：

* **`request.getURI()`**
  ：获取请求uri，本例中就是
  [http://user-service/user/8](http://user-service/user/8 "http://user-service/user/8")
* **`originalUri.getHost()`**
...
![](https://i-blog.csdnimg.cn/img_convert/7fd94da23baec9100465da2fdb7d6684.png)
...
![](https://i-blog.csdnimg.cn/img_convert/0a2d95223e4d7faba91a1bd8773f5eed.png)
...
![](https://i-blog.csdnimg.cn/img_convert/6a1617bf1dbf8d02e18ce74d74b1b819.png)

我们继续跟入：

![](https://i-blog.csdnimg.cn/img_convert/61180feb59df8bc9ab80385137699817.png)

继续跟踪源码chooseServer方法，发现这么一段代码：

![](https://i-blog.csdnimg.cn/img_convert/6976a4bbec7756f5a89e0b3aaf1c0fef.png)

我们看看这个rule是谁：

![](https://i-blog.csdnimg.cn/img_convert/16e6d103c826c608179586350d0d46d2.png)

这里的rule默认值是一个
**`RoundRobinRule`**
，看类的介绍：

![](https://i-blog.csdnimg.cn/img_convert/eacacea4016a4d85662b0f40c2515762.png)
...
![](https://i-blog.csdnimg.cn/img_convert/492c57dae5571e63eddaaccc5609f6fb.png)
...
![](https://i-blog.csdnimg.cn/img_convert/4ab0f6933baeb551c8d24f422a681ffb.png)

不同规则的含义如下：

![](https://i-blog.csdnimg.cn/img_convert/0236c1a93bc1986b09a24e35d930e983.png)
...
![](https://i-blog.csdnimg.cn/img_convert/076a4afb141f031b21862ed536594e35.png)

正常情况下各个节点相互配置，完成用户请求的处理工作

![](https://i-blog.csdnimg.cn/img_convert/196366c5aa4419e41113554ff2bcd610.png)

当某种请求增多，造成"服务T"故障的情况时，会延伸的造成"服务U"不可用，及继续扩展，如下

![](https://i-blog.csdnimg.cn/img_convert/0caa8f9722fcb2114dcef9f33b19563d.png)

最终造成下面这种所有服务不可用的情况

![](https://i-blog.csdnimg.cn/img_convert/2b456bebea99f4a0f91e2c8d23a8e212.png)
...
![](https://i-blog.csdnimg.cn/img_convert/602c4a75be7f54d28ec736f59213070b.png)

当consumer调用provider服务出现问题的情况下:

![](https://i-blog.csdnimg.cn/img_convert/6e8a4277fe3a23eb18a6a1a3aaad501c.png)

此时我们对consumer的服务调用做降级处理

![](https://i-blog.csdnimg.cn/img_convert/9dbda46640bf63669aa2dc281b3783a9.png)
...
![](https://i-blog.csdnimg.cn/img_convert/868b8c8715f6b8c12e20cd3639426c06.png)

##### 合并请求的场景

![](https://i-blog.csdnimg.cn/img_convert/85de052e0957ca1559b972b441c667ee.png)
...
![](https://i-blog.csdnimg.cn/img_convert/c803a7064b21ac66881ff6737bcd658e.png)

#### 熔断

熔断其实是在降级的基础上引入了重试的机制。当某个时间内失败的次数达到了多少次就会触发熔断机制，具体的流程如下

![](https://i-blog.csdnimg.cn/img_convert/99259ae6505a90e3323335e4b37c253f.png)
...
![](https://i-blog.csdnimg.cn/img_convert/e81312d6a82632b829acbfdd8fefa472.png)
...
![](https://i-blog.csdnimg.cn/img_convert/ef6c7ffef3856092702db67d93c51c39.png)

当接口A压力增大，接口C同时也会受到影响

![](https://i-blog.csdnimg.cn/img_convert/d19ca35978c8ce0e2f654232e35d0de2.png)

使用线程池的场景

![](https://i-blog.csdnimg.cn/img_convert/060510c6ae86d2110cc489d6f9ee7177.png)

当服务接口A访问量增大时，因为接口C在不同的线程池中所以不会受到影响

![](https://i-blog.csdnimg.cn/img_convert/0d2a51c9a71420e7df79f45f42f84366.png)
...
![](https://i-blog.csdnimg.cn/img_convert/36080bf02f9caad3c62a9e43fbeaf4f1.png)

##### 信号量隔离

信号量隔离其实就是我们定义的队列并发时最多支持多大的访问，其他的访问通过托底数据来响应，如下结构图

![](https://i-blog.csdnimg.cn/img_convert/15d918f5e019fd06bbbcb34e35c9d2c6.png)
...
![](https://i-blog.csdnimg.cn/img_convert/5b14bbc78a48b0dd6c7d91348c05453c.png)

##### 两者的区别

线程池隔离和信号量隔离的区别

![](https://i-blog.csdnimg.cn/img_convert/99070c1031266540374ca194c6da36d3.png)
...
![](https://i-blog.csdnimg.cn/img_convert/22137ed6bd0d3bb5877b9c42cc808f26.png)
...
![](https://i-blog.csdnimg.cn/img_convert/b9bf64ce2e2159890b66849441337876.png)
...
![](https://i-blog.csdnimg.cn/img_convert/408e8f732854bc9656de0f1d1ae794f6.png)
...
![](https://i-blog.csdnimg.cn/img_convert/9d55d43c405c1086963634873a00c0b3.png)

Debug方式启动order-service服务，可以看到这里的client，底层就是Apache HttpClient：

![](https://i-blog.csdnimg.cn/img_convert/c72f7a80f7b4fbd531b49c14250816c9.png)
...
![](https://i-blog.csdnimg.cn/img_convert/cddb578e34289a3f6bf9c282c010727c.png)

UserController：

![](https://i-blog.csdnimg.cn/img_convert/829cda7fe5b298b079f590f0d26547cc.png)
...
![](https://i-blog.csdnimg.cn/img_convert/614e94faeb763c9341292d278521ff31.png)
...
![](https://i-blog.csdnimg.cn/img_convert/0f29710f7c768dec2a0db66c172b6c08.png)
...
![](https://i-blog.csdnimg.cn/img_convert/abb6bba925774a199b8681c3d081d1d9.png)
...
![](https://i-blog.csdnimg.cn/img_convert/fd238e646fea91bfb7a5375b1128d4ee.png)
...
![](https://i-blog.csdnimg.cn/img_convert/f678ff5cd83d9d9a1441cb2d7e687a8d.png)

##### 网关路由的流程图

整个访问的流程如下：

![](https://i-blog.csdnimg.cn/img_convert/d2661b158597baafdd135d2e75b9cc9f.png)
...
![](https://i-blog.csdnimg.cn/img_convert/9e31599afdd14bcdcf92a63e94db8d24.png)
...
![](https://i-blog.csdnimg.cn/img_convert/e47387e879fbfbba9f156de34d49ddcd.png)

##### 路由过滤器的种类

Spring提供了31种不同的路由过滤器工厂。例如：

![](https://i-blog.csdnimg.cn/img_convert/5bd4f3cc332ec6eff4ada6c699eefeec.png)
...
![](https://i-blog.csdnimg.cn/img_convert/bb9b299b973d5208023f2497ac901d3c.png)
...
![](https://i-blog.csdnimg.cn/img_convert/9c5e55c57b42787cb5a346887634a3dc.png)
...
> **文章转载自：**
> [Seven](https://www.cnblogs.com/seven97-top "Seven")
>
> **原文链接：**
> [SpringCloud带你走进微服务的世界 - seven97\_top - 博客园](https://www.cnblogs.com/seven97-top/p/18768699 "SpringCloud带你走进微服务的世界 - seven97_top - 博客园")
>
> **体验地址：**
> [引迈 - JNPF快速开发平台\_低代码开发平台\_零代码开发平台\_流程设计器\_表单引擎\_工作流引擎\_软件架构](http://www.jnpfsoft.com/?from=001YH "引迈 - JNPF快速开发平台_低代码开发平台_零代码开发平台_流程设计器_表单引擎_工作流引擎_软件架构")