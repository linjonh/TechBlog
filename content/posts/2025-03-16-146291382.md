...
3. 处理插件的情况。
实例化具体的`Executor`对象。
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/39f5de23092447d8b7d5fe183ff07845.png)\_案例中默认的是simple\_
...
+ 方法名\_
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b546be656b174806bb9a3abc38ff3745.png)\_最终找到的是该方法在mapper.xml中对应解析出的MappedStatement\_
### 2.2、query
