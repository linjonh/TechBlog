...
def test_division():
    ...
    <pre><code>pytest path/to/tests
</code></pre>
    <p>
     运行特定测试文件中的某个测试函数：
    </p>
    <pre><code>pytest path/to/tests/test_module.py::test_function
</code></pre>
    <p>
     显示详细的打印输出：
    </p>
    ...
    <pre><code>pytest --junitxml=path/to/report.xml
</code></pre>
    <p>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f485541363931312f:61727469636c652f64657461696c732f313436303732363434" class_="artid" style="display:none">
 </p>
</div>
