   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <span style="color:rgb(0,153,0)">
      <span style="font-family:System; font-size:16px">
    ...
    <p>
     <span style="font-family:'Comic Sans MS'; font-size:18px; color:#3366ff">
      <br/>
     </span>
    </p>
    <p>
    ...
    <pre><code class="language-java">package com.game.view;
...
public class TestView extends SurfaceView implements Callback, Runnable{
 ...
 <p alt="68747470733a2f:2f626c6f672e6373646e2e6e65742f7a313037343937313433:322f61727469636c652f64657461696c732f37303234383039" class_="artid" style="display:none">
 </p>
</div>
