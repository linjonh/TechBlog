 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-dracula" id="content_views">
    ...
    <p>
     <a href="https://download.csdn.net/download/sjp1992/84784721">
      客户端、服务器完整源码下载地址
     </a>
    </p>
    <p>
     <strong>
      <a href="https://blog.csdn.net/sjp1992/article/details/119455910">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/157788771bd293e3c287513ed3e69e0a.gif#pic_center"/>
    </p>
    <h3>
     <a id="1_TCP_8">
     </a>
...
有新的连接时发送此信号
    ...
    <h3>
     <a id="3_QTcpSocket_49">
     </a>
     3. QTcpSocket常用函数
    </h3>
    <pre><code>virtual void connectToHost(const QString &amp;hostName, quint16 port, OpenMode openMode = ReadWrite, NetworkLayerProtocol protocol = AnyIPProtocol)
...
每次将有效数据写入设备的当前写入通道时，都会发出此信号。bytes参数设置为写入的字节数。
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f736a70313939322f:61727469636c652f64657461696c732f313139343533383338" class_="artid" style="display:none">
 </p>
</div>
