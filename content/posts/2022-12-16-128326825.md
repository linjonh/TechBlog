...
* `注意：环境变量中的非相关项不要轻易删改，否则可能导致其他程序无法正常运行，甚至系统故障。`
  ...
  **第三步 新建一个叫 JAVA\_HOME 的系统变量，变量值为你的 jdk 安装路径**
  ...
  **第八步 将新建的%JAVA\_HOME%\bin变量上移到顶部，表示优先使用**
...
> 。
>
> * 如果你只需要一个 Java 环境，则完全不需要再单独配置 JAVA\_HOME、修改 Path 了，直接可以用该环境。
...
参考文献一：https://blog.csdn.net/qq\_42250281/article/details/123662746
  
参考文献二：https://blog.csdn.net/weixin\_54217081/article/details/122521606
  
参考文献三：https://blog.csdn.net/m0\_58873085/article/details/125242114
