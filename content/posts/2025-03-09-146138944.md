...
`dname` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4\_0900\_ai\_ci DEFAULT NULL COMMENT '部门名称',
`loc` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4\_0900\_ai\_ci DEFAULT NULL COMMENT '部门位置',
PRIMARY KEY (`deptno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4\_0900\_ai\_ci;
CREATE TABLE `emp` (
`empno` int NOT NULL COMMENT '员工编号',
`ename` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4\_0900\_ai\_ci DEFAULT NULL COMMENT '员工名字',
`job` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4\_0900\_ai\_ci DEFAULT NULL COMMENT '员工岗位',
...
/\*
SELECT \* FROM table\_name LIMIT offset, row\_count;
...
count( e.deptno ),
IFNULL( avg( e.sal ), 0 ),
IFNULL(avg(( TO\_DAYS( NOW()) - TO\_DAYS( hiredate )) / 365 ) , 0)
FROM
emp e
...
select empno,sal from emp where ((TO\_DAYS(NOW()) - TO\_DAYS(hiredate))/365) > 30;
drop table if EXISTS emp\_bak;
create table emp\_bak as select \* from emp;
update emp\_bak set sal = (sal\*1.1) where (TO\_DAYS(NOW()) - TO\_DAYS(hiredate))/365 > 30;
参考：[SQL经典训练试题\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1sE41147eG/?spm\_id\_from=333.1387.favlist.content.click&vd\_source=6b519d498b1d3d31a214c1998c1e5d0f
"SQL经典训练试题\_哔哩哔哩\_bilibili")