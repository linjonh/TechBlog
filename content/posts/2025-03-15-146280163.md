 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <pre><code class="language-cpp">//以point为例
class Point {
public:
...
Lines::Lines(const Lines&amp; rhs) {
    ...
    <pre><code class="language-cpp">class Point3d : public virtual Point {
public:
...
private:
    ...
    <pre><code class="language-cpp">class Vertex : virtual public Point { };
class Vertex3d : public Point3d, public Vertex { };
class PVertex : public Vertex3d { };</code></pre>
    <p>
     <img alt="" height="524" src="https://i-blog.csdnimg.cn/direct/c5ef9ade94b24459a8086a4fb2003587.png" width="442"/>
    </p>
    <p>
    ...
    <pre><code class="language-cpp">//c++伪码
Point3d*
...
Vextex3d::Vextex3d(Vextex3d* this, bool __most_derived,
    ...
    <pre><code class="language-cpp">Vertex3d cv;</code></pre>
    <p>
    ...
    <pre><code class="language-cpp">Point(x, y);
Point3d(x, y, z);
Vertex(x, y, z);
Vertex3d(x, y, z);
PVertex(x, y, z);</code></pre>
    <p>
     假设每个class都定义了一个virtual function size();返回该class的大小。我们来看看定义的PVertex constructor
    </p>
    <pre><code class="language-cpp">PVertex::Pvertex(float x, float y, float z)
    ...
    <pre><code class="language-cpp">PVertex*
PVertex::Pvertex(PVertex*this, bool __most_derived,
    ...
    <p>
     参考
     <a href="https://www.cnblogs.com/tianzeng/p/12162177.html" rel="nofollow" title="构造、析构、拷贝语意学 - tianzeng - 博客园">
      构造、析构、拷贝语意学 - tianzeng - 博客园
     </a>
    </p>
   </div>
  </div>
 </article>
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34303137383038322f:61727469636c652f64657461696c732f313436323830313633" class_="artid" style="display:none">
 </p>
</div>
