...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <h3>
     什么是身份？
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#id2" rel="nofollow" title="¶">
      ¶
     </a>
    </h3>
    <p>
    ...
    <p>
     ...
     权威机构。
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/membership/membership.html" rel="nofollow" title="成员服务提供者">
      成员服务提供者
     </a>
    ...
    <h3>
     一个简单的场景来解释身份的使用
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#id3" rel="nofollow" title="¶">
      ¶
     </a>
    </h3>
    <p>
    ...
    <p class="img-center">
     <img alt="Scenario" height="283" src="https://i-blog.csdnimg.cn/img_convert/e286eb474441f8d451ba83887b2dfa13.png" width="777"/>
    </p>
    <p>
     <em>
    ...
    <h3>
     什么是 PKI？
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#pki" rel="nofollow" title="¶">
      ¶
     </a>
    </h3>
    <p>
    ...
    <p class="img-center">
     <img alt="PKI" height="371" src="https://i-blog.csdnimg.cn/img_convert/3aed287b431a94efa147be7f39121a15.png" width="884"/>
    </p>
    <p>
     <em>
    ...
    <p>
     ...
     <a href="https://en.wikipedia.org/wiki/Public_key_infrastructure" rel="nofollow" title="维基百科">
      维基百科
     </a>
     是一个很好的起点。
    </p>
    <h3>
     数字证书
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#id4" rel="nofollow" title="¶">
      ¶
     </a>
    </h3>
    <p>
     数字证书是包含与证书持有者相关的属性的文档。最常见的证书类型是符合
     <a href="https://en.wikipedia.org/wiki/X.509" rel="nofollow" title="X.509标准">
      X.509标准
     </a>
    ...
    <p class="img-center">
     <img alt="DigitalCertificate" height="349" src="https://i-blog.csdnimg.cn/img_convert/a6333c4b646b43bed3044f0b030c4ea9.png" width="750"/>
    </p>
    <p>
     <em>
    ...
    <h3>
     授权，公钥和私钥
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#id5" rel="nofollow" title="¶">
      ¶
     </a>
    </h3>
    <p>
    ...
    <p class="img-center">
     <img alt="AuthenticationKeys" height="473" src="https://i-blog.csdnimg.cn/img_convert/d9a1bb1afd2222dd0b8b46acecf129ea.png" width="889"/>
    </p>
    <p>
    ...
    <h3>
     证书授权中心
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#id6" rel="nofollow" title="¶">
      ¶
     </a>
    </h3>
    <p>
    ...
    <p class="img-center">
     <img alt="CertificateAuthorities" height="284" src="https://i-blog.csdnimg.cn/img_convert/1cd31138a2cbff18b6e853b896bf5078.png" width="624"/>
    </p>
    <p>
     <em>
    ...
    <h4>
     根 CA，中间 CA 和信任链
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#ca-ca" rel="nofollow" title="¶">
      ¶
     </a>
    </h4>
    <p>
    ...
    <p class="img-center">
     <img alt="ChainOfTrust" height="382" src="https://i-blog.csdnimg.cn/img_convert/b8d0cd724f1aaadfa3ce3ccfde84ecdb.png" width="678"/>
    </p>
    <p>
     <em>
    ...
    <h4>
     Fabric CA
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#fabric-ca" rel="nofollow" title="¶">
      ¶
     </a>
    </h4>
    <p>
    ...
    <p>
     如果你有兴趣，你可以
     <a href="http://hyperledger-fabric-ca.readthedocs.io/" rel="nofollow" title="在 CA 文档部分">
      在 CA 文档部分
     </a>
    ...
    <h3>
     证书撤销列表
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/identity/identity.html#id7" rel="nofollow" title="¶">
      ¶
     </a>
    </h3>
    <p>
    ...
    <p class="img-center">
     <img alt="CRL" height="384" src="https://i-blog.csdnimg.cn/img_convert/81945a208bad624e85834d376598d74a.png" width="984"/>
    </p>
    <p>
     <em>
    ...
    <p>
     ...
     <a href="https://hyperledger-fabric-ca.readthedocs.io/en/latest/users-guide.html#generating-a-crl-certificate-revocation-list" rel="nofollow" title="此处">
      此处
     </a>
     。
    </p>
    ...
    <p>
     要了解有关成员的更多信息，请查看有关
     <a href="https://hyperledger-fabric.readthedocs.io/zh-cn/release-2.5/membership/membership.html" rel="nofollow" title="MSP">
      MSP
     </a>
     的概念文档。
    </p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34323130343639342f:61727469636c652f64657461696c732f313436313830363331" class_="artid" style="display:none">
 </p>
</div>
