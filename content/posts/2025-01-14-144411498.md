...
* + - [1. 导入库](#1__57)
    ...
    - * [3.1 `__init__` 方法](#31___init____94)
      * [3.2 `build` 方法](#32_build__115)
      * [3.3 `calc_position` 方法](#33_calc_position__128)
      * [3.4 `calc` 方法](#34_calc__140)
      * [3.5 `render` 方法](#35_render__165)
    - [4. 辅助函数](#4__176)
    - * [4.1 `heart_function`](#41_heart_function_178)
      * [4.2 `scatter_inside`](#42_scatter_inside_194)
