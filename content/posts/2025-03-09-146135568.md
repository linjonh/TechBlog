...
**修改大模型存放位置：$env:HF\_HOME = "E:\soft\Hugging-Face"**

**修改大模型下载位置：$env:HF\_ENDPOINT="**
[HF-Mirror](https://hf-mirror.com "HF-Mirror")
**"**

![](https://i-blog.csdnimg.cn/img_convert/595f304a081a353174d11f5bbc4a4778.png)

**安装huggingface\_hub：pip install -U huggingface\_hub**
...
接下来就是准备训练数据集了，在LLaMA-Factory工程中，打开data文件夹下的READ\_ME.md文件，查看框架支持的训练数据集：
...
把xfc.json配置到dataset\_info.json
...
* ✅ 参数精调：固定的生成参数配置（max\_length=100, top\_p=0.85, temperature=0.6...）
* ✅ 错误处理：完整的异常捕获和日志记录机制
* ✅ 健康检查：提供服务状态监控端点
...
[10分钟上手DeepSeek开发：SpringBoot + Vue2快速构建AI对话系统\_springboot deepseek-CSDN博客](https://blog.csdn.net/c18213590220/article/details/145708471?spm=1001.2014.3001.5501 "10分钟上手DeepSeek开发：SpringBoot + Vue2快速构建AI对话系统_springboot deepseek-CSDN博客")
