 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    <p>
     <img alt="" height="1426" src="https://i-blog.csdnimg.cn/direct/c3bb5888fcb54a8e8fe3bfe2117f6246.png" width="1610"/>
    </p>
    <h2>
     Arm Runner 编译
    </h2>
    ...
    <p>
     官方文档有说明：
     <a href="https://v2.tauri.app/distribute/pipelines/github/#_top" rel="nofollow" title="GitHub | Tauri">
      GitHub | Tauri
     </a>
    </p>
    <pre><code class="hljs">name: 'Publish Linux Arm builds'
...
jobs:
    ...
    steps:
      ...
      - name: Upload appimage bundle
        ...
        with:
          ...
          path: ${<!-- -->{ github.workspace }}/src-tauri/target/release/bundle/appimage/appname_${<!-- -->{ env.APP_VERSION }}_${<!-- -->{ matrix.appimage }}.AppImage</code></pre>
    <h2>
     故障排除
    </h2>
    <p>
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343738363533302f:61727469636c652f64657461696c732f313436313631333031" class_="artid" style="display:none">
 </p>
</div>
