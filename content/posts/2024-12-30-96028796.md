...
<div class="blog-content-box">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <div class="toc">
     ...
     <ul>
      ...
      <li>
       <ul>
        <li>
         <a href="#11_docker_10" rel="nofollow">
          1.1 docker
         </a>
        </li>
       </ul>
      ...
      <li>
       <a href="#2_kubernetes_55" rel="nofollow">
        2. 云原生核心--kubernetes
       </a>
      </li>
      <li>
       <ul>
        <li>
         <a href="#21_kubernetes_72" rel="nofollow">
          2.1 kubernetes核心概念
         </a>
        </li>
       </ul>
    ...
    <ol>
     ...
     <li>
      docker如何解决哪些问题
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/89e88c2b1445794a7c5e2201b62606b6.png">
       <br/>
       下面分别讲述这些问题：
       <ul>
        <li>
        ...
        <li>
         ...
         仓库类似github 存放镜像的仓库。
         <br/>
         <img alt="Docker与虚拟机区别" src="https://i-blog.csdnimg.cn/blog_migrate/655685c3414750f2b01c7744d4a9dc3a.png">
          <br/>
          <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/049e3ca82ba7d00a85d3d8949e792aec.png">
           <br/>
    ...
    <ol start="2">
     ...
     <li>
      aufs层叠文件系统
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6d5b397d10c7f50c5ad90880d5e2ee05.png">
       <br/>
       ...
       <br/>
       <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/f99ff38a0b26469a79f5041ba5180768.png"/>
      </img>
     </li>
    </ol>
    <ul>
    ...
    <ul>
     ...
     <li>
      ...
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/47ed9ad6d9fbeec9c43d0af0a4c70349.png"/>
     </li>
     <li>
      2013年，docker项目发布
      <br/>
    ...
    <ul>
     <li>
      k8s体系结构
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/5bf9f924737c88248a3b1f863f1bba39.png"/>
     </li>
     <li>
      核心概念包含Pod、Volume、Deployment、Service、Namespaces
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/2a28f762b2f6551982060f740ce2160b.png">
 ...
 <p alt="68747470733a2f2f:626c6f672e6373646e2e6e65742f6373646e5f78696172616e:2f61727469636c652f64657461696c732f3936303238373936" class_="artid" style="display:none">
 </p>
</div>
