...
### \*\*容器应用管理应用场景\*\*
![图片](https://i-blog.csdnimg.cn/img\_convert/657fe636d463a7f354775f11718a3b03.png)
...
![图片](https://i-blog.csdnimg.cn/img\_convert/351b74bd7f861f53f060462a846e57e4.png)
如上所示，在应用组件集群的工作负载中，支持高效的应用组件版本控制，提供应用组件按照版本滚动部署、按照版本恢复部署的集群管理功能
### \*\*秒级弹性伸缩应用场景\*\*
![图片](https://i-blog.csdnimg.cn/img\_convert/55acde20d8fdb73d59f7095aa2132c80.png)
...
### \*\*微服务流量治理应用场景\*\*
![图片](https://i-blog.csdnimg.cn/img\_convert/784df27e63a2277b040a6b3bd0f633ed.png)
如上所示，在CCE容器引擎中，部署lstio微服务应用集群，集群是由控制面以及数据面构成，访问流量的输入由负载均衡器分发、Pod实例中的应用侧访问代理组件对接应用提供的服务、集群的微服务治理策略由控制面提供实现
### \*\*DevOps持续交付应用场景\*\*
![图片](https://i-blog.csdnimg.cn/img\_convert/401e7ff94f0292d5b531ca9500bafce8.png)
...
### \*\*混合云应用场景\*\*
![图片](https://i-blog.csdnimg.cn/img\_convert/0f47538a4a917bc41bb8275d0258740c.png)
...
### \*\*高性能调度应用场景\*\*
![图片](https://i-blog.csdnimg.cn/img\_convert/e81cc7818e6dc8e3d49c2f2d5409d4fd.png)
...
![图片](https://i-blog.csdnimg.cn/img\_convert/52269009bbec3a31dbd0d55d98da7331.png)
...
![图片](https://i-blog.csdnimg.cn/img\_convert/80b153e40593056f62892bb4c8c5078d.png)
