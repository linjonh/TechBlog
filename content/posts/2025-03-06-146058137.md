...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a00361dc4d6a4b4689edc55f7f45c777.png"/>
    </p>
    <h2>
     <a id="0_5">
     </a>
    ...
    <p>
     <a href="https://arxiv.org/abs/2410.13842" rel="nofollow">
      论文链接
     </a>
     <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/81fa9f52e33847d0b472ca3247a23a1f.png"/>
    </p>
    <p>
     其中，
     <span class="katex--inline">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/5124590e60a941b28a8d9eaefcb62b70.png"/>
    </p>
    <h3>
     <a id="41__69">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7b9d79297aea457abae78eb4547a912d.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/64a4f4494da542609d5e5d0f601cf5a1.png"/>
    </p>
    <p>
     其中，
     <span class="katex--inline">
      <span class="katex">
       <span class="katex-mathml">
        ...
        Pr^l(n) = \{P^l_t(n), Pr^l_b(n), Pr^l_l(n), Pr^l_r(n)\}
       </span>
       <span class="katex-html">
        <span class="base">
         <span class="strut" style="height: 1.0991em; vertical-align: -0.25em;">
        ...
        <span class="base">
         <span class="strut" style="height: 1.1322em; vertical-align: -0.2831em;">
         </span>
         <span class="mopen">
          {
          <!-- -->
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/48b2ab7a237e4d47a70a400265e0365e.png"/>
    </p>
    <p>
     前一层的logits
     <span class="katex--inline">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/2cdb7887192e46dbbd791fa93c74c0da.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/085e6d1401bb4d2b899c4d19bec3d030.png"/>
    </p>
    <p>
     其中，
     <span class="katex--inline">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3b9626903a8a4d79b041a00e678e0171.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/24e5fc15bd4b402aacf18ab6d9ee95ce.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/20d0e59869934a1cbd51601bbb5b95d1.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/5dc74ec091c04573a4f780623a36e38a.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c2d2881320384ec0be3c875d4fbac6ef.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c9a7651bb12c43deb6d105a2ae7c39ed.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/96589930fe4c4ec99d2d2b3cb5e0383f.png"/>
    </p>
    <h3>
     <a id="54__159">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/539528b69ef943c79ec1d6dd24f0791b.png"/>
     <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/52991a0c19ba4e159015322a6379148e.png"/>
    </p>
    <p>
     其中，
     <span class="katex--inline">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/eb1876c0c9c749b0b8552ef1e2f56b47.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1e1afd603f7b45d8b67d592d7eea0de2.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/4b32bee4005f40888882930014151445.png"/>
     <br/>
     表6：不同D-FINE模型的超参数配置。
    </p>
    <h4>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/231505e3a870423092eabe9c8f8a4d47.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/08411b2f18ab416ea8796e1079bb8831.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/fa983408afae4c9e955a07c9069b281d.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/4bbd3f0726604740a8c38bc322179cc1.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/74d649fc61384bffb4bf8c6c6a628b90.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/ce69e907ad69403f8254941ca24654e6.png"/>
    </p>
    <p>
     其中，
     <span class="katex--inline">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/e1731729237a40798c85c3d1128ecf64.png"/>
    </p>
    <p>
     此处，
     <span class="katex--inline">
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f34343138343835322f:61727469636c652f64657461696c732f313436303538313337" class_="artid" style="display:none">
 </p>
</div>
