...
配置虚拟环境到指定目录/python\_virtual，配置pyweb的虚拟python环境
...
虚拟环境下创建django\_projects初始化django的mysite项目
...
django的服务渲染json可以用nginx的proxy\_pass抛出去
