 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="703" src="https://i-blog.csdnimg.cn/direct/6fcd6f4895274713b5b75523e4843f6a.png" width="969"/>
    </p>
    <p>
...
data=data.dropna(axis=1)</code></pre>
    ...
    <pre><code class="language-python">#维度一：针对频数进行数据的可视化，保存到def自定义函数中，以便后续的调用
...
def dimension_counts(dish_famous):
    ...
    <p>
     效果：
     <img alt="" height="594" src="https://i-blog.csdnimg.cn/direct/8d11f90ce8144c45bcf7d06c0c856e5b.png" width="790"/>
    </p>
    <p>
    ...
    <pre><code class="language-python">#维度二：订单消费类型的统计。同理，先进行频数统计，然后进行绘图分析
...
def dimension_orders(dish_order):
    ...
    <p>
     效果：
     <img alt="" height="592" src="https://i-blog.csdnimg.cn/direct/7c86c9ff9b1d4f75b0278479df81df53.png" width="789">
    ...
    <pre><code class="language-python">#维度三：订单消费金额以及点菜数量的维度分析
...
def dimension_dish_count(dish_order_count):
    ...
    <p>
     效果：
     <img alt="" height="543" src="https://i-blog.csdnimg.cn/direct/2c2295ebc964431696d3d4199e5a78b1.png" width="728">
      <img alt="" height="541" src="https://i-blog.csdnimg.cn/direct/686d08a7479f46fda65f407b4e64b662.png" width="728"/>
     </img>
    </p>
    <p>
    ...
    <pre><code class="language-python">#维度四：时间维度分析
...
def dimension_time_count(time_count):
    ...
    <p>
     效果：
     <img alt="" height="548" src="https://i-blog.csdnimg.cn/direct/38d631b607734d4d8937a44ca707918b.png" width="728"/>
    </p>
    <p>
     可见一天内11点人最多，其他时间点稀少
    </p>
    ...
    <pre><code class="language-python">#  分析哪一天的订点菜数量最多,利用strftime函数进行详细信息的提取
...
def dimension_daycount(day_count):
    ...
    <p>
     效果：
     <img alt="" height="541" src="https://i-blog.csdnimg.cn/direct/65a76ce5fd74444b9f22c84c3bd49e2e.png" width="727"/>
    </p>
    <p>
    ...
    <pre><code class="language-python">#  分析周几人最多，映射到星期
...
def dimension_weekcount(week_count):
    ...
    <p>
     效果：
     <img alt="" height="594" src="https://i-blog.csdnimg.cn/direct/568e964c8ed247539938b80a56342265.png" width="798"/>
    </p>
    <p>
    ...
    <pre><code class="language-python">#进行程序的交互设计
...
if __name__ == '__main__':
    ...
    <p>
     效果：
     <img alt="" height="202" src="https://i-blog.csdnimg.cn/direct/a67dc8b90a3e45de9a8961e1f268d979.png" width="1031"/>
    </p>
    <p>
     可见自动生成：
     <img alt="" height="433" src="https://i-blog.csdnimg.cn/direct/d17194172f214d9a9ceebcaed07fb2e9.png" width="1009"/>
    </p>
    <h2>
     完整代码：
    </h2>
    <pre><code class="language-python">#数据要求：有多个客户id对不同的类别进行了交互，其中的不同列代表客户对类型的交互属性。例如：客户id/客户年龄/消费类别/消费个数/消费资金
...
if __name__ == '__main__':
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323330325f37373937353934302f:61727469636c652f64657461696c732f313436303736393237" class_="artid" style="display:none">
 </p>
</div>
