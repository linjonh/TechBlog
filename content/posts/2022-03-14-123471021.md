...
[SpringBoot多环境的切换(生产环境、开发环境、测试环境)_周太阳的博客-CSDN博客_springboot测试生产环境切换](https://blog.csdn.net/qq_43891148/article/details/110479863 "SpringBoot多环境的切换(生产环境、开发环境、测试环境)_周太阳的博客-CSDN博客_springboot测试生产环境切换")

[java maven 测试生产环境配置_SpringBoot生产环境和测试环境配置分离的教程详解_落云歌语文的博客-CSDN博客](https://blog.csdn.net/weixin_28729205/article/details/114132122 "java maven 测试生产环境配置_SpringBoot生产环境和测试环境配置分离的教程详解_落云歌语文的博客-CSDN博客")

server.servlet.context-path=/hello  指定请求的基础路径

---

[黑马程序员SpringBoot教程，6小时快速入门Java微服务架构Spring Boot_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1Lq4y1J77x?p=12 "黑马程序员SpringBoot教程，6小时快速入门Java微服务架构Spring Boot_哔哩哔哩_bilibili")
