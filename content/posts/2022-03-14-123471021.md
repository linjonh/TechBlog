---
layout: post
title: "31-SpringBoot多环境的切换生产环境开发环境测试环境"
date: 2022-03-14 09:48:03 +0800
description: "参考链接：SpringBoot多环境的切换(生产环境、开发环境、测试环境)_周太阳的博客-CSDN博"
keywords: "spring boot生产和开发环境"
categories: ['Spring']
tags: ['后端', 'Spring', 'Java', 'Boot']
artid: "123471021"
image:
    path: https://api.vvhan.com/api/bing?rand=sj&artid=123471021
    alt: "31-SpringBoot多环境的切换生产环境开发环境测试环境"
render_with_liquid: false
featuredImage: https://bing.ee123.net/img/rand?artid=123471021
featuredImagePreview: https://bing.ee123.net/img/rand?artid=123471021
---
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <a href="https://spring.io/" rel="nofollow" title="Spring官网">
      Spring官网
     </a>
    </p>
    <p>
     <a href="https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.external-config" rel="nofollow" title="Spring官网 外部配置加载顺序的说明">
      Spring官网 外部配置加载顺序的说明
     </a>
    </p>
    <p>
     <a href="https://blog.csdn.net/qq_43891148/article/details/110479863" title="SpringBoot多环境的切换(生产环境、开发环境、测试环境)_周太阳的博客-CSDN博客_springboot测试生产环境切换">
      SpringBoot多环境的切换(生产环境、开发环境、测试环境)_周太阳的博客-CSDN博客_springboot测试生产环境切换
     </a>
    </p>
    <p>
     <a href="https://blog.csdn.net/weixin_28729205/article/details/114132122" title="java maven 测试生产环境配置_SpringBoot生产环境和测试环境配置分离的教程详解_落云歌语文的博客-CSDN博客">
    ...
    <hr/>
    <p>
     <a href="https://www.bilibili.com/video/BV1Lq4y1J77x?p=12" rel="nofollow" title="黑马程序员SpringBoot教程，6小时快速入门Java微服务架构Spring Boot_哔哩哔哩_bilibili">
    ...
    <p>
     <img alt="" height="640" src="https://i-blog.csdnimg.cn/blog_migrate/5bdd1a7c27e53041ae3157fa9ca81f65.png" width="1200"/>
    </p>
    <h3>
     1 application.propertes配置文件多环境配置
    </h3>
    <p>
     <img alt="" height="905" src="https://i-blog.csdnimg.cn/blog_migrate/dda598dc52dbeb837af73ac8a56a5f47.png" width="1200">
      （图片中的内容补充：application.properties中不写server.port=8080，也是默认启动8080端口的。）
     </img>
    </p>
    <p>
     <img alt="" height="888" src="https://i-blog.csdnimg.cn/blog_migrate/baac8d43546109dd64bb5830b4a5a1f7.png" width="1200"/>
    </p>
    <h3>
     2 application.yml文件多环境配置
    </h3>
    <p>
     <img alt="" height="402" src="https://i-blog.csdnimg.cn/blog_migrate/55ba728ded4e8a76d78d784d939ebb97.png" width="739"/>
    </p>
    <p>
     <img alt="" height="882" src="https://i-blog.csdnimg.cn/blog_migrate/95bb42d6a3fcbe1e87d08017a8ce9c64.png" width="1200"/>
    </p>
    <p>
    </p>
    <h4>
    ...
    <p>
     <img alt="" height="547" src="https://i-blog.csdnimg.cn/blog_migrate/b9b99f298f1b417d848555a2b69c5bbd.png" width="1055"/>
    </p>
    <h4>
    ...
    <p>
     <img alt="" height="518" src="https://i-blog.csdnimg.cn/blog_migrate/6179fd6c4f2e0c2e990ba6e1682f48e3.png" width="774"/>
    </p>
    <h2>
     内部配置加载顺序
    </h2>
    <p>
     <img alt="" height="448" src="https://i-blog.csdnimg.cn/blog_migrate/5cfd04e4f097617bd111472bb36d1912.png" width="786"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" height="752" src="https://i-blog.csdnimg.cn/blog_migrate/4b85aacdea6ce3d624ac40433325596b.png" width="625"/>
    </p>
    <p>
    ...
    <p>
     <br/>
     <img alt="" height="462" src="https://i-blog.csdnimg.cn/blog_migrate/b67409bac692074efb26b9328878c9d9.png" width="887"/>
    </p>
    <p>
    </p>
    <p>
    ...
    <h2>
     第一种：用application.
     <a href="https://so.csdn.net/so/search?q=properties&amp;spm=1001.2101.3001.7020" title="properties">
      properties
     </a>
     做配置文件
    </h2>
    ...
    <p>
     <img alt="" height="185" src="https://i-blog.csdnimg.cn/blog_migrate/cbaad43e7f642bbbb95c21231049d9e6.png" width="314"/>
    </p>
    <h4>
     <a name="t2">
     </a>
    ...
    <p>
     <img alt="" height="61" src="https://i-blog.csdnimg.cn/blog_migrate/8b65e7b322d64118f3719c175ce817a7.png" width="259"/>
    </p>
    <p>
     <img alt="" height="68" src="https://i-blog.csdnimg.cn/blog_migrate/6ed1f2ee72a66fc1ed2946cc43041667.png" width="262"/>
    </p>
    <p>
     <img alt="" height="69" src="https://i-blog.csdnimg.cn/blog_migrate/30813c6a1bba5478de45e9343c31a7f9.png" width="271"/>
    </p>
    <h4>
     在主配置文件种使用其中某个配置：
    </h4>
    <p>
     <img alt="" height="63" src="https://i-blog.csdnimg.cn/blog_migrate/2fecbaff6dbfb3f201c643204440b417.png" width="302"/>
    </p>
    <h4>
     运行后的结果：
    </h4>
    <p>
     <img alt="" height="301" src="https://i-blog.csdnimg.cn/blog_migrate/d34444774ccce75c7b7f254e49ec8413.png" width="1200"/>
    </p>
    <p>
    </p>
    <hr/>
    ...
    <p>
     <img alt="" height="442" src="https://i-blog.csdnimg.cn/blog_migrate/e5858333edf8deb6372ca4aa069580c6.png" width="341"/>
    </p>
    <pre><code>spring:
  profiles:
    active: dev
...
spring:
  ...
  datasource:
    ...
    <p>
     <img alt="" height="269" src="https://i-blog.csdnimg.cn/blog_migrate/798484c4996e8b58892f5635b8b5a493.png" width="1200"/>
    </p>
    <p>
    </p>
    <hr/>
    ...
    <h3>
     <a href="https://so.csdn.net/so/search?q=%E8%99%9A%E6%8B%9F%E6%9C%BA&amp;spm=1001.2101.3001.7020" title="虚拟机">
      虚拟机
     </a>
     参数
    </h3>
    ...
    <p>
     ...
     springboot-0.0.1-SNAPSHOT.jar(命令行中指定active文件)
    </p>
    <hr/>
    <h2>
     第四种：cmd 中的命令行参数
    ...
    <p>
     ...
     <strong>
      <span style="color:#f3f3f4;">
       <code>
        <span style="background-color:#0d0016;">
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/blog_migrate/6693785c725a273c7c13d1a1fa6ca91d.png"/>
    </p>
    <p>
    </p>
    <hr/>
...
public class ProdEmailServiceImpl2 implements EmailService{
    ...
    <pre><code>java -jar app.jar --spring.profiles.active=dev</code></pre>
    <p>
     第七种：通过pom.xml选择运行环境
    </p>
    <p>
    ...
    <pre><code class="language-XML">    &lt;!--  定义配置文件  --&gt;
    &lt;profiles&gt;
    ...
    &lt;build&gt;
        ...
        &lt;resources&gt;
            &lt;!--   配置一个 resource   directory 为对象目录
                  excludes-&gt;exclude  build时排除
                    includes-&gt;include build时包含
            --&gt;
            &lt;resource&gt;
	...
	&lt;/profiles&gt;
&lt;build&gt;
		&lt;!-- 打包后的名称，如下：打包后是ROOT.war --&gt;
		&lt;finalName&gt;ROOT&lt;/finalName&gt;
		&lt;!-- resources这个元素描述了项目相关的所有资源路径列表，例如和项目相关的属性文件，这些资源被包含在
             最终的打包文件里。 --&gt; 
		&lt;resources&gt;
			&lt;resource&gt;
			&lt;!-- directory描述存放资源的目录，pom.xml文件的相对路径	 --&gt; 
				&lt;directory&gt;src/main/java&lt;/directory&gt;
				&lt;excludes&gt;
					&lt;exclude&gt;**/*.java&lt;/exclude&gt;
				&lt;/excludes&gt;
				&lt;!-- 是否替换资源中的属性,默认也是false --&gt;
			...
			&lt;resource&gt;
			&lt;!-- 这个就是切换不同环境的路径，${env}对应标签env的值，可自定义 --&gt; 
				&lt;directory&gt;src/main/resources/deployEnv/${env}&lt;/directory&gt;
				&lt;filtering&gt;true&lt;/filtering&gt;
				&lt;excludes&gt; &lt;!-- 打包时排除 --&gt; 
					&lt;exclude&gt;s_root/**&lt;/exclude&gt;
				&lt;/excludes&gt;
			&lt;/resource&gt;
		&lt;/resources&gt;
		&lt;plugins&gt;
...
&lt;!-- 指定maven编译的jdk版本,如果不指定,maven3默认用jdk 1.5 maven2默认用jdk1.3 --&gt;
    ...
    <p>
     参考链接：
     <a href="https://www.cnblogs.com/hafiz/p/5360195.html" rel="nofollow" title="史上最全的maven的pom.xml文件详解 - 阿豪聊干货 - 博客园">
      史上最全的maven的pom.xml文件详解 - 阿豪聊干货 - 博客园
     </a>
    </p>
...
xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd "&gt; 
    ...
    &lt;!-- 父项目的坐标。如果项目中没有规定某个元素的值，那么父项目中的对应值即为项目的默认值。
         坐标包括group ID，artifact ID和 version。#一级 --&gt; 
    &lt;parent&gt; 
        &lt;!-- 被继承的父项目的构件标识符 --&gt; 
    ...
    &lt;!-- 构件的标识符，它和group ID一起唯一标识一个构件。换句话说，你不能有两个不同的项目拥有同样的artifact ID
         ...
         为项目产生的构件包括：JARs，源码，二进制发布和WARs等。#一级 --&gt; 
    &lt;artifactId&gt;xxx&lt;/artifactId&gt; 
    ...
    &lt;!-- 项目的名称, Maven产生的文档用 #一级--&gt; 
    &lt;name&gt; xxx-maven &lt;/name&gt; 

    &lt;!-- 项目主页的URL, Maven产生的文档用 #一级--&gt; 
    ...
    &lt;!-- 描述了这个项目构建环境中的前提条件。#一级 --&gt; 
    &lt;prerequisites&gt; 
        &lt;!-- 构建该项目或使用该插件所需要的Maven的最低版本 --&gt; 
        &lt;maven&gt;&lt;/maven&gt; 
    &lt;/prerequisites&gt; 

    &lt;!-- 项目的问题管理系统(Bugzilla, Jira, Scarab,或任何你喜欢的问题管理系统)的名称和URL，本例为 jira #一级--&gt; 
    &lt;issueManagement&gt; 
        &lt;!-- 问题管理系统（例如jira）的名字， --&gt; 
        &lt;system&gt; jira &lt;/system&gt; 
    ...
    &lt;!-- 该元素描述了项目所有License列表。 应该只列出该项目的license列表，不要列出依赖项目的 license列表。
         如果列出多个license，用户可以选择它们中的一个而不是接受所有license。 #一级 --&gt; 
    &lt;licenses&gt; 
    ...
    &lt;!-- SCM(Source Control Management)标签允许你配置你的代码库，供Maven web站点和其它插件使用。 #一级 --&gt; 
    &lt;scm&gt; 
    ...
    &lt;!-- 在列的项目构建profile，如果被激活，会修改构建处理 #一级 --&gt; 
    &lt;profiles&gt; 
    ...
    &lt;!-- 模块（有时称作子项目） 被构建成项目的一部分。列出的每个模块元素是指向该模块的目录的相对路径 #一级 --&gt; 
    &lt;modules&gt;
        &lt;!--子项目相对路径--&gt;
        &lt;module&gt;&lt;/module&gt;
    &lt;/modules&gt; 
    ...
    &lt;!-- 不赞成使用. 现在Maven忽略该元素. #一级--&gt; 
    &lt;reports&gt;&lt;/reports&gt; 

    &lt;!-- 该元素描述使用报表插件产生报表的规范。当用户执行“mvn site”，这些报表就会运行。 在页面导航栏能看到所有报表的链接。#一级 --&gt; 
    &lt;reporting&gt; 
    ...
    &lt;!-- 继承自该项目的所有子项目的默认依赖信息。这部分的依赖信息不会被立即解析,而是当子项目声明一个依赖
        （必须描述group ID和artifact ID信息），如果group ID和artifact ID以外的一些信息没有描述，则通过
            group ID和artifact ID匹配到这里的依赖，并使用这里的依赖信息。 #一级 --&gt; 
    &lt;dependencyManagement&gt; 
        &lt;dependencies&gt; 
            &lt;!-- 参见dependencies/dependency元素 --&gt; 
            &lt;dependency&gt; 
    ...
    &lt;!-- 以值替代名称，Properties可以在整个POM中使用，也可以作为触发条件（见settings.xml配置文件里
         activation元素的说明）。格式是&lt;name.xx&gt;valuex&lt;/name.xx&gt;。#一级 --&gt; 
    &lt;properties&gt;
        &lt;name&gt;value&lt;/name&gt;
    &lt;/properties&gt; 
&lt;/project&gt; 
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34343838353737352f:61727469636c652f64657461696c732f313233343731303231" class_="artid" style="display:none">
 </p>
</div>
