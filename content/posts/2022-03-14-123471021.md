---
arturl_encode: "68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34343838353737352f:61727469636c652f64657461696c732f313233343731303231"
layout: post
title: "31-SpringBoot多环境的切换生产环境开发环境测试环境"
date: 2022-03-14 09:48:03 +08:00
...
[Spring官网](https://spring.io/ "Spring官网")

[Spring官网 外部配置加载顺序的说明](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.external-config "Spring官网 外部配置加载顺序的说明")

[SpringBoot多环境的切换(生产环境、开发环境、测试环境)\_周太阳的博客-CSDN博客\_springboot测试生产环境切换](https://blog.csdn.net/qq_43891148/article/details/110479863 "SpringBoot多环境的切换(生产环境、开发环境、测试环境)_周太阳的博客-CSDN博客_springboot测试生产环境切换")

[java maven 测试生产环境配置\_SpringBoot生产环境和测试环境配置分离的教程详解\_落云歌语文的博客-CSDN博客](https://blog.csdn.net/weixin_28729205/article/details/114132122 "java maven 测试生产环境配置_SpringBoot生产环境和测试环境配置分离的教程详解_落云歌语文的博客-CSDN博客")

server.servlet.context-path=/hello  指定请求的基础路径

---

[黑马程序员SpringBoot教程，6小时快速入门Java微服务架构Spring Boot\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1Lq4y1J77x?p=12 "黑马程序员SpringBoot教程，6小时快速入门Java微服务架构Spring Boot_哔哩哔哩_bilibili")

## Profile

![](https://i-blog.csdnimg.cn/blog_migrate/5bdd1a7c27e53041ae3157fa9ca81f65.png)

### 1 application.propertes配置文件多环境配置

![](https://i-blog.csdnimg.cn/blog_migrate/dda598dc52dbeb837af73ac8a56a5f47.png)
（图片中的内容补充：application.properties中不写server.port=8080，也是默认启动8080端口的。）

![](https://i-blog.csdnimg.cn/blog_migrate/baac8d43546109dd64bb5830b4a5a1f7.png)

### 2 application.yml文件多环境配置

![](https://i-blog.csdnimg.cn/blog_migrate/55ba728ded4e8a76d78d784d939ebb97.png)

![](https://i-blog.csdnimg.cn/blog_migrate/95bb42d6a3fcbe1e87d08017a8ce9c64.png)

#### 3 VM options指定参数式启动某个环境的配置文件

-Dspring.profiles.active=development

![](https://i-blog.csdnimg.cn/blog_migrate/b9b99f298f1b417d848555a2b69c5bbd.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/6179fd6c4f2e0c2e990ba6e1682f48e3.png)

## 内部配置加载顺序

![](https://i-blog.csdnimg.cn/blog_migrate/5cfd04e4f097617bd111472bb36d1912.png)

我们写在resources目录下的那个application.propertes文件，将来 打包会打到classpath:/：classpath的根目录下。

同时在项目文件系统中：优先级是这样的

![](https://i-blog.csdnimg.cn/blog_migrate/4b85aacdea6ce3d624ac40433325596b.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/b67409bac692074efb26b9328878c9d9.png)
...
## 第一种：用application. [properties](https://so.csdn.net/so/search?q=properties&spm=1001.2101.3001.7020 "properties") 做配置文件

#### 配置多个环境的配置文件：

![](https://i-blog.csdnimg.cn/blog_migrate/cbaad43e7f642bbbb95c21231049d9e6.png)

#### 3种环境配置不同的端口，如下：

![](https://i-blog.csdnimg.cn/blog_migrate/8b65e7b322d64118f3719c175ce817a7.png)

![](https://i-blog.csdnimg.cn/blog_migrate/6ed1f2ee72a66fc1ed2946cc43041667.png)

![](https://i-blog.csdnimg.cn/blog_migrate/30813c6a1bba5478de45e9343c31a7f9.png)

#### 在主配置文件种使用其中某个配置：

![](https://i-blog.csdnimg.cn/blog_migrate/2fecbaff6dbfb3f201c643204440b417.png)

#### 运行后的结果：

![](https://i-blog.csdnimg.cn/blog_migrate/d34444774ccce75c7b7f254e49ec8413.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e5858333edf8deb6372ca4aa069580c6.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/798484c4996e8b58892f5635b8b5a493.png)

---

## 第三种：cmd中的jvm虚拟机参数

### [虚拟机](https://so.csdn.net/so/search?q=%E8%99%9A%E6%8B%9F%E6%9C%BA&spm=1001.2101.3001.7020 "虚拟机") 参数
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6693785c725a273c7c13d1a1fa6ca91d.png)
...
参考链接：
[史上最全的maven的pom.xml文件详解 - 阿豪聊干货 - 博客园](https://www.cnblogs.com/hafiz/p/5360195.html "史上最全的maven的pom.xml文件详解 - 阿豪聊干货 - 博客园")
