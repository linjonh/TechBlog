---
arturl_encode: "68747470733a2f2f62:6c6f672e6373646e2e6e65742f6d305f37343832333236342f:61727469636c652f64657461696c732f313436313530383737"
layout: post
title: "Redis-简介"
...
![](https://i-blog.csdnimg.cn/blog_migrate/45e66fed525c58abeaa20ed991ad516e.png)

目前全球最大的 Redis 用户是新浪微博，在新浪有 200 多台物理机，400 多个端口正在运行着 Redis,有+4G 的数据跑在 Redis 上来为微博用户提供服务。

![](https://i-blog.csdnimg.cn/blog_migrate/20c2290918b8a4c22b96dc539bed87cc.png)

在新浪微博 Redis 的部署场景很多，大概分为如下的 2 种:
  
第一种是应用程序直接访问 Redis 数据库

![](https://i-blog.csdnimg.cn/blog_migrate/f3dbefe44886e58ffc70c441a97b9634.png)

第二种是应用程序直接访问 Redis，只有当 Redis 访问失败时才访问 MySQL!

![](https://i-blog.csdnimg.cn/blog_migrate/61d3e8f2dc82eb0fc745f070d6fbdcbb.png)
...
windows下载安装 ：
[Releases · microsoftarchive/redis · GitHub](https://github.com/MicrosoftArchive/redis/releases "Releases · microsoftarchive/redis · GitHub")
...
![](https://i-blog.csdnimg.cn/blog_migrate/b9ce935b28080503f8bb015017d93722.png)
...
[RESP.app (formerly Redis Desktop Manager) - GUI for Redis ? available on Windows, macOS, iPad and Linux.](https://redisdesktop.com/ "RESP.app (formerly Redis Desktop Manager) - GUI for Redis  available on  Windows, macOS, iPad and Linux.")
...
![](https://i-blog.csdnimg.cn/blog_migrate/35ef7bfb7ae3d643c98f68e39b2e4b0e.png)
