...
void thread_b(void* args){
 ...
    }
    ...
    <p>
     <a class="has-card" href="https://blog.csdn.net/charlie114514191/article/details/146172810" title="从0开始的操作系统手搓教程22——锁让我们的并发变得更加安全-CSDN博客">
      <span class="link-card-box" contenteditable="false">
       <span class="link-title">
        从0开始的操作系统手搓教程22——锁让我们的并发变得更加安全-CSDN博客
       </span>
       <span class="link-desc">
        文章浏览阅读2次。笔者是先于此项目才知道的锁的。实际上，上一个问题的根源是——锁的缺失导致程序潜在的不安全。如果你学习过锁和信号量，那显然，你就可以直接跳到实现上，直接实现一个信号量和锁就可以结束本小节的内容了，如果你没有，请听我慢慢道来。现在呢，我们启动这个存在问题的内核。然后当运行还在正常的时候，快速的嗯下我们的Ctrl + C稍微让我们的内核休息一下。然后，我们就打开外部中断检测。OK，在执行一段时间后，我们终于看到了触发异常的地方了这里，我们看到的是时刻00191782969发生了不应该发生的东西。
       </span>
       <span class="link-link">
        <img alt=" " class="link-link-icon" src="https://g.csdnimg.cn/static/logo/favicon32.ico">
         https://blog.csdn.net/charlie114514191/article/details/146172810
        </img>
       </span>
      </span>
     </a>
