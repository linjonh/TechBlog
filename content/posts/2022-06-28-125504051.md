 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/3a3f0125ba6ead10a785125fa419f1ec.png"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/e5c4a76ec1274e9d18a66007c531ed46.png"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" height="395" src="https://i-blog.csdnimg.cn/blog_migrate/2f4a9b63caafdd66632e555a4810a289.png" width="680"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/7fd9cd28f9cae9646a2d0d9c9280faea.png"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/5a993da1c1e0b1a1fc1e678010964c57.png"/>
    </p>
    <p>
...
python -m uiautomator2 init --addr :7912
    ...
    <pre><code>python -m weditor
</code></pre>
    <p>
     weditor 可以抓取安卓控件元素、自动生成脚本代码并进行Debug。
    </p>
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/1f389006342fa941d308f8645c028b98.png"/>
    </p>
    <p>
     <strong>
    ...
    <pre><code>xcodebuild -project WebDriverAgent.xcodeproj -scheme WebDriverAgentRunner -destination 'platform=iOS Simulator,name=iPhone 6' test
</code></pre>
    <p>
     <strong>
    ...
    <pre><code># 解锁keychain，以便可以正常的签名应用
...
xcodebuild -project WebDriverAgent.xcodeproj -scheme WebDriverAgentRunner -destination "id=$UDID" test
    ...
    <pre><code>pip3 install -U facebook-wda
</code></pre>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/1227762b11a9895c0835b5cd3128db9f.png"/>
    </p>
    <p>
     私有云真机集群，需要自己采购真机设备和专用机柜。
    </p>
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/d651827e5ef62ef3480f3a567a0864ce.png"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/c1850a04a74f65ff0d9a38c37b5c418a.png"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/e4b875fd09ae54d307cc2939cb750a19.png"/>
    </p>
    <p>
     生成测试报告：
    </p>
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/1428e5a21b125955eac456c8c49405f4.png"/>
    </p>
    <p>
    ...
    <p class="img-center">
     <img alt="" src="https://i-blog.csdnimg.cn/blog_migrate/36b0dfdc7e2a1c59da32de6b4998ea69.png"/>
    </p>
    <p>
     这些资料，对于想进阶【自动化测试】的朋友来说应该是最全面最完整的备战仓库，这个仓库也陪伴我走过了最艰难的路程，希望也能帮助到你！凡事要趁早，特别是技术行业，一定要提升技术功底。希望对大家有所帮助…….
    </p>
    <p class="img-center">
     <img alt="" height="151" src="https://i-blog.csdnimg.cn/blog_migrate/32d3197335b2beef90977bc7bea1cdbb.png" width="451"/>
    </p>
   </div>
  </div>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f6a69616e676a756e7373732f:61727469636c652f64657461696c732f313235353034303531" class_="artid" style="display:none">
 </p>
</div>
