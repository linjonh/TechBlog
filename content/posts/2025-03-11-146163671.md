...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" height="831" src="https://i-blog.csdnimg.cn/direct/33fe1c9137714e5dac9a316f9112d410.png" width="1068"/>
    </p>
    <p>
     bgsave命令的运行流程：
    </p>
    ...
    <p>
     ...
     ，可以通过info stats命令查看lastest_fork_usec选项，可以获取最近一次fork操作的耗时，单位为微秒
    </p>
    <p>
    ...
    <p>
     ...
     。执行lastsave命令可以获取最后一次生成RDB的时间，对应info统计rdb_last_save_time选项
    </p>
    <p>
     5
     <strong>
 ...
 <p alt="68747470733a2f2f626c6f:672e6373646e2e6e65742f323330315f37363932383039372f:61727469636c652f64657461696c732f313436313633363731" class_="artid" style="display:none">
 </p>
</div>
