  ...
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-dark" id="content_views">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3af7c73150c04284930c6be978504857.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a3dc635818994723998c805c10af552e.png"/>
     </img>
    </p>
    <h3>
     <a id="_12">
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/62d656cd20c84671b6990be3073f2260.png">
      <br/>
      X表⽰某⼀个具体的数据； 表⽰模型的参数。
     </img>
    </p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f750e69f5090476ba80d1b893600629d.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/5d4567813da3484b9014b9e05739a06d.png"/>
    </p>
    <h4>
     <a id="_26">
     </a>
    ...
    <p>
     我们对似然函数取对数, 就是对数似然函数
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/bd77152eae25460591a849949030414b.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/00fdb165119347d0b946f83934c3fea8.png"/>
     </img>
    </p>
    <p>
     <strong>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/c635f6622cda4b53acbdc6b2f66581d9.png">
      <br/>
      <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/22702af7d03142fc8a2ccafcdbf22ffa.png"/>
     </img>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/987fee751e2e45acb027cde85b030164.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/22b70644c58b4a228998de5364095490.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/9c8cfa8cda384a1e934a6d0d7b5b39cd.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/837a410627c34e1bb8acab13bde53ad6.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7aa70ab98a5e4cf4bcab8642b6dfbf2e.png"/>
    </p>
    <h2>
     <a id="_44">
     </a>
    ...
    <p>
     <img alt="逻辑回归就是将线性回归模型映射为概率的模型" src="https://i-blog.csdnimg.cn/direct/d5db9cafe0fd4e76ab1c1c92d9adf4a6.png"/>
     <br/>
     ⽽这其中的转换，我们使⽤的就是sigmoid函数
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/7639694b835141618807e2b66d49f6c8.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/6923816ddec345509e2cf3592741497b.png"/>
     <br/>
     回过头来看之前说过的
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/395dc31c76b64d92a547bbac4d560df6.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/6e7661d8c9264a0fa09f2dfb576b9f16.png"/>
    </p>
    <h2>
     <a id="_52">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/1d857d58829a4839b30f45e2e3cdc2f9.png"/>
    </p>
    <h4>
     <a id="_64">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/cc10fa9c591d4977adc7728cae09fca8.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/3a5d560a663e40e281bd21959d02f1e2.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/0e11993e7d1244f99469614d5f8784a5.png"/>
     <br/>
     如果学习率过⼤的时候，函数收敛过程如下图所⽰：
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/a94e13173e2b4f0f9f8922f503f09544.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b17c5ce482f3402192dc476425f2c136.png"/>
     <br/>
...
plt.show()
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/b6b75e82665448a2b2bf48ca26421b36.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/f59d0ac62e4e47afa5189e5a4a3a8830.png"/>
    </p>
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/cfc528b4542645b69f86387d574387c6.png"/>
    </p>
    <h3>
     <a id="_95">
     </a>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/700d9efd991240bdb71d7a20c91eb022.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/61a69deb9f2b42b280806e3cb66b7a81.png"/>
     <br/>
    ...
    <p>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/07059be875034eee9797720ea1d50f8d.png"/>
    </p>
    <h3>
     <a id="_101">
     </a>
    ...
    <p>
     ...
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/466367c496154248bc0609a3ee99dca6.png"/>
     <br/>
     <img alt="在这里插入图片描述" src="https://i-blog.csdnimg.cn/direct/93df5a6cf12347838893c13ff8e4b6cc.png"/>
    </p>
    <h3>
     <a id="_106">
     </a>
    ...
    <p>
     ...
     <br/>
     <a href="https://scikit-learn.org/stable/api/index.html" rel="nofollow">
...
for i in range(epochs):
 ...
 <p alt="68747470733a2f2f626c6f672e:6373646e2e6e65742f77656978696e5f35333833313439362f:61727469636c652f64657461696c732f313436303239333633" class_="artid" style="display:none">
 </p>
</div>
