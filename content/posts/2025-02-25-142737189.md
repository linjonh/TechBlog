...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-tomorrow-night" id="content_views">
       ...
       <ul>
        ...
        <li>
         <ul>
          ...
          <li>
           <a href="#GO_38" rel="nofollow">
            三、安装GO语言主程序
           </a>
          </li>
          <li>
           <a href="#GOLANG_41" rel="nofollow">
            四、GOLANG常用命令
           </a>
          </li>
          <li>
           <a href="#VSCODE_44" rel="nofollow">
            五、安装VSCODE
           </a>
          </li>
          <li>
          ...
          <li>
           <a href="#Goland_50" rel="nofollow">
            七、安装Goland
           </a>
          </li>
          <li>
           <a href="#GolandVsCode_53" rel="nofollow">
            八、Goland与VsCode的区别
           </a>
          </li>
          <li>
           <a href="#vscode_56" rel="nofollow">
            九、使用vscode编写第一个程序
           </a>
          </li>
          <li>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#ModulePackage_106" rel="nofollow">
            ...
            <li>
             <a href="#VsCode_112" rel="nofollow">
              七、VsCode项目管理
             </a>
            </li>
            <li>
             <a href="#Goland_115" rel="nofollow">
              八、Goland项目管理
             </a>
            </li>
            <li>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#Ifelse_168" rel="nofollow">
              一、条件语句（If-else）
             </a>
            </li>
            <li>
             <a href="#Switch_171" rel="nofollow">
              二、Switch语句
             </a>
            </li>
            <li>
             <a href="#For_174" rel="nofollow">
              三、循环语句：For循环
             </a>
            </li>
            <li>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#Go_OCP_394" rel="nofollow">
              六、Go 语言中的接口设计与OCP设计原则
             </a>
            </li>
            <li>
             <a href="#Go__OCP__397" rel="nofollow">
              七、Go 语言接口设计遵循 OCP 原则的应用示例
             </a>
            </li>
            <li>
             <a href="#Go__400" rel="nofollow">
              八、Go 语言与面向对象程序设计
             </a>
            </li>
            <li>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#Reflection_431" rel="nofollow">
              一、反射（Reflection）
             </a>
            </li>
            <li>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#Asynchronous_Programming_469" rel="nofollow">
              一、异步编程（Asynchronous Programming）
             </a>
            </li>
            <li>
             <a href="#Concurrency_Programming_472" rel="nofollow">
            ...
            <li>
             <a href="#Go__478" rel="nofollow">
              四、Go 语言中并发编程
             </a>
            </li>
            <li>
             <a href="#Goroutines_481" rel="nofollow">
              五、Goroutines
             </a>
            </li>
            <li>
             <a href="#Goroutine_484" rel="nofollow">
              六、Goroutine应用示例
             </a>
            </li>
            <li>
            ...
            <li>
             <a href="#Channel_490" rel="nofollow">
              八、Channel
             </a>
            </li>
            <li>
             <a href="#_Channel_493" rel="nofollow">
              九、创建 Channel
             </a>
            </li>
            <li>
             <a href="#Channel_496" rel="nofollow">
              十、Channel使用示例
             </a>
            </li>
            <li>
             <a href="#select_499" rel="nofollow">
              十一、select语句
             </a>
            </li>
            <li>
            ...
            <li>
             <a href="#Atomic_Operation_508" rel="nofollow">
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#defer_522" rel="nofollow">
              一、defer
             </a>
            </li>
            <li>
             <a href="#panic_527" rel="nofollow">
              二、panic
             </a>
            </li>
            <li>
             <a href="#recover_532" rel="nofollow">
              三、recover
             </a>
            </li>
            <li>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#Go_619" rel="nofollow">
              二、Go语言标准库
             </a>
            </li>
            <li>
             <a href="#math_622" rel="nofollow">
              三、math包
             </a>
            </li>
            <li>
             <a href="#strings_627" rel="nofollow">
              四、strings包
             </a>
            </li>
            <li>
             <a href="#regexp_630" rel="nofollow">
              五、regexp包
             </a>
            </li>
            <li>
             <a href="#os_633" rel="nofollow">
              六、os包
             </a>
            </li>
            <li>
             <a href="#image_636" rel="nofollow">
              七、image包
             </a>
            </li>
            <li>
             <a href="#_639" rel="nofollow">
              小结
             </a>
            </li>
           </ul>
        ...
        <li>
         <a href="#19JSON_642" rel="nofollow">
          19课题、JSON数据
         </a>
        </li>
        <li>
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#JSON_647" rel="nofollow">
              一、JSON数据
             </a>
            </li>
            <li>
             <a href="#GoJSON_651" rel="nofollow">
              二、Go语言JSON数据处理
             </a>
            </li>
            <li>
             <a href="#_655" rel="nofollow">
              三、注意事项
             </a>
            </li>
            <li>
             <a href="#_661" rel="nofollow">
              小结
             </a>
            </li>
           </ul>
        ...
        <li>
         <ul>
          <li>
           <ul>
            <li>
             <a href="#_675" rel="nofollow">
              课题摘要
             </a>
            </li>
            <li>
             <a href="#_678" rel="nofollow">
              一、模板引擎
             </a>
            </li>
            <li>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#Go_726" rel="nofollow">
              一、Go语言编程适合的开发方向
             </a>
            </li>
            <li>
             <a href="#Go_735" rel="nofollow">
              二、Go语言开发人工智能程序的生态状况
             </a>
            </li>
            <li>
             <a href="#Go_741" rel="nofollow">
              三、Go语言编程可以面向哪些就业岗位
             </a>
            </li>
           </ul>
         ...
         <ul>
          <li>
           <ul>
            ...
            <li>
             <a href="#Go_779" rel="nofollow">
              三、Go语言编程哲学
             </a>
            </li>
            <li>
             <a href="#Go_786" rel="nofollow">
              四、理解Go语言编程哲学的重要意义
             </a>
            </li>
           </ul>
    ...
    <h5>
     <a id="Asynchronous_Programming_469">
     </a>
     一、异步编程（Asynchronous Programming）
    </h5>
    <p>
    ...
    <h5>
     <a id="Concurrency_Programming_472">
     </a>
     二、并发编程（Concurrency Programming）
    </h5>
    <p>
 ...
 <p alt="68747470733a2f2f62:6c6f672e6373646e2e6e65742f71715f34303037313538352f:61727469636c652f64657461696c732f313432373337313839" class_="artid" style="display:none">
 </p>
</div>
