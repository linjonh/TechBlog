...
如果希望用户输入数据的同时修改 data 中的数据，可以借助简单双向绑定机制，在对应属性之前添加 model: 前缀即可：例如 **`<input
model:value="{{ value }}" />`**；
...
参考视频：[尚硅谷微信小程序开发教程](https://www.bilibili.com/video/BV1LF4m1E7kB?spm_id_from=333.788.player.switch&vd_source=685932cc10434c6f812b07e579c1c1bf&p=39)
