...
onready var resource\_manager = $ResourceManager # 子节点：资源部门
...
func \_input(event):
if event.is\_action\_pressed("ui\_select"):
resource\_manager.collect("wood", 1) # 通知资源部门加木材
```
2. 玩家模块（Player.gd）
```
...
velocity.x += 1
move\_and\_slide(velocity \* speed) # 使用Godot的API移动
```
3. 资源模块（ResourceManager.gd）
```
extends Node
func collect(resource\_type, amount):
get\_parent().resources[resource\_type] += amount # 更新主节点的共享数据
print("采集了", amount, resource\_type)
```
4. UI模块（UI.gd）
```
extends Control
...
---
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c2f02d44c207420e8c7e6c4cb9bb0d85.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/70e4fc24b8044602be2ca8cbc260ad8f.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7495de55238f4be19840e20d5c3024b6.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0253cd1008d141f7a8aad65a4ad1cd55.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/78196813f80f454b96af8c0a0802ee6b.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/dab42f638ac240bf8a6a069b34436755.png#pic\_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/601e8df05e9b45d29d1e37dc3c73e880.png#pic\_center)