...
ffmpeg -r 10 -pattern\_type glob -i './\*.jpg' -vcodec libx264 lottery.mp4

//获取视频长度

/usr/local/ffmpeg/bin/ffprobe -v error -show\_entries format=duration -of default=noprint\_wrappers=1:nokey=1 lottery.mp4
...
ffmpeg -stream\_loop 1 -i gc.aac -i lottery.mp4 lottery\_ok.mp4