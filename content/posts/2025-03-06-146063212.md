...
<div class="blog-content-box">
 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="markdown_views prism-atom-one-light" id="content_views">
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/fc64e6adc8de153dd5c11e5afff74d13.png"/>
    </p>
    <p>
     绘制散点图，这个scatter就是绘制散点图的函数方法，y&lt;50目的是为了进行筛选，因为这个y=50位置有很多店符合条件，但是这个参考机制不大，所以我们把这些点过滤掉；
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/0be2a9a17ee311fd700d3aa7b5b705e9.png"/>
    </p>
    <p>
     划分测试集和训练集：并且绘制这个训练集的可视化效果
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/246d1bea8d4a3bc92113d089d0c56100.png"/>
    </p>
    <p>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/0ae6c787b14b6c1f6966f4c1a4dddae4.png"/>
    </p>
    <p>
     我们可以在查看一下这个测试集的效果：
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/bf23d04616c6d86b8e7001086cf63668.png"/>
    </p>
    <p>
     下面的这个是直接调用包，使用训练集进行训练，测试集进行预测即可：绘制出来这个散点图查看方程的拟合效果；
    </p>
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/b7c9bbe3b1739d111a82566dcb5a7d54.png"/>
    </p>
    <h2>
     <a id="2_46">
     </a>
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/img_convert/1eb83ab6544034d984679f5ecfdbdb6c.png"/>
    </p>
   </div>
 ...
 <p alt="6874747073:3a2f2f626c6f672e6373646e2e6e65742f62696e6879756e2f:61727469636c652f64657461696c732f313436303633323132" class_="artid" style="display:none">
 </p>
</div>
