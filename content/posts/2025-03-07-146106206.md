...
keywords: "DeepSeek-进阶版部署(Linux+GPU)"
categories: ['Deepseek']
...
这里需要内核高于4.15才可以，否则驱动会安装失败,所以建议选择更高内核系统，我这里使用是CentOS7.5，做了先升级内核，然后手工编译了gcc才最终安装成功驱动。我在其他环境安装Ubuntu
22.4 则没有这个动作，直接安装下面的包即可(gcc需要换成gcc-12)。
...
[参考上小节：快速搭建DeepSeek-
Linux版本](https://mp.weixin.qq.com/s?__biz=MzA5MTkyMTQ0NA==&mid=2247485808&idx=1&sn=5ed7cb369ae9926778aaa7c5ef8992fc&scene=21#wechat_redirect
