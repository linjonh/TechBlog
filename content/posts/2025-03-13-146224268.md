 ...
 <article class="baidu_pl">
  <div class="article_content clearfix" id="article_content">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <p>
     <img alt="" src="https://i-blog.csdnimg.cn/direct/9f40fcb645794c4ca2c2b8a29695499e.png"/>
    </p>
    <p>
     说明：
    </p>
    ...
    <pre><code class="language-javascript">import webSocket from '@ohos.net.webSocket';
...
struct ChatPage {
  ...
  connect2Server() {
    ...
    <pre><code class="language-java">package cn.wujiangbo.WebSocket.server;
...
//    @Scheduled(cron = "0/59 * *  * * ? ")
 ...
 <p alt="68747470733a2f2f626c:6f672e6373646e2e6e65742f77756a69616e67626f3532302f:61727469636c652f64657461696c732f313436323234323638" class_="artid" style="display:none">
 </p>
</div>
