...
int pos=left;
//合并
while (l\_pos <= mid && r\_pos <= right)
{
if (arr[l\_pos] < arr[r\_pos])
tempArr[pos++] = arr[l\_pos++];
else
tempArr[pos++] = arr[r\_pos++];
}
//合并左半区剩余的元素
while (l\_pos <= mid)
{
...
//归并排序入口
void merge\_sort(int arr[], int n)
{
//分配一个辅助的数组
