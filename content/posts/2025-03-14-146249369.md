...
# Win11基于anaconda pip安装cx\_Oracle库报错ERROR: Failed building wheel for cx\_Oracle
...
安装cx\_Oracle库报错，python版本3.12.7，报错：

* ERROR: Failed to build installable wheels for some pyproject.toml based projects (cx\_Oracle)
* ERROR: Failed building wheel for cx\_Oracle
