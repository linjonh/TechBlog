...
# MySQL 的 innodb\_buffer\_pool\_size 参数配置指南
...
[MySQL的innodb\_buffer\_pool\_size参数优化配置指南 - #2 by hex - 数据库 - iSharkFly](https://www.isharkfly.com/t/mysql-innodb-buffer-pool-size/17058/2 "MySQL的innodb_buffer_pool_size参数优化配置指南 - #2 by hex - 数据库 - iSharkFly")