...
<div class="blog-content-box">
   ...
   <div class="htmledit_views" id="content_views">
    ...
    <ul>
     ...
     <li>
      ...
      ：图像是二维数据，经过词向量表达的文本为一维数据，因此在TextCNN卷积用的是一维卷积。一维卷积带来的问题是需要设计通过不同 filter_size 的 filter 获取不同宽度的视野。
     </li>
     <li>
      <strong>
       Pooling
    ...
    <p style="margin-left:0cm;">
     ...
     ，一方面无法建模更长的序列信息，另一方面 filter_size 的超参调节也很繁琐。
     <strong>
      CNN
     </strong>
     <strong>
 ...
 <p alt="68747470733a:2f2f626c6f672e6373646e2e6e65742f78757869617469616e:2f61727469636c652f64657461696c732f3839303836323835" class_="artid" style="display:none">
 </p>
</div>
