---
arturl_encode: "68747470733a2f:2f626c6f672e6373646e2e6e65742f68616c6c6f62696b652f:61727469636c652f64657461696c732f313330343436393437"
layout: post
title: "Python编程IDE的选择"
date: 2023-04-30 12:01:14 +08:00
...
featuredImage: https://bing.ee123.net/img/rand?artid=130446947
featuredImagePreview: https://bing.ee123.net/img/rand?artid=130446947
---

# Python编程IDE的选择

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0d5cf090fd02f394953128fca769aa7c.jpeg#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/dc189de1ee7a57da32497e2f66c36f77.png)
...
* Jupyter的安装，直接在DOS窗口中
  ...
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/eac096bf210b52b99f70f197909821ca.png)
* 打开Jupyter notebook，这也是非常简单的，直接Dos窗口输入jupyter notebook即可，如下图：期间如果出现错误，请参考
  [输入 jupyter notebook 报错 ModuleNotFoundError: No module named ‘pysqlite2‘ 解决方案](https://blog.csdn.net/hallobike/article/details/130382635)
    
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b39a4e9e23101f36b3e5e04c20a0ff42.png)
    
  这是最直接的打开方式，但如果你想要jupyter从你的创建的文件夹下面打开的话，可以两种方法，一种是dos里面cd到对应文件夹下面；第二种比较简单，直接到对应文件夹下面，在导航框里输入
  `jupyter notebook`
  就行了。
    
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5ad3d013205748f446468129599c18be.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/fb3449c0f095624d6b6d17fcf76a491d.png)
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/352a2c1f22a222b60ead9ff317a5ba15.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/90fd1dc798a51f6cd71f55ab7296c30d.png)
  
他的下载和安装也会专门出一期博客，因为其配置有很多，需要讲解的也很多，大家敬请期待。
  
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5df2f3fd71b630fdc67f735892f39aeb.png)
