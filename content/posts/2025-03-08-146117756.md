...
[transformer架构嵌入层位置编码之动态NTK-aware位置编码\_动态的位置编码嵌入-CSDN博客](https://lzm07.blog.csdn.net/article/details/145865840 "transformer架构嵌入层位置编码之动态NTK-aware位置编码_动态的位置编码嵌入-CSDN博客")
