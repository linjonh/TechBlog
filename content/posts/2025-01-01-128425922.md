...
screen.draw的circle、filled\_circle、filled\_rect、line、rect、text、textbox可以绘制图形和文字。
...
screen.draw.filled\_circle(pos, radius, color)
...
screen.draw.filled\_rect(rect, color)
